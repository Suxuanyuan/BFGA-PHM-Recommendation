...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DYH49Q8B_E148` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Statistical moments |  |
| 2 | `DYH49Q8B_E149` | `motivates` | 09-Problem Scenario | limited data or information case(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Statistical moments |  |
| 3 | `DYH49Q8B_E150` | `motivates` | 09-Problem Scenario | training and testing data available at different operating conditions(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Statistical moments |  |
| 4 | `DYH49Q8B_E151` | `motivates` | 09-Problem Scenario | multi-sensor(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | Statistical moments |  |
| 5 | `DYH49Q8B_E152` | `motivates` | 09-Problem Scenario | limited data or information case(Small Fault Samples) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 6 | `DYH49Q8B_E153` | `motivates` | 09-Problem Scenario | training and testing data available at different operating conditions(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 7 | `DYH49Q8B_E154` | `motivates` | 09-Problem Scenario | multi-sensor(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 8 | `DYH49Q8B_E155` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Statistical moments |  |
| 9 | `DYH49Q8B_E156` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 10 | `DYH49Q8B_E157` | `motivates` | 06-Fault Severity | severity levels(Multiple Severities) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `DYH49Q8B_E149`：limited data or information case(Small Fault Samples) motivates Statistical moments
  - `DYH49Q8B_E150`：training and testing data available at different operating conditions(Distribution Discrepancy) motivates Statistical moments
  - `DYH49Q8B_E151`：multi-sensor(Multi-Source Heterogeneous / Multimodal Data) motivates Statistical moments
  - `DYH49Q8B_E152`：limited data or information case(Small Fault Samples) motivates Support Vector Machine
  - `DYH49Q8B_E153`：training and testing data available at different operating conditions(Distribution Discrepancy) motivates Support Vector Machine
  - `DYH49Q8B_E154`：multi-sensor(Multi-Source Heterogeneous / Multimodal Data) motivates Support Vector Machine
