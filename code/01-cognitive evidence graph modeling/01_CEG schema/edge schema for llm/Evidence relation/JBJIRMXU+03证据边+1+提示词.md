...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `JBJIRMXU_E076` | `motivates` | 13-Noise Level | Gaussian white noise, sinusoidal interference, random impacts(High Noise) |  | 15-Data Preprocessing Algorithm | Bandpass Filtering |  |
| 2 | `JBJIRMXU_E077` | `motivates` | 13-Noise Level | Gaussian white noise, sinusoidal interference, random impacts(High Noise) |  | 16-Feature Extraction Algorithm | L-Kurtosis |  |
| 3 | `JBJIRMXU_E078` | `motivates` | 09-Problem Scenario | susceptible to outliers and noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Bandpass Filtering |  |
| 4 | `JBJIRMXU_E079` | `motivates` | 09-Problem Scenario | susceptible to outliers and noise(Uncertainty) |  | 16-Feature Extraction Algorithm | L-Kurtosis |  |
| 5 | `JBJIRMXU_E080` | `motivates` | 09-Problem Scenario | susceptible to outliers and noise(Uncertainty) |  | 17-Core Classifier Algorithm | Thresholding |  |
| 6 | `JBJIRMXU_E081` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | L-Kurtosis |  |
| 7 | `JBJIRMXU_E082` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Thresholding |  |
| 8 | `JBJIRMXU_E083` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Thresholding |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `JBJIRMXU_E078`：susceptible to outliers and noise(Uncertainty) motivates Bandpass Filtering
  - `JBJIRMXU_E079`：susceptible to outliers and noise(Uncertainty) motivates L-Kurtosis
  - `JBJIRMXU_E080`：susceptible to outliers and noise(Uncertainty) motivates Thresholding
