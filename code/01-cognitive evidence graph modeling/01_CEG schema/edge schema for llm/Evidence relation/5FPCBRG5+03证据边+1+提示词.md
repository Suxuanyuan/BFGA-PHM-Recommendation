...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `5FPCBRG5_E075` | `motivates` | 13-Noise Level | raw measured stator current data(Normal) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 2 | `5FPCBRG5_E076` | `motivates` | 13-Noise Level | raw measured stator current data(Normal) |  | 16-Feature Extraction Algorithm | CNN |  |
| 3 | `5FPCBRG5_E077` | `motivates` | 09-Problem Scenario | incipient stator winding fault detection(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 4 | `5FPCBRG5_E078` | `motivates` | 09-Problem Scenario | direct processing of raw diagnostic signals omitting analytical methods(Other) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 5 | `5FPCBRG5_E079` | `motivates` | 09-Problem Scenario | incipient stator winding fault detection(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | CNN |  |
| 6 | `5FPCBRG5_E080` | `motivates` | 09-Problem Scenario | direct processing of raw diagnostic signals omitting analytical methods(Other) |  | 16-Feature Extraction Algorithm | CNN |  |
| 7 | `5FPCBRG5_E081` | `motivates` | 09-Problem Scenario | incipient stator winding fault detection(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `5FPCBRG5_E082` | `motivates` | 09-Problem Scenario | direct processing of raw diagnostic signals omitting analytical methods(Other) |  | 17-Core Classifier Algorithm | Softmax |  |
| 9 | `5FPCBRG5_E083` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 10 | `5FPCBRG5_E084` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `5FPCBRG5_E085` | `motivates` | 06-Fault Severity | 1-5 shorted turns(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `5FPCBRG5_E077`：incipient stator winding fault detection(Early Degradation Prediction) motivates Normalization
  - `5FPCBRG5_E078`：direct processing of raw diagnostic signals omitting analytical methods(Other) motivates Normalization
  - `5FPCBRG5_E079`：incipient stator winding fault detection(Early Degradation Prediction) motivates CNN
  - `5FPCBRG5_E080`：direct processing of raw diagnostic signals omitting analytical methods(Other) motivates CNN
  - `5FPCBRG5_E081`：incipient stator winding fault detection(Early Degradation Prediction) motivates Softmax
  - `5FPCBRG5_E082`：direct processing of raw diagnostic signals omitting analytical methods(Other) motivates Softmax
