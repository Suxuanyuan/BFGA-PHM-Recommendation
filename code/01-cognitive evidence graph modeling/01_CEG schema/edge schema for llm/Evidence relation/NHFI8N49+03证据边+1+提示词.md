...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `NHFI8N49_E118` | `motivates` | 13-Noise Level | Gaussian noise simulating the environment ambient noise was artificially added into each data segment to obtain different SNR from 10 dB to 30 dB(High Noise) |  | 15-Data Preprocessing Algorithm | Discrete Wavelet Transform |  |
| 2 | `NHFI8N49_E119` | `motivates` | 13-Noise Level | Gaussian noise simulating the environment ambient noise was artificially added into each data segment to obtain different SNR from 10 dB to 30 dB(High Noise) |  | 16-Feature Extraction Algorithm | Convolutional Neural Network |  |
| 3 | `NHFI8N49_E120` | `motivates` | 09-Problem Scenario | ambient noise / strong background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Discrete Wavelet Transform |  |
| 4 | `NHFI8N49_E121` | `motivates` | 09-Problem Scenario | complex structure of planetary gearboxes and time-varying transmission path(Complex Systems) |  | 15-Data Preprocessing Algorithm | Discrete Wavelet Transform |  |
| 5 | `NHFI8N49_E122` | `motivates` | 09-Problem Scenario | ambient noise / strong background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Convolutional Neural Network |  |
| 6 | `NHFI8N49_E123` | `motivates` | 09-Problem Scenario | complex structure of planetary gearboxes and time-varying transmission path(Complex Systems) |  | 16-Feature Extraction Algorithm | Convolutional Neural Network |  |
| 7 | `NHFI8N49_E124` | `motivates` | 09-Problem Scenario | ambient noise / strong background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `NHFI8N49_E125` | `motivates` | 09-Problem Scenario | complex structure of planetary gearboxes and time-varying transmission path(Complex Systems) |  | 17-Core Classifier Algorithm | Softmax |  |
| 9 | `NHFI8N49_E126` | `motivates` | 07-Compound Fault | composite seeded fault(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Convolutional Neural Network |  |
| 10 | `NHFI8N49_E127` | `motivates` | 07-Compound Fault | composite seeded fault(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `NHFI8N49_E128` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `NHFI8N49_E120`：ambient noise / strong background noise(Uncertainty) motivates Discrete Wavelet Transform
  - `NHFI8N49_E121`：complex structure of planetary gearboxes and time-varying transmission path(Complex Systems) motivates Discrete Wavelet Transform
  - `NHFI8N49_E122`：ambient noise / strong background noise(Uncertainty) motivates Convolutional Neural Network
  - `NHFI8N49_E123`：complex structure of planetary gearboxes and time-varying transmission path(Complex Systems) motivates Convolutional Neural Network
  - `NHFI8N49_E124`：ambient noise / strong background noise(Uncertainty) motivates Softmax
  - `NHFI8N49_E125`：complex structure of planetary gearboxes and time-varying transmission path(Complex Systems) motivates Softmax
