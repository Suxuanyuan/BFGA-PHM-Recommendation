...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `N4R5BLFT_E061` | `motivates` | 09-Problem Scenario | high cost of online monitoring and sensor placement optimization(Other) |  | 17-Core Classifier Algorithm | Rule-based Fault Diagnosis Algorithm |  |
| 2 | `N4R5BLFT_E062` | `motivates` | 09-Problem Scenario | multi-string multi-module fault diagnosis(Compound Faults) |  | 17-Core Classifier Algorithm | Rule-based Fault Diagnosis Algorithm |  |
| 3 | `N4R5BLFT_E063` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Rule-based Fault Diagnosis Algorithm |  |
| 4 | `N4R5BLFT_E064` | `motivates` | 06-Fault Severity | fully shaded(Single Severity) |  | 17-Core Classifier Algorithm | Rule-based Fault Diagnosis Algorithm |  |
| 5 | `N4SKTFF8_E116` | `motivates` | 09-Problem Scenario | unseen fault conditions(Zero Fault Samples) |  | 19-Training Optimization Algorithm | Incremental Learning |  |
| 6 | `N4SKTFF8_E117` | `motivates` | 09-Problem Scenario | incremental learning of new classes(Other) |  | 19-Training Optimization Algorithm | Incremental Learning |  |
| 7 | `N4SKTFF8_E118` | `motivates` | 12-Training Data Availability | For each scenario – Hc, F1 and F2 – a batch of 30 measurements of full shaft turns is available for training and validation(Scarce) |  | 19-Training Optimization Algorithm | Incremental Learning |  |
| 8 | `N4SKTFF8_E119` | `motivates` | 13-Noise Level | stator current signatures(Normal) |  | 15-Data Preprocessing Algorithm | NTFM |  |
| 9 | `N4SKTFF8_E120` | `motivates` | 13-Noise Level | stator current signatures(Normal) |  | 16-Feature Extraction Algorithm | STFT |  |
| 10 | `N4SKTFF8_E121` | `motivates` | 09-Problem Scenario | unseen fault conditions(Zero Fault Samples) |  | 15-Data Preprocessing Algorithm | NTFM |  |
| 11 | `N4SKTFF8_E122` | `motivates` | 09-Problem Scenario | incremental learning of new classes(Other) |  | 15-Data Preprocessing Algorithm | NTFM |  |
| 12 | `N4SKTFF8_E123` | `motivates` | 09-Problem Scenario | unseen fault conditions(Zero Fault Samples) |  | 16-Feature Extraction Algorithm | STFT |  |
| 13 | `N4SKTFF8_E124` | `motivates` | 09-Problem Scenario | incremental learning of new classes(Other) |  | 16-Feature Extraction Algorithm | STFT |  |
| 14 | `N4SKTFF8_E125` | `motivates` | 09-Problem Scenario | unseen fault conditions(Zero Fault Samples) |  | 17-Core Classifier Algorithm | MVKDE |  |
| 15 | `N4SKTFF8_E126` | `motivates` | 09-Problem Scenario | incremental learning of new classes(Other) |  | 17-Core Classifier Algorithm | MVKDE |  |
| 16 | `N4SKTFF8_E127` | `motivates` | 07-Compound Fault | two faults combined(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | STFT |  |
| 17 | `N4SKTFF8_E128` | `motivates` | 07-Compound Fault | two faults combined(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | MVKDE |  |
| 18 | `N4SKTFF8_E129` | `motivates` | 06-Fault Severity | decrease in the effort patterns(Multiple Severities) |  | 17-Core Classifier Algorithm | MVKDE |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `N4R5BLFT_E061`：high cost of online monitoring and sensor placement optimization(Other) motivates Rule-based Fault Diagnosis Algorithm
  - `N4R5BLFT_E062`：multi-string multi-module fault diagnosis(Compound Faults) motivates Rule-based Fault Diagnosis Algorithm
  - `N4SKTFF8_E116`：unseen fault conditions(Zero Fault Samples) motivates Incremental Learning
  - `N4SKTFF8_E117`：incremental learning of new classes(Other) motivates Incremental Learning
  - `N4SKTFF8_E121`：unseen fault conditions(Zero Fault Samples) motivates NTFM
  - `N4SKTFF8_E122`：incremental learning of new classes(Other) motivates NTFM
  - `N4SKTFF8_E123`：unseen fault conditions(Zero Fault Samples) motivates STFT
  - `N4SKTFF8_E124`：incremental learning of new classes(Other) motivates STFT
  - `N4SKTFF8_E125`：unseen fault conditions(Zero Fault Samples) motivates MVKDE
  - `N4SKTFF8_E126`：incremental learning of new classes(Other) motivates MVKDE
