...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XSVHIQI8_E055` | `motivates` | 09-Problem Scenario | delayed and missing measurements(Uncertainty) |  | 17-Core Classifier Algorithm | Kalman Filter |  |
| 2 | `XSVHIQI8_E056` | `motivates` | 09-Problem Scenario | time-varying systems(Other) |  | 17-Core Classifier Algorithm | Kalman Filter |  |
| 3 | `XSVHIQI8_E057` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Kalman Filter |  |
| 4 | `XSVHIQI8_E058` | `motivates` | 06-Fault Severity | amplitude about 1.0 * 10^-4 m^3/s(Single Severity) |  | 17-Core Classifier Algorithm | Kalman Filter |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `XSVHIQI8_E055`：delayed and missing measurements(Uncertainty) motivates Kalman Filter
  - `XSVHIQI8_E056`：time-varying systems(Other) motivates Kalman Filter
