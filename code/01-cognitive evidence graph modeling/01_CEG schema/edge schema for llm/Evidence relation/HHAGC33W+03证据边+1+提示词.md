...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HHAGC33W_E100` | `motivates` | 13-Noise Level | Gaussian white noise at a signal to noise ratio of 10 dB(High Noise) |  | 15-Data Preprocessing Algorithm | Bandpass Filtering |  |
| 2 | `HHAGC33W_E101` | `motivates` | 13-Noise Level | Gaussian white noise at a signal to noise ratio of 10 dB(High Noise) |  | 16-Feature Extraction Algorithm | EEMD |  |
| 3 | `HHAGC33W_E102` | `motivates` | 09-Problem Scenario | extra amplitude modulation effect due to time-varying transmission paths(Complex Systems) |  | 15-Data Preprocessing Algorithm | Bandpass Filtering |  |
| 4 | `HHAGC33W_E103` | `motivates` | 09-Problem Scenario | extra amplitude modulation effect due to time-varying transmission paths(Complex Systems) |  | 16-Feature Extraction Algorithm | EEMD |  |
| 5 | `HHAGC33W_E104` | `motivates` | 09-Problem Scenario | extra amplitude modulation effect due to time-varying transmission paths(Complex Systems) |  | 17-Core Classifier Algorithm | Demodulation |  |
| 6 | `HHAGC33W_E105` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | EEMD |  |
| 7 | `HHAGC33W_E106` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Demodulation |  |
| 8 | `HHAGC33W_E107` | `motivates` | 06-Fault Severity | crack of length 3.9 mm(Single Severity) |  | 17-Core Classifier Algorithm | Demodulation |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `HHAGC33W_E102`：extra amplitude modulation effect due to time-varying transmission paths(Complex Systems) motivates Bandpass Filtering
  - `HHAGC33W_E103`：extra amplitude modulation effect due to time-varying transmission paths(Complex Systems) motivates EEMD
  - `HHAGC33W_E104`：extra amplitude modulation effect due to time-varying transmission paths(Complex Systems) motivates Demodulation
