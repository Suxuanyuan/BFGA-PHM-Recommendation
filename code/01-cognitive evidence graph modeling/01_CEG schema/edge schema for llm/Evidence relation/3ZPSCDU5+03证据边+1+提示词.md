...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3ZPSCDU5_E079` | `motivates` | 13-Noise Level | strong background noise(High Noise) |  | 15-Data Preprocessing Algorithm | VMD |  |
| 2 | `3ZPSCDU5_E080` | `motivates` | 13-Noise Level | strong background noise(High Noise) |  | 16-Feature Extraction Algorithm | MTEO |  |
| 3 | `3ZPSCDU5_E081` | `motivates` | 09-Problem Scenario | strong background noise / low signal-to-noise ratio(Uncertainty) |  | 15-Data Preprocessing Algorithm | VMD |  |
| 4 | `3ZPSCDU5_E082` | `motivates` | 09-Problem Scenario | early incipient defect(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | VMD |  |
| 5 | `3ZPSCDU5_E083` | `motivates` | 09-Problem Scenario | strong background noise / low signal-to-noise ratio(Uncertainty) |  | 16-Feature Extraction Algorithm | MTEO |  |
| 6 | `3ZPSCDU5_E084` | `motivates` | 09-Problem Scenario | early incipient defect(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | MTEO |  |
| 7 | `3ZPSCDU5_E085` | `motivates` | 09-Problem Scenario | strong background noise / low signal-to-noise ratio(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Spectrum |  |
| 8 | `3ZPSCDU5_E086` | `motivates` | 09-Problem Scenario | early incipient defect(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Envelope Spectrum |  |
| 9 | `3ZPSCDU5_E087` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | MTEO |  |
| 10 | `3ZPSCDU5_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope Spectrum |  |
| 11 | `3ZPSCDU5_E089` | `motivates` | 06-Fault Severity | early stage defect, severe fault(Multiple Severities) |  | 17-Core Classifier Algorithm | Envelope Spectrum |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `3ZPSCDU5_E081`：strong background noise / low signal-to-noise ratio(Uncertainty) motivates VMD
  - `3ZPSCDU5_E082`：early incipient defect(Early Degradation Prediction) motivates VMD
  - `3ZPSCDU5_E083`：strong background noise / low signal-to-noise ratio(Uncertainty) motivates MTEO
  - `3ZPSCDU5_E084`：early incipient defect(Early Degradation Prediction) motivates MTEO
  - `3ZPSCDU5_E085`：strong background noise / low signal-to-noise ratio(Uncertainty) motivates Envelope Spectrum
  - `3ZPSCDU5_E086`：early incipient defect(Early Degradation Prediction) motivates Envelope Spectrum
