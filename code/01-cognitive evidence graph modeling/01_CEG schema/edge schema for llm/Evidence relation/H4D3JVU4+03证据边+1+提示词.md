...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `H4D3JVU4_E089` | `motivates` | 13-Noise Level | sensor noise, signal noise, electromagnetic interference(High Noise) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 2 | `H4D3JVU4_E090` | `motivates` | 13-Noise Level | sensor noise, signal noise, electromagnetic interference(High Noise) |  | 16-Feature Extraction Algorithm | Thresholding |  |
| 3 | `H4D3JVU4_E091` | `motivates` | 09-Problem Scenario | transient spikes, estimation errors, sensor noise or electromagnetic interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 4 | `H4D3JVU4_E092` | `motivates` | 09-Problem Scenario | zero-current (ZC) conditions(Other) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 5 | `H4D3JVU4_E093` | `motivates` | 09-Problem Scenario | transient spikes, estimation errors, sensor noise or electromagnetic interference(Uncertainty) |  | 16-Feature Extraction Algorithm | Thresholding |  |
| 6 | `H4D3JVU4_E094` | `motivates` | 09-Problem Scenario | zero-current (ZC) conditions(Other) |  | 16-Feature Extraction Algorithm | Thresholding |  |
| 7 | `H4D3JVU4_E095` | `motivates` | 09-Problem Scenario | transient spikes, estimation errors, sensor noise or electromagnetic interference(Uncertainty) |  | 17-Core Classifier Algorithm | Rule-based Classifier |  |
| 8 | `H4D3JVU4_E096` | `motivates` | 09-Problem Scenario | zero-current (ZC) conditions(Other) |  | 17-Core Classifier Algorithm | Rule-based Classifier |  |
| 9 | `H4D3JVU4_E097` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Thresholding |  |
| 10 | `H4D3JVU4_E098` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Rule-based Classifier |  |
| 11 | `H4D3JVU4_E099` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Rule-based Classifier |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `H4D3JVU4_E091`：transient spikes, estimation errors, sensor noise or electromagnetic interference(Uncertainty) motivates Normalization
  - `H4D3JVU4_E092`：zero-current (ZC) conditions(Other) motivates Normalization
  - `H4D3JVU4_E093`：transient spikes, estimation errors, sensor noise or electromagnetic interference(Uncertainty) motivates Thresholding
  - `H4D3JVU4_E094`：zero-current (ZC) conditions(Other) motivates Thresholding
  - `H4D3JVU4_E095`：transient spikes, estimation errors, sensor noise or electromagnetic interference(Uncertainty) motivates Rule-based Classifier
  - `H4D3JVU4_E096`：zero-current (ZC) conditions(Other) motivates Rule-based Classifier
