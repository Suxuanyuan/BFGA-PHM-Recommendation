...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `N6BYKHID_E080` | `motivates` | 13-Noise Level | process noise, measurement noise(High Noise) |  | 16-Feature Extraction Algorithm | Extended Kalman Filter |  |
| 2 | `N6BYKHID_E081` | `motivates` | 09-Problem Scenario | incipient fault detection(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Extended Kalman Filter |  |
| 3 | `N6BYKHID_E082` | `motivates` | 09-Problem Scenario | simultaneous multiple sensors fault(Compound Faults) |  | 16-Feature Extraction Algorithm | Extended Kalman Filter |  |
| 4 | `N6BYKHID_E083` | `motivates` | 09-Problem Scenario | incipient fault detection(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Kullback-Leibler Divergence |  |
| 5 | `N6BYKHID_E084` | `motivates` | 09-Problem Scenario | simultaneous multiple sensors fault(Compound Faults) |  | 17-Core Classifier Algorithm | Kullback-Leibler Divergence |  |
| 6 | `N6BYKHID_E085` | `motivates` | 07-Compound Fault | simultaneous multiple sensors incipient fault(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | Extended Kalman Filter |  |
| 7 | `N6BYKHID_E086` | `motivates` | 07-Compound Fault | simultaneous multiple sensors incipient fault(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | Kullback-Leibler Divergence |  |
| 8 | `N6BYKHID_E087` | `motivates` | 06-Fault Severity | time-varying incipient fault(Multiple Severities) |  | 17-Core Classifier Algorithm | Kullback-Leibler Divergence |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `N6BYKHID_E081`：incipient fault detection(Early Degradation Prediction) motivates Extended Kalman Filter
  - `N6BYKHID_E082`：simultaneous multiple sensors fault(Compound Faults) motivates Extended Kalman Filter
  - `N6BYKHID_E083`：incipient fault detection(Early Degradation Prediction) motivates Kullback-Leibler Divergence
  - `N6BYKHID_E084`：simultaneous multiple sensors fault(Compound Faults) motivates Kullback-Leibler Divergence
