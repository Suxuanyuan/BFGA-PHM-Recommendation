...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `YVK32STF_E081` | `motivates` | 09-Problem Scenario | incipient faults(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | Gauss-Newton method |  |
| 2 | `YVK32STF_E082` | `motivates` | 09-Problem Scenario | stochastic noise(Uncertainty) |  | 19-Training Optimization Algorithm | Gauss-Newton method |  |
| 3 | `YVK32STF_E083` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Gauss-Newton method |  |
| 4 | `YVK32STF_E084` | `motivates` | 09-Problem Scenario | incipient faults(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Particle filter |  |
| 5 | `YVK32STF_E085` | `motivates` | 09-Problem Scenario | stochastic noise(Uncertainty) |  | 17-Core Classifier Algorithm | Particle filter |  |
| 6 | `YVK32STF_E086` | `motivates` | 07-Compound Fault | multi-faults(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | Particle filter |  |
| 7 | `YVK32STF_E087` | `motivates` | 06-Fault Severity | incipient fault parameters(Multiple Severities) |  | 17-Core Classifier Algorithm | Particle filter |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `YVK32STF_E081`：incipient faults(Early Degradation Prediction) motivates Gauss-Newton method
  - `YVK32STF_E082`：stochastic noise(Uncertainty) motivates Gauss-Newton method
  - `YVK32STF_E084`：incipient faults(Early Degradation Prediction) motivates Particle filter
  - `YVK32STF_E085`：stochastic noise(Uncertainty) motivates Particle filter
