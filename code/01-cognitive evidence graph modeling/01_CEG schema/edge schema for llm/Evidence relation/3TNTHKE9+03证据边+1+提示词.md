...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3TNTHKE9_E096` | `motivates` | 09-Problem Scenario | distribution difference of vibration signal between a training set and a test set(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Joint Distribution Adaptation |  |
| 2 | `3TNTHKE9_E097` | `motivates` | 12-Training Data Availability | each fault type contains 200 samples(Sufficient) |  | 19-Training Optimization Algorithm | Joint Distribution Adaptation |  |
| 3 | `3TNTHKE9_E098` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | FFT |  |
| 4 | `3TNTHKE9_E099` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | PCA |  |
| 5 | `3TNTHKE9_E100` | `motivates` | 09-Problem Scenario | distribution difference of vibration signal between a training set and a test set(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 6 | `3TNTHKE9_E101` | `motivates` | 09-Problem Scenario | distribution difference of vibration signal between a training set and a test set(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | PCA |  |
| 7 | `3TNTHKE9_E102` | `motivates` | 09-Problem Scenario | distribution difference of vibration signal between a training set and a test set(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | NN |  |
| 8 | `3TNTHKE9_E103` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | PCA |  |
| 9 | `3TNTHKE9_E104` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | NN |  |
| 10 | `3TNTHKE9_E105` | `motivates` | 06-Fault Severity | 0.007in, 0.014in, 0.021in(Multiple Severities) |  | 17-Core Classifier Algorithm | NN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `3TNTHKE9_E096`：distribution difference of vibration signal between a training set and a test set(Distribution Discrepancy) motivates Joint Distribution Adaptation
  - `3TNTHKE9_E100`：distribution difference of vibration signal between a training set and a test set(Distribution Discrepancy) motivates FFT
  - `3TNTHKE9_E101`：distribution difference of vibration signal between a training set and a test set(Distribution Discrepancy) motivates PCA
  - `3TNTHKE9_E102`：distribution difference of vibration signal between a training set and a test set(Distribution Discrepancy) motivates NN
