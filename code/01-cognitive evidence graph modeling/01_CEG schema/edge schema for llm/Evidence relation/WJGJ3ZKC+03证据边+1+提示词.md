...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WJGJ3ZKC_E080` | `motivates` | 13-Noise Level | noises(High Noise) |  | 15-Data Preprocessing Algorithm | Local Mean Decomposition |  |
| 2 | `WJGJ3ZKC_E081` | `motivates` | 13-Noise Level | noises(High Noise) |  | 16-Feature Extraction Algorithm | IAMMA |  |
| 3 | `WJGJ3ZKC_E082` | `motivates` | 09-Problem Scenario | susceptible to noises(Uncertainty) |  | 15-Data Preprocessing Algorithm | Local Mean Decomposition |  |
| 4 | `WJGJ3ZKC_E083` | `motivates` | 09-Problem Scenario | susceptible to noises(Uncertainty) |  | 16-Feature Extraction Algorithm | IAMMA |  |
| 5 | `WJGJ3ZKC_E084` | `motivates` | 09-Problem Scenario | susceptible to noises(Uncertainty) |  | 17-Core Classifier Algorithm | Fast Fourier Transform |  |
| 6 | `WJGJ3ZKC_E085` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | IAMMA |  |
| 7 | `WJGJ3ZKC_E086` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Fast Fourier Transform |  |
| 8 | `WJGJ3ZKC_E087` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Fast Fourier Transform |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `WJGJ3ZKC_E082`：susceptible to noises(Uncertainty) motivates Local Mean Decomposition
  - `WJGJ3ZKC_E083`：susceptible to noises(Uncertainty) motivates IAMMA
  - `WJGJ3ZKC_E084`：susceptible to noises(Uncertainty) motivates Fast Fourier Transform
