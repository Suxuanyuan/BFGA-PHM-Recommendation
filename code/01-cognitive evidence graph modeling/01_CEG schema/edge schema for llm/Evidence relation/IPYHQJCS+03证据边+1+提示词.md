...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `IPYHQJCS_E091` | `motivates` | 13-Noise Level | interference noise(High Noise) |  | 15-Data Preprocessing Algorithm | LMD |  |
| 2 | `IPYHQJCS_E092` | `motivates` | 13-Noise Level | interference noise(High Noise) |  | 16-Feature Extraction Algorithm | IMFE |  |
| 3 | `IPYHQJCS_E093` | `motivates` | 09-Problem Scenario | uncertain and unsatisfactory analysis for short-term data(Uncertainty) |  | 15-Data Preprocessing Algorithm | LMD |  |
| 4 | `IPYHQJCS_E094` | `motivates` | 09-Problem Scenario | high dimension of feature vector and information redundancy(Other) |  | 15-Data Preprocessing Algorithm | LMD |  |
| 5 | `IPYHQJCS_E095` | `motivates` | 09-Problem Scenario | uncertain and unsatisfactory analysis for short-term data(Uncertainty) |  | 16-Feature Extraction Algorithm | IMFE |  |
| 6 | `IPYHQJCS_E096` | `motivates` | 09-Problem Scenario | high dimension of feature vector and information redundancy(Other) |  | 16-Feature Extraction Algorithm | IMFE |  |
| 7 | `IPYHQJCS_E097` | `motivates` | 09-Problem Scenario | uncertain and unsatisfactory analysis for short-term data(Uncertainty) |  | 17-Core Classifier Algorithm | ISVM-BT |  |
| 8 | `IPYHQJCS_E098` | `motivates` | 09-Problem Scenario | high dimension of feature vector and information redundancy(Other) |  | 17-Core Classifier Algorithm | ISVM-BT |  |
| 9 | `IPYHQJCS_E099` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | IMFE |  |
| 10 | `IPYHQJCS_E100` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | ISVM-BT |  |
| 11 | `IPYHQJCS_E101` | `motivates` | 06-Fault Severity | 0.1778 mm, 0.3556 mm, 0.5334 mm, 0.7112 mm(Multiple Severities) |  | 17-Core Classifier Algorithm | ISVM-BT |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `IPYHQJCS_E093`：uncertain and unsatisfactory analysis for short-term data(Uncertainty) motivates LMD
  - `IPYHQJCS_E094`：high dimension of feature vector and information redundancy(Other) motivates LMD
  - `IPYHQJCS_E095`：uncertain and unsatisfactory analysis for short-term data(Uncertainty) motivates IMFE
  - `IPYHQJCS_E096`：high dimension of feature vector and information redundancy(Other) motivates IMFE
  - `IPYHQJCS_E097`：uncertain and unsatisfactory analysis for short-term data(Uncertainty) motivates ISVM-BT
  - `IPYHQJCS_E098`：high dimension of feature vector and information redundancy(Other) motivates ISVM-BT
