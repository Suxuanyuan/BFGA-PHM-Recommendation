...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `6TYYMA8M_E087` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 19-Training Optimization Algorithm | L1 regularization |  |
| 2 | `6TYYMA8M_E088` | `motivates` | 09-Problem Scenario | varying working conditions (domain shift)(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | L1 regularization |  |
| 3 | `6TYYMA8M_E089` | `motivates` | 12-Training Data Availability | 150 samples per class for XJTU-SY and 100 samples per class for CWRU(Sufficient) |  | 19-Training Optimization Algorithm | L1 regularization |  |
| 4 | `6TYYMA8M_E090` | `motivates` | 13-Noise Level | strong background noise, heavy noise(High Noise) |  | 16-Feature Extraction Algorithm | AKSNet |  |
| 5 | `6TYYMA8M_E091` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | AKSNet |  |
| 6 | `6TYYMA8M_E092` | `motivates` | 09-Problem Scenario | varying working conditions (domain shift)(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | AKSNet |  |
| 7 | `6TYYMA8M_E093` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `6TYYMA8M_E094` | `motivates` | 09-Problem Scenario | varying working conditions (domain shift)(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 9 | `6TYYMA8M_E095` | `motivates` | 07-Compound Fault | inner race and outer race fault(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | AKSNet |  |
| 10 | `6TYYMA8M_E096` | `motivates` | 07-Compound Fault | inner race and outer race fault(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `6TYYMA8M_E097` | `motivates` | 06-Fault Severity | 0.007 inch(Single Severity) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `6TYYMA8M_E087`：noise robustness(Uncertainty) motivates L1 regularization
  - `6TYYMA8M_E088`：varying working conditions (domain shift)(Distribution Discrepancy) motivates L1 regularization
  - `6TYYMA8M_E091`：noise robustness(Uncertainty) motivates AKSNet
  - `6TYYMA8M_E092`：varying working conditions (domain shift)(Distribution Discrepancy) motivates AKSNet
  - `6TYYMA8M_E093`：noise robustness(Uncertainty) motivates Softmax
  - `6TYYMA8M_E094`：varying working conditions (domain shift)(Distribution Discrepancy) motivates Softmax
