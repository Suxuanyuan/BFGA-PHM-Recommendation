...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VM758RQZ_E120` | `motivates` | 09-Problem Scenario | ambient noise(Uncertainty) |  | 19-Training Optimization Algorithm | Variant Length Input |  |
| 2 | `VM758RQZ_E121` | `motivates` | 09-Problem Scenario | multiple sensors(Multi-Source Heterogeneous / Multimodal Data) |  | 19-Training Optimization Algorithm | Variant Length Input |  |
| 3 | `VM758RQZ_E122` | `motivates` | 09-Problem Scenario | load fluctuations(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Variant Length Input |  |
| 4 | `VM758RQZ_E123` | `motivates` | 12-Training Data Availability | 300 training samples / 1000 samples per dataset(Sufficient) |  | 19-Training Optimization Algorithm | Variant Length Input |  |
| 5 | `VM758RQZ_E124` | `motivates` | 13-Noise Level | ambient noise(High Noise) |  | 15-Data Preprocessing Algorithm | Masking Noise |  |
| 6 | `VM758RQZ_E125` | `motivates` | 13-Noise Level | ambient noise(High Noise) |  | 16-Feature Extraction Algorithm | GRU |  |
| 7 | `VM758RQZ_E126` | `motivates` | 09-Problem Scenario | ambient noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Masking Noise |  |
| 8 | `VM758RQZ_E127` | `motivates` | 09-Problem Scenario | multiple sensors(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Masking Noise |  |
| 9 | `VM758RQZ_E128` | `motivates` | 09-Problem Scenario | load fluctuations(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Masking Noise |  |
| 10 | `VM758RQZ_E129` | `motivates` | 09-Problem Scenario | ambient noise(Uncertainty) |  | 16-Feature Extraction Algorithm | GRU |  |
| 11 | `VM758RQZ_E130` | `motivates` | 09-Problem Scenario | multiple sensors(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | GRU |  |
| 12 | `VM758RQZ_E131` | `motivates` | 09-Problem Scenario | load fluctuations(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | GRU |  |
| 13 | `VM758RQZ_E132` | `motivates` | 09-Problem Scenario | ambient noise(Uncertainty) |  | 17-Core Classifier Algorithm | Minimum Reconstruction Error |  |
| 14 | `VM758RQZ_E133` | `motivates` | 09-Problem Scenario | multiple sensors(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | Minimum Reconstruction Error |  |
| 15 | `VM758RQZ_E134` | `motivates` | 09-Problem Scenario | load fluctuations(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Minimum Reconstruction Error |  |
| 16 | `VM758RQZ_E135` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | GRU |  |
| 17 | `VM758RQZ_E136` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Minimum Reconstruction Error |  |
| 18 | `VM758RQZ_E137` | `motivates` | 06-Fault Severity | 0.007 mm(Single Severity) |  | 17-Core Classifier Algorithm | Minimum Reconstruction Error |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `VM758RQZ_E120`：ambient noise(Uncertainty) motivates Variant Length Input
  - `VM758RQZ_E121`：multiple sensors(Multi-Source Heterogeneous / Multimodal Data) motivates Variant Length Input
  - `VM758RQZ_E122`：load fluctuations(Distribution Discrepancy) motivates Variant Length Input
  - `VM758RQZ_E126`：ambient noise(Uncertainty) motivates Masking Noise
  - `VM758RQZ_E127`：multiple sensors(Multi-Source Heterogeneous / Multimodal Data) motivates Masking Noise
  - `VM758RQZ_E128`：load fluctuations(Distribution Discrepancy) motivates Masking Noise
  - `VM758RQZ_E129`：ambient noise(Uncertainty) motivates GRU
  - `VM758RQZ_E130`：multiple sensors(Multi-Source Heterogeneous / Multimodal Data) motivates GRU
  - `VM758RQZ_E131`：load fluctuations(Distribution Discrepancy) motivates GRU
  - `VM758RQZ_E132`：ambient noise(Uncertainty) motivates Minimum Reconstruction Error
  - `VM758RQZ_E133`：multiple sensors(Multi-Source Heterogeneous / Multimodal Data) motivates Minimum Reconstruction Error
  - `VM758RQZ_E134`：load fluctuations(Distribution Discrepancy) motivates Minimum Reconstruction Error
