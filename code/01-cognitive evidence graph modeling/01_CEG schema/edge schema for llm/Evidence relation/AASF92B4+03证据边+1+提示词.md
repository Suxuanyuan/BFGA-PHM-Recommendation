...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AASF92B4_E072` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 2 | `AASF92B4_E073` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Principal Component Analysis |  |
| 3 | `AASF92B4_E074` | `motivates` | 09-Problem Scenario | fault detection in continuous and fast-arriving data streams(Other) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 4 | `AASF92B4_E075` | `motivates` | 09-Problem Scenario | fault detection in continuous and fast-arriving data streams(Other) |  | 16-Feature Extraction Algorithm | Principal Component Analysis |  |
| 5 | `AASF92B4_E076` | `motivates` | 09-Problem Scenario | fault detection in continuous and fast-arriving data streams(Other) |  | 17-Core Classifier Algorithm | T2 and Q statistics |  |
| 6 | `AASF92B4_E077` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Principal Component Analysis |  |
| 7 | `AASF92B4_E078` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | T2 and Q statistics |  |
| 8 | `AASF92B4_E079` | `motivates` | 06-Fault Severity | fully clogged, half fully clogged(Multiple Severities) |  | 17-Core Classifier Algorithm | T2 and Q statistics |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `AASF92B4_E074`：fault detection in continuous and fast-arriving data streams(Other) motivates Normalization
  - `AASF92B4_E075`：fault detection in continuous and fast-arriving data streams(Other) motivates Principal Component Analysis
  - `AASF92B4_E076`：fault detection in continuous and fast-arriving data streams(Other) motivates T2 and Q statistics
