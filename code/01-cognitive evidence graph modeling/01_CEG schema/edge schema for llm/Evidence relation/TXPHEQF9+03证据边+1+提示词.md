...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TXPHEQF9_E068` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 2 | `TXPHEQF9_E069` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Balanced Sparse Filtering |  |
| 3 | `TXPHEQF9_E070` | `motivates` | 09-Problem Scenario | class-imbalance problem(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 4 | `TXPHEQF9_E071` | `motivates` | 09-Problem Scenario | class-imbalance problem(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Balanced Sparse Filtering |  |
| 5 | `TXPHEQF9_E072` | `motivates` | 09-Problem Scenario | class-imbalance problem(Small Fault Samples) |  | 17-Core Classifier Algorithm | Balanced Softmax Regression |  |
| 6 | `TXPHEQF9_E073` | `motivates` | 07-Compound Fault | composite fault of the roller and outer race (OFBF)(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Balanced Sparse Filtering |  |
| 7 | `TXPHEQF9_E074` | `motivates` | 07-Compound Fault | composite fault of the roller and outer race (OFBF)(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Balanced Softmax Regression |  |
| 8 | `TXPHEQF9_E075` | `motivates` | 06-Fault Severity | 0.18, 0.36 and 0.54 mm, 0.20 mm(Multiple Severities) |  | 17-Core Classifier Algorithm | Balanced Softmax Regression |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `TXPHEQF9_E070`：class-imbalance problem(Small Fault Samples) motivates Sliding Window
  - `TXPHEQF9_E071`：class-imbalance problem(Small Fault Samples) motivates Balanced Sparse Filtering
  - `TXPHEQF9_E072`：class-imbalance problem(Small Fault Samples) motivates Balanced Softmax Regression
