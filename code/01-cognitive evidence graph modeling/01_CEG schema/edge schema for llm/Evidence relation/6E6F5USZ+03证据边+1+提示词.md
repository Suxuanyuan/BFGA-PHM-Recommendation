...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `6E6F5USZ_E098` | `motivates` | 13-Noise Level | in-band noise, noisy, small signal-to-noise ratio (SNR)(High Noise) |  | 15-Data Preprocessing Algorithm | Cubic spline interpolation |  |
| 2 | `6E6F5USZ_E099` | `motivates` | 13-Noise Level | in-band noise, noisy, small signal-to-noise ratio (SNR)(High Noise) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 3 | `6E6F5USZ_E100` | `motivates` | 09-Problem Scenario | current-aided vibration order tracking(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Cubic spline interpolation |  |
| 4 | `6E6F5USZ_E101` | `motivates` | 09-Problem Scenario | tacholess order tracking without speed sensors(Other) |  | 15-Data Preprocessing Algorithm | Cubic spline interpolation |  |
| 5 | `6E6F5USZ_E102` | `motivates` | 09-Problem Scenario | current-aided vibration order tracking(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 6 | `6E6F5USZ_E103` | `motivates` | 09-Problem Scenario | tacholess order tracking without speed sensors(Other) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 7 | `6E6F5USZ_E104` | `motivates` | 09-Problem Scenario | current-aided vibration order tracking(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | Spectrum peak identification |  |
| 8 | `6E6F5USZ_E105` | `motivates` | 09-Problem Scenario | tacholess order tracking without speed sensors(Other) |  | 17-Core Classifier Algorithm | Spectrum peak identification |  |
| 9 | `6E6F5USZ_E106` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 10 | `6E6F5USZ_E107` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Spectrum peak identification |  |
| 11 | `6E6F5USZ_E108` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Spectrum peak identification |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `6E6F5USZ_E100`：current-aided vibration order tracking(Multi-Source Heterogeneous / Multimodal Data) motivates Cubic spline interpolation
  - `6E6F5USZ_E101`：tacholess order tracking without speed sensors(Other) motivates Cubic spline interpolation
  - `6E6F5USZ_E102`：current-aided vibration order tracking(Multi-Source Heterogeneous / Multimodal Data) motivates Fast Fourier Transform
  - `6E6F5USZ_E103`：tacholess order tracking without speed sensors(Other) motivates Fast Fourier Transform
  - `6E6F5USZ_E104`：current-aided vibration order tracking(Multi-Source Heterogeneous / Multimodal Data) motivates Spectrum peak identification
  - `6E6F5USZ_E105`：tacholess order tracking without speed sensors(Other) motivates Spectrum peak identification
