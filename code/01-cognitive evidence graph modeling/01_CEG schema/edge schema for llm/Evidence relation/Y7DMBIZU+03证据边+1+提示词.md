...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `Y7DMBIZU_E095` | `motivates` | 09-Problem Scenario | small dataset(Small Fault Samples) |  | 19-Training Optimization Algorithm | Transfer learning |  |
| 2 | `Y7DMBIZU_E096` | `motivates` | 09-Problem Scenario | distribution discrepancy(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Transfer learning |  |
| 3 | `Y7DMBIZU_E097` | `motivates` | 12-Training Data Availability | small dataset, 100 samples (each running state has 25 samples)(Scarce) |  | 19-Training Optimization Algorithm | Transfer learning |  |
| 4 | `Y7DMBIZU_E098` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | CNN |  |
| 5 | `Y7DMBIZU_E099` | `motivates` | 09-Problem Scenario | small dataset(Small Fault Samples) |  | 16-Feature Extraction Algorithm | CNN |  |
| 6 | `Y7DMBIZU_E100` | `motivates` | 09-Problem Scenario | distribution discrepancy(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | CNN |  |
| 7 | `Y7DMBIZU_E101` | `motivates` | 09-Problem Scenario | small dataset(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `Y7DMBIZU_E102` | `motivates` | 09-Problem Scenario | distribution discrepancy(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 9 | `Y7DMBIZU_E103` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 10 | `Y7DMBIZU_E104` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `Y7DMBIZU_E105` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `Y7DMBIZU_E095`：small dataset(Small Fault Samples) motivates Transfer learning
  - `Y7DMBIZU_E096`：distribution discrepancy(Distribution Discrepancy) motivates Transfer learning
  - `Y7DMBIZU_E099`：small dataset(Small Fault Samples) motivates CNN
  - `Y7DMBIZU_E100`：distribution discrepancy(Distribution Discrepancy) motivates CNN
  - `Y7DMBIZU_E101`：small dataset(Small Fault Samples) motivates Softmax
  - `Y7DMBIZU_E102`：distribution discrepancy(Distribution Discrepancy) motivates Softmax
