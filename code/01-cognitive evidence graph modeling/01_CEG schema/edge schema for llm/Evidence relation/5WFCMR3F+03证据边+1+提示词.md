...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `5WFCMR3F_E060` | `motivates` | 13-Noise Level | higher environmental noise(High Noise) |  | 16-Feature Extraction Algorithm | Orthogonal Empirical Mode Decomposition |  |
| 2 | `5WFCMR3F_E061` | `motivates` | 09-Problem Scenario | incipient fault detection(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Orthogonal Empirical Mode Decomposition |  |
| 3 | `5WFCMR3F_E062` | `motivates` | 09-Problem Scenario | environmental noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Orthogonal Empirical Mode Decomposition |  |
| 4 | `5WFCMR3F_E063` | `motivates` | 09-Problem Scenario | incipient fault detection(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Fast Fourier Transform |  |
| 5 | `5WFCMR3F_E064` | `motivates` | 09-Problem Scenario | environmental noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Fast Fourier Transform |  |
| 6 | `5WFCMR3F_E065` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Orthogonal Empirical Mode Decomposition |  |
| 7 | `5WFCMR3F_E066` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Fast Fourier Transform |  |
| 8 | `5WFCMR3F_E067` | `motivates` | 06-Fault Severity | 20 μm, 60 μm, 100 μm(Multiple Severities) |  | 17-Core Classifier Algorithm | Fast Fourier Transform |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `5WFCMR3F_E061`：incipient fault detection(Early Degradation Prediction) motivates Orthogonal Empirical Mode Decomposition
  - `5WFCMR3F_E062`：environmental noise robustness(Uncertainty) motivates Orthogonal Empirical Mode Decomposition
  - `5WFCMR3F_E063`：incipient fault detection(Early Degradation Prediction) motivates Fast Fourier Transform
  - `5WFCMR3F_E064`：environmental noise robustness(Uncertainty) motivates Fast Fourier Transform
