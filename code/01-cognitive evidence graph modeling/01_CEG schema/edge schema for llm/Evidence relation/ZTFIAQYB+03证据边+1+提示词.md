...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZTFIAQYB_E111` | `motivates` | 13-Noise Level | white Gaussian noise(High Noise) |  | 16-Feature Extraction Algorithm | Iterative generalized demodulation |  |
| 2 | `ZTFIAQYB_E112` | `motivates` | 09-Problem Scenario | fault feature extraction under time-varying speed conditions(Other) |  | 16-Feature Extraction Algorithm | Iterative generalized demodulation |  |
| 3 | `ZTFIAQYB_E113` | `motivates` | 09-Problem Scenario | complex components and multi-modulations of planetary gearbox(Complex Systems) |  | 16-Feature Extraction Algorithm | Iterative generalized demodulation |  |
| 4 | `ZTFIAQYB_E114` | `motivates` | 09-Problem Scenario | analytical modelling of vibration signals in resonance region(Trustworthiness / Interpretability) |  | 16-Feature Extraction Algorithm | Iterative generalized demodulation |  |
| 5 | `ZTFIAQYB_E115` | `motivates` | 09-Problem Scenario | fault feature extraction under time-varying speed conditions(Other) |  | 17-Core Classifier Algorithm | Sideband analysis |  |
| 6 | `ZTFIAQYB_E116` | `motivates` | 09-Problem Scenario | complex components and multi-modulations of planetary gearbox(Complex Systems) |  | 17-Core Classifier Algorithm | Sideband analysis |  |
| 7 | `ZTFIAQYB_E117` | `motivates` | 09-Problem Scenario | analytical modelling of vibration signals in resonance region(Trustworthiness / Interpretability) |  | 17-Core Classifier Algorithm | Sideband analysis |  |
| 8 | `ZTFIAQYB_E118` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Iterative generalized demodulation |  |
| 9 | `ZTFIAQYB_E119` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Sideband analysis |  |
| 10 | `ZTFIAQYB_E120` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Sideband analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZTFIAQYB_E112`：fault feature extraction under time-varying speed conditions(Other) motivates Iterative generalized demodulation
  - `ZTFIAQYB_E113`：complex components and multi-modulations of planetary gearbox(Complex Systems) motivates Iterative generalized demodulation
  - `ZTFIAQYB_E114`：analytical modelling of vibration signals in resonance region(Trustworthiness / Interpretability) motivates Iterative generalized demodulation
  - `ZTFIAQYB_E115`：fault feature extraction under time-varying speed conditions(Other) motivates Sideband analysis
  - `ZTFIAQYB_E116`：complex components and multi-modulations of planetary gearbox(Complex Systems) motivates Sideband analysis
  - `ZTFIAQYB_E117`：analytical modelling of vibration signals in resonance region(Trustworthiness / Interpretability) motivates Sideband analysis
