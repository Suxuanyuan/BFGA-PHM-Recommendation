...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `II7PRHPY_E079` | `motivates` | 13-Noise Level | environmental noise conditions (SNR = 20 dB, 30 dB, 40 dB)(High Noise) |  | 16-Feature Extraction Algorithm | Principal Component Analysis |  |
| 2 | `II7PRHPY_E080` | `motivates` | 09-Problem Scenario | incipient fault estimation(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Principal Component Analysis |  |
| 3 | `II7PRHPY_E081` | `motivates` | 09-Problem Scenario | environmental noise conditions(Uncertainty) |  | 16-Feature Extraction Algorithm | Principal Component Analysis |  |
| 4 | `II7PRHPY_E082` | `motivates` | 09-Problem Scenario | incipient fault estimation(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Kullback-Leibler Divergence |  |
| 5 | `II7PRHPY_E083` | `motivates` | 09-Problem Scenario | environmental noise conditions(Uncertainty) |  | 17-Core Classifier Algorithm | Kullback-Leibler Divergence |  |
| 6 | `II7PRHPY_E084` | `motivates` | 07-Compound Fault | single fault case(No Compound Fault) |  | 16-Feature Extraction Algorithm | Principal Component Analysis |  |
| 7 | `II7PRHPY_E085` | `motivates` | 07-Compound Fault | single fault case(No Compound Fault) |  | 17-Core Classifier Algorithm | Kullback-Leibler Divergence |  |
| 8 | `II7PRHPY_E086` | `motivates` | 06-Fault Severity | gain fault amplitude(Multiple Severities) |  | 17-Core Classifier Algorithm | Kullback-Leibler Divergence |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `II7PRHPY_E080`：incipient fault estimation(Early Degradation Prediction) motivates Principal Component Analysis
  - `II7PRHPY_E081`：environmental noise conditions(Uncertainty) motivates Principal Component Analysis
  - `II7PRHPY_E082`：incipient fault estimation(Early Degradation Prediction) motivates Kullback-Leibler Divergence
  - `II7PRHPY_E083`：environmental noise conditions(Uncertainty) motivates Kullback-Leibler Divergence
