...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `R5KTTPST_E096` | `motivates` | 09-Problem Scenario | insufficient training data(Small Fault Samples) |  | 19-Training Optimization Algorithm | Elastic Net |  |
| 2 | `R5KTTPST_E097` | `motivates` | 12-Training Data Availability | 3200 signals for the training data in each condition(Sufficient) |  | 19-Training Optimization Algorithm | Elastic Net |  |
| 3 | `R5KTTPST_E098` | `motivates` | 13-Noise Level | corrupted data point / noise level(High Noise) |  | 15-Data Preprocessing Algorithm | Overlapping data reuse |  |
| 4 | `R5KTTPST_E099` | `motivates` | 13-Noise Level | corrupted data point / noise level(High Noise) |  | 16-Feature Extraction Algorithm | Denoising Autoencoder |  |
| 5 | `R5KTTPST_E100` | `motivates` | 09-Problem Scenario | insufficient training data(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Overlapping data reuse |  |
| 6 | `R5KTTPST_E101` | `motivates` | 09-Problem Scenario | insufficient training data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Denoising Autoencoder |  |
| 7 | `R5KTTPST_E102` | `motivates` | 09-Problem Scenario | insufficient training data(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `R5KTTPST_E103` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Denoising Autoencoder |  |
| 9 | `R5KTTPST_E104` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 10 | `R5KTTPST_E105` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `R5KTTPST_E096`：insufficient training data(Small Fault Samples) motivates Elastic Net
  - `R5KTTPST_E100`：insufficient training data(Small Fault Samples) motivates Overlapping data reuse
  - `R5KTTPST_E101`：insufficient training data(Small Fault Samples) motivates Denoising Autoencoder
  - `R5KTTPST_E102`：insufficient training data(Small Fault Samples) motivates Softmax
