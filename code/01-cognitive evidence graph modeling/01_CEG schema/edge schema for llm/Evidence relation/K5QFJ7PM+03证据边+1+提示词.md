...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `K5QFJ7PM_E089` | `motivates` | 12-Training Data Availability | Physics-based observer without historical training data(Sufficient) |  | 18-Data Generation Algorithm | FE-based phase variable model |  |
| 2 | `K5QFJ7PM_E090` | `motivates` | 13-Noise Level | harmonic loads and measurement harmonics(High Noise) |  | 16-Feature Extraction Algorithm | Back EMF Estimator |  |
| 3 | `K5QFJ7PM_E091` | `motivates` | 09-Problem Scenario | Uncertainty and noise robustness(Uncertainty) |  | 18-Data Generation Algorithm | FE-based phase variable model |  |
| 4 | `K5QFJ7PM_E092` | `motivates` | 09-Problem Scenario | Physics-based estimation(Trustworthiness / Interpretability) |  | 18-Data Generation Algorithm | FE-based phase variable model |  |
| 5 | `K5QFJ7PM_E093` | `motivates` | 09-Problem Scenario | Uncertainty and noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Back EMF Estimator |  |
| 6 | `K5QFJ7PM_E094` | `motivates` | 09-Problem Scenario | Physics-based estimation(Trustworthiness / Interpretability) |  | 16-Feature Extraction Algorithm | Back EMF Estimator |  |
| 7 | `K5QFJ7PM_E095` | `motivates` | 09-Problem Scenario | Uncertainty and noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold-based decision method |  |
| 8 | `K5QFJ7PM_E096` | `motivates` | 09-Problem Scenario | Physics-based estimation(Trustworthiness / Interpretability) |  | 17-Core Classifier Algorithm | Threshold-based decision method |  |
| 9 | `K5QFJ7PM_E097` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Back EMF Estimator |  |
| 10 | `K5QFJ7PM_E098` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold-based decision method |  |
| 11 | `K5QFJ7PM_E099` | `motivates` | 06-Fault Severity | Fault severity(Multiple Severities) |  | 17-Core Classifier Algorithm | Threshold-based decision method |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `K5QFJ7PM_E091`：Uncertainty and noise robustness(Uncertainty) motivates FE-based phase variable model
  - `K5QFJ7PM_E092`：Physics-based estimation(Trustworthiness / Interpretability) motivates FE-based phase variable model
  - `K5QFJ7PM_E093`：Uncertainty and noise robustness(Uncertainty) motivates Back EMF Estimator
  - `K5QFJ7PM_E094`：Physics-based estimation(Trustworthiness / Interpretability) motivates Back EMF Estimator
  - `K5QFJ7PM_E095`：Uncertainty and noise robustness(Uncertainty) motivates Threshold-based decision method
  - `K5QFJ7PM_E096`：Physics-based estimation(Trustworthiness / Interpretability) motivates Threshold-based decision method
