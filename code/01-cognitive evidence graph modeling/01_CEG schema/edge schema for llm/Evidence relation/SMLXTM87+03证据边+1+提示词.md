...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SMLXTM87_E091` | `motivates` | 13-Noise Level | masked by strong noise(High Noise) |  | 15-Data Preprocessing Algorithm | Trend spectrum reconstruction |  |
| 2 | `SMLXTM87_E092` | `motivates` | 13-Noise Level | masked by strong noise(High Noise) |  | 16-Feature Extraction Algorithm | Frequency slice wavelet transform |  |
| 3 | `SMLXTM87_E093` | `motivates` | 09-Problem Scenario | vulnerable to noise and random shocks(Uncertainty) |  | 15-Data Preprocessing Algorithm | Trend spectrum reconstruction |  |
| 4 | `SMLXTM87_E094` | `motivates` | 09-Problem Scenario | fixed spectrum segmentation of Fast Kurtogram(Other) |  | 15-Data Preprocessing Algorithm | Trend spectrum reconstruction |  |
| 5 | `SMLXTM87_E095` | `motivates` | 09-Problem Scenario | vulnerable to noise and random shocks(Uncertainty) |  | 16-Feature Extraction Algorithm | Frequency slice wavelet transform |  |
| 6 | `SMLXTM87_E096` | `motivates` | 09-Problem Scenario | fixed spectrum segmentation of Fast Kurtogram(Other) |  | 16-Feature Extraction Algorithm | Frequency slice wavelet transform |  |
| 7 | `SMLXTM87_E097` | `motivates` | 09-Problem Scenario | vulnerable to noise and random shocks(Uncertainty) |  | 17-Core Classifier Algorithm | Correlation spectral negentropy |  |
| 8 | `SMLXTM87_E098` | `motivates` | 09-Problem Scenario | fixed spectrum segmentation of Fast Kurtogram(Other) |  | 17-Core Classifier Algorithm | Correlation spectral negentropy |  |
| 9 | `SMLXTM87_E099` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Frequency slice wavelet transform |  |
| 10 | `SMLXTM87_E100` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Correlation spectral negentropy |  |
| 11 | `SMLXTM87_E101` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Correlation spectral negentropy |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `SMLXTM87_E093`：vulnerable to noise and random shocks(Uncertainty) motivates Trend spectrum reconstruction
  - `SMLXTM87_E094`：fixed spectrum segmentation of Fast Kurtogram(Other) motivates Trend spectrum reconstruction
  - `SMLXTM87_E095`：vulnerable to noise and random shocks(Uncertainty) motivates Frequency slice wavelet transform
  - `SMLXTM87_E096`：fixed spectrum segmentation of Fast Kurtogram(Other) motivates Frequency slice wavelet transform
  - `SMLXTM87_E097`：vulnerable to noise and random shocks(Uncertainty) motivates Correlation spectral negentropy
  - `SMLXTM87_E098`：fixed spectrum segmentation of Fast Kurtogram(Other) motivates Correlation spectral negentropy
