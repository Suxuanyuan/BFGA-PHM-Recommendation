...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `V7PQ6X9P_E092` | `motivates` | 12-Training Data Availability | Sufficient |  | 18-Data Generation Algorithm | Bearing Fault Model |  |
| 2 | `V7PQ6X9P_E093` | `motivates` | 13-Noise Level | strong background noise(High Noise) |  | 15-Data Preprocessing Algorithm | Cyclic Wiener Filter |  |
| 3 | `V7PQ6X9P_E094` | `motivates` | 09-Problem Scenario | compound faults(Compound Faults) |  | 18-Data Generation Algorithm | Bearing Fault Model |  |
| 4 | `V7PQ6X9P_E095` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 18-Data Generation Algorithm | Bearing Fault Model |  |
| 5 | `V7PQ6X9P_E096` | `motivates` | 09-Problem Scenario | compound faults(Compound Faults) |  | 15-Data Preprocessing Algorithm | Cyclic Wiener Filter |  |
| 6 | `V7PQ6X9P_E097` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Cyclic Wiener Filter |  |
| 7 | `V7PQ6X9P_E098` | `motivates` | 09-Problem Scenario | compound faults(Compound Faults) |  | 17-Core Classifier Algorithm | Envelope Demodulation |  |
| 8 | `V7PQ6X9P_E099` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Demodulation |  |
| 9 | `V7PQ6X9P_E100` | `motivates` | 07-Compound Fault | compound faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Envelope Demodulation |  |
| 10 | `V7PQ6X9P_E101` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Envelope Demodulation |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `V7PQ6X9P_E094`：compound faults(Compound Faults) motivates Bearing Fault Model
  - `V7PQ6X9P_E095`：strong background noise(Uncertainty) motivates Bearing Fault Model
  - `V7PQ6X9P_E096`：compound faults(Compound Faults) motivates Cyclic Wiener Filter
  - `V7PQ6X9P_E097`：strong background noise(Uncertainty) motivates Cyclic Wiener Filter
  - `V7PQ6X9P_E098`：compound faults(Compound Faults) motivates Envelope Demodulation
  - `V7PQ6X9P_E099`：strong background noise(Uncertainty) motivates Envelope Demodulation
