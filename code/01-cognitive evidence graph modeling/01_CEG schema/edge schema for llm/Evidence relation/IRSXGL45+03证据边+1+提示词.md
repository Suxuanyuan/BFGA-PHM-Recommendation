...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `IRSXGL45_E138` | `motivates` | 09-Problem Scenario | complete abnormal samples are not needed(Zero Fault Samples) |  | 19-Training Optimization Algorithm | Adaptive law |  |
| 2 | `IRSXGL45_E139` | `motivates` | 09-Problem Scenario | poor balance between coverage rate and overlap rate(Other) |  | 19-Training Optimization Algorithm | Adaptive law |  |
| 3 | `IRSXGL45_E140` | `motivates` | 12-Training Data Availability | training data volume and the test data volume are both 450(Sufficient) |  | 19-Training Optimization Algorithm | Adaptive law |  |
| 4 | `IRSXGL45_E141` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Min-max normalization |  |
| 5 | `IRSXGL45_E142` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Mean and variance |  |
| 6 | `IRSXGL45_E143` | `motivates` | 09-Problem Scenario | complete abnormal samples are not needed(Zero Fault Samples) |  | 15-Data Preprocessing Algorithm | Min-max normalization |  |
| 7 | `IRSXGL45_E144` | `motivates` | 09-Problem Scenario | poor balance between coverage rate and overlap rate(Other) |  | 15-Data Preprocessing Algorithm | Min-max normalization |  |
| 8 | `IRSXGL45_E145` | `motivates` | 09-Problem Scenario | complete abnormal samples are not needed(Zero Fault Samples) |  | 16-Feature Extraction Algorithm | Mean and variance |  |
| 9 | `IRSXGL45_E146` | `motivates` | 09-Problem Scenario | poor balance between coverage rate and overlap rate(Other) |  | 16-Feature Extraction Algorithm | Mean and variance |  |
| 10 | `IRSXGL45_E147` | `motivates` | 09-Problem Scenario | complete abnormal samples are not needed(Zero Fault Samples) |  | 17-Core Classifier Algorithm | Improved Negative Selection Algorithm |  |
| 11 | `IRSXGL45_E148` | `motivates` | 09-Problem Scenario | poor balance between coverage rate and overlap rate(Other) |  | 17-Core Classifier Algorithm | Improved Negative Selection Algorithm |  |
| 12 | `IRSXGL45_E149` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Mean and variance |  |
| 13 | `IRSXGL45_E150` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Improved Negative Selection Algorithm |  |
| 14 | `IRSXGL45_E151` | `motivates` | 06-Fault Severity | leak 50%, actuator fail 50%, sensor fail 20%(Single Severity) |  | 17-Core Classifier Algorithm | Improved Negative Selection Algorithm |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `IRSXGL45_E138`：complete abnormal samples are not needed(Zero Fault Samples) motivates Adaptive law
  - `IRSXGL45_E139`：poor balance between coverage rate and overlap rate(Other) motivates Adaptive law
  - `IRSXGL45_E143`：complete abnormal samples are not needed(Zero Fault Samples) motivates Min-max normalization
  - `IRSXGL45_E144`：poor balance between coverage rate and overlap rate(Other) motivates Min-max normalization
  - `IRSXGL45_E145`：complete abnormal samples are not needed(Zero Fault Samples) motivates Mean and variance
  - `IRSXGL45_E146`：poor balance between coverage rate and overlap rate(Other) motivates Mean and variance
  - `IRSXGL45_E147`：complete abnormal samples are not needed(Zero Fault Samples) motivates Improved Negative Selection Algorithm
  - `IRSXGL45_E148`：poor balance between coverage rate and overlap rate(Other) motivates Improved Negative Selection Algorithm
