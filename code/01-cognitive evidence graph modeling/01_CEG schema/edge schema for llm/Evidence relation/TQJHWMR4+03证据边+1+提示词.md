...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TQJHWMR4_E047` | `motivates` | 09-Problem Scenario | Imperfect channel state information (CSI)(Uncertainty) |  | 19-Training Optimization Algorithm | S-procedure |  |
| 2 | `TQJHWMR4_E048` | `motivates` | 12-Training Data Availability | Simulation parameters(Sufficient) |  | 19-Training Optimization Algorithm | S-procedure |  |
| 3 | `TQJHWMR4_E049` | `motivates` | 13-Noise Level | additive Gaussian white noises, channel uncertainty(High Noise) |  | 16-Feature Extraction Algorithm | SVD |  |
| 4 | `TQJHWMR4_E050` | `motivates` | 09-Problem Scenario | Imperfect channel state information (CSI)(Uncertainty) |  | 16-Feature Extraction Algorithm | SVD |  |
| 5 | `TQJHWMR4_E051` | `motivates` | 09-Problem Scenario | Imperfect channel state information (CSI)(Uncertainty) |  | 17-Core Classifier Algorithm | SDR |  |
| 6 | `TQJHWMR4_E052` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | SVD |  |
| 7 | `TQJHWMR4_E053` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SDR |  |
| 8 | `TQJHWMR4_E054` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | SDR |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `TQJHWMR4_E047`：Imperfect channel state information (CSI)(Uncertainty) motivates S-procedure
  - `TQJHWMR4_E050`：Imperfect channel state information (CSI)(Uncertainty) motivates SVD
  - `TQJHWMR4_E051`：Imperfect channel state information (CSI)(Uncertainty) motivates SDR
