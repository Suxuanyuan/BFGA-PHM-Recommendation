...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `NYEZIYYG_E068` | `motivates` | 13-Noise Level | Gauss noise, strong background noise(High Noise) |  | 15-Data Preprocessing Algorithm | Empirical Mode Decomposition |  |
| 2 | `NYEZIYYG_E069` | `motivates` | 13-Noise Level | Gauss noise, strong background noise(High Noise) |  | 16-Feature Extraction Algorithm | 1.5 Dimension Spectrum |  |
| 3 | `NYEZIYYG_E070` | `motivates` | 09-Problem Scenario | Gaussian noise interference, strong background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Empirical Mode Decomposition |  |
| 4 | `NYEZIYYG_E071` | `motivates` | 09-Problem Scenario | Gaussian noise interference, strong background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | 1.5 Dimension Spectrum |  |
| 5 | `NYEZIYYG_E072` | `motivates` | 09-Problem Scenario | Gaussian noise interference, strong background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Frequency Analysis |  |
| 6 | `NYEZIYYG_E073` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | 1.5 Dimension Spectrum |  |
| 7 | `NYEZIYYG_E074` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Frequency Analysis |  |
| 8 | `NYEZIYYG_E075` | `motivates` | 06-Fault Severity | 0.1 mm width and 3 mm depth(Single Severity) |  | 17-Core Classifier Algorithm | Frequency Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `NYEZIYYG_E070`：Gaussian noise interference, strong background noise(Uncertainty) motivates Empirical Mode Decomposition
  - `NYEZIYYG_E071`：Gaussian noise interference, strong background noise(Uncertainty) motivates 1.5 Dimension Spectrum
  - `NYEZIYYG_E072`：Gaussian noise interference, strong background noise(Uncertainty) motivates Frequency Analysis
