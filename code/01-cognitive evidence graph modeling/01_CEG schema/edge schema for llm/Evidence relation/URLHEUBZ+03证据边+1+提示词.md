...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `URLHEUBZ_E070` | `motivates` | 13-Noise Level | noise, global fault, local fault(High Noise) |  | 16-Feature Extraction Algorithm | ResNet |  |
| 2 | `URLHEUBZ_E071` | `motivates` | 09-Problem Scenario | sensor fault and noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | ResNet |  |
| 3 | `URLHEUBZ_E072` | `motivates` | 09-Problem Scenario | multi-source environmental perception data fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | ResNet |  |
| 4 | `URLHEUBZ_E073` | `motivates` | 09-Problem Scenario | sensor fault and noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | GNMS |  |
| 5 | `URLHEUBZ_E074` | `motivates` | 09-Problem Scenario | multi-source environmental perception data fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | GNMS |  |
| 6 | `URLHEUBZ_E075` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | ResNet |  |
| 7 | `URLHEUBZ_E076` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | GNMS |  |
| 8 | `URLHEUBZ_E077` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | GNMS |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `URLHEUBZ_E071`：sensor fault and noise robustness(Uncertainty) motivates ResNet
  - `URLHEUBZ_E072`：multi-source environmental perception data fusion(Multi-Source Heterogeneous / Multimodal Data) motivates ResNet
  - `URLHEUBZ_E073`：sensor fault and noise robustness(Uncertainty) motivates GNMS
  - `URLHEUBZ_E074`：multi-source environmental perception data fusion(Multi-Source Heterogeneous / Multimodal Data) motivates GNMS
