...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4I789QGT_E073` | `motivates` | 13-Noise Level | mechanical noise sources, ground vibration contamination, background noise(High Noise) |  | 15-Data Preprocessing Algorithm | EEMD |  |
| 2 | `4I789QGT_E074` | `motivates` | 13-Noise Level | mechanical noise sources, ground vibration contamination, background noise(High Noise) |  | 16-Feature Extraction Algorithm | Correlation Analysis |  |
| 3 | `4I789QGT_E075` | `motivates` | 09-Problem Scenario | Signal attenuation and background noise contamination in the tower pathway(Uncertainty) |  | 15-Data Preprocessing Algorithm | EEMD |  |
| 4 | `4I789QGT_E076` | `motivates` | 09-Problem Scenario | Signal attenuation and background noise contamination in the tower pathway(Uncertainty) |  | 16-Feature Extraction Algorithm | Correlation Analysis |  |
| 5 | `4I789QGT_E077` | `motivates` | 09-Problem Scenario | Signal attenuation and background noise contamination in the tower pathway(Uncertainty) |  | 17-Core Classifier Algorithm | Order Analysis |  |
| 6 | `4I789QGT_E078` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Correlation Analysis |  |
| 7 | `4I789QGT_E079` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Order Analysis |  |
| 8 | `4I789QGT_E080` | `motivates` | 06-Fault Severity | RMS(Multiple Severities) |  | 17-Core Classifier Algorithm | Order Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4I789QGT_E075`：Signal attenuation and background noise contamination in the tower pathway(Uncertainty) motivates EEMD
  - `4I789QGT_E076`：Signal attenuation and background noise contamination in the tower pathway(Uncertainty) motivates Correlation Analysis
  - `4I789QGT_E077`：Signal attenuation and background noise contamination in the tower pathway(Uncertainty) motivates Order Analysis
