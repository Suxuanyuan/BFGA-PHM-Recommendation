...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `EK7LGK7M_E087` | `motivates` | 09-Problem Scenario | imbalanced SCADA data(Small Fault Samples) |  | 19-Training Optimization Algorithm | Triplet loss |  |
| 2 | `EK7LGK7M_E088` | `motivates` | 12-Training Data Availability | massive SCADA data(Sufficient) |  | 19-Training Optimization Algorithm | Triplet loss |  |
| 3 | `EK7LGK7M_E089` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | CNN |  |
| 4 | `EK7LGK7M_E090` | `motivates` | 09-Problem Scenario | imbalanced SCADA data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | CNN |  |
| 5 | `EK7LGK7M_E091` | `motivates` | 09-Problem Scenario | imbalanced SCADA data(Small Fault Samples) |  | 17-Core Classifier Algorithm | kNN |  |
| 6 | `EK7LGK7M_E092` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 7 | `EK7LGK7M_E093` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | kNN |  |
| 8 | `EK7LGK7M_E094` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | kNN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `EK7LGK7M_E087`：imbalanced SCADA data(Small Fault Samples) motivates Triplet loss
  - `EK7LGK7M_E090`：imbalanced SCADA data(Small Fault Samples) motivates CNN
  - `EK7LGK7M_E091`：imbalanced SCADA data(Small Fault Samples) motivates kNN
