...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `7JEYIN5K_E097` | `motivates` | 09-Problem Scenario | environmental noise interference and strong background noise(Uncertainty) |  | 19-Training Optimization Algorithm | WOA |  |
| 2 | `7JEYIN5K_E098` | `motivates` | 12-Training Data Availability | N/A(Sufficient) |  | 19-Training Optimization Algorithm | WOA |  |
| 3 | `7JEYIN5K_E099` | `motivates` | 13-Noise Level | environmental noise interference, strong background noise(High Noise) |  | 15-Data Preprocessing Algorithm | VMD |  |
| 4 | `7JEYIN5K_E100` | `motivates` | 13-Noise Level | environmental noise interference, strong background noise(High Noise) |  | 16-Feature Extraction Algorithm | MOMEDA |  |
| 5 | `7JEYIN5K_E101` | `motivates` | 09-Problem Scenario | environmental noise interference and strong background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | VMD |  |
| 6 | `7JEYIN5K_E102` | `motivates` | 09-Problem Scenario | environmental noise interference and strong background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | MOMEDA |  |
| 7 | `7JEYIN5K_E103` | `motivates` | 09-Problem Scenario | environmental noise interference and strong background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Spectrum |  |
| 8 | `7JEYIN5K_E104` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | MOMEDA |  |
| 9 | `7JEYIN5K_E105` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope Spectrum |  |
| 10 | `7JEYIN5K_E106` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Envelope Spectrum |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `7JEYIN5K_E097`：environmental noise interference and strong background noise(Uncertainty) motivates WOA
  - `7JEYIN5K_E101`：environmental noise interference and strong background noise(Uncertainty) motivates VMD
  - `7JEYIN5K_E102`：environmental noise interference and strong background noise(Uncertainty) motivates MOMEDA
  - `7JEYIN5K_E103`：environmental noise interference and strong background noise(Uncertainty) motivates Envelope Spectrum
