...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `EU3PTEPM_E084` | `motivates` | 13-Noise Level | measurement noise, undesired perturbations(High Noise) |  | 15-Data Preprocessing Algorithm | Low-Pass Filter |  |
| 2 | `EU3PTEPM_E085` | `motivates` | 13-Noise Level | measurement noise, undesired perturbations(High Noise) |  | 16-Feature Extraction Algorithm | State Observer |  |
| 3 | `EU3PTEPM_E086` | `motivates` | 09-Problem Scenario | parameter variations and external disturbances(Uncertainty) |  | 15-Data Preprocessing Algorithm | Low-Pass Filter |  |
| 4 | `EU3PTEPM_E087` | `motivates` | 09-Problem Scenario | incipient interturn short-circuit fault(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Low-Pass Filter |  |
| 5 | `EU3PTEPM_E088` | `motivates` | 09-Problem Scenario | parameter variations and external disturbances(Uncertainty) |  | 16-Feature Extraction Algorithm | State Observer |  |
| 6 | `EU3PTEPM_E089` | `motivates` | 09-Problem Scenario | incipient interturn short-circuit fault(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | State Observer |  |
| 7 | `EU3PTEPM_E090` | `motivates` | 09-Problem Scenario | parameter variations and external disturbances(Uncertainty) |  | 17-Core Classifier Algorithm | Thresholding |  |
| 8 | `EU3PTEPM_E091` | `motivates` | 09-Problem Scenario | incipient interturn short-circuit fault(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Thresholding |  |
| 9 | `EU3PTEPM_E092` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | State Observer |  |
| 10 | `EU3PTEPM_E093` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Thresholding |  |
| 11 | `EU3PTEPM_E094` | `motivates` | 06-Fault Severity | 1st, 3rd, 5th and 10th turns(Multiple Severities) |  | 17-Core Classifier Algorithm | Thresholding |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `EU3PTEPM_E086`：parameter variations and external disturbances(Uncertainty) motivates Low-Pass Filter
  - `EU3PTEPM_E087`：incipient interturn short-circuit fault(Early Degradation Prediction) motivates Low-Pass Filter
  - `EU3PTEPM_E088`：parameter variations and external disturbances(Uncertainty) motivates State Observer
  - `EU3PTEPM_E089`：incipient interturn short-circuit fault(Early Degradation Prediction) motivates State Observer
  - `EU3PTEPM_E090`：parameter variations and external disturbances(Uncertainty) motivates Thresholding
  - `EU3PTEPM_E091`：incipient interturn short-circuit fault(Early Degradation Prediction) motivates Thresholding
