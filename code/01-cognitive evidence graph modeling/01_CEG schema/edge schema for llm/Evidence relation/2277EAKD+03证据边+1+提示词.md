...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `2277EAKD_E072` | `motivates` | 13-Noise Level | outliers(Normal) |  | 15-Data Preprocessing Algorithm | OSC |  |
| 2 | `2277EAKD_E073` | `motivates` | 09-Problem Scenario | outliers, contaminated data(Uncertainty) |  | 15-Data Preprocessing Algorithm | OSC |  |
| 3 | `2277EAKD_E074` | `motivates` | 09-Problem Scenario | insufficient data, scale of training sets(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | OSC |  |
| 4 | `2277EAKD_E075` | `motivates` | 09-Problem Scenario | key-performance-indicator (KPI) oriented prognosis and diagnosis(Other) |  | 15-Data Preprocessing Algorithm | OSC |  |
| 5 | `2277EAKD_E076` | `motivates` | 09-Problem Scenario | outliers, contaminated data(Uncertainty) |  | 17-Core Classifier Algorithm | MPLS |  |
| 6 | `2277EAKD_E077` | `motivates` | 09-Problem Scenario | insufficient data, scale of training sets(Small Fault Samples) |  | 17-Core Classifier Algorithm | MPLS |  |
| 7 | `2277EAKD_E078` | `motivates` | 09-Problem Scenario | key-performance-indicator (KPI) oriented prognosis and diagnosis(Other) |  | 17-Core Classifier Algorithm | MPLS |  |
| 8 | `2277EAKD_E079` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | MPLS |  |
| 9 | `2277EAKD_E080` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | MPLS |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `2277EAKD_E073`：outliers, contaminated data(Uncertainty) motivates OSC
  - `2277EAKD_E074`：insufficient data, scale of training sets(Small Fault Samples) motivates OSC
  - `2277EAKD_E075`：key-performance-indicator (KPI) oriented prognosis and diagnosis(Other) motivates OSC
  - `2277EAKD_E076`：outliers, contaminated data(Uncertainty) motivates MPLS
  - `2277EAKD_E077`：insufficient data, scale of training sets(Small Fault Samples) motivates MPLS
  - `2277EAKD_E078`：key-performance-indicator (KPI) oriented prognosis and diagnosis(Other) motivates MPLS
