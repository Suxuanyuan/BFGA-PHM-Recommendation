...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `NWK3MZIS_E102` | `motivates` | 13-Noise Level | ambient EMI, disturbing noise(High Noise) |  | 15-Data Preprocessing Algorithm | Band-pass Filter |  |
| 2 | `NWK3MZIS_E103` | `motivates` | 13-Noise Level | ambient EMI, disturbing noise(High Noise) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 3 | `NWK3MZIS_E104` | `motivates` | 09-Problem Scenario | multiple open-circuit faults(Compound Faults) |  | 15-Data Preprocessing Algorithm | Band-pass Filter |  |
| 4 | `NWK3MZIS_E105` | `motivates` | 09-Problem Scenario | noise robustness and parameter sensitivity(Uncertainty) |  | 15-Data Preprocessing Algorithm | Band-pass Filter |  |
| 5 | `NWK3MZIS_E106` | `motivates` | 09-Problem Scenario | multiple open-circuit faults(Compound Faults) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 6 | `NWK3MZIS_E107` | `motivates` | 09-Problem Scenario | noise robustness and parameter sensitivity(Uncertainty) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 7 | `NWK3MZIS_E108` | `motivates` | 09-Problem Scenario | multiple open-circuit faults(Compound Faults) |  | 17-Core Classifier Algorithm | Thresholding Decision |  |
| 8 | `NWK3MZIS_E109` | `motivates` | 09-Problem Scenario | noise robustness and parameter sensitivity(Uncertainty) |  | 17-Core Classifier Algorithm | Thresholding Decision |  |
| 9 | `NWK3MZIS_E110` | `motivates` | 07-Compound Fault | multiple open-circuit faults(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 10 | `NWK3MZIS_E111` | `motivates` | 07-Compound Fault | multiple open-circuit faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Thresholding Decision |  |
| 11 | `NWK3MZIS_E112` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Thresholding Decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `NWK3MZIS_E104`：multiple open-circuit faults(Compound Faults) motivates Band-pass Filter
  - `NWK3MZIS_E105`：noise robustness and parameter sensitivity(Uncertainty) motivates Band-pass Filter
  - `NWK3MZIS_E106`：multiple open-circuit faults(Compound Faults) motivates Fast Fourier Transform
  - `NWK3MZIS_E107`：noise robustness and parameter sensitivity(Uncertainty) motivates Fast Fourier Transform
  - `NWK3MZIS_E108`：multiple open-circuit faults(Compound Faults) motivates Thresholding Decision
  - `NWK3MZIS_E109`：noise robustness and parameter sensitivity(Uncertainty) motivates Thresholding Decision
