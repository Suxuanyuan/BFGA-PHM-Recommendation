...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TJTG289F_E060` | `motivates` | 13-Noise Level | measurement noise(High Noise) |  | 16-Feature Extraction Algorithm | PCA |  |
| 2 | `TJTG289F_E061` | `motivates` | 09-Problem Scenario | system uncertainty and measurement noise(Uncertainty) |  | 16-Feature Extraction Algorithm | PCA |  |
| 3 | `TJTG289F_E062` | `motivates` | 09-Problem Scenario | simultaneous sensor selection and active test input design(Other) |  | 16-Feature Extraction Algorithm | PCA |  |
| 4 | `TJTG289F_E063` | `motivates` | 09-Problem Scenario | system uncertainty and measurement noise(Uncertainty) |  | 17-Core Classifier Algorithm | k-NN |  |
| 5 | `TJTG289F_E064` | `motivates` | 09-Problem Scenario | simultaneous sensor selection and active test input design(Other) |  | 17-Core Classifier Algorithm | k-NN |  |
| 6 | `TJTG289F_E065` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | PCA |  |
| 7 | `TJTG289F_E066` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | k-NN |  |
| 8 | `TJTG289F_E067` | `motivates` | 06-Fault Severity | leak radii (2.0 mm)(Single Severity) |  | 17-Core Classifier Algorithm | k-NN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `TJTG289F_E061`：system uncertainty and measurement noise(Uncertainty) motivates PCA
  - `TJTG289F_E062`：simultaneous sensor selection and active test input design(Other) motivates PCA
  - `TJTG289F_E063`：system uncertainty and measurement noise(Uncertainty) motivates k-NN
  - `TJTG289F_E064`：simultaneous sensor selection and active test input design(Other) motivates k-NN
