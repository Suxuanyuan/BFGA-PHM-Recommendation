...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `Q5Q5DRPF_E113` | `motivates` | 09-Problem Scenario | small number of samples in some modes(Small Fault Samples) |  | 19-Training Optimization Algorithm | One-Class Transfer Learning |  |
| 2 | `Q5Q5DRPF_E114` | `motivates` | 09-Problem Scenario | one-class transfer learning across modes(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | One-Class Transfer Learning |  |
| 3 | `Q5Q5DRPF_E115` | `motivates` | 12-Training Data Availability | there are only a small number of samples in some modes(Scarce) |  | 19-Training Optimization Algorithm | One-Class Transfer Learning |  |
| 4 | `Q5Q5DRPF_E116` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 5 | `Q5Q5DRPF_E117` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Deep Autoencoder |  |
| 6 | `Q5Q5DRPF_E118` | `motivates` | 09-Problem Scenario | small number of samples in some modes(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 7 | `Q5Q5DRPF_E119` | `motivates` | 09-Problem Scenario | one-class transfer learning across modes(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 8 | `Q5Q5DRPF_E120` | `motivates` | 09-Problem Scenario | small number of samples in some modes(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Deep Autoencoder |  |
| 9 | `Q5Q5DRPF_E121` | `motivates` | 09-Problem Scenario | one-class transfer learning across modes(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Deep Autoencoder |  |
| 10 | `Q5Q5DRPF_E122` | `motivates` | 09-Problem Scenario | small number of samples in some modes(Small Fault Samples) |  | 17-Core Classifier Algorithm | Deep Autoencoder |  |
| 11 | `Q5Q5DRPF_E123` | `motivates` | 09-Problem Scenario | one-class transfer learning across modes(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Deep Autoencoder |  |
| 12 | `Q5Q5DRPF_E124` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Deep Autoencoder |  |
| 13 | `Q5Q5DRPF_E125` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Deep Autoencoder |  |
| 14 | `Q5Q5DRPF_E126` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Deep Autoencoder |  |
| 15 | `Q5TW9R27_E064` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Time-domain Statistical Feature Extraction |  |
| 16 | `Q5TW9R27_E065` | `motivates` | 09-Problem Scenario | handle uncertainties(Uncertainty) |  | 16-Feature Extraction Algorithm | Time-domain Statistical Feature Extraction |  |
| 17 | `Q5TW9R27_E066` | `motivates` | 09-Problem Scenario | black box learning method cannot expose input-output relationships(Trustworthiness / Interpretability) |  | 16-Feature Extraction Algorithm | Time-domain Statistical Feature Extraction |  |
| 18 | `Q5TW9R27_E067` | `motivates` | 09-Problem Scenario | handle uncertainties(Uncertainty) |  | 17-Core Classifier Algorithm | ANFIS |  |
| 19 | `Q5TW9R27_E068` | `motivates` | 09-Problem Scenario | black box learning method cannot expose input-output relationships(Trustworthiness / Interpretability) |  | 17-Core Classifier Algorithm | ANFIS |  |
| 20 | `Q5TW9R27_E069` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Time-domain Statistical Feature Extraction |  |
| 21 | `Q5TW9R27_E070` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | ANFIS |  |
| 22 | `Q5TW9R27_E071` | `motivates` | 06-Fault Severity | 0.15 mm, 0.5 mm, and 0.9 mm diameter(Multiple Severities) |  | 17-Core Classifier Algorithm | ANFIS |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `Q5Q5DRPF_E113`：small number of samples in some modes(Small Fault Samples) motivates One-Class Transfer Learning
  - `Q5Q5DRPF_E114`：one-class transfer learning across modes(Distribution Discrepancy) motivates One-Class Transfer Learning
  - `Q5Q5DRPF_E118`：small number of samples in some modes(Small Fault Samples) motivates Min-Max Normalization
  - `Q5Q5DRPF_E119`：one-class transfer learning across modes(Distribution Discrepancy) motivates Min-Max Normalization
  - `Q5Q5DRPF_E120`：small number of samples in some modes(Small Fault Samples) motivates Deep Autoencoder
  - `Q5Q5DRPF_E121`：one-class transfer learning across modes(Distribution Discrepancy) motivates Deep Autoencoder
  - `Q5Q5DRPF_E122`：small number of samples in some modes(Small Fault Samples) motivates Deep Autoencoder
  - `Q5Q5DRPF_E123`：one-class transfer learning across modes(Distribution Discrepancy) motivates Deep Autoencoder
  - `Q5TW9R27_E065`：handle uncertainties(Uncertainty) motivates Time-domain Statistical Feature Extraction
  - `Q5TW9R27_E066`：black box learning method cannot expose input-output relationships(Trustworthiness / Interpretability) motivates Time-domain Statistical Feature Extraction
  - `Q5TW9R27_E067`：handle uncertainties(Uncertainty) motivates ANFIS
  - `Q5TW9R27_E068`：black box learning method cannot expose input-output relationships(Trustworthiness / Interpretability) motivates ANFIS
