...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AKECDSKQ_E092` | `motivates` | 09-Problem Scenario | outliers in the training dataset(Uncertainty) |  | 19-Training Optimization Algorithm | Iterative re-weighted PLS |  |
| 2 | `AKECDSKQ_E093` | `motivates` | 09-Problem Scenario | distinguish quality-related faults from quality-unrelated ones(Other) |  | 19-Training Optimization Algorithm | Iterative re-weighted PLS |  |
| 3 | `AKECDSKQ_E094` | `motivates` | 12-Training Data Availability | 1000 samples to construct training model(Sufficient) |  | 19-Training Optimization Algorithm | Iterative re-weighted PLS |  |
| 4 | `AKECDSKQ_E095` | `motivates` | 13-Noise Level | outliers, measurement error(High Noise) |  | 15-Data Preprocessing Algorithm | tSL-Center |  |
| 5 | `AKECDSKQ_E096` | `motivates` | 13-Noise Level | outliers, measurement error(High Noise) |  | 16-Feature Extraction Algorithm | SVD |  |
| 6 | `AKECDSKQ_E097` | `motivates` | 09-Problem Scenario | outliers in the training dataset(Uncertainty) |  | 15-Data Preprocessing Algorithm | tSL-Center |  |
| 7 | `AKECDSKQ_E098` | `motivates` | 09-Problem Scenario | distinguish quality-related faults from quality-unrelated ones(Other) |  | 15-Data Preprocessing Algorithm | tSL-Center |  |
| 8 | `AKECDSKQ_E099` | `motivates` | 09-Problem Scenario | outliers in the training dataset(Uncertainty) |  | 16-Feature Extraction Algorithm | SVD |  |
| 9 | `AKECDSKQ_E100` | `motivates` | 09-Problem Scenario | distinguish quality-related faults from quality-unrelated ones(Other) |  | 16-Feature Extraction Algorithm | SVD |  |
| 10 | `AKECDSKQ_E101` | `motivates` | 09-Problem Scenario | outliers in the training dataset(Uncertainty) |  | 17-Core Classifier Algorithm | MPRM |  |
| 11 | `AKECDSKQ_E102` | `motivates` | 09-Problem Scenario | distinguish quality-related faults from quality-unrelated ones(Other) |  | 17-Core Classifier Algorithm | MPRM |  |
| 12 | `AKECDSKQ_E103` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | SVD |  |
| 13 | `AKECDSKQ_E104` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | MPRM |  |
| 14 | `AKECDSKQ_E105` | `motivates` | 06-Fault Severity | f=6, f=8(Single Severity) |  | 17-Core Classifier Algorithm | MPRM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `AKECDSKQ_E092`：outliers in the training dataset(Uncertainty) motivates Iterative re-weighted PLS
  - `AKECDSKQ_E093`：distinguish quality-related faults from quality-unrelated ones(Other) motivates Iterative re-weighted PLS
  - `AKECDSKQ_E097`：outliers in the training dataset(Uncertainty) motivates tSL-Center
  - `AKECDSKQ_E098`：distinguish quality-related faults from quality-unrelated ones(Other) motivates tSL-Center
  - `AKECDSKQ_E099`：outliers in the training dataset(Uncertainty) motivates SVD
  - `AKECDSKQ_E100`：distinguish quality-related faults from quality-unrelated ones(Other) motivates SVD
  - `AKECDSKQ_E101`：outliers in the training dataset(Uncertainty) motivates MPRM
  - `AKECDSKQ_E102`：distinguish quality-related faults from quality-unrelated ones(Other) motivates MPRM
