...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `MTPHQCRR_E114` | `motivates` | 13-Noise Level | strong background noise(High Noise) |  | 15-Data Preprocessing Algorithm | PSR |  |
| 2 | `MTPHQCRR_E115` | `motivates` | 13-Noise Level | strong background noise(High Noise) |  | 16-Feature Extraction Algorithm | LTSA |  |
| 3 | `MTPHQCRR_E116` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | PSR |  |
| 4 | `MTPHQCRR_E117` | `motivates` | 09-Problem Scenario | high-dimensional feature redundancy and nonlinearity(Other) |  | 15-Data Preprocessing Algorithm | PSR |  |
| 5 | `MTPHQCRR_E118` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | LTSA |  |
| 6 | `MTPHQCRR_E119` | `motivates` | 09-Problem Scenario | high-dimensional feature redundancy and nonlinearity(Other) |  | 16-Feature Extraction Algorithm | LTSA |  |
| 7 | `MTPHQCRR_E120` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Perceptron |  |
| 8 | `MTPHQCRR_E121` | `motivates` | 09-Problem Scenario | high-dimensional feature redundancy and nonlinearity(Other) |  | 17-Core Classifier Algorithm | Perceptron |  |
| 9 | `MTPHQCRR_E122` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | LTSA |  |
| 10 | `MTPHQCRR_E123` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Perceptron |  |
| 11 | `MTPHQCRR_E124` | `motivates` | 06-Fault Severity | defect size(Multiple Severities) |  | 17-Core Classifier Algorithm | Perceptron |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `MTPHQCRR_E116`：noise robustness(Uncertainty) motivates PSR
  - `MTPHQCRR_E117`：high-dimensional feature redundancy and nonlinearity(Other) motivates PSR
  - `MTPHQCRR_E118`：noise robustness(Uncertainty) motivates LTSA
  - `MTPHQCRR_E119`：high-dimensional feature redundancy and nonlinearity(Other) motivates LTSA
  - `MTPHQCRR_E120`：noise robustness(Uncertainty) motivates Perceptron
  - `MTPHQCRR_E121`：high-dimensional feature redundancy and nonlinearity(Other) motivates Perceptron
