...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `FCSN67SF_E098` | `motivates` | 13-Noise Level | N/A(Normal) |  | 15-Data Preprocessing Algorithm | Stable Filter |  |
| 2 | `FCSN67SF_E099` | `motivates` | 09-Problem Scenario | sensor malfunctioning mitigation(Other) |  | 15-Data Preprocessing Algorithm | Stable Filter |  |
| 3 | `FCSN67SF_E100` | `motivates` | 09-Problem Scenario | unknown but bounded measurement errors(Uncertainty) |  | 15-Data Preprocessing Algorithm | Stable Filter |  |
| 4 | `FCSN67SF_E101` | `motivates` | 09-Problem Scenario | sensor malfunctioning mitigation(Other) |  | 17-Core Classifier Algorithm | Sliding Mode Observer |  |
| 5 | `FCSN67SF_E102` | `motivates` | 09-Problem Scenario | unknown but bounded measurement errors(Uncertainty) |  | 17-Core Classifier Algorithm | Sliding Mode Observer |  |
| 6 | `FCSN67SF_E103` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Sliding Mode Observer |  |
| 7 | `FCSN67SF_E104` | `motivates` | 06-Fault Severity | loss of sensor and bias faults with amplitudes: 1.0, 0.8, 1.95, 0.45, 0.9(Multiple Severities) |  | 17-Core Classifier Algorithm | Sliding Mode Observer |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `FCSN67SF_E099`：sensor malfunctioning mitigation(Other) motivates Stable Filter
  - `FCSN67SF_E100`：unknown but bounded measurement errors(Uncertainty) motivates Stable Filter
  - `FCSN67SF_E101`：sensor malfunctioning mitigation(Other) motivates Sliding Mode Observer
  - `FCSN67SF_E102`：unknown but bounded measurement errors(Uncertainty) motivates Sliding Mode Observer
