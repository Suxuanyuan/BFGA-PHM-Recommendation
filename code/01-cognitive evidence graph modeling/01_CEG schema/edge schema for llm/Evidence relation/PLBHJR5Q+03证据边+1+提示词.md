...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PLBHJR5Q_E155` | `motivates` | 09-Problem Scenario | imbalanced data(Small Fault Samples) |  | 19-Training Optimization Algorithm | Ensemble Learning |  |
| 2 | `PLBHJR5Q_E156` | `motivates` | 09-Problem Scenario | noise disturbance(Uncertainty) |  | 19-Training Optimization Algorithm | Ensemble Learning |  |
| 3 | `PLBHJR5Q_E157` | `motivates` | 12-Training Data Availability | 1000 samples for normal state, 100 to 1000 samples for each fault state(Sufficient) |  | 18-Data Generation Algorithm | Simulink |  |
| 4 | `PLBHJR5Q_E158` | `motivates` | 12-Training Data Availability | 1000 samples for normal state, 100 to 1000 samples for each fault state(Sufficient) |  | 19-Training Optimization Algorithm | Ensemble Learning |  |
| 5 | `PLBHJR5Q_E159` | `motivates` | 13-Noise Level | random noise, signal-to-noise ratios of 65 dB to 40 dB(High Noise) |  | 15-Data Preprocessing Algorithm | Residual Analysis |  |
| 6 | `PLBHJR5Q_E160` | `motivates` | 13-Noise Level | random noise, signal-to-noise ratios of 65 dB to 40 dB(High Noise) |  | 16-Feature Extraction Algorithm | ELM-AE |  |
| 7 | `PLBHJR5Q_E161` | `motivates` | 09-Problem Scenario | imbalanced data(Small Fault Samples) |  | 18-Data Generation Algorithm | Simulink |  |
| 8 | `PLBHJR5Q_E162` | `motivates` | 09-Problem Scenario | noise disturbance(Uncertainty) |  | 18-Data Generation Algorithm | Simulink |  |
| 9 | `PLBHJR5Q_E163` | `motivates` | 09-Problem Scenario | imbalanced data(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Residual Analysis |  |
| 10 | `PLBHJR5Q_E164` | `motivates` | 09-Problem Scenario | noise disturbance(Uncertainty) |  | 15-Data Preprocessing Algorithm | Residual Analysis |  |
| 11 | `PLBHJR5Q_E165` | `motivates` | 09-Problem Scenario | imbalanced data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | ELM-AE |  |
| 12 | `PLBHJR5Q_E166` | `motivates` | 09-Problem Scenario | noise disturbance(Uncertainty) |  | 16-Feature Extraction Algorithm | ELM-AE |  |
| 13 | `PLBHJR5Q_E167` | `motivates` | 09-Problem Scenario | imbalanced data(Small Fault Samples) |  | 17-Core Classifier Algorithm | DELM-AE |  |
| 14 | `PLBHJR5Q_E168` | `motivates` | 09-Problem Scenario | noise disturbance(Uncertainty) |  | 17-Core Classifier Algorithm | DELM-AE |  |
| 15 | `PLBHJR5Q_E169` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | ELM-AE |  |
| 16 | `PLBHJR5Q_E170` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | DELM-AE |  |
| 17 | `PLBHJR5Q_E171` | `motivates` | 06-Fault Severity | fault magnitude(Multiple Severities) |  | 17-Core Classifier Algorithm | DELM-AE |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `PLBHJR5Q_E155`：imbalanced data(Small Fault Samples) motivates Ensemble Learning
  - `PLBHJR5Q_E156`：noise disturbance(Uncertainty) motivates Ensemble Learning
  - `PLBHJR5Q_E161`：imbalanced data(Small Fault Samples) motivates Simulink
  - `PLBHJR5Q_E162`：noise disturbance(Uncertainty) motivates Simulink
  - `PLBHJR5Q_E163`：imbalanced data(Small Fault Samples) motivates Residual Analysis
  - `PLBHJR5Q_E164`：noise disturbance(Uncertainty) motivates Residual Analysis
  - `PLBHJR5Q_E165`：imbalanced data(Small Fault Samples) motivates ELM-AE
  - `PLBHJR5Q_E166`：noise disturbance(Uncertainty) motivates ELM-AE
  - `PLBHJR5Q_E167`：imbalanced data(Small Fault Samples) motivates DELM-AE
  - `PLBHJR5Q_E168`：noise disturbance(Uncertainty) motivates DELM-AE
