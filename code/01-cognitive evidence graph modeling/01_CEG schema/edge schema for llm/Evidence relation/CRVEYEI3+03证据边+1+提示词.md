...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CRVEYEI3_E092` | `motivates` | 13-Noise Level | Gaussian noise, measurement noise(High Noise) |  | 15-Data Preprocessing Algorithm | TS-MDU |  |
| 2 | `CRVEYEI3_E093` | `motivates` | 13-Noise Level | Gaussian noise, measurement noise(High Noise) |  | 16-Feature Extraction Algorithm | DGKSFA |  |
| 3 | `CRVEYEI3_E094` | `motivates` | 09-Problem Scenario | relation between original variables and final models is lost in kernel space(Trustworthiness / Interpretability) |  | 15-Data Preprocessing Algorithm | TS-MDU |  |
| 4 | `CRVEYEI3_E095` | `motivates` | 09-Problem Scenario | relation between original variables and final models is lost in kernel space(Trustworthiness / Interpretability) |  | 16-Feature Extraction Algorithm | DGKSFA |  |
| 5 | `CRVEYEI3_E096` | `motivates` | 09-Problem Scenario | relation between original variables and final models is lost in kernel space(Trustworthiness / Interpretability) |  | 17-Core Classifier Algorithm | KDE |  |
| 6 | `CRVEYEI3_E097` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | DGKSFA |  |
| 7 | `CRVEYEI3_E098` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | KDE |  |
| 8 | `CRVEYEI3_E099` | `motivates` | 06-Fault Severity | step change (+10%), ramp change (+1, +3, +0.004)(Single Severity) |  | 17-Core Classifier Algorithm | KDE |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `CRVEYEI3_E094`：relation between original variables and final models is lost in kernel space(Trustworthiness / Interpretability) motivates TS-MDU
  - `CRVEYEI3_E095`：relation between original variables and final models is lost in kernel space(Trustworthiness / Interpretability) motivates DGKSFA
  - `CRVEYEI3_E096`：relation between original variables and final models is lost in kernel space(Trustworthiness / Interpretability) motivates KDE
