...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZYTILS4E_E131` | `motivates` | 09-Problem Scenario | shift variant properties and feature similarity in raw signals(Other) |  | 19-Training Optimization Algorithm | Fine-tuning |  |
| 2 | `ZYTILS4E_E132` | `motivates` | 12-Training Data Availability | 25% of samples are randomly selected for training(Sufficient) |  | 19-Training Optimization Algorithm | Fine-tuning |  |
| 3 | `ZYTILS4E_E133` | `motivates` | 13-Noise Level | random noise(Normal) |  | 15-Data Preprocessing Algorithm | Whitening |  |
| 4 | `ZYTILS4E_E134` | `motivates` | 13-Noise Level | random noise(Normal) |  | 16-Feature Extraction Algorithm | NSAE |  |
| 5 | `ZYTILS4E_E135` | `motivates` | 09-Problem Scenario | shift variant properties and feature similarity in raw signals(Other) |  | 15-Data Preprocessing Algorithm | Whitening |  |
| 6 | `ZYTILS4E_E136` | `motivates` | 09-Problem Scenario | shift variant properties and feature similarity in raw signals(Other) |  | 16-Feature Extraction Algorithm | NSAE |  |
| 7 | `ZYTILS4E_E137` | `motivates` | 09-Problem Scenario | shift variant properties and feature similarity in raw signals(Other) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `ZYTILS4E_E138` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | NSAE |  |
| 9 | `ZYTILS4E_E139` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 10 | `ZYTILS4E_E140` | `motivates` | 06-Fault Severity | three different severity levels (0.18, 0.36, and 0.53 mm)(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZYTILS4E_E131`：shift variant properties and feature similarity in raw signals(Other) motivates Fine-tuning
  - `ZYTILS4E_E135`：shift variant properties and feature similarity in raw signals(Other) motivates Whitening
  - `ZYTILS4E_E136`：shift variant properties and feature similarity in raw signals(Other) motivates NSAE
  - `ZYTILS4E_E137`：shift variant properties and feature similarity in raw signals(Other) motivates Softmax
