...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PMCDMLT3_E169` | `motivates` | 09-Problem Scenario | unknown class recognition(Zero Fault Samples) |  | 19-Training Optimization Algorithm | Fine-tune |  |
| 2 | `PMCDMLT3_E170` | `motivates` | 09-Problem Scenario | sample imbalance of the new class during model self-learning(Small Fault Samples) |  | 19-Training Optimization Algorithm | Fine-tune |  |
| 3 | `PMCDMLT3_E171` | `motivates` | 12-Training Data Availability | Dataset A to E: 588 or 1000 samples per condition(Sufficient) |  | 19-Training Optimization Algorithm | Fine-tune |  |
| 4 | `PMCDMLT3_E172` | `motivates` | 13-Noise Level | Gaussian noise is added to the testing set to verify the robustness of each method(High Noise) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 5 | `PMCDMLT3_E173` | `motivates` | 13-Noise Level | Gaussian noise is added to the testing set to verify the robustness of each method(High Noise) |  | 16-Feature Extraction Algorithm | CNN |  |
| 6 | `PMCDMLT3_E174` | `motivates` | 09-Problem Scenario | unknown class recognition(Zero Fault Samples) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 7 | `PMCDMLT3_E175` | `motivates` | 09-Problem Scenario | sample imbalance of the new class during model self-learning(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 8 | `PMCDMLT3_E176` | `motivates` | 09-Problem Scenario | unknown class recognition(Zero Fault Samples) |  | 16-Feature Extraction Algorithm | CNN |  |
| 9 | `PMCDMLT3_E177` | `motivates` | 09-Problem Scenario | sample imbalance of the new class during model self-learning(Small Fault Samples) |  | 16-Feature Extraction Algorithm | CNN |  |
| 10 | `PMCDMLT3_E178` | `motivates` | 09-Problem Scenario | unknown class recognition(Zero Fault Samples) |  | 17-Core Classifier Algorithm | SoftMax-Plus |  |
| 11 | `PMCDMLT3_E179` | `motivates` | 09-Problem Scenario | sample imbalance of the new class during model self-learning(Small Fault Samples) |  | 17-Core Classifier Algorithm | SoftMax-Plus |  |
| 12 | `PMCDMLT3_E180` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 13 | `PMCDMLT3_E181` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SoftMax-Plus |  |
| 14 | `PMCDMLT3_E182` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | SoftMax-Plus |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `PMCDMLT3_E169`：unknown class recognition(Zero Fault Samples) motivates Fine-tune
  - `PMCDMLT3_E170`：sample imbalance of the new class during model self-learning(Small Fault Samples) motivates Fine-tune
  - `PMCDMLT3_E174`：unknown class recognition(Zero Fault Samples) motivates FFT
  - `PMCDMLT3_E175`：sample imbalance of the new class during model self-learning(Small Fault Samples) motivates FFT
  - `PMCDMLT3_E176`：unknown class recognition(Zero Fault Samples) motivates CNN
  - `PMCDMLT3_E177`：sample imbalance of the new class during model self-learning(Small Fault Samples) motivates CNN
  - `PMCDMLT3_E178`：unknown class recognition(Zero Fault Samples) motivates SoftMax-Plus
  - `PMCDMLT3_E179`：sample imbalance of the new class during model self-learning(Small Fault Samples) motivates SoftMax-Plus
