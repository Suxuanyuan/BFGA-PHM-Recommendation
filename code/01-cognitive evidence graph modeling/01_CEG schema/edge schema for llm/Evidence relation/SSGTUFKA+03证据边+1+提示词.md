...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SSGTUFKA_E103` | `motivates` | 09-Problem Scenario | over-fitting and large variance due to excessive hidden nodes(Other) |  | 19-Training Optimization Algorithm | LASSO |  |
| 2 | `SSGTUFKA_E104` | `motivates` | 09-Problem Scenario | training data with noises(Uncertainty) |  | 19-Training Optimization Algorithm | LASSO |  |
| 3 | `SSGTUFKA_E105` | `motivates` | 12-Training Data Availability | training samples(Scarce) |  | 19-Training Optimization Algorithm | LASSO |  |
| 4 | `SSGTUFKA_E106` | `motivates` | 13-Noise Level | noise level(High Noise) |  | 16-Feature Extraction Algorithm | 2DPCA |  |
| 5 | `SSGTUFKA_E107` | `motivates` | 09-Problem Scenario | over-fitting and large variance due to excessive hidden nodes(Other) |  | 16-Feature Extraction Algorithm | 2DPCA |  |
| 6 | `SSGTUFKA_E108` | `motivates` | 09-Problem Scenario | training data with noises(Uncertainty) |  | 16-Feature Extraction Algorithm | 2DPCA |  |
| 7 | `SSGTUFKA_E109` | `motivates` | 09-Problem Scenario | over-fitting and large variance due to excessive hidden nodes(Other) |  | 17-Core Classifier Algorithm | SC-RWN |  |
| 8 | `SSGTUFKA_E110` | `motivates` | 09-Problem Scenario | training data with noises(Uncertainty) |  | 17-Core Classifier Algorithm | SC-RWN |  |
| 9 | `SSGTUFKA_E111` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | 2DPCA |  |
| 10 | `SSGTUFKA_E112` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SC-RWN |  |
| 11 | `SSGTUFKA_E113` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | SC-RWN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `SSGTUFKA_E103`：over-fitting and large variance due to excessive hidden nodes(Other) motivates LASSO
  - `SSGTUFKA_E104`：training data with noises(Uncertainty) motivates LASSO
  - `SSGTUFKA_E107`：over-fitting and large variance due to excessive hidden nodes(Other) motivates 2DPCA
  - `SSGTUFKA_E108`：training data with noises(Uncertainty) motivates 2DPCA
  - `SSGTUFKA_E109`：over-fitting and large variance due to excessive hidden nodes(Other) motivates SC-RWN
  - `SSGTUFKA_E110`：training data with noises(Uncertainty) motivates SC-RWN
