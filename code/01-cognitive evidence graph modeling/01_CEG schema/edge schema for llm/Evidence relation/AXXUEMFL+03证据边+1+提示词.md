...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AXXUEMFL_E118` | `motivates` | 09-Problem Scenario | strong background noise, weak fault characteristics(Uncertainty) |  | 19-Training Optimization Algorithm | Ant colony algorithm |  |
| 2 | `AXXUEMFL_E119` | `motivates` | 09-Problem Scenario | planetary gearbox structure is more complex, unique operation mode and common complex dynamic load forces(Complex Systems) |  | 19-Training Optimization Algorithm | Ant colony algorithm |  |
| 3 | `AXXUEMFL_E120` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Ant colony algorithm |  |
| 4 | `AXXUEMFL_E121` | `motivates` | 13-Noise Level | strong background noise, heavy noise(High Noise) |  | 15-Data Preprocessing Algorithm | Shifting-frequency rescaling transform |  |
| 5 | `AXXUEMFL_E122` | `motivates` | 09-Problem Scenario | strong background noise, weak fault characteristics(Uncertainty) |  | 15-Data Preprocessing Algorithm | Shifting-frequency rescaling transform |  |
| 6 | `AXXUEMFL_E123` | `motivates` | 09-Problem Scenario | planetary gearbox structure is more complex, unique operation mode and common complex dynamic load forces(Complex Systems) |  | 15-Data Preprocessing Algorithm | Shifting-frequency rescaling transform |  |
| 7 | `AXXUEMFL_E124` | `motivates` | 09-Problem Scenario | strong background noise, weak fault characteristics(Uncertainty) |  | 17-Core Classifier Algorithm | Bistable confining potential stochastic resonance |  |
| 8 | `AXXUEMFL_E125` | `motivates` | 09-Problem Scenario | planetary gearbox structure is more complex, unique operation mode and common complex dynamic load forces(Complex Systems) |  | 17-Core Classifier Algorithm | Bistable confining potential stochastic resonance |  |
| 9 | `AXXUEMFL_E126` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Bistable confining potential stochastic resonance |  |
| 10 | `AXXUEMFL_E127` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Bistable confining potential stochastic resonance |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `AXXUEMFL_E118`：strong background noise, weak fault characteristics(Uncertainty) motivates Ant colony algorithm
  - `AXXUEMFL_E119`：planetary gearbox structure is more complex, unique operation mode and common complex dynamic load forces(Complex Systems) motivates Ant colony algorithm
  - `AXXUEMFL_E122`：strong background noise, weak fault characteristics(Uncertainty) motivates Shifting-frequency rescaling transform
  - `AXXUEMFL_E123`：planetary gearbox structure is more complex, unique operation mode and common complex dynamic load forces(Complex Systems) motivates Shifting-frequency rescaling transform
  - `AXXUEMFL_E124`：strong background noise, weak fault characteristics(Uncertainty) motivates Bistable confining potential stochastic resonance
  - `AXXUEMFL_E125`：planetary gearbox structure is more complex, unique operation mode and common complex dynamic load forces(Complex Systems) motivates Bistable confining potential stochastic resonance
