...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SPKE8UC8_E102` | `motivates` | 13-Noise Level | gear noise interferences, background noise(High Noise) |  | 15-Data Preprocessing Algorithm | Band-pass filter |  |
| 2 | `SPKE8UC8_E103` | `motivates` | 13-Noise Level | gear noise interferences, background noise(High Noise) |  | 16-Feature Extraction Algorithm | Generalized Demodulation Transform |  |
| 3 | `SPKE8UC8_E104` | `motivates` | 09-Problem Scenario | gear noise interferences(Uncertainty) |  | 15-Data Preprocessing Algorithm | Band-pass filter |  |
| 4 | `SPKE8UC8_E105` | `motivates` | 09-Problem Scenario | nonstationary conditions without the tachometer(Other) |  | 15-Data Preprocessing Algorithm | Band-pass filter |  |
| 5 | `SPKE8UC8_E106` | `motivates` | 09-Problem Scenario | gear noise interferences(Uncertainty) |  | 16-Feature Extraction Algorithm | Generalized Demodulation Transform |  |
| 6 | `SPKE8UC8_E107` | `motivates` | 09-Problem Scenario | nonstationary conditions without the tachometer(Other) |  | 16-Feature Extraction Algorithm | Generalized Demodulation Transform |  |
| 7 | `SPKE8UC8_E108` | `motivates` | 09-Problem Scenario | gear noise interferences(Uncertainty) |  | 17-Core Classifier Algorithm | Spectral peak matching |  |
| 8 | `SPKE8UC8_E109` | `motivates` | 09-Problem Scenario | nonstationary conditions without the tachometer(Other) |  | 17-Core Classifier Algorithm | Spectral peak matching |  |
| 9 | `SPKE8UC8_E110` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Generalized Demodulation Transform |  |
| 10 | `SPKE8UC8_E111` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Spectral peak matching |  |
| 11 | `SPKE8UC8_E112` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Spectral peak matching |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `SPKE8UC8_E104`：gear noise interferences(Uncertainty) motivates Band-pass filter
  - `SPKE8UC8_E105`：nonstationary conditions without the tachometer(Other) motivates Band-pass filter
  - `SPKE8UC8_E106`：gear noise interferences(Uncertainty) motivates Generalized Demodulation Transform
  - `SPKE8UC8_E107`：nonstationary conditions without the tachometer(Other) motivates Generalized Demodulation Transform
  - `SPKE8UC8_E108`：gear noise interferences(Uncertainty) motivates Spectral peak matching
  - `SPKE8UC8_E109`：nonstationary conditions without the tachometer(Other) motivates Spectral peak matching
