...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `6M5SZWN2_E075` | `motivates` | 13-Noise Level | high level of noise(High Noise) |  | 15-Data Preprocessing Algorithm | Band-pass filter |  |
| 2 | `6M5SZWN2_E076` | `motivates` | 13-Noise Level | high level of noise(High Noise) |  | 16-Feature Extraction Algorithm | Empirical Wavelet Transform |  |
| 3 | `6M5SZWN2_E077` | `motivates` | 09-Problem Scenario | high level of noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Band-pass filter |  |
| 4 | `6M5SZWN2_E078` | `motivates` | 09-Problem Scenario | incipient fault(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Band-pass filter |  |
| 5 | `6M5SZWN2_E079` | `motivates` | 09-Problem Scenario | high level of noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Empirical Wavelet Transform |  |
| 6 | `6M5SZWN2_E080` | `motivates` | 09-Problem Scenario | incipient fault(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Empirical Wavelet Transform |  |
| 7 | `6M5SZWN2_E081` | `motivates` | 09-Problem Scenario | high level of noise(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope analysis |  |
| 8 | `6M5SZWN2_E082` | `motivates` | 09-Problem Scenario | incipient fault(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Envelope analysis |  |
| 9 | `6M5SZWN2_E083` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Empirical Wavelet Transform |  |
| 10 | `6M5SZWN2_E084` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope analysis |  |
| 11 | `6M5SZWN2_E085` | `motivates` | 06-Fault Severity | incipient fault, completed failure(Multiple Severities) |  | 17-Core Classifier Algorithm | Envelope analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `6M5SZWN2_E077`：high level of noise(Uncertainty) motivates Band-pass filter
  - `6M5SZWN2_E078`：incipient fault(Early Degradation Prediction) motivates Band-pass filter
  - `6M5SZWN2_E079`：high level of noise(Uncertainty) motivates Empirical Wavelet Transform
  - `6M5SZWN2_E080`：incipient fault(Early Degradation Prediction) motivates Empirical Wavelet Transform
  - `6M5SZWN2_E081`：high level of noise(Uncertainty) motivates Envelope analysis
  - `6M5SZWN2_E082`：incipient fault(Early Degradation Prediction) motivates Envelope analysis
