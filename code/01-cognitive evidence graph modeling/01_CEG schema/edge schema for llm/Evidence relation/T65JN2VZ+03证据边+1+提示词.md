...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `T65JN2VZ_E079` | `motivates` | 13-Noise Level | strong background noise(High Noise) |  | 15-Data Preprocessing Algorithm | LMD-MHD |  |
| 2 | `T65JN2VZ_E080` | `motivates` | 13-Noise Level | strong background noise(High Noise) |  | 16-Feature Extraction Algorithm | LMD |  |
| 3 | `T65JN2VZ_E081` | `motivates` | 09-Problem Scenario | weak fault feature extraction under strong background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | LMD-MHD |  |
| 4 | `T65JN2VZ_E082` | `motivates` | 09-Problem Scenario | early fault detection / weak fault features(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | LMD-MHD |  |
| 5 | `T65JN2VZ_E083` | `motivates` | 09-Problem Scenario | weak fault feature extraction under strong background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | LMD |  |
| 6 | `T65JN2VZ_E084` | `motivates` | 09-Problem Scenario | early fault detection / weak fault features(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | LMD |  |
| 7 | `T65JN2VZ_E085` | `motivates` | 09-Problem Scenario | weak fault feature extraction under strong background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 8 | `T65JN2VZ_E086` | `motivates` | 09-Problem Scenario | early fault detection / weak fault features(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 9 | `T65JN2VZ_E087` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | LMD |  |
| 10 | `T65JN2VZ_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 11 | `T65JN2VZ_E089` | `motivates` | 06-Fault Severity | 0.007 in(Single Severity) |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `T65JN2VZ_E081`：weak fault feature extraction under strong background noise(Uncertainty) motivates LMD-MHD
  - `T65JN2VZ_E082`：early fault detection / weak fault features(Early Degradation Prediction) motivates LMD-MHD
  - `T65JN2VZ_E083`：weak fault feature extraction under strong background noise(Uncertainty) motivates LMD
  - `T65JN2VZ_E084`：early fault detection / weak fault features(Early Degradation Prediction) motivates LMD
  - `T65JN2VZ_E085`：weak fault feature extraction under strong background noise(Uncertainty) motivates Envelope Spectrum Analysis
  - `T65JN2VZ_E086`：early fault detection / weak fault features(Early Degradation Prediction) motivates Envelope Spectrum Analysis
