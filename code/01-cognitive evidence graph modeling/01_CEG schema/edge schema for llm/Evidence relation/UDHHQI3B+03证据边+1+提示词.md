...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `UDHHQI3B_E084` | `motivates` | 13-Noise Level | Not mentioned(Normal) |  | 15-Data Preprocessing Algorithm | AZPTF |  |
| 2 | `UDHHQI3B_E085` | `motivates` | 13-Noise Level | Not mentioned(Normal) |  | 16-Feature Extraction Algorithm | MCSSD |  |
| 3 | `UDHHQI3B_E086` | `motivates` | 09-Problem Scenario | Phase shift and signal distortion of adaptive time-varying filter(Other) |  | 15-Data Preprocessing Algorithm | AZPTF |  |
| 4 | `UDHHQI3B_E087` | `motivates` | 09-Problem Scenario | Vibration signal interference among multiple gearboxes installed on one foundation bed(Complex Systems) |  | 15-Data Preprocessing Algorithm | AZPTF |  |
| 5 | `UDHHQI3B_E088` | `motivates` | 09-Problem Scenario | Phase shift and signal distortion of adaptive time-varying filter(Other) |  | 16-Feature Extraction Algorithm | MCSSD |  |
| 6 | `UDHHQI3B_E089` | `motivates` | 09-Problem Scenario | Vibration signal interference among multiple gearboxes installed on one foundation bed(Complex Systems) |  | 16-Feature Extraction Algorithm | MCSSD |  |
| 7 | `UDHHQI3B_E090` | `motivates` | 09-Problem Scenario | Phase shift and signal distortion of adaptive time-varying filter(Other) |  | 17-Core Classifier Algorithm | Envelope order analysis |  |
| 8 | `UDHHQI3B_E091` | `motivates` | 09-Problem Scenario | Vibration signal interference among multiple gearboxes installed on one foundation bed(Complex Systems) |  | 17-Core Classifier Algorithm | Envelope order analysis |  |
| 9 | `UDHHQI3B_E092` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | MCSSD |  |
| 10 | `UDHHQI3B_E093` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope order analysis |  |
| 11 | `UDHHQI3B_E094` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Envelope order analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `UDHHQI3B_E086`：Phase shift and signal distortion of adaptive time-varying filter(Other) motivates AZPTF
  - `UDHHQI3B_E087`：Vibration signal interference among multiple gearboxes installed on one foundation bed(Complex Systems) motivates AZPTF
  - `UDHHQI3B_E088`：Phase shift and signal distortion of adaptive time-varying filter(Other) motivates MCSSD
  - `UDHHQI3B_E089`：Vibration signal interference among multiple gearboxes installed on one foundation bed(Complex Systems) motivates MCSSD
  - `UDHHQI3B_E090`：Phase shift and signal distortion of adaptive time-varying filter(Other) motivates Envelope order analysis
  - `UDHHQI3B_E091`：Vibration signal interference among multiple gearboxes installed on one foundation bed(Complex Systems) motivates Envelope order analysis
