...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QVBIMVQ8_E083` | `motivates` | 13-Noise Level | heavy background noise, noise variance level(High Noise) |  | 15-Data Preprocessing Algorithm | Over-Complete Rational Dilation Wavelet Transform |  |
| 2 | `QVBIMVQ8_E084` | `motivates` | 13-Noise Level | heavy background noise, noise variance level(High Noise) |  | 16-Feature Extraction Algorithm | Analytic Energy Operator |  |
| 3 | `QVBIMVQ8_E085` | `motivates` | 09-Problem Scenario | heavy background noise and sporadic shocks(Uncertainty) |  | 15-Data Preprocessing Algorithm | Over-Complete Rational Dilation Wavelet Transform |  |
| 4 | `QVBIMVQ8_E086` | `motivates` | 09-Problem Scenario | sensitivity to fault severity(Other) |  | 15-Data Preprocessing Algorithm | Over-Complete Rational Dilation Wavelet Transform |  |
| 5 | `QVBIMVQ8_E087` | `motivates` | 09-Problem Scenario | heavy background noise and sporadic shocks(Uncertainty) |  | 16-Feature Extraction Algorithm | Analytic Energy Operator |  |
| 6 | `QVBIMVQ8_E088` | `motivates` | 09-Problem Scenario | sensitivity to fault severity(Other) |  | 16-Feature Extraction Algorithm | Analytic Energy Operator |  |
| 7 | `QVBIMVQ8_E089` | `motivates` | 09-Problem Scenario | heavy background noise and sporadic shocks(Uncertainty) |  | 17-Core Classifier Algorithm | Autocorrelation |  |
| 8 | `QVBIMVQ8_E090` | `motivates` | 09-Problem Scenario | sensitivity to fault severity(Other) |  | 17-Core Classifier Algorithm | Autocorrelation |  |
| 9 | `QVBIMVQ8_E091` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Analytic Energy Operator |  |
| 10 | `QVBIMVQ8_E092` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Autocorrelation |  |
| 11 | `QVBIMVQ8_E093` | `motivates` | 06-Fault Severity | fault size(Multiple Severities) |  | 17-Core Classifier Algorithm | Autocorrelation |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `QVBIMVQ8_E085`：heavy background noise and sporadic shocks(Uncertainty) motivates Over-Complete Rational Dilation Wavelet Transform
  - `QVBIMVQ8_E086`：sensitivity to fault severity(Other) motivates Over-Complete Rational Dilation Wavelet Transform
  - `QVBIMVQ8_E087`：heavy background noise and sporadic shocks(Uncertainty) motivates Analytic Energy Operator
  - `QVBIMVQ8_E088`：sensitivity to fault severity(Other) motivates Analytic Energy Operator
  - `QVBIMVQ8_E089`：heavy background noise and sporadic shocks(Uncertainty) motivates Autocorrelation
  - `QVBIMVQ8_E090`：sensitivity to fault severity(Other) motivates Autocorrelation
