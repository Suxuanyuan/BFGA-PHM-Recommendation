...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `MIVICJ6P_E164` | `motivates` | 09-Problem Scenario | distribution discrepancy between different datasets / different operating conditions or other same-type machines(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Transfer Locality Preserving Projection |  |
| 2 | `MIVICJ6P_E165` | `motivates` | 09-Problem Scenario | inadequate information of target domain / only normal samples of target domain are available in training stage(Small Fault Samples) |  | 19-Training Optimization Algorithm | Transfer Locality Preserving Projection |  |
| 3 | `MIVICJ6P_E166` | `motivates` | 12-Training Data Availability | massive labeled samples(Sufficient) |  | 19-Training Optimization Algorithm | Transfer Locality Preserving Projection |  |
| 4 | `MIVICJ6P_E167` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | l2-norm normalization |  |
| 5 | `MIVICJ6P_E168` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | statistical feature extraction |  |
| 6 | `MIVICJ6P_E169` | `motivates` | 09-Problem Scenario | distribution discrepancy between different datasets / different operating conditions or other same-type machines(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | l2-norm normalization |  |
| 7 | `MIVICJ6P_E170` | `motivates` | 09-Problem Scenario | inadequate information of target domain / only normal samples of target domain are available in training stage(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | l2-norm normalization |  |
| 8 | `MIVICJ6P_E171` | `motivates` | 09-Problem Scenario | distribution discrepancy between different datasets / different operating conditions or other same-type machines(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | statistical feature extraction |  |
| 9 | `MIVICJ6P_E172` | `motivates` | 09-Problem Scenario | inadequate information of target domain / only normal samples of target domain are available in training stage(Small Fault Samples) |  | 16-Feature Extraction Algorithm | statistical feature extraction |  |
| 10 | `MIVICJ6P_E173` | `motivates` | 09-Problem Scenario | distribution discrepancy between different datasets / different operating conditions or other same-type machines(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 11 | `MIVICJ6P_E174` | `motivates` | 09-Problem Scenario | inadequate information of target domain / only normal samples of target domain are available in training stage(Small Fault Samples) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 12 | `MIVICJ6P_E175` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | statistical feature extraction |  |
| 13 | `MIVICJ6P_E176` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 14 | `MIVICJ6P_E177` | `motivates` | 06-Fault Severity | 0.18 mm, 0.36 mm, 0.53 mm, early fault, serious fault(Multiple Severities) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `MIVICJ6P_E164`：distribution discrepancy between different datasets / different operating conditions or other same-type machines(Distribution Discrepancy) motivates Transfer Locality Preserving Projection
  - `MIVICJ6P_E165`：inadequate information of target domain / only normal samples of target domain are available in training stage(Small Fault Samples) motivates Transfer Locality Preserving Projection
  - `MIVICJ6P_E169`：distribution discrepancy between different datasets / different operating conditions or other same-type machines(Distribution Discrepancy) motivates l2-norm normalization
  - `MIVICJ6P_E170`：inadequate information of target domain / only normal samples of target domain are available in training stage(Small Fault Samples) motivates l2-norm normalization
  - `MIVICJ6P_E171`：distribution discrepancy between different datasets / different operating conditions or other same-type machines(Distribution Discrepancy) motivates statistical feature extraction
  - `MIVICJ6P_E172`：inadequate information of target domain / only normal samples of target domain are available in training stage(Small Fault Samples) motivates statistical feature extraction
  - `MIVICJ6P_E173`：distribution discrepancy between different datasets / different operating conditions or other same-type machines(Distribution Discrepancy) motivates Support Vector Machine
  - `MIVICJ6P_E174`：inadequate information of target domain / only normal samples of target domain are available in training stage(Small Fault Samples) motivates Support Vector Machine
