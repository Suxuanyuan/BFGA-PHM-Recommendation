...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DLGL2F9Y_E093` | `motivates` | 13-Noise Level | heavy noise(High Noise) |  | 15-Data Preprocessing Algorithm | Iterative Nonlinear Filter |  |
| 2 | `DLGL2F9Y_E094` | `motivates` | 13-Noise Level | heavy noise(High Noise) |  | 16-Feature Extraction Algorithm | Morphological Analysis |  |
| 3 | `DLGL2F9Y_E095` | `motivates` | 09-Problem Scenario | weak fault signals masked by heavy noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Iterative Nonlinear Filter |  |
| 4 | `DLGL2F9Y_E096` | `motivates` | 09-Problem Scenario | limited number of fault signals due to limited rotation angle(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Iterative Nonlinear Filter |  |
| 5 | `DLGL2F9Y_E097` | `motivates` | 09-Problem Scenario | weak fault signals masked by heavy noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Morphological Analysis |  |
| 6 | `DLGL2F9Y_E098` | `motivates` | 09-Problem Scenario | limited number of fault signals due to limited rotation angle(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Morphological Analysis |  |
| 7 | `DLGL2F9Y_E099` | `motivates` | 09-Problem Scenario | weak fault signals masked by heavy noise(Uncertainty) |  | 17-Core Classifier Algorithm | Defect Frequency Matching Error |  |
| 8 | `DLGL2F9Y_E100` | `motivates` | 09-Problem Scenario | limited number of fault signals due to limited rotation angle(Small Fault Samples) |  | 17-Core Classifier Algorithm | Defect Frequency Matching Error |  |
| 9 | `DLGL2F9Y_E101` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Morphological Analysis |  |
| 10 | `DLGL2F9Y_E102` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Defect Frequency Matching Error |  |
| 11 | `DLGL2F9Y_E103` | `motivates` | 06-Fault Severity | large crack (over 9 mm long and 5 mm wide) and smaller cracks (less than 4 mm)(Single Severity) |  | 17-Core Classifier Algorithm | Defect Frequency Matching Error |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `DLGL2F9Y_E095`：weak fault signals masked by heavy noise(Uncertainty) motivates Iterative Nonlinear Filter
  - `DLGL2F9Y_E096`：limited number of fault signals due to limited rotation angle(Small Fault Samples) motivates Iterative Nonlinear Filter
  - `DLGL2F9Y_E097`：weak fault signals masked by heavy noise(Uncertainty) motivates Morphological Analysis
  - `DLGL2F9Y_E098`：limited number of fault signals due to limited rotation angle(Small Fault Samples) motivates Morphological Analysis
  - `DLGL2F9Y_E099`：weak fault signals masked by heavy noise(Uncertainty) motivates Defect Frequency Matching Error
  - `DLGL2F9Y_E100`：limited number of fault signals due to limited rotation angle(Small Fault Samples) motivates Defect Frequency Matching Error
