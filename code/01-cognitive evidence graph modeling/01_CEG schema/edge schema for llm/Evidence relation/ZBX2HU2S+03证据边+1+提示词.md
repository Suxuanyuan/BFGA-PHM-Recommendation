...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZBX2HU2S_E104` | `motivates` | 13-Noise Level | mixed with much noise(High Noise) |  | 15-Data Preprocessing Algorithm | Fast Fourier Transform |  |
| 2 | `ZBX2HU2S_E105` | `motivates` | 09-Problem Scenario | small-sample(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Fast Fourier Transform |  |
| 3 | `ZBX2HU2S_E106` | `motivates` | 09-Problem Scenario | poor quality data usually mixed with much noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Fast Fourier Transform |  |
| 4 | `ZBX2HU2S_E107` | `motivates` | 09-Problem Scenario | small-sample(Small Fault Samples) |  | 17-Core Classifier Algorithm | Doublet Extreme Learning Machine |  |
| 5 | `ZBX2HU2S_E108` | `motivates` | 09-Problem Scenario | poor quality data usually mixed with much noise(Uncertainty) |  | 17-Core Classifier Algorithm | Doublet Extreme Learning Machine |  |
| 6 | `ZBX2HU2S_E109` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Doublet Extreme Learning Machine |  |
| 7 | `ZBX2HU2S_E110` | `motivates` | 06-Fault Severity | Loosen two turns, Loosen three teeth(Single Severity) |  | 17-Core Classifier Algorithm | Doublet Extreme Learning Machine |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZBX2HU2S_E105`：small-sample(Small Fault Samples) motivates Fast Fourier Transform
  - `ZBX2HU2S_E106`：poor quality data usually mixed with much noise(Uncertainty) motivates Fast Fourier Transform
  - `ZBX2HU2S_E107`：small-sample(Small Fault Samples) motivates Doublet Extreme Learning Machine
  - `ZBX2HU2S_E108`：poor quality data usually mixed with much noise(Uncertainty) motivates Doublet Extreme Learning Machine
