...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HQYLWLVF_E083` | `motivates` | 09-Problem Scenario | Weak fault feature submerged in noise(Uncertainty) |  | 19-Training Optimization Algorithm | PSO |  |
| 2 | `HQYLWLVF_E084` | `motivates` | 09-Problem Scenario | Nonlinear and non-stationary vibration of planetary gear(Complex Systems) |  | 19-Training Optimization Algorithm | PSO |  |
| 3 | `HQYLWLVF_E085` | `motivates` | 12-Training Data Availability | N/A(Sufficient) |  | 19-Training Optimization Algorithm | PSO |  |
| 4 | `HQYLWLVF_E086` | `motivates` | 13-Noise Level | noise interferences(High Noise) |  | 15-Data Preprocessing Algorithm | EEMD |  |
| 5 | `HQYLWLVF_E087` | `motivates` | 09-Problem Scenario | Weak fault feature submerged in noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | EEMD |  |
| 6 | `HQYLWLVF_E088` | `motivates` | 09-Problem Scenario | Nonlinear and non-stationary vibration of planetary gear(Complex Systems) |  | 15-Data Preprocessing Algorithm | EEMD |  |
| 7 | `HQYLWLVF_E089` | `motivates` | 09-Problem Scenario | Weak fault feature submerged in noise(Uncertainty) |  | 17-Core Classifier Algorithm | ASR |  |
| 8 | `HQYLWLVF_E090` | `motivates` | 09-Problem Scenario | Nonlinear and non-stationary vibration of planetary gear(Complex Systems) |  | 17-Core Classifier Algorithm | ASR |  |
| 9 | `HQYLWLVF_E091` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | ASR |  |
| 10 | `HQYLWLVF_E092` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | ASR |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `HQYLWLVF_E083`：Weak fault feature submerged in noise(Uncertainty) motivates PSO
  - `HQYLWLVF_E084`：Nonlinear and non-stationary vibration of planetary gear(Complex Systems) motivates PSO
  - `HQYLWLVF_E087`：Weak fault feature submerged in noise(Uncertainty) motivates EEMD
  - `HQYLWLVF_E088`：Nonlinear and non-stationary vibration of planetary gear(Complex Systems) motivates EEMD
  - `HQYLWLVF_E089`：Weak fault feature submerged in noise(Uncertainty) motivates ASR
  - `HQYLWLVF_E090`：Nonlinear and non-stationary vibration of planetary gear(Complex Systems) motivates ASR
