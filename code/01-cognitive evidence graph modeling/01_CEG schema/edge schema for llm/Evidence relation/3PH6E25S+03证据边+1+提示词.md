...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3PH6E25S_E104` | `motivates` | 13-Noise Level | high frequency PWM switching noise(High Noise) |  | 15-Data Preprocessing Algorithm | Time Integration |  |
| 2 | `3PH6E25S_E105` | `motivates` | 13-Noise Level | high frequency PWM switching noise(High Noise) |  | 16-Feature Extraction Algorithm | Zero-crossing Detection |  |
| 3 | `3PH6E25S_E106` | `motivates` | 09-Problem Scenario | multiple drive system with identical operating frequency(Complex Systems) |  | 15-Data Preprocessing Algorithm | Time Integration |  |
| 4 | `3PH6E25S_E107` | `motivates` | 09-Problem Scenario | low frequency, low voltage ground faults at low motor speeds(Other) |  | 15-Data Preprocessing Algorithm | Time Integration |  |
| 5 | `3PH6E25S_E108` | `motivates` | 09-Problem Scenario | multiple drive system with identical operating frequency(Complex Systems) |  | 16-Feature Extraction Algorithm | Zero-crossing Detection |  |
| 6 | `3PH6E25S_E109` | `motivates` | 09-Problem Scenario | low frequency, low voltage ground faults at low motor speeds(Other) |  | 16-Feature Extraction Algorithm | Zero-crossing Detection |  |
| 7 | `3PH6E25S_E110` | `motivates` | 09-Problem Scenario | multiple drive system with identical operating frequency(Complex Systems) |  | 17-Core Classifier Algorithm | Frequency Matching Algorithm |  |
| 8 | `3PH6E25S_E111` | `motivates` | 09-Problem Scenario | low frequency, low voltage ground faults at low motor speeds(Other) |  | 17-Core Classifier Algorithm | Frequency Matching Algorithm |  |
| 9 | `3PH6E25S_E112` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Zero-crossing Detection |  |
| 10 | `3PH6E25S_E113` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Frequency Matching Algorithm |  |
| 11 | `3PH6E25S_E114` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Frequency Matching Algorithm |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `3PH6E25S_E106`：multiple drive system with identical operating frequency(Complex Systems) motivates Time Integration
  - `3PH6E25S_E107`：low frequency, low voltage ground faults at low motor speeds(Other) motivates Time Integration
  - `3PH6E25S_E108`：multiple drive system with identical operating frequency(Complex Systems) motivates Zero-crossing Detection
  - `3PH6E25S_E109`：low frequency, low voltage ground faults at low motor speeds(Other) motivates Zero-crossing Detection
  - `3PH6E25S_E110`：multiple drive system with identical operating frequency(Complex Systems) motivates Frequency Matching Algorithm
  - `3PH6E25S_E111`：low frequency, low voltage ground faults at low motor speeds(Other) motivates Frequency Matching Algorithm
