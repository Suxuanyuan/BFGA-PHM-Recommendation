...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AXB3YMZY_E149` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | MK-MMD |  |
| 2 | `AXB3YMZY_E150` | `motivates` | 09-Problem Scenario | coupling fault(Compound Faults) |  | 19-Training Optimization Algorithm | MK-MMD |  |
| 3 | `AXB3YMZY_E151` | `motivates` | 12-Training Data Availability | CWRU dataset: 400 samples in each category, 75% for training; Gearbox dataset: 130 samples, 100 for training; DDS dataset: 400 samples, 75% for training(Sufficient) |  | 19-Training Optimization Algorithm | MK-MMD |  |
| 4 | `AXB3YMZY_E152` | `motivates` | 13-Noise Level | internal and external interference, suppress noise, severe noise interference(High Noise) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 5 | `AXB3YMZY_E153` | `motivates` | 13-Noise Level | internal and external interference, suppress noise, severe noise interference(High Noise) |  | 16-Feature Extraction Algorithm | ISC |  |
| 6 | `AXB3YMZY_E154` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 7 | `AXB3YMZY_E155` | `motivates` | 09-Problem Scenario | coupling fault(Compound Faults) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 8 | `AXB3YMZY_E156` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | ISC |  |
| 9 | `AXB3YMZY_E157` | `motivates` | 09-Problem Scenario | coupling fault(Compound Faults) |  | 16-Feature Extraction Algorithm | ISC |  |
| 10 | `AXB3YMZY_E158` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `AXB3YMZY_E159` | `motivates` | 09-Problem Scenario | coupling fault(Compound Faults) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `AXB3YMZY_E160` | `motivates` | 07-Compound Fault | coupling faults, coupled failure(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | ISC |  |
| 13 | `AXB3YMZY_E161` | `motivates` | 07-Compound Fault | coupling faults, coupled failure(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `AXB3YMZY_E162` | `motivates` | 06-Fault Severity | 0.007 inch, 0.014 inch, 0.021 inch(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `AXB3YMZY_E149`：domain shift(Distribution Discrepancy) motivates MK-MMD
  - `AXB3YMZY_E150`：coupling fault(Compound Faults) motivates MK-MMD
  - `AXB3YMZY_E154`：domain shift(Distribution Discrepancy) motivates FFT
  - `AXB3YMZY_E155`：coupling fault(Compound Faults) motivates FFT
  - `AXB3YMZY_E156`：domain shift(Distribution Discrepancy) motivates ISC
  - `AXB3YMZY_E157`：coupling fault(Compound Faults) motivates ISC
  - `AXB3YMZY_E158`：domain shift(Distribution Discrepancy) motivates Softmax
  - `AXB3YMZY_E159`：coupling fault(Compound Faults) motivates Softmax
