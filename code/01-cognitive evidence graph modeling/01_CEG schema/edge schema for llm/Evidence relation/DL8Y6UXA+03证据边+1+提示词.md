...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DL8Y6UXA_E092` | `motivates` | 13-Noise Level | harsh working conditions, heavy noise, severe background noise(High Noise) |  | 15-Data Preprocessing Algorithm | Autocorrelation |  |
| 2 | `DL8Y6UXA_E093` | `motivates` | 13-Noise Level | harsh working conditions, heavy noise, severe background noise(High Noise) |  | 16-Feature Extraction Algorithm | IMCKD |  |
| 3 | `DL8Y6UXA_E094` | `motivates` | 09-Problem Scenario | compound-fault diagnosis(Compound Faults) |  | 15-Data Preprocessing Algorithm | Autocorrelation |  |
| 4 | `DL8Y6UXA_E095` | `motivates` | 09-Problem Scenario | severe background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Autocorrelation |  |
| 5 | `DL8Y6UXA_E096` | `motivates` | 09-Problem Scenario | compound-fault diagnosis(Compound Faults) |  | 16-Feature Extraction Algorithm | IMCKD |  |
| 6 | `DL8Y6UXA_E097` | `motivates` | 09-Problem Scenario | severe background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | IMCKD |  |
| 7 | `DL8Y6UXA_E098` | `motivates` | 09-Problem Scenario | compound-fault diagnosis(Compound Faults) |  | 17-Core Classifier Algorithm | Hilbert envelope spectrum analysis |  |
| 8 | `DL8Y6UXA_E099` | `motivates` | 09-Problem Scenario | severe background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Hilbert envelope spectrum analysis |  |
| 9 | `DL8Y6UXA_E100` | `motivates` | 07-Compound Fault | compound-fault(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | IMCKD |  |
| 10 | `DL8Y6UXA_E101` | `motivates` | 07-Compound Fault | compound-fault(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Hilbert envelope spectrum analysis |  |
| 11 | `DL8Y6UXA_E102` | `motivates` | 06-Fault Severity | 1 mm * 6 mm (D * W), 1 mm * 10 mm (D * W), 0.5 mm * 30 mm (D * W)(Single Severity) |  | 17-Core Classifier Algorithm | Hilbert envelope spectrum analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `DL8Y6UXA_E094`：compound-fault diagnosis(Compound Faults) motivates Autocorrelation
  - `DL8Y6UXA_E095`：severe background noise(Uncertainty) motivates Autocorrelation
  - `DL8Y6UXA_E096`：compound-fault diagnosis(Compound Faults) motivates IMCKD
  - `DL8Y6UXA_E097`：severe background noise(Uncertainty) motivates IMCKD
  - `DL8Y6UXA_E098`：compound-fault diagnosis(Compound Faults) motivates Hilbert envelope spectrum analysis
  - `DL8Y6UXA_E099`：severe background noise(Uncertainty) motivates Hilbert envelope spectrum analysis
