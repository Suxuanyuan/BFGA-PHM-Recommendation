...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `NS6KES4Z_E080` | `motivates` | 13-Noise Level | white Gaussian noise, very low signal-to-noise ratio(High Noise) |  | 16-Feature Extraction Algorithm | CMQGWT |  |
| 2 | `NS6KES4Z_E081` | `motivates` | 09-Problem Scenario | limited resolution of continuous wavelet transform(Other) |  | 16-Feature Extraction Algorithm | CMQGWT |  |
| 3 | `NS6KES4Z_E082` | `motivates` | 09-Problem Scenario | low signal-to-noise ratio(Uncertainty) |  | 16-Feature Extraction Algorithm | CMQGWT |  |
| 4 | `NS6KES4Z_E083` | `motivates` | 09-Problem Scenario | limited resolution of continuous wavelet transform(Other) |  | 17-Core Classifier Algorithm | Frequency Comparison |  |
| 5 | `NS6KES4Z_E084` | `motivates` | 09-Problem Scenario | low signal-to-noise ratio(Uncertainty) |  | 17-Core Classifier Algorithm | Frequency Comparison |  |
| 6 | `NS6KES4Z_E085` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CMQGWT |  |
| 7 | `NS6KES4Z_E086` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Frequency Comparison |  |
| 8 | `NS6KES4Z_E087` | `motivates` | 06-Fault Severity | 0.6 mm(Single Severity) |  | 17-Core Classifier Algorithm | Frequency Comparison |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `NS6KES4Z_E081`：limited resolution of continuous wavelet transform(Other) motivates CMQGWT
  - `NS6KES4Z_E082`：low signal-to-noise ratio(Uncertainty) motivates CMQGWT
  - `NS6KES4Z_E083`：limited resolution of continuous wavelet transform(Other) motivates Frequency Comparison
  - `NS6KES4Z_E084`：low signal-to-noise ratio(Uncertainty) motivates Frequency Comparison
