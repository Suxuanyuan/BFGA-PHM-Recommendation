...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZV8E286Y_E127` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Trend removal |  |
| 2 | `ZV8E286Y_E128` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Wavelet Packet Transform |  |
| 3 | `ZV8E286Y_E129` | `motivates` | 09-Problem Scenario | multi-source signals(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Trend removal |  |
| 4 | `ZV8E286Y_E130` | `motivates` | 09-Problem Scenario | small samples(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Trend removal |  |
| 5 | `ZV8E286Y_E131` | `motivates` | 09-Problem Scenario | susceptible to outliers(Uncertainty) |  | 15-Data Preprocessing Algorithm | Trend removal |  |
| 6 | `ZV8E286Y_E132` | `motivates` | 09-Problem Scenario | multi-source signals(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | Wavelet Packet Transform |  |
| 7 | `ZV8E286Y_E133` | `motivates` | 09-Problem Scenario | small samples(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Wavelet Packet Transform |  |
| 8 | `ZV8E286Y_E134` | `motivates` | 09-Problem Scenario | susceptible to outliers(Uncertainty) |  | 16-Feature Extraction Algorithm | Wavelet Packet Transform |  |
| 9 | `ZV8E286Y_E135` | `motivates` | 09-Problem Scenario | multi-source signals(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | Kernel flexible and displaceable convex hull based tensor machine |  |
| 10 | `ZV8E286Y_E136` | `motivates` | 09-Problem Scenario | small samples(Small Fault Samples) |  | 17-Core Classifier Algorithm | Kernel flexible and displaceable convex hull based tensor machine |  |
| 11 | `ZV8E286Y_E137` | `motivates` | 09-Problem Scenario | susceptible to outliers(Uncertainty) |  | 17-Core Classifier Algorithm | Kernel flexible and displaceable convex hull based tensor machine |  |
| 12 | `ZV8E286Y_E138` | `motivates` | 07-Compound Fault | pitting and wear, tooth-broken and wear(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Wavelet Packet Transform |  |
| 13 | `ZV8E286Y_E139` | `motivates` | 07-Compound Fault | pitting and wear, tooth-broken and wear(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Kernel flexible and displaceable convex hull based tensor machine |  |
| 14 | `ZV8E286Y_E140` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Kernel flexible and displaceable convex hull based tensor machine |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZV8E286Y_E129`：multi-source signals(Multi-Source Heterogeneous / Multimodal Data) motivates Trend removal
  - `ZV8E286Y_E130`：small samples(Small Fault Samples) motivates Trend removal
  - `ZV8E286Y_E131`：susceptible to outliers(Uncertainty) motivates Trend removal
  - `ZV8E286Y_E132`：multi-source signals(Multi-Source Heterogeneous / Multimodal Data) motivates Wavelet Packet Transform
  - `ZV8E286Y_E133`：small samples(Small Fault Samples) motivates Wavelet Packet Transform
  - `ZV8E286Y_E134`：susceptible to outliers(Uncertainty) motivates Wavelet Packet Transform
  - `ZV8E286Y_E135`：multi-source signals(Multi-Source Heterogeneous / Multimodal Data) motivates Kernel flexible and displaceable convex hull based tensor machine
  - `ZV8E286Y_E136`：small samples(Small Fault Samples) motivates Kernel flexible and displaceable convex hull based tensor machine
  - `ZV8E286Y_E137`：susceptible to outliers(Uncertainty) motivates Kernel flexible and displaceable convex hull based tensor machine
