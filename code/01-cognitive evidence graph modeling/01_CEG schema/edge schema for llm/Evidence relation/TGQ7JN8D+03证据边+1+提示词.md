...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TGQ7JN8D_E101` | `motivates` | 13-Noise Level | strong background noises(High Noise) |  | 15-Data Preprocessing Algorithm | Adaptive Noise Cancelling |  |
| 2 | `TGQ7JN8D_E102` | `motivates` | 13-Noise Level | strong background noises(High Noise) |  | 16-Feature Extraction Algorithm | Smoothed Pseudo Wigner-Ville Distribution |  |
| 3 | `TGQ7JN8D_E103` | `motivates` | 09-Problem Scenario | strong background noises(Uncertainty) |  | 15-Data Preprocessing Algorithm | Adaptive Noise Cancelling |  |
| 4 | `TGQ7JN8D_E104` | `motivates` | 09-Problem Scenario | railway wheel flat and rail surface defect(Compound Faults) |  | 15-Data Preprocessing Algorithm | Adaptive Noise Cancelling |  |
| 5 | `TGQ7JN8D_E105` | `motivates` | 09-Problem Scenario | strong background noises(Uncertainty) |  | 16-Feature Extraction Algorithm | Smoothed Pseudo Wigner-Ville Distribution |  |
| 6 | `TGQ7JN8D_E106` | `motivates` | 09-Problem Scenario | railway wheel flat and rail surface defect(Compound Faults) |  | 16-Feature Extraction Algorithm | Smoothed Pseudo Wigner-Ville Distribution |  |
| 7 | `TGQ7JN8D_E107` | `motivates` | 09-Problem Scenario | strong background noises(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold Detection |  |
| 8 | `TGQ7JN8D_E108` | `motivates` | 09-Problem Scenario | railway wheel flat and rail surface defect(Compound Faults) |  | 17-Core Classifier Algorithm | Threshold Detection |  |
| 9 | `TGQ7JN8D_E109` | `motivates` | 07-Compound Fault | roller defect and wheel defect(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | Smoothed Pseudo Wigner-Ville Distribution |  |
| 10 | `TGQ7JN8D_E110` | `motivates` | 07-Compound Fault | roller defect and wheel defect(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | Threshold Detection |  |
| 11 | `TGQ7JN8D_E111` | `motivates` | 06-Fault Severity | 3 mm long x 2 mm wide x 0.2 mm deep dent, 2 mm wide x 1 mm long wheel flat(Single Severity) |  | 17-Core Classifier Algorithm | Threshold Detection |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `TGQ7JN8D_E103`：strong background noises(Uncertainty) motivates Adaptive Noise Cancelling
  - `TGQ7JN8D_E104`：railway wheel flat and rail surface defect(Compound Faults) motivates Adaptive Noise Cancelling
  - `TGQ7JN8D_E105`：strong background noises(Uncertainty) motivates Smoothed Pseudo Wigner-Ville Distribution
  - `TGQ7JN8D_E106`：railway wheel flat and rail surface defect(Compound Faults) motivates Smoothed Pseudo Wigner-Ville Distribution
  - `TGQ7JN8D_E107`：strong background noises(Uncertainty) motivates Threshold Detection
  - `TGQ7JN8D_E108`：railway wheel flat and rail surface defect(Compound Faults) motivates Threshold Detection
