...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `NXMKCDDS_E165` | `motivates` | 09-Problem Scenario | lack of sufficient training data(Small Fault Samples) |  | 19-Training Optimization Algorithm | Two-stage training |  |
| 2 | `NXMKCDDS_E166` | `motivates` | 09-Problem Scenario | mechanism interpretation(Trustworthiness / Interpretability) |  | 19-Training Optimization Algorithm | Two-stage training |  |
| 3 | `NXMKCDDS_E167` | `motivates` | 12-Training Data Availability | lack of sufficient training data / small sample condition(Scarce) |  | 18-Data Generation Algorithm | SC-GAN |  |
| 4 | `NXMKCDDS_E168` | `motivates` | 12-Training Data Availability | lack of sufficient training data / small sample condition(Scarce) |  | 19-Training Optimization Algorithm | Two-stage training |  |
| 5 | `NXMKCDDS_E169` | `motivates` | 13-Noise Level | noise disturbances / noisier and more complicated(High Noise) |  | 15-Data Preprocessing Algorithm | Fixed-width windowing |  |
| 6 | `NXMKCDDS_E170` | `motivates` | 13-Noise Level | noise disturbances / noisier and more complicated(High Noise) |  | 16-Feature Extraction Algorithm | Sparse Autoencoder |  |
| 7 | `NXMKCDDS_E171` | `motivates` | 09-Problem Scenario | lack of sufficient training data(Small Fault Samples) |  | 18-Data Generation Algorithm | SC-GAN |  |
| 8 | `NXMKCDDS_E172` | `motivates` | 09-Problem Scenario | mechanism interpretation(Trustworthiness / Interpretability) |  | 18-Data Generation Algorithm | SC-GAN |  |
| 9 | `NXMKCDDS_E173` | `motivates` | 09-Problem Scenario | lack of sufficient training data(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Fixed-width windowing |  |
| 10 | `NXMKCDDS_E174` | `motivates` | 09-Problem Scenario | mechanism interpretation(Trustworthiness / Interpretability) |  | 15-Data Preprocessing Algorithm | Fixed-width windowing |  |
| 11 | `NXMKCDDS_E175` | `motivates` | 09-Problem Scenario | lack of sufficient training data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Sparse Autoencoder |  |
| 12 | `NXMKCDDS_E176` | `motivates` | 09-Problem Scenario | mechanism interpretation(Trustworthiness / Interpretability) |  | 16-Feature Extraction Algorithm | Sparse Autoencoder |  |
| 13 | `NXMKCDDS_E177` | `motivates` | 09-Problem Scenario | lack of sufficient training data(Small Fault Samples) |  | 17-Core Classifier Algorithm | Deep Neural Network |  |
| 14 | `NXMKCDDS_E178` | `motivates` | 09-Problem Scenario | mechanism interpretation(Trustworthiness / Interpretability) |  | 17-Core Classifier Algorithm | Deep Neural Network |  |
| 15 | `NXMKCDDS_E179` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Sparse Autoencoder |  |
| 16 | `NXMKCDDS_E180` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Deep Neural Network |  |
| 17 | `NXMKCDDS_E181` | `motivates` | 06-Fault Severity | 0.007 in., 0.014 in., 0.021 in.(Multiple Severities) |  | 17-Core Classifier Algorithm | Deep Neural Network |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `NXMKCDDS_E165`：lack of sufficient training data(Small Fault Samples) motivates Two-stage training
  - `NXMKCDDS_E166`：mechanism interpretation(Trustworthiness / Interpretability) motivates Two-stage training
  - `NXMKCDDS_E171`：lack of sufficient training data(Small Fault Samples) motivates SC-GAN
  - `NXMKCDDS_E172`：mechanism interpretation(Trustworthiness / Interpretability) motivates SC-GAN
  - `NXMKCDDS_E173`：lack of sufficient training data(Small Fault Samples) motivates Fixed-width windowing
  - `NXMKCDDS_E174`：mechanism interpretation(Trustworthiness / Interpretability) motivates Fixed-width windowing
  - `NXMKCDDS_E175`：lack of sufficient training data(Small Fault Samples) motivates Sparse Autoencoder
  - `NXMKCDDS_E176`：mechanism interpretation(Trustworthiness / Interpretability) motivates Sparse Autoencoder
  - `NXMKCDDS_E177`：lack of sufficient training data(Small Fault Samples) motivates Deep Neural Network
  - `NXMKCDDS_E178`：mechanism interpretation(Trustworthiness / Interpretability) motivates Deep Neural Network
