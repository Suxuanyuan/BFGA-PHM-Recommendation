...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `2UAVYSMP_E080` | `motivates` | 13-Noise Level | contaminated by background noise and instrumentation errors(High Noise) |  | 15-Data Preprocessing Algorithm | Spectral Pre-whitening |  |
| 2 | `2UAVYSMP_E081` | `motivates` | 13-Noise Level | contaminated by background noise and instrumentation errors(High Noise) |  | 16-Feature Extraction Algorithm | Generalized Demodulation |  |
| 3 | `2UAVYSMP_E082` | `motivates` | 09-Problem Scenario | nonstationary running conditions(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Spectral Pre-whitening |  |
| 4 | `2UAVYSMP_E083` | `motivates` | 09-Problem Scenario | nonstationary running conditions(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Generalized Demodulation |  |
| 5 | `2UAVYSMP_E084` | `motivates` | 09-Problem Scenario | nonstationary running conditions(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Deep Residual Network |  |
| 6 | `2UAVYSMP_E085` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Generalized Demodulation |  |
| 7 | `2UAVYSMP_E086` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Deep Residual Network |  |
| 8 | `2UAVYSMP_E087` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Deep Residual Network |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `2UAVYSMP_E082`：nonstationary running conditions(Distribution Discrepancy) motivates Spectral Pre-whitening
  - `2UAVYSMP_E083`：nonstationary running conditions(Distribution Discrepancy) motivates Generalized Demodulation
  - `2UAVYSMP_E084`：nonstationary running conditions(Distribution Discrepancy) motivates Deep Residual Network
