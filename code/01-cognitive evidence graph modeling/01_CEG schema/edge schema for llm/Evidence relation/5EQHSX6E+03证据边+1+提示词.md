...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `5EQHSX6E_E124` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 19-Training Optimization Algorithm | GWO |  |
| 2 | `5EQHSX6E_E125` | `motivates` | 09-Problem Scenario | incipient fault diagnosis(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | GWO |  |
| 3 | `5EQHSX6E_E126` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | GWO |  |
| 4 | `5EQHSX6E_E127` | `motivates` | 13-Noise Level | strong interferences generated by background noises(High Noise) |  | 15-Data Preprocessing Algorithm | TVF-EMD |  |
| 5 | `5EQHSX6E_E128` | `motivates` | 13-Noise Level | strong interferences generated by background noises(High Noise) |  | 16-Feature Extraction Algorithm | KCI |  |
| 6 | `5EQHSX6E_E129` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | TVF-EMD |  |
| 7 | `5EQHSX6E_E130` | `motivates` | 09-Problem Scenario | incipient fault diagnosis(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | TVF-EMD |  |
| 8 | `5EQHSX6E_E131` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | KCI |  |
| 9 | `5EQHSX6E_E132` | `motivates` | 09-Problem Scenario | incipient fault diagnosis(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | KCI |  |
| 10 | `5EQHSX6E_E133` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope spectrum |  |
| 11 | `5EQHSX6E_E134` | `motivates` | 09-Problem Scenario | incipient fault diagnosis(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Envelope spectrum |  |
| 12 | `5EQHSX6E_E135` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | KCI |  |
| 13 | `5EQHSX6E_E136` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope spectrum |  |
| 14 | `5EQHSX6E_E137` | `motivates` | 06-Fault Severity | crack with a depth of 3.4 mm, light defect(Single Severity) |  | 17-Core Classifier Algorithm | Envelope spectrum |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `5EQHSX6E_E124`：noise robustness(Uncertainty) motivates GWO
  - `5EQHSX6E_E125`：incipient fault diagnosis(Early Degradation Prediction) motivates GWO
  - `5EQHSX6E_E129`：noise robustness(Uncertainty) motivates TVF-EMD
  - `5EQHSX6E_E130`：incipient fault diagnosis(Early Degradation Prediction) motivates TVF-EMD
  - `5EQHSX6E_E131`：noise robustness(Uncertainty) motivates KCI
  - `5EQHSX6E_E132`：incipient fault diagnosis(Early Degradation Prediction) motivates KCI
  - `5EQHSX6E_E133`：noise robustness(Uncertainty) motivates Envelope spectrum
  - `5EQHSX6E_E134`：incipient fault diagnosis(Early Degradation Prediction) motivates Envelope spectrum
