...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `YSDAD68Z_E095` | `motivates` | 13-Noise Level | quantization and acquisition noises(High Noise) |  | 15-Data Preprocessing Algorithm | Savitzky-Golay Filter |  |
| 2 | `YSDAD68Z_E096` | `motivates` | 13-Noise Level | quantization and acquisition noises(High Noise) |  | 16-Feature Extraction Algorithm | Symmetrical Component Transformation |  |
| 3 | `YSDAD68Z_E097` | `motivates` | 09-Problem Scenario | incipient failure detection(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Savitzky-Golay Filter |  |
| 4 | `YSDAD68Z_E098` | `motivates` | 09-Problem Scenario | sensor's inherent errors(Uncertainty) |  | 15-Data Preprocessing Algorithm | Savitzky-Golay Filter |  |
| 5 | `YSDAD68Z_E099` | `motivates` | 09-Problem Scenario | closed-loop controllers hide the fault's signatures(Other) |  | 15-Data Preprocessing Algorithm | Savitzky-Golay Filter |  |
| 6 | `YSDAD68Z_E100` | `motivates` | 09-Problem Scenario | incipient failure detection(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Symmetrical Component Transformation |  |
| 7 | `YSDAD68Z_E101` | `motivates` | 09-Problem Scenario | sensor's inherent errors(Uncertainty) |  | 16-Feature Extraction Algorithm | Symmetrical Component Transformation |  |
| 8 | `YSDAD68Z_E102` | `motivates` | 09-Problem Scenario | closed-loop controllers hide the fault's signatures(Other) |  | 16-Feature Extraction Algorithm | Symmetrical Component Transformation |  |
| 9 | `YSDAD68Z_E103` | `motivates` | 09-Problem Scenario | incipient failure detection(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 10 | `YSDAD68Z_E104` | `motivates` | 09-Problem Scenario | sensor's inherent errors(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 11 | `YSDAD68Z_E105` | `motivates` | 09-Problem Scenario | closed-loop controllers hide the fault's signatures(Other) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 12 | `YSDAD68Z_E106` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Symmetrical Component Transformation |  |
| 13 | `YSDAD68Z_E107` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 14 | `YSDAD68Z_E108` | `motivates` | 06-Fault Severity | fault severity factor(Multiple Severities) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `YSDAD68Z_E097`：incipient failure detection(Early Degradation Prediction) motivates Savitzky-Golay Filter
  - `YSDAD68Z_E098`：sensor's inherent errors(Uncertainty) motivates Savitzky-Golay Filter
  - `YSDAD68Z_E099`：closed-loop controllers hide the fault's signatures(Other) motivates Savitzky-Golay Filter
  - `YSDAD68Z_E100`：incipient failure detection(Early Degradation Prediction) motivates Symmetrical Component Transformation
  - `YSDAD68Z_E101`：sensor's inherent errors(Uncertainty) motivates Symmetrical Component Transformation
  - `YSDAD68Z_E102`：closed-loop controllers hide the fault's signatures(Other) motivates Symmetrical Component Transformation
  - `YSDAD68Z_E103`：incipient failure detection(Early Degradation Prediction) motivates Threshold Decision
  - `YSDAD68Z_E104`：sensor's inherent errors(Uncertainty) motivates Threshold Decision
  - `YSDAD68Z_E105`：closed-loop controllers hide the fault's signatures(Other) motivates Threshold Decision
