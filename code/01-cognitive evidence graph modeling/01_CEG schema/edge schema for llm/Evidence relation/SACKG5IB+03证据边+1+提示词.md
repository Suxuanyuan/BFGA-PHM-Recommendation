...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SACKG5IB_E069` | `motivates` | 13-Noise Level | fault indices noise / noise rejection(High Noise) |  | 15-Data Preprocessing Algorithm | Clarke transformation |  |
| 2 | `SACKG5IB_E070` | `motivates` | 13-Noise Level | fault indices noise / noise rejection(High Noise) |  | 16-Feature Extraction Algorithm | VSD-based ratio calculation |  |
| 3 | `SACKG5IB_E071` | `motivates` | 09-Problem Scenario | robustness to parameter variations and operating transients(Uncertainty) |  | 15-Data Preprocessing Algorithm | Clarke transformation |  |
| 4 | `SACKG5IB_E072` | `motivates` | 09-Problem Scenario | robustness to parameter variations and operating transients(Uncertainty) |  | 16-Feature Extraction Algorithm | VSD-based ratio calculation |  |
| 5 | `SACKG5IB_E073` | `motivates` | 09-Problem Scenario | robustness to parameter variations and operating transients(Uncertainty) |  | 17-Core Classifier Algorithm | threshold classifier |  |
| 6 | `SACKG5IB_E074` | `motivates` | 07-Compound Fault | multiple open-phase faults(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | VSD-based ratio calculation |  |
| 7 | `SACKG5IB_E075` | `motivates` | 07-Compound Fault | multiple open-phase faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | threshold classifier |  |
| 8 | `SACKG5IB_E076` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | threshold classifier |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `SACKG5IB_E071`：robustness to parameter variations and operating transients(Uncertainty) motivates Clarke transformation
  - `SACKG5IB_E072`：robustness to parameter variations and operating transients(Uncertainty) motivates VSD-based ratio calculation
  - `SACKG5IB_E073`：robustness to parameter variations and operating transients(Uncertainty) motivates threshold classifier
