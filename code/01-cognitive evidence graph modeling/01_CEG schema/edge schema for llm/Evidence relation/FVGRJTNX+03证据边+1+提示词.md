...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `FVGRJTNX_E090` | `motivates` | 09-Problem Scenario | different feature distributions because of different operational conditions(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Wasserstein Distance-based Domain Adaptation |  |
| 2 | `FVGRJTNX_E091` | `motivates` | 09-Problem Scenario | insufficient or unlabeled data in target domains(Small Fault Samples) |  | 19-Training Optimization Algorithm | Wasserstein Distance-based Domain Adaptation |  |
| 3 | `FVGRJTNX_E092` | `motivates` | 12-Training Data Availability | insufficient labeled data(Scarce) |  | 19-Training Optimization Algorithm | Wasserstein Distance-based Domain Adaptation |  |
| 4 | `FVGRJTNX_E093` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | FFT |  |
| 5 | `FVGRJTNX_E094` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | 1-D CNN |  |
| 6 | `FVGRJTNX_E095` | `motivates` | 09-Problem Scenario | different feature distributions because of different operational conditions(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 7 | `FVGRJTNX_E096` | `motivates` | 09-Problem Scenario | insufficient or unlabeled data in target domains(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 8 | `FVGRJTNX_E097` | `motivates` | 09-Problem Scenario | different feature distributions because of different operational conditions(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | 1-D CNN |  |
| 9 | `FVGRJTNX_E098` | `motivates` | 09-Problem Scenario | insufficient or unlabeled data in target domains(Small Fault Samples) |  | 16-Feature Extraction Algorithm | 1-D CNN |  |
| 10 | `FVGRJTNX_E099` | `motivates` | 09-Problem Scenario | different feature distributions because of different operational conditions(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `FVGRJTNX_E100` | `motivates` | 09-Problem Scenario | insufficient or unlabeled data in target domains(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `FVGRJTNX_E101` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | 1-D CNN |  |
| 13 | `FVGRJTNX_E102` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `FVGRJTNX_E103` | `motivates` | 06-Fault Severity | 0.007-inch, 0.014-inch, and 0.021-inch fault diameters(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `FVGRJTNX_E090`：different feature distributions because of different operational conditions(Distribution Discrepancy) motivates Wasserstein Distance-based Domain Adaptation
  - `FVGRJTNX_E091`：insufficient or unlabeled data in target domains(Small Fault Samples) motivates Wasserstein Distance-based Domain Adaptation
  - `FVGRJTNX_E095`：different feature distributions because of different operational conditions(Distribution Discrepancy) motivates FFT
  - `FVGRJTNX_E096`：insufficient or unlabeled data in target domains(Small Fault Samples) motivates FFT
  - `FVGRJTNX_E097`：different feature distributions because of different operational conditions(Distribution Discrepancy) motivates 1-D CNN
  - `FVGRJTNX_E098`：insufficient or unlabeled data in target domains(Small Fault Samples) motivates 1-D CNN
  - `FVGRJTNX_E099`：different feature distributions because of different operational conditions(Distribution Discrepancy) motivates Softmax
  - `FVGRJTNX_E100`：insufficient or unlabeled data in target domains(Small Fault Samples) motivates Softmax
