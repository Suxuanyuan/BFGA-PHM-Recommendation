...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `YPXRJPH5_E083` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Hann window |  |
| 2 | `YPXRJPH5_E084` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 3 | `YPXRJPH5_E085` | `motivates` | 09-Problem Scenario | Unsteady loading and variable speed conditions in real operating environments(Uncertainty) |  | 15-Data Preprocessing Algorithm | Hann window |  |
| 4 | `YPXRJPH5_E086` | `motivates` | 09-Problem Scenario | Lack of in-service WT operational data and diagnosis validation(Other) |  | 15-Data Preprocessing Algorithm | Hann window |  |
| 5 | `YPXRJPH5_E087` | `motivates` | 09-Problem Scenario | Unsteady loading and variable speed conditions in real operating environments(Uncertainty) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 6 | `YPXRJPH5_E088` | `motivates` | 09-Problem Scenario | Lack of in-service WT operational data and diagnosis validation(Other) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 7 | `YPXRJPH5_E089` | `motivates` | 09-Problem Scenario | Unsteady loading and variable speed conditions in real operating environments(Uncertainty) |  | 17-Core Classifier Algorithm | Current Signature Analysis |  |
| 8 | `YPXRJPH5_E090` | `motivates` | 09-Problem Scenario | Lack of in-service WT operational data and diagnosis validation(Other) |  | 17-Core Classifier Algorithm | Current Signature Analysis |  |
| 9 | `YPXRJPH5_E091` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 10 | `YPXRJPH5_E092` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Current Signature Analysis |  |
| 11 | `YPXRJPH5_E093` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Current Signature Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `YPXRJPH5_E085`：Unsteady loading and variable speed conditions in real operating environments(Uncertainty) motivates Hann window
  - `YPXRJPH5_E086`：Lack of in-service WT operational data and diagnosis validation(Other) motivates Hann window
  - `YPXRJPH5_E087`：Unsteady loading and variable speed conditions in real operating environments(Uncertainty) motivates Fast Fourier Transform
  - `YPXRJPH5_E088`：Lack of in-service WT operational data and diagnosis validation(Other) motivates Fast Fourier Transform
  - `YPXRJPH5_E089`：Unsteady loading and variable speed conditions in real operating environments(Uncertainty) motivates Current Signature Analysis
  - `YPXRJPH5_E090`：Lack of in-service WT operational data and diagnosis validation(Other) motivates Current Signature Analysis
