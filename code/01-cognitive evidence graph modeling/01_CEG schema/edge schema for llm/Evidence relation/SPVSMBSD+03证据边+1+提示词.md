...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SPVSMBSD_E075` | `motivates` | 13-Noise Level | Normal(Normal) |  | 15-Data Preprocessing Algorithm | Maximum Correlated Kurtosis Deconvolution |  |
| 2 | `SPVSMBSD_E076` | `motivates` | 13-Noise Level | Normal(Normal) |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 3 | `SPVSMBSD_E077` | `motivates` | 09-Problem Scenario | early stage crack tooth defects(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Maximum Correlated Kurtosis Deconvolution |  |
| 4 | `SPVSMBSD_E078` | `motivates` | 09-Problem Scenario | non-stationarity and complex vibration signatures(Other) |  | 15-Data Preprocessing Algorithm | Maximum Correlated Kurtosis Deconvolution |  |
| 5 | `SPVSMBSD_E079` | `motivates` | 09-Problem Scenario | early stage crack tooth defects(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 6 | `SPVSMBSD_E080` | `motivates` | 09-Problem Scenario | non-stationarity and complex vibration signatures(Other) |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 7 | `SPVSMBSD_E081` | `motivates` | 09-Problem Scenario | early stage crack tooth defects(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Squared Envelope Analysis |  |
| 8 | `SPVSMBSD_E082` | `motivates` | 09-Problem Scenario | non-stationarity and complex vibration signatures(Other) |  | 17-Core Classifier Algorithm | Squared Envelope Analysis |  |
| 9 | `SPVSMBSD_E083` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 10 | `SPVSMBSD_E084` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Squared Envelope Analysis |  |
| 11 | `SPVSMBSD_E085` | `motivates` | 06-Fault Severity | 3 % amplitude reduction of gear mesh stiffness(Single Severity) |  | 17-Core Classifier Algorithm | Squared Envelope Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `SPVSMBSD_E077`：early stage crack tooth defects(Early Degradation Prediction) motivates Maximum Correlated Kurtosis Deconvolution
  - `SPVSMBSD_E078`：non-stationarity and complex vibration signatures(Other) motivates Maximum Correlated Kurtosis Deconvolution
  - `SPVSMBSD_E079`：early stage crack tooth defects(Early Degradation Prediction) motivates Spectral Kurtosis
  - `SPVSMBSD_E080`：non-stationarity and complex vibration signatures(Other) motivates Spectral Kurtosis
  - `SPVSMBSD_E081`：early stage crack tooth defects(Early Degradation Prediction) motivates Squared Envelope Analysis
  - `SPVSMBSD_E082`：non-stationarity and complex vibration signatures(Other) motivates Squared Envelope Analysis
