...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `UXTM8REB_E098` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 2 | `UXTM8REB_E099` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Envelope Analysis |  |
| 3 | `UXTM8REB_E100` | `motivates` | 09-Problem Scenario | fusion of electrical & mechanical signals(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 4 | `UXTM8REB_E101` | `motivates` | 09-Problem Scenario | fusion of electrical & mechanical signals(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | Envelope Analysis |  |
| 5 | `UXTM8REB_E102` | `motivates` | 09-Problem Scenario | fusion of electrical & mechanical signals(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | CUSUM |  |
| 6 | `UXTM8REB_E103` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Envelope Analysis |  |
| 7 | `UXTM8REB_E104` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | CUSUM |  |
| 8 | `UXTM8REB_E105` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | CUSUM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `UXTM8REB_E100`：fusion of electrical & mechanical signals(Multi-Source Heterogeneous / Multimodal Data) motivates Normalization
  - `UXTM8REB_E101`：fusion of electrical & mechanical signals(Multi-Source Heterogeneous / Multimodal Data) motivates Envelope Analysis
  - `UXTM8REB_E102`：fusion of electrical & mechanical signals(Multi-Source Heterogeneous / Multimodal Data) motivates CUSUM
