...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `5KZ3MKJJ_E104` | `motivates` | 09-Problem Scenario | small samples(Small Fault Samples) |  | 19-Training Optimization Algorithm | OMP |  |
| 2 | `5KZ3MKJJ_E105` | `motivates` | 09-Problem Scenario | support vector machine kernel function selection(Other) |  | 19-Training Optimization Algorithm | OMP |  |
| 3 | `5KZ3MKJJ_E106` | `motivates` | 12-Training Data Availability | Selected the first 80 points of each category as the training set / Use the first 120 of the 350 sample points of each fault as the training set(Sufficient) |  | 19-Training Optimization Algorithm | OMP |  |
| 4 | `5KZ3MKJJ_E107` | `motivates` | 13-Noise Level | A bearing fault signal is generally composed of three parts: the impact frequency, the harmonic component, and the noise. ... n(t) is noise.(High Noise) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 5 | `5KZ3MKJJ_E108` | `motivates` | 13-Noise Level | A bearing fault signal is generally composed of three parts: the impact frequency, the harmonic component, and the noise. ... n(t) is noise.(High Noise) |  | 16-Feature Extraction Algorithm | Time-domain feature extraction |  |
| 6 | `5KZ3MKJJ_E109` | `motivates` | 09-Problem Scenario | small samples(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 7 | `5KZ3MKJJ_E110` | `motivates` | 09-Problem Scenario | support vector machine kernel function selection(Other) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 8 | `5KZ3MKJJ_E111` | `motivates` | 09-Problem Scenario | small samples(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Time-domain feature extraction |  |
| 9 | `5KZ3MKJJ_E112` | `motivates` | 09-Problem Scenario | support vector machine kernel function selection(Other) |  | 16-Feature Extraction Algorithm | Time-domain feature extraction |  |
| 10 | `5KZ3MKJJ_E113` | `motivates` | 09-Problem Scenario | small samples(Small Fault Samples) |  | 17-Core Classifier Algorithm | SVM |  |
| 11 | `5KZ3MKJJ_E114` | `motivates` | 09-Problem Scenario | support vector machine kernel function selection(Other) |  | 17-Core Classifier Algorithm | SVM |  |
| 12 | `5KZ3MKJJ_E115` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Time-domain feature extraction |  |
| 13 | `5KZ3MKJJ_E116` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVM |  |
| 14 | `5KZ3MKJJ_E117` | `motivates` | 06-Fault Severity | spalling area(Multiple Severities) |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `5KZ3MKJJ_E104`：small samples(Small Fault Samples) motivates OMP
  - `5KZ3MKJJ_E105`：support vector machine kernel function selection(Other) motivates OMP
  - `5KZ3MKJJ_E109`：small samples(Small Fault Samples) motivates Normalization
  - `5KZ3MKJJ_E110`：support vector machine kernel function selection(Other) motivates Normalization
  - `5KZ3MKJJ_E111`：small samples(Small Fault Samples) motivates Time-domain feature extraction
  - `5KZ3MKJJ_E112`：support vector machine kernel function selection(Other) motivates Time-domain feature extraction
  - `5KZ3MKJJ_E113`：small samples(Small Fault Samples) motivates SVM
  - `5KZ3MKJJ_E114`：support vector machine kernel function selection(Other) motivates SVM
