...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `RWRUTBI6_E084` | `motivates` | 09-Problem Scenario | heavy noise(Uncertainty) |  | 19-Training Optimization Algorithm | SAL |  |
| 2 | `RWRUTBI6_E085` | `motivates` | 12-Training Data Availability | Test 1 and Test 2(Sufficient) |  | 19-Training Optimization Algorithm | SAL |  |
| 3 | `RWRUTBI6_E086` | `motivates` | 13-Noise Level | heavy noise(High Noise) |  | 15-Data Preprocessing Algorithm | Angular resampling |  |
| 4 | `RWRUTBI6_E087` | `motivates` | 13-Noise Level | heavy noise(High Noise) |  | 16-Feature Extraction Algorithm | Hilbert transform |  |
| 5 | `RWRUTBI6_E088` | `motivates` | 09-Problem Scenario | heavy noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Angular resampling |  |
| 6 | `RWRUTBI6_E089` | `motivates` | 09-Problem Scenario | heavy noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Hilbert transform |  |
| 7 | `RWRUTBI6_E090` | `motivates` | 09-Problem Scenario | heavy noise(Uncertainty) |  | 17-Core Classifier Algorithm | Order analysis |  |
| 8 | `RWRUTBI6_E091` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Hilbert transform |  |
| 9 | `RWRUTBI6_E092` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Order analysis |  |
| 10 | `RWRUTBI6_E093` | `motivates` | 06-Fault Severity | 5 mm wide and 9 mm long(Single Severity) |  | 17-Core Classifier Algorithm | Order analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `RWRUTBI6_E084`：heavy noise(Uncertainty) motivates SAL
  - `RWRUTBI6_E088`：heavy noise(Uncertainty) motivates Angular resampling
  - `RWRUTBI6_E089`：heavy noise(Uncertainty) motivates Hilbert transform
  - `RWRUTBI6_E090`：heavy noise(Uncertainty) motivates Order analysis
