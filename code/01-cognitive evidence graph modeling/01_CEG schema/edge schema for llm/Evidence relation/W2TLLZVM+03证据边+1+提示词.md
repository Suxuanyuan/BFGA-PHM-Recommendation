...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `W2LGQAAM_E100` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | STFT |  |
| 2 | `W2LGQAAM_E101` | `motivates` | 09-Problem Scenario | detect a slight fault / small-size hole(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | STFT |  |
| 3 | `W2LGQAAM_E102` | `motivates` | 09-Problem Scenario | diagnose the several kinds of bearing faults and the short-circuit fault in the same framework simultaneously(Other) |  | 15-Data Preprocessing Algorithm | STFT |  |
| 4 | `W2LGQAAM_E103` | `motivates` | 09-Problem Scenario | detect a slight fault / small-size hole(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | LSTM |  |
| 5 | `W2LGQAAM_E104` | `motivates` | 09-Problem Scenario | diagnose the several kinds of bearing faults and the short-circuit fault in the same framework simultaneously(Other) |  | 17-Core Classifier Algorithm | LSTM |  |
| 6 | `W2LGQAAM_E105` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | LSTM |  |
| 7 | `W2LGQAAM_E106` | `motivates` | 06-Fault Severity | 0.5 mm, 2.0 mm, 10 mm(Multiple Severities) |  | 17-Core Classifier Algorithm | LSTM |  |
| 8 | `W2TLLZVM_E164` | `motivates` | 09-Problem Scenario | domain shifts(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | FRAN |  |
| 9 | `W2TLLZVM_E165` | `motivates` | 09-Problem Scenario | early degradation stage(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | FRAN |  |
| 10 | `W2TLLZVM_E166` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | FRAN |  |
| 11 | `W2TLLZVM_E167` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 12 | `W2TLLZVM_E168` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | CNN |  |
| 13 | `W2TLLZVM_E169` | `motivates` | 09-Problem Scenario | domain shifts(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 14 | `W2TLLZVM_E170` | `motivates` | 09-Problem Scenario | early degradation stage(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 15 | `W2TLLZVM_E171` | `motivates` | 09-Problem Scenario | domain shifts(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | CNN |  |
| 16 | `W2TLLZVM_E172` | `motivates` | 09-Problem Scenario | early degradation stage(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | CNN |  |
| 17 | `W2TLLZVM_E173` | `motivates` | 09-Problem Scenario | domain shifts(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 18 | `W2TLLZVM_E174` | `motivates` | 09-Problem Scenario | early degradation stage(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Softmax |  |
| 19 | `W2TLLZVM_E175` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 20 | `W2TLLZVM_E176` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 21 | `W2TLLZVM_E177` | `motivates` | 06-Fault Severity | three severity levels (fault diameter: 0.007, 0.014, 0.021 inches), early degradation, serious fault(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `W2LGQAAM_E101`：detect a slight fault / small-size hole(Early Degradation Prediction) motivates STFT
  - `W2LGQAAM_E102`：diagnose the several kinds of bearing faults and the short-circuit fault in the same framework simultaneously(Other) motivates STFT
  - `W2LGQAAM_E103`：detect a slight fault / small-size hole(Early Degradation Prediction) motivates LSTM
  - `W2LGQAAM_E104`：diagnose the several kinds of bearing faults and the short-circuit fault in the same framework simultaneously(Other) motivates LSTM
  - `W2TLLZVM_E164`：domain shifts(Distribution Discrepancy) motivates FRAN
  - `W2TLLZVM_E165`：early degradation stage(Early Degradation Prediction) motivates FRAN
  - `W2TLLZVM_E169`：domain shifts(Distribution Discrepancy) motivates Normalization
  - `W2TLLZVM_E170`：early degradation stage(Early Degradation Prediction) motivates Normalization
  - `W2TLLZVM_E171`：domain shifts(Distribution Discrepancy) motivates CNN
  - `W2TLLZVM_E172`：early degradation stage(Early Degradation Prediction) motivates CNN
  - `W2TLLZVM_E173`：domain shifts(Distribution Discrepancy) motivates Softmax
  - `W2TLLZVM_E174`：early degradation stage(Early Degradation Prediction) motivates Softmax
