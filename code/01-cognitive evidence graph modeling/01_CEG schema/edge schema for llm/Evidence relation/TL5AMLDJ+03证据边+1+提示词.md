...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TL5AMLDJ_E108` | `motivates` | 09-Problem Scenario | complex transmission path of planetary gears(Complex Systems) |  | 19-Training Optimization Algorithm | Unsupervised pre-training |  |
| 2 | `TL5AMLDJ_E109` | `motivates` | 09-Problem Scenario | unstable and insensitive features(Uncertainty) |  | 19-Training Optimization Algorithm | Unsupervised pre-training |  |
| 3 | `TL5AMLDJ_E110` | `motivates` | 12-Training Data Availability | 60 sets of each fault were used to train the neural network(Sufficient) |  | 19-Training Optimization Algorithm | Unsupervised pre-training |  |
| 4 | `TL5AMLDJ_E111` | `motivates` | 13-Noise Level | noise robustness, noise signal(High Noise) |  | 15-Data Preprocessing Algorithm | Variational Mode Decomposition |  |
| 5 | `TL5AMLDJ_E112` | `motivates` | 13-Noise Level | noise robustness, noise signal(High Noise) |  | 16-Feature Extraction Algorithm | Power Spectral Entropy |  |
| 6 | `TL5AMLDJ_E113` | `motivates` | 09-Problem Scenario | complex transmission path of planetary gears(Complex Systems) |  | 15-Data Preprocessing Algorithm | Variational Mode Decomposition |  |
| 7 | `TL5AMLDJ_E114` | `motivates` | 09-Problem Scenario | unstable and insensitive features(Uncertainty) |  | 15-Data Preprocessing Algorithm | Variational Mode Decomposition |  |
| 8 | `TL5AMLDJ_E115` | `motivates` | 09-Problem Scenario | complex transmission path of planetary gears(Complex Systems) |  | 16-Feature Extraction Algorithm | Power Spectral Entropy |  |
| 9 | `TL5AMLDJ_E116` | `motivates` | 09-Problem Scenario | unstable and insensitive features(Uncertainty) |  | 16-Feature Extraction Algorithm | Power Spectral Entropy |  |
| 10 | `TL5AMLDJ_E117` | `motivates` | 09-Problem Scenario | complex transmission path of planetary gears(Complex Systems) |  | 17-Core Classifier Algorithm | Deep Neural Network |  |
| 11 | `TL5AMLDJ_E118` | `motivates` | 09-Problem Scenario | unstable and insensitive features(Uncertainty) |  | 17-Core Classifier Algorithm | Deep Neural Network |  |
| 12 | `TL5AMLDJ_E119` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Power Spectral Entropy |  |
| 13 | `TL5AMLDJ_E120` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Deep Neural Network |  |
| 14 | `TL5AMLDJ_E121` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Deep Neural Network |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `TL5AMLDJ_E108`：complex transmission path of planetary gears(Complex Systems) motivates Unsupervised pre-training
  - `TL5AMLDJ_E109`：unstable and insensitive features(Uncertainty) motivates Unsupervised pre-training
  - `TL5AMLDJ_E113`：complex transmission path of planetary gears(Complex Systems) motivates Variational Mode Decomposition
  - `TL5AMLDJ_E114`：unstable and insensitive features(Uncertainty) motivates Variational Mode Decomposition
  - `TL5AMLDJ_E115`：complex transmission path of planetary gears(Complex Systems) motivates Power Spectral Entropy
  - `TL5AMLDJ_E116`：unstable and insensitive features(Uncertainty) motivates Power Spectral Entropy
  - `TL5AMLDJ_E117`：complex transmission path of planetary gears(Complex Systems) motivates Deep Neural Network
  - `TL5AMLDJ_E118`：unstable and insensitive features(Uncertainty) motivates Deep Neural Network
