...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4EYEBBKT_E150` | `motivates` | 09-Problem Scenario | combination of sound texture and vibration entropy characteristics(Multi-Source Heterogeneous / Multimodal Data) |  | 19-Training Optimization Algorithm | GWO |  |
| 2 | `4EYEBBKT_E151` | `motivates` | 09-Problem Scenario | sensor frequency response, environmental noise, and load fluctuation disturbance(Uncertainty) |  | 19-Training Optimization Algorithm | GWO |  |
| 3 | `4EYEBBKT_E152` | `motivates` | 09-Problem Scenario | changes in acquisition parameter settings, sensor types, and positions(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | GWO |  |
| 4 | `4EYEBBKT_E153` | `motivates` | 12-Training Data Availability | 60 sets of samples were collected for each state, 40 sets were used for training(Sufficient) |  | 19-Training Optimization Algorithm | GWO |  |
| 5 | `4EYEBBKT_E154` | `motivates` | 13-Noise Level | environmental noise, and load fluctuation disturbance, belt friction noise of oil pumping machine, the noise of the motor, wind noise, thunder noise, and human voice(High Noise) |  | 15-Data Preprocessing Algorithm | Band-pass filter |  |
| 6 | `4EYEBBKT_E155` | `motivates` | 13-Noise Level | environmental noise, and load fluctuation disturbance, belt friction noise of oil pumping machine, the noise of the motor, wind noise, thunder noise, and human voice(High Noise) |  | 16-Feature Extraction Algorithm | Generalized S-transform |  |
| 7 | `4EYEBBKT_E156` | `motivates` | 09-Problem Scenario | combination of sound texture and vibration entropy characteristics(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Band-pass filter |  |
| 8 | `4EYEBBKT_E157` | `motivates` | 09-Problem Scenario | sensor frequency response, environmental noise, and load fluctuation disturbance(Uncertainty) |  | 15-Data Preprocessing Algorithm | Band-pass filter |  |
| 9 | `4EYEBBKT_E158` | `motivates` | 09-Problem Scenario | changes in acquisition parameter settings, sensor types, and positions(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Band-pass filter |  |
| 10 | `4EYEBBKT_E159` | `motivates` | 09-Problem Scenario | combination of sound texture and vibration entropy characteristics(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | Generalized S-transform |  |
| 11 | `4EYEBBKT_E160` | `motivates` | 09-Problem Scenario | sensor frequency response, environmental noise, and load fluctuation disturbance(Uncertainty) |  | 16-Feature Extraction Algorithm | Generalized S-transform |  |
| 12 | `4EYEBBKT_E161` | `motivates` | 09-Problem Scenario | changes in acquisition parameter settings, sensor types, and positions(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Generalized S-transform |  |
| 13 | `4EYEBBKT_E162` | `motivates` | 09-Problem Scenario | combination of sound texture and vibration entropy characteristics(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | SVM |  |
| 14 | `4EYEBBKT_E163` | `motivates` | 09-Problem Scenario | sensor frequency response, environmental noise, and load fluctuation disturbance(Uncertainty) |  | 17-Core Classifier Algorithm | SVM |  |
| 15 | `4EYEBBKT_E164` | `motivates` | 09-Problem Scenario | changes in acquisition parameter settings, sensor types, and positions(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | SVM |  |
| 16 | `4EYEBBKT_E165` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Generalized S-transform |  |
| 17 | `4EYEBBKT_E166` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVM |  |
| 18 | `4EYEBBKT_E167` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4EYEBBKT_E150`：combination of sound texture and vibration entropy characteristics(Multi-Source Heterogeneous / Multimodal Data) motivates GWO
  - `4EYEBBKT_E151`：sensor frequency response, environmental noise, and load fluctuation disturbance(Uncertainty) motivates GWO
  - `4EYEBBKT_E152`：changes in acquisition parameter settings, sensor types, and positions(Distribution Discrepancy) motivates GWO
  - `4EYEBBKT_E156`：combination of sound texture and vibration entropy characteristics(Multi-Source Heterogeneous / Multimodal Data) motivates Band-pass filter
  - `4EYEBBKT_E157`：sensor frequency response, environmental noise, and load fluctuation disturbance(Uncertainty) motivates Band-pass filter
  - `4EYEBBKT_E158`：changes in acquisition parameter settings, sensor types, and positions(Distribution Discrepancy) motivates Band-pass filter
  - `4EYEBBKT_E159`：combination of sound texture and vibration entropy characteristics(Multi-Source Heterogeneous / Multimodal Data) motivates Generalized S-transform
  - `4EYEBBKT_E160`：sensor frequency response, environmental noise, and load fluctuation disturbance(Uncertainty) motivates Generalized S-transform
  - `4EYEBBKT_E161`：changes in acquisition parameter settings, sensor types, and positions(Distribution Discrepancy) motivates Generalized S-transform
  - `4EYEBBKT_E162`：combination of sound texture and vibration entropy characteristics(Multi-Source Heterogeneous / Multimodal Data) motivates SVM
  - `4EYEBBKT_E163`：sensor frequency response, environmental noise, and load fluctuation disturbance(Uncertainty) motivates SVM
  - `4EYEBBKT_E164`：changes in acquisition parameter settings, sensor types, and positions(Distribution Discrepancy) motivates SVM
