...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `Z5TKUTPL_E086` | `motivates` | 09-Problem Scenario | diagnose the developing faults when the classifier is trained by the incipient faulty samples(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Improved Bayesian belief method |  |
| 2 | `Z5TKUTPL_E087` | `motivates` | 09-Problem Scenario | the diagnosis accuracy is affected by the number of samples in each class(Small Fault Samples) |  | 19-Training Optimization Algorithm | Improved Bayesian belief method |  |
| 3 | `Z5TKUTPL_E088` | `motivates` | 09-Problem Scenario | performance of FAM is affected by the sequence of sample presentation(Uncertainty) |  | 19-Training Optimization Algorithm | Improved Bayesian belief method |  |
| 4 | `Z5TKUTPL_E089` | `motivates` | 12-Training Data Availability | The number of training samples(Scarce) |  | 19-Training Optimization Algorithm | Improved Bayesian belief method |  |
| 5 | `Z5TKUTPL_E090` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Continuous Morlet wavelet analysis |  |
| 6 | `Z5TKUTPL_E091` | `motivates` | 09-Problem Scenario | diagnose the developing faults when the classifier is trained by the incipient faulty samples(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Continuous Morlet wavelet analysis |  |
| 7 | `Z5TKUTPL_E092` | `motivates` | 09-Problem Scenario | the diagnosis accuracy is affected by the number of samples in each class(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Continuous Morlet wavelet analysis |  |
| 8 | `Z5TKUTPL_E093` | `motivates` | 09-Problem Scenario | performance of FAM is affected by the sequence of sample presentation(Uncertainty) |  | 16-Feature Extraction Algorithm | Continuous Morlet wavelet analysis |  |
| 9 | `Z5TKUTPL_E094` | `motivates` | 09-Problem Scenario | diagnose the developing faults when the classifier is trained by the incipient faulty samples(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Fuzzy ARTMAP |  |
| 10 | `Z5TKUTPL_E095` | `motivates` | 09-Problem Scenario | the diagnosis accuracy is affected by the number of samples in each class(Small Fault Samples) |  | 17-Core Classifier Algorithm | Fuzzy ARTMAP |  |
| 11 | `Z5TKUTPL_E096` | `motivates` | 09-Problem Scenario | performance of FAM is affected by the sequence of sample presentation(Uncertainty) |  | 17-Core Classifier Algorithm | Fuzzy ARTMAP |  |
| 12 | `Z5TKUTPL_E097` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Continuous Morlet wavelet analysis |  |
| 13 | `Z5TKUTPL_E098` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Fuzzy ARTMAP |  |
| 14 | `Z5TKUTPL_E099` | `motivates` | 06-Fault Severity | defect diameters (0.007, 0.014, 0.021, 0.028 in.)(Multiple Severities) |  | 17-Core Classifier Algorithm | Fuzzy ARTMAP |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `Z5TKUTPL_E086`：diagnose the developing faults when the classifier is trained by the incipient faulty samples(Distribution Discrepancy) motivates Improved Bayesian belief method
  - `Z5TKUTPL_E087`：the diagnosis accuracy is affected by the number of samples in each class(Small Fault Samples) motivates Improved Bayesian belief method
  - `Z5TKUTPL_E088`：performance of FAM is affected by the sequence of sample presentation(Uncertainty) motivates Improved Bayesian belief method
  - `Z5TKUTPL_E091`：diagnose the developing faults when the classifier is trained by the incipient faulty samples(Distribution Discrepancy) motivates Continuous Morlet wavelet analysis
  - `Z5TKUTPL_E092`：the diagnosis accuracy is affected by the number of samples in each class(Small Fault Samples) motivates Continuous Morlet wavelet analysis
  - `Z5TKUTPL_E093`：performance of FAM is affected by the sequence of sample presentation(Uncertainty) motivates Continuous Morlet wavelet analysis
  - `Z5TKUTPL_E094`：diagnose the developing faults when the classifier is trained by the incipient faulty samples(Distribution Discrepancy) motivates Fuzzy ARTMAP
  - `Z5TKUTPL_E095`：the diagnosis accuracy is affected by the number of samples in each class(Small Fault Samples) motivates Fuzzy ARTMAP
  - `Z5TKUTPL_E096`：performance of FAM is affected by the sequence of sample presentation(Uncertainty) motivates Fuzzy ARTMAP
