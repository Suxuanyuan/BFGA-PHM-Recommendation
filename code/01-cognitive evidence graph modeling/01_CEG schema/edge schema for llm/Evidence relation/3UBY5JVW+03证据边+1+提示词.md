...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3UBY5JVW_E135` | `motivates` | 12-Training Data Availability | Experimental test runs(Sufficient) |  | 18-Data Generation Algorithm | d-q Model |  |
| 2 | `3UBY5JVW_E136` | `motivates` | 13-Noise Level | Measured currents and voltages(Normal) |  | 15-Data Preprocessing Algorithm | Clarke Transform |  |
| 3 | `3UBY5JVW_E137` | `motivates` | 13-Noise Level | Measured currents and voltages(Normal) |  | 16-Feature Extraction Algorithm | SCSVIF |  |
| 4 | `3UBY5JVW_E138` | `motivates` | 09-Problem Scenario | early stage non-invasive gear fault detection(Early Degradation Prediction) |  | 18-Data Generation Algorithm | d-q Model |  |
| 5 | `3UBY5JVW_E139` | `motivates` | 09-Problem Scenario | non-invasive fault detection(Other) |  | 18-Data Generation Algorithm | d-q Model |  |
| 6 | `3UBY5JVW_E140` | `motivates` | 09-Problem Scenario | early stage non-invasive gear fault detection(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Clarke Transform |  |
| 7 | `3UBY5JVW_E141` | `motivates` | 09-Problem Scenario | non-invasive fault detection(Other) |  | 15-Data Preprocessing Algorithm | Clarke Transform |  |
| 8 | `3UBY5JVW_E142` | `motivates` | 09-Problem Scenario | early stage non-invasive gear fault detection(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | SCSVIF |  |
| 9 | `3UBY5JVW_E143` | `motivates` | 09-Problem Scenario | non-invasive fault detection(Other) |  | 16-Feature Extraction Algorithm | SCSVIF |  |
| 10 | `3UBY5JVW_E144` | `motivates` | 09-Problem Scenario | early stage non-invasive gear fault detection(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 11 | `3UBY5JVW_E145` | `motivates` | 09-Problem Scenario | non-invasive fault detection(Other) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 12 | `3UBY5JVW_E146` | `motivates` | 07-Compound Fault | simultaneous synchronous and simultaneous asynchronous pinion-wheel gear tooth surface damage faults(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | SCSVIF |  |
| 13 | `3UBY5JVW_E147` | `motivates` | 07-Compound Fault | simultaneous synchronous and simultaneous asynchronous pinion-wheel gear tooth surface damage faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 14 | `3UBY5JVW_E148` | `motivates` | 06-Fault Severity | deeps of about 0.3mm(Single Severity) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `3UBY5JVW_E138`：early stage non-invasive gear fault detection(Early Degradation Prediction) motivates d-q Model
  - `3UBY5JVW_E139`：non-invasive fault detection(Other) motivates d-q Model
  - `3UBY5JVW_E140`：early stage non-invasive gear fault detection(Early Degradation Prediction) motivates Clarke Transform
  - `3UBY5JVW_E141`：non-invasive fault detection(Other) motivates Clarke Transform
  - `3UBY5JVW_E142`：early stage non-invasive gear fault detection(Early Degradation Prediction) motivates SCSVIF
  - `3UBY5JVW_E143`：non-invasive fault detection(Other) motivates SCSVIF
  - `3UBY5JVW_E144`：early stage non-invasive gear fault detection(Early Degradation Prediction) motivates Threshold Decision
  - `3UBY5JVW_E145`：non-invasive fault detection(Other) motivates Threshold Decision
