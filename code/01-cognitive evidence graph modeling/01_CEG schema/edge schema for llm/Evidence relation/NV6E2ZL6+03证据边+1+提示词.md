...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `NV6E2ZL6_E061` | `motivates` | 09-Problem Scenario | model variance(Uncertainty) |  | 19-Training Optimization Algorithm | Normal-inverse-Wishart prior |  |
| 2 | `NV6E2ZL6_E062` | `motivates` | 12-Training Data Availability | N = 1000, N = 200(Sufficient) |  | 19-Training Optimization Algorithm | Normal-inverse-Wishart prior |  |
| 3 | `NV6E2ZL6_E063` | `motivates` | 09-Problem Scenario | model variance(Uncertainty) |  | 17-Core Classifier Algorithm | Bayesian hypothesis testing |  |
| 4 | `NV6E2ZL6_E064` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Bayesian hypothesis testing |  |
| 5 | `NV6E2ZL6_E065` | `motivates` | 06-Fault Severity | fault magnitude z*(Multiple Severities) |  | 17-Core Classifier Algorithm | Bayesian hypothesis testing |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `NV6E2ZL6_E061`：model variance(Uncertainty) motivates Normal-inverse-Wishart prior
  - `NV6E2ZL6_E063`：model variance(Uncertainty) motivates Bayesian hypothesis testing
