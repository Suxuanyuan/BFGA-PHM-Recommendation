...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VERUCUQD_E178` | `motivates` | 09-Problem Scenario | poor model interpretability(Trustworthiness / Interpretability) |  | 19-Training Optimization Algorithm | Minorization-Maximization Algorithm |  |
| 2 | `VERUCUQD_E179` | `motivates` | 09-Problem Scenario | small-sample-size data, singularity problem(Small Fault Samples) |  | 19-Training Optimization Algorithm | Minorization-Maximization Algorithm |  |
| 3 | `VERUCUQD_E180` | `motivates` | 12-Training Data Availability | 50 fault samples of each fault(Sufficient) |  | 19-Training Optimization Algorithm | Minorization-Maximization Algorithm |  |
| 4 | `VERUCUQD_E181` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Z-score Standardization |  |
| 5 | `VERUCUQD_E182` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Matrix Exponential Mapping |  |
| 6 | `VERUCUQD_E183` | `motivates` | 09-Problem Scenario | poor model interpretability(Trustworthiness / Interpretability) |  | 15-Data Preprocessing Algorithm | Z-score Standardization |  |
| 7 | `VERUCUQD_E184` | `motivates` | 09-Problem Scenario | small-sample-size data, singularity problem(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Z-score Standardization |  |
| 8 | `VERUCUQD_E185` | `motivates` | 09-Problem Scenario | poor model interpretability(Trustworthiness / Interpretability) |  | 16-Feature Extraction Algorithm | Matrix Exponential Mapping |  |
| 9 | `VERUCUQD_E186` | `motivates` | 09-Problem Scenario | small-sample-size data, singularity problem(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Matrix Exponential Mapping |  |
| 10 | `VERUCUQD_E187` | `motivates` | 09-Problem Scenario | poor model interpretability(Trustworthiness / Interpretability) |  | 17-Core Classifier Algorithm | Sparse Exponential Discriminant Analysis |  |
| 11 | `VERUCUQD_E188` | `motivates` | 09-Problem Scenario | small-sample-size data, singularity problem(Small Fault Samples) |  | 17-Core Classifier Algorithm | Sparse Exponential Discriminant Analysis |  |
| 12 | `VERUCUQD_E189` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Matrix Exponential Mapping |  |
| 13 | `VERUCUQD_E190` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Sparse Exponential Discriminant Analysis |  |
| 14 | `VERUCUQD_E191` | `motivates` | 06-Fault Severity | increased by 25%(Single Severity) |  | 17-Core Classifier Algorithm | Sparse Exponential Discriminant Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `VERUCUQD_E178`：poor model interpretability(Trustworthiness / Interpretability) motivates Minorization-Maximization Algorithm
  - `VERUCUQD_E179`：small-sample-size data, singularity problem(Small Fault Samples) motivates Minorization-Maximization Algorithm
  - `VERUCUQD_E183`：poor model interpretability(Trustworthiness / Interpretability) motivates Z-score Standardization
  - `VERUCUQD_E184`：small-sample-size data, singularity problem(Small Fault Samples) motivates Z-score Standardization
  - `VERUCUQD_E185`：poor model interpretability(Trustworthiness / Interpretability) motivates Matrix Exponential Mapping
  - `VERUCUQD_E186`：small-sample-size data, singularity problem(Small Fault Samples) motivates Matrix Exponential Mapping
  - `VERUCUQD_E187`：poor model interpretability(Trustworthiness / Interpretability) motivates Sparse Exponential Discriminant Analysis
  - `VERUCUQD_E188`：small-sample-size data, singularity problem(Small Fault Samples) motivates Sparse Exponential Discriminant Analysis
