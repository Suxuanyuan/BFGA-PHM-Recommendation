...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3CCIQCBA_E075` | `motivates` | 13-Noise Level | noise and impulse component(Normal) |  | 15-Data Preprocessing Algorithm | Short-Time Fourier Transform |  |
| 2 | `3CCIQCBA_E076` | `motivates` | 13-Noise Level | noise and impulse component(Normal) |  | 16-Feature Extraction Algorithm | Supervised Non-negative Matrix Factorization |  |
| 3 | `3CCIQCBA_E077` | `motivates` | 09-Problem Scenario | high dimensional feature space(Other) |  | 15-Data Preprocessing Algorithm | Short-Time Fourier Transform |  |
| 4 | `3CCIQCBA_E078` | `motivates` | 09-Problem Scenario | parts-based representation(Trustworthiness / Interpretability) |  | 15-Data Preprocessing Algorithm | Short-Time Fourier Transform |  |
| 5 | `3CCIQCBA_E079` | `motivates` | 09-Problem Scenario | high dimensional feature space(Other) |  | 16-Feature Extraction Algorithm | Supervised Non-negative Matrix Factorization |  |
| 6 | `3CCIQCBA_E080` | `motivates` | 09-Problem Scenario | parts-based representation(Trustworthiness / Interpretability) |  | 16-Feature Extraction Algorithm | Supervised Non-negative Matrix Factorization |  |
| 7 | `3CCIQCBA_E081` | `motivates` | 09-Problem Scenario | high dimensional feature space(Other) |  | 17-Core Classifier Algorithm | Non-negative Matrix Factorization |  |
| 8 | `3CCIQCBA_E082` | `motivates` | 09-Problem Scenario | parts-based representation(Trustworthiness / Interpretability) |  | 17-Core Classifier Algorithm | Non-negative Matrix Factorization |  |
| 9 | `3CCIQCBA_E083` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Supervised Non-negative Matrix Factorization |  |
| 10 | `3CCIQCBA_E084` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Non-negative Matrix Factorization |  |
| 11 | `3CCIQCBA_E085` | `motivates` | 06-Fault Severity | fault diameters(Multiple Severities) |  | 17-Core Classifier Algorithm | Non-negative Matrix Factorization |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `3CCIQCBA_E077`：high dimensional feature space(Other) motivates Short-Time Fourier Transform
  - `3CCIQCBA_E078`：parts-based representation(Trustworthiness / Interpretability) motivates Short-Time Fourier Transform
  - `3CCIQCBA_E079`：high dimensional feature space(Other) motivates Supervised Non-negative Matrix Factorization
  - `3CCIQCBA_E080`：parts-based representation(Trustworthiness / Interpretability) motivates Supervised Non-negative Matrix Factorization
  - `3CCIQCBA_E081`：high dimensional feature space(Other) motivates Non-negative Matrix Factorization
  - `3CCIQCBA_E082`：parts-based representation(Trustworthiness / Interpretability) motivates Non-negative Matrix Factorization
