...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `RGC8ZLE6_E079` | `motivates` | 13-Noise Level | RF interference from partial discharge and HV transients(High Noise) |  | 16-Feature Extraction Algorithm | Von Karman equation |  |
| 2 | `RGC8ZLE6_E080` | `motivates` | 09-Problem Scenario | low intensity faults / degrading insulation(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Von Karman equation |  |
| 3 | `RGC8ZLE6_E081` | `motivates` | 09-Problem Scenario | HV gradients and stresses(Other) |  | 16-Feature Extraction Algorithm | Von Karman equation |  |
| 4 | `RGC8ZLE6_E082` | `motivates` | 09-Problem Scenario | low intensity faults / degrading insulation(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | MEMS generator |  |
| 5 | `RGC8ZLE6_E083` | `motivates` | 09-Problem Scenario | HV gradients and stresses(Other) |  | 17-Core Classifier Algorithm | MEMS generator |  |
| 6 | `RGC8ZLE6_E084` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Von Karman equation |  |
| 7 | `RGC8ZLE6_E085` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | MEMS generator |  |
| 8 | `RGC8ZLE6_E086` | `motivates` | 06-Fault Severity | low intensity faults, minor fault conditions, extreme faults(Multiple Severities) |  | 17-Core Classifier Algorithm | MEMS generator |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `RGC8ZLE6_E080`：low intensity faults / degrading insulation(Early Degradation Prediction) motivates Von Karman equation
  - `RGC8ZLE6_E081`：HV gradients and stresses(Other) motivates Von Karman equation
  - `RGC8ZLE6_E082`：low intensity faults / degrading insulation(Early Degradation Prediction) motivates MEMS generator
  - `RGC8ZLE6_E083`：HV gradients and stresses(Other) motivates MEMS generator
