...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XT4QFD6S_E112` | `motivates` | 13-Noise Level | white Gaussian noise, SNR from 1 to 40 dB(High Noise) |  | 15-Data Preprocessing Algorithm | Bandpass Filter |  |
| 2 | `XT4QFD6S_E113` | `motivates` | 13-Noise Level | white Gaussian noise, SNR from 1 to 40 dB(High Noise) |  | 16-Feature Extraction Algorithm | Empirical Demodulation |  |
| 3 | `XT4QFD6S_E114` | `motivates` | 09-Problem Scenario | noise presence(Uncertainty) |  | 15-Data Preprocessing Algorithm | Bandpass Filter |  |
| 4 | `XT4QFD6S_E115` | `motivates` | 09-Problem Scenario | computational complexity(Other) |  | 15-Data Preprocessing Algorithm | Bandpass Filter |  |
| 5 | `XT4QFD6S_E116` | `motivates` | 09-Problem Scenario | noise presence(Uncertainty) |  | 16-Feature Extraction Algorithm | Empirical Demodulation |  |
| 6 | `XT4QFD6S_E117` | `motivates` | 09-Problem Scenario | computational complexity(Other) |  | 16-Feature Extraction Algorithm | Empirical Demodulation |  |
| 7 | `XT4QFD6S_E118` | `motivates` | 09-Problem Scenario | noise presence(Uncertainty) |  | 17-Core Classifier Algorithm | Fast Fourier Transform |  |
| 8 | `XT4QFD6S_E119` | `motivates` | 09-Problem Scenario | computational complexity(Other) |  | 17-Core Classifier Algorithm | Fast Fourier Transform |  |
| 9 | `XT4QFD6S_E120` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Empirical Demodulation |  |
| 10 | `XT4QFD6S_E121` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Fast Fourier Transform |  |
| 11 | `XT4QFD6S_E122` | `motivates` | 06-Fault Severity | two-, four-, and eight-turn short circuits(Multiple Severities) |  | 17-Core Classifier Algorithm | Fast Fourier Transform |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `XT4QFD6S_E114`：noise presence(Uncertainty) motivates Bandpass Filter
  - `XT4QFD6S_E115`：computational complexity(Other) motivates Bandpass Filter
  - `XT4QFD6S_E116`：noise presence(Uncertainty) motivates Empirical Demodulation
  - `XT4QFD6S_E117`：computational complexity(Other) motivates Empirical Demodulation
  - `XT4QFD6S_E118`：noise presence(Uncertainty) motivates Fast Fourier Transform
  - `XT4QFD6S_E119`：computational complexity(Other) motivates Fast Fourier Transform
