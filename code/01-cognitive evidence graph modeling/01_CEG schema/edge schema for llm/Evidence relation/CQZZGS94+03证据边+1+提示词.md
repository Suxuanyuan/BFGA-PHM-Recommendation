...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CQZZGS94_E071` | `motivates` | 13-Noise Level | Not mentioned(Normal) |  | 15-Data Preprocessing Algorithm | Framing |  |
| 2 | `CQZZGS94_E072` | `motivates` | 13-Noise Level | Not mentioned(Normal) |  | 16-Feature Extraction Algorithm | Fisher Vector Encoding |  |
| 3 | `CQZZGS94_E073` | `motivates` | 09-Problem Scenario | statistical features exhibits non-linear characteristics(Other) |  | 15-Data Preprocessing Algorithm | Framing |  |
| 4 | `CQZZGS94_E074` | `motivates` | 09-Problem Scenario | statistical features exhibits non-linear characteristics(Other) |  | 16-Feature Extraction Algorithm | Fisher Vector Encoding |  |
| 5 | `CQZZGS94_E075` | `motivates` | 09-Problem Scenario | statistical features exhibits non-linear characteristics(Other) |  | 17-Core Classifier Algorithm | Linear Support Vector Machine |  |
| 6 | `CQZZGS94_E076` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Fisher Vector Encoding |  |
| 7 | `CQZZGS94_E077` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Linear Support Vector Machine |  |
| 8 | `CQZZGS94_E078` | `motivates` | 06-Fault Severity | 30%, 60%, and 82% of the total number of turns(Multiple Severities) |  | 17-Core Classifier Algorithm | Linear Support Vector Machine |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `CQZZGS94_E073`：statistical features exhibits non-linear characteristics(Other) motivates Framing
  - `CQZZGS94_E074`：statistical features exhibits non-linear characteristics(Other) motivates Fisher Vector Encoding
  - `CQZZGS94_E075`：statistical features exhibits non-linear characteristics(Other) motivates Linear Support Vector Machine
