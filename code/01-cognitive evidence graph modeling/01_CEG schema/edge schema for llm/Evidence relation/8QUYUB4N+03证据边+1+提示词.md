...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `8QUYUB4N_E084` | `motivates` | 13-Noise Level | low signal-to-noise ratio(High Noise) |  | 15-Data Preprocessing Algorithm | Bandpass Filter |  |
| 2 | `8QUYUB4N_E085` | `motivates` | 13-Noise Level | low signal-to-noise ratio(High Noise) |  | 16-Feature Extraction Algorithm | Instantaneous Power Calculation |  |
| 3 | `8QUYUB4N_E086` | `motivates` | 09-Problem Scenario | turn fault involving few turns resulting in a benign fault signature(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Bandpass Filter |  |
| 4 | `8QUYUB4N_E087` | `motivates` | 09-Problem Scenario | influence of machine inherent asymmetry, sensor inaccuracies, and transients on false alarms(Uncertainty) |  | 15-Data Preprocessing Algorithm | Bandpass Filter |  |
| 5 | `8QUYUB4N_E088` | `motivates` | 09-Problem Scenario | turn fault involving few turns resulting in a benign fault signature(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Instantaneous Power Calculation |  |
| 6 | `8QUYUB4N_E089` | `motivates` | 09-Problem Scenario | influence of machine inherent asymmetry, sensor inaccuracies, and transients on false alarms(Uncertainty) |  | 16-Feature Extraction Algorithm | Instantaneous Power Calculation |  |
| 7 | `8QUYUB4N_E090` | `motivates` | 09-Problem Scenario | turn fault involving few turns resulting in a benign fault signature(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Threshold Decision Logic |  |
| 8 | `8QUYUB4N_E091` | `motivates` | 09-Problem Scenario | influence of machine inherent asymmetry, sensor inaccuracies, and transients on false alarms(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold Decision Logic |  |
| 9 | `8QUYUB4N_E092` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Instantaneous Power Calculation |  |
| 10 | `8QUYUB4N_E093` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold Decision Logic |  |
| 11 | `8QUYUB4N_E094` | `motivates` | 06-Fault Severity | Faulty turn number Nf = 1(Single Severity) |  | 17-Core Classifier Algorithm | Threshold Decision Logic |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `8QUYUB4N_E086`：turn fault involving few turns resulting in a benign fault signature(Early Degradation Prediction) motivates Bandpass Filter
  - `8QUYUB4N_E087`：influence of machine inherent asymmetry, sensor inaccuracies, and transients on false alarms(Uncertainty) motivates Bandpass Filter
  - `8QUYUB4N_E088`：turn fault involving few turns resulting in a benign fault signature(Early Degradation Prediction) motivates Instantaneous Power Calculation
  - `8QUYUB4N_E089`：influence of machine inherent asymmetry, sensor inaccuracies, and transients on false alarms(Uncertainty) motivates Instantaneous Power Calculation
  - `8QUYUB4N_E090`：turn fault involving few turns resulting in a benign fault signature(Early Degradation Prediction) motivates Threshold Decision Logic
  - `8QUYUB4N_E091`：influence of machine inherent asymmetry, sensor inaccuracies, and transients on false alarms(Uncertainty) motivates Threshold Decision Logic
