...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4GNGWQBP_E129` | `motivates` | 13-Noise Level | noise(High Noise) |  | 15-Data Preprocessing Algorithm | Wavelet transform |  |
| 2 | `4GNGWQBP_E130` | `motivates` | 13-Noise Level | noise(High Noise) |  | 16-Feature Extraction Algorithm | Adaptive chirp mode decomposition |  |
| 3 | `4GNGWQBP_E131` | `motivates` | 09-Problem Scenario | complex and nonlinear mechanism system(Complex Systems) |  | 15-Data Preprocessing Algorithm | Wavelet transform |  |
| 4 | `4GNGWQBP_E132` | `motivates` | 09-Problem Scenario | highly time-varying and non-stationary vibration signals submerged in noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Wavelet transform |  |
| 5 | `4GNGWQBP_E133` | `motivates` | 09-Problem Scenario | complex and nonlinear mechanism system(Complex Systems) |  | 16-Feature Extraction Algorithm | Adaptive chirp mode decomposition |  |
| 6 | `4GNGWQBP_E134` | `motivates` | 09-Problem Scenario | highly time-varying and non-stationary vibration signals submerged in noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Adaptive chirp mode decomposition |  |
| 7 | `4GNGWQBP_E135` | `motivates` | 09-Problem Scenario | complex and nonlinear mechanism system(Complex Systems) |  | 17-Core Classifier Algorithm | RST feature space decision |  |
| 8 | `4GNGWQBP_E136` | `motivates` | 09-Problem Scenario | highly time-varying and non-stationary vibration signals submerged in noise(Uncertainty) |  | 17-Core Classifier Algorithm | RST feature space decision |  |
| 9 | `4GNGWQBP_E137` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Adaptive chirp mode decomposition |  |
| 10 | `4GNGWQBP_E138` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | RST feature space decision |  |
| 11 | `4GNGWQBP_E139` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | RST feature space decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4GNGWQBP_E131`：complex and nonlinear mechanism system(Complex Systems) motivates Wavelet transform
  - `4GNGWQBP_E132`：highly time-varying and non-stationary vibration signals submerged in noise(Uncertainty) motivates Wavelet transform
  - `4GNGWQBP_E133`：complex and nonlinear mechanism system(Complex Systems) motivates Adaptive chirp mode decomposition
  - `4GNGWQBP_E134`：highly time-varying and non-stationary vibration signals submerged in noise(Uncertainty) motivates Adaptive chirp mode decomposition
  - `4GNGWQBP_E135`：complex and nonlinear mechanism system(Complex Systems) motivates RST feature space decision
  - `4GNGWQBP_E136`：highly time-varying and non-stationary vibration signals submerged in noise(Uncertainty) motivates RST feature space decision
