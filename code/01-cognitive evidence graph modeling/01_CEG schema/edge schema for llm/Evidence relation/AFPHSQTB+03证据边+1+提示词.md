...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AFPHSQTB_E054` | `motivates` | 13-Noise Level | No details on added noise(Normal) |  | 15-Data Preprocessing Algorithm | Downsampling |  |
| 2 | `AFPHSQTB_E055` | `motivates` | 09-Problem Scenario | large-scale multi-machine power systems complexity(Complex Systems) |  | 15-Data Preprocessing Algorithm | Downsampling |  |
| 3 | `AFPHSQTB_E056` | `motivates` | 09-Problem Scenario | large-scale multi-machine power systems complexity(Complex Systems) |  | 17-Core Classifier Algorithm | LSTM |  |
| 4 | `AFPHSQTB_E057` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | LSTM |  |
| 5 | `AFPHSQTB_E058` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | LSTM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `AFPHSQTB_E055`：large-scale multi-machine power systems complexity(Complex Systems) motivates Downsampling
  - `AFPHSQTB_E056`：large-scale multi-machine power systems complexity(Complex Systems) motivates LSTM
