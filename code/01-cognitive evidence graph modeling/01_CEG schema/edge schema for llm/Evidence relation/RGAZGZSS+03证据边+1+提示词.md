...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `RGAZGZSS_E116` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 2 | `RGAZGZSS_E117` | `motivates` | 09-Problem Scenario | low-speed fault diagnosis(Other) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 3 | `RGAZGZSS_E118` | `motivates` | 12-Training Data Availability | small samples(Scarce) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 4 | `RGAZGZSS_E119` | `motivates` | 13-Noise Level | disturbed by environmental noise(High Noise) |  | 15-Data Preprocessing Algorithm | Envelope Analysis |  |
| 5 | `RGAZGZSS_E120` | `motivates` | 13-Noise Level | disturbed by environmental noise(High Noise) |  | 16-Feature Extraction Algorithm | Multifractal Detrended Fluctuation Analysis |  |
| 6 | `RGAZGZSS_E121` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Envelope Analysis |  |
| 7 | `RGAZGZSS_E122` | `motivates` | 09-Problem Scenario | low-speed fault diagnosis(Other) |  | 15-Data Preprocessing Algorithm | Envelope Analysis |  |
| 8 | `RGAZGZSS_E123` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Multifractal Detrended Fluctuation Analysis |  |
| 9 | `RGAZGZSS_E124` | `motivates` | 09-Problem Scenario | low-speed fault diagnosis(Other) |  | 16-Feature Extraction Algorithm | Multifractal Detrended Fluctuation Analysis |  |
| 10 | `RGAZGZSS_E125` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | LSSVM |  |
| 11 | `RGAZGZSS_E126` | `motivates` | 09-Problem Scenario | low-speed fault diagnosis(Other) |  | 17-Core Classifier Algorithm | LSSVM |  |
| 12 | `RGAZGZSS_E127` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Multifractal Detrended Fluctuation Analysis |  |
| 13 | `RGAZGZSS_E128` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | LSSVM |  |
| 14 | `RGAZGZSS_E129` | `motivates` | 06-Fault Severity | slight faults, serious faults(Multiple Severities) |  | 17-Core Classifier Algorithm | LSSVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `RGAZGZSS_E116`：noise robustness(Uncertainty) motivates Particle Swarm Optimization
  - `RGAZGZSS_E117`：low-speed fault diagnosis(Other) motivates Particle Swarm Optimization
  - `RGAZGZSS_E121`：noise robustness(Uncertainty) motivates Envelope Analysis
  - `RGAZGZSS_E122`：low-speed fault diagnosis(Other) motivates Envelope Analysis
  - `RGAZGZSS_E123`：noise robustness(Uncertainty) motivates Multifractal Detrended Fluctuation Analysis
  - `RGAZGZSS_E124`：low-speed fault diagnosis(Other) motivates Multifractal Detrended Fluctuation Analysis
  - `RGAZGZSS_E125`：noise robustness(Uncertainty) motivates LSSVM
  - `RGAZGZSS_E126`：low-speed fault diagnosis(Other) motivates LSSVM
