...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QUIV2CAB_E085` | `motivates` | 13-Noise Level | current noises, sensor offset, sensor gain deviation, inverter switching harmonics(High Noise) |  | 15-Data Preprocessing Algorithm | Low-Pass Filter |  |
| 2 | `QUIV2CAB_E086` | `motivates` | 13-Noise Level | current noises, sensor offset, sensor gain deviation, inverter switching harmonics(High Noise) |  | 16-Feature Extraction Algorithm | Demodulation |  |
| 3 | `QUIV2CAB_E087` | `motivates` | 09-Problem Scenario | Sensor measurement errors and noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Low-Pass Filter |  |
| 4 | `QUIV2CAB_E088` | `motivates` | 09-Problem Scenario | Low fault harmonic magnitudes at light load(Other) |  | 15-Data Preprocessing Algorithm | Low-Pass Filter |  |
| 5 | `QUIV2CAB_E089` | `motivates` | 09-Problem Scenario | Sensor measurement errors and noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Demodulation |  |
| 6 | `QUIV2CAB_E090` | `motivates` | 09-Problem Scenario | Low fault harmonic magnitudes at light load(Other) |  | 16-Feature Extraction Algorithm | Demodulation |  |
| 7 | `QUIV2CAB_E091` | `motivates` | 09-Problem Scenario | Sensor measurement errors and noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 8 | `QUIV2CAB_E092` | `motivates` | 09-Problem Scenario | Low fault harmonic magnitudes at light load(Other) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 9 | `QUIV2CAB_E093` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Demodulation |  |
| 10 | `QUIV2CAB_E094` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 11 | `QUIV2CAB_E095` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Threshold Decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `QUIV2CAB_E087`：Sensor measurement errors and noise robustness(Uncertainty) motivates Low-Pass Filter
  - `QUIV2CAB_E088`：Low fault harmonic magnitudes at light load(Other) motivates Low-Pass Filter
  - `QUIV2CAB_E089`：Sensor measurement errors and noise robustness(Uncertainty) motivates Demodulation
  - `QUIV2CAB_E090`：Low fault harmonic magnitudes at light load(Other) motivates Demodulation
  - `QUIV2CAB_E091`：Sensor measurement errors and noise robustness(Uncertainty) motivates Threshold Decision
  - `QUIV2CAB_E092`：Low fault harmonic magnitudes at light load(Other) motivates Threshold Decision
