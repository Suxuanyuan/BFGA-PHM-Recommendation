...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XZC9V9U9_E093` | `motivates` | 09-Problem Scenario | partially-decoupled disturbances(Uncertainty) |  | 19-Training Optimization Algorithm | Linear Matrix Inequality |  |
| 2 | `XZC9V9U9_E094` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Linear Matrix Inequality |  |
| 3 | `XZC9V9U9_E095` | `motivates` | 09-Problem Scenario | partially-decoupled disturbances(Uncertainty) |  | 17-Core Classifier Algorithm | Unknown Input Observer |  |
| 4 | `XZC9V9U9_E096` | `motivates` | 07-Compound Fault | simultaneous actuator and sensor faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Unknown Input Observer |  |
| 5 | `XZC9V9U9_E097` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Unknown Input Observer |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `XZC9V9U9_E093`：partially-decoupled disturbances(Uncertainty) motivates Linear Matrix Inequality
  - `XZC9V9U9_E095`：partially-decoupled disturbances(Uncertainty) motivates Unknown Input Observer
