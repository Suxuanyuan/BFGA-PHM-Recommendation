...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `2Q3UWQ5M_E063` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | DWT |  |
| 2 | `2Q3UWQ5M_E064` | `motivates` | 09-Problem Scenario | harmonics introduced by the soft-starter / noise pollution(Uncertainty) |  | 16-Feature Extraction Algorithm | DWT |  |
| 3 | `2Q3UWQ5M_E065` | `motivates` | 09-Problem Scenario | steady-state constraints of MCSA under reduced load / variable load conditions(Other) |  | 16-Feature Extraction Algorithm | DWT |  |
| 4 | `2Q3UWQ5M_E066` | `motivates` | 09-Problem Scenario | harmonics introduced by the soft-starter / noise pollution(Uncertainty) |  | 17-Core Classifier Algorithm | gamma_DE |  |
| 5 | `2Q3UWQ5M_E067` | `motivates` | 09-Problem Scenario | steady-state constraints of MCSA under reduced load / variable load conditions(Other) |  | 17-Core Classifier Algorithm | gamma_DE |  |
| 6 | `2Q3UWQ5M_E068` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | DWT |  |
| 7 | `2Q3UWQ5M_E069` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | gamma_DE |  |
| 8 | `2Q3UWQ5M_E070` | `motivates` | 06-Fault Severity | broken rotor bars(Multiple Severities) |  | 17-Core Classifier Algorithm | gamma_DE |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `2Q3UWQ5M_E064`：harmonics introduced by the soft-starter / noise pollution(Uncertainty) motivates DWT
  - `2Q3UWQ5M_E065`：steady-state constraints of MCSA under reduced load / variable load conditions(Other) motivates DWT
  - `2Q3UWQ5M_E066`：harmonics introduced by the soft-starter / noise pollution(Uncertainty) motivates gamma_DE
  - `2Q3UWQ5M_E067`：steady-state constraints of MCSA under reduced load / variable load conditions(Other) motivates gamma_DE
