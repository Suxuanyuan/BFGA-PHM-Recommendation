...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PIB5UHYL_E096` | `motivates` | 09-Problem Scenario | stator branch current contains interference / noise robustness(Uncertainty) |  | 19-Training Optimization Algorithm | Recursive batch least squares |  |
| 2 | `PIB5UHYL_E097` | `motivates` | 09-Problem Scenario | early stage / incipient fault(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | Recursive batch least squares |  |
| 3 | `PIB5UHYL_E098` | `motivates` | 12-Training Data Availability | experimental data(Sufficient) |  | 19-Training Optimization Algorithm | Recursive batch least squares |  |
| 4 | `PIB5UHYL_E099` | `motivates` | 13-Noise Level | interference(High Noise) |  | 15-Data Preprocessing Algorithm | Unified voltage and current reference system |  |
| 5 | `PIB5UHYL_E100` | `motivates` | 13-Noise Level | interference(High Noise) |  | 16-Feature Extraction Algorithm | Volterra series |  |
| 6 | `PIB5UHYL_E101` | `motivates` | 09-Problem Scenario | stator branch current contains interference / noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Unified voltage and current reference system |  |
| 7 | `PIB5UHYL_E102` | `motivates` | 09-Problem Scenario | early stage / incipient fault(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Unified voltage and current reference system |  |
| 8 | `PIB5UHYL_E103` | `motivates` | 09-Problem Scenario | stator branch current contains interference / noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Volterra series |  |
| 9 | `PIB5UHYL_E104` | `motivates` | 09-Problem Scenario | early stage / incipient fault(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Volterra series |  |
| 10 | `PIB5UHYL_E105` | `motivates` | 09-Problem Scenario | stator branch current contains interference / noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold decision |  |
| 11 | `PIB5UHYL_E106` | `motivates` | 09-Problem Scenario | early stage / incipient fault(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Threshold decision |  |
| 12 | `PIB5UHYL_E107` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Volterra series |  |
| 13 | `PIB5UHYL_E108` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold decision |  |
| 14 | `PIB5UHYL_E109` | `motivates` | 06-Fault Severity | inter-turn short circuit ratio of 3%–15%(Multiple Severities) |  | 17-Core Classifier Algorithm | Threshold decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `PIB5UHYL_E096`：stator branch current contains interference / noise robustness(Uncertainty) motivates Recursive batch least squares
  - `PIB5UHYL_E097`：early stage / incipient fault(Early Degradation Prediction) motivates Recursive batch least squares
  - `PIB5UHYL_E101`：stator branch current contains interference / noise robustness(Uncertainty) motivates Unified voltage and current reference system
  - `PIB5UHYL_E102`：early stage / incipient fault(Early Degradation Prediction) motivates Unified voltage and current reference system
  - `PIB5UHYL_E103`：stator branch current contains interference / noise robustness(Uncertainty) motivates Volterra series
  - `PIB5UHYL_E104`：early stage / incipient fault(Early Degradation Prediction) motivates Volterra series
  - `PIB5UHYL_E105`：stator branch current contains interference / noise robustness(Uncertainty) motivates Threshold decision
  - `PIB5UHYL_E106`：early stage / incipient fault(Early Degradation Prediction) motivates Threshold decision
