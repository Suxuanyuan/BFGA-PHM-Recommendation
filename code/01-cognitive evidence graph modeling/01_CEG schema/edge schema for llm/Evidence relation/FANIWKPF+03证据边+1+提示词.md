...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `FANIWKPF_E124` | `motivates` | 09-Problem Scenario | incipient faults(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 2 | `FANIWKPF_E125` | `motivates` | 09-Problem Scenario | amplitude estimation limitation in classical high-resolution algorithms(Other) |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 3 | `FANIWKPF_E126` | `motivates` | 12-Training Data Availability | Simulated and experimental data(Sufficient) |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 4 | `FANIWKPF_E127` | `motivates` | 13-Noise Level | Stator currents fed by synchronous generator(Normal) |  | 15-Data Preprocessing Algorithm | Down-sampling |  |
| 5 | `FANIWKPF_E128` | `motivates` | 13-Noise Level | Stator currents fed by synchronous generator(Normal) |  | 16-Feature Extraction Algorithm | MD MUSIC |  |
| 6 | `FANIWKPF_E129` | `motivates` | 09-Problem Scenario | incipient faults(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Down-sampling |  |
| 7 | `FANIWKPF_E130` | `motivates` | 09-Problem Scenario | amplitude estimation limitation in classical high-resolution algorithms(Other) |  | 15-Data Preprocessing Algorithm | Down-sampling |  |
| 8 | `FANIWKPF_E131` | `motivates` | 09-Problem Scenario | incipient faults(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | MD MUSIC |  |
| 9 | `FANIWKPF_E132` | `motivates` | 09-Problem Scenario | amplitude estimation limitation in classical high-resolution algorithms(Other) |  | 16-Feature Extraction Algorithm | MD MUSIC |  |
| 10 | `FANIWKPF_E133` | `motivates` | 09-Problem Scenario | incipient faults(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Maximum Likelihood Estimation |  |
| 11 | `FANIWKPF_E134` | `motivates` | 09-Problem Scenario | amplitude estimation limitation in classical high-resolution algorithms(Other) |  | 17-Core Classifier Algorithm | Maximum Likelihood Estimation |  |
| 12 | `FANIWKPF_E135` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | MD MUSIC |  |
| 13 | `FANIWKPF_E136` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Maximum Likelihood Estimation |  |
| 14 | `FANIWKPF_E137` | `motivates` | 06-Fault Severity | severity 1, severity 2, severity 3(Multiple Severities) |  | 17-Core Classifier Algorithm | Maximum Likelihood Estimation |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `FANIWKPF_E124`：incipient faults(Early Degradation Prediction) motivates Genetic Algorithm
  - `FANIWKPF_E125`：amplitude estimation limitation in classical high-resolution algorithms(Other) motivates Genetic Algorithm
  - `FANIWKPF_E129`：incipient faults(Early Degradation Prediction) motivates Down-sampling
  - `FANIWKPF_E130`：amplitude estimation limitation in classical high-resolution algorithms(Other) motivates Down-sampling
  - `FANIWKPF_E131`：incipient faults(Early Degradation Prediction) motivates MD MUSIC
  - `FANIWKPF_E132`：amplitude estimation limitation in classical high-resolution algorithms(Other) motivates MD MUSIC
  - `FANIWKPF_E133`：incipient faults(Early Degradation Prediction) motivates Maximum Likelihood Estimation
  - `FANIWKPF_E134`：amplitude estimation limitation in classical high-resolution algorithms(Other) motivates Maximum Likelihood Estimation
