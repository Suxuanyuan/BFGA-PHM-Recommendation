...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `2QYTMVXT_E116` | `motivates` | 13-Noise Level | random noises from various sources in measurements(High Noise) |  | 15-Data Preprocessing Algorithm | Mean centering |  |
| 2 | `2QYTMVXT_E117` | `motivates` | 13-Noise Level | random noises from various sources in measurements(High Noise) |  | 16-Feature Extraction Algorithm | Canonical Correlation Analysis |  |
| 3 | `2QYTMVXT_E118` | `motivates` | 09-Problem Scenario | random noises, uncertainty(Uncertainty) |  | 15-Data Preprocessing Algorithm | Mean centering |  |
| 4 | `2QYTMVXT_E119` | `motivates` | 09-Problem Scenario | slow detection of faults and lack of fault isolation(Other) |  | 15-Data Preprocessing Algorithm | Mean centering |  |
| 5 | `2QYTMVXT_E120` | `motivates` | 09-Problem Scenario | random noises, uncertainty(Uncertainty) |  | 16-Feature Extraction Algorithm | Canonical Correlation Analysis |  |
| 6 | `2QYTMVXT_E121` | `motivates` | 09-Problem Scenario | slow detection of faults and lack of fault isolation(Other) |  | 16-Feature Extraction Algorithm | Canonical Correlation Analysis |  |
| 7 | `2QYTMVXT_E122` | `motivates` | 09-Problem Scenario | random noises, uncertainty(Uncertainty) |  | 17-Core Classifier Algorithm | T2 statistic |  |
| 8 | `2QYTMVXT_E123` | `motivates` | 09-Problem Scenario | slow detection of faults and lack of fault isolation(Other) |  | 17-Core Classifier Algorithm | T2 statistic |  |
| 9 | `2QYTMVXT_E124` | `motivates` | 07-Compound Fault | single fault(No Compound Fault) |  | 16-Feature Extraction Algorithm | Canonical Correlation Analysis |  |
| 10 | `2QYTMVXT_E125` | `motivates` | 07-Compound Fault | single fault(No Compound Fault) |  | 17-Core Classifier Algorithm | T2 statistic |  |
| 11 | `2QYTMVXT_E126` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | T2 statistic |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `2QYTMVXT_E118`：random noises, uncertainty(Uncertainty) motivates Mean centering
  - `2QYTMVXT_E119`：slow detection of faults and lack of fault isolation(Other) motivates Mean centering
  - `2QYTMVXT_E120`：random noises, uncertainty(Uncertainty) motivates Canonical Correlation Analysis
  - `2QYTMVXT_E121`：slow detection of faults and lack of fault isolation(Other) motivates Canonical Correlation Analysis
  - `2QYTMVXT_E122`：random noises, uncertainty(Uncertainty) motivates T2 statistic
  - `2QYTMVXT_E123`：slow detection of faults and lack of fault isolation(Other) motivates T2 statistic
