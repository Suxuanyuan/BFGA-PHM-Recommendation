...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `IAZDRN8C_E116` | `motivates` | 09-Problem Scenario | One-shot learning with limited data(Small Fault Samples) |  | 19-Training Optimization Algorithm | BiGAN |  |
| 2 | `IAZDRN8C_E117` | `motivates` | 12-Training Data Availability | one single sample for each faulty class(Scarce) |  | 18-Data Generation Algorithm | 1DTCNN |  |
| 3 | `IAZDRN8C_E118` | `motivates` | 12-Training Data Availability | one single sample for each faulty class(Scarce) |  | 19-Training Optimization Algorithm | BiGAN |  |
| 4 | `IAZDRN8C_E119` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 5 | `IAZDRN8C_E120` | `motivates` | 09-Problem Scenario | One-shot learning with limited data(Small Fault Samples) |  | 18-Data Generation Algorithm | 1DTCNN |  |
| 6 | `IAZDRN8C_E121` | `motivates` | 09-Problem Scenario | One-shot learning with limited data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 7 | `IAZDRN8C_E122` | `motivates` | 09-Problem Scenario | One-shot learning with limited data(Small Fault Samples) |  | 17-Core Classifier Algorithm | 1-NN |  |
| 8 | `IAZDRN8C_E123` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 9 | `IAZDRN8C_E124` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | 1-NN |  |
| 10 | `IAZDRN8C_E125` | `motivates` | 06-Fault Severity | decreasing the effective tension by 1.5 mm, unscrewing the clamping screw by 2 turns (0.7 mm)(Single Severity) |  | 17-Core Classifier Algorithm | 1-NN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `IAZDRN8C_E116`：One-shot learning with limited data(Small Fault Samples) motivates BiGAN
  - `IAZDRN8C_E120`：One-shot learning with limited data(Small Fault Samples) motivates 1DTCNN
  - `IAZDRN8C_E121`：One-shot learning with limited data(Small Fault Samples) motivates 1DCNN
  - `IAZDRN8C_E122`：One-shot learning with limited data(Small Fault Samples) motivates 1-NN
