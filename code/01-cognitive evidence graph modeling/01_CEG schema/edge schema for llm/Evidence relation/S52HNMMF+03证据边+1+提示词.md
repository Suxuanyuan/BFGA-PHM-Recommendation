...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `S52HNMMF_E102` | `motivates` | 13-Noise Level | noise reduction, noisy Lorenz signals, white Gaussian noises(High Noise) |  | 15-Data Preprocessing Algorithm | Modified Local Projection |  |
| 2 | `S52HNMMF_E103` | `motivates` | 13-Noise Level | noise reduction, noisy Lorenz signals, white Gaussian noises(High Noise) |  | 16-Feature Extraction Algorithm | Hessian Locally Linear Embedding |  |
| 3 | `S52HNMMF_E104` | `motivates` | 09-Problem Scenario | noise reduction in nonlinear and chaotic signals(Uncertainty) |  | 15-Data Preprocessing Algorithm | Modified Local Projection |  |
| 4 | `S52HNMMF_E105` | `motivates` | 09-Problem Scenario | fault classification under variable operating conditions(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Modified Local Projection |  |
| 5 | `S52HNMMF_E106` | `motivates` | 09-Problem Scenario | health assessment and early fault warning(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Modified Local Projection |  |
| 6 | `S52HNMMF_E107` | `motivates` | 09-Problem Scenario | noise reduction in nonlinear and chaotic signals(Uncertainty) |  | 16-Feature Extraction Algorithm | Hessian Locally Linear Embedding |  |
| 7 | `S52HNMMF_E108` | `motivates` | 09-Problem Scenario | fault classification under variable operating conditions(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Hessian Locally Linear Embedding |  |
| 8 | `S52HNMMF_E109` | `motivates` | 09-Problem Scenario | health assessment and early fault warning(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Hessian Locally Linear Embedding |  |
| 9 | `S52HNMMF_E110` | `motivates` | 09-Problem Scenario | noise reduction in nonlinear and chaotic signals(Uncertainty) |  | 17-Core Classifier Algorithm | Information-Geometric Support Vector Machine |  |
| 10 | `S52HNMMF_E111` | `motivates` | 09-Problem Scenario | fault classification under variable operating conditions(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Information-Geometric Support Vector Machine |  |
| 11 | `S52HNMMF_E112` | `motivates` | 09-Problem Scenario | health assessment and early fault warning(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Information-Geometric Support Vector Machine |  |
| 12 | `S52HNMMF_E113` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Hessian Locally Linear Embedding |  |
| 13 | `S52HNMMF_E114` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Information-Geometric Support Vector Machine |  |
| 14 | `S52HNMMF_E115` | `motivates` | 06-Fault Severity | 0.007 in., run-to-failure(Multiple Severities) |  | 17-Core Classifier Algorithm | Information-Geometric Support Vector Machine |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `S52HNMMF_E104`：noise reduction in nonlinear and chaotic signals(Uncertainty) motivates Modified Local Projection
  - `S52HNMMF_E105`：fault classification under variable operating conditions(Distribution Discrepancy) motivates Modified Local Projection
  - `S52HNMMF_E106`：health assessment and early fault warning(Early Degradation Prediction) motivates Modified Local Projection
  - `S52HNMMF_E107`：noise reduction in nonlinear and chaotic signals(Uncertainty) motivates Hessian Locally Linear Embedding
  - `S52HNMMF_E108`：fault classification under variable operating conditions(Distribution Discrepancy) motivates Hessian Locally Linear Embedding
  - `S52HNMMF_E109`：health assessment and early fault warning(Early Degradation Prediction) motivates Hessian Locally Linear Embedding
  - `S52HNMMF_E110`：noise reduction in nonlinear and chaotic signals(Uncertainty) motivates Information-Geometric Support Vector Machine
  - `S52HNMMF_E111`：fault classification under variable operating conditions(Distribution Discrepancy) motivates Information-Geometric Support Vector Machine
  - `S52HNMMF_E112`：health assessment and early fault warning(Early Degradation Prediction) motivates Information-Geometric Support Vector Machine
