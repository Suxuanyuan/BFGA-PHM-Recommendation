...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TLVNPMZ5_E211` | `motivates` | 09-Problem Scenario | limited data / sparse target data(Small Fault Samples) |  | 19-Training Optimization Algorithm | Multiple Adversarial Domain Adaptation |  |
| 2 | `TLVNPMZ5_E212` | `motivates` | 09-Problem Scenario | distribution discrepancy / domain shift(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Multiple Adversarial Domain Adaptation |  |
| 3 | `TLVNPMZ5_E213` | `motivates` | 12-Training Data Availability | limited data, sparse data (single or several samples)(Scarce) |  | 19-Training Optimization Algorithm | Multiple Adversarial Domain Adaptation |  |
| 4 | `TLVNPMZ5_E214` | `motivates` | 13-Noise Level | Gaussian noise(High Noise) |  | 15-Data Preprocessing Algorithm | Gaussian noise addition |  |
| 5 | `TLVNPMZ5_E215` | `motivates` | 13-Noise Level | Gaussian noise(High Noise) |  | 16-Feature Extraction Algorithm | CNN |  |
| 6 | `TLVNPMZ5_E216` | `motivates` | 09-Problem Scenario | limited data / sparse target data(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Gaussian noise addition |  |
| 7 | `TLVNPMZ5_E217` | `motivates` | 09-Problem Scenario | distribution discrepancy / domain shift(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Gaussian noise addition |  |
| 8 | `TLVNPMZ5_E218` | `motivates` | 09-Problem Scenario | limited data / sparse target data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | CNN |  |
| 9 | `TLVNPMZ5_E219` | `motivates` | 09-Problem Scenario | distribution discrepancy / domain shift(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | CNN |  |
| 10 | `TLVNPMZ5_E220` | `motivates` | 09-Problem Scenario | limited data / sparse target data(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `TLVNPMZ5_E221` | `motivates` | 09-Problem Scenario | distribution discrepancy / domain shift(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `TLVNPMZ5_E222` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 13 | `TLVNPMZ5_E223` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `TLVNPMZ5_E224` | `motivates` | 06-Fault Severity | fault diameter, damage extent(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `TLVNPMZ5_E211`：limited data / sparse target data(Small Fault Samples) motivates Multiple Adversarial Domain Adaptation
  - `TLVNPMZ5_E212`：distribution discrepancy / domain shift(Distribution Discrepancy) motivates Multiple Adversarial Domain Adaptation
  - `TLVNPMZ5_E216`：limited data / sparse target data(Small Fault Samples) motivates Gaussian noise addition
  - `TLVNPMZ5_E217`：distribution discrepancy / domain shift(Distribution Discrepancy) motivates Gaussian noise addition
  - `TLVNPMZ5_E218`：limited data / sparse target data(Small Fault Samples) motivates CNN
  - `TLVNPMZ5_E219`：distribution discrepancy / domain shift(Distribution Discrepancy) motivates CNN
  - `TLVNPMZ5_E220`：limited data / sparse target data(Small Fault Samples) motivates Softmax
  - `TLVNPMZ5_E221`：distribution discrepancy / domain shift(Distribution Discrepancy) motivates Softmax
