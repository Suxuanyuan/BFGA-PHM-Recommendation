...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `I69QEN5Z_E120` | `motivates` | 13-Noise Level | uncorrelated noise in the measured vibration responses(High Noise) |  | 15-Data Preprocessing Algorithm | Hanning window |  |
| 2 | `I69QEN5Z_E121` | `motivates` | 13-Noise Level | uncorrelated noise in the measured vibration responses(High Noise) |  | 16-Feature Extraction Algorithm | Coherent Composite Spectrum |  |
| 3 | `I69QEN5Z_E122` | `motivates` | 09-Problem Scenario | large vibration data set makes the diagnosis process complex(Complex Systems) |  | 15-Data Preprocessing Algorithm | Hanning window |  |
| 4 | `I69QEN5Z_E123` | `motivates` | 09-Problem Scenario | uncorrelated noise in the measured vibration responses(Uncertainty) |  | 15-Data Preprocessing Algorithm | Hanning window |  |
| 5 | `I69QEN5Z_E124` | `motivates` | 09-Problem Scenario | large vibration data set makes the diagnosis process complex(Complex Systems) |  | 16-Feature Extraction Algorithm | Coherent Composite Spectrum |  |
| 6 | `I69QEN5Z_E125` | `motivates` | 09-Problem Scenario | uncorrelated noise in the measured vibration responses(Uncertainty) |  | 16-Feature Extraction Algorithm | Coherent Composite Spectrum |  |
| 7 | `I69QEN5Z_E126` | `motivates` | 09-Problem Scenario | large vibration data set makes the diagnosis process complex(Complex Systems) |  | 17-Core Classifier Algorithm | Spectrum analysis |  |
| 8 | `I69QEN5Z_E127` | `motivates` | 09-Problem Scenario | uncorrelated noise in the measured vibration responses(Uncertainty) |  | 17-Core Classifier Algorithm | Spectrum analysis |  |
| 9 | `I69QEN5Z_E128` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Coherent Composite Spectrum |  |
| 10 | `I69QEN5Z_E129` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Spectrum analysis |  |
| 11 | `I69QEN5Z_E130` | `motivates` | 06-Fault Severity | 2 mm misalignment, 4 mm crack depth, 21 mm hole(Single Severity) |  | 17-Core Classifier Algorithm | Spectrum analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `I69QEN5Z_E122`：large vibration data set makes the diagnosis process complex(Complex Systems) motivates Hanning window
  - `I69QEN5Z_E123`：uncorrelated noise in the measured vibration responses(Uncertainty) motivates Hanning window
  - `I69QEN5Z_E124`：large vibration data set makes the diagnosis process complex(Complex Systems) motivates Coherent Composite Spectrum
  - `I69QEN5Z_E125`：uncorrelated noise in the measured vibration responses(Uncertainty) motivates Coherent Composite Spectrum
  - `I69QEN5Z_E126`：large vibration data set makes the diagnosis process complex(Complex Systems) motivates Spectrum analysis
  - `I69QEN5Z_E127`：uncorrelated noise in the measured vibration responses(Uncertainty) motivates Spectrum analysis
