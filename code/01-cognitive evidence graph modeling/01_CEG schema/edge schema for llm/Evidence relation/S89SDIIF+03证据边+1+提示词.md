...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `S89SDIIF_E100` | `motivates` | 09-Problem Scenario | low signal-to-noise ratios and background noise(Uncertainty) |  | 19-Training Optimization Algorithm | Regularized ALS |  |
| 2 | `S89SDIIF_E101` | `motivates` | 09-Problem Scenario | interpretability of the decomposition(Trustworthiness / Interpretability) |  | 19-Training Optimization Algorithm | Regularized ALS |  |
| 3 | `S89SDIIF_E102` | `motivates` | 12-Training Data Availability | 21 samples for each kinds of fault(Scarce) |  | 19-Training Optimization Algorithm | Regularized ALS |  |
| 4 | `S89SDIIF_E103` | `motivates` | 13-Noise Level | low signal-to-noise ratios (SNRs), submersed in much background noised(High Noise) |  | 15-Data Preprocessing Algorithm | Min-max normalization |  |
| 5 | `S89SDIIF_E104` | `motivates` | 13-Noise Level | low signal-to-noise ratios (SNRs), submersed in much background noised(High Noise) |  | 16-Feature Extraction Algorithm | FFT |  |
| 6 | `S89SDIIF_E105` | `motivates` | 09-Problem Scenario | low signal-to-noise ratios and background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Min-max normalization |  |
| 7 | `S89SDIIF_E106` | `motivates` | 09-Problem Scenario | interpretability of the decomposition(Trustworthiness / Interpretability) |  | 15-Data Preprocessing Algorithm | Min-max normalization |  |
| 8 | `S89SDIIF_E107` | `motivates` | 09-Problem Scenario | low signal-to-noise ratios and background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | FFT |  |
| 9 | `S89SDIIF_E108` | `motivates` | 09-Problem Scenario | interpretability of the decomposition(Trustworthiness / Interpretability) |  | 16-Feature Extraction Algorithm | FFT |  |
| 10 | `S89SDIIF_E109` | `motivates` | 09-Problem Scenario | low signal-to-noise ratios and background noise(Uncertainty) |  | 17-Core Classifier Algorithm | k-NN |  |
| 11 | `S89SDIIF_E110` | `motivates` | 09-Problem Scenario | interpretability of the decomposition(Trustworthiness / Interpretability) |  | 17-Core Classifier Algorithm | k-NN |  |
| 12 | `S89SDIIF_E111` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | FFT |  |
| 13 | `S89SDIIF_E112` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | k-NN |  |
| 14 | `S89SDIIF_E113` | `motivates` | 06-Fault Severity | fault diameters of 0.007, 0.014, and 0.021 in.(Multiple Severities) |  | 17-Core Classifier Algorithm | k-NN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `S89SDIIF_E100`：low signal-to-noise ratios and background noise(Uncertainty) motivates Regularized ALS
  - `S89SDIIF_E101`：interpretability of the decomposition(Trustworthiness / Interpretability) motivates Regularized ALS
  - `S89SDIIF_E105`：low signal-to-noise ratios and background noise(Uncertainty) motivates Min-max normalization
  - `S89SDIIF_E106`：interpretability of the decomposition(Trustworthiness / Interpretability) motivates Min-max normalization
  - `S89SDIIF_E107`：low signal-to-noise ratios and background noise(Uncertainty) motivates FFT
  - `S89SDIIF_E108`：interpretability of the decomposition(Trustworthiness / Interpretability) motivates FFT
  - `S89SDIIF_E109`：low signal-to-noise ratios and background noise(Uncertainty) motivates k-NN
  - `S89SDIIF_E110`：interpretability of the decomposition(Trustworthiness / Interpretability) motivates k-NN
