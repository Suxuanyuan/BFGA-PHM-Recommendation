...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `8NZNQHTJ_E057` | `motivates` | 13-Noise Level | Not mentioned(Normal) |  | 15-Data Preprocessing Algorithm | Moving window method |  |
| 2 | `8NZNQHTJ_E058` | `motivates` | 09-Problem Scenario | simultaneous open faults / same fault signature(Compound Faults) |  | 15-Data Preprocessing Algorithm | Moving window method |  |
| 3 | `8NZNQHTJ_E059` | `motivates` | 09-Problem Scenario | simultaneous open faults / same fault signature(Compound Faults) |  | 17-Core Classifier Algorithm | Free-wheeling mode detection |  |
| 4 | `8NZNQHTJ_E060` | `motivates` | 07-Compound Fault | simultaneous open-switches (up to three)(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Free-wheeling mode detection |  |
| 5 | `8NZNQHTJ_E061` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Free-wheeling mode detection |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `8NZNQHTJ_E058`：simultaneous open faults / same fault signature(Compound Faults) motivates Moving window method
  - `8NZNQHTJ_E059`：simultaneous open faults / same fault signature(Compound Faults) motivates Free-wheeling mode detection
