...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HNQDNGTY_E079` | `motivates` | 13-Noise Level | White Gaussian noise is added to obtain a noise-contaminated signal with signal-to-noise ratio of -7 dB(High Noise) |  | 15-Data Preprocessing Algorithm | Low-pass Filter |  |
| 2 | `HNQDNGTY_E080` | `motivates` | 13-Noise Level | White Gaussian noise is added to obtain a noise-contaminated signal with signal-to-noise ratio of -7 dB(High Noise) |  | 16-Feature Extraction Algorithm | Cost Function Ridge Detection |  |
| 3 | `HNQDNGTY_E081` | `motivates` | 09-Problem Scenario | bearing diagnosis under speed variation conditions without the use of a tachometer(Other) |  | 15-Data Preprocessing Algorithm | Low-pass Filter |  |
| 4 | `HNQDNGTY_E082` | `motivates` | 09-Problem Scenario | noise-robust ridge detection from signal corrupted by background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Low-pass Filter |  |
| 5 | `HNQDNGTY_E083` | `motivates` | 09-Problem Scenario | bearing diagnosis under speed variation conditions without the use of a tachometer(Other) |  | 16-Feature Extraction Algorithm | Cost Function Ridge Detection |  |
| 6 | `HNQDNGTY_E084` | `motivates` | 09-Problem Scenario | noise-robust ridge detection from signal corrupted by background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Cost Function Ridge Detection |  |
| 7 | `HNQDNGTY_E085` | `motivates` | 09-Problem Scenario | bearing diagnosis under speed variation conditions without the use of a tachometer(Other) |  | 17-Core Classifier Algorithm | Rotating Speed Isolation |  |
| 8 | `HNQDNGTY_E086` | `motivates` | 09-Problem Scenario | noise-robust ridge detection from signal corrupted by background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Rotating Speed Isolation |  |
| 9 | `HNQDNGTY_E087` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Cost Function Ridge Detection |  |
| 10 | `HNQDNGTY_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Rotating Speed Isolation |  |
| 11 | `HNQDNGTY_E089` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Rotating Speed Isolation |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `HNQDNGTY_E081`：bearing diagnosis under speed variation conditions without the use of a tachometer(Other) motivates Low-pass Filter
  - `HNQDNGTY_E082`：noise-robust ridge detection from signal corrupted by background noise(Uncertainty) motivates Low-pass Filter
  - `HNQDNGTY_E083`：bearing diagnosis under speed variation conditions without the use of a tachometer(Other) motivates Cost Function Ridge Detection
  - `HNQDNGTY_E084`：noise-robust ridge detection from signal corrupted by background noise(Uncertainty) motivates Cost Function Ridge Detection
  - `HNQDNGTY_E085`：bearing diagnosis under speed variation conditions without the use of a tachometer(Other) motivates Rotating Speed Isolation
  - `HNQDNGTY_E086`：noise-robust ridge detection from signal corrupted by background noise(Uncertainty) motivates Rotating Speed Isolation
