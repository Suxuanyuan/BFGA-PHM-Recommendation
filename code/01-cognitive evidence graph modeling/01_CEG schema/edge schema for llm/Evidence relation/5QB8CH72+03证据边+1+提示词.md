...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `5QB8CH72_E098` | `motivates` | 09-Problem Scenario | complex structure of wind turbines(Complex Systems) |  | 17-Core Classifier Algorithm | JESS |  |
| 2 | `5QB8CH72_E099` | `motivates` | 09-Problem Scenario | FMECA results are difficult to share and reuse(Other) |  | 17-Core Classifier Algorithm | JESS |  |
| 3 | `5QB8CH72_E100` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | JESS |  |
| 4 | `5QB8CH72_E101` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | JESS |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `5QB8CH72_E098`：complex structure of wind turbines(Complex Systems) motivates JESS
  - `5QB8CH72_E099`：FMECA results are difficult to share and reuse(Other) motivates JESS
