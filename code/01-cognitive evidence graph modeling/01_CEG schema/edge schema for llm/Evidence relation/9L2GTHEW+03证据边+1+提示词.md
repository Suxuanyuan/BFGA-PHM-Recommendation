...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `9L2GTHEW_E078` | `motivates` | 09-Problem Scenario | system-level complexity with underdetermined models(Complex Systems) |  | 17-Core Classifier Algorithm | Dulmage-Mendelsohn decomposition |  |
| 2 | `9L2GTHEW_E079` | `motivates` | 09-Problem Scenario | sensor placement optimization for fault isolability(Other) |  | 17-Core Classifier Algorithm | Dulmage-Mendelsohn decomposition |  |
| 3 | `9L2GTHEW_E080` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Dulmage-Mendelsohn decomposition |  |
| 4 | `9L2GTHEW_E081` | `motivates` | 06-Fault Severity | unknown size, unknown percentage error(Single Severity) |  | 17-Core Classifier Algorithm | Dulmage-Mendelsohn decomposition |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `9L2GTHEW_E078`：system-level complexity with underdetermined models(Complex Systems) motivates Dulmage-Mendelsohn decomposition
  - `9L2GTHEW_E079`：sensor placement optimization for fault isolability(Other) motivates Dulmage-Mendelsohn decomposition
