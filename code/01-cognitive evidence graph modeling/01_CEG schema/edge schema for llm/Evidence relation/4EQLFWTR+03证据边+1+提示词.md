...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4EQLFWTR_E090` | `motivates` | 09-Problem Scenario | multiple combined faults(Compound Faults) |  | 19-Training Optimization Algorithm | DReM |  |
| 2 | `4EQLFWTR_E091` | `motivates` | 09-Problem Scenario | unreliability and uncertainty problem of OAA-MCSVM(Uncertainty) |  | 19-Training Optimization Algorithm | DReM |  |
| 3 | `4EQLFWTR_E092` | `motivates` | 12-Training Data Availability | 40 training samples for each bearing condition(Sufficient) |  | 19-Training Optimization Algorithm | DReM |  |
| 4 | `4EQLFWTR_E093` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 5 | `4EQLFWTR_E094` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | complex envelope spectrum analysis |  |
| 6 | `4EQLFWTR_E095` | `motivates` | 09-Problem Scenario | multiple combined faults(Compound Faults) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 7 | `4EQLFWTR_E096` | `motivates` | 09-Problem Scenario | unreliability and uncertainty problem of OAA-MCSVM(Uncertainty) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 8 | `4EQLFWTR_E097` | `motivates` | 09-Problem Scenario | multiple combined faults(Compound Faults) |  | 16-Feature Extraction Algorithm | complex envelope spectrum analysis |  |
| 9 | `4EQLFWTR_E098` | `motivates` | 09-Problem Scenario | unreliability and uncertainty problem of OAA-MCSVM(Uncertainty) |  | 16-Feature Extraction Algorithm | complex envelope spectrum analysis |  |
| 10 | `4EQLFWTR_E099` | `motivates` | 09-Problem Scenario | multiple combined faults(Compound Faults) |  | 17-Core Classifier Algorithm | OAA-MCSVM |  |
| 11 | `4EQLFWTR_E100` | `motivates` | 09-Problem Scenario | unreliability and uncertainty problem of OAA-MCSVM(Uncertainty) |  | 17-Core Classifier Algorithm | OAA-MCSVM |  |
| 12 | `4EQLFWTR_E101` | `motivates` | 07-Compound Fault | multiple combined faults(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | complex envelope spectrum analysis |  |
| 13 | `4EQLFWTR_E102` | `motivates` | 07-Compound Fault | multiple combined faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | OAA-MCSVM |  |
| 14 | `4EQLFWTR_E103` | `motivates` | 06-Fault Severity | crack sizes(Multiple Severities) |  | 17-Core Classifier Algorithm | OAA-MCSVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4EQLFWTR_E090`：multiple combined faults(Compound Faults) motivates DReM
  - `4EQLFWTR_E091`：unreliability and uncertainty problem of OAA-MCSVM(Uncertainty) motivates DReM
  - `4EQLFWTR_E095`：multiple combined faults(Compound Faults) motivates Hilbert transform
  - `4EQLFWTR_E096`：unreliability and uncertainty problem of OAA-MCSVM(Uncertainty) motivates Hilbert transform
  - `4EQLFWTR_E097`：multiple combined faults(Compound Faults) motivates complex envelope spectrum analysis
  - `4EQLFWTR_E098`：unreliability and uncertainty problem of OAA-MCSVM(Uncertainty) motivates complex envelope spectrum analysis
  - `4EQLFWTR_E099`：multiple combined faults(Compound Faults) motivates OAA-MCSVM
  - `4EQLFWTR_E100`：unreliability and uncertainty problem of OAA-MCSVM(Uncertainty) motivates OAA-MCSVM
