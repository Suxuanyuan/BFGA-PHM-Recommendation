...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `8Z2SE9XB_E095` | `motivates` | 09-Problem Scenario | uncertainties and systematic errors(Uncertainty) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 2 | `8Z2SE9XB_E096` | `motivates` | 09-Problem Scenario | fault-tolerant flow measuring under sensor drift and failure(Other) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 3 | `8Z2SE9XB_E097` | `motivates` | 12-Training Data Availability | 25 flowrates for training and 18 flowrates for testing, 50 measurements per flowrate(Sufficient) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 4 | `8Z2SE9XB_E098` | `motivates` | 13-Noise Level | random errors, gross errors, white noise offsets(High Noise) |  | 15-Data Preprocessing Algorithm | 3-sigma rule |  |
| 5 | `8Z2SE9XB_E099` | `motivates` | 09-Problem Scenario | uncertainties and systematic errors(Uncertainty) |  | 15-Data Preprocessing Algorithm | 3-sigma rule |  |
| 6 | `8Z2SE9XB_E100` | `motivates` | 09-Problem Scenario | fault-tolerant flow measuring under sensor drift and failure(Other) |  | 15-Data Preprocessing Algorithm | 3-sigma rule |  |
| 7 | `8Z2SE9XB_E101` | `motivates` | 09-Problem Scenario | uncertainties and systematic errors(Uncertainty) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 8 | `8Z2SE9XB_E102` | `motivates` | 09-Problem Scenario | fault-tolerant flow measuring under sensor drift and failure(Other) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 9 | `8Z2SE9XB_E103` | `motivates` | 07-Compound Fault | two dysfunctional acoustic paths(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 10 | `8Z2SE9XB_E104` | `motivates` | 06-Fault Severity | 10-μs average offsets, zeroing(Single Severity) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `8Z2SE9XB_E095`：uncertainties and systematic errors(Uncertainty) motivates Particle Swarm Optimization
  - `8Z2SE9XB_E096`：fault-tolerant flow measuring under sensor drift and failure(Other) motivates Particle Swarm Optimization
  - `8Z2SE9XB_E099`：uncertainties and systematic errors(Uncertainty) motivates 3-sigma rule
  - `8Z2SE9XB_E100`：fault-tolerant flow measuring under sensor drift and failure(Other) motivates 3-sigma rule
  - `8Z2SE9XB_E101`：uncertainties and systematic errors(Uncertainty) motivates Support Vector Machine
  - `8Z2SE9XB_E102`：fault-tolerant flow measuring under sensor drift and failure(Other) motivates Support Vector Machine
