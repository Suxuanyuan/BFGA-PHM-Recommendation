...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `5D92RRKU_E120` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | EMD |  |
| 2 | `5D92RRKU_E121` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | MFDCCA |  |
| 3 | `5D92RRKU_E122` | `motivates` | 09-Problem Scenario | compound fault(Compound Faults) |  | 15-Data Preprocessing Algorithm | EMD |  |
| 4 | `5D92RRKU_E123` | `motivates` | 09-Problem Scenario | non-stationary and non-linear vibration signal with cross-correlation(Other) |  | 15-Data Preprocessing Algorithm | EMD |  |
| 5 | `5D92RRKU_E124` | `motivates` | 09-Problem Scenario | compound fault(Compound Faults) |  | 16-Feature Extraction Algorithm | MFDCCA |  |
| 6 | `5D92RRKU_E125` | `motivates` | 09-Problem Scenario | non-stationary and non-linear vibration signal with cross-correlation(Other) |  | 16-Feature Extraction Algorithm | MFDCCA |  |
| 7 | `5D92RRKU_E126` | `motivates` | 09-Problem Scenario | compound fault(Compound Faults) |  | 17-Core Classifier Algorithm | RBF |  |
| 8 | `5D92RRKU_E127` | `motivates` | 09-Problem Scenario | non-stationary and non-linear vibration signal with cross-correlation(Other) |  | 17-Core Classifier Algorithm | RBF |  |
| 9 | `5D92RRKU_E128` | `motivates` | 07-Compound Fault | Compound Fault Across Structures |  | 16-Feature Extraction Algorithm | MFDCCA |  |
| 10 | `5D92RRKU_E129` | `motivates` | 07-Compound Fault | Compound Fault Across Structures |  | 17-Core Classifier Algorithm | RBF |  |
| 11 | `5D92RRKU_E130` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | RBF |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `5D92RRKU_E122`：compound fault(Compound Faults) motivates EMD
  - `5D92RRKU_E123`：non-stationary and non-linear vibration signal with cross-correlation(Other) motivates EMD
  - `5D92RRKU_E124`：compound fault(Compound Faults) motivates MFDCCA
  - `5D92RRKU_E125`：non-stationary and non-linear vibration signal with cross-correlation(Other) motivates MFDCCA
  - `5D92RRKU_E126`：compound fault(Compound Faults) motivates RBF
  - `5D92RRKU_E127`：non-stationary and non-linear vibration signal with cross-correlation(Other) motivates RBF
