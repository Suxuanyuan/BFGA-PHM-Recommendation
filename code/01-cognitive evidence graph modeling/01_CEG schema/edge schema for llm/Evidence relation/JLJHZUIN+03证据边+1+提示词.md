...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `JLJHZUIN_E116` | `motivates` | 09-Problem Scenario | multisensor data fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 19-Training Optimization Algorithm | CBA |  |
| 2 | `JLJHZUIN_E117` | `motivates` | 09-Problem Scenario | complex faults(Compound Faults) |  | 19-Training Optimization Algorithm | CBA |  |
| 3 | `JLJHZUIN_E118` | `motivates` | 12-Training Data Availability | 6,064,640 vibratory signals are collected... a fused domain matrix with 2369 lines and 66 columns is obtained. 80% of the data samples are randomly exploited to be as the training dataset(Sufficient) |  | 19-Training Optimization Algorithm | CBA |  |
| 4 | `JLJHZUIN_E119` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 5 | `JLJHZUIN_E120` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | TDI |  |
| 6 | `JLJHZUIN_E121` | `motivates` | 09-Problem Scenario | multisensor data fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 7 | `JLJHZUIN_E122` | `motivates` | 09-Problem Scenario | complex faults(Compound Faults) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 8 | `JLJHZUIN_E123` | `motivates` | 09-Problem Scenario | multisensor data fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | TDI |  |
| 9 | `JLJHZUIN_E124` | `motivates` | 09-Problem Scenario | complex faults(Compound Faults) |  | 16-Feature Extraction Algorithm | TDI |  |
| 10 | `JLJHZUIN_E125` | `motivates` | 09-Problem Scenario | multisensor data fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | KELM |  |
| 11 | `JLJHZUIN_E126` | `motivates` | 09-Problem Scenario | complex faults(Compound Faults) |  | 17-Core Classifier Algorithm | KELM |  |
| 12 | `JLJHZUIN_E127` | `motivates` | 07-Compound Fault | complex faults(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | TDI |  |
| 13 | `JLJHZUIN_E128` | `motivates` | 07-Compound Fault | complex faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | KELM |  |
| 14 | `JLJHZUIN_E129` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | KELM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `JLJHZUIN_E116`：multisensor data fusion(Multi-Source Heterogeneous / Multimodal Data) motivates CBA
  - `JLJHZUIN_E117`：complex faults(Compound Faults) motivates CBA
  - `JLJHZUIN_E121`：multisensor data fusion(Multi-Source Heterogeneous / Multimodal Data) motivates Normalization
  - `JLJHZUIN_E122`：complex faults(Compound Faults) motivates Normalization
  - `JLJHZUIN_E123`：multisensor data fusion(Multi-Source Heterogeneous / Multimodal Data) motivates TDI
  - `JLJHZUIN_E124`：complex faults(Compound Faults) motivates TDI
  - `JLJHZUIN_E125`：multisensor data fusion(Multi-Source Heterogeneous / Multimodal Data) motivates KELM
  - `JLJHZUIN_E126`：complex faults(Compound Faults) motivates KELM
