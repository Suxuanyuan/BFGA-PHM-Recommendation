...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QHZBFPW3_E072` | `motivates` | 13-Noise Level | noise(High Noise) |  | 15-Data Preprocessing Algorithm | AWT |  |
| 2 | `QHZBFPW3_E073` | `motivates` | 13-Noise Level | noise(High Noise) |  | 16-Feature Extraction Algorithm | EEMD |  |
| 3 | `QHZBFPW3_E074` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | AWT |  |
| 4 | `QHZBFPW3_E075` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | EEMD |  |
| 5 | `QHZBFPW3_E076` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Correlation Dimension |  |
| 6 | `QHZBFPW3_E077` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | EEMD |  |
| 7 | `QHZBFPW3_E078` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Correlation Dimension |  |
| 8 | `QHZBFPW3_E079` | `motivates` | 06-Fault Severity | fuel injection advance angle increase 2, fuel injection advance angle decrease 2(Single Severity) |  | 17-Core Classifier Algorithm | Correlation Dimension |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `QHZBFPW3_E074`：noise robustness(Uncertainty) motivates AWT
  - `QHZBFPW3_E075`：noise robustness(Uncertainty) motivates EEMD
  - `QHZBFPW3_E076`：noise robustness(Uncertainty) motivates Correlation Dimension
