...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QWYC5UL7_E101` | `motivates` | 09-Problem Scenario | multiple faults condition(Compound Faults) |  | 19-Training Optimization Algorithm | PABBO |  |
| 2 | `QWYC5UL7_E102` | `motivates` | 09-Problem Scenario | multiplicative and additive nonparametric faults(Other) |  | 19-Training Optimization Algorithm | PABBO |  |
| 3 | `QWYC5UL7_E103` | `motivates` | 12-Training Data Availability | N = 500 sample data(Sufficient) |  | 19-Training Optimization Algorithm | PABBO |  |
| 4 | `QWYC5UL7_E104` | `motivates` | 09-Problem Scenario | multiple faults condition(Compound Faults) |  | 17-Core Classifier Algorithm | EARR |  |
| 5 | `QWYC5UL7_E105` | `motivates` | 09-Problem Scenario | multiplicative and additive nonparametric faults(Other) |  | 17-Core Classifier Algorithm | EARR |  |
| 6 | `QWYC5UL7_E106` | `motivates` | 07-Compound Fault | simultaneous faults(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | EARR |  |
| 7 | `QWYC5UL7_E107` | `motivates` | 06-Fault Severity | K = 0.5, Jm = 0.0005, beta_u = 0.7/0.65, delta_u = 0.3/0.1(Single Severity) |  | 17-Core Classifier Algorithm | EARR |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `QWYC5UL7_E101`：multiple faults condition(Compound Faults) motivates PABBO
  - `QWYC5UL7_E102`：multiplicative and additive nonparametric faults(Other) motivates PABBO
  - `QWYC5UL7_E104`：multiple faults condition(Compound Faults) motivates EARR
  - `QWYC5UL7_E105`：multiplicative and additive nonparametric faults(Other) motivates EARR
