...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `5U6SPQLF_E134` | `motivates` | 09-Problem Scenario | distribution shifts(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | DDA |  |
| 2 | `5U6SPQLF_E135` | `motivates` | 09-Problem Scenario | complicated faults(Compound Faults) |  | 19-Training Optimization Algorithm | DDA |  |
| 3 | `5U6SPQLF_E136` | `motivates` | 12-Training Data Availability | 1000 samples for each health condition in bearing cases, 500 samples for each health condition in gearbox cases(Sufficient) |  | 19-Training Optimization Algorithm | DDA |  |
| 4 | `5U6SPQLF_E137` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | FFT |  |
| 5 | `5U6SPQLF_E138` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | SF-MDA |  |
| 6 | `5U6SPQLF_E139` | `motivates` | 09-Problem Scenario | distribution shifts(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 7 | `5U6SPQLF_E140` | `motivates` | 09-Problem Scenario | complicated faults(Compound Faults) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 8 | `5U6SPQLF_E141` | `motivates` | 09-Problem Scenario | distribution shifts(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | SF-MDA |  |
| 9 | `5U6SPQLF_E142` | `motivates` | 09-Problem Scenario | complicated faults(Compound Faults) |  | 16-Feature Extraction Algorithm | SF-MDA |  |
| 10 | `5U6SPQLF_E143` | `motivates` | 09-Problem Scenario | distribution shifts(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Kernel Classifier |  |
| 11 | `5U6SPQLF_E144` | `motivates` | 09-Problem Scenario | complicated faults(Compound Faults) |  | 17-Core Classifier Algorithm | Kernel Classifier |  |
| 12 | `5U6SPQLF_E145` | `motivates` | 07-Compound Fault | complicated faults(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | SF-MDA |  |
| 13 | `5U6SPQLF_E146` | `motivates` | 07-Compound Fault | complicated faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Kernel Classifier |  |
| 14 | `5U6SPQLF_E147` | `motivates` | 06-Fault Severity | 10 health conditions(Multiple Severities) |  | 17-Core Classifier Algorithm | Kernel Classifier |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `5U6SPQLF_E134`：distribution shifts(Distribution Discrepancy) motivates DDA
  - `5U6SPQLF_E135`：complicated faults(Compound Faults) motivates DDA
  - `5U6SPQLF_E139`：distribution shifts(Distribution Discrepancy) motivates FFT
  - `5U6SPQLF_E140`：complicated faults(Compound Faults) motivates FFT
  - `5U6SPQLF_E141`：distribution shifts(Distribution Discrepancy) motivates SF-MDA
  - `5U6SPQLF_E142`：complicated faults(Compound Faults) motivates SF-MDA
  - `5U6SPQLF_E143`：distribution shifts(Distribution Discrepancy) motivates Kernel Classifier
  - `5U6SPQLF_E144`：complicated faults(Compound Faults) motivates Kernel Classifier
