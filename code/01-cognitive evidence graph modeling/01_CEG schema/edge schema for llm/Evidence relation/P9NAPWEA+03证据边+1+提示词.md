...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `P9NAPWEA_E095` | `motivates` | 13-Noise Level | heavy background noise(High Noise) |  | 15-Data Preprocessing Algorithm | Hilbert Transform |  |
| 2 | `P9NAPWEA_E096` | `motivates` | 13-Noise Level | heavy background noise(High Noise) |  | 16-Feature Extraction Algorithm | ADOMP |  |
| 3 | `P9NAPWEA_E097` | `motivates` | 09-Problem Scenario | incipient fault / early stage of rolling element bearing fault(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Hilbert Transform |  |
| 4 | `P9NAPWEA_E098` | `motivates` | 09-Problem Scenario | heavy background noise and various unpredictable interferences(Uncertainty) |  | 15-Data Preprocessing Algorithm | Hilbert Transform |  |
| 5 | `P9NAPWEA_E099` | `motivates` | 09-Problem Scenario | incipient fault / early stage of rolling element bearing fault(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | ADOMP |  |
| 6 | `P9NAPWEA_E100` | `motivates` | 09-Problem Scenario | heavy background noise and various unpredictable interferences(Uncertainty) |  | 16-Feature Extraction Algorithm | ADOMP |  |
| 7 | `P9NAPWEA_E101` | `motivates` | 09-Problem Scenario | incipient fault / early stage of rolling element bearing fault(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | HPS |  |
| 8 | `P9NAPWEA_E102` | `motivates` | 09-Problem Scenario | heavy background noise and various unpredictable interferences(Uncertainty) |  | 17-Core Classifier Algorithm | HPS |  |
| 9 | `P9NAPWEA_E103` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | ADOMP |  |
| 10 | `P9NAPWEA_E104` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | HPS |  |
| 11 | `P9NAPWEA_E105` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | HPS |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `P9NAPWEA_E097`：incipient fault / early stage of rolling element bearing fault(Early Degradation Prediction) motivates Hilbert Transform
  - `P9NAPWEA_E098`：heavy background noise and various unpredictable interferences(Uncertainty) motivates Hilbert Transform
  - `P9NAPWEA_E099`：incipient fault / early stage of rolling element bearing fault(Early Degradation Prediction) motivates ADOMP
  - `P9NAPWEA_E100`：heavy background noise and various unpredictable interferences(Uncertainty) motivates ADOMP
  - `P9NAPWEA_E101`：incipient fault / early stage of rolling element bearing fault(Early Degradation Prediction) motivates HPS
  - `P9NAPWEA_E102`：heavy background noise and various unpredictable interferences(Uncertainty) motivates HPS
