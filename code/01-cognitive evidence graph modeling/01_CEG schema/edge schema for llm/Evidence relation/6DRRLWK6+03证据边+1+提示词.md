...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `6DRRLWK6_E122` | `motivates` | 09-Problem Scenario | limited labeled samples(Small Fault Samples) |  | 19-Training Optimization Algorithm | Multi-Stage Semi-Supervised Learning |  |
| 2 | `6DRRLWK6_E123` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 19-Training Optimization Algorithm | Multi-Stage Semi-Supervised Learning |  |
| 3 | `6DRRLWK6_E124` | `motivates` | 12-Training Data Availability | limited labeled samples(Scarce) |  | 19-Training Optimization Algorithm | Multi-Stage Semi-Supervised Learning |  |
| 4 | `6DRRLWK6_E125` | `motivates` | 13-Noise Level | heavy noise(High Noise) |  | 15-Data Preprocessing Algorithm | Data Augmentation Method |  |
| 5 | `6DRRLWK6_E126` | `motivates` | 13-Noise Level | heavy noise(High Noise) |  | 16-Feature Extraction Algorithm | 1D-CNN |  |
| 6 | `6DRRLWK6_E127` | `motivates` | 09-Problem Scenario | limited labeled samples(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Data Augmentation Method |  |
| 7 | `6DRRLWK6_E128` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | Data Augmentation Method |  |
| 8 | `6DRRLWK6_E129` | `motivates` | 09-Problem Scenario | limited labeled samples(Small Fault Samples) |  | 16-Feature Extraction Algorithm | 1D-CNN |  |
| 9 | `6DRRLWK6_E130` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 16-Feature Extraction Algorithm | 1D-CNN |  |
| 10 | `6DRRLWK6_E131` | `motivates` | 09-Problem Scenario | limited labeled samples(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `6DRRLWK6_E132` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `6DRRLWK6_E133` | `motivates` | 07-Compound Fault | compound fault(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | 1D-CNN |  |
| 13 | `6DRRLWK6_E134` | `motivates` | 07-Compound Fault | compound fault(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `6DRRLWK6_E135` | `motivates` | 06-Fault Severity | degradation(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `6DRRLWK6_E122`：limited labeled samples(Small Fault Samples) motivates Multi-Stage Semi-Supervised Learning
  - `6DRRLWK6_E123`：noise interference(Uncertainty) motivates Multi-Stage Semi-Supervised Learning
  - `6DRRLWK6_E127`：limited labeled samples(Small Fault Samples) motivates Data Augmentation Method
  - `6DRRLWK6_E128`：noise interference(Uncertainty) motivates Data Augmentation Method
  - `6DRRLWK6_E129`：limited labeled samples(Small Fault Samples) motivates 1D-CNN
  - `6DRRLWK6_E130`：noise interference(Uncertainty) motivates 1D-CNN
  - `6DRRLWK6_E131`：limited labeled samples(Small Fault Samples) motivates Softmax
  - `6DRRLWK6_E132`：noise interference(Uncertainty) motivates Softmax
