...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PEVLN9SN_E105` | `motivates` | 13-Noise Level | random noise, low signal to noise ratio(High Noise) |  | 15-Data Preprocessing Algorithm | Butterworth band-pass filter |  |
| 2 | `PEVLN9SN_E106` | `motivates` | 13-Noise Level | random noise, low signal to noise ratio(High Noise) |  | 16-Feature Extraction Algorithm | Discrete Wavelet Transform |  |
| 3 | `PEVLN9SN_E107` | `motivates` | 09-Problem Scenario | incipient fault detection(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Butterworth band-pass filter |  |
| 4 | `PEVLN9SN_E108` | `motivates` | 09-Problem Scenario | motor current and vibration signals(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Butterworth band-pass filter |  |
| 5 | `PEVLN9SN_E109` | `motivates` | 09-Problem Scenario | incipient fault detection(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Discrete Wavelet Transform |  |
| 6 | `PEVLN9SN_E110` | `motivates` | 09-Problem Scenario | motor current and vibration signals(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | Discrete Wavelet Transform |  |
| 7 | `PEVLN9SN_E111` | `motivates` | 09-Problem Scenario | incipient fault detection(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Threshold-based decision |  |
| 8 | `PEVLN9SN_E112` | `motivates` | 09-Problem Scenario | motor current and vibration signals(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | Threshold-based decision |  |
| 9 | `PEVLN9SN_E113` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Discrete Wavelet Transform |  |
| 10 | `PEVLN9SN_E114` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold-based decision |  |
| 11 | `PEVLN9SN_E115` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Threshold-based decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `PEVLN9SN_E107`：incipient fault detection(Early Degradation Prediction) motivates Butterworth band-pass filter
  - `PEVLN9SN_E108`：motor current and vibration signals(Multi-Source Heterogeneous / Multimodal Data) motivates Butterworth band-pass filter
  - `PEVLN9SN_E109`：incipient fault detection(Early Degradation Prediction) motivates Discrete Wavelet Transform
  - `PEVLN9SN_E110`：motor current and vibration signals(Multi-Source Heterogeneous / Multimodal Data) motivates Discrete Wavelet Transform
  - `PEVLN9SN_E111`：incipient fault detection(Early Degradation Prediction) motivates Threshold-based decision
  - `PEVLN9SN_E112`：motor current and vibration signals(Multi-Source Heterogeneous / Multimodal Data) motivates Threshold-based decision
