...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `86HZC3HC_E132` | `motivates` | 13-Noise Level | strong noise / background strong noise(High Noise) |  | 15-Data Preprocessing Algorithm | Sparse Code Shrinkage |  |
| 2 | `86HZC3HC_E133` | `motivates` | 13-Noise Level | strong noise / background strong noise(High Noise) |  | 16-Feature Extraction Algorithm | Variational Mode Decomposition |  |
| 3 | `86HZC3HC_E134` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Sparse Code Shrinkage |  |
| 4 | `86HZC3HC_E135` | `motivates` | 09-Problem Scenario | adaptive parameter determination and over-decomposition in VMD(Other) |  | 15-Data Preprocessing Algorithm | Sparse Code Shrinkage |  |
| 5 | `86HZC3HC_E136` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Variational Mode Decomposition |  |
| 6 | `86HZC3HC_E137` | `motivates` | 09-Problem Scenario | adaptive parameter determination and over-decomposition in VMD(Other) |  | 16-Feature Extraction Algorithm | Variational Mode Decomposition |  |
| 7 | `86HZC3HC_E138` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Hilbert envelope spectrum |  |
| 8 | `86HZC3HC_E139` | `motivates` | 09-Problem Scenario | adaptive parameter determination and over-decomposition in VMD(Other) |  | 17-Core Classifier Algorithm | Hilbert envelope spectrum |  |
| 9 | `86HZC3HC_E140` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Variational Mode Decomposition |  |
| 10 | `86HZC3HC_E141` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Hilbert envelope spectrum |  |
| 11 | `86HZC3HC_E142` | `motivates` | 06-Fault Severity | one-third of a tooth(Single Severity) |  | 17-Core Classifier Algorithm | Hilbert envelope spectrum |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `86HZC3HC_E134`：noise robustness(Uncertainty) motivates Sparse Code Shrinkage
  - `86HZC3HC_E135`：adaptive parameter determination and over-decomposition in VMD(Other) motivates Sparse Code Shrinkage
  - `86HZC3HC_E136`：noise robustness(Uncertainty) motivates Variational Mode Decomposition
  - `86HZC3HC_E137`：adaptive parameter determination and over-decomposition in VMD(Other) motivates Variational Mode Decomposition
  - `86HZC3HC_E138`：noise robustness(Uncertainty) motivates Hilbert envelope spectrum
  - `86HZC3HC_E139`：adaptive parameter determination and over-decomposition in VMD(Other) motivates Hilbert envelope spectrum
