...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PY2R5NFP_E117` | `motivates` | 13-Noise Level | non-Gaussian noise, random impacts, white Gaussian noise(High Noise) |  | 15-Data Preprocessing Algorithm | Computed Order Tracking |  |
| 2 | `PY2R5NFP_E118` | `motivates` | 13-Noise Level | non-Gaussian noise, random impacts, white Gaussian noise(High Noise) |  | 16-Feature Extraction Algorithm | Hilbert Envelope Order Spectrum |  |
| 3 | `PY2R5NFP_E119` | `motivates` | 09-Problem Scenario | non-Gaussian noise and random impacts(Uncertainty) |  | 15-Data Preprocessing Algorithm | Computed Order Tracking |  |
| 4 | `PY2R5NFP_E120` | `motivates` | 09-Problem Scenario | variable speed conditions(Other) |  | 15-Data Preprocessing Algorithm | Computed Order Tracking |  |
| 5 | `PY2R5NFP_E121` | `motivates` | 09-Problem Scenario | non-Gaussian noise and random impacts(Uncertainty) |  | 16-Feature Extraction Algorithm | Hilbert Envelope Order Spectrum |  |
| 6 | `PY2R5NFP_E122` | `motivates` | 09-Problem Scenario | variable speed conditions(Other) |  | 16-Feature Extraction Algorithm | Hilbert Envelope Order Spectrum |  |
| 7 | `PY2R5NFP_E123` | `motivates` | 09-Problem Scenario | non-Gaussian noise and random impacts(Uncertainty) |  | 17-Core Classifier Algorithm | Automatic Bearing Diagnosis System |  |
| 8 | `PY2R5NFP_E124` | `motivates` | 09-Problem Scenario | variable speed conditions(Other) |  | 17-Core Classifier Algorithm | Automatic Bearing Diagnosis System |  |
| 9 | `PY2R5NFP_E125` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Hilbert Envelope Order Spectrum |  |
| 10 | `PY2R5NFP_E126` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Automatic Bearing Diagnosis System |  |
| 11 | `PY2R5NFP_E127` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Automatic Bearing Diagnosis System |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `PY2R5NFP_E119`：non-Gaussian noise and random impacts(Uncertainty) motivates Computed Order Tracking
  - `PY2R5NFP_E120`：variable speed conditions(Other) motivates Computed Order Tracking
  - `PY2R5NFP_E121`：non-Gaussian noise and random impacts(Uncertainty) motivates Hilbert Envelope Order Spectrum
  - `PY2R5NFP_E122`：variable speed conditions(Other) motivates Hilbert Envelope Order Spectrum
  - `PY2R5NFP_E123`：non-Gaussian noise and random impacts(Uncertainty) motivates Automatic Bearing Diagnosis System
  - `PY2R5NFP_E124`：variable speed conditions(Other) motivates Automatic Bearing Diagnosis System
