...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZGC77V5M_E122` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Curve Registration |  |
| 2 | `ZGC77V5M_E123` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Discrete Wavelet Transform |  |
| 3 | `ZGC77V5M_E124` | `motivates` | 09-Problem Scenario | multiple, interacting fault modes(Compound Faults) |  | 15-Data Preprocessing Algorithm | Curve Registration |  |
| 4 | `ZGC77V5M_E125` | `motivates` | 09-Problem Scenario | mapping component-fault severity combinations to system State-of-Health(Complex Systems) |  | 15-Data Preprocessing Algorithm | Curve Registration |  |
| 5 | `ZGC77V5M_E126` | `motivates` | 09-Problem Scenario | multiple, interacting fault modes(Compound Faults) |  | 16-Feature Extraction Algorithm | Discrete Wavelet Transform |  |
| 6 | `ZGC77V5M_E127` | `motivates` | 09-Problem Scenario | mapping component-fault severity combinations to system State-of-Health(Complex Systems) |  | 16-Feature Extraction Algorithm | Discrete Wavelet Transform |  |
| 7 | `ZGC77V5M_E128` | `motivates` | 09-Problem Scenario | multiple, interacting fault modes(Compound Faults) |  | 17-Core Classifier Algorithm | Regularized Multinomial Regression |  |
| 8 | `ZGC77V5M_E129` | `motivates` | 09-Problem Scenario | mapping component-fault severity combinations to system State-of-Health(Complex Systems) |  | 17-Core Classifier Algorithm | Regularized Multinomial Regression |  |
| 9 | `ZGC77V5M_E130` | `motivates` | 07-Compound Fault | multiple, interacting fault modes(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | Discrete Wavelet Transform |  |
| 10 | `ZGC77V5M_E131` | `motivates` | 07-Compound Fault | multiple, interacting fault modes(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | Regularized Multinomial Regression |  |
| 11 | `ZGC77V5M_E132` | `motivates` | 06-Fault Severity | added resistance, brush thickness(Multiple Severities) |  | 17-Core Classifier Algorithm | Regularized Multinomial Regression |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZGC77V5M_E124`：multiple, interacting fault modes(Compound Faults) motivates Curve Registration
  - `ZGC77V5M_E125`：mapping component-fault severity combinations to system State-of-Health(Complex Systems) motivates Curve Registration
  - `ZGC77V5M_E126`：multiple, interacting fault modes(Compound Faults) motivates Discrete Wavelet Transform
  - `ZGC77V5M_E127`：mapping component-fault severity combinations to system State-of-Health(Complex Systems) motivates Discrete Wavelet Transform
  - `ZGC77V5M_E128`：multiple, interacting fault modes(Compound Faults) motivates Regularized Multinomial Regression
  - `ZGC77V5M_E129`：mapping component-fault severity combinations to system State-of-Health(Complex Systems) motivates Regularized Multinomial Regression
