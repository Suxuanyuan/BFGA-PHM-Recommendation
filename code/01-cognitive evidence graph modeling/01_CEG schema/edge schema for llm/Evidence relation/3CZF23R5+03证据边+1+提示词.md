...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3CZF23R5_E069` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Instantaneous power calculation |  |
| 2 | `3CZF23R5_E070` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Power spectrum analysis |  |
| 3 | `3CZF23R5_E071` | `motivates` | 09-Problem Scenario | false rotor fault alarms due to magnetic asymmetry and load oscillations(Uncertainty) |  | 15-Data Preprocessing Algorithm | Instantaneous power calculation |  |
| 4 | `3CZF23R5_E072` | `motivates` | 09-Problem Scenario | false rotor fault alarms due to magnetic asymmetry and load oscillations(Uncertainty) |  | 16-Feature Extraction Algorithm | Power spectrum analysis |  |
| 5 | `3CZF23R5_E073` | `motivates` | 09-Problem Scenario | false rotor fault alarms due to magnetic asymmetry and load oscillations(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold-based decision |  |
| 6 | `3CZF23R5_E074` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Power spectrum analysis |  |
| 7 | `3CZF23R5_E075` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold-based decision |  |
| 8 | `3CZF23R5_E076` | `motivates` | 06-Fault Severity | broken bars(Multiple Severities) |  | 17-Core Classifier Algorithm | Threshold-based decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `3CZF23R5_E071`：false rotor fault alarms due to magnetic asymmetry and load oscillations(Uncertainty) motivates Instantaneous power calculation
  - `3CZF23R5_E072`：false rotor fault alarms due to magnetic asymmetry and load oscillations(Uncertainty) motivates Power spectrum analysis
  - `3CZF23R5_E073`：false rotor fault alarms due to magnetic asymmetry and load oscillations(Uncertainty) motivates Threshold-based decision
