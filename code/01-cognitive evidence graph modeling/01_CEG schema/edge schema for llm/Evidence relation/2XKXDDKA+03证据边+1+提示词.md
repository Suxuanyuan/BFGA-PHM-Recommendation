...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `2XKXDDKA_E143` | `motivates` | 09-Problem Scenario | unseen faults(Zero Fault Samples) |  | 19-Training Optimization Algorithm | Partial Domain Adaptation |  |
| 2 | `2XKXDDKA_E144` | `motivates` | 09-Problem Scenario | imbalanced target samples(Small Fault Samples) |  | 19-Training Optimization Algorithm | Partial Domain Adaptation |  |
| 3 | `2XKXDDKA_E145` | `motivates` | 09-Problem Scenario | multi-source transfer learning / distribution discrepancy(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Partial Domain Adaptation |  |
| 4 | `2XKXDDKA_E146` | `motivates` | 12-Training Data Availability | unseen faults(Zero-Sample) |  | 19-Training Optimization Algorithm | Partial Domain Adaptation |  |
| 5 | `2XKXDDKA_E147` | `motivates` | 13-Noise Level | vibration data(Normal) |  | 16-Feature Extraction Algorithm | ResNet |  |
| 6 | `2XKXDDKA_E148` | `motivates` | 09-Problem Scenario | unseen faults(Zero Fault Samples) |  | 16-Feature Extraction Algorithm | ResNet |  |
| 7 | `2XKXDDKA_E149` | `motivates` | 09-Problem Scenario | imbalanced target samples(Small Fault Samples) |  | 16-Feature Extraction Algorithm | ResNet |  |
| 8 | `2XKXDDKA_E150` | `motivates` | 09-Problem Scenario | multi-source transfer learning / distribution discrepancy(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | ResNet |  |
| 9 | `2XKXDDKA_E151` | `motivates` | 09-Problem Scenario | unseen faults(Zero Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 10 | `2XKXDDKA_E152` | `motivates` | 09-Problem Scenario | imbalanced target samples(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `2XKXDDKA_E153` | `motivates` | 09-Problem Scenario | multi-source transfer learning / distribution discrepancy(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `2XKXDDKA_E154` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | ResNet |  |
| 13 | `2XKXDDKA_E155` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `2XKXDDKA_E156` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `2XKXDDKA_E143`：unseen faults(Zero Fault Samples) motivates Partial Domain Adaptation
  - `2XKXDDKA_E144`：imbalanced target samples(Small Fault Samples) motivates Partial Domain Adaptation
  - `2XKXDDKA_E145`：multi-source transfer learning / distribution discrepancy(Distribution Discrepancy) motivates Partial Domain Adaptation
  - `2XKXDDKA_E148`：unseen faults(Zero Fault Samples) motivates ResNet
  - `2XKXDDKA_E149`：imbalanced target samples(Small Fault Samples) motivates ResNet
  - `2XKXDDKA_E150`：multi-source transfer learning / distribution discrepancy(Distribution Discrepancy) motivates ResNet
  - `2XKXDDKA_E151`：unseen faults(Zero Fault Samples) motivates Softmax
  - `2XKXDDKA_E152`：imbalanced target samples(Small Fault Samples) motivates Softmax
  - `2XKXDDKA_E153`：multi-source transfer learning / distribution discrepancy(Distribution Discrepancy) motivates Softmax
