...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `LCQA83JN_E084` | `motivates` | 09-Problem Scenario | cold start learning / unseen faults(Zero Fault Samples) |  | 19-Training Optimization Algorithm | Disagreement Regularization |  |
| 2 | `LCQA83JN_E085` | `motivates` | 09-Problem Scenario | partially annotated data(Small Fault Samples) |  | 19-Training Optimization Algorithm | Disagreement Regularization |  |
| 3 | `LCQA83JN_E086` | `motivates` | 12-Training Data Availability | N_0 = 5000 normal examples, N_b = 4800 batch examples(Sufficient) |  | 19-Training Optimization Algorithm | Disagreement Regularization |  |
| 4 | `LCQA83JN_E087` | `motivates` | 09-Problem Scenario | cold start learning / unseen faults(Zero Fault Samples) |  | 17-Core Classifier Algorithm | Decision Fusion |  |
| 5 | `LCQA83JN_E088` | `motivates` | 09-Problem Scenario | partially annotated data(Small Fault Samples) |  | 17-Core Classifier Algorithm | Decision Fusion |  |
| 6 | `LCQA83JN_E089` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Decision Fusion |  |
| 7 | `LCQA83JN_E090` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Decision Fusion |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `LCQA83JN_E084`：cold start learning / unseen faults(Zero Fault Samples) motivates Disagreement Regularization
  - `LCQA83JN_E085`：partially annotated data(Small Fault Samples) motivates Disagreement Regularization
  - `LCQA83JN_E087`：cold start learning / unseen faults(Zero Fault Samples) motivates Decision Fusion
  - `LCQA83JN_E088`：partially annotated data(Small Fault Samples) motivates Decision Fusion
