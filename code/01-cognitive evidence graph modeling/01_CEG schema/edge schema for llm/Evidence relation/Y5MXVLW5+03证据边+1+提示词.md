...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `Y5AB3LDI_E094` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Bandpass filter |  |
| 2 | `Y5AB3LDI_E095` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Phase-sensitive detection |  |
| 3 | `Y5AB3LDI_E096` | `motivates` | 09-Problem Scenario | incipient stator inter-laminar short-circuits(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Bandpass filter |  |
| 4 | `Y5AB3LDI_E097` | `motivates` | 09-Problem Scenario | deep faults in the core(Other) |  | 15-Data Preprocessing Algorithm | Bandpass filter |  |
| 5 | `Y5AB3LDI_E098` | `motivates` | 09-Problem Scenario | incipient stator inter-laminar short-circuits(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Phase-sensitive detection |  |
| 6 | `Y5AB3LDI_E099` | `motivates` | 09-Problem Scenario | deep faults in the core(Other) |  | 16-Feature Extraction Algorithm | Phase-sensitive detection |  |
| 7 | `Y5AB3LDI_E100` | `motivates` | 09-Problem Scenario | incipient stator inter-laminar short-circuits(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | ELCID |  |
| 8 | `Y5AB3LDI_E101` | `motivates` | 09-Problem Scenario | deep faults in the core(Other) |  | 17-Core Classifier Algorithm | ELCID |  |
| 9 | `Y5AB3LDI_E102` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Phase-sensitive detection |  |
| 10 | `Y5AB3LDI_E103` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | ELCID |  |
| 11 | `Y5AB3LDI_E104` | `motivates` | 06-Fault Severity | number of faulty laminations(Multiple Severities) |  | 17-Core Classifier Algorithm | ELCID |  |
| 12 | `Y5MXVLW5_E083` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Expansion-Reduction Algorithm |  |
| 13 | `Y5MXVLW5_E084` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Fisher Discriminant Analysis |  |
| 14 | `Y5MXVLW5_E085` | `motivates` | 09-Problem Scenario | imperfect test points(Uncertainty) |  | 15-Data Preprocessing Algorithm | Expansion-Reduction Algorithm |  |
| 15 | `Y5MXVLW5_E086` | `motivates` | 09-Problem Scenario | test-point optimization(Other) |  | 15-Data Preprocessing Algorithm | Expansion-Reduction Algorithm |  |
| 16 | `Y5MXVLW5_E087` | `motivates` | 09-Problem Scenario | imperfect test points(Uncertainty) |  | 16-Feature Extraction Algorithm | Fisher Discriminant Analysis |  |
| 17 | `Y5MXVLW5_E088` | `motivates` | 09-Problem Scenario | test-point optimization(Other) |  | 16-Feature Extraction Algorithm | Fisher Discriminant Analysis |  |
| 18 | `Y5MXVLW5_E089` | `motivates` | 09-Problem Scenario | imperfect test points(Uncertainty) |  | 17-Core Classifier Algorithm | Intelligent Classifier |  |
| 19 | `Y5MXVLW5_E090` | `motivates` | 09-Problem Scenario | test-point optimization(Other) |  | 17-Core Classifier Algorithm | Intelligent Classifier |  |
| 20 | `Y5MXVLW5_E091` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Fisher Discriminant Analysis |  |
| 21 | `Y5MXVLW5_E092` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Intelligent Classifier |  |
| 22 | `Y5MXVLW5_E093` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Intelligent Classifier |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `Y5AB3LDI_E096`：incipient stator inter-laminar short-circuits(Early Degradation Prediction) motivates Bandpass filter
  - `Y5AB3LDI_E097`：deep faults in the core(Other) motivates Bandpass filter
  - `Y5AB3LDI_E098`：incipient stator inter-laminar short-circuits(Early Degradation Prediction) motivates Phase-sensitive detection
  - `Y5AB3LDI_E099`：deep faults in the core(Other) motivates Phase-sensitive detection
  - `Y5AB3LDI_E100`：incipient stator inter-laminar short-circuits(Early Degradation Prediction) motivates ELCID
  - `Y5AB3LDI_E101`：deep faults in the core(Other) motivates ELCID
  - `Y5MXVLW5_E085`：imperfect test points(Uncertainty) motivates Expansion-Reduction Algorithm
  - `Y5MXVLW5_E086`：test-point optimization(Other) motivates Expansion-Reduction Algorithm
  - `Y5MXVLW5_E087`：imperfect test points(Uncertainty) motivates Fisher Discriminant Analysis
  - `Y5MXVLW5_E088`：test-point optimization(Other) motivates Fisher Discriminant Analysis
  - `Y5MXVLW5_E089`：imperfect test points(Uncertainty) motivates Intelligent Classifier
  - `Y5MXVLW5_E090`：test-point optimization(Other) motivates Intelligent Classifier
