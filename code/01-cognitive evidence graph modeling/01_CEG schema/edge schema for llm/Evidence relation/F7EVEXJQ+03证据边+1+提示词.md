...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `F7A2YH65_E080` | `motivates` | 13-Noise Level | submerged by strong noises / Gaussian noises(High Noise) |  | 16-Feature Extraction Algorithm | Dual-Kurtogram |  |
| 2 | `F7A2YH65_E081` | `motivates` | 09-Problem Scenario | compound fault diagnosis(Compound Faults) |  | 16-Feature Extraction Algorithm | Dual-Kurtogram |  |
| 3 | `F7A2YH65_E082` | `motivates` | 09-Problem Scenario | vibration signals submerged in considerable noises / unknown distribution(Uncertainty) |  | 16-Feature Extraction Algorithm | Dual-Kurtogram |  |
| 4 | `F7A2YH65_E083` | `motivates` | 09-Problem Scenario | early warning of weak faults(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Dual-Kurtogram |  |
| 5 | `F7A2YH65_E084` | `motivates` | 09-Problem Scenario | compound fault diagnosis(Compound Faults) |  | 17-Core Classifier Algorithm | Hotelling's T2 Control Chart |  |
| 6 | `F7A2YH65_E085` | `motivates` | 09-Problem Scenario | vibration signals submerged in considerable noises / unknown distribution(Uncertainty) |  | 17-Core Classifier Algorithm | Hotelling's T2 Control Chart |  |
| 7 | `F7A2YH65_E086` | `motivates` | 09-Problem Scenario | early warning of weak faults(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Hotelling's T2 Control Chart |  |
| 8 | `F7A2YH65_E087` | `motivates` | 07-Compound Fault | compound fault(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Dual-Kurtogram |  |
| 9 | `F7A2YH65_E088` | `motivates` | 07-Compound Fault | compound fault(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Hotelling's T2 Control Chart |  |
| 10 | `F7A2YH65_E089` | `motivates` | 06-Fault Severity | amplitude of the impact response, run-to-failure life data(Multiple Severities) |  | 17-Core Classifier Algorithm | Hotelling's T2 Control Chart |  |
| 11 | `F7EVEXJQ_E080` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Luenberger observer |  |
| 12 | `F7EVEXJQ_E081` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | DWT |  |
| 13 | `F7EVEXJQ_E082` | `motivates` | 09-Problem Scenario | control loops mask the fault effect(Other) |  | 15-Data Preprocessing Algorithm | Luenberger observer |  |
| 14 | `F7EVEXJQ_E083` | `motivates` | 09-Problem Scenario | non-stationary current signals(Other) |  | 15-Data Preprocessing Algorithm | Luenberger observer |  |
| 15 | `F7EVEXJQ_E084` | `motivates` | 09-Problem Scenario | control loops mask the fault effect(Other) |  | 16-Feature Extraction Algorithm | DWT |  |
| 16 | `F7EVEXJQ_E085` | `motivates` | 09-Problem Scenario | non-stationary current signals(Other) |  | 16-Feature Extraction Algorithm | DWT |  |
| 17 | `F7EVEXJQ_E086` | `motivates` | 09-Problem Scenario | control loops mask the fault effect(Other) |  | 17-Core Classifier Algorithm | Spectrum Analysis |  |
| 18 | `F7EVEXJQ_E087` | `motivates` | 09-Problem Scenario | non-stationary current signals(Other) |  | 17-Core Classifier Algorithm | Spectrum Analysis |  |
| 19 | `F7EVEXJQ_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | DWT |  |
| 20 | `F7EVEXJQ_E089` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Spectrum Analysis |  |
| 21 | `F7EVEXJQ_E090` | `motivates` | 06-Fault Severity | two broken rotor bars(Single Severity) |  | 17-Core Classifier Algorithm | Spectrum Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `F7A2YH65_E081`：compound fault diagnosis(Compound Faults) motivates Dual-Kurtogram
  - `F7A2YH65_E082`：vibration signals submerged in considerable noises / unknown distribution(Uncertainty) motivates Dual-Kurtogram
  - `F7A2YH65_E083`：early warning of weak faults(Early Degradation Prediction) motivates Dual-Kurtogram
  - `F7A2YH65_E084`：compound fault diagnosis(Compound Faults) motivates Hotelling's T2 Control Chart
  - `F7A2YH65_E085`：vibration signals submerged in considerable noises / unknown distribution(Uncertainty) motivates Hotelling's T2 Control Chart
  - `F7A2YH65_E086`：early warning of weak faults(Early Degradation Prediction) motivates Hotelling's T2 Control Chart
  - `F7EVEXJQ_E082`：control loops mask the fault effect(Other) motivates Luenberger observer
  - `F7EVEXJQ_E083`：non-stationary current signals(Other) motivates Luenberger observer
  - `F7EVEXJQ_E084`：control loops mask the fault effect(Other) motivates DWT
  - `F7EVEXJQ_E085`：non-stationary current signals(Other) motivates DWT
  - `F7EVEXJQ_E086`：control loops mask the fault effect(Other) motivates Spectrum Analysis
  - `F7EVEXJQ_E087`：non-stationary current signals(Other) motivates Spectrum Analysis
