...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `9CPEMLCQ_E120` | `motivates` | 09-Problem Scenario | difference in the distribution of rolling bearing fault data under different working conditions(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Pseudo-label learning |  |
| 2 | `9CPEMLCQ_E121` | `motivates` | 09-Problem Scenario | large environmental noise interference(Uncertainty) |  | 19-Training Optimization Algorithm | Pseudo-label learning |  |
| 3 | `9CPEMLCQ_E122` | `motivates` | 09-Problem Scenario | insufficient effective data sample(Small Fault Samples) |  | 19-Training Optimization Algorithm | Pseudo-label learning |  |
| 4 | `9CPEMLCQ_E123` | `motivates` | 12-Training Data Availability | 900 normal signal samples and 900 fault signals for each of the three data types, we finally get 3600 samples in each of the four conditions(Sufficient) |  | 19-Training Optimization Algorithm | Pseudo-label learning |  |
| 5 | `9CPEMLCQ_E124` | `motivates` | 13-Noise Level | large environmental noise interference(High Noise) |  | 15-Data Preprocessing Algorithm | CWT |  |
| 6 | `9CPEMLCQ_E125` | `motivates` | 13-Noise Level | large environmental noise interference(High Noise) |  | 16-Feature Extraction Algorithm | MMCNN |  |
| 7 | `9CPEMLCQ_E126` | `motivates` | 09-Problem Scenario | difference in the distribution of rolling bearing fault data under different working conditions(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | CWT |  |
| 8 | `9CPEMLCQ_E127` | `motivates` | 09-Problem Scenario | large environmental noise interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | CWT |  |
| 9 | `9CPEMLCQ_E128` | `motivates` | 09-Problem Scenario | insufficient effective data sample(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | CWT |  |
| 10 | `9CPEMLCQ_E129` | `motivates` | 09-Problem Scenario | difference in the distribution of rolling bearing fault data under different working conditions(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | MMCNN |  |
| 11 | `9CPEMLCQ_E130` | `motivates` | 09-Problem Scenario | large environmental noise interference(Uncertainty) |  | 16-Feature Extraction Algorithm | MMCNN |  |
| 12 | `9CPEMLCQ_E131` | `motivates` | 09-Problem Scenario | insufficient effective data sample(Small Fault Samples) |  | 16-Feature Extraction Algorithm | MMCNN |  |
| 13 | `9CPEMLCQ_E132` | `motivates` | 09-Problem Scenario | difference in the distribution of rolling bearing fault data under different working conditions(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `9CPEMLCQ_E133` | `motivates` | 09-Problem Scenario | large environmental noise interference(Uncertainty) |  | 17-Core Classifier Algorithm | Softmax |  |
| 15 | `9CPEMLCQ_E134` | `motivates` | 09-Problem Scenario | insufficient effective data sample(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 16 | `9CPEMLCQ_E135` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | MMCNN |  |
| 17 | `9CPEMLCQ_E136` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 18 | `9CPEMLCQ_E137` | `motivates` | 06-Fault Severity | fault diameters of 0.3 mm(Single Severity) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `9CPEMLCQ_E120`：difference in the distribution of rolling bearing fault data under different working conditions(Distribution Discrepancy) motivates Pseudo-label learning
  - `9CPEMLCQ_E121`：large environmental noise interference(Uncertainty) motivates Pseudo-label learning
  - `9CPEMLCQ_E122`：insufficient effective data sample(Small Fault Samples) motivates Pseudo-label learning
  - `9CPEMLCQ_E126`：difference in the distribution of rolling bearing fault data under different working conditions(Distribution Discrepancy) motivates CWT
  - `9CPEMLCQ_E127`：large environmental noise interference(Uncertainty) motivates CWT
  - `9CPEMLCQ_E128`：insufficient effective data sample(Small Fault Samples) motivates CWT
  - `9CPEMLCQ_E129`：difference in the distribution of rolling bearing fault data under different working conditions(Distribution Discrepancy) motivates MMCNN
  - `9CPEMLCQ_E130`：large environmental noise interference(Uncertainty) motivates MMCNN
  - `9CPEMLCQ_E131`：insufficient effective data sample(Small Fault Samples) motivates MMCNN
  - `9CPEMLCQ_E132`：difference in the distribution of rolling bearing fault data under different working conditions(Distribution Discrepancy) motivates Softmax
  - `9CPEMLCQ_E133`：large environmental noise interference(Uncertainty) motivates Softmax
  - `9CPEMLCQ_E134`：insufficient effective data sample(Small Fault Samples) motivates Softmax
