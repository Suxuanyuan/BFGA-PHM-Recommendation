...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HELS9JUS_E103` | `motivates` | 09-Problem Scenario | different machines suffer from significant differences in working conditions, structural parameters... distribution discrepancy(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Fine-tuning |  |
| 2 | `HELS9JUS_E104` | `motivates` | 09-Problem Scenario | limited labeled information / few labeled data(Small Fault Samples) |  | 19-Training Optimization Algorithm | Fine-tuning |  |
| 3 | `HELS9JUS_E105` | `motivates` | 12-Training Data Availability | limited labeled target training samples(Scarce) |  | 19-Training Optimization Algorithm | Fine-tuning |  |
| 4 | `HELS9JUS_E106` | `motivates` | 13-Noise Level | complex signals affected by noise(High Noise) |  | 16-Feature Extraction Algorithm | Auto-Encoder |  |
| 5 | `HELS9JUS_E107` | `motivates` | 09-Problem Scenario | different machines suffer from significant differences in working conditions, structural parameters... distribution discrepancy(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Auto-Encoder |  |
| 6 | `HELS9JUS_E108` | `motivates` | 09-Problem Scenario | limited labeled information / few labeled data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Auto-Encoder |  |
| 7 | `HELS9JUS_E109` | `motivates` | 09-Problem Scenario | different machines suffer from significant differences in working conditions, structural parameters... distribution discrepancy(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `HELS9JUS_E110` | `motivates` | 09-Problem Scenario | limited labeled information / few labeled data(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 9 | `HELS9JUS_E111` | `motivates` | 07-Compound Fault | Compound faults (inner and outer races)(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Auto-Encoder |  |
| 10 | `HELS9JUS_E112` | `motivates` | 07-Compound Fault | Compound faults (inner and outer races)(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `HELS9JUS_E113` | `motivates` | 06-Fault Severity | 0.18mm, 0.53mm, 0.2mm, 0.3mm, 0.4mm(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `HELS9JUS_E103`：different machines suffer from significant differences in working conditions, structural parameters... distribution discrepancy(Distribution Discrepancy) motivates Fine-tuning
  - `HELS9JUS_E104`：limited labeled information / few labeled data(Small Fault Samples) motivates Fine-tuning
  - `HELS9JUS_E107`：different machines suffer from significant differences in working conditions, structural parameters... distribution discrepancy(Distribution Discrepancy) motivates Auto-Encoder
  - `HELS9JUS_E108`：limited labeled information / few labeled data(Small Fault Samples) motivates Auto-Encoder
  - `HELS9JUS_E109`：different machines suffer from significant differences in working conditions, structural parameters... distribution discrepancy(Distribution Discrepancy) motivates Softmax
  - `HELS9JUS_E110`：limited labeled information / few labeled data(Small Fault Samples) motivates Softmax
