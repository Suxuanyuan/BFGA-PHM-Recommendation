...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SC93PNIR_E105` | `motivates` | 09-Problem Scenario | mode mixing of EMD and classifier parameter selection(Other) |  | 19-Training Optimization Algorithm | Harmony Search |  |
| 2 | `SC93PNIR_E106` | `motivates` | 12-Training Data Availability | 85 sets of experimental data (40 training sets)(Scarce) |  | 19-Training Optimization Algorithm | Harmony Search |  |
| 3 | `SC93PNIR_E107` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Variational Mode Decomposition |  |
| 4 | `SC93PNIR_E108` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Kullback-Leibler Divergence |  |
| 5 | `SC93PNIR_E109` | `motivates` | 09-Problem Scenario | mode mixing of EMD and classifier parameter selection(Other) |  | 15-Data Preprocessing Algorithm | Variational Mode Decomposition |  |
| 6 | `SC93PNIR_E110` | `motivates` | 09-Problem Scenario | mode mixing of EMD and classifier parameter selection(Other) |  | 16-Feature Extraction Algorithm | Kullback-Leibler Divergence |  |
| 7 | `SC93PNIR_E111` | `motivates` | 09-Problem Scenario | mode mixing of EMD and classifier parameter selection(Other) |  | 17-Core Classifier Algorithm | Relevance Vector Machine |  |
| 8 | `SC93PNIR_E112` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Kullback-Leibler Divergence |  |
| 9 | `SC93PNIR_E113` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Relevance Vector Machine |  |
| 10 | `SC93PNIR_E114` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Relevance Vector Machine |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `SC93PNIR_E105`：mode mixing of EMD and classifier parameter selection(Other) motivates Harmony Search
  - `SC93PNIR_E109`：mode mixing of EMD and classifier parameter selection(Other) motivates Variational Mode Decomposition
  - `SC93PNIR_E110`：mode mixing of EMD and classifier parameter selection(Other) motivates Kullback-Leibler Divergence
  - `SC93PNIR_E111`：mode mixing of EMD and classifier parameter selection(Other) motivates Relevance Vector Machine
