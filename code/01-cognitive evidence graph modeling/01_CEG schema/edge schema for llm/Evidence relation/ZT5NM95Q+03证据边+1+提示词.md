...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZT5NM95Q_E096` | `motivates` | 13-Noise Level | high-frequency noise(High Noise) |  | 15-Data Preprocessing Algorithm | Park's Vector Modulus |  |
| 2 | `ZT5NM95Q_E097` | `motivates` | 13-Noise Level | high-frequency noise(High Noise) |  | 16-Feature Extraction Algorithm | Weighted Sliding Hilbert Transform |  |
| 3 | `ZT5NM95Q_E098` | `motivates` | 09-Problem Scenario | speed variations(Other) |  | 15-Data Preprocessing Algorithm | Park's Vector Modulus |  |
| 4 | `ZT5NM95Q_E099` | `motivates` | 09-Problem Scenario | multiple open-circuit faults(Other) |  | 15-Data Preprocessing Algorithm | Park's Vector Modulus |  |
| 5 | `ZT5NM95Q_E100` | `motivates` | 09-Problem Scenario | speed variations(Other) |  | 16-Feature Extraction Algorithm | Weighted Sliding Hilbert Transform |  |
| 6 | `ZT5NM95Q_E101` | `motivates` | 09-Problem Scenario | multiple open-circuit faults(Other) |  | 16-Feature Extraction Algorithm | Weighted Sliding Hilbert Transform |  |
| 7 | `ZT5NM95Q_E102` | `motivates` | 09-Problem Scenario | speed variations(Other) |  | 17-Core Classifier Algorithm | Threshold Identification Method |  |
| 8 | `ZT5NM95Q_E103` | `motivates` | 09-Problem Scenario | multiple open-circuit faults(Other) |  | 17-Core Classifier Algorithm | Threshold Identification Method |  |
| 9 | `ZT5NM95Q_E104` | `motivates` | 07-Compound Fault | multiple open-circuit faults(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Weighted Sliding Hilbert Transform |  |
| 10 | `ZT5NM95Q_E105` | `motivates` | 07-Compound Fault | multiple open-circuit faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Threshold Identification Method |  |
| 11 | `ZT5NM95Q_E106` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Threshold Identification Method |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZT5NM95Q_E098`：speed variations(Other) motivates Park's Vector Modulus
  - `ZT5NM95Q_E099`：multiple open-circuit faults(Other) motivates Park's Vector Modulus
  - `ZT5NM95Q_E100`：speed variations(Other) motivates Weighted Sliding Hilbert Transform
  - `ZT5NM95Q_E101`：multiple open-circuit faults(Other) motivates Weighted Sliding Hilbert Transform
  - `ZT5NM95Q_E102`：speed variations(Other) motivates Threshold Identification Method
  - `ZT5NM95Q_E103`：multiple open-circuit faults(Other) motivates Threshold Identification Method
