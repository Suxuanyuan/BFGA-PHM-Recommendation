...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `NITTNNHE_E102` | `motivates` | 13-Noise Level | white Gaussian noise, strong noise(High Noise) |  | 15-Data Preprocessing Algorithm | Vold-Kalman filter |  |
| 2 | `NITTNNHE_E103` | `motivates` | 13-Noise Level | white Gaussian noise, strong noise(High Noise) |  | 16-Feature Extraction Algorithm | Hilbert transform |  |
| 3 | `NITTNNHE_E104` | `motivates` | 09-Problem Scenario | nonstationary speeds / time-varying gear fault features(Other) |  | 15-Data Preprocessing Algorithm | Vold-Kalman filter |  |
| 4 | `NITTNNHE_E105` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Vold-Kalman filter |  |
| 5 | `NITTNNHE_E106` | `motivates` | 09-Problem Scenario | nonstationary speeds / time-varying gear fault features(Other) |  | 16-Feature Extraction Algorithm | Hilbert transform |  |
| 6 | `NITTNNHE_E107` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Hilbert transform |  |
| 7 | `NITTNNHE_E108` | `motivates` | 09-Problem Scenario | nonstationary speeds / time-varying gear fault features(Other) |  | 17-Core Classifier Algorithm | Demodulation analysis |  |
| 8 | `NITTNNHE_E109` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Demodulation analysis |  |
| 9 | `NITTNNHE_E110` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Hilbert transform |  |
| 10 | `NITTNNHE_E111` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Demodulation analysis |  |
| 11 | `NITTNNHE_E112` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Demodulation analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `NITTNNHE_E104`：nonstationary speeds / time-varying gear fault features(Other) motivates Vold-Kalman filter
  - `NITTNNHE_E105`：noise robustness(Uncertainty) motivates Vold-Kalman filter
  - `NITTNNHE_E106`：nonstationary speeds / time-varying gear fault features(Other) motivates Hilbert transform
  - `NITTNNHE_E107`：noise robustness(Uncertainty) motivates Hilbert transform
  - `NITTNNHE_E108`：nonstationary speeds / time-varying gear fault features(Other) motivates Demodulation analysis
  - `NITTNNHE_E109`：noise robustness(Uncertainty) motivates Demodulation analysis
