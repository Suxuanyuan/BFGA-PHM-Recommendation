...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PHHPWRL5_E098` | `motivates` | 09-Problem Scenario | inaccurate estimation of the fault period, noise robustness(Uncertainty) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 2 | `PHHPWRL5_E099` | `motivates` | 12-Training Data Availability | Sufficient |  | 18-Data Generation Algorithm | Vibration Model |  |
| 3 | `PHHPWRL5_E100` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 4 | `PHHPWRL5_E101` | `motivates` | 13-Noise Level | strong noise(High Noise) |  | 15-Data Preprocessing Algorithm | Resampling |  |
| 5 | `PHHPWRL5_E102` | `motivates` | 13-Noise Level | strong noise(High Noise) |  | 16-Feature Extraction Algorithm | Deconvolution |  |
| 6 | `PHHPWRL5_E103` | `motivates` | 09-Problem Scenario | inaccurate estimation of the fault period, noise robustness(Uncertainty) |  | 18-Data Generation Algorithm | Vibration Model |  |
| 7 | `PHHPWRL5_E104` | `motivates` | 09-Problem Scenario | inaccurate estimation of the fault period, noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Resampling |  |
| 8 | `PHHPWRL5_E105` | `motivates` | 09-Problem Scenario | inaccurate estimation of the fault period, noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Deconvolution |  |
| 9 | `PHHPWRL5_E106` | `motivates` | 09-Problem Scenario | inaccurate estimation of the fault period, noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 10 | `PHHPWRL5_E107` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Deconvolution |  |
| 11 | `PHHPWRL5_E108` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 12 | `PHHPWRL5_E109` | `motivates` | 06-Fault Severity | depth: 0.2 mm, width: 0.6 mm(Single Severity) |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `PHHPWRL5_E098`：inaccurate estimation of the fault period, noise robustness(Uncertainty) motivates Particle Swarm Optimization
  - `PHHPWRL5_E103`：inaccurate estimation of the fault period, noise robustness(Uncertainty) motivates Vibration Model
  - `PHHPWRL5_E104`：inaccurate estimation of the fault period, noise robustness(Uncertainty) motivates Resampling
  - `PHHPWRL5_E105`：inaccurate estimation of the fault period, noise robustness(Uncertainty) motivates Deconvolution
  - `PHHPWRL5_E106`：inaccurate estimation of the fault period, noise robustness(Uncertainty) motivates Envelope Spectrum Analysis
...
*This prompt is automatically generated by edge_03_prompt.py (Batch 1, total 12 edges)*
