...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `NKVS7LKS_E084` | `motivates` | 09-Problem Scenario | multiagent systems(Complex Systems) |  | 19-Training Optimization Algorithm | Mixed H-infinity/H2 optimization |  |
| 2 | `NKVS7LKS_E085` | `motivates` | 09-Problem Scenario | external disturbances and model uncertainties(Uncertainty) |  | 19-Training Optimization Algorithm | Mixed H-infinity/H2 optimization |  |
| 3 | `NKVS7LKS_E086` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Mixed H-infinity/H2 optimization |  |
| 4 | `NKVS7LKS_E087` | `motivates` | 13-Noise Level | external disturbances, measurement errors(High Noise) |  | 16-Feature Extraction Algorithm | Observer-based residual generator |  |
| 5 | `NKVS7LKS_E088` | `motivates` | 09-Problem Scenario | multiagent systems(Complex Systems) |  | 16-Feature Extraction Algorithm | Observer-based residual generator |  |
| 6 | `NKVS7LKS_E089` | `motivates` | 09-Problem Scenario | external disturbances and model uncertainties(Uncertainty) |  | 16-Feature Extraction Algorithm | Observer-based residual generator |  |
| 7 | `NKVS7LKS_E090` | `motivates` | 09-Problem Scenario | multiagent systems(Complex Systems) |  | 17-Core Classifier Algorithm | Adaptive thresholding |  |
| 8 | `NKVS7LKS_E091` | `motivates` | 09-Problem Scenario | external disturbances and model uncertainties(Uncertainty) |  | 17-Core Classifier Algorithm | Adaptive thresholding |  |
| 9 | `NKVS7LKS_E092` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Observer-based residual generator |  |
| 10 | `NKVS7LKS_E093` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Adaptive thresholding |  |
| 11 | `NKVS7LKS_E094` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Adaptive thresholding |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `NKVS7LKS_E084`：multiagent systems(Complex Systems) motivates Mixed H-infinity/H2 optimization
  - `NKVS7LKS_E085`：external disturbances and model uncertainties(Uncertainty) motivates Mixed H-infinity/H2 optimization
  - `NKVS7LKS_E088`：multiagent systems(Complex Systems) motivates Observer-based residual generator
  - `NKVS7LKS_E089`：external disturbances and model uncertainties(Uncertainty) motivates Observer-based residual generator
  - `NKVS7LKS_E090`：multiagent systems(Complex Systems) motivates Adaptive thresholding
  - `NKVS7LKS_E091`：external disturbances and model uncertainties(Uncertainty) motivates Adaptive thresholding
