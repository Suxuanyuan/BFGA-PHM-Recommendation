...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3S8K24WT_E150` | `motivates` | 13-Noise Level | low-pass filtered(Normal) |  | 15-Data Preprocessing Algorithm | Low-pass filter |  |
| 2 | `3S8K24WT_E151` | `motivates` | 13-Noise Level | low-pass filtered(Normal) |  | 16-Feature Extraction Algorithm | MSTD |  |
| 3 | `3S8K24WT_E152` | `motivates` | 09-Problem Scenario | multimodal data collection (strain, acceleration, video, and GPS/IMU data)(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Low-pass filter |  |
| 4 | `3S8K24WT_E153` | `motivates` | 09-Problem Scenario | temperature interference and vibration noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Low-pass filter |  |
| 5 | `3S8K24WT_E154` | `motivates` | 09-Problem Scenario | pantograph-catenary interaction (complex structural analysis)(Complex Systems) |  | 15-Data Preprocessing Algorithm | Low-pass filter |  |
| 6 | `3S8K24WT_E155` | `motivates` | 09-Problem Scenario | multimodal data collection (strain, acceleration, video, and GPS/IMU data)(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | MSTD |  |
| 7 | `3S8K24WT_E156` | `motivates` | 09-Problem Scenario | temperature interference and vibration noise(Uncertainty) |  | 16-Feature Extraction Algorithm | MSTD |  |
| 8 | `3S8K24WT_E157` | `motivates` | 09-Problem Scenario | pantograph-catenary interaction (complex structural analysis)(Complex Systems) |  | 16-Feature Extraction Algorithm | MSTD |  |
| 9 | `3S8K24WT_E158` | `motivates` | 09-Problem Scenario | multimodal data collection (strain, acceleration, video, and GPS/IMU data)(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | Adaptive Pauta criterion |  |
| 10 | `3S8K24WT_E159` | `motivates` | 09-Problem Scenario | temperature interference and vibration noise(Uncertainty) |  | 17-Core Classifier Algorithm | Adaptive Pauta criterion |  |
| 11 | `3S8K24WT_E160` | `motivates` | 09-Problem Scenario | pantograph-catenary interaction (complex structural analysis)(Complex Systems) |  | 17-Core Classifier Algorithm | Adaptive Pauta criterion |  |
| 12 | `3S8K24WT_E161` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | MSTD |  |
| 13 | `3S8K24WT_E162` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Adaptive Pauta criterion |  |
| 14 | `3S8K24WT_E163` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Adaptive Pauta criterion |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `3S8K24WT_E152`：multimodal data collection (strain, acceleration, video, and GPS/IMU data)(Multi-Source Heterogeneous / Multimodal Data) motivates Low-pass filter
  - `3S8K24WT_E153`：temperature interference and vibration noise(Uncertainty) motivates Low-pass filter
  - `3S8K24WT_E154`：pantograph-catenary interaction (complex structural analysis)(Complex Systems) motivates Low-pass filter
  - `3S8K24WT_E155`：multimodal data collection (strain, acceleration, video, and GPS/IMU data)(Multi-Source Heterogeneous / Multimodal Data) motivates MSTD
  - `3S8K24WT_E156`：temperature interference and vibration noise(Uncertainty) motivates MSTD
  - `3S8K24WT_E157`：pantograph-catenary interaction (complex structural analysis)(Complex Systems) motivates MSTD
  - `3S8K24WT_E158`：multimodal data collection (strain, acceleration, video, and GPS/IMU data)(Multi-Source Heterogeneous / Multimodal Data) motivates Adaptive Pauta criterion
  - `3S8K24WT_E159`：temperature interference and vibration noise(Uncertainty) motivates Adaptive Pauta criterion
  - `3S8K24WT_E160`：pantograph-catenary interaction (complex structural analysis)(Complex Systems) motivates Adaptive Pauta criterion
