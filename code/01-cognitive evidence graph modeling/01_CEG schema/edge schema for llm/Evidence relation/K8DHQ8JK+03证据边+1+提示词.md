...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `K8DHQ8JK_E073` | `motivates` | 13-Noise Level | Normal operating environment(Normal) |  | 15-Data Preprocessing Algorithm | Hanning window |  |
| 2 | `K8DHQ8JK_E074` | `motivates` | 13-Noise Level | Normal operating environment(Normal) |  | 16-Feature Extraction Algorithm | FFT |  |
| 3 | `K8DHQ8JK_E075` | `motivates` | 09-Problem Scenario | False alarms produced by rotor axial air ducts(Other) |  | 15-Data Preprocessing Algorithm | Hanning window |  |
| 4 | `K8DHQ8JK_E076` | `motivates` | 09-Problem Scenario | False alarms produced by rotor axial air ducts(Other) |  | 16-Feature Extraction Algorithm | FFT |  |
| 5 | `K8DHQ8JK_E077` | `motivates` | 09-Problem Scenario | False alarms produced by rotor axial air ducts(Other) |  | 17-Core Classifier Algorithm | Amplitude thresholding |  |
| 6 | `K8DHQ8JK_E078` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | FFT |  |
| 7 | `K8DHQ8JK_E079` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Amplitude thresholding |  |
| 8 | `K8DHQ8JK_E080` | `motivates` | 06-Fault Severity | 0, 1, and 2 broken rotor bars(Multiple Severities) |  | 17-Core Classifier Algorithm | Amplitude thresholding |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `K8DHQ8JK_E075`：False alarms produced by rotor axial air ducts(Other) motivates Hanning window
  - `K8DHQ8JK_E076`：False alarms produced by rotor axial air ducts(Other) motivates FFT
  - `K8DHQ8JK_E077`：False alarms produced by rotor axial air ducts(Other) motivates Amplitude thresholding
