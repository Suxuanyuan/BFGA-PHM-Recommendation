...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QNTBIQVP_E080` | `motivates` | 13-Noise Level | spectral analysis signals(Normal) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 2 | `QNTBIQVP_E081` | `motivates` | 13-Noise Level | spectral analysis signals(Normal) |  | 16-Feature Extraction Algorithm | FFT |  |
| 3 | `QNTBIQVP_E082` | `motivates` | 09-Problem Scenario | uncertainty and noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 4 | `QNTBIQVP_E083` | `motivates` | 09-Problem Scenario | false indications due to structural asymmetry and fault cancellation(Other) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 5 | `QNTBIQVP_E084` | `motivates` | 09-Problem Scenario | uncertainty and noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | FFT |  |
| 6 | `QNTBIQVP_E085` | `motivates` | 09-Problem Scenario | false indications due to structural asymmetry and fault cancellation(Other) |  | 16-Feature Extraction Algorithm | FFT |  |
| 7 | `QNTBIQVP_E086` | `motivates` | 09-Problem Scenario | uncertainty and noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 8 | `QNTBIQVP_E087` | `motivates` | 09-Problem Scenario | false indications due to structural asymmetry and fault cancellation(Other) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 9 | `QNTBIQVP_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | FFT |  |
| 10 | `QNTBIQVP_E089` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 11 | `QNTBIQVP_E090` | `motivates` | 06-Fault Severity | number of broken bars(Multiple Severities) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `QNTBIQVP_E082`：uncertainty and noise robustness(Uncertainty) motivates Normalization
  - `QNTBIQVP_E083`：false indications due to structural asymmetry and fault cancellation(Other) motivates Normalization
  - `QNTBIQVP_E084`：uncertainty and noise robustness(Uncertainty) motivates FFT
  - `QNTBIQVP_E085`：false indications due to structural asymmetry and fault cancellation(Other) motivates FFT
  - `QNTBIQVP_E086`：uncertainty and noise robustness(Uncertainty) motivates Threshold Decision
  - `QNTBIQVP_E087`：false indications due to structural asymmetry and fault cancellation(Other) motivates Threshold Decision
