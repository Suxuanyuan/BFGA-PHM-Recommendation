...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZELVFWZ7_E099` | `motivates` | 13-Noise Level | strong background noise(High Noise) |  | 15-Data Preprocessing Algorithm | Nonlocal Means |  |
| 2 | `ZELVFWZ7_E100` | `motivates` | 13-Noise Level | strong background noise(High Noise) |  | 16-Feature Extraction Algorithm | Shift-invariant K-singular value decomposition |  |
| 3 | `ZELVFWZ7_E101` | `motivates` | 09-Problem Scenario | incipient fault detection(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Nonlocal Means |  |
| 4 | `ZELVFWZ7_E102` | `motivates` | 09-Problem Scenario | strong background noise and random slippage(Uncertainty) |  | 15-Data Preprocessing Algorithm | Nonlocal Means |  |
| 5 | `ZELVFWZ7_E103` | `motivates` | 09-Problem Scenario | incipient fault detection(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Shift-invariant K-singular value decomposition |  |
| 6 | `ZELVFWZ7_E104` | `motivates` | 09-Problem Scenario | strong background noise and random slippage(Uncertainty) |  | 16-Feature Extraction Algorithm | Shift-invariant K-singular value decomposition |  |
| 7 | `ZELVFWZ7_E105` | `motivates` | 09-Problem Scenario | incipient fault detection(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Envelope spectrum analysis |  |
| 8 | `ZELVFWZ7_E106` | `motivates` | 09-Problem Scenario | strong background noise and random slippage(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope spectrum analysis |  |
| 9 | `ZELVFWZ7_E107` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Shift-invariant K-singular value decomposition |  |
| 10 | `ZELVFWZ7_E108` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope spectrum analysis |  |
| 11 | `ZELVFWZ7_E109` | `motivates` | 06-Fault Severity | early failure stage, medium stage, last failure stage(Multiple Severities) |  | 17-Core Classifier Algorithm | Envelope spectrum analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZELVFWZ7_E101`：incipient fault detection(Early Degradation Prediction) motivates Nonlocal Means
  - `ZELVFWZ7_E102`：strong background noise and random slippage(Uncertainty) motivates Nonlocal Means
  - `ZELVFWZ7_E103`：incipient fault detection(Early Degradation Prediction) motivates Shift-invariant K-singular value decomposition
  - `ZELVFWZ7_E104`：strong background noise and random slippage(Uncertainty) motivates Shift-invariant K-singular value decomposition
  - `ZELVFWZ7_E105`：incipient fault detection(Early Degradation Prediction) motivates Envelope spectrum analysis
  - `ZELVFWZ7_E106`：strong background noise and random slippage(Uncertainty) motivates Envelope spectrum analysis
