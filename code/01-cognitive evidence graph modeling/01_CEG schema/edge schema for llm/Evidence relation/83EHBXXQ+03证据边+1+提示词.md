...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `83EHBXXQ_E140` | `motivates` | 13-Noise Level | signal to noise ratio (SNR) of 20 dB(High Noise) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 2 | `83EHBXXQ_E141` | `motivates` | 13-Noise Level | signal to noise ratio (SNR) of 20 dB(High Noise) |  | 16-Feature Extraction Algorithm | FFT |  |
| 3 | `83EHBXXQ_E142` | `motivates` | 09-Problem Scenario | non-ideal operating conditions / noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 4 | `83EHBXXQ_E143` | `motivates` | 09-Problem Scenario | sensor reduction and cost constraints(Other) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 5 | `83EHBXXQ_E144` | `motivates` | 09-Problem Scenario | non-ideal operating conditions / noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | FFT |  |
| 6 | `83EHBXXQ_E145` | `motivates` | 09-Problem Scenario | sensor reduction and cost constraints(Other) |  | 16-Feature Extraction Algorithm | FFT |  |
| 7 | `83EHBXXQ_E146` | `motivates` | 09-Problem Scenario | non-ideal operating conditions / noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold Method |  |
| 8 | `83EHBXXQ_E147` | `motivates` | 09-Problem Scenario | sensor reduction and cost constraints(Other) |  | 17-Core Classifier Algorithm | Threshold Method |  |
| 9 | `83EHBXXQ_E148` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | FFT |  |
| 10 | `83EHBXXQ_E149` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold Method |  |
| 11 | `83EHBXXQ_E150` | `motivates` | 06-Fault Severity | unbalance ratio in the line voltages(Multiple Severities) |  | 17-Core Classifier Algorithm | Threshold Method |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `83EHBXXQ_E142`：non-ideal operating conditions / noise robustness(Uncertainty) motivates Normalization
  - `83EHBXXQ_E143`：sensor reduction and cost constraints(Other) motivates Normalization
  - `83EHBXXQ_E144`：non-ideal operating conditions / noise robustness(Uncertainty) motivates FFT
  - `83EHBXXQ_E145`：sensor reduction and cost constraints(Other) motivates FFT
  - `83EHBXXQ_E146`：non-ideal operating conditions / noise robustness(Uncertainty) motivates Threshold Method
  - `83EHBXXQ_E147`：sensor reduction and cost constraints(Other) motivates Threshold Method
