...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `25MYVY4Y_E095` | `motivates` | 13-Noise Level | white noise of SNR= -7 dB, submerged in the sharp interference from both shaft rubbing and noise(High Noise) |  | 16-Feature Extraction Algorithm | Shift-invariant dictionary learning |  |
| 2 | `25MYVY4Y_E096` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Shift-invariant dictionary learning |  |
| 3 | `25MYVY4Y_E097` | `motivates` | 09-Problem Scenario | priori knowledge dependence of predefined dictionary(Other) |  | 16-Feature Extraction Algorithm | Shift-invariant dictionary learning |  |
| 4 | `25MYVY4Y_E098` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Hidden Markov model |  |
| 5 | `25MYVY4Y_E099` | `motivates` | 09-Problem Scenario | priori knowledge dependence of predefined dictionary(Other) |  | 17-Core Classifier Algorithm | Hidden Markov model |  |
| 6 | `25MYVY4Y_E100` | `motivates` | 07-Compound Fault | notch and local rubbing(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | Shift-invariant dictionary learning |  |
| 7 | `25MYVY4Y_E101` | `motivates` | 07-Compound Fault | notch and local rubbing(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | Hidden Markov model |  |
| 8 | `25MYVY4Y_E102` | `motivates` | 06-Fault Severity | notch with a width of 1.0 mm(Single Severity) |  | 17-Core Classifier Algorithm | Hidden Markov model |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `25MYVY4Y_E096`：noise robustness(Uncertainty) motivates Shift-invariant dictionary learning
  - `25MYVY4Y_E097`：priori knowledge dependence of predefined dictionary(Other) motivates Shift-invariant dictionary learning
  - `25MYVY4Y_E098`：noise robustness(Uncertainty) motivates Hidden Markov model
  - `25MYVY4Y_E099`：priori knowledge dependence of predefined dictionary(Other) motivates Hidden Markov model
