...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `YM6YE4FW_E068` | `motivates` | 13-Noise Level | measurement noise(High Noise) |  | 15-Data Preprocessing Algorithm | Butterworth filter |  |
| 2 | `YM6YE4FW_E069` | `motivates` | 09-Problem Scenario | complexity of multidomain systems(Complex Systems) |  | 15-Data Preprocessing Algorithm | Butterworth filter |  |
| 3 | `YM6YE4FW_E070` | `motivates` | 09-Problem Scenario | multiple fault modes(Compound Faults) |  | 15-Data Preprocessing Algorithm | Butterworth filter |  |
| 4 | `YM6YE4FW_E071` | `motivates` | 09-Problem Scenario | complexity of multidomain systems(Complex Systems) |  | 17-Core Classifier Algorithm | consistency-based diagnosis |  |
| 5 | `YM6YE4FW_E072` | `motivates` | 09-Problem Scenario | multiple fault modes(Compound Faults) |  | 17-Core Classifier Algorithm | consistency-based diagnosis |  |
| 6 | `YM6YE4FW_E073` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | consistency-based diagnosis |  |
| 7 | `YM6YE4FW_E074` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | consistency-based diagnosis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `YM6YE4FW_E069`：complexity of multidomain systems(Complex Systems) motivates Butterworth filter
  - `YM6YE4FW_E070`：multiple fault modes(Compound Faults) motivates Butterworth filter
  - `YM6YE4FW_E071`：complexity of multidomain systems(Complex Systems) motivates consistency-based diagnosis
  - `YM6YE4FW_E072`：multiple fault modes(Compound Faults) motivates consistency-based diagnosis
