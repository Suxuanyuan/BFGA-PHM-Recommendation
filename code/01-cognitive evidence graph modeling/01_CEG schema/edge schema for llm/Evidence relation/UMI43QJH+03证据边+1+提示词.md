...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `UMI43QJH_E206` | `motivates` | 09-Problem Scenario | data imbalance(Small Fault Samples) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 2 | `UMI43QJH_E207` | `motivates` | 09-Problem Scenario | distribution differences(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 3 | `UMI43QJH_E208` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 4 | `UMI43QJH_E209` | `motivates` | 12-Training Data Availability | training samples(Sufficient) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 5 | `UMI43QJH_E210` | `motivates` | 13-Noise Level | heavy ambient noise(High Noise) |  | 15-Data Preprocessing Algorithm | Teager calculated order spectrum |  |
| 6 | `UMI43QJH_E211` | `motivates` | 13-Noise Level | heavy ambient noise(High Noise) |  | 16-Feature Extraction Algorithm | 1D-CNN |  |
| 7 | `UMI43QJH_E212` | `motivates` | 09-Problem Scenario | data imbalance(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Teager calculated order spectrum |  |
| 8 | `UMI43QJH_E213` | `motivates` | 09-Problem Scenario | distribution differences(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Teager calculated order spectrum |  |
| 9 | `UMI43QJH_E214` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Teager calculated order spectrum |  |
| 10 | `UMI43QJH_E215` | `motivates` | 09-Problem Scenario | data imbalance(Small Fault Samples) |  | 16-Feature Extraction Algorithm | 1D-CNN |  |
| 11 | `UMI43QJH_E216` | `motivates` | 09-Problem Scenario | distribution differences(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | 1D-CNN |  |
| 12 | `UMI43QJH_E217` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | 1D-CNN |  |
| 13 | `UMI43QJH_E218` | `motivates` | 09-Problem Scenario | data imbalance(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `UMI43QJH_E219` | `motivates` | 09-Problem Scenario | distribution differences(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 15 | `UMI43QJH_E220` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Softmax |  |
| 16 | `UMI43QJH_E221` | `motivates` | 07-Compound Fault | compound fault(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | 1D-CNN |  |
| 17 | `UMI43QJH_E222` | `motivates` | 07-Compound Fault | compound fault(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | Softmax |  |
| 18 | `UMI43QJH_E223` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `UMI43QJH_E206`：data imbalance(Small Fault Samples) motivates Particle Swarm Optimization
  - `UMI43QJH_E207`：distribution differences(Distribution Discrepancy) motivates Particle Swarm Optimization
  - `UMI43QJH_E208`：noise robustness(Uncertainty) motivates Particle Swarm Optimization
  - `UMI43QJH_E212`：data imbalance(Small Fault Samples) motivates Teager calculated order spectrum
  - `UMI43QJH_E213`：distribution differences(Distribution Discrepancy) motivates Teager calculated order spectrum
  - `UMI43QJH_E214`：noise robustness(Uncertainty) motivates Teager calculated order spectrum
  - `UMI43QJH_E215`：data imbalance(Small Fault Samples) motivates 1D-CNN
  - `UMI43QJH_E216`：distribution differences(Distribution Discrepancy) motivates 1D-CNN
  - `UMI43QJH_E217`：noise robustness(Uncertainty) motivates 1D-CNN
  - `UMI43QJH_E218`：data imbalance(Small Fault Samples) motivates Softmax
  - `UMI43QJH_E219`：distribution differences(Distribution Discrepancy) motivates Softmax
  - `UMI43QJH_E220`：noise robustness(Uncertainty) motivates Softmax
