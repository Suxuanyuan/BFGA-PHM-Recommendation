...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `8SEZD7QB_E111` | `motivates` | 09-Problem Scenario | only a few labeled data available(Small Fault Samples) |  | 19-Training Optimization Algorithm | DPC |  |
| 2 | `8SEZD7QB_E112` | `motivates` | 09-Problem Scenario | noises(Uncertainty) |  | 19-Training Optimization Algorithm | DPC |  |
| 3 | `8SEZD7QB_E113` | `motivates` | 09-Problem Scenario | combinations of heath condition(Compound Faults) |  | 19-Training Optimization Algorithm | DPC |  |
| 4 | `8SEZD7QB_E114` | `motivates` | 12-Training Data Availability | 500 training samples per class(Sufficient) |  | 19-Training Optimization Algorithm | DPC |  |
| 5 | `8SEZD7QB_E115` | `motivates` | 13-Noise Level | white noise is added into dataset to yield three noisy data with SNR of 10 dB, 5 dB and 2 dB(High Noise) |  | 15-Data Preprocessing Algorithm | Z-score normalization |  |
| 6 | `8SEZD7QB_E116` | `motivates` | 13-Noise Level | white noise is added into dataset to yield three noisy data with SNR of 10 dB, 5 dB and 2 dB(High Noise) |  | 16-Feature Extraction Algorithm | SS-KLFDA |  |
| 7 | `8SEZD7QB_E117` | `motivates` | 09-Problem Scenario | only a few labeled data available(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Z-score normalization |  |
| 8 | `8SEZD7QB_E118` | `motivates` | 09-Problem Scenario | noises(Uncertainty) |  | 15-Data Preprocessing Algorithm | Z-score normalization |  |
| 9 | `8SEZD7QB_E119` | `motivates` | 09-Problem Scenario | combinations of heath condition(Compound Faults) |  | 15-Data Preprocessing Algorithm | Z-score normalization |  |
| 10 | `8SEZD7QB_E120` | `motivates` | 09-Problem Scenario | only a few labeled data available(Small Fault Samples) |  | 16-Feature Extraction Algorithm | SS-KLFDA |  |
| 11 | `8SEZD7QB_E121` | `motivates` | 09-Problem Scenario | noises(Uncertainty) |  | 16-Feature Extraction Algorithm | SS-KLFDA |  |
| 12 | `8SEZD7QB_E122` | `motivates` | 09-Problem Scenario | combinations of heath condition(Compound Faults) |  | 16-Feature Extraction Algorithm | SS-KLFDA |  |
| 13 | `8SEZD7QB_E123` | `motivates` | 09-Problem Scenario | only a few labeled data available(Small Fault Samples) |  | 17-Core Classifier Algorithm | 1NN |  |
| 14 | `8SEZD7QB_E124` | `motivates` | 09-Problem Scenario | noises(Uncertainty) |  | 17-Core Classifier Algorithm | 1NN |  |
| 15 | `8SEZD7QB_E125` | `motivates` | 09-Problem Scenario | combinations of heath condition(Compound Faults) |  | 17-Core Classifier Algorithm | 1NN |  |
| 16 | `8SEZD7QB_E126` | `motivates` | 07-Compound Fault | IF+OF, OF+RF, IF+RF, IF+OF+RF(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | SS-KLFDA |  |
| 17 | `8SEZD7QB_E127` | `motivates` | 07-Compound Fault | IF+OF, OF+RF, IF+RF, IF+OF+RF(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | 1NN |  |
| 18 | `8SEZD7QB_E128` | `motivates` | 06-Fault Severity | 0.6 mm width, 1 mm diameter and 2 mm depth(Single Severity) |  | 17-Core Classifier Algorithm | 1NN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `8SEZD7QB_E111`：only a few labeled data available(Small Fault Samples) motivates DPC
  - `8SEZD7QB_E112`：noises(Uncertainty) motivates DPC
  - `8SEZD7QB_E113`：combinations of heath condition(Compound Faults) motivates DPC
  - `8SEZD7QB_E117`：only a few labeled data available(Small Fault Samples) motivates Z-score normalization
  - `8SEZD7QB_E118`：noises(Uncertainty) motivates Z-score normalization
  - `8SEZD7QB_E119`：combinations of heath condition(Compound Faults) motivates Z-score normalization
  - `8SEZD7QB_E120`：only a few labeled data available(Small Fault Samples) motivates SS-KLFDA
  - `8SEZD7QB_E121`：noises(Uncertainty) motivates SS-KLFDA
  - `8SEZD7QB_E122`：combinations of heath condition(Compound Faults) motivates SS-KLFDA
  - `8SEZD7QB_E123`：only a few labeled data available(Small Fault Samples) motivates 1NN
  - `8SEZD7QB_E124`：noises(Uncertainty) motivates 1NN
  - `8SEZD7QB_E125`：combinations of heath condition(Compound Faults) motivates 1NN
