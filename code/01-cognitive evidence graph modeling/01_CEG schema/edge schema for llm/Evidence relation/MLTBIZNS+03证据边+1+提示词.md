...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `MLTBIZNS_E097` | `motivates` | 13-Noise Level | heavy noise, contaminated by some noise(High Noise) |  | 15-Data Preprocessing Algorithm | Vold-Kalman filter |  |
| 2 | `MLTBIZNS_E098` | `motivates` | 13-Noise Level | heavy noise, contaminated by some noise(High Noise) |  | 16-Feature Extraction Algorithm | Multiscale filtering spectrum |  |
| 3 | `MLTBIZNS_E099` | `motivates` | 09-Problem Scenario | varying speed and spectrum smearing(Other) |  | 15-Data Preprocessing Algorithm | Vold-Kalman filter |  |
| 4 | `MLTBIZNS_E100` | `motivates` | 09-Problem Scenario | disturbances of the SRF-unrelated components and noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Vold-Kalman filter |  |
| 5 | `MLTBIZNS_E101` | `motivates` | 09-Problem Scenario | varying speed and spectrum smearing(Other) |  | 16-Feature Extraction Algorithm | Multiscale filtering spectrum |  |
| 6 | `MLTBIZNS_E102` | `motivates` | 09-Problem Scenario | disturbances of the SRF-unrelated components and noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Multiscale filtering spectrum |  |
| 7 | `MLTBIZNS_E103` | `motivates` | 09-Problem Scenario | varying speed and spectrum smearing(Other) |  | 17-Core Classifier Algorithm | Order peak identification |  |
| 8 | `MLTBIZNS_E104` | `motivates` | 09-Problem Scenario | disturbances of the SRF-unrelated components and noise(Uncertainty) |  | 17-Core Classifier Algorithm | Order peak identification |  |
| 9 | `MLTBIZNS_E105` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Multiscale filtering spectrum |  |
| 10 | `MLTBIZNS_E106` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Order peak identification |  |
| 11 | `MLTBIZNS_E107` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Order peak identification |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `MLTBIZNS_E099`：varying speed and spectrum smearing(Other) motivates Vold-Kalman filter
  - `MLTBIZNS_E100`：disturbances of the SRF-unrelated components and noise(Uncertainty) motivates Vold-Kalman filter
  - `MLTBIZNS_E101`：varying speed and spectrum smearing(Other) motivates Multiscale filtering spectrum
  - `MLTBIZNS_E102`：disturbances of the SRF-unrelated components and noise(Uncertainty) motivates Multiscale filtering spectrum
  - `MLTBIZNS_E103`：varying speed and spectrum smearing(Other) motivates Order peak identification
  - `MLTBIZNS_E104`：disturbances of the SRF-unrelated components and noise(Uncertainty) motivates Order peak identification
