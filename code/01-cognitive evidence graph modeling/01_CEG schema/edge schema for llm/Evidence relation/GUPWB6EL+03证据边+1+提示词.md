...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `GUPWB6EL_E093` | `motivates` | 13-Noise Level | -10db SNR noise(High Noise) |  | 15-Data Preprocessing Algorithm | Concealed Component Decomposition |  |
| 2 | `GUPWB6EL_E094` | `motivates` | 13-Noise Level | -10db SNR noise(High Noise) |  | 16-Feature Extraction Algorithm | Hilbert Transform |  |
| 3 | `GUPWB6EL_E095` | `motivates` | 09-Problem Scenario | non-stationary and noisy, mode mixing(Uncertainty) |  | 15-Data Preprocessing Algorithm | Concealed Component Decomposition |  |
| 4 | `GUPWB6EL_E096` | `motivates` | 09-Problem Scenario | weak incipient fault characteristics(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Concealed Component Decomposition |  |
| 5 | `GUPWB6EL_E097` | `motivates` | 09-Problem Scenario | non-stationary and noisy, mode mixing(Uncertainty) |  | 16-Feature Extraction Algorithm | Hilbert Transform |  |
| 6 | `GUPWB6EL_E098` | `motivates` | 09-Problem Scenario | weak incipient fault characteristics(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Hilbert Transform |  |
| 7 | `GUPWB6EL_E099` | `motivates` | 09-Problem Scenario | non-stationary and noisy, mode mixing(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 8 | `GUPWB6EL_E100` | `motivates` | 09-Problem Scenario | weak incipient fault characteristics(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 9 | `GUPWB6EL_E101` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Hilbert Transform |  |
| 10 | `GUPWB6EL_E102` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 11 | `GUPWB6EL_E103` | `motivates` | 06-Fault Severity | 2 mm(Single Severity) |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `GUPWB6EL_E095`：non-stationary and noisy, mode mixing(Uncertainty) motivates Concealed Component Decomposition
  - `GUPWB6EL_E096`：weak incipient fault characteristics(Early Degradation Prediction) motivates Concealed Component Decomposition
  - `GUPWB6EL_E097`：non-stationary and noisy, mode mixing(Uncertainty) motivates Hilbert Transform
  - `GUPWB6EL_E098`：weak incipient fault characteristics(Early Degradation Prediction) motivates Hilbert Transform
  - `GUPWB6EL_E099`：non-stationary and noisy, mode mixing(Uncertainty) motivates Envelope Spectrum Analysis
  - `GUPWB6EL_E100`：weak incipient fault characteristics(Early Degradation Prediction) motivates Envelope Spectrum Analysis
