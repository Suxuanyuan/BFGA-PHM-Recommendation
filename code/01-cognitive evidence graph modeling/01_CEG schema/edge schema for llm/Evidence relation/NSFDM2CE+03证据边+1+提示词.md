...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `NSFDM2CE_E101` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Maximum Classifier Discrepancy |  |
| 2 | `NSFDM2CE_E102` | `motivates` | 12-Training Data Availability | 360 samples for each class, 2600 samples in each class(Sufficient) |  | 19-Training Optimization Algorithm | Maximum Classifier Discrepancy |  |
| 3 | `NSFDM2CE_E103` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 4 | `NSFDM2CE_E104` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | 1D-CNN |  |
| 5 | `NSFDM2CE_E105` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 6 | `NSFDM2CE_E106` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | 1D-CNN |  |
| 7 | `NSFDM2CE_E107` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax Classifier |  |
| 8 | `NSFDM2CE_E108` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | 1D-CNN |  |
| 9 | `NSFDM2CE_E109` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax Classifier |  |
| 10 | `NSFDM2CE_E110` | `motivates` | 06-Fault Severity | fault diameters (7 mils, 14 mils, 21 mils), damage severity levels(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax Classifier |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `NSFDM2CE_E101`：domain shift(Distribution Discrepancy) motivates Maximum Classifier Discrepancy
  - `NSFDM2CE_E105`：domain shift(Distribution Discrepancy) motivates Sliding Window
  - `NSFDM2CE_E106`：domain shift(Distribution Discrepancy) motivates 1D-CNN
  - `NSFDM2CE_E107`：domain shift(Distribution Discrepancy) motivates Softmax Classifier
