...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `7URDS65B_E184` | `motivates` | 09-Problem Scenario | domain shift caused by fluctuation of working condition(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | RM-induced selection scheme |  |
| 2 | `7URDS65B_E185` | `motivates` | 09-Problem Scenario | noisy environment / noise robustness(Uncertainty) |  | 19-Training Optimization Algorithm | RM-induced selection scheme |  |
| 3 | `7URDS65B_E186` | `motivates` | 12-Training Data Availability | 2400 samples and 1600 samples with 2:1:1 ratio(Sufficient) |  | 19-Training Optimization Algorithm | RM-induced selection scheme |  |
| 4 | `7URDS65B_E187` | `motivates` | 13-Noise Level | noisy environment, Gaussian noises(High Noise) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 5 | `7URDS65B_E188` | `motivates` | 13-Noise Level | noisy environment, Gaussian noises(High Noise) |  | 16-Feature Extraction Algorithm | ELM-DAE |  |
| 6 | `7URDS65B_E189` | `motivates` | 09-Problem Scenario | domain shift caused by fluctuation of working condition(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 7 | `7URDS65B_E190` | `motivates` | 09-Problem Scenario | noisy environment / noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 8 | `7URDS65B_E191` | `motivates` | 09-Problem Scenario | domain shift caused by fluctuation of working condition(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | ELM-DAE |  |
| 9 | `7URDS65B_E192` | `motivates` | 09-Problem Scenario | noisy environment / noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | ELM-DAE |  |
| 10 | `7URDS65B_E193` | `motivates` | 09-Problem Scenario | domain shift caused by fluctuation of working condition(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | DMELM |  |
| 11 | `7URDS65B_E194` | `motivates` | 09-Problem Scenario | noisy environment / noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | DMELM |  |
| 12 | `7URDS65B_E195` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | ELM-DAE |  |
| 13 | `7URDS65B_E196` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | DMELM |  |
| 14 | `7URDS65B_E197` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | DMELM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `7URDS65B_E184`：domain shift caused by fluctuation of working condition(Distribution Discrepancy) motivates RM-induced selection scheme
  - `7URDS65B_E185`：noisy environment / noise robustness(Uncertainty) motivates RM-induced selection scheme
  - `7URDS65B_E189`：domain shift caused by fluctuation of working condition(Distribution Discrepancy) motivates FFT
  - `7URDS65B_E190`：noisy environment / noise robustness(Uncertainty) motivates FFT
  - `7URDS65B_E191`：domain shift caused by fluctuation of working condition(Distribution Discrepancy) motivates ELM-DAE
  - `7URDS65B_E192`：noisy environment / noise robustness(Uncertainty) motivates ELM-DAE
  - `7URDS65B_E193`：domain shift caused by fluctuation of working condition(Distribution Discrepancy) motivates DMELM
  - `7URDS65B_E194`：noisy environment / noise robustness(Uncertainty) motivates DMELM
