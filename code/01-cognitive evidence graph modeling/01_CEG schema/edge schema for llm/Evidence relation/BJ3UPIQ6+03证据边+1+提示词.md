...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `BJ3UPIQ6_E120` | `motivates` | 13-Noise Level | Inevitable noise and random noise originating from measurement and power supply system(High Noise) |  | 15-Data Preprocessing Algorithm | Low-pass filter |  |
| 2 | `BJ3UPIQ6_E121` | `motivates` | 13-Noise Level | Inevitable noise and random noise originating from measurement and power supply system(High Noise) |  | 16-Feature Extraction Algorithm | Dynamic Time Warping |  |
| 3 | `BJ3UPIQ6_E122` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Low-pass filter |  |
| 4 | `BJ3UPIQ6_E123` | `motivates` | 09-Problem Scenario | weak signature extraction under strong carrier frequency component(Other) |  | 15-Data Preprocessing Algorithm | Low-pass filter |  |
| 5 | `BJ3UPIQ6_E124` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Dynamic Time Warping |  |
| 6 | `BJ3UPIQ6_E125` | `motivates` | 09-Problem Scenario | weak signature extraction under strong carrier frequency component(Other) |  | 16-Feature Extraction Algorithm | Dynamic Time Warping |  |
| 7 | `BJ3UPIQ6_E126` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Linear classifier |  |
| 8 | `BJ3UPIQ6_E127` | `motivates` | 09-Problem Scenario | weak signature extraction under strong carrier frequency component(Other) |  | 17-Core Classifier Algorithm | Linear classifier |  |
| 9 | `BJ3UPIQ6_E128` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Dynamic Time Warping |  |
| 10 | `BJ3UPIQ6_E129` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Linear classifier |  |
| 11 | `BJ3UPIQ6_E130` | `motivates` | 06-Fault Severity | 1mm hole, reduced by 2mm(Single Severity) |  | 17-Core Classifier Algorithm | Linear classifier |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `BJ3UPIQ6_E122`：noise robustness(Uncertainty) motivates Low-pass filter
  - `BJ3UPIQ6_E123`：weak signature extraction under strong carrier frequency component(Other) motivates Low-pass filter
  - `BJ3UPIQ6_E124`：noise robustness(Uncertainty) motivates Dynamic Time Warping
  - `BJ3UPIQ6_E125`：weak signature extraction under strong carrier frequency component(Other) motivates Dynamic Time Warping
  - `BJ3UPIQ6_E126`：noise robustness(Uncertainty) motivates Linear classifier
  - `BJ3UPIQ6_E127`：weak signature extraction under strong carrier frequency component(Other) motivates Linear classifier
