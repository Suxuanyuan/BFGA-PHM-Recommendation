...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SYMN937Q_E121` | `motivates` | 12-Training Data Availability | first 17 minutes (about 100 samples) as normal samples... last 17 min as fault samples... IMS dataset: first 16.6 h, about 100 samples, as normal samples... XJTU-SY5: first 100 samples as normal state samples and the last 100 samples as fault samples(Sufficient) |  | 18-Data Generation Algorithm | Principal Curve |  |
| 2 | `SYMN937Q_E122` | `motivates` | 13-Noise Level | strong noise environment(High Noise) |  | 15-Data Preprocessing Algorithm | Hilbert-Huang Transform |  |
| 3 | `SYMN937Q_E123` | `motivates` | 13-Noise Level | strong noise environment(High Noise) |  | 16-Feature Extraction Algorithm | Stacked Denoising Auto-Encoder |  |
| 4 | `SYMN937Q_E124` | `motivates` | 09-Problem Scenario | incipient fault detection(Early Degradation Prediction) |  | 18-Data Generation Algorithm | Principal Curve |  |
| 5 | `SYMN937Q_E125` | `motivates` | 09-Problem Scenario | distribution inconsistency in online sequential data(Distribution Discrepancy) |  | 18-Data Generation Algorithm | Principal Curve |  |
| 6 | `SYMN937Q_E126` | `motivates` | 09-Problem Scenario | data imbalance during online monitoring(Small Fault Samples) |  | 18-Data Generation Algorithm | Principal Curve |  |
| 7 | `SYMN937Q_E127` | `motivates` | 09-Problem Scenario | incipient fault detection(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Hilbert-Huang Transform |  |
| 8 | `SYMN937Q_E128` | `motivates` | 09-Problem Scenario | distribution inconsistency in online sequential data(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Hilbert-Huang Transform |  |
| 9 | `SYMN937Q_E129` | `motivates` | 09-Problem Scenario | data imbalance during online monitoring(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Hilbert-Huang Transform |  |
| 10 | `SYMN937Q_E130` | `motivates` | 09-Problem Scenario | incipient fault detection(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Stacked Denoising Auto-Encoder |  |
| 11 | `SYMN937Q_E131` | `motivates` | 09-Problem Scenario | distribution inconsistency in online sequential data(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Stacked Denoising Auto-Encoder |  |
| 12 | `SYMN937Q_E132` | `motivates` | 09-Problem Scenario | data imbalance during online monitoring(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Stacked Denoising Auto-Encoder |  |
| 13 | `SYMN937Q_E133` | `motivates` | 09-Problem Scenario | incipient fault detection(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Safe Semi-supervised Support Vector Machine |  |
| 14 | `SYMN937Q_E134` | `motivates` | 09-Problem Scenario | distribution inconsistency in online sequential data(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Safe Semi-supervised Support Vector Machine |  |
| 15 | `SYMN937Q_E135` | `motivates` | 09-Problem Scenario | data imbalance during online monitoring(Small Fault Samples) |  | 17-Core Classifier Algorithm | Safe Semi-supervised Support Vector Machine |  |
| 16 | `SYMN937Q_E136` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Stacked Denoising Auto-Encoder |  |
| 17 | `SYMN937Q_E137` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Safe Semi-supervised Support Vector Machine |  |
| 18 | `SYMN937Q_E138` | `motivates` | 06-Fault Severity | run-to-failure(Multiple Severities) |  | 17-Core Classifier Algorithm | Safe Semi-supervised Support Vector Machine |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `SYMN937Q_E124`：incipient fault detection(Early Degradation Prediction) motivates Principal Curve
  - `SYMN937Q_E125`：distribution inconsistency in online sequential data(Distribution Discrepancy) motivates Principal Curve
  - `SYMN937Q_E126`：data imbalance during online monitoring(Small Fault Samples) motivates Principal Curve
  - `SYMN937Q_E127`：incipient fault detection(Early Degradation Prediction) motivates Hilbert-Huang Transform
  - `SYMN937Q_E128`：distribution inconsistency in online sequential data(Distribution Discrepancy) motivates Hilbert-Huang Transform
  - `SYMN937Q_E129`：data imbalance during online monitoring(Small Fault Samples) motivates Hilbert-Huang Transform
  - `SYMN937Q_E130`：incipient fault detection(Early Degradation Prediction) motivates Stacked Denoising Auto-Encoder
  - `SYMN937Q_E131`：distribution inconsistency in online sequential data(Distribution Discrepancy) motivates Stacked Denoising Auto-Encoder
  - `SYMN937Q_E132`：data imbalance during online monitoring(Small Fault Samples) motivates Stacked Denoising Auto-Encoder
  - `SYMN937Q_E133`：incipient fault detection(Early Degradation Prediction) motivates Safe Semi-supervised Support Vector Machine
  - `SYMN937Q_E134`：distribution inconsistency in online sequential data(Distribution Discrepancy) motivates Safe Semi-supervised Support Vector Machine
  - `SYMN937Q_E135`：data imbalance during online monitoring(Small Fault Samples) motivates Safe Semi-supervised Support Vector Machine
