...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `GG9Z55YL_E109` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 19-Training Optimization Algorithm | GOA |  |
| 2 | `GG9Z55YL_E110` | `motivates` | 09-Problem Scenario | early weak fault diagnosis(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | GOA |  |
| 3 | `GG9Z55YL_E111` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | GOA |  |
| 4 | `GG9Z55YL_E112` | `motivates` | 13-Noise Level | strong background noise(High Noise) |  | 15-Data Preprocessing Algorithm | APPCA |  |
| 5 | `GG9Z55YL_E113` | `motivates` | 13-Noise Level | strong background noise(High Noise) |  | 16-Feature Extraction Algorithm | EMDO |  |
| 6 | `GG9Z55YL_E114` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | APPCA |  |
| 7 | `GG9Z55YL_E115` | `motivates` | 09-Problem Scenario | early weak fault diagnosis(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | APPCA |  |
| 8 | `GG9Z55YL_E116` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | EMDO |  |
| 9 | `GG9Z55YL_E117` | `motivates` | 09-Problem Scenario | early weak fault diagnosis(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | EMDO |  |
| 10 | `GG9Z55YL_E118` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Analysis |  |
| 11 | `GG9Z55YL_E119` | `motivates` | 09-Problem Scenario | early weak fault diagnosis(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Envelope Analysis |  |
| 12 | `GG9Z55YL_E120` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | EMDO |  |
| 13 | `GG9Z55YL_E121` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope Analysis |  |
| 14 | `GG9Z55YL_E122` | `motivates` | 06-Fault Severity | early, middle, and late stages(Multiple Severities) |  | 17-Core Classifier Algorithm | Envelope Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `GG9Z55YL_E109`：strong background noise(Uncertainty) motivates GOA
  - `GG9Z55YL_E110`：early weak fault diagnosis(Early Degradation Prediction) motivates GOA
  - `GG9Z55YL_E114`：strong background noise(Uncertainty) motivates APPCA
  - `GG9Z55YL_E115`：early weak fault diagnosis(Early Degradation Prediction) motivates APPCA
  - `GG9Z55YL_E116`：strong background noise(Uncertainty) motivates EMDO
  - `GG9Z55YL_E117`：early weak fault diagnosis(Early Degradation Prediction) motivates EMDO
  - `GG9Z55YL_E118`：strong background noise(Uncertainty) motivates Envelope Analysis
  - `GG9Z55YL_E119`：early weak fault diagnosis(Early Degradation Prediction) motivates Envelope Analysis
