...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `I8BX38W4_E123` | `motivates` | 13-Noise Level | process noises, measurement noise(High Noise) |  | 15-Data Preprocessing Algorithm | Centralization |  |
| 2 | `I8BX38W4_E124` | `motivates` | 13-Noise Level | process noises, measurement noise(High Noise) |  | 16-Feature Extraction Algorithm | KPCA |  |
| 3 | `I8BX38W4_E125` | `motivates` | 09-Problem Scenario | physical meaning is not intuitive(Trustworthiness / Interpretability) |  | 15-Data Preprocessing Algorithm | Centralization |  |
| 4 | `I8BX38W4_E126` | `motivates` | 09-Problem Scenario | amount of the computation is enormous(Other) |  | 15-Data Preprocessing Algorithm | Centralization |  |
| 5 | `I8BX38W4_E127` | `motivates` | 09-Problem Scenario | physical meaning is not intuitive(Trustworthiness / Interpretability) |  | 16-Feature Extraction Algorithm | KPCA |  |
| 6 | `I8BX38W4_E128` | `motivates` | 09-Problem Scenario | amount of the computation is enormous(Other) |  | 16-Feature Extraction Algorithm | KPCA |  |
| 7 | `I8BX38W4_E129` | `motivates` | 09-Problem Scenario | physical meaning is not intuitive(Trustworthiness / Interpretability) |  | 17-Core Classifier Algorithm | KSER |  |
| 8 | `I8BX38W4_E130` | `motivates` | 09-Problem Scenario | amount of the computation is enormous(Other) |  | 17-Core Classifier Algorithm | KSER |  |
| 9 | `I8BX38W4_E131` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | KPCA |  |
| 10 | `I8BX38W4_E132` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | KSER |  |
| 11 | `I8BX38W4_E133` | `motivates` | 06-Fault Severity | step fault in x2 from 501th sample, ramp fault in x1 from 501th sample, random fault in x1 from 501th sample(Single Severity) |  | 17-Core Classifier Algorithm | KSER |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `I8BX38W4_E125`：physical meaning is not intuitive(Trustworthiness / Interpretability) motivates Centralization
  - `I8BX38W4_E126`：amount of the computation is enormous(Other) motivates Centralization
  - `I8BX38W4_E127`：physical meaning is not intuitive(Trustworthiness / Interpretability) motivates KPCA
  - `I8BX38W4_E128`：amount of the computation is enormous(Other) motivates KPCA
  - `I8BX38W4_E129`：physical meaning is not intuitive(Trustworthiness / Interpretability) motivates KSER
  - `I8BX38W4_E130`：amount of the computation is enormous(Other) motivates KSER
