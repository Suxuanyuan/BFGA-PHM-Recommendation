...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `8TL3VK7G_E057` | `motivates` | 13-Noise Level | noise induced in the gate signal(High Noise) |  | 15-Data Preprocessing Algorithm | Low-pass filter |  |
| 2 | `8TL3VK7G_E058` | `motivates` | 09-Problem Scenario | Uncertainty in input signal and noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Low-pass filter |  |
| 3 | `8TL3VK7G_E059` | `motivates` | 09-Problem Scenario | Uncertainty in input signal and noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Adaptive thresholding |  |
| 4 | `8TL3VK7G_E060` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Adaptive thresholding |  |
| 5 | `8TL3VK7G_E061` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Adaptive thresholding |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `8TL3VK7G_E058`：Uncertainty in input signal and noise robustness(Uncertainty) motivates Low-pass filter
  - `8TL3VK7G_E059`：Uncertainty in input signal and noise robustness(Uncertainty) motivates Adaptive thresholding
