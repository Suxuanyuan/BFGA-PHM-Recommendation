...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `E8CCKFRC_E096` | `motivates` | 13-Noise Level | spikes caused by commutation phenomena, electromagnetic interference (EMI) phenomena(High Noise) |  | 15-Data Preprocessing Algorithm | Median Filter |  |
| 2 | `E8CCKFRC_E097` | `motivates` | 13-Noise Level | spikes caused by commutation phenomena, electromagnetic interference (EMI) phenomena(High Noise) |  | 16-Feature Extraction Algorithm | Discrete Wavelet Transform |  |
| 3 | `E8CCKFRC_E098` | `motivates` | 09-Problem Scenario | uncertainty and noise robustness in fault detection(Uncertainty) |  | 15-Data Preprocessing Algorithm | Median Filter |  |
| 4 | `E8CCKFRC_E099` | `motivates` | 09-Problem Scenario | minimizing implementation cost and complexity without extra sensors(Other) |  | 15-Data Preprocessing Algorithm | Median Filter |  |
| 5 | `E8CCKFRC_E100` | `motivates` | 09-Problem Scenario | uncertainty and noise robustness in fault detection(Uncertainty) |  | 16-Feature Extraction Algorithm | Discrete Wavelet Transform |  |
| 6 | `E8CCKFRC_E101` | `motivates` | 09-Problem Scenario | minimizing implementation cost and complexity without extra sensors(Other) |  | 16-Feature Extraction Algorithm | Discrete Wavelet Transform |  |
| 7 | `E8CCKFRC_E102` | `motivates` | 09-Problem Scenario | uncertainty and noise robustness in fault detection(Uncertainty) |  | 17-Core Classifier Algorithm | Fuzzy Inference System |  |
| 8 | `E8CCKFRC_E103` | `motivates` | 09-Problem Scenario | minimizing implementation cost and complexity without extra sensors(Other) |  | 17-Core Classifier Algorithm | Fuzzy Inference System |  |
| 9 | `E8CCKFRC_E104` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Discrete Wavelet Transform |  |
| 10 | `E8CCKFRC_E105` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Fuzzy Inference System |  |
| 11 | `E8CCKFRC_E106` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Fuzzy Inference System |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `E8CCKFRC_E098`：uncertainty and noise robustness in fault detection(Uncertainty) motivates Median Filter
  - `E8CCKFRC_E099`：minimizing implementation cost and complexity without extra sensors(Other) motivates Median Filter
  - `E8CCKFRC_E100`：uncertainty and noise robustness in fault detection(Uncertainty) motivates Discrete Wavelet Transform
  - `E8CCKFRC_E101`：minimizing implementation cost and complexity without extra sensors(Other) motivates Discrete Wavelet Transform
  - `E8CCKFRC_E102`：uncertainty and noise robustness in fault detection(Uncertainty) motivates Fuzzy Inference System
  - `E8CCKFRC_E103`：minimizing implementation cost and complexity without extra sensors(Other) motivates Fuzzy Inference System
