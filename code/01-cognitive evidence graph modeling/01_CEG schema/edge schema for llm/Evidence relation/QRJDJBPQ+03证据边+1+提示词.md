...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QRJDJBPQ_E078` | `motivates` | 13-Noise Level | high signal-to-noise ratio(Normal) |  | 15-Data Preprocessing Algorithm | Timer/counter-based method |  |
| 2 | `QRJDJBPQ_E079` | `motivates` | 13-Noise Level | high signal-to-noise ratio(Normal) |  | 16-Feature Extraction Algorithm | Differential calculation |  |
| 3 | `QRJDJBPQ_E080` | `motivates` | 09-Problem Scenario | interference of sensor position or other components / noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Timer/counter-based method |  |
| 4 | `QRJDJBPQ_E081` | `motivates` | 09-Problem Scenario | interference of sensor position or other components / noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Differential calculation |  |
| 5 | `QRJDJBPQ_E082` | `motivates` | 09-Problem Scenario | interference of sensor position or other components / noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Spectral analysis |  |
| 6 | `QRJDJBPQ_E083` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Differential calculation |  |
| 7 | `QRJDJBPQ_E084` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Spectral analysis |  |
| 8 | `QRJDJBPQ_E085` | `motivates` | 06-Fault Severity | crack depth of 1 mm, one tooth completely removed(Single Severity) |  | 17-Core Classifier Algorithm | Spectral analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `QRJDJBPQ_E080`：interference of sensor position or other components / noise robustness(Uncertainty) motivates Timer/counter-based method
  - `QRJDJBPQ_E081`：interference of sensor position or other components / noise robustness(Uncertainty) motivates Differential calculation
  - `QRJDJBPQ_E082`：interference of sensor position or other components / noise robustness(Uncertainty) motivates Spectral analysis
