...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VUIYRN53_E140` | `motivates` | 09-Problem Scenario | limited labeled data(Small Fault Samples) |  | 19-Training Optimization Algorithm | Balanced Domain Adaptation |  |
| 2 | `VUIYRN53_E141` | `motivates` | 09-Problem Scenario | distribution discrepancy / domain shift(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Balanced Domain Adaptation |  |
| 3 | `VUIYRN53_E142` | `motivates` | 12-Training Data Availability | limited labeled target data(Scarce) |  | 19-Training Optimization Algorithm | Balanced Domain Adaptation |  |
| 4 | `VUIYRN53_E143` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Signal Segmentation |  |
| 5 | `VUIYRN53_E144` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | CNN |  |
| 6 | `VUIYRN53_E145` | `motivates` | 09-Problem Scenario | limited labeled data(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Signal Segmentation |  |
| 7 | `VUIYRN53_E146` | `motivates` | 09-Problem Scenario | distribution discrepancy / domain shift(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Signal Segmentation |  |
| 8 | `VUIYRN53_E147` | `motivates` | 09-Problem Scenario | limited labeled data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | CNN |  |
| 9 | `VUIYRN53_E148` | `motivates` | 09-Problem Scenario | distribution discrepancy / domain shift(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | CNN |  |
| 10 | `VUIYRN53_E149` | `motivates` | 09-Problem Scenario | limited labeled data(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `VUIYRN53_E150` | `motivates` | 09-Problem Scenario | distribution discrepancy / domain shift(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `VUIYRN53_E151` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 13 | `VUIYRN53_E152` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `VUIYRN53_E153` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `VUIYRN53_E140`：limited labeled data(Small Fault Samples) motivates Balanced Domain Adaptation
  - `VUIYRN53_E141`：distribution discrepancy / domain shift(Distribution Discrepancy) motivates Balanced Domain Adaptation
  - `VUIYRN53_E145`：limited labeled data(Small Fault Samples) motivates Signal Segmentation
  - `VUIYRN53_E146`：distribution discrepancy / domain shift(Distribution Discrepancy) motivates Signal Segmentation
  - `VUIYRN53_E147`：limited labeled data(Small Fault Samples) motivates CNN
  - `VUIYRN53_E148`：distribution discrepancy / domain shift(Distribution Discrepancy) motivates CNN
  - `VUIYRN53_E149`：limited labeled data(Small Fault Samples) motivates Softmax
  - `VUIYRN53_E150`：distribution discrepancy / domain shift(Distribution Discrepancy) motivates Softmax
