...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `KGXHSDR7_E078` | `motivates` | 13-Noise Level | measurement noise(Normal) |  | 15-Data Preprocessing Algorithm | Correlation analysis |  |
| 2 | `KGXHSDR7_E079` | `motivates` | 13-Noise Level | measurement noise(Normal) |  | 16-Feature Extraction Algorithm | Fuzzy-based slope analysis |  |
| 3 | `KGXHSDR7_E080` | `motivates` | 09-Problem Scenario | unlabeled plant operation data, lack of labeled examples(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Correlation analysis |  |
| 4 | `KGXHSDR7_E081` | `motivates` | 09-Problem Scenario | imprecise linguistic concepts(Uncertainty) |  | 15-Data Preprocessing Algorithm | Correlation analysis |  |
| 5 | `KGXHSDR7_E082` | `motivates` | 09-Problem Scenario | misaligned transient data(Other) |  | 15-Data Preprocessing Algorithm | Correlation analysis |  |
| 6 | `KGXHSDR7_E083` | `motivates` | 09-Problem Scenario | unlabeled plant operation data, lack of labeled examples(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Fuzzy-based slope analysis |  |
| 7 | `KGXHSDR7_E084` | `motivates` | 09-Problem Scenario | imprecise linguistic concepts(Uncertainty) |  | 16-Feature Extraction Algorithm | Fuzzy-based slope analysis |  |
| 8 | `KGXHSDR7_E085` | `motivates` | 09-Problem Scenario | misaligned transient data(Other) |  | 16-Feature Extraction Algorithm | Fuzzy-based slope analysis |  |
| 9 | `KGXHSDR7_E086` | `motivates` | 09-Problem Scenario | unlabeled plant operation data, lack of labeled examples(Small Fault Samples) |  | 17-Core Classifier Algorithm | Spectral clustering |  |
| 10 | `KGXHSDR7_E087` | `motivates` | 09-Problem Scenario | imprecise linguistic concepts(Uncertainty) |  | 17-Core Classifier Algorithm | Spectral clustering |  |
| 11 | `KGXHSDR7_E088` | `motivates` | 09-Problem Scenario | misaligned transient data(Other) |  | 17-Core Classifier Algorithm | Spectral clustering |  |
| 12 | `KGXHSDR7_E089` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Fuzzy-based slope analysis |  |
| 13 | `KGXHSDR7_E090` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Spectral clustering |  |
| 14 | `KGXHSDR7_E091` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Spectral clustering |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `KGXHSDR7_E080`：unlabeled plant operation data, lack of labeled examples(Small Fault Samples) motivates Correlation analysis
  - `KGXHSDR7_E081`：imprecise linguistic concepts(Uncertainty) motivates Correlation analysis
  - `KGXHSDR7_E082`：misaligned transient data(Other) motivates Correlation analysis
  - `KGXHSDR7_E083`：unlabeled plant operation data, lack of labeled examples(Small Fault Samples) motivates Fuzzy-based slope analysis
  - `KGXHSDR7_E084`：imprecise linguistic concepts(Uncertainty) motivates Fuzzy-based slope analysis
  - `KGXHSDR7_E085`：misaligned transient data(Other) motivates Fuzzy-based slope analysis
  - `KGXHSDR7_E086`：unlabeled plant operation data, lack of labeled examples(Small Fault Samples) motivates Spectral clustering
  - `KGXHSDR7_E087`：imprecise linguistic concepts(Uncertainty) motivates Spectral clustering
  - `KGXHSDR7_E088`：misaligned transient data(Other) motivates Spectral clustering
