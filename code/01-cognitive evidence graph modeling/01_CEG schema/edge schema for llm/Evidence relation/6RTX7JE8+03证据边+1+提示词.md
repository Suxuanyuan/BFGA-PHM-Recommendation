...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `6RTX7JE8_E157` | `motivates` | 09-Problem Scenario | zero-shot classification, missing classes(Zero Fault Samples) |  | 19-Training Optimization Algorithm | Adversarial Training |  |
| 2 | `6RTX7JE8_E158` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 19-Training Optimization Algorithm | Adversarial Training |  |
| 3 | `6RTX7JE8_E159` | `motivates` | 12-Training Data Availability | zero-shot classification(Zero-Sample) |  | 18-Data Generation Algorithm | CADAE |  |
| 4 | `6RTX7JE8_E160` | `motivates` | 12-Training Data Availability | zero-shot classification(Zero-Sample) |  | 19-Training Optimization Algorithm | Adversarial Training |  |
| 5 | `6RTX7JE8_E161` | `motivates` | 13-Noise Level | contains more noise and less fault information(High Noise) |  | 15-Data Preprocessing Algorithm | MinMaxScaler |  |
| 6 | `6RTX7JE8_E162` | `motivates` | 13-Noise Level | contains more noise and less fault information(High Noise) |  | 16-Feature Extraction Algorithm | CNN |  |
| 7 | `6RTX7JE8_E163` | `motivates` | 09-Problem Scenario | zero-shot classification, missing classes(Zero Fault Samples) |  | 18-Data Generation Algorithm | CADAE |  |
| 8 | `6RTX7JE8_E164` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 18-Data Generation Algorithm | CADAE |  |
| 9 | `6RTX7JE8_E165` | `motivates` | 09-Problem Scenario | zero-shot classification, missing classes(Zero Fault Samples) |  | 15-Data Preprocessing Algorithm | MinMaxScaler |  |
| 10 | `6RTX7JE8_E166` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | MinMaxScaler |  |
| 11 | `6RTX7JE8_E167` | `motivates` | 09-Problem Scenario | zero-shot classification, missing classes(Zero Fault Samples) |  | 16-Feature Extraction Algorithm | CNN |  |
| 12 | `6RTX7JE8_E168` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | CNN |  |
| 13 | `6RTX7JE8_E169` | `motivates` | 09-Problem Scenario | zero-shot classification, missing classes(Zero Fault Samples) |  | 17-Core Classifier Algorithm | CNN |  |
| 14 | `6RTX7JE8_E170` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | CNN |  |
| 15 | `6RTX7JE8_E171` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 16 | `6RTX7JE8_E172` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | CNN |  |
| 17 | `6RTX7JE8_E173` | `motivates` | 06-Fault Severity | minor, medium, severe(Multiple Severities) |  | 17-Core Classifier Algorithm | CNN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `6RTX7JE8_E157`：zero-shot classification, missing classes(Zero Fault Samples) motivates Adversarial Training
  - `6RTX7JE8_E158`：noise robustness(Uncertainty) motivates Adversarial Training
  - `6RTX7JE8_E163`：zero-shot classification, missing classes(Zero Fault Samples) motivates CADAE
  - `6RTX7JE8_E164`：noise robustness(Uncertainty) motivates CADAE
  - `6RTX7JE8_E165`：zero-shot classification, missing classes(Zero Fault Samples) motivates MinMaxScaler
  - `6RTX7JE8_E166`：noise robustness(Uncertainty) motivates MinMaxScaler
  - `6RTX7JE8_E167`：zero-shot classification, missing classes(Zero Fault Samples) motivates CNN
  - `6RTX7JE8_E168`：noise robustness(Uncertainty) motivates CNN
  - `6RTX7JE8_E169`：zero-shot classification, missing classes(Zero Fault Samples) motivates CNN
  - `6RTX7JE8_E170`：noise robustness(Uncertainty) motivates CNN
