...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `8DXNP3IH_E103` | `motivates` | 09-Problem Scenario | Continuous parameter shifting fault modeling(Other) |  | 19-Training Optimization Algorithm | Constraint Optimization |  |
| 2 | `8DXNP3IH_E104` | `motivates` | 09-Problem Scenario | Fault aliasing in complex plane(Other) |  | 19-Training Optimization Algorithm | Constraint Optimization |  |
| 3 | `8DXNP3IH_E105` | `motivates` | 12-Training Data Availability | parameter sweep simulation data(Sufficient) |  | 19-Training Optimization Algorithm | Constraint Optimization |  |
| 4 | `8DXNP3IH_E106` | `motivates` | 13-Noise Level | noise-free simulation(Normal) |  | 16-Feature Extraction Algorithm | Complex Field Fault Modeling |  |
| 5 | `8DXNP3IH_E107` | `motivates` | 09-Problem Scenario | Continuous parameter shifting fault modeling(Other) |  | 16-Feature Extraction Algorithm | Complex Field Fault Modeling |  |
| 6 | `8DXNP3IH_E108` | `motivates` | 09-Problem Scenario | Fault aliasing in complex plane(Other) |  | 16-Feature Extraction Algorithm | Complex Field Fault Modeling |  |
| 7 | `8DXNP3IH_E109` | `motivates` | 09-Problem Scenario | Continuous parameter shifting fault modeling(Other) |  | 17-Core Classifier Algorithm | Fault Dictionary |  |
| 8 | `8DXNP3IH_E110` | `motivates` | 09-Problem Scenario | Fault aliasing in complex plane(Other) |  | 17-Core Classifier Algorithm | Fault Dictionary |  |
| 9 | `8DXNP3IH_E111` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Complex Field Fault Modeling |  |
| 10 | `8DXNP3IH_E112` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Fault Dictionary |  |
| 11 | `8DXNP3IH_E113` | `motivates` | 06-Fault Severity | continuous parameter shifting(Multiple Severities) |  | 17-Core Classifier Algorithm | Fault Dictionary |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `8DXNP3IH_E103`：Continuous parameter shifting fault modeling(Other) motivates Constraint Optimization
  - `8DXNP3IH_E104`：Fault aliasing in complex plane(Other) motivates Constraint Optimization
  - `8DXNP3IH_E107`：Continuous parameter shifting fault modeling(Other) motivates Complex Field Fault Modeling
  - `8DXNP3IH_E108`：Fault aliasing in complex plane(Other) motivates Complex Field Fault Modeling
  - `8DXNP3IH_E109`：Continuous parameter shifting fault modeling(Other) motivates Fault Dictionary
  - `8DXNP3IH_E110`：Fault aliasing in complex plane(Other) motivates Fault Dictionary
