...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `BDSZ85BY_E101` | `motivates` | 09-Problem Scenario | multi-fault(Compound Faults) |  | 19-Training Optimization Algorithm | Whale Optimization Algorithm |  |
| 2 | `BDSZ85BY_E102` | `motivates` | 09-Problem Scenario | low signal-to-noise ratio (SNR) / heavy noise(Uncertainty) |  | 19-Training Optimization Algorithm | Whale Optimization Algorithm |  |
| 3 | `BDSZ85BY_E103` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Whale Optimization Algorithm |  |
| 4 | `BDSZ85BY_E104` | `motivates` | 13-Noise Level | heavy noise / low SNR(High Noise) |  | 15-Data Preprocessing Algorithm | Morlet wavelet filter |  |
| 5 | `BDSZ85BY_E105` | `motivates` | 13-Noise Level | heavy noise / low SNR(High Noise) |  | 16-Feature Extraction Algorithm | Squared envelope spectrum |  |
| 6 | `BDSZ85BY_E106` | `motivates` | 09-Problem Scenario | multi-fault(Compound Faults) |  | 15-Data Preprocessing Algorithm | Morlet wavelet filter |  |
| 7 | `BDSZ85BY_E107` | `motivates` | 09-Problem Scenario | low signal-to-noise ratio (SNR) / heavy noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Morlet wavelet filter |  |
| 8 | `BDSZ85BY_E108` | `motivates` | 09-Problem Scenario | multi-fault(Compound Faults) |  | 16-Feature Extraction Algorithm | Squared envelope spectrum |  |
| 9 | `BDSZ85BY_E109` | `motivates` | 09-Problem Scenario | low signal-to-noise ratio (SNR) / heavy noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Squared envelope spectrum |  |
| 10 | `BDSZ85BY_E110` | `motivates` | 09-Problem Scenario | multi-fault(Compound Faults) |  | 17-Core Classifier Algorithm | Envelope spectrum analysis |  |
| 11 | `BDSZ85BY_E111` | `motivates` | 09-Problem Scenario | low signal-to-noise ratio (SNR) / heavy noise(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope spectrum analysis |  |
| 12 | `BDSZ85BY_E112` | `motivates` | 07-Compound Fault | multi-fault(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Squared envelope spectrum |  |
| 13 | `BDSZ85BY_E113` | `motivates` | 07-Compound Fault | multi-fault(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Envelope spectrum analysis |  |
| 14 | `BDSZ85BY_E114` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Envelope spectrum analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `BDSZ85BY_E101`：multi-fault(Compound Faults) motivates Whale Optimization Algorithm
  - `BDSZ85BY_E102`：low signal-to-noise ratio (SNR) / heavy noise(Uncertainty) motivates Whale Optimization Algorithm
  - `BDSZ85BY_E106`：multi-fault(Compound Faults) motivates Morlet wavelet filter
  - `BDSZ85BY_E107`：low signal-to-noise ratio (SNR) / heavy noise(Uncertainty) motivates Morlet wavelet filter
  - `BDSZ85BY_E108`：multi-fault(Compound Faults) motivates Squared envelope spectrum
  - `BDSZ85BY_E109`：low signal-to-noise ratio (SNR) / heavy noise(Uncertainty) motivates Squared envelope spectrum
  - `BDSZ85BY_E110`：multi-fault(Compound Faults) motivates Envelope spectrum analysis
  - `BDSZ85BY_E111`：low signal-to-noise ratio (SNR) / heavy noise(Uncertainty) motivates Envelope spectrum analysis
