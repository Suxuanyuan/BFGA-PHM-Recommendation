...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `LR37AN3U_E113` | `motivates` | 12-Training Data Availability | Twenty synchronization period signals(Sufficient) |  | 18-Data Generation Algorithm | Fault Simulation Model |  |
| 2 | `LR37AN3U_E114` | `motivates` | 13-Noise Level | strong background noise, Gaussian white noise with a signal-to-noise ratio size of -15 dB(High Noise) |  | 15-Data Preprocessing Algorithm | Time Synchronous Averaging |  |
| 3 | `LR37AN3U_E115` | `motivates` | 13-Noise Level | strong background noise, Gaussian white noise with a signal-to-noise ratio size of -15 dB(High Noise) |  | 16-Feature Extraction Algorithm | Wavelet Ridge |  |
| 4 | `LR37AN3U_E116` | `motivates` | 09-Problem Scenario | complexity of the planetary gearbox structure(Complex Systems) |  | 18-Data Generation Algorithm | Fault Simulation Model |  |
| 5 | `LR37AN3U_E117` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 18-Data Generation Algorithm | Fault Simulation Model |  |
| 6 | `LR37AN3U_E118` | `motivates` | 09-Problem Scenario | incipient fault(Early Degradation Prediction) |  | 18-Data Generation Algorithm | Fault Simulation Model |  |
| 7 | `LR37AN3U_E119` | `motivates` | 09-Problem Scenario | complexity of the planetary gearbox structure(Complex Systems) |  | 15-Data Preprocessing Algorithm | Time Synchronous Averaging |  |
| 8 | `LR37AN3U_E120` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Time Synchronous Averaging |  |
| 9 | `LR37AN3U_E121` | `motivates` | 09-Problem Scenario | incipient fault(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Time Synchronous Averaging |  |
| 10 | `LR37AN3U_E122` | `motivates` | 09-Problem Scenario | complexity of the planetary gearbox structure(Complex Systems) |  | 16-Feature Extraction Algorithm | Wavelet Ridge |  |
| 11 | `LR37AN3U_E123` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Wavelet Ridge |  |
| 12 | `LR37AN3U_E124` | `motivates` | 09-Problem Scenario | incipient fault(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Wavelet Ridge |  |
| 13 | `LR37AN3U_E125` | `motivates` | 09-Problem Scenario | complexity of the planetary gearbox structure(Complex Systems) |  | 17-Core Classifier Algorithm | Characteristic Frequency Analysis |  |
| 14 | `LR37AN3U_E126` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Characteristic Frequency Analysis |  |
| 15 | `LR37AN3U_E127` | `motivates` | 09-Problem Scenario | incipient fault(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Characteristic Frequency Analysis |  |
| 16 | `LR37AN3U_E128` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Wavelet Ridge |  |
| 17 | `LR37AN3U_E129` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Characteristic Frequency Analysis |  |
| 18 | `LR37AN3U_E130` | `motivates` | 06-Fault Severity | 1 mm wide fault(Single Severity) |  | 17-Core Classifier Algorithm | Characteristic Frequency Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `LR37AN3U_E116`：complexity of the planetary gearbox structure(Complex Systems) motivates Fault Simulation Model
  - `LR37AN3U_E117`：strong background noise(Uncertainty) motivates Fault Simulation Model
  - `LR37AN3U_E118`：incipient fault(Early Degradation Prediction) motivates Fault Simulation Model
  - `LR37AN3U_E119`：complexity of the planetary gearbox structure(Complex Systems) motivates Time Synchronous Averaging
  - `LR37AN3U_E120`：strong background noise(Uncertainty) motivates Time Synchronous Averaging
  - `LR37AN3U_E121`：incipient fault(Early Degradation Prediction) motivates Time Synchronous Averaging
  - `LR37AN3U_E122`：complexity of the planetary gearbox structure(Complex Systems) motivates Wavelet Ridge
  - `LR37AN3U_E123`：strong background noise(Uncertainty) motivates Wavelet Ridge
  - `LR37AN3U_E124`：incipient fault(Early Degradation Prediction) motivates Wavelet Ridge
  - `LR37AN3U_E125`：complexity of the planetary gearbox structure(Complex Systems) motivates Characteristic Frequency Analysis
  - `LR37AN3U_E126`：strong background noise(Uncertainty) motivates Characteristic Frequency Analysis
  - `LR37AN3U_E127`：incipient fault(Early Degradation Prediction) motivates Characteristic Frequency Analysis
