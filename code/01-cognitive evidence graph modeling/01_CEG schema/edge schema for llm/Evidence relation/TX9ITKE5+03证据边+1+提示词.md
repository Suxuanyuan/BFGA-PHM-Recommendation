...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TX9ITKE5_E145` | `motivates` | 09-Problem Scenario | Poor frequency resolution and leakage effects of classical spectral estimators(Other) |  | 19-Training Optimization Algorithm | Minimum Description Length |  |
| 2 | `TX9ITKE5_E146` | `motivates` | 09-Problem Scenario | Sensitivity to noise of subspace techniques(Uncertainty) |  | 19-Training Optimization Algorithm | Minimum Description Length |  |
| 3 | `TX9ITKE5_E147` | `motivates` | 12-Training Data Availability | N/A(Sufficient) |  | 19-Training Optimization Algorithm | Minimum Description Length |  |
| 4 | `TX9ITKE5_E148` | `motivates` | 13-Noise Level | White Gaussian noise(Normal) |  | 15-Data Preprocessing Algorithm | Down-sampling |  |
| 5 | `TX9ITKE5_E149` | `motivates` | 13-Noise Level | White Gaussian noise(Normal) |  | 16-Feature Extraction Algorithm | Maximum Likelihood Estimator |  |
| 6 | `TX9ITKE5_E150` | `motivates` | 09-Problem Scenario | Poor frequency resolution and leakage effects of classical spectral estimators(Other) |  | 15-Data Preprocessing Algorithm | Down-sampling |  |
| 7 | `TX9ITKE5_E151` | `motivates` | 09-Problem Scenario | Sensitivity to noise of subspace techniques(Uncertainty) |  | 15-Data Preprocessing Algorithm | Down-sampling |  |
| 8 | `TX9ITKE5_E152` | `motivates` | 09-Problem Scenario | Poor frequency resolution and leakage effects of classical spectral estimators(Other) |  | 16-Feature Extraction Algorithm | Maximum Likelihood Estimator |  |
| 9 | `TX9ITKE5_E153` | `motivates` | 09-Problem Scenario | Sensitivity to noise of subspace techniques(Uncertainty) |  | 16-Feature Extraction Algorithm | Maximum Likelihood Estimator |  |
| 10 | `TX9ITKE5_E154` | `motivates` | 09-Problem Scenario | Poor frequency resolution and leakage effects of classical spectral estimators(Other) |  | 17-Core Classifier Algorithm | Threshold-based Decision |  |
| 11 | `TX9ITKE5_E155` | `motivates` | 09-Problem Scenario | Sensitivity to noise of subspace techniques(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold-based Decision |  |
| 12 | `TX9ITKE5_E156` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Maximum Likelihood Estimator |  |
| 13 | `TX9ITKE5_E157` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold-based Decision |  |
| 14 | `TX9ITKE5_E158` | `motivates` | 06-Fault Severity | number of broken rotor bars(Multiple Severities) |  | 17-Core Classifier Algorithm | Threshold-based Decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `TX9ITKE5_E145`：Poor frequency resolution and leakage effects of classical spectral estimators(Other) motivates Minimum Description Length
  - `TX9ITKE5_E146`：Sensitivity to noise of subspace techniques(Uncertainty) motivates Minimum Description Length
  - `TX9ITKE5_E150`：Poor frequency resolution and leakage effects of classical spectral estimators(Other) motivates Down-sampling
  - `TX9ITKE5_E151`：Sensitivity to noise of subspace techniques(Uncertainty) motivates Down-sampling
  - `TX9ITKE5_E152`：Poor frequency resolution and leakage effects of classical spectral estimators(Other) motivates Maximum Likelihood Estimator
  - `TX9ITKE5_E153`：Sensitivity to noise of subspace techniques(Uncertainty) motivates Maximum Likelihood Estimator
  - `TX9ITKE5_E154`：Poor frequency resolution and leakage effects of classical spectral estimators(Other) motivates Threshold-based Decision
  - `TX9ITKE5_E155`：Sensitivity to noise of subspace techniques(Uncertainty) motivates Threshold-based Decision
