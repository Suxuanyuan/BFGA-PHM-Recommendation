...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XF2W5UG3_E070` | `motivates` | 09-Problem Scenario | sensor/actuator faults(Other) |  | 17-Core Classifier Algorithm | Robust Adaptive Kalman Filter |  |
| 2 | `XF2W5UG3_E071` | `motivates` | 09-Problem Scenario | measurement and process noise covariance adaptation(Uncertainty) |  | 17-Core Classifier Algorithm | Robust Adaptive Kalman Filter |  |
| 3 | `XF2W5UG3_E072` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Robust Adaptive Kalman Filter |  |
| 4 | `XF2W5UG3_E073` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Robust Adaptive Kalman Filter |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `XF2W5UG3_E070`：sensor/actuator faults(Other) motivates Robust Adaptive Kalman Filter
  - `XF2W5UG3_E071`：measurement and process noise covariance adaptation(Uncertainty) motivates Robust Adaptive Kalman Filter
