...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4FVWYFG4_E087` | `motivates` | 13-Noise Level | Not mentioned(Normal) |  | 15-Data Preprocessing Algorithm | IIR Bandpass Filter |  |
| 2 | `4FVWYFG4_E088` | `motivates` | 13-Noise Level | Not mentioned(Normal) |  | 16-Feature Extraction Algorithm | RMS Calculation |  |
| 3 | `4FVWYFG4_E089` | `motivates` | 09-Problem Scenario | distinguish turn fault from high resistance connection (HRC) fault(Other) |  | 15-Data Preprocessing Algorithm | IIR Bandpass Filter |  |
| 4 | `4FVWYFG4_E090` | `motivates` | 09-Problem Scenario | distinguish turn fault from high resistance connection (HRC) fault(Other) |  | 16-Feature Extraction Algorithm | RMS Calculation |  |
| 5 | `4FVWYFG4_E091` | `motivates` | 09-Problem Scenario | distinguish turn fault from high resistance connection (HRC) fault(Other) |  | 17-Core Classifier Algorithm | Standard Deviation |  |
| 6 | `4FVWYFG4_E092` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | RMS Calculation |  |
| 7 | `4FVWYFG4_E093` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Standard Deviation |  |
| 8 | `4FVWYFG4_E094` | `motivates` | 06-Fault Severity | single turn short-circuit, 0.1 ohm additional resistance(Single Severity) |  | 17-Core Classifier Algorithm | Standard Deviation |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4FVWYFG4_E089`：distinguish turn fault from high resistance connection (HRC) fault(Other) motivates IIR Bandpass Filter
  - `4FVWYFG4_E090`：distinguish turn fault from high resistance connection (HRC) fault(Other) motivates RMS Calculation
  - `4FVWYFG4_E091`：distinguish turn fault from high resistance connection (HRC) fault(Other) motivates Standard Deviation
