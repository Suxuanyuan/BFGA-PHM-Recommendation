...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `2I77HP4K_E080` | `motivates` | 13-Noise Level | noisy environment, different SNR levels(High Noise) |  | 15-Data Preprocessing Algorithm | EKF |  |
| 2 | `2I77HP4K_E081` | `motivates` | 13-Noise Level | noisy environment, different SNR levels(High Noise) |  | 16-Feature Extraction Algorithm | Rayleigh-quotient |  |
| 3 | `2I77HP4K_E082` | `motivates` | 09-Problem Scenario | detecting weak failure modes (partial BRB) in low-load applications(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | EKF |  |
| 4 | `2I77HP4K_E083` | `motivates` | 09-Problem Scenario | estimation of closely spaced sinusoidal frequencies in noisy environment(Uncertainty) |  | 15-Data Preprocessing Algorithm | EKF |  |
| 5 | `2I77HP4K_E084` | `motivates` | 09-Problem Scenario | detecting weak failure modes (partial BRB) in low-load applications(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Rayleigh-quotient |  |
| 6 | `2I77HP4K_E085` | `motivates` | 09-Problem Scenario | estimation of closely spaced sinusoidal frequencies in noisy environment(Uncertainty) |  | 16-Feature Extraction Algorithm | Rayleigh-quotient |  |
| 7 | `2I77HP4K_E086` | `motivates` | 09-Problem Scenario | detecting weak failure modes (partial BRB) in low-load applications(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | ECDF |  |
| 8 | `2I77HP4K_E087` | `motivates` | 09-Problem Scenario | estimation of closely spaced sinusoidal frequencies in noisy environment(Uncertainty) |  | 17-Core Classifier Algorithm | ECDF |  |
| 9 | `2I77HP4K_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Rayleigh-quotient |  |
| 10 | `2I77HP4K_E089` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | ECDF |  |
| 11 | `2I77HP4K_E090` | `motivates` | 06-Fault Severity | Drill depth(Multiple Severities) |  | 17-Core Classifier Algorithm | ECDF |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `2I77HP4K_E082`：detecting weak failure modes (partial BRB) in low-load applications(Early Degradation Prediction) motivates EKF
  - `2I77HP4K_E083`：estimation of closely spaced sinusoidal frequencies in noisy environment(Uncertainty) motivates EKF
  - `2I77HP4K_E084`：detecting weak failure modes (partial BRB) in low-load applications(Early Degradation Prediction) motivates Rayleigh-quotient
  - `2I77HP4K_E085`：estimation of closely spaced sinusoidal frequencies in noisy environment(Uncertainty) motivates Rayleigh-quotient
  - `2I77HP4K_E086`：detecting weak failure modes (partial BRB) in low-load applications(Early Degradation Prediction) motivates ECDF
  - `2I77HP4K_E087`：estimation of closely spaced sinusoidal frequencies in noisy environment(Uncertainty) motivates ECDF
