...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WZXL8UVZ_E099` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 19-Training Optimization Algorithm | Parametric optimization |  |
| 2 | `WZXL8UVZ_E100` | `motivates` | 09-Problem Scenario | adaptive parameter selection(Other) |  | 19-Training Optimization Algorithm | Parametric optimization |  |
| 3 | `WZXL8UVZ_E101` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Parametric optimization |  |
| 4 | `WZXL8UVZ_E102` | `motivates` | 13-Noise Level | heavy background noise, low SNR(High Noise) |  | 16-Feature Extraction Algorithm | TQWT |  |
| 5 | `WZXL8UVZ_E103` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | TQWT |  |
| 6 | `WZXL8UVZ_E104` | `motivates` | 09-Problem Scenario | adaptive parameter selection(Other) |  | 16-Feature Extraction Algorithm | TQWT |  |
| 7 | `WZXL8UVZ_E105` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Hilbert envelope spectrum |  |
| 8 | `WZXL8UVZ_E106` | `motivates` | 09-Problem Scenario | adaptive parameter selection(Other) |  | 17-Core Classifier Algorithm | Hilbert envelope spectrum |  |
| 9 | `WZXL8UVZ_E107` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | TQWT |  |
| 10 | `WZXL8UVZ_E108` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Hilbert envelope spectrum |  |
| 11 | `WZXL8UVZ_E109` | `motivates` | 06-Fault Severity | slight(Single Severity) |  | 17-Core Classifier Algorithm | Hilbert envelope spectrum |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `WZXL8UVZ_E099`：noise robustness(Uncertainty) motivates Parametric optimization
  - `WZXL8UVZ_E100`：adaptive parameter selection(Other) motivates Parametric optimization
  - `WZXL8UVZ_E103`：noise robustness(Uncertainty) motivates TQWT
  - `WZXL8UVZ_E104`：adaptive parameter selection(Other) motivates TQWT
  - `WZXL8UVZ_E105`：noise robustness(Uncertainty) motivates Hilbert envelope spectrum
  - `WZXL8UVZ_E106`：adaptive parameter selection(Other) motivates Hilbert envelope spectrum
