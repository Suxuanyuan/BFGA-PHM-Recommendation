...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SGDT4UGZ_E090` | `motivates` | 09-Problem Scenario | compound fault(Compound Faults) |  | 19-Training Optimization Algorithm | PSO |  |
| 2 | `SGDT4UGZ_E091` | `motivates` | 09-Problem Scenario | real-time production quality control scenarios lacking computing resources(Other) |  | 19-Training Optimization Algorithm | PSO |  |
| 3 | `SGDT4UGZ_E092` | `motivates` | 12-Training Data Availability | 700 training samples per class(Sufficient) |  | 19-Training Optimization Algorithm | PSO |  |
| 4 | `SGDT4UGZ_E093` | `motivates` | 13-Noise Level | raw vibration signal(Normal) |  | 15-Data Preprocessing Algorithm | Min-Max normalization |  |
| 5 | `SGDT4UGZ_E094` | `motivates` | 13-Noise Level | raw vibration signal(Normal) |  | 16-Feature Extraction Algorithm | TSFFCNN |  |
| 6 | `SGDT4UGZ_E095` | `motivates` | 09-Problem Scenario | compound fault(Compound Faults) |  | 15-Data Preprocessing Algorithm | Min-Max normalization |  |
| 7 | `SGDT4UGZ_E096` | `motivates` | 09-Problem Scenario | real-time production quality control scenarios lacking computing resources(Other) |  | 15-Data Preprocessing Algorithm | Min-Max normalization |  |
| 8 | `SGDT4UGZ_E097` | `motivates` | 09-Problem Scenario | compound fault(Compound Faults) |  | 16-Feature Extraction Algorithm | TSFFCNN |  |
| 9 | `SGDT4UGZ_E098` | `motivates` | 09-Problem Scenario | real-time production quality control scenarios lacking computing resources(Other) |  | 16-Feature Extraction Algorithm | TSFFCNN |  |
| 10 | `SGDT4UGZ_E099` | `motivates` | 09-Problem Scenario | compound fault(Compound Faults) |  | 17-Core Classifier Algorithm | SVM |  |
| 11 | `SGDT4UGZ_E100` | `motivates` | 09-Problem Scenario | real-time production quality control scenarios lacking computing resources(Other) |  | 17-Core Classifier Algorithm | SVM |  |
| 12 | `SGDT4UGZ_E101` | `motivates` | 07-Compound Fault | simulated compound faults(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | TSFFCNN |  |
| 13 | `SGDT4UGZ_E102` | `motivates` | 07-Compound Fault | simulated compound faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | SVM |  |
| 14 | `SGDT4UGZ_E103` | `motivates` | 06-Fault Severity | wear diameter of 0.1778, 0.3556, and 0.5334 mm(Multiple Severities) |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `SGDT4UGZ_E090`：compound fault(Compound Faults) motivates PSO
  - `SGDT4UGZ_E091`：real-time production quality control scenarios lacking computing resources(Other) motivates PSO
  - `SGDT4UGZ_E095`：compound fault(Compound Faults) motivates Min-Max normalization
  - `SGDT4UGZ_E096`：real-time production quality control scenarios lacking computing resources(Other) motivates Min-Max normalization
  - `SGDT4UGZ_E097`：compound fault(Compound Faults) motivates TSFFCNN
  - `SGDT4UGZ_E098`：real-time production quality control scenarios lacking computing resources(Other) motivates TSFFCNN
  - `SGDT4UGZ_E099`：compound fault(Compound Faults) motivates SVM
  - `SGDT4UGZ_E100`：real-time production quality control scenarios lacking computing resources(Other) motivates SVM
