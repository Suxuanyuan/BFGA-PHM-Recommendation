...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HQ2BM65L_E080` | `motivates` | 13-Noise Level | noise(High Noise) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 2 | `HQ2BM65L_E081` | `motivates` | 13-Noise Level | noise(High Noise) |  | 16-Feature Extraction Algorithm | Peak-to-Peak Value |  |
| 3 | `HQ2BM65L_E082` | `motivates` | 09-Problem Scenario | big-data problem of massive amounts of redundant information(Other) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 4 | `HQ2BM65L_E083` | `motivates` | 09-Problem Scenario | big-data problem of massive amounts of redundant information(Other) |  | 16-Feature Extraction Algorithm | Peak-to-Peak Value |  |
| 5 | `HQ2BM65L_E084` | `motivates` | 09-Problem Scenario | big-data problem of massive amounts of redundant information(Other) |  | 17-Core Classifier Algorithm | Matching Pursuit |  |
| 6 | `HQ2BM65L_E085` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Peak-to-Peak Value |  |
| 7 | `HQ2BM65L_E086` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Matching Pursuit |  |
| 8 | `HQ2BM65L_E087` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Matching Pursuit |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `HQ2BM65L_E082`：big-data problem of massive amounts of redundant information(Other) motivates Sliding Window
  - `HQ2BM65L_E083`：big-data problem of massive amounts of redundant information(Other) motivates Peak-to-Peak Value
  - `HQ2BM65L_E084`：big-data problem of massive amounts of redundant information(Other) motivates Matching Pursuit
