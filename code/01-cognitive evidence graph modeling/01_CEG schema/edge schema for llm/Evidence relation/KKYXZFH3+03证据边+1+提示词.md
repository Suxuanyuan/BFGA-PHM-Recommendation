...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `KKYXZFH3_E104` | `motivates` | 09-Problem Scenario | strong non-Gaussian noise / background noise(Uncertainty) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 2 | `KKYXZFH3_E105` | `motivates` | 09-Problem Scenario | incipient bearing defects / initial bearing defect(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 3 | `KKYXZFH3_E106` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 4 | `KKYXZFH3_E107` | `motivates` | 13-Noise Level | contaminated by strong non-Gaussian noise(High Noise) |  | 15-Data Preprocessing Algorithm | Empirical Wavelet Transform |  |
| 5 | `KKYXZFH3_E108` | `motivates` | 13-Noise Level | contaminated by strong non-Gaussian noise(High Noise) |  | 16-Feature Extraction Algorithm | Harmonic Product Spectrum |  |
| 6 | `KKYXZFH3_E109` | `motivates` | 09-Problem Scenario | strong non-Gaussian noise / background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Empirical Wavelet Transform |  |
| 7 | `KKYXZFH3_E110` | `motivates` | 09-Problem Scenario | incipient bearing defects / initial bearing defect(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Empirical Wavelet Transform |  |
| 8 | `KKYXZFH3_E111` | `motivates` | 09-Problem Scenario | strong non-Gaussian noise / background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Harmonic Product Spectrum |  |
| 9 | `KKYXZFH3_E112` | `motivates` | 09-Problem Scenario | incipient bearing defects / initial bearing defect(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Harmonic Product Spectrum |  |
| 10 | `KKYXZFH3_E113` | `motivates` | 09-Problem Scenario | strong non-Gaussian noise / background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Analysis |  |
| 11 | `KKYXZFH3_E114` | `motivates` | 09-Problem Scenario | incipient bearing defects / initial bearing defect(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Envelope Analysis |  |
| 12 | `KKYXZFH3_E115` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Harmonic Product Spectrum |  |
| 13 | `KKYXZFH3_E116` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope Analysis |  |
| 14 | `KKYXZFH3_E117` | `motivates` | 06-Fault Severity | diameter of 2.2mm and depth of 1.0mm(Single Severity) |  | 17-Core Classifier Algorithm | Envelope Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `KKYXZFH3_E104`：strong non-Gaussian noise / background noise(Uncertainty) motivates Particle Swarm Optimization
  - `KKYXZFH3_E105`：incipient bearing defects / initial bearing defect(Early Degradation Prediction) motivates Particle Swarm Optimization
  - `KKYXZFH3_E109`：strong non-Gaussian noise / background noise(Uncertainty) motivates Empirical Wavelet Transform
  - `KKYXZFH3_E110`：incipient bearing defects / initial bearing defect(Early Degradation Prediction) motivates Empirical Wavelet Transform
  - `KKYXZFH3_E111`：strong non-Gaussian noise / background noise(Uncertainty) motivates Harmonic Product Spectrum
  - `KKYXZFH3_E112`：incipient bearing defects / initial bearing defect(Early Degradation Prediction) motivates Harmonic Product Spectrum
  - `KKYXZFH3_E113`：strong non-Gaussian noise / background noise(Uncertainty) motivates Envelope Analysis
  - `KKYXZFH3_E114`：incipient bearing defects / initial bearing defect(Early Degradation Prediction) motivates Envelope Analysis
