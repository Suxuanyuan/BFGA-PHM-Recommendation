...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DPI7P267_E102` | `motivates` | 13-Noise Level | noise, signal-to-noise ratio(High Noise) |  | 15-Data Preprocessing Algorithm | Bandpass filter |  |
| 2 | `DPI7P267_E103` | `motivates` | 13-Noise Level | noise, signal-to-noise ratio(High Noise) |  | 16-Feature Extraction Algorithm | Fourier transform |  |
| 3 | `DPI7P267_E104` | `motivates` | 09-Problem Scenario | robustness against transient states and parameter sensitivity(Uncertainty) |  | 15-Data Preprocessing Algorithm | Bandpass filter |  |
| 4 | `DPI7P267_E105` | `motivates` | 09-Problem Scenario | classification of faults with similar symptoms(Other) |  | 15-Data Preprocessing Algorithm | Bandpass filter |  |
| 5 | `DPI7P267_E106` | `motivates` | 09-Problem Scenario | robustness against transient states and parameter sensitivity(Uncertainty) |  | 16-Feature Extraction Algorithm | Fourier transform |  |
| 6 | `DPI7P267_E107` | `motivates` | 09-Problem Scenario | classification of faults with similar symptoms(Other) |  | 16-Feature Extraction Algorithm | Fourier transform |  |
| 7 | `DPI7P267_E108` | `motivates` | 09-Problem Scenario | robustness against transient states and parameter sensitivity(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold classifier |  |
| 8 | `DPI7P267_E109` | `motivates` | 09-Problem Scenario | classification of faults with similar symptoms(Other) |  | 17-Core Classifier Algorithm | Threshold classifier |  |
| 9 | `DPI7P267_E110` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Fourier transform |  |
| 10 | `DPI7P267_E111` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold classifier |  |
| 11 | `DPI7P267_E112` | `motivates` | 06-Fault Severity | single turn short-circuit, 0.1 Ω additional resistance(Single Severity) |  | 17-Core Classifier Algorithm | Threshold classifier |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `DPI7P267_E104`：robustness against transient states and parameter sensitivity(Uncertainty) motivates Bandpass filter
  - `DPI7P267_E105`：classification of faults with similar symptoms(Other) motivates Bandpass filter
  - `DPI7P267_E106`：robustness against transient states and parameter sensitivity(Uncertainty) motivates Fourier transform
  - `DPI7P267_E107`：classification of faults with similar symptoms(Other) motivates Fourier transform
  - `DPI7P267_E108`：robustness against transient states and parameter sensitivity(Uncertainty) motivates Threshold classifier
  - `DPI7P267_E109`：classification of faults with similar symptoms(Other) motivates Threshold classifier
