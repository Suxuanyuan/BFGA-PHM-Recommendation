...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HRJ3UDJ2_E080` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | CMD |  |
| 2 | `HRJ3UDJ2_E081` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | CMD |  |
| 3 | `HRJ3UDJ2_E082` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Z-score normalization |  |
| 4 | `HRJ3UDJ2_E083` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | CNN |  |
| 5 | `HRJ3UDJ2_E084` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Z-score normalization |  |
| 6 | `HRJ3UDJ2_E085` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | CNN |  |
| 7 | `HRJ3UDJ2_E086` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `HRJ3UDJ2_E087` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 9 | `HRJ3UDJ2_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 10 | `HRJ3UDJ2_E089` | `motivates` | 06-Fault Severity | 0.007 inches, 0.014 inches, 0.021 inches(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `HRJ3UDJ2_E080`：domain shift(Distribution Discrepancy) motivates CMD
  - `HRJ3UDJ2_E084`：domain shift(Distribution Discrepancy) motivates Z-score normalization
  - `HRJ3UDJ2_E085`：domain shift(Distribution Discrepancy) motivates CNN
  - `HRJ3UDJ2_E086`：domain shift(Distribution Discrepancy) motivates Softmax
