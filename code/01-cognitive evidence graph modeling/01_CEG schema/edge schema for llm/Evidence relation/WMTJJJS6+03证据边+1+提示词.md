...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WMTJJJS6_E130` | `motivates` | 12-Training Data Availability | Sufficient |  | 18-Data Generation Algorithm | Lumped Parameter Model |  |
| 2 | `WMTJJJS6_E131` | `motivates` | 13-Noise Level | complex noises(High Noise) |  | 15-Data Preprocessing Algorithm | EMD |  |
| 3 | `WMTJJJS6_E132` | `motivates` | 13-Noise Level | complex noises(High Noise) |  | 16-Feature Extraction Algorithm | FFT |  |
| 4 | `WMTJJJS6_E133` | `motivates` | 09-Problem Scenario | Non-stationary and nonlinear signals with complex noise(Uncertainty) |  | 18-Data Generation Algorithm | Lumped Parameter Model |  |
| 5 | `WMTJJJS6_E134` | `motivates` | 09-Problem Scenario | Early fault diagnosis / Degradation modeling of cylinder stiffness(Early Degradation Prediction) |  | 18-Data Generation Algorithm | Lumped Parameter Model |  |
| 6 | `WMTJJJS6_E135` | `motivates` | 09-Problem Scenario | Non-stationary and nonlinear signals with complex noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | EMD |  |
| 7 | `WMTJJJS6_E136` | `motivates` | 09-Problem Scenario | Early fault diagnosis / Degradation modeling of cylinder stiffness(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | EMD |  |
| 8 | `WMTJJJS6_E137` | `motivates` | 09-Problem Scenario | Non-stationary and nonlinear signals with complex noise(Uncertainty) |  | 16-Feature Extraction Algorithm | FFT |  |
| 9 | `WMTJJJS6_E138` | `motivates` | 09-Problem Scenario | Early fault diagnosis / Degradation modeling of cylinder stiffness(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | FFT |  |
| 10 | `WMTJJJS6_E139` | `motivates` | 09-Problem Scenario | Non-stationary and nonlinear signals with complex noise(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold-based Decision |  |
| 11 | `WMTJJJS6_E140` | `motivates` | 09-Problem Scenario | Early fault diagnosis / Degradation modeling of cylinder stiffness(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Threshold-based Decision |  |
| 12 | `WMTJJJS6_E141` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | FFT |  |
| 13 | `WMTJJJS6_E142` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold-based Decision |  |
| 14 | `WMTJJJS6_E143` | `motivates` | 06-Fault Severity | equivalent stiffness of the seals, the CGS(Multiple Severities) |  | 17-Core Classifier Algorithm | Threshold-based Decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `WMTJJJS6_E133`：Non-stationary and nonlinear signals with complex noise(Uncertainty) motivates Lumped Parameter Model
  - `WMTJJJS6_E134`：Early fault diagnosis / Degradation modeling of cylinder stiffness(Early Degradation Prediction) motivates Lumped Parameter Model
  - `WMTJJJS6_E135`：Non-stationary and nonlinear signals with complex noise(Uncertainty) motivates EMD
  - `WMTJJJS6_E136`：Early fault diagnosis / Degradation modeling of cylinder stiffness(Early Degradation Prediction) motivates EMD
  - `WMTJJJS6_E137`：Non-stationary and nonlinear signals with complex noise(Uncertainty) motivates FFT
  - `WMTJJJS6_E138`：Early fault diagnosis / Degradation modeling of cylinder stiffness(Early Degradation Prediction) motivates FFT
  - `WMTJJJS6_E139`：Non-stationary and nonlinear signals with complex noise(Uncertainty) motivates Threshold-based Decision
  - `WMTJJJS6_E140`：Early fault diagnosis / Degradation modeling of cylinder stiffness(Early Degradation Prediction) motivates Threshold-based Decision
