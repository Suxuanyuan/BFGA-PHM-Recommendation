...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `79E2EYNK_E100` | `motivates` | 13-Noise Level | low signal to noise ratio, additive background noise(High Noise) |  | 15-Data Preprocessing Algorithm | High-pass filter |  |
| 2 | `79E2EYNK_E101` | `motivates` | 13-Noise Level | low signal to noise ratio, additive background noise(High Noise) |  | 16-Feature Extraction Algorithm | Matching pursuit |  |
| 3 | `79E2EYNK_E102` | `motivates` | 09-Problem Scenario | low signal to noise ratio(Uncertainty) |  | 15-Data Preprocessing Algorithm | High-pass filter |  |
| 4 | `79E2EYNK_E103` | `motivates` | 09-Problem Scenario | rolling element sliding and impulse missing(Other) |  | 15-Data Preprocessing Algorithm | High-pass filter |  |
| 5 | `79E2EYNK_E104` | `motivates` | 09-Problem Scenario | low signal to noise ratio(Uncertainty) |  | 16-Feature Extraction Algorithm | Matching pursuit |  |
| 6 | `79E2EYNK_E105` | `motivates` | 09-Problem Scenario | rolling element sliding and impulse missing(Other) |  | 16-Feature Extraction Algorithm | Matching pursuit |  |
| 7 | `79E2EYNK_E106` | `motivates` | 09-Problem Scenario | low signal to noise ratio(Uncertainty) |  | 17-Core Classifier Algorithm | Hilbert transform |  |
| 8 | `79E2EYNK_E107` | `motivates` | 09-Problem Scenario | rolling element sliding and impulse missing(Other) |  | 17-Core Classifier Algorithm | Hilbert transform |  |
| 9 | `79E2EYNK_E108` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Matching pursuit |  |
| 10 | `79E2EYNK_E109` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Hilbert transform |  |
| 11 | `79E2EYNK_E110` | `motivates` | 06-Fault Severity | width 0.2 mm, depth 0.5 mm; width 0.2 mm, depth 1 mm(Single Severity) |  | 17-Core Classifier Algorithm | Hilbert transform |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `79E2EYNK_E102`：low signal to noise ratio(Uncertainty) motivates High-pass filter
  - `79E2EYNK_E103`：rolling element sliding and impulse missing(Other) motivates High-pass filter
  - `79E2EYNK_E104`：low signal to noise ratio(Uncertainty) motivates Matching pursuit
  - `79E2EYNK_E105`：rolling element sliding and impulse missing(Other) motivates Matching pursuit
  - `79E2EYNK_E106`：low signal to noise ratio(Uncertainty) motivates Hilbert transform
  - `79E2EYNK_E107`：rolling element sliding and impulse missing(Other) motivates Hilbert transform
