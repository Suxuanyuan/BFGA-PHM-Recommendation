...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CL9B8945_E087` | `motivates` | 13-Noise Level | highly noisy vibration signals(High Noise) |  | 15-Data Preprocessing Algorithm | Hankel matrix |  |
| 2 | `CL9B8945_E088` | `motivates` | 13-Noise Level | highly noisy vibration signals(High Noise) |  | 16-Feature Extraction Algorithm | GMSVs |  |
| 3 | `CL9B8945_E089` | `motivates` | 09-Problem Scenario | early fault detection / weak fault information(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Hankel matrix |  |
| 4 | `CL9B8945_E090` | `motivates` | 09-Problem Scenario | small/limited number of reference data(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Hankel matrix |  |
| 5 | `CL9B8945_E091` | `motivates` | 09-Problem Scenario | early fault detection / weak fault information(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | GMSVs |  |
| 6 | `CL9B8945_E092` | `motivates` | 09-Problem Scenario | small/limited number of reference data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | GMSVs |  |
| 7 | `CL9B8945_E093` | `motivates` | 09-Problem Scenario | early fault detection / weak fault information(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | KNN |  |
| 8 | `CL9B8945_E094` | `motivates` | 09-Problem Scenario | small/limited number of reference data(Small Fault Samples) |  | 17-Core Classifier Algorithm | KNN |  |
| 9 | `CL9B8945_E095` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | GMSVs |  |
| 10 | `CL9B8945_E096` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | KNN |  |
| 11 | `CL9B8945_E097` | `motivates` | 06-Fault Severity | 0.18 mm, 0.36 mm, 0.53 mm(Multiple Severities) |  | 17-Core Classifier Algorithm | KNN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `CL9B8945_E089`：early fault detection / weak fault information(Early Degradation Prediction) motivates Hankel matrix
  - `CL9B8945_E090`：small/limited number of reference data(Small Fault Samples) motivates Hankel matrix
  - `CL9B8945_E091`：early fault detection / weak fault information(Early Degradation Prediction) motivates GMSVs
  - `CL9B8945_E092`：small/limited number of reference data(Small Fault Samples) motivates GMSVs
  - `CL9B8945_E093`：early fault detection / weak fault information(Early Degradation Prediction) motivates KNN
  - `CL9B8945_E094`：small/limited number of reference data(Small Fault Samples) motivates KNN
