...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HRXGHV4F_E098` | `motivates` | 13-Noise Level | noisy vibration signatures(High Noise) |  | 15-Data Preprocessing Algorithm | Wavelet de-noising |  |
| 2 | `HRXGHV4F_E099` | `motivates` | 13-Noise Level | noisy vibration signatures(High Noise) |  | 16-Feature Extraction Algorithm | Envelope analysis |  |
| 3 | `HRXGHV4F_E100` | `motivates` | 09-Problem Scenario | Noise robustness under slow speed operation(Uncertainty) |  | 15-Data Preprocessing Algorithm | Wavelet de-noising |  |
| 4 | `HRXGHV4F_E101` | `motivates` | 09-Problem Scenario | Combination/multiple faults diagnosis(Compound Faults) |  | 15-Data Preprocessing Algorithm | Wavelet de-noising |  |
| 5 | `HRXGHV4F_E102` | `motivates` | 09-Problem Scenario | Noise robustness under slow speed operation(Uncertainty) |  | 16-Feature Extraction Algorithm | Envelope analysis |  |
| 6 | `HRXGHV4F_E103` | `motivates` | 09-Problem Scenario | Combination/multiple faults diagnosis(Compound Faults) |  | 16-Feature Extraction Algorithm | Envelope analysis |  |
| 7 | `HRXGHV4F_E104` | `motivates` | 09-Problem Scenario | Noise robustness under slow speed operation(Uncertainty) |  | 17-Core Classifier Algorithm | Bearing characteristic frequency identification |  |
| 8 | `HRXGHV4F_E105` | `motivates` | 09-Problem Scenario | Combination/multiple faults diagnosis(Compound Faults) |  | 17-Core Classifier Algorithm | Bearing characteristic frequency identification |  |
| 9 | `HRXGHV4F_E106` | `motivates` | 07-Compound Fault | combination fault (outer and inner raceway fault with ball fault)(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Envelope analysis |  |
| 10 | `HRXGHV4F_E107` | `motivates` | 07-Compound Fault | combination fault (outer and inner raceway fault with ball fault)(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Bearing characteristic frequency identification |  |
| 11 | `HRXGHV4F_E108` | `motivates` | 06-Fault Severity | 3 mm width and 1 mm depth, 1.5 mm depth(Single Severity) |  | 17-Core Classifier Algorithm | Bearing characteristic frequency identification |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `HRXGHV4F_E100`：Noise robustness under slow speed operation(Uncertainty) motivates Wavelet de-noising
  - `HRXGHV4F_E101`：Combination/multiple faults diagnosis(Compound Faults) motivates Wavelet de-noising
  - `HRXGHV4F_E102`：Noise robustness under slow speed operation(Uncertainty) motivates Envelope analysis
  - `HRXGHV4F_E103`：Combination/multiple faults diagnosis(Compound Faults) motivates Envelope analysis
  - `HRXGHV4F_E104`：Noise robustness under slow speed operation(Uncertainty) motivates Bearing characteristic frequency identification
  - `HRXGHV4F_E105`：Combination/multiple faults diagnosis(Compound Faults) motivates Bearing characteristic frequency identification
