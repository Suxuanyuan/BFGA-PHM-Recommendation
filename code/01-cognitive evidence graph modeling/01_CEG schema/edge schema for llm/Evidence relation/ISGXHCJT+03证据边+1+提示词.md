...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ISGXHCJT_E064` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Park Transformation |  |
| 2 | `ISGXHCJT_E065` | `motivates` | 09-Problem Scenario | voltage hexagon limitation and current distortion under open-switch fault(Other) |  | 16-Feature Extraction Algorithm | Park Transformation |  |
| 3 | `ISGXHCJT_E066` | `motivates` | 09-Problem Scenario | voltage hexagon limitation and current distortion under open-switch fault(Other) |  | 17-Core Classifier Algorithm | Field-Oriented Control |  |
| 4 | `ISGXHCJT_E067` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Park Transformation |  |
| 5 | `ISGXHCJT_E068` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Field-Oriented Control |  |
| 6 | `ISGXHCJT_E069` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Field-Oriented Control |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ISGXHCJT_E065`：voltage hexagon limitation and current distortion under open-switch fault(Other) motivates Park Transformation
  - `ISGXHCJT_E066`：voltage hexagon limitation and current distortion under open-switch fault(Other) motivates Field-Oriented Control
