...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZI2RIQFP_E122` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Transfer learning |  |
| 2 | `ZI2RIQFP_E123` | `motivates` | 09-Problem Scenario | data deficiency problem in target domain(Small Fault Samples) |  | 19-Training Optimization Algorithm | Transfer learning |  |
| 3 | `ZI2RIQFP_E124` | `motivates` | 12-Training Data Availability | 30 * us * ls, 60 * us * ls, 90 * us * ls, 120 * us * ls, 150 * us * ls(Sufficient) |  | 19-Training Optimization Algorithm | Transfer learning |  |
| 4 | `ZI2RIQFP_E125` | `motivates` | 13-Noise Level | low-frequency noise, interfering noise(High Noise) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 5 | `ZI2RIQFP_E126` | `motivates` | 13-Noise Level | low-frequency noise, interfering noise(High Noise) |  | 16-Feature Extraction Algorithm | Modified FSOM |  |
| 6 | `ZI2RIQFP_E127` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 7 | `ZI2RIQFP_E128` | `motivates` | 09-Problem Scenario | data deficiency problem in target domain(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 8 | `ZI2RIQFP_E129` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Modified FSOM |  |
| 9 | `ZI2RIQFP_E130` | `motivates` | 09-Problem Scenario | data deficiency problem in target domain(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Modified FSOM |  |
| 10 | `ZI2RIQFP_E131` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Two-order selective ensemble |  |
| 11 | `ZI2RIQFP_E132` | `motivates` | 09-Problem Scenario | data deficiency problem in target domain(Small Fault Samples) |  | 17-Core Classifier Algorithm | Two-order selective ensemble |  |
| 12 | `ZI2RIQFP_E133` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Modified FSOM |  |
| 13 | `ZI2RIQFP_E134` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Two-order selective ensemble |  |
| 14 | `ZI2RIQFP_E135` | `motivates` | 06-Fault Severity | light crack, small crack, medium crack, heavy crack(Multiple Severities) |  | 17-Core Classifier Algorithm | Two-order selective ensemble |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZI2RIQFP_E122`：domain shift(Distribution Discrepancy) motivates Transfer learning
  - `ZI2RIQFP_E123`：data deficiency problem in target domain(Small Fault Samples) motivates Transfer learning
  - `ZI2RIQFP_E127`：domain shift(Distribution Discrepancy) motivates Hilbert transform
  - `ZI2RIQFP_E128`：data deficiency problem in target domain(Small Fault Samples) motivates Hilbert transform
  - `ZI2RIQFP_E129`：domain shift(Distribution Discrepancy) motivates Modified FSOM
  - `ZI2RIQFP_E130`：data deficiency problem in target domain(Small Fault Samples) motivates Modified FSOM
  - `ZI2RIQFP_E131`：domain shift(Distribution Discrepancy) motivates Two-order selective ensemble
  - `ZI2RIQFP_E132`：data deficiency problem in target domain(Small Fault Samples) motivates Two-order selective ensemble
