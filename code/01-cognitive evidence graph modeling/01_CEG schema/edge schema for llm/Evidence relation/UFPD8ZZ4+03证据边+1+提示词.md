...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `UFPD8ZZ4_E107` | `motivates` | 13-Noise Level | noisy references, noise floor, signal to noise ratio(High Noise) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 2 | `UFPD8ZZ4_E108` | `motivates` | 13-Noise Level | noisy references, noise floor, signal to noise ratio(High Noise) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 3 | `UFPD8ZZ4_E109` | `motivates` | 09-Problem Scenario | incipient phase fault detection(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 4 | `UFPD8ZZ4_E110` | `motivates` | 09-Problem Scenario | noisy references(Uncertainty) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 5 | `UFPD8ZZ4_E111` | `motivates` | 09-Problem Scenario | incipient phase fault detection(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 6 | `UFPD8ZZ4_E112` | `motivates` | 09-Problem Scenario | noisy references(Uncertainty) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 7 | `UFPD8ZZ4_E113` | `motivates` | 09-Problem Scenario | incipient phase fault detection(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Standard Deviation Thresholding |  |
| 8 | `UFPD8ZZ4_E114` | `motivates` | 09-Problem Scenario | noisy references(Uncertainty) |  | 17-Core Classifier Algorithm | Standard Deviation Thresholding |  |
| 9 | `UFPD8ZZ4_E115` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 10 | `UFPD8ZZ4_E116` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Standard Deviation Thresholding |  |
| 11 | `UFPD8ZZ4_E117` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Standard Deviation Thresholding |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `UFPD8ZZ4_E109`：incipient phase fault detection(Early Degradation Prediction) motivates Normalization
  - `UFPD8ZZ4_E110`：noisy references(Uncertainty) motivates Normalization
  - `UFPD8ZZ4_E111`：incipient phase fault detection(Early Degradation Prediction) motivates Fast Fourier Transform
  - `UFPD8ZZ4_E112`：noisy references(Uncertainty) motivates Fast Fourier Transform
  - `UFPD8ZZ4_E113`：incipient phase fault detection(Early Degradation Prediction) motivates Standard Deviation Thresholding
  - `UFPD8ZZ4_E114`：noisy references(Uncertainty) motivates Standard Deviation Thresholding
