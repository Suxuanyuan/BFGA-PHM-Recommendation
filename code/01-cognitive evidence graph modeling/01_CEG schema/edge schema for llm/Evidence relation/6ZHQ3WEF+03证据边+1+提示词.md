...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `6ZHQ3WEF_E124` | `motivates` | 12-Training Data Availability | Sufficient |  | 18-Data Generation Algorithm | Fourth-order Runge-Kutta method |  |
| 2 | `6ZHQ3WEF_E125` | `motivates` | 13-Noise Level | mechanical noise(High Noise) |  | 15-Data Preprocessing Algorithm | Butterworth high-pass filter |  |
| 3 | `6ZHQ3WEF_E126` | `motivates` | 13-Noise Level | mechanical noise(High Noise) |  | 16-Feature Extraction Algorithm | Crank-angle domain mapping |  |
| 4 | `6ZHQ3WEF_E127` | `motivates` | 09-Problem Scenario | integrating acoustic emission signal and simulated valve motion (thermodynamic model)(Trustworthiness / Interpretability) |  | 18-Data Generation Algorithm | Fourth-order Runge-Kutta method |  |
| 5 | `6ZHQ3WEF_E128` | `motivates` | 09-Problem Scenario | require a library of reference data for each fault / limited sensitivity to slight faults(Other) |  | 18-Data Generation Algorithm | Fourth-order Runge-Kutta method |  |
| 6 | `6ZHQ3WEF_E129` | `motivates` | 09-Problem Scenario | integrating acoustic emission signal and simulated valve motion (thermodynamic model)(Trustworthiness / Interpretability) |  | 15-Data Preprocessing Algorithm | Butterworth high-pass filter |  |
| 7 | `6ZHQ3WEF_E130` | `motivates` | 09-Problem Scenario | require a library of reference data for each fault / limited sensitivity to slight faults(Other) |  | 15-Data Preprocessing Algorithm | Butterworth high-pass filter |  |
| 8 | `6ZHQ3WEF_E131` | `motivates` | 09-Problem Scenario | integrating acoustic emission signal and simulated valve motion (thermodynamic model)(Trustworthiness / Interpretability) |  | 16-Feature Extraction Algorithm | Crank-angle domain mapping |  |
| 9 | `6ZHQ3WEF_E132` | `motivates` | 09-Problem Scenario | require a library of reference data for each fault / limited sensitivity to slight faults(Other) |  | 16-Feature Extraction Algorithm | Crank-angle domain mapping |  |
| 10 | `6ZHQ3WEF_E133` | `motivates` | 09-Problem Scenario | integrating acoustic emission signal and simulated valve motion (thermodynamic model)(Trustworthiness / Interpretability) |  | 17-Core Classifier Algorithm | Crank-angle domain comparison |  |
| 11 | `6ZHQ3WEF_E134` | `motivates` | 09-Problem Scenario | require a library of reference data for each fault / limited sensitivity to slight faults(Other) |  | 17-Core Classifier Algorithm | Crank-angle domain comparison |  |
| 12 | `6ZHQ3WEF_E135` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Crank-angle domain mapping |  |
| 13 | `6ZHQ3WEF_E136` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Crank-angle domain comparison |  |
| 14 | `6ZHQ3WEF_E137` | `motivates` | 06-Fault Severity | spring rigidity(Multiple Severities) |  | 17-Core Classifier Algorithm | Crank-angle domain comparison |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `6ZHQ3WEF_E127`：integrating acoustic emission signal and simulated valve motion (thermodynamic model)(Trustworthiness / Interpretability) motivates Fourth-order Runge-Kutta method
  - `6ZHQ3WEF_E128`：require a library of reference data for each fault / limited sensitivity to slight faults(Other) motivates Fourth-order Runge-Kutta method
  - `6ZHQ3WEF_E129`：integrating acoustic emission signal and simulated valve motion (thermodynamic model)(Trustworthiness / Interpretability) motivates Butterworth high-pass filter
  - `6ZHQ3WEF_E130`：require a library of reference data for each fault / limited sensitivity to slight faults(Other) motivates Butterworth high-pass filter
  - `6ZHQ3WEF_E131`：integrating acoustic emission signal and simulated valve motion (thermodynamic model)(Trustworthiness / Interpretability) motivates Crank-angle domain mapping
  - `6ZHQ3WEF_E132`：require a library of reference data for each fault / limited sensitivity to slight faults(Other) motivates Crank-angle domain mapping
  - `6ZHQ3WEF_E133`：integrating acoustic emission signal and simulated valve motion (thermodynamic model)(Trustworthiness / Interpretability) motivates Crank-angle domain comparison
  - `6ZHQ3WEF_E134`：require a library of reference data for each fault / limited sensitivity to slight faults(Other) motivates Crank-angle domain comparison
