...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QPC87HB6_E091` | `motivates` | 09-Problem Scenario | uncertain systems with unknown inputs(Uncertainty) |  | 19-Training Optimization Algorithm | Clustering-based identification |  |
| 2 | `QPC87HB6_E092` | `motivates` | 09-Problem Scenario | indirect position sensing(Other) |  | 19-Training Optimization Algorithm | Clustering-based identification |  |
| 3 | `QPC87HB6_E093` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Clustering-based identification |  |
| 4 | `QPC87HB6_E094` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Luenberger observer |  |
| 5 | `QPC87HB6_E095` | `motivates` | 09-Problem Scenario | uncertain systems with unknown inputs(Uncertainty) |  | 16-Feature Extraction Algorithm | Luenberger observer |  |
| 6 | `QPC87HB6_E096` | `motivates` | 09-Problem Scenario | indirect position sensing(Other) |  | 16-Feature Extraction Algorithm | Luenberger observer |  |
| 7 | `QPC87HB6_E097` | `motivates` | 09-Problem Scenario | uncertain systems with unknown inputs(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold classifier |  |
| 8 | `QPC87HB6_E098` | `motivates` | 09-Problem Scenario | indirect position sensing(Other) |  | 17-Core Classifier Algorithm | Threshold classifier |  |
| 9 | `QPC87HB6_E099` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Luenberger observer |  |
| 10 | `QPC87HB6_E100` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold classifier |  |
| 11 | `QPC87HB6_E101` | `motivates` | 06-Fault Severity | faulty operation, operation under warning, and normal operation(Multiple Severities) |  | 17-Core Classifier Algorithm | Threshold classifier |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `QPC87HB6_E091`：uncertain systems with unknown inputs(Uncertainty) motivates Clustering-based identification
  - `QPC87HB6_E092`：indirect position sensing(Other) motivates Clustering-based identification
  - `QPC87HB6_E095`：uncertain systems with unknown inputs(Uncertainty) motivates Luenberger observer
  - `QPC87HB6_E096`：indirect position sensing(Other) motivates Luenberger observer
  - `QPC87HB6_E097`：uncertain systems with unknown inputs(Uncertainty) motivates Threshold classifier
  - `QPC87HB6_E098`：indirect position sensing(Other) motivates Threshold classifier
