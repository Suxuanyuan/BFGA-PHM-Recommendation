...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `5EEV34ZJ_E100` | `motivates` | 09-Problem Scenario | small sample size(Small Fault Samples) |  | 19-Training Optimization Algorithm | ICD |  |
| 2 | `5EEV34ZJ_E101` | `motivates` | 09-Problem Scenario | parameter selection of SVM(Other) |  | 19-Training Optimization Algorithm | ICD |  |
| 3 | `5EEV34ZJ_E102` | `motivates` | 12-Training Data Availability | 10 samples were randomly selected as training data(Scarce) |  | 19-Training Optimization Algorithm | ICD |  |
| 4 | `5EEV34ZJ_E103` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | EEMD |  |
| 5 | `5EEV34ZJ_E104` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | SVD |  |
| 6 | `5EEV34ZJ_E105` | `motivates` | 09-Problem Scenario | small sample size(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | EEMD |  |
| 7 | `5EEV34ZJ_E106` | `motivates` | 09-Problem Scenario | parameter selection of SVM(Other) |  | 15-Data Preprocessing Algorithm | EEMD |  |
| 8 | `5EEV34ZJ_E107` | `motivates` | 09-Problem Scenario | small sample size(Small Fault Samples) |  | 16-Feature Extraction Algorithm | SVD |  |
| 9 | `5EEV34ZJ_E108` | `motivates` | 09-Problem Scenario | parameter selection of SVM(Other) |  | 16-Feature Extraction Algorithm | SVD |  |
| 10 | `5EEV34ZJ_E109` | `motivates` | 09-Problem Scenario | small sample size(Small Fault Samples) |  | 17-Core Classifier Algorithm | SVM |  |
| 11 | `5EEV34ZJ_E110` | `motivates` | 09-Problem Scenario | parameter selection of SVM(Other) |  | 17-Core Classifier Algorithm | SVM |  |
| 12 | `5EEV34ZJ_E111` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | SVD |  |
| 13 | `5EEV34ZJ_E112` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVM |  |
| 14 | `5EEV34ZJ_E113` | `motivates` | 06-Fault Severity | 0.007 in., 0.021 in.(Multiple Severities) |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `5EEV34ZJ_E100`：small sample size(Small Fault Samples) motivates ICD
  - `5EEV34ZJ_E101`：parameter selection of SVM(Other) motivates ICD
  - `5EEV34ZJ_E105`：small sample size(Small Fault Samples) motivates EEMD
  - `5EEV34ZJ_E106`：parameter selection of SVM(Other) motivates EEMD
  - `5EEV34ZJ_E107`：small sample size(Small Fault Samples) motivates SVD
  - `5EEV34ZJ_E108`：parameter selection of SVM(Other) motivates SVD
  - `5EEV34ZJ_E109`：small sample size(Small Fault Samples) motivates SVM
  - `5EEV34ZJ_E110`：parameter selection of SVM(Other) motivates SVM
