...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PNZZPWPS_E109` | `motivates` | 13-Noise Level | noise in measurements and stochastic nonlinear distortions(High Noise) |  | 16-Feature Extraction Algorithm | Sample Maximum Likelihood |  |
| 2 | `PNZZPWPS_E110` | `motivates` | 09-Problem Scenario | noise in measurements and stochastic nonlinear distortions(Uncertainty) |  | 16-Feature Extraction Algorithm | Sample Maximum Likelihood |  |
| 3 | `PNZZPWPS_E111` | `motivates` | 09-Problem Scenario | incipient multiplicative faults(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Sample Maximum Likelihood |  |
| 4 | `PNZZPWPS_E112` | `motivates` | 09-Problem Scenario | noise in measurements and stochastic nonlinear distortions(Uncertainty) |  | 17-Core Classifier Algorithm | Two-ellipsoid overlap test |  |
| 5 | `PNZZPWPS_E113` | `motivates` | 09-Problem Scenario | incipient multiplicative faults(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Two-ellipsoid overlap test |  |
| 6 | `PNZZPWPS_E114` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Sample Maximum Likelihood |  |
| 7 | `PNZZPWPS_E115` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Two-ellipsoid overlap test |  |
| 8 | `PNZZPWPS_E116` | `motivates` | 06-Fault Severity | R >= 7.3%, mu >= 0.004, PS/P_S^N <= 0.95(Multiple Severities) |  | 17-Core Classifier Algorithm | Two-ellipsoid overlap test |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `PNZZPWPS_E110`：noise in measurements and stochastic nonlinear distortions(Uncertainty) motivates Sample Maximum Likelihood
  - `PNZZPWPS_E111`：incipient multiplicative faults(Early Degradation Prediction) motivates Sample Maximum Likelihood
  - `PNZZPWPS_E112`：noise in measurements and stochastic nonlinear distortions(Uncertainty) motivates Two-ellipsoid overlap test
  - `PNZZPWPS_E113`：incipient multiplicative faults(Early Degradation Prediction) motivates Two-ellipsoid overlap test
