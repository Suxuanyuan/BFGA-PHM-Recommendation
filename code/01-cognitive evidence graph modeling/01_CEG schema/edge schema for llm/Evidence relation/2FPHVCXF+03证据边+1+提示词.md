...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `2FPHVCXF_E068` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Overlapped segmentation |  |
| 2 | `2FPHVCXF_E069` | `motivates` | 09-Problem Scenario | limited data(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Overlapped segmentation |  |
| 3 | `2FPHVCXF_E070` | `motivates` | 09-Problem Scenario | incipient bearing corrosion failure(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Overlapped segmentation |  |
| 4 | `2FPHVCXF_E071` | `motivates` | 09-Problem Scenario | limited data(Small Fault Samples) |  | 17-Core Classifier Algorithm | Modulation Signal Bispectrum |  |
| 5 | `2FPHVCXF_E072` | `motivates` | 09-Problem Scenario | incipient bearing corrosion failure(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Modulation Signal Bispectrum |  |
| 6 | `2FPHVCXF_E073` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Modulation Signal Bispectrum |  |
| 7 | `2FPHVCXF_E074` | `motivates` | 06-Fault Severity | incipient(Single Severity) |  | 17-Core Classifier Algorithm | Modulation Signal Bispectrum |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `2FPHVCXF_E069`：limited data(Small Fault Samples) motivates Overlapped segmentation
  - `2FPHVCXF_E070`：incipient bearing corrosion failure(Early Degradation Prediction) motivates Overlapped segmentation
  - `2FPHVCXF_E071`：limited data(Small Fault Samples) motivates Modulation Signal Bispectrum
  - `2FPHVCXF_E072`：incipient bearing corrosion failure(Early Degradation Prediction) motivates Modulation Signal Bispectrum
