...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `7HCURVQ7_E075` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Average value calculation |  |
| 2 | `7HCURVQ7_E076` | `motivates` | 09-Problem Scenario | multiple simultaneous open-switch faults(Compound Faults) |  | 16-Feature Extraction Algorithm | Average value calculation |  |
| 3 | `7HCURVQ7_E077` | `motivates` | 09-Problem Scenario | dc-link capacitor voltage unbalance and hardware cost in fault-tolerant control(Other) |  | 16-Feature Extraction Algorithm | Average value calculation |  |
| 4 | `7HCURVQ7_E078` | `motivates` | 09-Problem Scenario | multiple simultaneous open-switch faults(Compound Faults) |  | 17-Core Classifier Algorithm | Average current-based fault detection method |  |
| 5 | `7HCURVQ7_E079` | `motivates` | 09-Problem Scenario | dc-link capacitor voltage unbalance and hardware cost in fault-tolerant control(Other) |  | 17-Core Classifier Algorithm | Average current-based fault detection method |  |
| 6 | `7HCURVQ7_E080` | `motivates` | 07-Compound Fault | simultaneous open-switch faults(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Average value calculation |  |
| 7 | `7HCURVQ7_E081` | `motivates` | 07-Compound Fault | simultaneous open-switch faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Average current-based fault detection method |  |
| 8 | `7HCURVQ7_E082` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Average current-based fault detection method |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `7HCURVQ7_E076`：multiple simultaneous open-switch faults(Compound Faults) motivates Average value calculation
  - `7HCURVQ7_E077`：dc-link capacitor voltage unbalance and hardware cost in fault-tolerant control(Other) motivates Average value calculation
  - `7HCURVQ7_E078`：multiple simultaneous open-switch faults(Compound Faults) motivates Average current-based fault detection method
  - `7HCURVQ7_E079`：dc-link capacitor voltage unbalance and hardware cost in fault-tolerant control(Other) motivates Average current-based fault detection method
