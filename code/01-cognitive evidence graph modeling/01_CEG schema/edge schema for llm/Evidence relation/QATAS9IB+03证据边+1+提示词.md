...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QATAS9IB_E068` | `motivates` | 13-Noise Level | inverter noise and variations, noisy current plot(High Noise) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 2 | `QATAS9IB_E069` | `motivates` | 13-Noise Level | inverter noise and variations, noisy current plot(High Noise) |  | 16-Feature Extraction Algorithm | Chirp Zeta Transform |  |
| 3 | `QATAS9IB_E070` | `motivates` | 09-Problem Scenario | randomness and intermittency of arc faults, and background noise from inverter(Uncertainty) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 4 | `QATAS9IB_E071` | `motivates` | 09-Problem Scenario | randomness and intermittency of arc faults, and background noise from inverter(Uncertainty) |  | 16-Feature Extraction Algorithm | Chirp Zeta Transform |  |
| 5 | `QATAS9IB_E072` | `motivates` | 09-Problem Scenario | randomness and intermittency of arc faults, and background noise from inverter(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 6 | `QATAS9IB_E073` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Chirp Zeta Transform |  |
| 7 | `QATAS9IB_E074` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 8 | `QATAS9IB_E075` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Threshold Decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `QATAS9IB_E070`：randomness and intermittency of arc faults, and background noise from inverter(Uncertainty) motivates Sliding Window
  - `QATAS9IB_E071`：randomness and intermittency of arc faults, and background noise from inverter(Uncertainty) motivates Chirp Zeta Transform
  - `QATAS9IB_E072`：randomness and intermittency of arc faults, and background noise from inverter(Uncertainty) motivates Threshold Decision
