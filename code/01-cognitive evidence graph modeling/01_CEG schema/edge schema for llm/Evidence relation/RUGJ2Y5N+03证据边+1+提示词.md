...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `RUGJ2Y5N_E080` | `motivates` | 13-Noise Level | background noise and rotational excitation component(High Noise) |  | 15-Data Preprocessing Algorithm | CMWT |  |
| 2 | `RUGJ2Y5N_E081` | `motivates` | 13-Noise Level | background noise and rotational excitation component(High Noise) |  | 16-Feature Extraction Algorithm | FH |  |
| 3 | `RUGJ2Y5N_E082` | `motivates` | 09-Problem Scenario | lack of theoretical formulas for FCFs of ESB(Other) |  | 15-Data Preprocessing Algorithm | CMWT |  |
| 4 | `RUGJ2Y5N_E083` | `motivates` | 09-Problem Scenario | fault impulse feature component submerged in the dominant rotational excitation(Uncertainty) |  | 15-Data Preprocessing Algorithm | CMWT |  |
| 5 | `RUGJ2Y5N_E084` | `motivates` | 09-Problem Scenario | lack of theoretical formulas for FCFs of ESB(Other) |  | 16-Feature Extraction Algorithm | FH |  |
| 6 | `RUGJ2Y5N_E085` | `motivates` | 09-Problem Scenario | fault impulse feature component submerged in the dominant rotational excitation(Uncertainty) |  | 16-Feature Extraction Algorithm | FH |  |
| 7 | `RUGJ2Y5N_E086` | `motivates` | 09-Problem Scenario | lack of theoretical formulas for FCFs of ESB(Other) |  | 17-Core Classifier Algorithm | Theoretical FCF calculation |  |
| 8 | `RUGJ2Y5N_E087` | `motivates` | 09-Problem Scenario | fault impulse feature component submerged in the dominant rotational excitation(Uncertainty) |  | 17-Core Classifier Algorithm | Theoretical FCF calculation |  |
| 9 | `RUGJ2Y5N_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | FH |  |
| 10 | `RUGJ2Y5N_E089` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Theoretical FCF calculation |  |
| 11 | `RUGJ2Y5N_E090` | `motivates` | 06-Fault Severity | 3×1×1(Single Severity) |  | 17-Core Classifier Algorithm | Theoretical FCF calculation |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `RUGJ2Y5N_E082`：lack of theoretical formulas for FCFs of ESB(Other) motivates CMWT
  - `RUGJ2Y5N_E083`：fault impulse feature component submerged in the dominant rotational excitation(Uncertainty) motivates CMWT
  - `RUGJ2Y5N_E084`：lack of theoretical formulas for FCFs of ESB(Other) motivates FH
  - `RUGJ2Y5N_E085`：fault impulse feature component submerged in the dominant rotational excitation(Uncertainty) motivates FH
  - `RUGJ2Y5N_E086`：lack of theoretical formulas for FCFs of ESB(Other) motivates Theoretical FCF calculation
  - `RUGJ2Y5N_E087`：fault impulse feature component submerged in the dominant rotational excitation(Uncertainty) motivates Theoretical FCF calculation
