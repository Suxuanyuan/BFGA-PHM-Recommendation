...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TILRATMF_E159` | `motivates` | 09-Problem Scenario | scarcity of fault samples, few-shot scenario(Small Fault Samples) |  | 19-Training Optimization Algorithm | Meta-learning |  |
| 2 | `TILRATMF_E160` | `motivates` | 09-Problem Scenario | conditions transfer, artificial-to-natural transfer, domain shift(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Meta-learning |  |
| 3 | `TILRATMF_E161` | `motivates` | 12-Training Data Availability | few-shot, limited data, 1 shot to 10 shot(Scarce) |  | 19-Training Optimization Algorithm | Meta-learning |  |
| 4 | `TILRATMF_E162` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | FFT |  |
| 5 | `TILRATMF_E163` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | 1D CNN |  |
| 6 | `TILRATMF_E164` | `motivates` | 09-Problem Scenario | scarcity of fault samples, few-shot scenario(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 7 | `TILRATMF_E165` | `motivates` | 09-Problem Scenario | conditions transfer, artificial-to-natural transfer, domain shift(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 8 | `TILRATMF_E166` | `motivates` | 09-Problem Scenario | scarcity of fault samples, few-shot scenario(Small Fault Samples) |  | 16-Feature Extraction Algorithm | 1D CNN |  |
| 9 | `TILRATMF_E167` | `motivates` | 09-Problem Scenario | conditions transfer, artificial-to-natural transfer, domain shift(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | 1D CNN |  |
| 10 | `TILRATMF_E168` | `motivates` | 09-Problem Scenario | scarcity of fault samples, few-shot scenario(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `TILRATMF_E169` | `motivates` | 09-Problem Scenario | conditions transfer, artificial-to-natural transfer, domain shift(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `TILRATMF_E170` | `motivates` | 07-Compound Fault | Outer + inner(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | 1D CNN |  |
| 13 | `TILRATMF_E171` | `motivates` | 07-Compound Fault | Outer + inner(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `TILRATMF_E172` | `motivates` | 06-Fault Severity | damage length, sizes of root cracks(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `TILRATMF_E159`：scarcity of fault samples, few-shot scenario(Small Fault Samples) motivates Meta-learning
  - `TILRATMF_E160`：conditions transfer, artificial-to-natural transfer, domain shift(Distribution Discrepancy) motivates Meta-learning
  - `TILRATMF_E164`：scarcity of fault samples, few-shot scenario(Small Fault Samples) motivates FFT
  - `TILRATMF_E165`：conditions transfer, artificial-to-natural transfer, domain shift(Distribution Discrepancy) motivates FFT
  - `TILRATMF_E166`：scarcity of fault samples, few-shot scenario(Small Fault Samples) motivates 1D CNN
  - `TILRATMF_E167`：conditions transfer, artificial-to-natural transfer, domain shift(Distribution Discrepancy) motivates 1D CNN
  - `TILRATMF_E168`：scarcity of fault samples, few-shot scenario(Small Fault Samples) motivates Softmax
  - `TILRATMF_E169`：conditions transfer, artificial-to-natural transfer, domain shift(Distribution Discrepancy) motivates Softmax
