...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `RDYNYFQP_E281` | `motivates` | 09-Problem Scenario | High storage and computational cost of cumbersome neural networks(Other) |  | 19-Training Optimization Algorithm | Knowledge Distillation |  |
| 2 | `RDYNYFQP_E282` | `motivates` | 09-Problem Scenario | Learning of irrelevant or unimportant features in deep networks(Trustworthiness / Interpretability) |  | 19-Training Optimization Algorithm | Knowledge Distillation |  |
| 3 | `RDYNYFQP_E283` | `motivates` | 09-Problem Scenario | Complex dynamic systems(Complex Systems) |  | 19-Training Optimization Algorithm | Knowledge Distillation |  |
| 4 | `RDYNYFQP_E284` | `motivates` | 12-Training Data Availability | 8000 samples(Sufficient) |  | 19-Training Optimization Algorithm | Knowledge Distillation |  |
| 5 | `RDYNYFQP_E285` | `motivates` | 13-Noise Level | 20dB noise(High Noise) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 6 | `RDYNYFQP_E286` | `motivates` | 13-Noise Level | 20dB noise(High Noise) |  | 16-Feature Extraction Algorithm | 1D CNN |  |
| 7 | `RDYNYFQP_E287` | `motivates` | 09-Problem Scenario | High storage and computational cost of cumbersome neural networks(Other) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 8 | `RDYNYFQP_E288` | `motivates` | 09-Problem Scenario | Learning of irrelevant or unimportant features in deep networks(Trustworthiness / Interpretability) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 9 | `RDYNYFQP_E289` | `motivates` | 09-Problem Scenario | Complex dynamic systems(Complex Systems) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 10 | `RDYNYFQP_E290` | `motivates` | 09-Problem Scenario | High storage and computational cost of cumbersome neural networks(Other) |  | 16-Feature Extraction Algorithm | 1D CNN |  |
| 11 | `RDYNYFQP_E291` | `motivates` | 09-Problem Scenario | Learning of irrelevant or unimportant features in deep networks(Trustworthiness / Interpretability) |  | 16-Feature Extraction Algorithm | 1D CNN |  |
| 12 | `RDYNYFQP_E292` | `motivates` | 09-Problem Scenario | Complex dynamic systems(Complex Systems) |  | 16-Feature Extraction Algorithm | 1D CNN |  |
| 13 | `RDYNYFQP_E293` | `motivates` | 09-Problem Scenario | High storage and computational cost of cumbersome neural networks(Other) |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `RDYNYFQP_E294` | `motivates` | 09-Problem Scenario | Learning of irrelevant or unimportant features in deep networks(Trustworthiness / Interpretability) |  | 17-Core Classifier Algorithm | Softmax |  |
| 15 | `RDYNYFQP_E295` | `motivates` | 09-Problem Scenario | Complex dynamic systems(Complex Systems) |  | 17-Core Classifier Algorithm | Softmax |  |
| 16 | `RDYNYFQP_E296` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | 1D CNN |  |
| 17 | `RDYNYFQP_E297` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 18 | `RDYNYFQP_E298` | `motivates` | 06-Fault Severity | fault parameter(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `RDYNYFQP_E281`：High storage and computational cost of cumbersome neural networks(Other) motivates Knowledge Distillation
  - `RDYNYFQP_E282`：Learning of irrelevant or unimportant features in deep networks(Trustworthiness / Interpretability) motivates Knowledge Distillation
  - `RDYNYFQP_E283`：Complex dynamic systems(Complex Systems) motivates Knowledge Distillation
  - `RDYNYFQP_E287`：High storage and computational cost of cumbersome neural networks(Other) motivates Sliding Window
  - `RDYNYFQP_E288`：Learning of irrelevant or unimportant features in deep networks(Trustworthiness / Interpretability) motivates Sliding Window
  - `RDYNYFQP_E289`：Complex dynamic systems(Complex Systems) motivates Sliding Window
  - `RDYNYFQP_E290`：High storage and computational cost of cumbersome neural networks(Other) motivates 1D CNN
  - `RDYNYFQP_E291`：Learning of irrelevant or unimportant features in deep networks(Trustworthiness / Interpretability) motivates 1D CNN
  - `RDYNYFQP_E292`：Complex dynamic systems(Complex Systems) motivates 1D CNN
  - `RDYNYFQP_E293`：High storage and computational cost of cumbersome neural networks(Other) motivates Softmax
  - `RDYNYFQP_E294`：Learning of irrelevant or unimportant features in deep networks(Trustworthiness / Interpretability) motivates Softmax
  - `RDYNYFQP_E295`：Complex dynamic systems(Complex Systems) motivates Softmax
