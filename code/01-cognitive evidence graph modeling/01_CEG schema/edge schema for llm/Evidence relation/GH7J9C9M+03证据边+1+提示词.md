...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `GH7J9C9M_E134` | `motivates` | 09-Problem Scenario | domain shift due to working condition changes(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | WDAN |  |
| 2 | `GH7J9C9M_E135` | `motivates` | 09-Problem Scenario | negative transfer in domain adaptation(Other) |  | 19-Training Optimization Algorithm | WDAN |  |
| 3 | `GH7J9C9M_E136` | `motivates` | 12-Training Data Availability | 2000 training samples per class (THU) and 1125 training samples per class (UofA)(Sufficient) |  | 19-Training Optimization Algorithm | WDAN |  |
| 4 | `GH7J9C9M_E137` | `motivates` | 13-Noise Level | raw vibration signals(Normal) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 5 | `GH7J9C9M_E138` | `motivates` | 13-Noise Level | raw vibration signals(Normal) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 6 | `GH7J9C9M_E139` | `motivates` | 09-Problem Scenario | domain shift due to working condition changes(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 7 | `GH7J9C9M_E140` | `motivates` | 09-Problem Scenario | negative transfer in domain adaptation(Other) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 8 | `GH7J9C9M_E141` | `motivates` | 09-Problem Scenario | domain shift due to working condition changes(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 9 | `GH7J9C9M_E142` | `motivates` | 09-Problem Scenario | negative transfer in domain adaptation(Other) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 10 | `GH7J9C9M_E143` | `motivates` | 09-Problem Scenario | domain shift due to working condition changes(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Multilayer Perceptron |  |
| 11 | `GH7J9C9M_E144` | `motivates` | 09-Problem Scenario | negative transfer in domain adaptation(Other) |  | 17-Core Classifier Algorithm | Multilayer Perceptron |  |
| 12 | `GH7J9C9M_E145` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 13 | `GH7J9C9M_E146` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Multilayer Perceptron |  |
| 14 | `GH7J9C9M_E147` | `motivates` | 06-Fault Severity | crack depth, break position, crack level(Multiple Severities) |  | 17-Core Classifier Algorithm | Multilayer Perceptron |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `GH7J9C9M_E134`：domain shift due to working condition changes(Distribution Discrepancy) motivates WDAN
  - `GH7J9C9M_E135`：negative transfer in domain adaptation(Other) motivates WDAN
  - `GH7J9C9M_E139`：domain shift due to working condition changes(Distribution Discrepancy) motivates Normalization
  - `GH7J9C9M_E140`：negative transfer in domain adaptation(Other) motivates Normalization
  - `GH7J9C9M_E141`：domain shift due to working condition changes(Distribution Discrepancy) motivates 1DCNN
  - `GH7J9C9M_E142`：negative transfer in domain adaptation(Other) motivates 1DCNN
  - `GH7J9C9M_E143`：domain shift due to working condition changes(Distribution Discrepancy) motivates Multilayer Perceptron
  - `GH7J9C9M_E144`：negative transfer in domain adaptation(Other) motivates Multilayer Perceptron
