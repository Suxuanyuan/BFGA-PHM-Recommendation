...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AG9MIYTD_E128` | `motivates` | 13-Noise Level | noisy data(High Noise) |  | 15-Data Preprocessing Algorithm | Least Squares Method |  |
| 2 | `AG9MIYTD_E129` | `motivates` | 09-Problem Scenario | slowly happening and accumulating physical phenomena(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Least Squares Method |  |
| 3 | `AG9MIYTD_E130` | `motivates` | 09-Problem Scenario | noisy data(Uncertainty) |  | 15-Data Preprocessing Algorithm | Least Squares Method |  |
| 4 | `AG9MIYTD_E131` | `motivates` | 09-Problem Scenario | strong interactions between measurements(Complex Systems) |  | 15-Data Preprocessing Algorithm | Least Squares Method |  |
| 5 | `AG9MIYTD_E132` | `motivates` | 09-Problem Scenario | slowly happening and accumulating physical phenomena(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Heuristic Rules |  |
| 6 | `AG9MIYTD_E133` | `motivates` | 09-Problem Scenario | noisy data(Uncertainty) |  | 17-Core Classifier Algorithm | Heuristic Rules |  |
| 7 | `AG9MIYTD_E134` | `motivates` | 09-Problem Scenario | strong interactions between measurements(Complex Systems) |  | 17-Core Classifier Algorithm | Heuristic Rules |  |
| 8 | `AG9MIYTD_E135` | `motivates` | 07-Compound Fault | Deposits and peening, Deposits and damages(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Heuristic Rules |  |
| 9 | `AG9MIYTD_E136` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Heuristic Rules |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `AG9MIYTD_E129`：slowly happening and accumulating physical phenomena(Early Degradation Prediction) motivates Least Squares Method
  - `AG9MIYTD_E130`：noisy data(Uncertainty) motivates Least Squares Method
  - `AG9MIYTD_E131`：strong interactions between measurements(Complex Systems) motivates Least Squares Method
  - `AG9MIYTD_E132`：slowly happening and accumulating physical phenomena(Early Degradation Prediction) motivates Heuristic Rules
  - `AG9MIYTD_E133`：noisy data(Uncertainty) motivates Heuristic Rules
  - `AG9MIYTD_E134`：strong interactions between measurements(Complex Systems) motivates Heuristic Rules
