...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `C93YTVRE_E099` | `motivates` | 09-Problem Scenario | noises, disturbances and uncertainties(Uncertainty) |  | 19-Training Optimization Algorithm | Sliding Mode Control |  |
| 2 | `C93YTVRE_E100` | `motivates` | 09-Problem Scenario | 6-DoF aircraft nonlinear dynamics(Complex Systems) |  | 19-Training Optimization Algorithm | Sliding Mode Control |  |
| 3 | `C93YTVRE_E101` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Sliding Mode Control |  |
| 4 | `C93YTVRE_E102` | `motivates` | 09-Problem Scenario | noises, disturbances and uncertainties(Uncertainty) |  | 17-Core Classifier Algorithm | ARBFNN |  |
| 5 | `C93YTVRE_E103` | `motivates` | 09-Problem Scenario | 6-DoF aircraft nonlinear dynamics(Complex Systems) |  | 17-Core Classifier Algorithm | ARBFNN |  |
| 6 | `C93YTVRE_E104` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | ARBFNN |  |
| 7 | `C93YTVRE_E105` | `motivates` | 06-Fault Severity | oscillatory: 0.5*(sin(t)+sin(0.5*t)) rad/s; bias: 11*pi/180 rad/s; step: 1 rad/s(Single Severity) |  | 17-Core Classifier Algorithm | ARBFNN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `C93YTVRE_E099`：noises, disturbances and uncertainties(Uncertainty) motivates Sliding Mode Control
  - `C93YTVRE_E100`：6-DoF aircraft nonlinear dynamics(Complex Systems) motivates Sliding Mode Control
  - `C93YTVRE_E102`：noises, disturbances and uncertainties(Uncertainty) motivates ARBFNN
  - `C93YTVRE_E103`：6-DoF aircraft nonlinear dynamics(Complex Systems) motivates ARBFNN
