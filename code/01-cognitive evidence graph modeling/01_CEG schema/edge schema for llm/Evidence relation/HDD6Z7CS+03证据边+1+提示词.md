...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HDD6Z7CS_E134` | `motivates` | 09-Problem Scenario | noise vulnerability / uncertainty(Uncertainty) |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 2 | `HDD6Z7CS_E135` | `motivates` | 09-Problem Scenario | nonlinear feature fusion / dimensionality reduction(Other) |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 3 | `HDD6Z7CS_E136` | `motivates` | 12-Training Data Availability | 20 samples for each class, 16 samples for each class(Scarce) |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 4 | `HDD6Z7CS_E137` | `motivates` | 13-Noise Level | noise component in signals(High Noise) |  | 15-Data Preprocessing Algorithm | GHM neighborhood coefficients denoising |  |
| 5 | `HDD6Z7CS_E138` | `motivates` | 13-Noise Level | noise component in signals(High Noise) |  | 16-Feature Extraction Algorithm | AMWT |  |
| 6 | `HDD6Z7CS_E139` | `motivates` | 09-Problem Scenario | noise vulnerability / uncertainty(Uncertainty) |  | 15-Data Preprocessing Algorithm | GHM neighborhood coefficients denoising |  |
| 7 | `HDD6Z7CS_E140` | `motivates` | 09-Problem Scenario | nonlinear feature fusion / dimensionality reduction(Other) |  | 15-Data Preprocessing Algorithm | GHM neighborhood coefficients denoising |  |
| 8 | `HDD6Z7CS_E141` | `motivates` | 09-Problem Scenario | noise vulnerability / uncertainty(Uncertainty) |  | 16-Feature Extraction Algorithm | AMWT |  |
| 9 | `HDD6Z7CS_E142` | `motivates` | 09-Problem Scenario | nonlinear feature fusion / dimensionality reduction(Other) |  | 16-Feature Extraction Algorithm | AMWT |  |
| 10 | `HDD6Z7CS_E143` | `motivates` | 09-Problem Scenario | noise vulnerability / uncertainty(Uncertainty) |  | 17-Core Classifier Algorithm | K-medoids |  |
| 11 | `HDD6Z7CS_E144` | `motivates` | 09-Problem Scenario | nonlinear feature fusion / dimensionality reduction(Other) |  | 17-Core Classifier Algorithm | K-medoids |  |
| 12 | `HDD6Z7CS_E145` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | AMWT |  |
| 13 | `HDD6Z7CS_E146` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | K-medoids |  |
| 14 | `HDD6Z7CS_E147` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | K-medoids |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `HDD6Z7CS_E134`：noise vulnerability / uncertainty(Uncertainty) motivates Genetic Algorithm
  - `HDD6Z7CS_E135`：nonlinear feature fusion / dimensionality reduction(Other) motivates Genetic Algorithm
  - `HDD6Z7CS_E139`：noise vulnerability / uncertainty(Uncertainty) motivates GHM neighborhood coefficients denoising
  - `HDD6Z7CS_E140`：nonlinear feature fusion / dimensionality reduction(Other) motivates GHM neighborhood coefficients denoising
  - `HDD6Z7CS_E141`：noise vulnerability / uncertainty(Uncertainty) motivates AMWT
  - `HDD6Z7CS_E142`：nonlinear feature fusion / dimensionality reduction(Other) motivates AMWT
  - `HDD6Z7CS_E143`：noise vulnerability / uncertainty(Uncertainty) motivates K-medoids
  - `HDD6Z7CS_E144`：nonlinear feature fusion / dimensionality reduction(Other) motivates K-medoids
