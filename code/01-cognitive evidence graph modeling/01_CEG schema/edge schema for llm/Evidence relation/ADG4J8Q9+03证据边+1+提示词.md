...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ADG4J8Q9_E111` | `motivates` | 12-Training Data Availability | Sufficient |  | 18-Data Generation Algorithm | Coupled electromagnetic circuits model |  |
| 2 | `ADG4J8Q9_E112` | `motivates` | 13-Noise Level | eliminate supply harmonics(Normal) |  | 15-Data Preprocessing Algorithm | STFT |  |
| 3 | `ADG4J8Q9_E113` | `motivates` | 13-Noise Level | eliminate supply harmonics(Normal) |  | 16-Feature Extraction Algorithm | Spectral subtraction |  |
| 4 | `ADG4J8Q9_E114` | `motivates` | 09-Problem Scenario | detect them at an early stage / incipient fault detection(Early Degradation Prediction) |  | 18-Data Generation Algorithm | Coupled electromagnetic circuits model |  |
| 5 | `ADG4J8Q9_E115` | `motivates` | 09-Problem Scenario | detect them at an early stage / incipient fault detection(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | STFT |  |
| 6 | `ADG4J8Q9_E116` | `motivates` | 09-Problem Scenario | detect them at an early stage / incipient fault detection(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Spectral subtraction |  |
| 7 | `ADG4J8Q9_E117` | `motivates` | 09-Problem Scenario | detect them at an early stage / incipient fault detection(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Threshold decision |  |
| 8 | `ADG4J8Q9_E118` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Spectral subtraction |  |
| 9 | `ADG4J8Q9_E119` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold decision |  |
| 10 | `ADG4J8Q9_E120` | `motivates` | 06-Fault Severity | 10% static and mixed eccentricities(Single Severity) |  | 17-Core Classifier Algorithm | Threshold decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ADG4J8Q9_E114`：detect them at an early stage / incipient fault detection(Early Degradation Prediction) motivates Coupled electromagnetic circuits model
  - `ADG4J8Q9_E115`：detect them at an early stage / incipient fault detection(Early Degradation Prediction) motivates STFT
  - `ADG4J8Q9_E116`：detect them at an early stage / incipient fault detection(Early Degradation Prediction) motivates Spectral subtraction
  - `ADG4J8Q9_E117`：detect them at an early stage / incipient fault detection(Early Degradation Prediction) motivates Threshold decision
