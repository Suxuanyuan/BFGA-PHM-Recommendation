...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DNA5PWZ6_E136` | `motivates` | 13-Noise Level | noised dataset 2(High Noise) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 2 | `DNA5PWZ6_E137` | `motivates` | 13-Noise Level | noised dataset 2(High Noise) |  | 16-Feature Extraction Algorithm | LSTM |  |
| 3 | `DNA5PWZ6_E138` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 4 | `DNA5PWZ6_E139` | `motivates` | 09-Problem Scenario | black-box characteristics and lack of domain expertise limit interpretability(Trustworthiness / Interpretability) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 5 | `DNA5PWZ6_E140` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | LSTM |  |
| 6 | `DNA5PWZ6_E141` | `motivates` | 09-Problem Scenario | black-box characteristics and lack of domain expertise limit interpretability(Trustworthiness / Interpretability) |  | 16-Feature Extraction Algorithm | LSTM |  |
| 7 | `DNA5PWZ6_E142` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | FCNN |  |
| 8 | `DNA5PWZ6_E143` | `motivates` | 09-Problem Scenario | black-box characteristics and lack of domain expertise limit interpretability(Trustworthiness / Interpretability) |  | 17-Core Classifier Algorithm | FCNN |  |
| 9 | `DNA5PWZ6_E144` | `motivates` | 07-Compound Fault | one inner race faulted bearing and one outer race faulted bearing(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | LSTM |  |
| 10 | `DNA5PWZ6_E145` | `motivates` | 07-Compound Fault | one inner race faulted bearing and one outer race faulted bearing(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | FCNN |  |
| 11 | `DNA5PWZ6_E146` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | FCNN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `DNA5PWZ6_E138`：noise robustness(Uncertainty) motivates Sliding Window
  - `DNA5PWZ6_E139`：black-box characteristics and lack of domain expertise limit interpretability(Trustworthiness / Interpretability) motivates Sliding Window
  - `DNA5PWZ6_E140`：noise robustness(Uncertainty) motivates LSTM
  - `DNA5PWZ6_E141`：black-box characteristics and lack of domain expertise limit interpretability(Trustworthiness / Interpretability) motivates LSTM
  - `DNA5PWZ6_E142`：noise robustness(Uncertainty) motivates FCNN
  - `DNA5PWZ6_E143`：black-box characteristics and lack of domain expertise limit interpretability(Trustworthiness / Interpretability) motivates FCNN
