...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DZ5A5Q2R_E096` | `motivates` | 13-Noise Level | system noise / disturbances(High Noise) |  | 15-Data Preprocessing Algorithm | Hilbert Transform |  |
| 2 | `DZ5A5Q2R_E097` | `motivates` | 13-Noise Level | system noise / disturbances(High Noise) |  | 16-Feature Extraction Algorithm | Sparse Coding |  |
| 3 | `DZ5A5Q2R_E098` | `motivates` | 09-Problem Scenario | without training a large amount of sample data(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Hilbert Transform |  |
| 4 | `DZ5A5Q2R_E099` | `motivates` | 09-Problem Scenario | disturbances such as system noise, environmental temperature, vibration, and working current(Uncertainty) |  | 15-Data Preprocessing Algorithm | Hilbert Transform |  |
| 5 | `DZ5A5Q2R_E100` | `motivates` | 09-Problem Scenario | without training a large amount of sample data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Sparse Coding |  |
| 6 | `DZ5A5Q2R_E101` | `motivates` | 09-Problem Scenario | disturbances such as system noise, environmental temperature, vibration, and working current(Uncertainty) |  | 16-Feature Extraction Algorithm | Sparse Coding |  |
| 7 | `DZ5A5Q2R_E102` | `motivates` | 09-Problem Scenario | without training a large amount of sample data(Small Fault Samples) |  | 17-Core Classifier Algorithm | Exemplar-based Conditional Particle Filter |  |
| 8 | `DZ5A5Q2R_E103` | `motivates` | 09-Problem Scenario | disturbances such as system noise, environmental temperature, vibration, and working current(Uncertainty) |  | 17-Core Classifier Algorithm | Exemplar-based Conditional Particle Filter |  |
| 9 | `DZ5A5Q2R_E104` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Sparse Coding |  |
| 10 | `DZ5A5Q2R_E105` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Exemplar-based Conditional Particle Filter |  |
| 11 | `DZ5A5Q2R_E106` | `motivates` | 06-Fault Severity | component deviation(Multiple Severities) |  | 17-Core Classifier Algorithm | Exemplar-based Conditional Particle Filter |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `DZ5A5Q2R_E098`：without training a large amount of sample data(Small Fault Samples) motivates Hilbert Transform
  - `DZ5A5Q2R_E099`：disturbances such as system noise, environmental temperature, vibration, and working current(Uncertainty) motivates Hilbert Transform
  - `DZ5A5Q2R_E100`：without training a large amount of sample data(Small Fault Samples) motivates Sparse Coding
  - `DZ5A5Q2R_E101`：disturbances such as system noise, environmental temperature, vibration, and working current(Uncertainty) motivates Sparse Coding
  - `DZ5A5Q2R_E102`：without training a large amount of sample data(Small Fault Samples) motivates Exemplar-based Conditional Particle Filter
  - `DZ5A5Q2R_E103`：disturbances such as system noise, environmental temperature, vibration, and working current(Uncertainty) motivates Exemplar-based Conditional Particle Filter
