...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SPF2CXJZ_E087` | `motivates` | 13-Noise Level | noises and vibration(High Noise) |  | 15-Data Preprocessing Algorithm | Autocorrelation Function |  |
| 2 | `SPF2CXJZ_E088` | `motivates` | 13-Noise Level | noises and vibration(High Noise) |  | 16-Feature Extraction Algorithm | Discrete Wavelet Transform |  |
| 3 | `SPF2CXJZ_E089` | `motivates` | 09-Problem Scenario | compound faults(Compound Faults) |  | 15-Data Preprocessing Algorithm | Autocorrelation Function |  |
| 4 | `SPF2CXJZ_E090` | `motivates` | 09-Problem Scenario | compound faults(Compound Faults) |  | 16-Feature Extraction Algorithm | Discrete Wavelet Transform |  |
| 5 | `SPF2CXJZ_E091` | `motivates` | 09-Problem Scenario | compound faults(Compound Faults) |  | 17-Core Classifier Algorithm | Hilbert Transform |  |
| 6 | `SPF2CXJZ_E092` | `motivates` | 07-Compound Fault | rolling bearing compound faults(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Discrete Wavelet Transform |  |
| 7 | `SPF2CXJZ_E093` | `motivates` | 07-Compound Fault | rolling bearing compound faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Hilbert Transform |  |
| 8 | `SPF2CXJZ_E094` | `motivates` | 06-Fault Severity | cutting measurement was 0.2 mm(Single Severity) |  | 17-Core Classifier Algorithm | Hilbert Transform |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `SPF2CXJZ_E089`：compound faults(Compound Faults) motivates Autocorrelation Function
  - `SPF2CXJZ_E090`：compound faults(Compound Faults) motivates Discrete Wavelet Transform
  - `SPF2CXJZ_E091`：compound faults(Compound Faults) motivates Hilbert Transform
