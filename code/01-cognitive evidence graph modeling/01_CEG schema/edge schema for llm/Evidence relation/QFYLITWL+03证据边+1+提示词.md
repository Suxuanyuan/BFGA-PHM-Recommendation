...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QFYLITWL_E099` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 19-Training Optimization Algorithm | PSO |  |
| 2 | `QFYLITWL_E100` | `motivates` | 09-Problem Scenario | small sample learning(Small Fault Samples) |  | 19-Training Optimization Algorithm | PSO |  |
| 3 | `QFYLITWL_E101` | `motivates` | 12-Training Data Availability | small samples(Scarce) |  | 19-Training Optimization Algorithm | PSO |  |
| 4 | `QFYLITWL_E102` | `motivates` | 13-Noise Level | Gaussian white noise(High Noise) |  | 15-Data Preprocessing Algorithm | EMD |  |
| 5 | `QFYLITWL_E103` | `motivates` | 13-Noise Level | Gaussian white noise(High Noise) |  | 16-Feature Extraction Algorithm | SVD |  |
| 6 | `QFYLITWL_E104` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | EMD |  |
| 7 | `QFYLITWL_E105` | `motivates` | 09-Problem Scenario | small sample learning(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | EMD |  |
| 8 | `QFYLITWL_E106` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 16-Feature Extraction Algorithm | SVD |  |
| 9 | `QFYLITWL_E107` | `motivates` | 09-Problem Scenario | small sample learning(Small Fault Samples) |  | 16-Feature Extraction Algorithm | SVD |  |
| 10 | `QFYLITWL_E108` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 17-Core Classifier Algorithm | SVM |  |
| 11 | `QFYLITWL_E109` | `motivates` | 09-Problem Scenario | small sample learning(Small Fault Samples) |  | 17-Core Classifier Algorithm | SVM |  |
| 12 | `QFYLITWL_E110` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | SVD |  |
| 13 | `QFYLITWL_E111` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVM |  |
| 14 | `QFYLITWL_E112` | `motivates` | 06-Fault Severity | different broken degrees and different degumming areas(Multiple Severities) |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `QFYLITWL_E099`：noise interference(Uncertainty) motivates PSO
  - `QFYLITWL_E100`：small sample learning(Small Fault Samples) motivates PSO
  - `QFYLITWL_E104`：noise interference(Uncertainty) motivates EMD
  - `QFYLITWL_E105`：small sample learning(Small Fault Samples) motivates EMD
  - `QFYLITWL_E106`：noise interference(Uncertainty) motivates SVD
  - `QFYLITWL_E107`：small sample learning(Small Fault Samples) motivates SVD
  - `QFYLITWL_E108`：noise interference(Uncertainty) motivates SVM
  - `QFYLITWL_E109`：small sample learning(Small Fault Samples) motivates SVM
