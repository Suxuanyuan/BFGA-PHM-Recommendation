...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `E2JRQY2X_E098` | `motivates` | 13-Noise Level | noise on the current signals / noise on the current measurement(High Noise) |  | 15-Data Preprocessing Algorithm | PT1 filter |  |
| 2 | `E2JRQY2X_E099` | `motivates` | 13-Noise Level | noise on the current signals / noise on the current measurement(High Noise) |  | 16-Feature Extraction Algorithm | Coordinate transformation |  |
| 3 | `E2JRQY2X_E100` | `motivates` | 09-Problem Scenario | transient operation and rapid set point changes(Other) |  | 15-Data Preprocessing Algorithm | PT1 filter |  |
| 4 | `E2JRQY2X_E101` | `motivates` | 09-Problem Scenario | noise on the current signals(Uncertainty) |  | 15-Data Preprocessing Algorithm | PT1 filter |  |
| 5 | `E2JRQY2X_E102` | `motivates` | 09-Problem Scenario | transient operation and rapid set point changes(Other) |  | 16-Feature Extraction Algorithm | Coordinate transformation |  |
| 6 | `E2JRQY2X_E103` | `motivates` | 09-Problem Scenario | noise on the current signals(Uncertainty) |  | 16-Feature Extraction Algorithm | Coordinate transformation |  |
| 7 | `E2JRQY2X_E104` | `motivates` | 09-Problem Scenario | transient operation and rapid set point changes(Other) |  | 17-Core Classifier Algorithm | Additional voltage test |  |
| 8 | `E2JRQY2X_E105` | `motivates` | 09-Problem Scenario | noise on the current signals(Uncertainty) |  | 17-Core Classifier Algorithm | Additional voltage test |  |
| 9 | `E2JRQY2X_E106` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Coordinate transformation |  |
| 10 | `E2JRQY2X_E107` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Additional voltage test |  |
| 11 | `E2JRQY2X_E108` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Additional voltage test |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `E2JRQY2X_E100`：transient operation and rapid set point changes(Other) motivates PT1 filter
  - `E2JRQY2X_E101`：noise on the current signals(Uncertainty) motivates PT1 filter
  - `E2JRQY2X_E102`：transient operation and rapid set point changes(Other) motivates Coordinate transformation
  - `E2JRQY2X_E103`：noise on the current signals(Uncertainty) motivates Coordinate transformation
  - `E2JRQY2X_E104`：transient operation and rapid set point changes(Other) motivates Additional voltage test
  - `E2JRQY2X_E105`：noise on the current signals(Uncertainty) motivates Additional voltage test
