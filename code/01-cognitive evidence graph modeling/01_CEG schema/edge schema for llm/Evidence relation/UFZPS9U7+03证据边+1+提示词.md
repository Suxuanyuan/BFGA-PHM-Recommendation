...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `UFZPS9U7_E098` | `motivates` | 09-Problem Scenario | interference and background noise(Uncertainty) |  | 19-Training Optimization Algorithm | PSO |  |
| 2 | `UFZPS9U7_E099` | `motivates` | 09-Problem Scenario | early weak fault(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | PSO |  |
| 3 | `UFZPS9U7_E100` | `motivates` | 12-Training Data Availability | sampling points of 2048(Sufficient) |  | 19-Training Optimization Algorithm | PSO |  |
| 4 | `UFZPS9U7_E101` | `motivates` | 13-Noise Level | Gaussian white noise w with the intensity of -9db, interference(High Noise) |  | 15-Data Preprocessing Algorithm | FIR filter |  |
| 5 | `UFZPS9U7_E102` | `motivates` | 13-Noise Level | Gaussian white noise w with the intensity of -9db, interference(High Noise) |  | 16-Feature Extraction Algorithm | ATQWT |  |
| 6 | `UFZPS9U7_E103` | `motivates` | 09-Problem Scenario | interference and background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | FIR filter |  |
| 7 | `UFZPS9U7_E104` | `motivates` | 09-Problem Scenario | early weak fault(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | FIR filter |  |
| 8 | `UFZPS9U7_E105` | `motivates` | 09-Problem Scenario | interference and background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | ATQWT |  |
| 9 | `UFZPS9U7_E106` | `motivates` | 09-Problem Scenario | early weak fault(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | ATQWT |  |
| 10 | `UFZPS9U7_E107` | `motivates` | 09-Problem Scenario | interference and background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Hilbert transform |  |
| 11 | `UFZPS9U7_E108` | `motivates` | 09-Problem Scenario | early weak fault(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Hilbert transform |  |
| 12 | `UFZPS9U7_E109` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | ATQWT |  |
| 13 | `UFZPS9U7_E110` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Hilbert transform |  |
| 14 | `UFZPS9U7_E111` | `motivates` | 06-Fault Severity | 0.2 mm diameter(Single Severity) |  | 17-Core Classifier Algorithm | Hilbert transform |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `UFZPS9U7_E098`：interference and background noise(Uncertainty) motivates PSO
  - `UFZPS9U7_E099`：early weak fault(Early Degradation Prediction) motivates PSO
  - `UFZPS9U7_E103`：interference and background noise(Uncertainty) motivates FIR filter
  - `UFZPS9U7_E104`：early weak fault(Early Degradation Prediction) motivates FIR filter
  - `UFZPS9U7_E105`：interference and background noise(Uncertainty) motivates ATQWT
  - `UFZPS9U7_E106`：early weak fault(Early Degradation Prediction) motivates ATQWT
  - `UFZPS9U7_E107`：interference and background noise(Uncertainty) motivates Hilbert transform
  - `UFZPS9U7_E108`：early weak fault(Early Degradation Prediction) motivates Hilbert transform
