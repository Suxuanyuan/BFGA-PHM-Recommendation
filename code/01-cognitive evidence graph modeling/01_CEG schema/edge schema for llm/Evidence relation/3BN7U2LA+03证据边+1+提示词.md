...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3BN7U2LA_E144` | `motivates` | 09-Problem Scenario | different load conditions(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Grasshopper Optimisation Algorithm |  |
| 2 | `3BN7U2LA_E145` | `motivates` | 09-Problem Scenario | weak faults(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | Grasshopper Optimisation Algorithm |  |
| 3 | `3BN7U2LA_E146` | `motivates` | 12-Training Data Availability | training samples(Scarce) |  | 19-Training Optimization Algorithm | Grasshopper Optimisation Algorithm |  |
| 4 | `3BN7U2LA_E147` | `motivates` | 13-Noise Level | noise(Normal) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 5 | `3BN7U2LA_E148` | `motivates` | 13-Noise Level | noise(Normal) |  | 16-Feature Extraction Algorithm | Variational Mode Decomposition |  |
| 6 | `3BN7U2LA_E149` | `motivates` | 09-Problem Scenario | different load conditions(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 7 | `3BN7U2LA_E150` | `motivates` | 09-Problem Scenario | weak faults(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 8 | `3BN7U2LA_E151` | `motivates` | 09-Problem Scenario | different load conditions(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Variational Mode Decomposition |  |
| 9 | `3BN7U2LA_E152` | `motivates` | 09-Problem Scenario | weak faults(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Variational Mode Decomposition |  |
| 10 | `3BN7U2LA_E153` | `motivates` | 09-Problem Scenario | different load conditions(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Mixed Kernel Support Vector Machine |  |
| 11 | `3BN7U2LA_E154` | `motivates` | 09-Problem Scenario | weak faults(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Mixed Kernel Support Vector Machine |  |
| 12 | `3BN7U2LA_E155` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Variational Mode Decomposition |  |
| 13 | `3BN7U2LA_E156` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Mixed Kernel Support Vector Machine |  |
| 14 | `3BN7U2LA_E157` | `motivates` | 06-Fault Severity | damage diameter(Multiple Severities) |  | 17-Core Classifier Algorithm | Mixed Kernel Support Vector Machine |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `3BN7U2LA_E144`：different load conditions(Distribution Discrepancy) motivates Grasshopper Optimisation Algorithm
  - `3BN7U2LA_E145`：weak faults(Early Degradation Prediction) motivates Grasshopper Optimisation Algorithm
  - `3BN7U2LA_E149`：different load conditions(Distribution Discrepancy) motivates Min-Max Normalization
  - `3BN7U2LA_E150`：weak faults(Early Degradation Prediction) motivates Min-Max Normalization
  - `3BN7U2LA_E151`：different load conditions(Distribution Discrepancy) motivates Variational Mode Decomposition
  - `3BN7U2LA_E152`：weak faults(Early Degradation Prediction) motivates Variational Mode Decomposition
  - `3BN7U2LA_E153`：different load conditions(Distribution Discrepancy) motivates Mixed Kernel Support Vector Machine
  - `3BN7U2LA_E154`：weak faults(Early Degradation Prediction) motivates Mixed Kernel Support Vector Machine
