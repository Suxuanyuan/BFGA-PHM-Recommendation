...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `UNFGE37E_E096` | `motivates` | 09-Problem Scenario | computational complexity and parameter optimization of classifiers for real-time monitoring(Other) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 2 | `UNFGE37E_E097` | `motivates` | 12-Training Data Availability | 150 subsets as training samples(Sufficient) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 3 | `UNFGE37E_E098` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Wavelet Packet Transform |  |
| 4 | `UNFGE37E_E099` | `motivates` | 09-Problem Scenario | computational complexity and parameter optimization of classifiers for real-time monitoring(Other) |  | 16-Feature Extraction Algorithm | Wavelet Packet Transform |  |
| 5 | `UNFGE37E_E100` | `motivates` | 09-Problem Scenario | computational complexity and parameter optimization of classifiers for real-time monitoring(Other) |  | 17-Core Classifier Algorithm | Relevance Vector Machine |  |
| 6 | `UNFGE37E_E101` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Wavelet Packet Transform |  |
| 7 | `UNFGE37E_E102` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Relevance Vector Machine |  |
| 8 | `UNFGE37E_E103` | `motivates` | 06-Fault Severity | groove with 0.2 mm depth and 0.3 mm width(Single Severity) |  | 17-Core Classifier Algorithm | Relevance Vector Machine |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `UNFGE37E_E096`：computational complexity and parameter optimization of classifiers for real-time monitoring(Other) motivates Particle Swarm Optimization
  - `UNFGE37E_E099`：computational complexity and parameter optimization of classifiers for real-time monitoring(Other) motivates Wavelet Packet Transform
  - `UNFGE37E_E100`：computational complexity and parameter optimization of classifiers for real-time monitoring(Other) motivates Relevance Vector Machine
