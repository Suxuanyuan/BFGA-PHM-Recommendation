...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WXWGWZEG_E121` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Improved ITD |  |
| 2 | `WXWGWZEG_E122` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Improved FCBF |  |
| 3 | `WXWGWZEG_E123` | `motivates` | 09-Problem Scenario | cross-term interference of Wigner–Ville distribution and redundancy control problem of fast correlation-based filter(Other) |  | 15-Data Preprocessing Algorithm | Improved ITD |  |
| 4 | `WXWGWZEG_E124` | `motivates` | 09-Problem Scenario | cross-term interference of Wigner–Ville distribution and redundancy control problem of fast correlation-based filter(Other) |  | 16-Feature Extraction Algorithm | Improved FCBF |  |
| 5 | `WXWGWZEG_E125` | `motivates` | 09-Problem Scenario | cross-term interference of Wigner–Ville distribution and redundancy control problem of fast correlation-based filter(Other) |  | 17-Core Classifier Algorithm | PECOC-RVM |  |
| 6 | `WXWGWZEG_E126` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Improved FCBF |  |
| 7 | `WXWGWZEG_E127` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | PECOC-RVM |  |
| 8 | `WXWGWZEG_E128` | `motivates` | 06-Fault Severity | intake valve clearance of 0.45 mm, exhaust valve clearance of 0.7 mm(Single Severity) |  | 17-Core Classifier Algorithm | PECOC-RVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `WXWGWZEG_E123`：cross-term interference of Wigner–Ville distribution and redundancy control problem of fast correlation-based filter(Other) motivates Improved ITD
  - `WXWGWZEG_E124`：cross-term interference of Wigner–Ville distribution and redundancy control problem of fast correlation-based filter(Other) motivates Improved FCBF
  - `WXWGWZEG_E125`：cross-term interference of Wigner–Ville distribution and redundancy control problem of fast correlation-based filter(Other) motivates PECOC-RVM
