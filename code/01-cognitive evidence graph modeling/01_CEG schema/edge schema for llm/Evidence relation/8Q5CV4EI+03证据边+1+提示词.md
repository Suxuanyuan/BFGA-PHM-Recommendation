...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `8Q5CV4EI_E177` | `motivates` | 09-Problem Scenario | insufficient training data / weakly supervised target domain(Small Fault Samples) |  | 19-Training Optimization Algorithm | Domain Adversarial Training |  |
| 2 | `8Q5CV4EI_E178` | `motivates` | 09-Problem Scenario | domain shift / cross-machine transfer / different label spaces(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Domain Adversarial Training |  |
| 3 | `8Q5CV4EI_E179` | `motivates` | 12-Training Data Availability | insufficient training data, weakly supervised(Scarce) |  | 19-Training Optimization Algorithm | Domain Adversarial Training |  |
| 4 | `8Q5CV4EI_E180` | `motivates` | 13-Noise Level | additional Gaussian noises(High Noise) |  | 15-Data Preprocessing Algorithm | Gaussian Noise |  |
| 5 | `8Q5CV4EI_E181` | `motivates` | 13-Noise Level | additional Gaussian noises(High Noise) |  | 16-Feature Extraction Algorithm | CNN |  |
| 6 | `8Q5CV4EI_E182` | `motivates` | 09-Problem Scenario | insufficient training data / weakly supervised target domain(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Gaussian Noise |  |
| 7 | `8Q5CV4EI_E183` | `motivates` | 09-Problem Scenario | domain shift / cross-machine transfer / different label spaces(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Gaussian Noise |  |
| 8 | `8Q5CV4EI_E184` | `motivates` | 09-Problem Scenario | insufficient training data / weakly supervised target domain(Small Fault Samples) |  | 16-Feature Extraction Algorithm | CNN |  |
| 9 | `8Q5CV4EI_E185` | `motivates` | 09-Problem Scenario | domain shift / cross-machine transfer / different label spaces(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | CNN |  |
| 10 | `8Q5CV4EI_E186` | `motivates` | 09-Problem Scenario | insufficient training data / weakly supervised target domain(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `8Q5CV4EI_E187` | `motivates` | 09-Problem Scenario | domain shift / cross-machine transfer / different label spaces(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `8Q5CV4EI_E188` | `motivates` | 07-Compound Fault | Single crack with imbalance, Single crack with looseness(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | CNN |  |
| 13 | `8Q5CV4EI_E189` | `motivates` | 07-Compound Fault | Single crack with imbalance, Single crack with looseness(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `8Q5CV4EI_E190` | `motivates` | 06-Fault Severity | 7, 14, 21 mils; OF1-OF4; incipient, medium, severe; 2.5, 3.5, 5 mils(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `8Q5CV4EI_E177`：insufficient training data / weakly supervised target domain(Small Fault Samples) motivates Domain Adversarial Training
  - `8Q5CV4EI_E178`：domain shift / cross-machine transfer / different label spaces(Distribution Discrepancy) motivates Domain Adversarial Training
  - `8Q5CV4EI_E182`：insufficient training data / weakly supervised target domain(Small Fault Samples) motivates Gaussian Noise
  - `8Q5CV4EI_E183`：domain shift / cross-machine transfer / different label spaces(Distribution Discrepancy) motivates Gaussian Noise
  - `8Q5CV4EI_E184`：insufficient training data / weakly supervised target domain(Small Fault Samples) motivates CNN
  - `8Q5CV4EI_E185`：domain shift / cross-machine transfer / different label spaces(Distribution Discrepancy) motivates CNN
  - `8Q5CV4EI_E186`：insufficient training data / weakly supervised target domain(Small Fault Samples) motivates Softmax
  - `8Q5CV4EI_E187`：domain shift / cross-machine transfer / different label spaces(Distribution Discrepancy) motivates Softmax
