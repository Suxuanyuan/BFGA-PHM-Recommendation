...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZT7TB4PH_E125` | `motivates` | 09-Problem Scenario | weak fault features obscured by power frequency and noise interference(Uncertainty) |  | 19-Training Optimization Algorithm | Unsupervised pre-training |  |
| 2 | `ZT7TB4PH_E126` | `motivates` | 12-Training Data Availability | 170 samples in the dataset of each working condition were randomly selected for training(Sufficient) |  | 19-Training Optimization Algorithm | Unsupervised pre-training |  |
| 3 | `ZT7TB4PH_E127` | `motivates` | 13-Noise Level | Not mentioned(Normal) |  | 15-Data Preprocessing Algorithm | Time shifting |  |
| 4 | `ZT7TB4PH_E128` | `motivates` | 13-Noise Level | Not mentioned(Normal) |  | 16-Feature Extraction Algorithm | Restricted Boltzmann Machine |  |
| 5 | `ZT7TB4PH_E129` | `motivates` | 09-Problem Scenario | weak fault features obscured by power frequency and noise interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | Time shifting |  |
| 6 | `ZT7TB4PH_E130` | `motivates` | 09-Problem Scenario | weak fault features obscured by power frequency and noise interference(Uncertainty) |  | 16-Feature Extraction Algorithm | Restricted Boltzmann Machine |  |
| 7 | `ZT7TB4PH_E131` | `motivates` | 09-Problem Scenario | weak fault features obscured by power frequency and noise interference(Uncertainty) |  | 17-Core Classifier Algorithm | Deep Neural Network |  |
| 8 | `ZT7TB4PH_E132` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Restricted Boltzmann Machine |  |
| 9 | `ZT7TB4PH_E133` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Deep Neural Network |  |
| 10 | `ZT7TB4PH_E134` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Deep Neural Network |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZT7TB4PH_E125`：weak fault features obscured by power frequency and noise interference(Uncertainty) motivates Unsupervised pre-training
  - `ZT7TB4PH_E129`：weak fault features obscured by power frequency and noise interference(Uncertainty) motivates Time shifting
  - `ZT7TB4PH_E130`：weak fault features obscured by power frequency and noise interference(Uncertainty) motivates Restricted Boltzmann Machine
  - `ZT7TB4PH_E131`：weak fault features obscured by power frequency and noise interference(Uncertainty) motivates Deep Neural Network
