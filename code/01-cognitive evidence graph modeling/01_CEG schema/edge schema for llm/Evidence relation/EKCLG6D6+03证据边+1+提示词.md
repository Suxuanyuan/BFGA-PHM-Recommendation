...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `EKCLG6D6_E079` | `motivates` | 13-Noise Level | heavy surrounding noise, SNR -14 dB(High Noise) |  | 15-Data Preprocessing Algorithm | SVD |  |
| 2 | `EKCLG6D6_E080` | `motivates` | 13-Noise Level | heavy surrounding noise, SNR -14 dB(High Noise) |  | 16-Feature Extraction Algorithm | Hilbert Transform |  |
| 3 | `EKCLG6D6_E081` | `motivates` | 09-Problem Scenario | heavy surrounding noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | SVD |  |
| 4 | `EKCLG6D6_E082` | `motivates` | 09-Problem Scenario | incipient faults in the natural degradation process(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | SVD |  |
| 5 | `EKCLG6D6_E083` | `motivates` | 09-Problem Scenario | heavy surrounding noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Hilbert Transform |  |
| 6 | `EKCLG6D6_E084` | `motivates` | 09-Problem Scenario | incipient faults in the natural degradation process(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Hilbert Transform |  |
| 7 | `EKCLG6D6_E085` | `motivates` | 09-Problem Scenario | heavy surrounding noise(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Analysis |  |
| 8 | `EKCLG6D6_E086` | `motivates` | 09-Problem Scenario | incipient faults in the natural degradation process(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Envelope Analysis |  |
| 9 | `EKCLG6D6_E087` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Hilbert Transform |  |
| 10 | `EKCLG6D6_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope Analysis |  |
| 11 | `EKCLG6D6_E089` | `motivates` | 06-Fault Severity | natural degradation process(Multiple Severities) |  | 17-Core Classifier Algorithm | Envelope Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `EKCLG6D6_E081`：heavy surrounding noise(Uncertainty) motivates SVD
  - `EKCLG6D6_E082`：incipient faults in the natural degradation process(Early Degradation Prediction) motivates SVD
  - `EKCLG6D6_E083`：heavy surrounding noise(Uncertainty) motivates Hilbert Transform
  - `EKCLG6D6_E084`：incipient faults in the natural degradation process(Early Degradation Prediction) motivates Hilbert Transform
  - `EKCLG6D6_E085`：heavy surrounding noise(Uncertainty) motivates Envelope Analysis
  - `EKCLG6D6_E086`：incipient faults in the natural degradation process(Early Degradation Prediction) motivates Envelope Analysis
