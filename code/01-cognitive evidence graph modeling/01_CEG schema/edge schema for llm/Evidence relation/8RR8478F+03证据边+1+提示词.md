...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `8RR8478F_E089` | `motivates` | 13-Noise Level | Gauss white noise, strong noise(High Noise) |  | 15-Data Preprocessing Algorithm | Low-pass Filtering |  |
| 2 | `8RR8478F_E090` | `motivates` | 13-Noise Level | Gauss white noise, strong noise(High Noise) |  | 16-Feature Extraction Algorithm | Empirical Wavelet Transform |  |
| 3 | `8RR8478F_E091` | `motivates` | 09-Problem Scenario | accidental pulse and harmonic interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | Low-pass Filtering |  |
| 4 | `8RR8478F_E092` | `motivates` | 09-Problem Scenario | accidental pulse and harmonic interference(Uncertainty) |  | 16-Feature Extraction Algorithm | Empirical Wavelet Transform |  |
| 5 | `8RR8478F_E093` | `motivates` | 09-Problem Scenario | accidental pulse and harmonic interference(Uncertainty) |  | 17-Core Classifier Algorithm | Enfigram |  |
| 6 | `8RR8478F_E094` | `motivates` | 07-Compound Fault | Outer race fault signal with misalignment(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | Empirical Wavelet Transform |  |
| 7 | `8RR8478F_E095` | `motivates` | 07-Compound Fault | Outer race fault signal with misalignment(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | Enfigram |  |
| 8 | `8RR8478F_E096` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Enfigram |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `8RR8478F_E091`：accidental pulse and harmonic interference(Uncertainty) motivates Low-pass Filtering
  - `8RR8478F_E092`：accidental pulse and harmonic interference(Uncertainty) motivates Empirical Wavelet Transform
  - `8RR8478F_E093`：accidental pulse and harmonic interference(Uncertainty) motivates Enfigram
