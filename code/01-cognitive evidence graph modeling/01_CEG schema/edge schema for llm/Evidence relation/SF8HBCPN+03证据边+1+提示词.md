...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SF8HBCPN_E143` | `motivates` | 13-Noise Level | suppress noise(High Noise) |  | 15-Data Preprocessing Algorithm | Z-score normalization |  |
| 2 | `SF8HBCPN_E144` | `motivates` | 13-Noise Level | suppress noise(High Noise) |  | 16-Feature Extraction Algorithm | RSNet |  |
| 3 | `SF8HBCPN_E145` | `motivates` | 09-Problem Scenario | multi-channel raw vibration signals fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Z-score normalization |  |
| 4 | `SF8HBCPN_E146` | `motivates` | 09-Problem Scenario | compound faulty states(Compound Faults) |  | 15-Data Preprocessing Algorithm | Z-score normalization |  |
| 5 | `SF8HBCPN_E147` | `motivates` | 09-Problem Scenario | imbalance of data(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Z-score normalization |  |
| 6 | `SF8HBCPN_E148` | `motivates` | 09-Problem Scenario | multi-channel raw vibration signals fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | RSNet |  |
| 7 | `SF8HBCPN_E149` | `motivates` | 09-Problem Scenario | compound faulty states(Compound Faults) |  | 16-Feature Extraction Algorithm | RSNet |  |
| 8 | `SF8HBCPN_E150` | `motivates` | 09-Problem Scenario | imbalance of data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | RSNet |  |
| 9 | `SF8HBCPN_E151` | `motivates` | 09-Problem Scenario | multi-channel raw vibration signals fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | Fully Connected Layer |  |
| 10 | `SF8HBCPN_E152` | `motivates` | 09-Problem Scenario | compound faulty states(Compound Faults) |  | 17-Core Classifier Algorithm | Fully Connected Layer |  |
| 11 | `SF8HBCPN_E153` | `motivates` | 09-Problem Scenario | imbalance of data(Small Fault Samples) |  | 17-Core Classifier Algorithm | Fully Connected Layer |  |
| 12 | `SF8HBCPN_E154` | `motivates` | 07-Compound Fault | compound faulty states(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | RSNet |  |
| 13 | `SF8HBCPN_E155` | `motivates` | 07-Compound Fault | compound faulty states(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Fully Connected Layer |  |
| 14 | `SF8HBCPN_E156` | `motivates` | 06-Fault Severity | totally loses effectiveness(Single Severity) |  | 17-Core Classifier Algorithm | Fully Connected Layer |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `SF8HBCPN_E145`：multi-channel raw vibration signals fusion(Multi-Source Heterogeneous / Multimodal Data) motivates Z-score normalization
  - `SF8HBCPN_E146`：compound faulty states(Compound Faults) motivates Z-score normalization
  - `SF8HBCPN_E147`：imbalance of data(Small Fault Samples) motivates Z-score normalization
  - `SF8HBCPN_E148`：multi-channel raw vibration signals fusion(Multi-Source Heterogeneous / Multimodal Data) motivates RSNet
  - `SF8HBCPN_E149`：compound faulty states(Compound Faults) motivates RSNet
  - `SF8HBCPN_E150`：imbalance of data(Small Fault Samples) motivates RSNet
  - `SF8HBCPN_E151`：multi-channel raw vibration signals fusion(Multi-Source Heterogeneous / Multimodal Data) motivates Fully Connected Layer
  - `SF8HBCPN_E152`：compound faulty states(Compound Faults) motivates Fully Connected Layer
  - `SF8HBCPN_E153`：imbalance of data(Small Fault Samples) motivates Fully Connected Layer
