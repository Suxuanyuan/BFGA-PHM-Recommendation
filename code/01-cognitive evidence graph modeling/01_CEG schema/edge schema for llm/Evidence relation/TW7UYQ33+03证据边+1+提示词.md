...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TW7UYQ33_E098` | `motivates` | 09-Problem Scenario | Small sample numbers(Small Fault Samples) |  | 19-Training Optimization Algorithm | VPSO |  |
| 2 | `TW7UYQ33_E099` | `motivates` | 09-Problem Scenario | Distinguishing generator open-circuit faults from sensor faults(Other) |  | 19-Training Optimization Algorithm | VPSO |  |
| 3 | `TW7UYQ33_E100` | `motivates` | 12-Training Data Availability | 600 samples for three OCFs and 1000 samples for five single-phase OCFs(Sufficient) |  | 19-Training Optimization Algorithm | VPSO |  |
| 4 | `TW7UYQ33_E101` | `motivates` | 13-Noise Level | Gaussian white noise signal(High Noise) |  | 15-Data Preprocessing Algorithm | EMD |  |
| 5 | `TW7UYQ33_E102` | `motivates` | 13-Noise Level | Gaussian white noise signal(High Noise) |  | 16-Feature Extraction Algorithm | HT |  |
| 6 | `TW7UYQ33_E103` | `motivates` | 09-Problem Scenario | Small sample numbers(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | EMD |  |
| 7 | `TW7UYQ33_E104` | `motivates` | 09-Problem Scenario | Distinguishing generator open-circuit faults from sensor faults(Other) |  | 15-Data Preprocessing Algorithm | EMD |  |
| 8 | `TW7UYQ33_E105` | `motivates` | 09-Problem Scenario | Small sample numbers(Small Fault Samples) |  | 16-Feature Extraction Algorithm | HT |  |
| 9 | `TW7UYQ33_E106` | `motivates` | 09-Problem Scenario | Distinguishing generator open-circuit faults from sensor faults(Other) |  | 16-Feature Extraction Algorithm | HT |  |
| 10 | `TW7UYQ33_E107` | `motivates` | 09-Problem Scenario | Small sample numbers(Small Fault Samples) |  | 17-Core Classifier Algorithm | SVM |  |
| 11 | `TW7UYQ33_E108` | `motivates` | 09-Problem Scenario | Distinguishing generator open-circuit faults from sensor faults(Other) |  | 17-Core Classifier Algorithm | SVM |  |
| 12 | `TW7UYQ33_E109` | `motivates` | 07-Compound Fault | concurrent open-circuit faults(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | HT |  |
| 13 | `TW7UYQ33_E110` | `motivates` | 07-Compound Fault | concurrent open-circuit faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | SVM |  |
| 14 | `TW7UYQ33_E111` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `TW7UYQ33_E098`：Small sample numbers(Small Fault Samples) motivates VPSO
  - `TW7UYQ33_E099`：Distinguishing generator open-circuit faults from sensor faults(Other) motivates VPSO
  - `TW7UYQ33_E103`：Small sample numbers(Small Fault Samples) motivates EMD
  - `TW7UYQ33_E104`：Distinguishing generator open-circuit faults from sensor faults(Other) motivates EMD
  - `TW7UYQ33_E105`：Small sample numbers(Small Fault Samples) motivates HT
  - `TW7UYQ33_E106`：Distinguishing generator open-circuit faults from sensor faults(Other) motivates HT
  - `TW7UYQ33_E107`：Small sample numbers(Small Fault Samples) motivates SVM
  - `TW7UYQ33_E108`：Distinguishing generator open-circuit faults from sensor faults(Other) motivates SVM
