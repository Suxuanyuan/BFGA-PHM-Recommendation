...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `F9AYYCMG_E173` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | CADA-DE |  |
| 2 | `F9AYYCMG_E174` | `motivates` | 09-Problem Scenario | disturbances(Uncertainty) |  | 19-Training Optimization Algorithm | CADA-DE |  |
| 3 | `F9AYYCMG_E175` | `motivates` | 12-Training Data Availability | 400 samples for each category(Sufficient) |  | 19-Training Optimization Algorithm | CADA-DE |  |
| 4 | `F9AYYCMG_E176` | `motivates` | 13-Noise Level | disturbances in its vibration signals, strong interferences, white Gaussian noise(High Noise) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 5 | `F9AYYCMG_E177` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 6 | `F9AYYCMG_E178` | `motivates` | 09-Problem Scenario | disturbances(Uncertainty) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 7 | `F9AYYCMG_E179` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `F9AYYCMG_E180` | `motivates` | 09-Problem Scenario | disturbances(Uncertainty) |  | 17-Core Classifier Algorithm | Softmax |  |
| 9 | `F9AYYCMG_E181` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 10 | `F9AYYCMG_E182` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `F9AYYCMG_E183` | `motivates` | 06-Fault Severity | fault diameters (7 mils, 14 mils, 21 mils), fault extent (weak, moderate), bolt loosening (a single bolt, three bolts)(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `F9ZLCC7L_E156` | `motivates` | 09-Problem Scenario | online detection of novel faults(Zero Fault Samples) |  | 19-Training Optimization Algorithm | Differential Evolution |  |
| 13 | `F9ZLCC7L_E157` | `motivates` | 09-Problem Scenario | noise and outlier data(Uncertainty) |  | 19-Training Optimization Algorithm | Differential Evolution |  |
| 14 | `F9ZLCC7L_E158` | `motivates` | 12-Training Data Availability | 80 observations for each one of the six process states(Sufficient) |  | 19-Training Optimization Algorithm | Differential Evolution |  |
| 15 | `F9ZLCC7L_E159` | `motivates` | 13-Noise Level | 5% of noise level, 10% of noise level(High Noise) |  | 15-Data Preprocessing Algorithm | Density Oriented Fuzzy C-Means |  |
| 16 | `F9ZLCC7L_E160` | `motivates` | 09-Problem Scenario | online detection of novel faults(Zero Fault Samples) |  | 15-Data Preprocessing Algorithm | Density Oriented Fuzzy C-Means |  |
| 17 | `F9ZLCC7L_E161` | `motivates` | 09-Problem Scenario | noise and outlier data(Uncertainty) |  | 15-Data Preprocessing Algorithm | Density Oriented Fuzzy C-Means |  |
| 18 | `F9ZLCC7L_E162` | `motivates` | 09-Problem Scenario | online detection of novel faults(Zero Fault Samples) |  | 17-Core Classifier Algorithm | Kernel Fuzzy C-Means |  |
| 19 | `F9ZLCC7L_E163` | `motivates` | 09-Problem Scenario | noise and outlier data(Uncertainty) |  | 17-Core Classifier Algorithm | Kernel Fuzzy C-Means |  |
| 20 | `F9ZLCC7L_E164` | `motivates` | 07-Compound Fault | single fault(No Compound Fault) |  | 17-Core Classifier Algorithm | Kernel Fuzzy C-Means |  |
| 21 | `F9ZLCC7L_E165` | `motivates` | 06-Fault Severity | simulated faults(Single Severity) |  | 17-Core Classifier Algorithm | Kernel Fuzzy C-Means |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `F9AYYCMG_E173`：domain shift(Distribution Discrepancy) motivates CADA-DE
  - `F9AYYCMG_E174`：disturbances(Uncertainty) motivates CADA-DE
  - `F9AYYCMG_E177`：domain shift(Distribution Discrepancy) motivates 1DCNN
  - `F9AYYCMG_E178`：disturbances(Uncertainty) motivates 1DCNN
  - `F9AYYCMG_E179`：domain shift(Distribution Discrepancy) motivates Softmax
  - `F9AYYCMG_E180`：disturbances(Uncertainty) motivates Softmax
  - `F9ZLCC7L_E156`：online detection of novel faults(Zero Fault Samples) motivates Differential Evolution
  - `F9ZLCC7L_E157`：noise and outlier data(Uncertainty) motivates Differential Evolution
  - `F9ZLCC7L_E160`：online detection of novel faults(Zero Fault Samples) motivates Density Oriented Fuzzy C-Means
  - `F9ZLCC7L_E161`：noise and outlier data(Uncertainty) motivates Density Oriented Fuzzy C-Means
  - `F9ZLCC7L_E162`：online detection of novel faults(Zero Fault Samples) motivates Kernel Fuzzy C-Means
  - `F9ZLCC7L_E163`：noise and outlier data(Uncertainty) motivates Kernel Fuzzy C-Means
