...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3E2AVEX5_E108` | `motivates` | 09-Problem Scenario | small sample(Small Fault Samples) |  | 19-Training Optimization Algorithm | PLS |  |
| 2 | `3E2AVEX5_E109` | `motivates` | 09-Problem Scenario | noise pollution(Uncertainty) |  | 19-Training Optimization Algorithm | PLS |  |
| 3 | `3E2AVEX5_E110` | `motivates` | 12-Training Data Availability | small sample(Scarce) |  | 19-Training Optimization Algorithm | PLS |  |
| 4 | `3E2AVEX5_E111` | `motivates` | 13-Noise Level | noise pollution of acquired signals(High Noise) |  | 15-Data Preprocessing Algorithm | SVD |  |
| 5 | `3E2AVEX5_E112` | `motivates` | 13-Noise Level | noise pollution of acquired signals(High Noise) |  | 16-Feature Extraction Algorithm | EMD |  |
| 6 | `3E2AVEX5_E113` | `motivates` | 09-Problem Scenario | small sample(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | SVD |  |
| 7 | `3E2AVEX5_E114` | `motivates` | 09-Problem Scenario | noise pollution(Uncertainty) |  | 15-Data Preprocessing Algorithm | SVD |  |
| 8 | `3E2AVEX5_E115` | `motivates` | 09-Problem Scenario | small sample(Small Fault Samples) |  | 16-Feature Extraction Algorithm | EMD |  |
| 9 | `3E2AVEX5_E116` | `motivates` | 09-Problem Scenario | noise pollution(Uncertainty) |  | 16-Feature Extraction Algorithm | EMD |  |
| 10 | `3E2AVEX5_E117` | `motivates` | 09-Problem Scenario | small sample(Small Fault Samples) |  | 17-Core Classifier Algorithm | VPMCD |  |
| 11 | `3E2AVEX5_E118` | `motivates` | 09-Problem Scenario | noise pollution(Uncertainty) |  | 17-Core Classifier Algorithm | VPMCD |  |
| 12 | `3E2AVEX5_E119` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | EMD |  |
| 13 | `3E2AVEX5_E120` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | VPMCD |  |
| 14 | `3E2AVEX5_E121` | `motivates` | 06-Fault Severity | diameter of the fault point is 0.1778 mm, and the depth of the fault is 0.2794 mm(Single Severity) |  | 17-Core Classifier Algorithm | VPMCD |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `3E2AVEX5_E108`：small sample(Small Fault Samples) motivates PLS
  - `3E2AVEX5_E109`：noise pollution(Uncertainty) motivates PLS
  - `3E2AVEX5_E113`：small sample(Small Fault Samples) motivates SVD
  - `3E2AVEX5_E114`：noise pollution(Uncertainty) motivates SVD
  - `3E2AVEX5_E115`：small sample(Small Fault Samples) motivates EMD
  - `3E2AVEX5_E116`：noise pollution(Uncertainty) motivates EMD
  - `3E2AVEX5_E117`：small sample(Small Fault Samples) motivates VPMCD
  - `3E2AVEX5_E118`：noise pollution(Uncertainty) motivates VPMCD
