...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `JZBGEF67_E086` | `motivates` | 13-Noise Level | buried in noise(High Noise) |  | 15-Data Preprocessing Algorithm | Notch Filter |  |
| 2 | `JZBGEF67_E087` | `motivates` | 13-Noise Level | buried in noise(High Noise) |  | 16-Feature Extraction Algorithm | Power Spectrum |  |
| 3 | `JZBGEF67_E088` | `motivates` | 09-Problem Scenario | false positive detection and noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Notch Filter |  |
| 4 | `JZBGEF67_E089` | `motivates` | 09-Problem Scenario | false positive detection and noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Power Spectrum |  |
| 5 | `JZBGEF67_E090` | `motivates` | 09-Problem Scenario | false positive detection and noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 6 | `JZBGEF67_E091` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Power Spectrum |  |
| 7 | `JZBGEF67_E092` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 8 | `JZBGEF67_E093` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Threshold Decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `JZBGEF67_E088`：false positive detection and noise robustness(Uncertainty) motivates Notch Filter
  - `JZBGEF67_E089`：false positive detection and noise robustness(Uncertainty) motivates Power Spectrum
  - `JZBGEF67_E090`：false positive detection and noise robustness(Uncertainty) motivates Threshold Decision
