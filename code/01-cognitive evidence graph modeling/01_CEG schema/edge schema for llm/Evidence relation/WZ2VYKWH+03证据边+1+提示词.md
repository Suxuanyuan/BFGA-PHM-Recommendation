...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WZ2VYKWH_E095` | `motivates` | 13-Noise Level | 0 dB white noise, strong interference noise(High Noise) |  | 15-Data Preprocessing Algorithm | MSVMD |  |
| 2 | `WZ2VYKWH_E096` | `motivates` | 13-Noise Level | 0 dB white noise, strong interference noise(High Noise) |  | 16-Feature Extraction Algorithm | Envelope Analysis |  |
| 3 | `WZ2VYKWH_E097` | `motivates` | 09-Problem Scenario | multiple fault(Compound Faults) |  | 15-Data Preprocessing Algorithm | MSVMD |  |
| 4 | `WZ2VYKWH_E098` | `motivates` | 09-Problem Scenario | adaptive determination of VMD parameters(Other) |  | 15-Data Preprocessing Algorithm | MSVMD |  |
| 5 | `WZ2VYKWH_E099` | `motivates` | 09-Problem Scenario | multiple fault(Compound Faults) |  | 16-Feature Extraction Algorithm | Envelope Analysis |  |
| 6 | `WZ2VYKWH_E100` | `motivates` | 09-Problem Scenario | adaptive determination of VMD parameters(Other) |  | 16-Feature Extraction Algorithm | Envelope Analysis |  |
| 7 | `WZ2VYKWH_E101` | `motivates` | 09-Problem Scenario | multiple fault(Compound Faults) |  | 17-Core Classifier Algorithm | Fault Frequency Matching |  |
| 8 | `WZ2VYKWH_E102` | `motivates` | 09-Problem Scenario | adaptive determination of VMD parameters(Other) |  | 17-Core Classifier Algorithm | Fault Frequency Matching |  |
| 9 | `WZ2VYKWH_E103` | `motivates` | 07-Compound Fault | multiple fault(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Envelope Analysis |  |
| 10 | `WZ2VYKWH_E104` | `motivates` | 07-Compound Fault | multiple fault(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Fault Frequency Matching |  |
| 11 | `WZ2VYKWH_E105` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Fault Frequency Matching |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `WZ2VYKWH_E097`：multiple fault(Compound Faults) motivates MSVMD
  - `WZ2VYKWH_E098`：adaptive determination of VMD parameters(Other) motivates MSVMD
  - `WZ2VYKWH_E099`：multiple fault(Compound Faults) motivates Envelope Analysis
  - `WZ2VYKWH_E100`：adaptive determination of VMD parameters(Other) motivates Envelope Analysis
  - `WZ2VYKWH_E101`：multiple fault(Compound Faults) motivates Fault Frequency Matching
  - `WZ2VYKWH_E102`：adaptive determination of VMD parameters(Other) motivates Fault Frequency Matching
