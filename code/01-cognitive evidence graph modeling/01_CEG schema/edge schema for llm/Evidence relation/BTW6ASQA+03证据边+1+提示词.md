...
- **Reference ID**: BTW6ASQA
- **Paper Title**: Detection of a static eccentricity fault in a closed loop driven induction motor by using the angular domain order tracking analysis method
...
> **Input Material**: Reference ID `BTW6ASQA` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `BTW6ASQA_E080` | `motivates` | 13-Noise Level | high level noise(High Noise) |  | 15-Data Preprocessing Algorithm | Interpolation algorithm |  |
| 2 | `BTW6ASQA_E081` | `motivates` | 13-Noise Level | high level noise(High Noise) |  | 16-Feature Extraction Algorithm | Angular Domain Order Tracking |  |
| 3 | `BTW6ASQA_E082` | `motivates` | 09-Problem Scenario | high level noise and additional harmonics generated by inverter(Uncertainty) |  | 15-Data Preprocessing Algorithm | Interpolation algorithm |  |
| 4 | `BTW6ASQA_E083` | `motivates` | 09-Problem Scenario | frequency and amplitude changes of current under dynamic operating conditions(Other) |  | 15-Data Preprocessing Algorithm | Interpolation algorithm |  |
| 5 | `BTW6ASQA_E084` | `motivates` | 09-Problem Scenario | high level noise and additional harmonics generated by inverter(Uncertainty) |  | 16-Feature Extraction Algorithm | Angular Domain Order Tracking |  |
| 6 | `BTW6ASQA_E085` | `motivates` | 09-Problem Scenario | frequency and amplitude changes of current under dynamic operating conditions(Other) |  | 16-Feature Extraction Algorithm | Angular Domain Order Tracking |  |
| 7 | `BTW6ASQA_E086` | `motivates` | 09-Problem Scenario | high level noise and additional harmonics generated by inverter(Uncertainty) |  | 17-Core Classifier Algorithm | Order spectrum analysis |  |
| 8 | `BTW6ASQA_E087` | `motivates` | 09-Problem Scenario | frequency and amplitude changes of current under dynamic operating conditions(Other) |  | 17-Core Classifier Algorithm | Order spectrum analysis |  |
| 9 | `BTW6ASQA_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Angular Domain Order Tracking |  |
| 10 | `BTW6ASQA_E089` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Order spectrum analysis |  |
| 11 | `BTW6ASQA_E090` | `motivates` | 06-Fault Severity | eccentricity of around 40%(Single Severity) |  | 17-Core Classifier Algorithm | Order spectrum analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `BTW6ASQA_E082`：high level noise and additional harmonics generated by inverter(Uncertainty) motivates Interpolation algorithm
  - `BTW6ASQA_E083`：frequency and amplitude changes of current under dynamic operating conditions(Other) motivates Interpolation algorithm
  - `BTW6ASQA_E084`：high level noise and additional harmonics generated by inverter(Uncertainty) motivates Angular Domain Order Tracking
  - `BTW6ASQA_E085`：frequency and amplitude changes of current under dynamic operating conditions(Other) motivates Angular Domain Order Tracking
  - `BTW6ASQA_E086`：high level noise and additional harmonics generated by inverter(Uncertainty) motivates Order spectrum analysis
  - `BTW6ASQA_E087`：frequency and amplitude changes of current under dynamic operating conditions(Other) motivates Order spectrum analysis
