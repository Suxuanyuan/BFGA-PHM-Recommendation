...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `NVTVRI2T_E087` | `motivates` | 13-Noise Level | strong white Gaussian noise, strong noise(High Noise) |  | 15-Data Preprocessing Algorithm | Signal resampling |  |
| 2 | `NVTVRI2T_E088` | `motivates` | 13-Noise Level | strong white Gaussian noise, strong noise(High Noise) |  | 16-Feature Extraction Algorithm | I-ACMD |  |
| 3 | `NVTVRI2T_E089` | `motivates` | 09-Problem Scenario | complex gearbox configuration and close characteristic components(Complex Systems) |  | 15-Data Preprocessing Algorithm | Signal resampling |  |
| 4 | `NVTVRI2T_E090` | `motivates` | 09-Problem Scenario | strong noise and interference robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Signal resampling |  |
| 5 | `NVTVRI2T_E091` | `motivates` | 09-Problem Scenario | complex gearbox configuration and close characteristic components(Complex Systems) |  | 16-Feature Extraction Algorithm | I-ACMD |  |
| 6 | `NVTVRI2T_E092` | `motivates` | 09-Problem Scenario | strong noise and interference robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | I-ACMD |  |
| 7 | `NVTVRI2T_E093` | `motivates` | 09-Problem Scenario | complex gearbox configuration and close characteristic components(Complex Systems) |  | 17-Core Classifier Algorithm | GCF identification |  |
| 8 | `NVTVRI2T_E094` | `motivates` | 09-Problem Scenario | strong noise and interference robustness(Uncertainty) |  | 17-Core Classifier Algorithm | GCF identification |  |
| 9 | `NVTVRI2T_E095` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | I-ACMD |  |
| 10 | `NVTVRI2T_E096` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | GCF identification |  |
| 11 | `NVTVRI2T_E097` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | GCF identification |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `NVTVRI2T_E089`：complex gearbox configuration and close characteristic components(Complex Systems) motivates Signal resampling
  - `NVTVRI2T_E090`：strong noise and interference robustness(Uncertainty) motivates Signal resampling
  - `NVTVRI2T_E091`：complex gearbox configuration and close characteristic components(Complex Systems) motivates I-ACMD
  - `NVTVRI2T_E092`：strong noise and interference robustness(Uncertainty) motivates I-ACMD
  - `NVTVRI2T_E093`：complex gearbox configuration and close characteristic components(Complex Systems) motivates GCF identification
  - `NVTVRI2T_E094`：strong noise and interference robustness(Uncertainty) motivates GCF identification
