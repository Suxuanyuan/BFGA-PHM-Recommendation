...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `L8FXEVZQ_E108` | `motivates` | 09-Problem Scenario | composite bearing faults(Compound Faults) |  | 19-Training Optimization Algorithm | Inexact ALM |  |
| 2 | `L8FXEVZQ_E109` | `motivates` | 09-Problem Scenario | submerged by surrounding noises(Uncertainty) |  | 19-Training Optimization Algorithm | Inexact ALM |  |
| 3 | `L8FXEVZQ_E110` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Inexact ALM |  |
| 4 | `L8FXEVZQ_E111` | `motivates` | 13-Noise Level | submerged by surrounding noises in practical engineering situations(High Noise) |  | 15-Data Preprocessing Algorithm | STFT |  |
| 5 | `L8FXEVZQ_E112` | `motivates` | 13-Noise Level | submerged by surrounding noises in practical engineering situations(High Noise) |  | 16-Feature Extraction Algorithm | Low-rank and sparse decomposition |  |
| 6 | `L8FXEVZQ_E113` | `motivates` | 09-Problem Scenario | composite bearing faults(Compound Faults) |  | 15-Data Preprocessing Algorithm | STFT |  |
| 7 | `L8FXEVZQ_E114` | `motivates` | 09-Problem Scenario | submerged by surrounding noises(Uncertainty) |  | 15-Data Preprocessing Algorithm | STFT |  |
| 8 | `L8FXEVZQ_E115` | `motivates` | 09-Problem Scenario | composite bearing faults(Compound Faults) |  | 16-Feature Extraction Algorithm | Low-rank and sparse decomposition |  |
| 9 | `L8FXEVZQ_E116` | `motivates` | 09-Problem Scenario | submerged by surrounding noises(Uncertainty) |  | 16-Feature Extraction Algorithm | Low-rank and sparse decomposition |  |
| 10 | `L8FXEVZQ_E117` | `motivates` | 09-Problem Scenario | composite bearing faults(Compound Faults) |  | 17-Core Classifier Algorithm | Convolutive Fast-ICA |  |
| 11 | `L8FXEVZQ_E118` | `motivates` | 09-Problem Scenario | submerged by surrounding noises(Uncertainty) |  | 17-Core Classifier Algorithm | Convolutive Fast-ICA |  |
| 12 | `L8FXEVZQ_E119` | `motivates` | 07-Compound Fault | composite bearing vibration signals(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Low-rank and sparse decomposition |  |
| 13 | `L8FXEVZQ_E120` | `motivates` | 07-Compound Fault | composite bearing vibration signals(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Convolutive Fast-ICA |  |
| 14 | `L8FXEVZQ_E121` | `motivates` | 06-Fault Severity | 0.5 mm (width) * 0.15 mm (depth)(Single Severity) |  | 17-Core Classifier Algorithm | Convolutive Fast-ICA |  |
| 15 | `L8YJQ56E_E115` | `motivates` | 09-Problem Scenario | timeliness of the data chunk(Other) |  | 19-Training Optimization Algorithm | Memory Principle |  |
| 16 | `L8YJQ56E_E116` | `motivates` | 09-Problem Scenario | working operation often changes across a wide range(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Memory Principle |  |
| 17 | `L8YJQ56E_E117` | `motivates` | 12-Training Data Availability | Double-shaft turbofan component level model simulation(Sufficient) |  | 19-Training Optimization Algorithm | Memory Principle |  |
| 18 | `L8YJQ56E_E118` | `motivates` | 13-Noise Level | Gaussian with the standard deviation being 0.30%(High Noise) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 19 | `L8YJQ56E_E119` | `motivates` | 09-Problem Scenario | timeliness of the data chunk(Other) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 20 | `L8YJQ56E_E120` | `motivates` | 09-Problem Scenario | working operation often changes across a wide range(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 21 | `L8YJQ56E_E121` | `motivates` | 09-Problem Scenario | timeliness of the data chunk(Other) |  | 17-Core Classifier Algorithm | MOS-ELM |  |
| 22 | `L8YJQ56E_E122` | `motivates` | 09-Problem Scenario | working operation often changes across a wide range(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | MOS-ELM |  |
| 23 | `L8YJQ56E_E123` | `motivates` | 07-Compound Fault | dual fault modes(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | MOS-ELM |  |
| 24 | `L8YJQ56E_E124` | `motivates` | 06-Fault Severity | bias fault magnitude of 3%, drift magnitude of 0%–4%(Multiple Severities) |  | 17-Core Classifier Algorithm | MOS-ELM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `L8FXEVZQ_E108`：composite bearing faults(Compound Faults) motivates Inexact ALM
  - `L8FXEVZQ_E109`：submerged by surrounding noises(Uncertainty) motivates Inexact ALM
  - `L8FXEVZQ_E113`：composite bearing faults(Compound Faults) motivates STFT
  - `L8FXEVZQ_E114`：submerged by surrounding noises(Uncertainty) motivates STFT
  - `L8FXEVZQ_E115`：composite bearing faults(Compound Faults) motivates Low-rank and sparse decomposition
  - `L8FXEVZQ_E116`：submerged by surrounding noises(Uncertainty) motivates Low-rank and sparse decomposition
  - `L8FXEVZQ_E117`：composite bearing faults(Compound Faults) motivates Convolutive Fast-ICA
  - `L8FXEVZQ_E118`：submerged by surrounding noises(Uncertainty) motivates Convolutive Fast-ICA
  - `L8YJQ56E_E115`：timeliness of the data chunk(Other) motivates Memory Principle
  - `L8YJQ56E_E116`：working operation often changes across a wide range(Distribution Discrepancy) motivates Memory Principle
  - `L8YJQ56E_E119`：timeliness of the data chunk(Other) motivates Min-Max Normalization
  - `L8YJQ56E_E120`：working operation often changes across a wide range(Distribution Discrepancy) motivates Min-Max Normalization
  - `L8YJQ56E_E121`：timeliness of the data chunk(Other) motivates MOS-ELM
  - `L8YJQ56E_E122`：working operation often changes across a wide range(Distribution Discrepancy) motivates MOS-ELM
