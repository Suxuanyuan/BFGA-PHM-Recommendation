...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TRYNYIJ9_E114` | `motivates` | 13-Noise Level | extra anomaly disturbance, noise(High Noise) |  | 15-Data Preprocessing Algorithm | Outlier detection |  |
| 2 | `TRYNYIJ9_E115` | `motivates` | 13-Noise Level | extra anomaly disturbance, noise(High Noise) |  | 16-Feature Extraction Algorithm | PCA |  |
| 3 | `TRYNYIJ9_E116` | `motivates` | 09-Problem Scenario | without learning data obtained in various abnormal states(Zero Fault Samples) |  | 15-Data Preprocessing Algorithm | Outlier detection |  |
| 4 | `TRYNYIJ9_E117` | `motivates` | 09-Problem Scenario | signal quality check (sensor disengagement, noise, instability)(Uncertainty) |  | 15-Data Preprocessing Algorithm | Outlier detection |  |
| 5 | `TRYNYIJ9_E118` | `motivates` | 09-Problem Scenario | without learning data obtained in various abnormal states(Zero Fault Samples) |  | 16-Feature Extraction Algorithm | PCA |  |
| 6 | `TRYNYIJ9_E119` | `motivates` | 09-Problem Scenario | signal quality check (sensor disengagement, noise, instability)(Uncertainty) |  | 16-Feature Extraction Algorithm | PCA |  |
| 7 | `TRYNYIJ9_E120` | `motivates` | 09-Problem Scenario | without learning data obtained in various abnormal states(Zero Fault Samples) |  | 17-Core Classifier Algorithm | Trivalent logic diagnosis theory |  |
| 8 | `TRYNYIJ9_E121` | `motivates` | 09-Problem Scenario | signal quality check (sensor disengagement, noise, instability)(Uncertainty) |  | 17-Core Classifier Algorithm | Trivalent logic diagnosis theory |  |
| 9 | `TRYNYIJ9_E122` | `motivates` | 07-Compound Fault | looseness and unbalance composite fault(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | PCA |  |
| 10 | `TRYNYIJ9_E123` | `motivates` | 07-Compound Fault | looseness and unbalance composite fault(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Trivalent logic diagnosis theory |  |
| 11 | `TRYNYIJ9_E124` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Trivalent logic diagnosis theory |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `TRYNYIJ9_E116`：without learning data obtained in various abnormal states(Zero Fault Samples) motivates Outlier detection
  - `TRYNYIJ9_E117`：signal quality check (sensor disengagement, noise, instability)(Uncertainty) motivates Outlier detection
  - `TRYNYIJ9_E118`：without learning data obtained in various abnormal states(Zero Fault Samples) motivates PCA
  - `TRYNYIJ9_E119`：signal quality check (sensor disengagement, noise, instability)(Uncertainty) motivates PCA
  - `TRYNYIJ9_E120`：without learning data obtained in various abnormal states(Zero Fault Samples) motivates Trivalent logic diagnosis theory
  - `TRYNYIJ9_E121`：signal quality check (sensor disengagement, noise, instability)(Uncertainty) motivates Trivalent logic diagnosis theory
