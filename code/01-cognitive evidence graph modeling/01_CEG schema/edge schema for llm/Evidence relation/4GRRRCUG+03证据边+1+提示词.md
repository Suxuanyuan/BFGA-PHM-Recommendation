...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4GRRRCUG_E071` | `motivates` | 13-Noise Level | heavily polluted by the severe background noises(High Noise) |  | 15-Data Preprocessing Algorithm | Local Mean Decomposition |  |
| 2 | `4GRRRCUG_E072` | `motivates` | 13-Noise Level | heavily polluted by the severe background noises(High Noise) |  | 16-Feature Extraction Algorithm | Fourier Transform |  |
| 3 | `4GRRRCUG_E073` | `motivates` | 09-Problem Scenario | background noises(Uncertainty) |  | 15-Data Preprocessing Algorithm | Local Mean Decomposition |  |
| 4 | `4GRRRCUG_E074` | `motivates` | 09-Problem Scenario | background noises(Uncertainty) |  | 16-Feature Extraction Algorithm | Fourier Transform |  |
| 5 | `4GRRRCUG_E075` | `motivates` | 09-Problem Scenario | background noises(Uncertainty) |  | 17-Core Classifier Algorithm | Shaft Center Orbit |  |
| 6 | `4GRRRCUG_E076` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Fourier Transform |  |
| 7 | `4GRRRCUG_E077` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Shaft Center Orbit |  |
| 8 | `4GRRRCUG_E078` | `motivates` | 06-Fault Severity | slight rub-impact fault(Single Severity) |  | 17-Core Classifier Algorithm | Shaft Center Orbit |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4GRRRCUG_E073`：background noises(Uncertainty) motivates Local Mean Decomposition
  - `4GRRRCUG_E074`：background noises(Uncertainty) motivates Fourier Transform
  - `4GRRRCUG_E075`：background noises(Uncertainty) motivates Shaft Center Orbit
