...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WUWBXYI3_E113` | `motivates` | 09-Problem Scenario | Noise interference and low SNR(Uncertainty) |  | 19-Training Optimization Algorithm | PDT |  |
| 2 | `WUWBXYI3_E114` | `motivates` | 09-Problem Scenario | Dependency on prior fault period and speed fluctuations(Other) |  | 19-Training Optimization Algorithm | PDT |  |
| 3 | `WUWBXYI3_E115` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | PDT |  |
| 4 | `WUWBXYI3_E116` | `motivates` | 13-Noise Level | background noise and other interferences(High Noise) |  | 15-Data Preprocessing Algorithm | Hilbert Transform |  |
| 5 | `WUWBXYI3_E117` | `motivates` | 13-Noise Level | background noise and other interferences(High Noise) |  | 16-Feature Extraction Algorithm | CYCBD |  |
| 6 | `WUWBXYI3_E118` | `motivates` | 09-Problem Scenario | Noise interference and low SNR(Uncertainty) |  | 15-Data Preprocessing Algorithm | Hilbert Transform |  |
| 7 | `WUWBXYI3_E119` | `motivates` | 09-Problem Scenario | Dependency on prior fault period and speed fluctuations(Other) |  | 15-Data Preprocessing Algorithm | Hilbert Transform |  |
| 8 | `WUWBXYI3_E120` | `motivates` | 09-Problem Scenario | Noise interference and low SNR(Uncertainty) |  | 16-Feature Extraction Algorithm | CYCBD |  |
| 9 | `WUWBXYI3_E121` | `motivates` | 09-Problem Scenario | Dependency on prior fault period and speed fluctuations(Other) |  | 16-Feature Extraction Algorithm | CYCBD |  |
| 10 | `WUWBXYI3_E122` | `motivates` | 09-Problem Scenario | Noise interference and low SNR(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 11 | `WUWBXYI3_E123` | `motivates` | 09-Problem Scenario | Dependency on prior fault period and speed fluctuations(Other) |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 12 | `WUWBXYI3_E124` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CYCBD |  |
| 13 | `WUWBXYI3_E125` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 14 | `WUWBXYI3_E126` | `motivates` | 06-Fault Severity | depth of 0.2 mm and a width of 0.6 mm(Single Severity) |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `WUWBXYI3_E113`：Noise interference and low SNR(Uncertainty) motivates PDT
  - `WUWBXYI3_E114`：Dependency on prior fault period and speed fluctuations(Other) motivates PDT
  - `WUWBXYI3_E118`：Noise interference and low SNR(Uncertainty) motivates Hilbert Transform
  - `WUWBXYI3_E119`：Dependency on prior fault period and speed fluctuations(Other) motivates Hilbert Transform
  - `WUWBXYI3_E120`：Noise interference and low SNR(Uncertainty) motivates CYCBD
  - `WUWBXYI3_E121`：Dependency on prior fault period and speed fluctuations(Other) motivates CYCBD
  - `WUWBXYI3_E122`：Noise interference and low SNR(Uncertainty) motivates Envelope Spectrum Analysis
  - `WUWBXYI3_E123`：Dependency on prior fault period and speed fluctuations(Other) motivates Envelope Spectrum Analysis
