...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VZSBCRJY_E087` | `motivates` | 13-Noise Level | Gaussian noise, strong noise(High Noise) |  | 15-Data Preprocessing Algorithm | Welch's method |  |
| 2 | `VZSBCRJY_E088` | `motivates` | 13-Noise Level | Gaussian noise, strong noise(High Noise) |  | 16-Feature Extraction Algorithm | ACEWT |  |
| 3 | `VZSBCRJY_E089` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Welch's method |  |
| 4 | `VZSBCRJY_E090` | `motivates` | 09-Problem Scenario | modal aliasing and invalid boundary division of EWT in complex spectrum(Other) |  | 15-Data Preprocessing Algorithm | Welch's method |  |
| 5 | `VZSBCRJY_E091` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | ACEWT |  |
| 6 | `VZSBCRJY_E092` | `motivates` | 09-Problem Scenario | modal aliasing and invalid boundary division of EWT in complex spectrum(Other) |  | 16-Feature Extraction Algorithm | ACEWT |  |
| 7 | `VZSBCRJY_E093` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Hilbert envelope demodulation |  |
| 8 | `VZSBCRJY_E094` | `motivates` | 09-Problem Scenario | modal aliasing and invalid boundary division of EWT in complex spectrum(Other) |  | 17-Core Classifier Algorithm | Hilbert envelope demodulation |  |
| 9 | `VZSBCRJY_E095` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | ACEWT |  |
| 10 | `VZSBCRJY_E096` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Hilbert envelope demodulation |  |
| 11 | `VZSBCRJY_E097` | `motivates` | 06-Fault Severity | width of 0.5 mm and a depth of 0.15 mm, width of 0.3 mm and a depth of 0.05 mm(Single Severity) |  | 17-Core Classifier Algorithm | Hilbert envelope demodulation |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `VZSBCRJY_E089`：noise robustness(Uncertainty) motivates Welch's method
  - `VZSBCRJY_E090`：modal aliasing and invalid boundary division of EWT in complex spectrum(Other) motivates Welch's method
  - `VZSBCRJY_E091`：noise robustness(Uncertainty) motivates ACEWT
  - `VZSBCRJY_E092`：modal aliasing and invalid boundary division of EWT in complex spectrum(Other) motivates ACEWT
  - `VZSBCRJY_E093`：noise robustness(Uncertainty) motivates Hilbert envelope demodulation
  - `VZSBCRJY_E094`：modal aliasing and invalid boundary division of EWT in complex spectrum(Other) motivates Hilbert envelope demodulation
