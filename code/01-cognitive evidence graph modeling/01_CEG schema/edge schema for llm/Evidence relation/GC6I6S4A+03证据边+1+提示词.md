...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `GC6I6S4A_E089` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Global Analytical Redundancy Relations |  |
| 2 | `GC6I6S4A_E090` | `motivates` | 09-Problem Scenario | multiple discrete faults(Compound Faults) |  | 16-Feature Extraction Algorithm | Global Analytical Redundancy Relations |  |
| 3 | `GC6I6S4A_E091` | `motivates` | 09-Problem Scenario | hybrid systems(Complex Systems) |  | 16-Feature Extraction Algorithm | Global Analytical Redundancy Relations |  |
| 4 | `GC6I6S4A_E092` | `motivates` | 09-Problem Scenario | multiple discrete faults(Compound Faults) |  | 17-Core Classifier Algorithm | Mode Diagnoser |  |
| 5 | `GC6I6S4A_E093` | `motivates` | 09-Problem Scenario | hybrid systems(Complex Systems) |  | 17-Core Classifier Algorithm | Mode Diagnoser |  |
| 6 | `GC6I6S4A_E094` | `motivates` | 07-Compound Fault | multiple discrete faults(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | Global Analytical Redundancy Relations |  |
| 7 | `GC6I6S4A_E095` | `motivates` | 07-Compound Fault | multiple discrete faults(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | Mode Diagnoser |  |
| 8 | `GC6I6S4A_E096` | `motivates` | 06-Fault Severity | 5% change in parameter Em0(Single Severity) |  | 17-Core Classifier Algorithm | Mode Diagnoser |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `GC6I6S4A_E090`：multiple discrete faults(Compound Faults) motivates Global Analytical Redundancy Relations
  - `GC6I6S4A_E091`：hybrid systems(Complex Systems) motivates Global Analytical Redundancy Relations
  - `GC6I6S4A_E092`：multiple discrete faults(Compound Faults) motivates Mode Diagnoser
  - `GC6I6S4A_E093`：hybrid systems(Complex Systems) motivates Mode Diagnoser
