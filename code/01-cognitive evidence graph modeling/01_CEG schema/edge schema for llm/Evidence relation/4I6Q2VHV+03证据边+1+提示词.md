...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4I6Q2VHV_E108` | `motivates` | 09-Problem Scenario | small-scale dataset(Small Fault Samples) |  | 19-Training Optimization Algorithm | Transfer learning |  |
| 2 | `4I6Q2VHV_E109` | `motivates` | 09-Problem Scenario | transfer learning across different loads(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Transfer learning |  |
| 3 | `4I6Q2VHV_E110` | `motivates` | 12-Training Data Availability | small-scale dataset(Scarce) |  | 19-Training Optimization Algorithm | Transfer learning |  |
| 4 | `4I6Q2VHV_E111` | `motivates` | 13-Noise Level | Gaussian noise(High Noise) |  | 15-Data Preprocessing Algorithm | Overlap sampling |  |
| 5 | `4I6Q2VHV_E112` | `motivates` | 13-Noise Level | Gaussian noise(High Noise) |  | 16-Feature Extraction Algorithm | DCNN |  |
| 6 | `4I6Q2VHV_E113` | `motivates` | 09-Problem Scenario | small-scale dataset(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Overlap sampling |  |
| 7 | `4I6Q2VHV_E114` | `motivates` | 09-Problem Scenario | transfer learning across different loads(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Overlap sampling |  |
| 8 | `4I6Q2VHV_E115` | `motivates` | 09-Problem Scenario | small-scale dataset(Small Fault Samples) |  | 16-Feature Extraction Algorithm | DCNN |  |
| 9 | `4I6Q2VHV_E116` | `motivates` | 09-Problem Scenario | transfer learning across different loads(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | DCNN |  |
| 10 | `4I6Q2VHV_E117` | `motivates` | 09-Problem Scenario | small-scale dataset(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `4I6Q2VHV_E118` | `motivates` | 09-Problem Scenario | transfer learning across different loads(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `4I6Q2VHV_E119` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | DCNN |  |
| 13 | `4I6Q2VHV_E120` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `4I6Q2VHV_E121` | `motivates` | 06-Fault Severity | 0.007 inch, 0.014 inch, 0.021 inch(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4I6Q2VHV_E108`：small-scale dataset(Small Fault Samples) motivates Transfer learning
  - `4I6Q2VHV_E109`：transfer learning across different loads(Distribution Discrepancy) motivates Transfer learning
  - `4I6Q2VHV_E113`：small-scale dataset(Small Fault Samples) motivates Overlap sampling
  - `4I6Q2VHV_E114`：transfer learning across different loads(Distribution Discrepancy) motivates Overlap sampling
  - `4I6Q2VHV_E115`：small-scale dataset(Small Fault Samples) motivates DCNN
  - `4I6Q2VHV_E116`：transfer learning across different loads(Distribution Discrepancy) motivates DCNN
  - `4I6Q2VHV_E117`：small-scale dataset(Small Fault Samples) motivates Softmax
  - `4I6Q2VHV_E118`：transfer learning across different loads(Distribution Discrepancy) motivates Softmax
