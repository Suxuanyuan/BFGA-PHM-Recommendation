...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `9U7TKXTP_E109` | `motivates` | 09-Problem Scenario | MMC contains a large number of SMs(Complex Systems) |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 2 | `9U7TKXTP_E110` | `motivates` | 09-Problem Scenario | frequency aliasing of current harmonic signals(Other) |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 3 | `9U7TKXTP_E111` | `motivates` | 12-Training Data Availability | 180 training samples per class(Sufficient) |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 4 | `9U7TKXTP_E112` | `motivates` | 13-Noise Level | denoise the collected raw signals(High Noise) |  | 15-Data Preprocessing Algorithm | Wavelet threshold denoise |  |
| 5 | `9U7TKXTP_E113` | `motivates` | 13-Noise Level | denoise the collected raw signals(High Noise) |  | 16-Feature Extraction Algorithm | Synchrosqueezing transform |  |
| 6 | `9U7TKXTP_E114` | `motivates` | 09-Problem Scenario | MMC contains a large number of SMs(Complex Systems) |  | 15-Data Preprocessing Algorithm | Wavelet threshold denoise |  |
| 7 | `9U7TKXTP_E115` | `motivates` | 09-Problem Scenario | frequency aliasing of current harmonic signals(Other) |  | 15-Data Preprocessing Algorithm | Wavelet threshold denoise |  |
| 8 | `9U7TKXTP_E116` | `motivates` | 09-Problem Scenario | MMC contains a large number of SMs(Complex Systems) |  | 16-Feature Extraction Algorithm | Synchrosqueezing transform |  |
| 9 | `9U7TKXTP_E117` | `motivates` | 09-Problem Scenario | frequency aliasing of current harmonic signals(Other) |  | 16-Feature Extraction Algorithm | Synchrosqueezing transform |  |
| 10 | `9U7TKXTP_E118` | `motivates` | 09-Problem Scenario | MMC contains a large number of SMs(Complex Systems) |  | 17-Core Classifier Algorithm | DCNN |  |
| 11 | `9U7TKXTP_E119` | `motivates` | 09-Problem Scenario | frequency aliasing of current harmonic signals(Other) |  | 17-Core Classifier Algorithm | DCNN |  |
| 12 | `9U7TKXTP_E120` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Synchrosqueezing transform |  |
| 13 | `9U7TKXTP_E121` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | DCNN |  |
| 14 | `9U7TKXTP_E122` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | DCNN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `9U7TKXTP_E109`：MMC contains a large number of SMs(Complex Systems) motivates Genetic Algorithm
  - `9U7TKXTP_E110`：frequency aliasing of current harmonic signals(Other) motivates Genetic Algorithm
  - `9U7TKXTP_E114`：MMC contains a large number of SMs(Complex Systems) motivates Wavelet threshold denoise
  - `9U7TKXTP_E115`：frequency aliasing of current harmonic signals(Other) motivates Wavelet threshold denoise
  - `9U7TKXTP_E116`：MMC contains a large number of SMs(Complex Systems) motivates Synchrosqueezing transform
  - `9U7TKXTP_E117`：frequency aliasing of current harmonic signals(Other) motivates Synchrosqueezing transform
  - `9U7TKXTP_E118`：MMC contains a large number of SMs(Complex Systems) motivates DCNN
  - `9U7TKXTP_E119`：frequency aliasing of current harmonic signals(Other) motivates DCNN
