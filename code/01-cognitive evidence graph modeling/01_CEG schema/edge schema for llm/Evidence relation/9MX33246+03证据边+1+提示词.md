...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `9MX33246_E108` | `motivates` | 09-Problem Scenario | environmental noises(Uncertainty) |  | 19-Training Optimization Algorithm | Adaptive Beetle Antennae Search |  |
| 2 | `9MX33246_E109` | `motivates` | 09-Problem Scenario | multiple operating conditions(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Adaptive Beetle Antennae Search |  |
| 3 | `9MX33246_E110` | `motivates` | 12-Training Data Availability | 200 training samples per state(Sufficient) |  | 19-Training Optimization Algorithm | Adaptive Beetle Antennae Search |  |
| 4 | `9MX33246_E111` | `motivates` | 13-Noise Level | white Gaussian noise (WGN) with SNR ranging from -10 dB to 40 dB(High Noise) |  | 15-Data Preprocessing Algorithm | Spectral Graph Wavelet Transform |  |
| 5 | `9MX33246_E112` | `motivates` | 13-Noise Level | white Gaussian noise (WGN) with SNR ranging from -10 dB to 40 dB(High Noise) |  | 16-Feature Extraction Algorithm | Multiscale Symbolic Dynamic Entropy |  |
| 6 | `9MX33246_E113` | `motivates` | 09-Problem Scenario | environmental noises(Uncertainty) |  | 15-Data Preprocessing Algorithm | Spectral Graph Wavelet Transform |  |
| 7 | `9MX33246_E114` | `motivates` | 09-Problem Scenario | multiple operating conditions(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Spectral Graph Wavelet Transform |  |
| 8 | `9MX33246_E115` | `motivates` | 09-Problem Scenario | environmental noises(Uncertainty) |  | 16-Feature Extraction Algorithm | Multiscale Symbolic Dynamic Entropy |  |
| 9 | `9MX33246_E116` | `motivates` | 09-Problem Scenario | multiple operating conditions(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Multiscale Symbolic Dynamic Entropy |  |
| 10 | `9MX33246_E117` | `motivates` | 09-Problem Scenario | environmental noises(Uncertainty) |  | 17-Core Classifier Algorithm | Random Forest |  |
| 11 | `9MX33246_E118` | `motivates` | 09-Problem Scenario | multiple operating conditions(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Random Forest |  |
| 12 | `9MX33246_E119` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Multiscale Symbolic Dynamic Entropy |  |
| 13 | `9MX33246_E120` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Random Forest |  |
| 14 | `9MX33246_E121` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Random Forest |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `9MX33246_E108`：environmental noises(Uncertainty) motivates Adaptive Beetle Antennae Search
  - `9MX33246_E109`：multiple operating conditions(Distribution Discrepancy) motivates Adaptive Beetle Antennae Search
  - `9MX33246_E113`：environmental noises(Uncertainty) motivates Spectral Graph Wavelet Transform
  - `9MX33246_E114`：multiple operating conditions(Distribution Discrepancy) motivates Spectral Graph Wavelet Transform
  - `9MX33246_E115`：environmental noises(Uncertainty) motivates Multiscale Symbolic Dynamic Entropy
  - `9MX33246_E116`：multiple operating conditions(Distribution Discrepancy) motivates Multiscale Symbolic Dynamic Entropy
  - `9MX33246_E117`：environmental noises(Uncertainty) motivates Random Forest
  - `9MX33246_E118`：multiple operating conditions(Distribution Discrepancy) motivates Random Forest
