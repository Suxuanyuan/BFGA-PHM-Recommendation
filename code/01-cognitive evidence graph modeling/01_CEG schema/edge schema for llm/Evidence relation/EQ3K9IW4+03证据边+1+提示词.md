...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `EQ3K9IW4_E095` | `motivates` | 09-Problem Scenario | nonlinear and nonstationary characteristics of rolling bearing vibration signals(Other) |  | 19-Training Optimization Algorithm | PSO |  |
| 2 | `EQ3K9IW4_E096` | `motivates` | 09-Problem Scenario | high-dimensional feature vectors containing redundant information(Other) |  | 19-Training Optimization Algorithm | PSO |  |
| 3 | `EQ3K9IW4_E097` | `motivates` | 12-Training Data Availability | 20 groups of training samples(Scarce) |  | 19-Training Optimization Algorithm | PSO |  |
| 4 | `EQ3K9IW4_E098` | `motivates` | 13-Noise Level | nonlinear and nonstationary characteristics(Normal) |  | 15-Data Preprocessing Algorithm | CEEMDAN |  |
| 5 | `EQ3K9IW4_E099` | `motivates` | 13-Noise Level | nonlinear and nonstationary characteristics(Normal) |  | 16-Feature Extraction Algorithm | RCMFE |  |
| 6 | `EQ3K9IW4_E100` | `motivates` | 09-Problem Scenario | nonlinear and nonstationary characteristics of rolling bearing vibration signals(Other) |  | 15-Data Preprocessing Algorithm | CEEMDAN |  |
| 7 | `EQ3K9IW4_E101` | `motivates` | 09-Problem Scenario | high-dimensional feature vectors containing redundant information(Other) |  | 15-Data Preprocessing Algorithm | CEEMDAN |  |
| 8 | `EQ3K9IW4_E102` | `motivates` | 09-Problem Scenario | nonlinear and nonstationary characteristics of rolling bearing vibration signals(Other) |  | 16-Feature Extraction Algorithm | RCMFE |  |
| 9 | `EQ3K9IW4_E103` | `motivates` | 09-Problem Scenario | high-dimensional feature vectors containing redundant information(Other) |  | 16-Feature Extraction Algorithm | RCMFE |  |
| 10 | `EQ3K9IW4_E104` | `motivates` | 09-Problem Scenario | nonlinear and nonstationary characteristics of rolling bearing vibration signals(Other) |  | 17-Core Classifier Algorithm | PNN |  |
| 11 | `EQ3K9IW4_E105` | `motivates` | 09-Problem Scenario | high-dimensional feature vectors containing redundant information(Other) |  | 17-Core Classifier Algorithm | PNN |  |
| 12 | `EQ3K9IW4_E106` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | RCMFE |  |
| 13 | `EQ3K9IW4_E107` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | PNN |  |
| 14 | `EQ3K9IW4_E108` | `motivates` | 06-Fault Severity | fault diameters are 0.1778, 0.3556, and 0.5334 mm; fault diameter is 0.2 mm(Multiple Severities) |  | 17-Core Classifier Algorithm | PNN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `EQ3K9IW4_E095`：nonlinear and nonstationary characteristics of rolling bearing vibration signals(Other) motivates PSO
  - `EQ3K9IW4_E096`：high-dimensional feature vectors containing redundant information(Other) motivates PSO
  - `EQ3K9IW4_E100`：nonlinear and nonstationary characteristics of rolling bearing vibration signals(Other) motivates CEEMDAN
  - `EQ3K9IW4_E101`：high-dimensional feature vectors containing redundant information(Other) motivates CEEMDAN
  - `EQ3K9IW4_E102`：nonlinear and nonstationary characteristics of rolling bearing vibration signals(Other) motivates RCMFE
  - `EQ3K9IW4_E103`：high-dimensional feature vectors containing redundant information(Other) motivates RCMFE
  - `EQ3K9IW4_E104`：nonlinear and nonstationary characteristics of rolling bearing vibration signals(Other) motivates PNN
  - `EQ3K9IW4_E105`：high-dimensional feature vectors containing redundant information(Other) motivates PNN
