...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `EMCTCATD_E093` | `motivates` | 13-Noise Level | Gaussian white noise at a SNR of 3 dB(High Noise) |  | 15-Data Preprocessing Algorithm | Iterative Generalized Demodulation |  |
| 2 | `EMCTCATD_E094` | `motivates` | 13-Noise Level | Gaussian white noise at a SNR of 3 dB(High Noise) |  | 16-Feature Extraction Algorithm | Time-Frequency Reassignment |  |
| 3 | `EMCTCATD_E095` | `motivates` | 09-Problem Scenario | intricate mechanical kinematics and modulation sidebands(Complex Systems) |  | 15-Data Preprocessing Algorithm | Iterative Generalized Demodulation |  |
| 4 | `EMCTCATD_E096` | `motivates` | 09-Problem Scenario | nonstationary conditions with time-varying running speed and load(Other) |  | 15-Data Preprocessing Algorithm | Iterative Generalized Demodulation |  |
| 5 | `EMCTCATD_E097` | `motivates` | 09-Problem Scenario | intricate mechanical kinematics and modulation sidebands(Complex Systems) |  | 16-Feature Extraction Algorithm | Time-Frequency Reassignment |  |
| 6 | `EMCTCATD_E098` | `motivates` | 09-Problem Scenario | nonstationary conditions with time-varying running speed and load(Other) |  | 16-Feature Extraction Algorithm | Time-Frequency Reassignment |  |
| 7 | `EMCTCATD_E099` | `motivates` | 09-Problem Scenario | intricate mechanical kinematics and modulation sidebands(Complex Systems) |  | 17-Core Classifier Algorithm | Iterative Generalized Time-Frequency Reassignment |  |
| 8 | `EMCTCATD_E100` | `motivates` | 09-Problem Scenario | nonstationary conditions with time-varying running speed and load(Other) |  | 17-Core Classifier Algorithm | Iterative Generalized Time-Frequency Reassignment |  |
| 9 | `EMCTCATD_E101` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Time-Frequency Reassignment |  |
| 10 | `EMCTCATD_E102` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Iterative Generalized Time-Frequency Reassignment |  |
| 11 | `EMCTCATD_E103` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Iterative Generalized Time-Frequency Reassignment |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `EMCTCATD_E095`：intricate mechanical kinematics and modulation sidebands(Complex Systems) motivates Iterative Generalized Demodulation
  - `EMCTCATD_E096`：nonstationary conditions with time-varying running speed and load(Other) motivates Iterative Generalized Demodulation
  - `EMCTCATD_E097`：intricate mechanical kinematics and modulation sidebands(Complex Systems) motivates Time-Frequency Reassignment
  - `EMCTCATD_E098`：nonstationary conditions with time-varying running speed and load(Other) motivates Time-Frequency Reassignment
  - `EMCTCATD_E099`：intricate mechanical kinematics and modulation sidebands(Complex Systems) motivates Iterative Generalized Time-Frequency Reassignment
  - `EMCTCATD_E100`：nonstationary conditions with time-varying running speed and load(Other) motivates Iterative Generalized Time-Frequency Reassignment
