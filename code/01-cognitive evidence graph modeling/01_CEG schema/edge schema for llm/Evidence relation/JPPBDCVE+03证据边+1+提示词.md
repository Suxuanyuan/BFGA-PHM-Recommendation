...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `JPPBDCVE_E091` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | High-pass filter |  |
| 2 | `JPPBDCVE_E092` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Frame transformation |  |
| 3 | `JPPBDCVE_E093` | `motivates` | 09-Problem Scenario | early stage turn fault detection(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | High-pass filter |  |
| 4 | `JPPBDCVE_E094` | `motivates` | 09-Problem Scenario | rotor saliency harmonics interference(Other) |  | 15-Data Preprocessing Algorithm | High-pass filter |  |
| 5 | `JPPBDCVE_E095` | `motivates` | 09-Problem Scenario | load dependency and parameter variation uncertainty(Uncertainty) |  | 15-Data Preprocessing Algorithm | High-pass filter |  |
| 6 | `JPPBDCVE_E096` | `motivates` | 09-Problem Scenario | early stage turn fault detection(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Frame transformation |  |
| 7 | `JPPBDCVE_E097` | `motivates` | 09-Problem Scenario | rotor saliency harmonics interference(Other) |  | 16-Feature Extraction Algorithm | Frame transformation |  |
| 8 | `JPPBDCVE_E098` | `motivates` | 09-Problem Scenario | load dependency and parameter variation uncertainty(Uncertainty) |  | 16-Feature Extraction Algorithm | Frame transformation |  |
| 9 | `JPPBDCVE_E099` | `motivates` | 09-Problem Scenario | early stage turn fault detection(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Threshold decision |  |
| 10 | `JPPBDCVE_E100` | `motivates` | 09-Problem Scenario | rotor saliency harmonics interference(Other) |  | 17-Core Classifier Algorithm | Threshold decision |  |
| 11 | `JPPBDCVE_E101` | `motivates` | 09-Problem Scenario | load dependency and parameter variation uncertainty(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold decision |  |
| 12 | `JPPBDCVE_E102` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Frame transformation |  |
| 13 | `JPPBDCVE_E103` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold decision |  |
| 14 | `JPPBDCVE_E104` | `motivates` | 06-Fault Severity | 1%, 2% and 5% turn-to-turn short per phase(Multiple Severities) |  | 17-Core Classifier Algorithm | Threshold decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `JPPBDCVE_E093`：early stage turn fault detection(Early Degradation Prediction) motivates High-pass filter
  - `JPPBDCVE_E094`：rotor saliency harmonics interference(Other) motivates High-pass filter
  - `JPPBDCVE_E095`：load dependency and parameter variation uncertainty(Uncertainty) motivates High-pass filter
  - `JPPBDCVE_E096`：early stage turn fault detection(Early Degradation Prediction) motivates Frame transformation
  - `JPPBDCVE_E097`：rotor saliency harmonics interference(Other) motivates Frame transformation
  - `JPPBDCVE_E098`：load dependency and parameter variation uncertainty(Uncertainty) motivates Frame transformation
  - `JPPBDCVE_E099`：early stage turn fault detection(Early Degradation Prediction) motivates Threshold decision
  - `JPPBDCVE_E100`：rotor saliency harmonics interference(Other) motivates Threshold decision
  - `JPPBDCVE_E101`：load dependency and parameter variation uncertainty(Uncertainty) motivates Threshold decision
