...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4TLZIMY3_E079` | `motivates` | 09-Problem Scenario | noises and interferences from different sources(Uncertainty) |  | 19-Training Optimization Algorithm | Modified Bidirectional Search |  |
| 2 | `4TLZIMY3_E080` | `motivates` | 09-Problem Scenario | selection of dominant features and optimum ELM parameters(Other) |  | 19-Training Optimization Algorithm | Modified Bidirectional Search |  |
| 3 | `4TLZIMY3_E081` | `motivates` | 12-Training Data Availability | vibration data sets(Sufficient) |  | 19-Training Optimization Algorithm | Modified Bidirectional Search |  |
| 4 | `4TLZIMY3_E082` | `motivates` | 13-Noise Level | noises and interferences(Normal) |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 5 | `4TLZIMY3_E083` | `motivates` | 09-Problem Scenario | noises and interferences from different sources(Uncertainty) |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 6 | `4TLZIMY3_E084` | `motivates` | 09-Problem Scenario | selection of dominant features and optimum ELM parameters(Other) |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 7 | `4TLZIMY3_E085` | `motivates` | 09-Problem Scenario | noises and interferences from different sources(Uncertainty) |  | 17-Core Classifier Algorithm | Extreme Learning Machine |  |
| 8 | `4TLZIMY3_E086` | `motivates` | 09-Problem Scenario | selection of dominant features and optimum ELM parameters(Other) |  | 17-Core Classifier Algorithm | Extreme Learning Machine |  |
| 9 | `4TLZIMY3_E087` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 10 | `4TLZIMY3_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Extreme Learning Machine |  |
| 11 | `4TLZIMY3_E089` | `motivates` | 06-Fault Severity | Multiple Severities |  | 17-Core Classifier Algorithm | Extreme Learning Machine |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4TLZIMY3_E079`：noises and interferences from different sources(Uncertainty) motivates Modified Bidirectional Search
  - `4TLZIMY3_E080`：selection of dominant features and optimum ELM parameters(Other) motivates Modified Bidirectional Search
  - `4TLZIMY3_E083`：noises and interferences from different sources(Uncertainty) motivates Spectral Kurtosis
  - `4TLZIMY3_E084`：selection of dominant features and optimum ELM parameters(Other) motivates Spectral Kurtosis
  - `4TLZIMY3_E085`：noises and interferences from different sources(Uncertainty) motivates Extreme Learning Machine
  - `4TLZIMY3_E086`：selection of dominant features and optimum ELM parameters(Other) motivates Extreme Learning Machine
