...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PRKTNAZI_E117` | `motivates` | 09-Problem Scenario | domain shift / distribution discrepancy(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Domain Adversarial Training |  |
| 2 | `PRKTNAZI_E118` | `motivates` | 09-Problem Scenario | noise contamination(Uncertainty) |  | 19-Training Optimization Algorithm | Domain Adversarial Training |  |
| 3 | `PRKTNAZI_E119` | `motivates` | 09-Problem Scenario | compound faults(Compound Faults) |  | 19-Training Optimization Algorithm | Domain Adversarial Training |  |
| 4 | `PRKTNAZI_E120` | `motivates` | 12-Training Data Availability | labelled source samples and unlabeled target samples(Sufficient) |  | 19-Training Optimization Algorithm | Domain Adversarial Training |  |
| 5 | `PRKTNAZI_E121` | `motivates` | 13-Noise Level | Gaussian white noise(High Noise) |  | 16-Feature Extraction Algorithm | CNN |  |
| 6 | `PRKTNAZI_E122` | `motivates` | 09-Problem Scenario | domain shift / distribution discrepancy(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | CNN |  |
| 7 | `PRKTNAZI_E123` | `motivates` | 09-Problem Scenario | noise contamination(Uncertainty) |  | 16-Feature Extraction Algorithm | CNN |  |
| 8 | `PRKTNAZI_E124` | `motivates` | 09-Problem Scenario | compound faults(Compound Faults) |  | 16-Feature Extraction Algorithm | CNN |  |
| 9 | `PRKTNAZI_E125` | `motivates` | 09-Problem Scenario | domain shift / distribution discrepancy(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 10 | `PRKTNAZI_E126` | `motivates` | 09-Problem Scenario | noise contamination(Uncertainty) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `PRKTNAZI_E127` | `motivates` | 09-Problem Scenario | compound faults(Compound Faults) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `PRKTNAZI_E128` | `motivates` | 07-Compound Fault | compound faults combining gears and bearings(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | CNN |  |
| 13 | `PRKTNAZI_E129` | `motivates` | 07-Compound Fault | compound faults combining gears and bearings(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `PRKTNAZI_E130` | `motivates` | 06-Fault Severity | defect diameters of 0.5 mm and 2 mm, 0.2mm defect(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `PRKTNAZI_E117`：domain shift / distribution discrepancy(Distribution Discrepancy) motivates Domain Adversarial Training
  - `PRKTNAZI_E118`：noise contamination(Uncertainty) motivates Domain Adversarial Training
  - `PRKTNAZI_E119`：compound faults(Compound Faults) motivates Domain Adversarial Training
  - `PRKTNAZI_E122`：domain shift / distribution discrepancy(Distribution Discrepancy) motivates CNN
  - `PRKTNAZI_E123`：noise contamination(Uncertainty) motivates CNN
  - `PRKTNAZI_E124`：compound faults(Compound Faults) motivates CNN
  - `PRKTNAZI_E125`：domain shift / distribution discrepancy(Distribution Discrepancy) motivates Softmax
  - `PRKTNAZI_E126`：noise contamination(Uncertainty) motivates Softmax
  - `PRKTNAZI_E127`：compound faults(Compound Faults) motivates Softmax
