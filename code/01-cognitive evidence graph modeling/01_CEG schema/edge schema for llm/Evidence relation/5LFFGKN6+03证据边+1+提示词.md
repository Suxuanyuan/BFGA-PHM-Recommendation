...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `5LFFGKN6_E113` | `motivates` | 09-Problem Scenario | distribution shift(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Unilateral Alignment |  |
| 2 | `5LFFGKN6_E114` | `motivates` | 09-Problem Scenario | missing classes in the target training dataset(Zero Fault Samples) |  | 19-Training Optimization Algorithm | Unilateral Alignment |  |
| 3 | `5LFFGKN6_E115` | `motivates` | 12-Training Data Availability | divide each it into 200 sequences(Sufficient) |  | 19-Training Optimization Algorithm | Unilateral Alignment |  |
| 4 | `5LFFGKN6_E116` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Fast Fourier Transform |  |
| 5 | `5LFFGKN6_E117` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | CNN |  |
| 6 | `5LFFGKN6_E118` | `motivates` | 09-Problem Scenario | distribution shift(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Fast Fourier Transform |  |
| 7 | `5LFFGKN6_E119` | `motivates` | 09-Problem Scenario | missing classes in the target training dataset(Zero Fault Samples) |  | 15-Data Preprocessing Algorithm | Fast Fourier Transform |  |
| 8 | `5LFFGKN6_E120` | `motivates` | 09-Problem Scenario | distribution shift(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | CNN |  |
| 9 | `5LFFGKN6_E121` | `motivates` | 09-Problem Scenario | missing classes in the target training dataset(Zero Fault Samples) |  | 16-Feature Extraction Algorithm | CNN |  |
| 10 | `5LFFGKN6_E122` | `motivates` | 09-Problem Scenario | distribution shift(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `5LFFGKN6_E123` | `motivates` | 09-Problem Scenario | missing classes in the target training dataset(Zero Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `5LFFGKN6_E124` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 13 | `5LFFGKN6_E125` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `5LFFGKN6_E126` | `motivates` | 06-Fault Severity | 7, 14, 21 mils(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `5LFFGKN6_E113`：distribution shift(Distribution Discrepancy) motivates Unilateral Alignment
  - `5LFFGKN6_E114`：missing classes in the target training dataset(Zero Fault Samples) motivates Unilateral Alignment
  - `5LFFGKN6_E118`：distribution shift(Distribution Discrepancy) motivates Fast Fourier Transform
  - `5LFFGKN6_E119`：missing classes in the target training dataset(Zero Fault Samples) motivates Fast Fourier Transform
  - `5LFFGKN6_E120`：distribution shift(Distribution Discrepancy) motivates CNN
  - `5LFFGKN6_E121`：missing classes in the target training dataset(Zero Fault Samples) motivates CNN
  - `5LFFGKN6_E122`：distribution shift(Distribution Discrepancy) motivates Softmax
  - `5LFFGKN6_E123`：missing classes in the target training dataset(Zero Fault Samples) motivates Softmax
