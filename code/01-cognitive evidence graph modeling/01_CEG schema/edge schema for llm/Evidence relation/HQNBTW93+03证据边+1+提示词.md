...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HQNBTW93_E106` | `motivates` | 09-Problem Scenario | early detection of faults / incipient defects(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | Differential evolution |  |
| 2 | `HQNBTW93_E107` | `motivates` | 09-Problem Scenario | noise robustness / vibration signal tainted by noise(Uncertainty) |  | 19-Training Optimization Algorithm | Differential evolution |  |
| 3 | `HQNBTW93_E108` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Differential evolution |  |
| 4 | `HQNBTW93_E109` | `motivates` | 13-Noise Level | noisy vibration data(High Noise) |  | 15-Data Preprocessing Algorithm | Morlet wavelet filter |  |
| 5 | `HQNBTW93_E110` | `motivates` | 13-Noise Level | noisy vibration data(High Noise) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 6 | `HQNBTW93_E111` | `motivates` | 09-Problem Scenario | early detection of faults / incipient defects(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Morlet wavelet filter |  |
| 7 | `HQNBTW93_E112` | `motivates` | 09-Problem Scenario | noise robustness / vibration signal tainted by noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Morlet wavelet filter |  |
| 8 | `HQNBTW93_E113` | `motivates` | 09-Problem Scenario | early detection of faults / incipient defects(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 9 | `HQNBTW93_E114` | `motivates` | 09-Problem Scenario | noise robustness / vibration signal tainted by noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 10 | `HQNBTW93_E115` | `motivates` | 09-Problem Scenario | early detection of faults / incipient defects(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | SABCF |  |
| 11 | `HQNBTW93_E116` | `motivates` | 09-Problem Scenario | noise robustness / vibration signal tainted by noise(Uncertainty) |  | 17-Core Classifier Algorithm | SABCF |  |
| 12 | `HQNBTW93_E117` | `motivates` | 07-Compound Fault | cracks and dents in the outraces, inner races and rolling elements(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 13 | `HQNBTW93_E118` | `motivates` | 07-Compound Fault | cracks and dents in the outraces, inner races and rolling elements(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | SABCF |  |
| 14 | `HQNBTW93_E119` | `motivates` | 06-Fault Severity | degradation(Multiple Severities) |  | 17-Core Classifier Algorithm | SABCF |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `HQNBTW93_E106`：early detection of faults / incipient defects(Early Degradation Prediction) motivates Differential evolution
  - `HQNBTW93_E107`：noise robustness / vibration signal tainted by noise(Uncertainty) motivates Differential evolution
  - `HQNBTW93_E111`：early detection of faults / incipient defects(Early Degradation Prediction) motivates Morlet wavelet filter
  - `HQNBTW93_E112`：noise robustness / vibration signal tainted by noise(Uncertainty) motivates Morlet wavelet filter
  - `HQNBTW93_E113`：early detection of faults / incipient defects(Early Degradation Prediction) motivates Fast Fourier Transform
  - `HQNBTW93_E114`：noise robustness / vibration signal tainted by noise(Uncertainty) motivates Fast Fourier Transform
  - `HQNBTW93_E115`：early detection of faults / incipient defects(Early Degradation Prediction) motivates SABCF
  - `HQNBTW93_E116`：noise robustness / vibration signal tainted by noise(Uncertainty) motivates SABCF
