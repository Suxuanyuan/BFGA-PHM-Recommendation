...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QX5T9ZFY_E018` | `motivates` | 09-Problem Scenario | incipient fault detection(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `QX5T9ZFY_E018`：incipient fault detection(Early Degradation Prediction) motivates Threshold Decision
...
*This prompt is automatically generated by edge_03_prompt.py (Batch 1, total 1 edges)*
