...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3IZAC4N4_E113` | `motivates` | 09-Problem Scenario | bearing incipient fault feature extraction(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | SSA |  |
| 2 | `3IZAC4N4_E114` | `motivates` | 09-Problem Scenario | environmental interference(Uncertainty) |  | 19-Training Optimization Algorithm | SSA |  |
| 3 | `3IZAC4N4_E115` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | SSA |  |
| 4 | `3IZAC4N4_E116` | `motivates` | 13-Noise Level | environmental interference(High Noise) |  | 15-Data Preprocessing Algorithm | SR |  |
| 5 | `3IZAC4N4_E117` | `motivates` | 13-Noise Level | environmental interference(High Noise) |  | 16-Feature Extraction Algorithm | AO-TVF-EMD |  |
| 6 | `3IZAC4N4_E118` | `motivates` | 09-Problem Scenario | bearing incipient fault feature extraction(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | SR |  |
| 7 | `3IZAC4N4_E119` | `motivates` | 09-Problem Scenario | environmental interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | SR |  |
| 8 | `3IZAC4N4_E120` | `motivates` | 09-Problem Scenario | bearing incipient fault feature extraction(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | AO-TVF-EMD |  |
| 9 | `3IZAC4N4_E121` | `motivates` | 09-Problem Scenario | environmental interference(Uncertainty) |  | 16-Feature Extraction Algorithm | AO-TVF-EMD |  |
| 10 | `3IZAC4N4_E122` | `motivates` | 09-Problem Scenario | bearing incipient fault feature extraction(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Hilbert Envelope Spectrum |  |
| 11 | `3IZAC4N4_E123` | `motivates` | 09-Problem Scenario | environmental interference(Uncertainty) |  | 17-Core Classifier Algorithm | Hilbert Envelope Spectrum |  |
| 12 | `3IZAC4N4_E124` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | AO-TVF-EMD |  |
| 13 | `3IZAC4N4_E125` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Hilbert Envelope Spectrum |  |
| 14 | `3IZAC4N4_E126` | `motivates` | 06-Fault Severity | run to failure tests(Multiple Severities) |  | 17-Core Classifier Algorithm | Hilbert Envelope Spectrum |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `3IZAC4N4_E113`：bearing incipient fault feature extraction(Early Degradation Prediction) motivates SSA
  - `3IZAC4N4_E114`：environmental interference(Uncertainty) motivates SSA
  - `3IZAC4N4_E118`：bearing incipient fault feature extraction(Early Degradation Prediction) motivates SR
  - `3IZAC4N4_E119`：environmental interference(Uncertainty) motivates SR
  - `3IZAC4N4_E120`：bearing incipient fault feature extraction(Early Degradation Prediction) motivates AO-TVF-EMD
  - `3IZAC4N4_E121`：environmental interference(Uncertainty) motivates AO-TVF-EMD
  - `3IZAC4N4_E122`：bearing incipient fault feature extraction(Early Degradation Prediction) motivates Hilbert Envelope Spectrum
  - `3IZAC4N4_E123`：environmental interference(Uncertainty) motivates Hilbert Envelope Spectrum
