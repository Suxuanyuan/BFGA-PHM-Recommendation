...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `275VHRA8_E089` | `motivates` | 13-Noise Level | Sensor noise, disturbances and data acquisition board defect(High Noise) |  | 16-Feature Extraction Algorithm | Time-Varying Kalman Filter |  |
| 2 | `275VHRA8_E090` | `motivates` | 09-Problem Scenario | noises and data acquisition defects(Uncertainty) |  | 16-Feature Extraction Algorithm | Time-Varying Kalman Filter |  |
| 3 | `275VHRA8_E091` | `motivates` | 09-Problem Scenario | parametric uncertainties(Other) |  | 16-Feature Extraction Algorithm | Time-Varying Kalman Filter |  |
| 4 | `275VHRA8_E092` | `motivates` | 09-Problem Scenario | noises and data acquisition defects(Uncertainty) |  | 17-Core Classifier Algorithm | CUSUM |  |
| 5 | `275VHRA8_E093` | `motivates` | 09-Problem Scenario | parametric uncertainties(Other) |  | 17-Core Classifier Algorithm | CUSUM |  |
| 6 | `275VHRA8_E094` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Time-Varying Kalman Filter |  |
| 7 | `275VHRA8_E095` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | CUSUM |  |
| 8 | `275VHRA8_E096` | `motivates` | 06-Fault Severity | -3%, +3%, -5%, -3%, +2%(Multiple Severities) |  | 17-Core Classifier Algorithm | CUSUM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `275VHRA8_E090`：noises and data acquisition defects(Uncertainty) motivates Time-Varying Kalman Filter
  - `275VHRA8_E091`：parametric uncertainties(Other) motivates Time-Varying Kalman Filter
  - `275VHRA8_E092`：noises and data acquisition defects(Uncertainty) motivates CUSUM
  - `275VHRA8_E093`：parametric uncertainties(Other) motivates CUSUM
