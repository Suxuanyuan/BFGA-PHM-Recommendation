...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XDKY9BKK_E088` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Resampling |  |
| 2 | `XDKY9BKK_E089` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Adaptive Local Iterative Filtering |  |
| 3 | `XDKY9BKK_E090` | `motivates` | 09-Problem Scenario | mechanical-magnetic-electric interaction analysis(Trustworthiness / Interpretability) |  | 15-Data Preprocessing Algorithm | Resampling |  |
| 4 | `XDKY9BKK_E091` | `motivates` | 09-Problem Scenario | mechanical-magnetic-electric interaction analysis(Trustworthiness / Interpretability) |  | 16-Feature Extraction Algorithm | Adaptive Local Iterative Filtering |  |
| 5 | `XDKY9BKK_E092` | `motivates` | 09-Problem Scenario | mechanical-magnetic-electric interaction analysis(Trustworthiness / Interpretability) |  | 17-Core Classifier Algorithm | Joint signature analysis |  |
| 6 | `XDKY9BKK_E093` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Adaptive Local Iterative Filtering |  |
| 7 | `XDKY9BKK_E094` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Joint signature analysis |  |
| 8 | `XDKY9BKK_E095` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Joint signature analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `XDKY9BKK_E090`：mechanical-magnetic-electric interaction analysis(Trustworthiness / Interpretability) motivates Resampling
  - `XDKY9BKK_E091`：mechanical-magnetic-electric interaction analysis(Trustworthiness / Interpretability) motivates Adaptive Local Iterative Filtering
  - `XDKY9BKK_E092`：mechanical-magnetic-electric interaction analysis(Trustworthiness / Interpretability) motivates Joint signature analysis
