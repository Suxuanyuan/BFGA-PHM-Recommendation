...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `Q7NPSC2C_E078` | `motivates` | 09-Problem Scenario | measurement noise, load disturbance, and unknown parameters(Uncertainty) |  | 19-Training Optimization Algorithm | Adaptive Parameter Estimation |  |
| 2 | `Q7NPSC2C_E079` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Adaptive Parameter Estimation |  |
| 3 | `Q7NPSC2C_E080` | `motivates` | 09-Problem Scenario | measurement noise, load disturbance, and unknown parameters(Uncertainty) |  | 17-Core Classifier Algorithm | Nonlinear Geometric FDI |  |
| 4 | `Q7NPSC2C_E081` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Nonlinear Geometric FDI |  |
| 5 | `Q7NPSC2C_E082` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Nonlinear Geometric FDI |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `Q7NPSC2C_E078`：measurement noise, load disturbance, and unknown parameters(Uncertainty) motivates Adaptive Parameter Estimation
  - `Q7NPSC2C_E080`：measurement noise, load disturbance, and unknown parameters(Uncertainty) motivates Nonlinear Geometric FDI
