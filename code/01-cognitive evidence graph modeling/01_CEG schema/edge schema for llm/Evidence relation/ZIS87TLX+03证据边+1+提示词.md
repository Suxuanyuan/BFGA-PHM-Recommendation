...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZIS87TLX_E116` | `motivates` | 09-Problem Scenario | model uncertainty and unknown disturbance bounds(Uncertainty) |  | 19-Training Optimization Algorithm | Dual-layer gain adaptation |  |
| 2 | `ZIS87TLX_E117` | `motivates` | 09-Problem Scenario | control gain overestimation and chattering(Other) |  | 19-Training Optimization Algorithm | Dual-layer gain adaptation |  |
| 3 | `ZIS87TLX_E118` | `motivates` | 12-Training Data Availability | Not applicable(Sufficient) |  | 19-Training Optimization Algorithm | Dual-layer gain adaptation |  |
| 4 | `ZIS87TLX_E119` | `motivates` | 13-Noise Level | external disturbance(High Noise) |  | 15-Data Preprocessing Algorithm | Low-pass filter |  |
| 5 | `ZIS87TLX_E120` | `motivates` | 13-Noise Level | external disturbance(High Noise) |  | 16-Feature Extraction Algorithm | Adaptive-gain finite-time observer |  |
| 6 | `ZIS87TLX_E121` | `motivates` | 09-Problem Scenario | model uncertainty and unknown disturbance bounds(Uncertainty) |  | 15-Data Preprocessing Algorithm | Low-pass filter |  |
| 7 | `ZIS87TLX_E122` | `motivates` | 09-Problem Scenario | control gain overestimation and chattering(Other) |  | 15-Data Preprocessing Algorithm | Low-pass filter |  |
| 8 | `ZIS87TLX_E123` | `motivates` | 09-Problem Scenario | model uncertainty and unknown disturbance bounds(Uncertainty) |  | 16-Feature Extraction Algorithm | Adaptive-gain finite-time observer |  |
| 9 | `ZIS87TLX_E124` | `motivates` | 09-Problem Scenario | control gain overestimation and chattering(Other) |  | 16-Feature Extraction Algorithm | Adaptive-gain finite-time observer |  |
| 10 | `ZIS87TLX_E125` | `motivates` | 09-Problem Scenario | model uncertainty and unknown disturbance bounds(Uncertainty) |  | 17-Core Classifier Algorithm | ISMC |  |
| 11 | `ZIS87TLX_E126` | `motivates` | 09-Problem Scenario | control gain overestimation and chattering(Other) |  | 17-Core Classifier Algorithm | ISMC |  |
| 12 | `ZIS87TLX_E127` | `motivates` | 07-Compound Fault | gain faults and bias faults(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Adaptive-gain finite-time observer |  |
| 13 | `ZIS87TLX_E128` | `motivates` | 07-Compound Fault | gain faults and bias faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | ISMC |  |
| 14 | `ZIS87TLX_E129` | `motivates` | 06-Fault Severity | gain fault parameter 0.4, bias fault parameters 2, -20(Single Severity) |  | 17-Core Classifier Algorithm | ISMC |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZIS87TLX_E116`：model uncertainty and unknown disturbance bounds(Uncertainty) motivates Dual-layer gain adaptation
  - `ZIS87TLX_E117`：control gain overestimation and chattering(Other) motivates Dual-layer gain adaptation
  - `ZIS87TLX_E121`：model uncertainty and unknown disturbance bounds(Uncertainty) motivates Low-pass filter
  - `ZIS87TLX_E122`：control gain overestimation and chattering(Other) motivates Low-pass filter
  - `ZIS87TLX_E123`：model uncertainty and unknown disturbance bounds(Uncertainty) motivates Adaptive-gain finite-time observer
  - `ZIS87TLX_E124`：control gain overestimation and chattering(Other) motivates Adaptive-gain finite-time observer
  - `ZIS87TLX_E125`：model uncertainty and unknown disturbance bounds(Uncertainty) motivates ISMC
  - `ZIS87TLX_E126`：control gain overestimation and chattering(Other) motivates ISMC
