...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PZG8U77S_E120` | `motivates` | 13-Noise Level | noise-polluted condition (SNR = 0dB)(High Noise) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 2 | `PZG8U77S_E121` | `motivates` | 13-Noise Level | noise-polluted condition (SNR = 0dB)(High Noise) |  | 16-Feature Extraction Algorithm | Order spectrum analysis |  |
| 3 | `PZG8U77S_E122` | `motivates` | 09-Problem Scenario | tracking the fast oscillating nature implied in the fault-induced sinusoidal FM patterns under non-stationary conditions(Other) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 4 | `PZG8U77S_E123` | `motivates` | 09-Problem Scenario | noise robustness under noise-polluted situations(Uncertainty) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 5 | `PZG8U77S_E124` | `motivates` | 09-Problem Scenario | tracking the fast oscillating nature implied in the fault-induced sinusoidal FM patterns under non-stationary conditions(Other) |  | 16-Feature Extraction Algorithm | Order spectrum analysis |  |
| 6 | `PZG8U77S_E125` | `motivates` | 09-Problem Scenario | noise robustness under noise-polluted situations(Uncertainty) |  | 16-Feature Extraction Algorithm | Order spectrum analysis |  |
| 7 | `PZG8U77S_E126` | `motivates` | 09-Problem Scenario | tracking the fast oscillating nature implied in the fault-induced sinusoidal FM patterns under non-stationary conditions(Other) |  | 17-Core Classifier Algorithm | Iterative-joint chirp mode decomposition |  |
| 8 | `PZG8U77S_E127` | `motivates` | 09-Problem Scenario | noise robustness under noise-polluted situations(Uncertainty) |  | 17-Core Classifier Algorithm | Iterative-joint chirp mode decomposition |  |
| 9 | `PZG8U77S_E128` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Order spectrum analysis |  |
| 10 | `PZG8U77S_E129` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Iterative-joint chirp mode decomposition |  |
| 11 | `PZG8U77S_E130` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Iterative-joint chirp mode decomposition |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `PZG8U77S_E122`：tracking the fast oscillating nature implied in the fault-induced sinusoidal FM patterns under non-stationary conditions(Other) motivates Hilbert transform
  - `PZG8U77S_E123`：noise robustness under noise-polluted situations(Uncertainty) motivates Hilbert transform
  - `PZG8U77S_E124`：tracking the fast oscillating nature implied in the fault-induced sinusoidal FM patterns under non-stationary conditions(Other) motivates Order spectrum analysis
  - `PZG8U77S_E125`：noise robustness under noise-polluted situations(Uncertainty) motivates Order spectrum analysis
  - `PZG8U77S_E126`：tracking the fast oscillating nature implied in the fault-induced sinusoidal FM patterns under non-stationary conditions(Other) motivates Iterative-joint chirp mode decomposition
  - `PZG8U77S_E127`：noise robustness under noise-polluted situations(Uncertainty) motivates Iterative-joint chirp mode decomposition
