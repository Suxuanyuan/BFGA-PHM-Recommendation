...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `L28P5XHW_E079` | `motivates` | 13-Noise Level | background noise and interferences(High Noise) |  | 15-Data Preprocessing Algorithm | Adaptive Signal Decomposition |  |
| 2 | `L28P5XHW_E080` | `motivates` | 13-Noise Level | background noise and interferences(High Noise) |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 3 | `L28P5XHW_E081` | `motivates` | 09-Problem Scenario | submerged in the background noise and interferences(Uncertainty) |  | 15-Data Preprocessing Algorithm | Adaptive Signal Decomposition |  |
| 4 | `L28P5XHW_E082` | `motivates` | 09-Problem Scenario | fixed decomposition scheme and prior information of the bearing faults(Other) |  | 15-Data Preprocessing Algorithm | Adaptive Signal Decomposition |  |
| 5 | `L28P5XHW_E083` | `motivates` | 09-Problem Scenario | submerged in the background noise and interferences(Uncertainty) |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 6 | `L28P5XHW_E084` | `motivates` | 09-Problem Scenario | fixed decomposition scheme and prior information of the bearing faults(Other) |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 7 | `L28P5XHW_E085` | `motivates` | 09-Problem Scenario | submerged in the background noise and interferences(Uncertainty) |  | 17-Core Classifier Algorithm | Adaptive Spectral Kurtosis |  |
| 8 | `L28P5XHW_E086` | `motivates` | 09-Problem Scenario | fixed decomposition scheme and prior information of the bearing faults(Other) |  | 17-Core Classifier Algorithm | Adaptive Spectral Kurtosis |  |
| 9 | `L28P5XHW_E087` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 10 | `L28P5XHW_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Adaptive Spectral Kurtosis |  |
| 11 | `L28P5XHW_E089` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Adaptive Spectral Kurtosis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `L28P5XHW_E081`：submerged in the background noise and interferences(Uncertainty) motivates Adaptive Signal Decomposition
  - `L28P5XHW_E082`：fixed decomposition scheme and prior information of the bearing faults(Other) motivates Adaptive Signal Decomposition
  - `L28P5XHW_E083`：submerged in the background noise and interferences(Uncertainty) motivates Spectral Kurtosis
  - `L28P5XHW_E084`：fixed decomposition scheme and prior information of the bearing faults(Other) motivates Spectral Kurtosis
  - `L28P5XHW_E085`：submerged in the background noise and interferences(Uncertainty) motivates Adaptive Spectral Kurtosis
  - `L28P5XHW_E086`：fixed decomposition scheme and prior information of the bearing faults(Other) motivates Adaptive Spectral Kurtosis
