...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ILWMKJWP_E147` | `motivates` | 12-Training Data Availability | faulty reference data are not required(Zero-Sample) |  | 18-Data Generation Algorithm | McFadden and Smith model |  |
| 2 | `ILWMKJWP_E148` | `motivates` | 13-Noise Level | masking noise / impulse noise(High Noise) |  | 15-Data Preprocessing Algorithm | FIR filter bank |  |
| 3 | `ILWMKJWP_E149` | `motivates` | 13-Noise Level | masking noise / impulse noise(High Noise) |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 4 | `ILWMKJWP_E150` | `motivates` | 09-Problem Scenario | faulty reference data are not required(Zero Fault Samples) |  | 18-Data Generation Algorithm | McFadden and Smith model |  |
| 5 | `ILWMKJWP_E151` | `motivates` | 09-Problem Scenario | masking noise from other vibration sources(Uncertainty) |  | 18-Data Generation Algorithm | McFadden and Smith model |  |
| 6 | `ILWMKJWP_E152` | `motivates` | 09-Problem Scenario | different types of faults coexist(Compound Faults) |  | 18-Data Generation Algorithm | McFadden and Smith model |  |
| 7 | `ILWMKJWP_E153` | `motivates` | 09-Problem Scenario | faulty reference data are not required(Zero Fault Samples) |  | 15-Data Preprocessing Algorithm | FIR filter bank |  |
| 8 | `ILWMKJWP_E154` | `motivates` | 09-Problem Scenario | masking noise from other vibration sources(Uncertainty) |  | 15-Data Preprocessing Algorithm | FIR filter bank |  |
| 9 | `ILWMKJWP_E155` | `motivates` | 09-Problem Scenario | different types of faults coexist(Compound Faults) |  | 15-Data Preprocessing Algorithm | FIR filter bank |  |
| 10 | `ILWMKJWP_E156` | `motivates` | 09-Problem Scenario | faulty reference data are not required(Zero Fault Samples) |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 11 | `ILWMKJWP_E157` | `motivates` | 09-Problem Scenario | masking noise from other vibration sources(Uncertainty) |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 12 | `ILWMKJWP_E158` | `motivates` | 09-Problem Scenario | different types of faults coexist(Compound Faults) |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 13 | `ILWMKJWP_E159` | `motivates` | 09-Problem Scenario | faulty reference data are not required(Zero Fault Samples) |  | 17-Core Classifier Algorithm | K-Nearest Neighbor |  |
| 14 | `ILWMKJWP_E160` | `motivates` | 09-Problem Scenario | masking noise from other vibration sources(Uncertainty) |  | 17-Core Classifier Algorithm | K-Nearest Neighbor |  |
| 15 | `ILWMKJWP_E161` | `motivates` | 09-Problem Scenario | different types of faults coexist(Compound Faults) |  | 17-Core Classifier Algorithm | K-Nearest Neighbor |  |
| 16 | `ILWMKJWP_E162` | `motivates` | 07-Compound Fault | faulty bearing and a faulty gearbox(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | Spectral Kurtosis |  |
| 17 | `ILWMKJWP_E163` | `motivates` | 07-Compound Fault | faulty bearing and a faulty gearbox(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | K-Nearest Neighbor |  |
| 18 | `ILWMKJWP_E164` | `motivates` | 06-Fault Severity | 1.5 × 1.0 × 0.1 mm, degradation(Multiple Severities) |  | 17-Core Classifier Algorithm | K-Nearest Neighbor |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ILWMKJWP_E150`：faulty reference data are not required(Zero Fault Samples) motivates McFadden and Smith model
  - `ILWMKJWP_E151`：masking noise from other vibration sources(Uncertainty) motivates McFadden and Smith model
  - `ILWMKJWP_E152`：different types of faults coexist(Compound Faults) motivates McFadden and Smith model
  - `ILWMKJWP_E153`：faulty reference data are not required(Zero Fault Samples) motivates FIR filter bank
  - `ILWMKJWP_E154`：masking noise from other vibration sources(Uncertainty) motivates FIR filter bank
  - `ILWMKJWP_E155`：different types of faults coexist(Compound Faults) motivates FIR filter bank
  - `ILWMKJWP_E156`：faulty reference data are not required(Zero Fault Samples) motivates Spectral Kurtosis
  - `ILWMKJWP_E157`：masking noise from other vibration sources(Uncertainty) motivates Spectral Kurtosis
  - `ILWMKJWP_E158`：different types of faults coexist(Compound Faults) motivates Spectral Kurtosis
  - `ILWMKJWP_E159`：faulty reference data are not required(Zero Fault Samples) motivates K-Nearest Neighbor
  - `ILWMKJWP_E160`：masking noise from other vibration sources(Uncertainty) motivates K-Nearest Neighbor
  - `ILWMKJWP_E161`：different types of faults coexist(Compound Faults) motivates K-Nearest Neighbor
