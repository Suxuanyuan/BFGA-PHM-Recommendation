...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `LJ674W83_E092` | `motivates` | 13-Noise Level | contaminated by noise(High Noise) |  | 16-Feature Extraction Algorithm | Iterative matching synchrosqueezing transform |  |
| 2 | `LJ674W83_E093` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Iterative matching synchrosqueezing transform |  |
| 3 | `LJ674W83_E094` | `motivates` | 09-Problem Scenario | early fault detection(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Iterative matching synchrosqueezing transform |  |
| 4 | `LJ674W83_E095` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Fourier analysis |  |
| 5 | `LJ674W83_E096` | `motivates` | 09-Problem Scenario | early fault detection(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Fourier analysis |  |
| 6 | `LJ674W83_E097` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Iterative matching synchrosqueezing transform |  |
| 7 | `LJ674W83_E098` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Fourier analysis |  |
| 8 | `LJ674W83_E099` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Fourier analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `LJ674W83_E093`：noise robustness(Uncertainty) motivates Iterative matching synchrosqueezing transform
  - `LJ674W83_E094`：early fault detection(Early Degradation Prediction) motivates Iterative matching synchrosqueezing transform
  - `LJ674W83_E095`：noise robustness(Uncertainty) motivates Fourier analysis
  - `LJ674W83_E096`：early fault detection(Early Degradation Prediction) motivates Fourier analysis
