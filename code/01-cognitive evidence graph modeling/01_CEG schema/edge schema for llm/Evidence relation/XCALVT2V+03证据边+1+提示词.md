...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XCALVT2V_E099` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 2 | `XCALVT2V_E100` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Shapelet Transform |  |
| 3 | `XCALVT2V_E101` | `motivates` | 09-Problem Scenario | system dynamics and spatial inhomogeneity(Complex Systems) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 4 | `XCALVT2V_E102` | `motivates` | 09-Problem Scenario | unseen fault recognition(Zero Fault Samples) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 5 | `XCALVT2V_E103` | `motivates` | 09-Problem Scenario | system dynamics and spatial inhomogeneity(Complex Systems) |  | 16-Feature Extraction Algorithm | Shapelet Transform |  |
| 6 | `XCALVT2V_E104` | `motivates` | 09-Problem Scenario | unseen fault recognition(Zero Fault Samples) |  | 16-Feature Extraction Algorithm | Shapelet Transform |  |
| 7 | `XCALVT2V_E105` | `motivates` | 09-Problem Scenario | system dynamics and spatial inhomogeneity(Complex Systems) |  | 17-Core Classifier Algorithm | SSM-SVM |  |
| 8 | `XCALVT2V_E106` | `motivates` | 09-Problem Scenario | unseen fault recognition(Zero Fault Samples) |  | 17-Core Classifier Algorithm | SSM-SVM |  |
| 9 | `XCALVT2V_E107` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Shapelet Transform |  |
| 10 | `XCALVT2V_E108` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SSM-SVM |  |
| 11 | `XCALVT2V_E109` | `motivates` | 06-Fault Severity | Pressure of 1.3 bar, Pressure of 1.7 bar, Stoichiometry Air 1.5(Single Severity) |  | 17-Core Classifier Algorithm | SSM-SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `XCALVT2V_E101`：system dynamics and spatial inhomogeneity(Complex Systems) motivates Sliding Window
  - `XCALVT2V_E102`：unseen fault recognition(Zero Fault Samples) motivates Sliding Window
  - `XCALVT2V_E103`：system dynamics and spatial inhomogeneity(Complex Systems) motivates Shapelet Transform
  - `XCALVT2V_E104`：unseen fault recognition(Zero Fault Samples) motivates Shapelet Transform
  - `XCALVT2V_E105`：system dynamics and spatial inhomogeneity(Complex Systems) motivates SSM-SVM
  - `XCALVT2V_E106`：unseen fault recognition(Zero Fault Samples) motivates SSM-SVM
