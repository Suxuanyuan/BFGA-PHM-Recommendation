...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `8BTRCQL6_E098` | `motivates` | 09-Problem Scenario | scarce labels / limited labeled training samples(Small Fault Samples) |  | 19-Training Optimization Algorithm | Anchor-Point-based Manifold Regularization |  |
| 2 | `8BTRCQL6_E099` | `motivates` | 09-Problem Scenario | sequentially generated training samples / online learning(Other) |  | 19-Training Optimization Algorithm | Anchor-Point-based Manifold Regularization |  |
| 3 | `8BTRCQL6_E100` | `motivates` | 12-Training Data Availability | limited labeled samples(Scarce) |  | 19-Training Optimization Algorithm | Anchor-Point-based Manifold Regularization |  |
| 4 | `8BTRCQL6_E101` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Broad Learning System |  |
| 5 | `8BTRCQL6_E102` | `motivates` | 09-Problem Scenario | scarce labels / limited labeled training samples(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Broad Learning System |  |
| 6 | `8BTRCQL6_E103` | `motivates` | 09-Problem Scenario | sequentially generated training samples / online learning(Other) |  | 16-Feature Extraction Algorithm | Broad Learning System |  |
| 7 | `8BTRCQL6_E104` | `motivates` | 09-Problem Scenario | scarce labels / limited labeled training samples(Small Fault Samples) |  | 17-Core Classifier Algorithm | Online Semi-Supervised Broad Learning System |  |
| 8 | `8BTRCQL6_E105` | `motivates` | 09-Problem Scenario | sequentially generated training samples / online learning(Other) |  | 17-Core Classifier Algorithm | Online Semi-Supervised Broad Learning System |  |
| 9 | `8BTRCQL6_E106` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Broad Learning System |  |
| 10 | `8BTRCQL6_E107` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Online Semi-Supervised Broad Learning System |  |
| 11 | `8BTRCQL6_E108` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Online Semi-Supervised Broad Learning System |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `8BTRCQL6_E098`：scarce labels / limited labeled training samples(Small Fault Samples) motivates Anchor-Point-based Manifold Regularization
  - `8BTRCQL6_E099`：sequentially generated training samples / online learning(Other) motivates Anchor-Point-based Manifold Regularization
  - `8BTRCQL6_E102`：scarce labels / limited labeled training samples(Small Fault Samples) motivates Broad Learning System
  - `8BTRCQL6_E103`：sequentially generated training samples / online learning(Other) motivates Broad Learning System
  - `8BTRCQL6_E104`：scarce labels / limited labeled training samples(Small Fault Samples) motivates Online Semi-Supervised Broad Learning System
  - `8BTRCQL6_E105`：sequentially generated training samples / online learning(Other) motivates Online Semi-Supervised Broad Learning System
