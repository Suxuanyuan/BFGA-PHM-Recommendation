...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `U5YE2QW9_E109` | `motivates` | 13-Noise Level | noise level(High Noise) |  | 15-Data Preprocessing Algorithm | Z-score Normalization |  |
| 2 | `U5YE2QW9_E110` | `motivates` | 13-Noise Level | noise level(High Noise) |  | 16-Feature Extraction Algorithm | Multi-band Pass Filter |  |
| 3 | `U5YE2QW9_E111` | `motivates` | 09-Problem Scenario | small number of training samples(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Z-score Normalization |  |
| 4 | `U5YE2QW9_E112` | `motivates` | 09-Problem Scenario | symptom parameters vary under different operating conditions(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Z-score Normalization |  |
| 5 | `U5YE2QW9_E113` | `motivates` | 09-Problem Scenario | small number of training samples(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Multi-band Pass Filter |  |
| 6 | `U5YE2QW9_E114` | `motivates` | 09-Problem Scenario | symptom parameters vary under different operating conditions(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Multi-band Pass Filter |  |
| 7 | `U5YE2QW9_E115` | `motivates` | 09-Problem Scenario | small number of training samples(Small Fault Samples) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 8 | `U5YE2QW9_E116` | `motivates` | 09-Problem Scenario | symptom parameters vary under different operating conditions(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 9 | `U5YE2QW9_E117` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Multi-band Pass Filter |  |
| 10 | `U5YE2QW9_E118` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 11 | `U5YE2QW9_E119` | `motivates` | 06-Fault Severity | defect size(Multiple Severities) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `U5YE2QW9_E111`：small number of training samples(Small Fault Samples) motivates Z-score Normalization
  - `U5YE2QW9_E112`：symptom parameters vary under different operating conditions(Distribution Discrepancy) motivates Z-score Normalization
  - `U5YE2QW9_E113`：small number of training samples(Small Fault Samples) motivates Multi-band Pass Filter
  - `U5YE2QW9_E114`：symptom parameters vary under different operating conditions(Distribution Discrepancy) motivates Multi-band Pass Filter
  - `U5YE2QW9_E115`：small number of training samples(Small Fault Samples) motivates Support Vector Machine
  - `U5YE2QW9_E116`：symptom parameters vary under different operating conditions(Distribution Discrepancy) motivates Support Vector Machine
