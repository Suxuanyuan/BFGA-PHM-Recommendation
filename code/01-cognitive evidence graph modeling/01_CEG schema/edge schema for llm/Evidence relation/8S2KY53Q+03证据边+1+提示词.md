...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `8S2KY53Q_E104` | `motivates` | 13-Noise Level | noisy data(Normal) |  | 15-Data Preprocessing Algorithm | Downsampling |  |
| 2 | `8S2KY53Q_E105` | `motivates` | 13-Noise Level | noisy data(Normal) |  | 16-Feature Extraction Algorithm | FTDD |  |
| 3 | `8S2KY53Q_E106` | `motivates` | 09-Problem Scenario | noisy data, variations in fault characteristic frequencies(Uncertainty) |  | 15-Data Preprocessing Algorithm | Downsampling |  |
| 4 | `8S2KY53Q_E107` | `motivates` | 09-Problem Scenario | high dimension feature and computational cost(Other) |  | 15-Data Preprocessing Algorithm | Downsampling |  |
| 5 | `8S2KY53Q_E108` | `motivates` | 09-Problem Scenario | noisy data, variations in fault characteristic frequencies(Uncertainty) |  | 16-Feature Extraction Algorithm | FTDD |  |
| 6 | `8S2KY53Q_E109` | `motivates` | 09-Problem Scenario | high dimension feature and computational cost(Other) |  | 16-Feature Extraction Algorithm | FTDD |  |
| 7 | `8S2KY53Q_E110` | `motivates` | 09-Problem Scenario | noisy data, variations in fault characteristic frequencies(Uncertainty) |  | 17-Core Classifier Algorithm | SVM |  |
| 8 | `8S2KY53Q_E111` | `motivates` | 09-Problem Scenario | high dimension feature and computational cost(Other) |  | 17-Core Classifier Algorithm | SVM |  |
| 9 | `8S2KY53Q_E112` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | FTDD |  |
| 10 | `8S2KY53Q_E113` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVM |  |
| 11 | `8S2KY53Q_E114` | `motivates` | 06-Fault Severity | 0.007 inch, 0.014 inch, 0.021 inch(Multiple Severities) |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `8S2KY53Q_E106`：noisy data, variations in fault characteristic frequencies(Uncertainty) motivates Downsampling
  - `8S2KY53Q_E107`：high dimension feature and computational cost(Other) motivates Downsampling
  - `8S2KY53Q_E108`：noisy data, variations in fault characteristic frequencies(Uncertainty) motivates FTDD
  - `8S2KY53Q_E109`：high dimension feature and computational cost(Other) motivates FTDD
  - `8S2KY53Q_E110`：noisy data, variations in fault characteristic frequencies(Uncertainty) motivates SVM
  - `8S2KY53Q_E111`：high dimension feature and computational cost(Other) motivates SVM
