...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `V4UQ9AUE_E133` | `motivates` | 13-Noise Level | interference and low signal to noise ratio(High Noise) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 2 | `V4UQ9AUE_E134` | `motivates` | 13-Noise Level | interference and low signal to noise ratio(High Noise) |  | 16-Feature Extraction Algorithm | CNN |  |
| 3 | `V4UQ9AUE_E135` | `motivates` | 09-Problem Scenario | multi-sensor fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 4 | `V4UQ9AUE_E136` | `motivates` | 09-Problem Scenario | fixed time window in sequential models(Other) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 5 | `V4UQ9AUE_E137` | `motivates` | 09-Problem Scenario | multi-sensor fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | CNN |  |
| 6 | `V4UQ9AUE_E138` | `motivates` | 09-Problem Scenario | fixed time window in sequential models(Other) |  | 16-Feature Extraction Algorithm | CNN |  |
| 7 | `V4UQ9AUE_E139` | `motivates` | 09-Problem Scenario | multi-sensor fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `V4UQ9AUE_E140` | `motivates` | 09-Problem Scenario | fixed time window in sequential models(Other) |  | 17-Core Classifier Algorithm | Softmax |  |
| 9 | `V4UQ9AUE_E141` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 10 | `V4UQ9AUE_E142` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `V4UQ9AUE_E143` | `motivates` | 06-Fault Severity | fault diameter(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `V4UQ9AUE_E135`：multi-sensor fusion(Multi-Source Heterogeneous / Multimodal Data) motivates Hilbert transform
  - `V4UQ9AUE_E136`：fixed time window in sequential models(Other) motivates Hilbert transform
  - `V4UQ9AUE_E137`：multi-sensor fusion(Multi-Source Heterogeneous / Multimodal Data) motivates CNN
  - `V4UQ9AUE_E138`：fixed time window in sequential models(Other) motivates CNN
  - `V4UQ9AUE_E139`：multi-sensor fusion(Multi-Source Heterogeneous / Multimodal Data) motivates Softmax
  - `V4UQ9AUE_E140`：fixed time window in sequential models(Other) motivates Softmax
