...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WNVRAXPR_E113` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Delay-alignment |  |
| 2 | `WNVRAXPR_E114` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | MWPCA |  |
| 3 | `WNVRAXPR_E115` | `motivates` | 09-Problem Scenario | large-scale processes monitoring(Complex Systems) |  | 15-Data Preprocessing Algorithm | Delay-alignment |  |
| 4 | `WNVRAXPR_E116` | `motivates` | 09-Problem Scenario | transportation delay of defective processing materials(Other) |  | 15-Data Preprocessing Algorithm | Delay-alignment |  |
| 5 | `WNVRAXPR_E117` | `motivates` | 09-Problem Scenario | large-scale processes monitoring(Complex Systems) |  | 16-Feature Extraction Algorithm | MWPCA |  |
| 6 | `WNVRAXPR_E118` | `motivates` | 09-Problem Scenario | transportation delay of defective processing materials(Other) |  | 16-Feature Extraction Algorithm | MWPCA |  |
| 7 | `WNVRAXPR_E119` | `motivates` | 09-Problem Scenario | large-scale processes monitoring(Complex Systems) |  | 17-Core Classifier Algorithm | MBCPLS |  |
| 8 | `WNVRAXPR_E120` | `motivates` | 09-Problem Scenario | transportation delay of defective processing materials(Other) |  | 17-Core Classifier Algorithm | MBCPLS |  |
| 9 | `WNVRAXPR_E121` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | MWPCA |  |
| 10 | `WNVRAXPR_E122` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | MBCPLS |  |
| 11 | `WNVRAXPR_E123` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | MBCPLS |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `WNVRAXPR_E115`：large-scale processes monitoring(Complex Systems) motivates Delay-alignment
  - `WNVRAXPR_E116`：transportation delay of defective processing materials(Other) motivates Delay-alignment
  - `WNVRAXPR_E117`：large-scale processes monitoring(Complex Systems) motivates MWPCA
  - `WNVRAXPR_E118`：transportation delay of defective processing materials(Other) motivates MWPCA
  - `WNVRAXPR_E119`：large-scale processes monitoring(Complex Systems) motivates MBCPLS
  - `WNVRAXPR_E120`：transportation delay of defective processing materials(Other) motivates MBCPLS
