...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `8U7HYWDM_E151` | `motivates` | 09-Problem Scenario | Class imbalance / Imbalanced data(Small Fault Samples) |  | 19-Training Optimization Algorithm | BML |  |
| 2 | `8U7HYWDM_E152` | `motivates` | 12-Training Data Availability | extremely class-imbalanced scenarios(Scarce) |  | 19-Training Optimization Algorithm | BML |  |
| 3 | `8U7HYWDM_E153` | `motivates` | 13-Noise Level | Gaussian noise, signal-to-noise ratio(High Noise) |  | 15-Data Preprocessing Algorithm | TDA |  |
| 4 | `8U7HYWDM_E154` | `motivates` | 13-Noise Level | Gaussian noise, signal-to-noise ratio(High Noise) |  | 16-Feature Extraction Algorithm | ResNet |  |
| 5 | `8U7HYWDM_E155` | `motivates` | 09-Problem Scenario | Class imbalance / Imbalanced data(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | TDA |  |
| 6 | `8U7HYWDM_E156` | `motivates` | 09-Problem Scenario | Class imbalance / Imbalanced data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | ResNet |  |
| 7 | `8U7HYWDM_E157` | `motivates` | 09-Problem Scenario | Class imbalance / Imbalanced data(Small Fault Samples) |  | 17-Core Classifier Algorithm | DDBB |  |
| 8 | `8U7HYWDM_E158` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | ResNet |  |
| 9 | `8U7HYWDM_E159` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | DDBB |  |
| 10 | `8U7HYWDM_E160` | `motivates` | 06-Fault Severity | five levels of chipping, severity 1 and 2(Multiple Severities) |  | 17-Core Classifier Algorithm | DDBB |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `8U7HYWDM_E151`：Class imbalance / Imbalanced data(Small Fault Samples) motivates BML
  - `8U7HYWDM_E155`：Class imbalance / Imbalanced data(Small Fault Samples) motivates TDA
  - `8U7HYWDM_E156`：Class imbalance / Imbalanced data(Small Fault Samples) motivates ResNet
  - `8U7HYWDM_E157`：Class imbalance / Imbalanced data(Small Fault Samples) motivates DDBB
