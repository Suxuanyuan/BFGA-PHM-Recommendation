...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CTMM6BTI_E095` | `motivates` | 09-Problem Scenario | incipient bearing failure with weak fault impulse modulated by skidding(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | Iterative Gaussian process regression |  |
| 2 | `CTMM6BTI_E096` | `motivates` | 09-Problem Scenario | key-phase information is not available(Other) |  | 19-Training Optimization Algorithm | Iterative Gaussian process regression |  |
| 3 | `CTMM6BTI_E097` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Iterative Gaussian process regression |  |
| 4 | `CTMM6BTI_E098` | `motivates` | 13-Noise Level | strong noise environment(High Noise) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 5 | `CTMM6BTI_E099` | `motivates` | 13-Noise Level | strong noise environment(High Noise) |  | 16-Feature Extraction Algorithm | Tacholess order tracking |  |
| 6 | `CTMM6BTI_E100` | `motivates` | 09-Problem Scenario | incipient bearing failure with weak fault impulse modulated by skidding(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 7 | `CTMM6BTI_E101` | `motivates` | 09-Problem Scenario | key-phase information is not available(Other) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 8 | `CTMM6BTI_E102` | `motivates` | 09-Problem Scenario | incipient bearing failure with weak fault impulse modulated by skidding(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Tacholess order tracking |  |
| 9 | `CTMM6BTI_E103` | `motivates` | 09-Problem Scenario | key-phase information is not available(Other) |  | 16-Feature Extraction Algorithm | Tacholess order tracking |  |
| 10 | `CTMM6BTI_E104` | `motivates` | 09-Problem Scenario | incipient bearing failure with weak fault impulse modulated by skidding(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | PRPIES |  |
| 11 | `CTMM6BTI_E105` | `motivates` | 09-Problem Scenario | key-phase information is not available(Other) |  | 17-Core Classifier Algorithm | PRPIES |  |
| 12 | `CTMM6BTI_E106` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Tacholess order tracking |  |
| 13 | `CTMM6BTI_E107` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | PRPIES |  |
| 14 | `CTMM6BTI_E108` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | PRPIES |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `CTMM6BTI_E095`：incipient bearing failure with weak fault impulse modulated by skidding(Early Degradation Prediction) motivates Iterative Gaussian process regression
  - `CTMM6BTI_E096`：key-phase information is not available(Other) motivates Iterative Gaussian process regression
  - `CTMM6BTI_E100`：incipient bearing failure with weak fault impulse modulated by skidding(Early Degradation Prediction) motivates Hilbert transform
  - `CTMM6BTI_E101`：key-phase information is not available(Other) motivates Hilbert transform
  - `CTMM6BTI_E102`：incipient bearing failure with weak fault impulse modulated by skidding(Early Degradation Prediction) motivates Tacholess order tracking
  - `CTMM6BTI_E103`：key-phase information is not available(Other) motivates Tacholess order tracking
  - `CTMM6BTI_E104`：incipient bearing failure with weak fault impulse modulated by skidding(Early Degradation Prediction) motivates PRPIES
  - `CTMM6BTI_E105`：key-phase information is not available(Other) motivates PRPIES
