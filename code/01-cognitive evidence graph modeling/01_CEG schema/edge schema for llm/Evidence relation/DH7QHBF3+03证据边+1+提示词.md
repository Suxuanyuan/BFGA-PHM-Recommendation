...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DH7QHBF3_E118` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Empirical Mode Decomposition |  |
| 2 | `DH7QHBF3_E119` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Linear Discriminant Analysis |  |
| 3 | `DH7QHBF3_E120` | `motivates` | 09-Problem Scenario | high-dimensional feature redundancy and non-significant information(Other) |  | 15-Data Preprocessing Algorithm | Empirical Mode Decomposition |  |
| 4 | `DH7QHBF3_E121` | `motivates` | 09-Problem Scenario | high-dimensional feature redundancy and non-significant information(Other) |  | 16-Feature Extraction Algorithm | Linear Discriminant Analysis |  |
| 5 | `DH7QHBF3_E122` | `motivates` | 09-Problem Scenario | high-dimensional feature redundancy and non-significant information(Other) |  | 17-Core Classifier Algorithm | Neural Network |  |
| 6 | `DH7QHBF3_E123` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Linear Discriminant Analysis |  |
| 7 | `DH7QHBF3_E124` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Neural Network |  |
| 8 | `DH7QHBF3_E125` | `motivates` | 06-Fault Severity | half-broken rotor bar, one broken rotor bar(Multiple Severities) |  | 17-Core Classifier Algorithm | Neural Network |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `DH7QHBF3_E120`：high-dimensional feature redundancy and non-significant information(Other) motivates Empirical Mode Decomposition
  - `DH7QHBF3_E121`：high-dimensional feature redundancy and non-significant information(Other) motivates Linear Discriminant Analysis
  - `DH7QHBF3_E122`：high-dimensional feature redundancy and non-significant information(Other) motivates Neural Network
