...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `35XL5SUH_E106` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 19-Training Optimization Algorithm | Genetic algorithm |  |
| 2 | `35XL5SUH_E107` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Genetic algorithm |  |
| 3 | `35XL5SUH_E108` | `motivates` | 13-Noise Level | strong noise / strong background noise(High Noise) |  | 15-Data Preprocessing Algorithm | Frequency shift modulation |  |
| 4 | `35XL5SUH_E109` | `motivates` | 13-Noise Level | strong noise / strong background noise(High Noise) |  | 16-Feature Extraction Algorithm | Discrete wavelet transform |  |
| 5 | `35XL5SUH_E110` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Frequency shift modulation |  |
| 6 | `35XL5SUH_E111` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Discrete wavelet transform |  |
| 7 | `35XL5SUH_E112` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Bistable stochastic resonance |  |
| 8 | `35XL5SUH_E113` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Discrete wavelet transform |  |
| 9 | `35XL5SUH_E114` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Bistable stochastic resonance |  |
| 10 | `35XL5SUH_E115` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Bistable stochastic resonance |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `35XL5SUH_E106`：strong background noise(Uncertainty) motivates Genetic algorithm
  - `35XL5SUH_E110`：strong background noise(Uncertainty) motivates Frequency shift modulation
  - `35XL5SUH_E111`：strong background noise(Uncertainty) motivates Discrete wavelet transform
  - `35XL5SUH_E112`：strong background noise(Uncertainty) motivates Bistable stochastic resonance
