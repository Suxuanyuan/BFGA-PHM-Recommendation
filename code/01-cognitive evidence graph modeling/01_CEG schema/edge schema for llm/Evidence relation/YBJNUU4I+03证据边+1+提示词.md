...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `YBJNUU4I_E160` | `motivates` | 09-Problem Scenario | classify nonlinear and multi-fault small sample data(Small Fault Samples) |  | 19-Training Optimization Algorithm | Improved Particle Swarm Optimization |  |
| 2 | `YBJNUU4I_E161` | `motivates` | 09-Problem Scenario | disturbed by signals such as vibration and noise(Uncertainty) |  | 19-Training Optimization Algorithm | Improved Particle Swarm Optimization |  |
| 3 | `YBJNUU4I_E162` | `motivates` | 12-Training Data Availability | A total of 188,000 system fault samples were collected.(Sufficient) |  | 19-Training Optimization Algorithm | Improved Particle Swarm Optimization |  |
| 4 | `YBJNUU4I_E163` | `motivates` | 13-Noise Level | easily disturbed by signals such as vibration and noise; feature signals extracted from the noise of non-linear and non-smooth processes(High Noise) |  | 16-Feature Extraction Algorithm | PCA |  |
| 5 | `YBJNUU4I_E164` | `motivates` | 09-Problem Scenario | classify nonlinear and multi-fault small sample data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | PCA |  |
| 6 | `YBJNUU4I_E165` | `motivates` | 09-Problem Scenario | disturbed by signals such as vibration and noise(Uncertainty) |  | 16-Feature Extraction Algorithm | PCA |  |
| 7 | `YBJNUU4I_E166` | `motivates` | 09-Problem Scenario | classify nonlinear and multi-fault small sample data(Small Fault Samples) |  | 17-Core Classifier Algorithm | SVM |  |
| 8 | `YBJNUU4I_E167` | `motivates` | 09-Problem Scenario | disturbed by signals such as vibration and noise(Uncertainty) |  | 17-Core Classifier Algorithm | SVM |  |
| 9 | `YBJNUU4I_E168` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | PCA |  |
| 10 | `YBJNUU4I_E169` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVM |  |
| 11 | `YBJNUU4I_E170` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `YBJNUU4I_E160`：classify nonlinear and multi-fault small sample data(Small Fault Samples) motivates Improved Particle Swarm Optimization
  - `YBJNUU4I_E161`：disturbed by signals such as vibration and noise(Uncertainty) motivates Improved Particle Swarm Optimization
  - `YBJNUU4I_E164`：classify nonlinear and multi-fault small sample data(Small Fault Samples) motivates PCA
  - `YBJNUU4I_E165`：disturbed by signals such as vibration and noise(Uncertainty) motivates PCA
  - `YBJNUU4I_E166`：classify nonlinear and multi-fault small sample data(Small Fault Samples) motivates SVM
  - `YBJNUU4I_E167`：disturbed by signals such as vibration and noise(Uncertainty) motivates SVM
