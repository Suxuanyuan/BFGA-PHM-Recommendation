...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `6LHBQ6AE_E079` | `motivates` | 13-Noise Level | noisy signal / strong background noise(High Noise) |  | 15-Data Preprocessing Algorithm | SVD |  |
| 2 | `6LHBQ6AE_E080` | `motivates` | 13-Noise Level | noisy signal / strong background noise(High Noise) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 3 | `6LHBQ6AE_E081` | `motivates` | 09-Problem Scenario | noisy signal(Uncertainty) |  | 15-Data Preprocessing Algorithm | SVD |  |
| 4 | `6LHBQ6AE_E082` | `motivates` | 09-Problem Scenario | interpretability(Trustworthiness / Interpretability) |  | 15-Data Preprocessing Algorithm | SVD |  |
| 5 | `6LHBQ6AE_E083` | `motivates` | 09-Problem Scenario | noisy signal(Uncertainty) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 6 | `6LHBQ6AE_E084` | `motivates` | 09-Problem Scenario | interpretability(Trustworthiness / Interpretability) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 7 | `6LHBQ6AE_E085` | `motivates` | 09-Problem Scenario | noisy signal(Uncertainty) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `6LHBQ6AE_E086` | `motivates` | 09-Problem Scenario | interpretability(Trustworthiness / Interpretability) |  | 17-Core Classifier Algorithm | Softmax |  |
| 9 | `6LHBQ6AE_E087` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 10 | `6LHBQ6AE_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `6LHBQ6AE_E089` | `motivates` | 06-Fault Severity | 0.007 mils(Single Severity) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `6LHBQ6AE_E081`：noisy signal(Uncertainty) motivates SVD
  - `6LHBQ6AE_E082`：interpretability(Trustworthiness / Interpretability) motivates SVD
  - `6LHBQ6AE_E083`：noisy signal(Uncertainty) motivates 1DCNN
  - `6LHBQ6AE_E084`：interpretability(Trustworthiness / Interpretability) motivates 1DCNN
  - `6LHBQ6AE_E085`：noisy signal(Uncertainty) motivates Softmax
  - `6LHBQ6AE_E086`：interpretability(Trustworthiness / Interpretability) motivates Softmax
