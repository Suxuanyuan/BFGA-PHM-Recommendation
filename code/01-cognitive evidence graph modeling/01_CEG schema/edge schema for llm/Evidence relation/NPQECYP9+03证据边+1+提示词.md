...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `NPQECYP9_E106` | `motivates` | 09-Problem Scenario | Parameter optimization and overfitting in deep neural networks(Other) |  | 19-Training Optimization Algorithm | Dynamic Adam |  |
| 2 | `NPQECYP9_E107` | `motivates` | 12-Training Data Availability | Dataset 1 consists of 135 samples, Dataset 2 contains 118 samples, Dataset 3 contains 533 samples(Sufficient) |  | 19-Training Optimization Algorithm | Dynamic Adam |  |
| 3 | `NPQECYP9_E108` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Z-score normalization |  |
| 4 | `NPQECYP9_E109` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | DNN |  |
| 5 | `NPQECYP9_E110` | `motivates` | 09-Problem Scenario | Parameter optimization and overfitting in deep neural networks(Other) |  | 15-Data Preprocessing Algorithm | Z-score normalization |  |
| 6 | `NPQECYP9_E111` | `motivates` | 09-Problem Scenario | Parameter optimization and overfitting in deep neural networks(Other) |  | 16-Feature Extraction Algorithm | DNN |  |
| 7 | `NPQECYP9_E112` | `motivates` | 09-Problem Scenario | Parameter optimization and overfitting in deep neural networks(Other) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `NPQECYP9_E113` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | DNN |  |
| 9 | `NPQECYP9_E114` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 10 | `NPQECYP9_E115` | `motivates` | 06-Fault Severity | low-energy discharge, high-energy discharge, thermal fault of low temperature, thermal fault of medium temperature, thermal fault of medium-low temperature, thermal fault of high temperature(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `NPQECYP9_E106`：Parameter optimization and overfitting in deep neural networks(Other) motivates Dynamic Adam
  - `NPQECYP9_E110`：Parameter optimization and overfitting in deep neural networks(Other) motivates Z-score normalization
  - `NPQECYP9_E111`：Parameter optimization and overfitting in deep neural networks(Other) motivates DNN
  - `NPQECYP9_E112`：Parameter optimization and overfitting in deep neural networks(Other) motivates Softmax
