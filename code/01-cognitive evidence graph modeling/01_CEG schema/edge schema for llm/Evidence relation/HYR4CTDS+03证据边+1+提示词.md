...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HYR4CTDS_E102` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Clarke-Concordia Transformation |  |
| 2 | `HYR4CTDS_E103` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Kernel Density Estimation |  |
| 3 | `HYR4CTDS_E104` | `motivates` | 09-Problem Scenario | High computational cost of standard KDE for online application(Other) |  | 15-Data Preprocessing Algorithm | Clarke-Concordia Transformation |  |
| 4 | `HYR4CTDS_E105` | `motivates` | 09-Problem Scenario | High computational cost of standard KDE for online application(Other) |  | 16-Feature Extraction Algorithm | Kernel Density Estimation |  |
| 5 | `HYR4CTDS_E106` | `motivates` | 09-Problem Scenario | High computational cost of standard KDE for online application(Other) |  | 17-Core Classifier Algorithm | Kullback-Leibler Divergence |  |
| 6 | `HYR4CTDS_E107` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Kernel Density Estimation |  |
| 7 | `HYR4CTDS_E108` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Kullback-Leibler Divergence |  |
| 8 | `HYR4CTDS_E109` | `motivates` | 06-Fault Severity | 1 to 10 broken bars and 1 to 10 broken connectors(Multiple Severities) |  | 17-Core Classifier Algorithm | Kullback-Leibler Divergence |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `HYR4CTDS_E104`：High computational cost of standard KDE for online application(Other) motivates Clarke-Concordia Transformation
  - `HYR4CTDS_E105`：High computational cost of standard KDE for online application(Other) motivates Kernel Density Estimation
  - `HYR4CTDS_E106`：High computational cost of standard KDE for online application(Other) motivates Kullback-Leibler Divergence
