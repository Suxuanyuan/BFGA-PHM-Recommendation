...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QAZZLUFR_E071` | `motivates` | 13-Noise Level | et is white noise(Normal) |  | 15-Data Preprocessing Algorithm | ADF |  |
| 2 | `QAZZLUFR_E072` | `motivates` | 13-Noise Level | et is white noise(Normal) |  | 16-Feature Extraction Algorithm | ARMA |  |
| 3 | `QAZZLUFR_E073` | `motivates` | 09-Problem Scenario | incipient fault diagnosis(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | ADF |  |
| 4 | `QAZZLUFR_E074` | `motivates` | 09-Problem Scenario | incipient fault diagnosis(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | ARMA |  |
| 5 | `QAZZLUFR_E075` | `motivates` | 09-Problem Scenario | incipient fault diagnosis(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | k-NN |  |
| 6 | `QAZZLUFR_E076` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | ARMA |  |
| 7 | `QAZZLUFR_E077` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | k-NN |  |
| 8 | `QAZZLUFR_E078` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | k-NN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `QAZZLUFR_E073`：incipient fault diagnosis(Early Degradation Prediction) motivates ADF
  - `QAZZLUFR_E074`：incipient fault diagnosis(Early Degradation Prediction) motivates ARMA
  - `QAZZLUFR_E075`：incipient fault diagnosis(Early Degradation Prediction) motivates k-NN
