...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `9H8NE2UR_E068` | `motivates` | 13-Noise Level | harmonic-polluted, noisy current signals, Additive White Gaussian Noise(High Noise) |  | 15-Data Preprocessing Algorithm | Chebyshev filter |  |
| 2 | `9H8NE2UR_E069` | `motivates` | 13-Noise Level | harmonic-polluted, noisy current signals, Additive White Gaussian Noise(High Noise) |  | 16-Feature Extraction Algorithm | Fractional Windowed Fourier Transform |  |
| 3 | `9H8NE2UR_E070` | `motivates` | 09-Problem Scenario | harmonic pollution and low signal-to-noise ratio(Uncertainty) |  | 15-Data Preprocessing Algorithm | Chebyshev filter |  |
| 4 | `9H8NE2UR_E071` | `motivates` | 09-Problem Scenario | harmonic pollution and low signal-to-noise ratio(Uncertainty) |  | 16-Feature Extraction Algorithm | Fractional Windowed Fourier Transform |  |
| 5 | `9H8NE2UR_E072` | `motivates` | 09-Problem Scenario | harmonic pollution and low signal-to-noise ratio(Uncertainty) |  | 17-Core Classifier Algorithm | L2-metric |  |
| 6 | `9H8NE2UR_E073` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Fractional Windowed Fourier Transform |  |
| 7 | `9H8NE2UR_E074` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | L2-metric |  |
| 8 | `9H8NE2UR_E075` | `motivates` | 06-Fault Severity | one broken rotor bar(Single Severity) |  | 17-Core Classifier Algorithm | L2-metric |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `9H8NE2UR_E070`：harmonic pollution and low signal-to-noise ratio(Uncertainty) motivates Chebyshev filter
  - `9H8NE2UR_E071`：harmonic pollution and low signal-to-noise ratio(Uncertainty) motivates Fractional Windowed Fourier Transform
  - `9H8NE2UR_E072`：harmonic pollution and low signal-to-noise ratio(Uncertainty) motivates L2-metric
