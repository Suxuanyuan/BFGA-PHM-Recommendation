...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `T4ZSNRSV_E076` | `motivates` | 09-Problem Scenario | corrupted data and noise(Uncertainty) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 2 | `T4ZSNRSV_E077` | `motivates` | 09-Problem Scenario | small sampling(Small Fault Samples) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 3 | `T4ZSNRSV_E078` | `motivates` | 12-Training Data Availability | small sampling(Scarce) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 4 | `T4ZSNRSV_E079` | `motivates` | 09-Problem Scenario | corrupted data and noise(Uncertainty) |  | 17-Core Classifier Algorithm | Support Vector Classification |  |
| 5 | `T4ZSNRSV_E080` | `motivates` | 09-Problem Scenario | small sampling(Small Fault Samples) |  | 17-Core Classifier Algorithm | Support Vector Classification |  |
| 6 | `T4ZSNRSV_E081` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Support Vector Classification |  |
| 7 | `T4ZSNRSV_E082` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Support Vector Classification |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `T4ZSNRSV_E076`：corrupted data and noise(Uncertainty) motivates Particle Swarm Optimization
  - `T4ZSNRSV_E077`：small sampling(Small Fault Samples) motivates Particle Swarm Optimization
  - `T4ZSNRSV_E079`：corrupted data and noise(Uncertainty) motivates Support Vector Classification
  - `T4ZSNRSV_E080`：small sampling(Small Fault Samples) motivates Support Vector Classification
