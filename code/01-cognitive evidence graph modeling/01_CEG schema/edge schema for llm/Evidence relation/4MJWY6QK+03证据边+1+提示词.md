...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4MJWY6QK_E088` | `motivates` | 09-Problem Scenario | weak fault characteristics within a noisy background, noise robustness(Uncertainty) |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 2 | `4MJWY6QK_E089` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 3 | `4MJWY6QK_E090` | `motivates` | 13-Noise Level | noisy settings(High Noise) |  | 15-Data Preprocessing Algorithm | Frequency shift variable scale |  |
| 4 | `4MJWY6QK_E091` | `motivates` | 13-Noise Level | noisy settings(High Noise) |  | 16-Feature Extraction Algorithm | Envelope extraction |  |
| 5 | `4MJWY6QK_E092` | `motivates` | 09-Problem Scenario | weak fault characteristics within a noisy background, noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Frequency shift variable scale |  |
| 6 | `4MJWY6QK_E093` | `motivates` | 09-Problem Scenario | weak fault characteristics within a noisy background, noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Envelope extraction |  |
| 7 | `4MJWY6QK_E094` | `motivates` | 09-Problem Scenario | weak fault characteristics within a noisy background, noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | PNTSR |  |
| 8 | `4MJWY6QK_E095` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Envelope extraction |  |
| 9 | `4MJWY6QK_E096` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | PNTSR |  |
| 10 | `4MJWY6QK_E097` | `motivates` | 06-Fault Severity | slight wear(Single Severity) |  | 17-Core Classifier Algorithm | PNTSR |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4MJWY6QK_E088`：weak fault characteristics within a noisy background, noise robustness(Uncertainty) motivates Genetic Algorithm
  - `4MJWY6QK_E092`：weak fault characteristics within a noisy background, noise robustness(Uncertainty) motivates Frequency shift variable scale
  - `4MJWY6QK_E093`：weak fault characteristics within a noisy background, noise robustness(Uncertainty) motivates Envelope extraction
  - `4MJWY6QK_E094`：weak fault characteristics within a noisy background, noise robustness(Uncertainty) motivates PNTSR
