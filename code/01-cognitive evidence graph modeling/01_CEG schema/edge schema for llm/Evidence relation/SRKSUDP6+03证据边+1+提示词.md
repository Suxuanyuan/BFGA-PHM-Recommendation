...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SRKSUDP6_E075` | `motivates` | 13-Noise Level | raw acoustic emission (AE) signal(Normal) |  | 15-Data Preprocessing Algorithm | Discrete Wavelet Packet Transform |  |
| 2 | `SRKSUDP6_E076` | `motivates` | 13-Noise Level | raw acoustic emission (AE) signal(Normal) |  | 16-Feature Extraction Algorithm | Adaptive Deep Convolutional Neural Network |  |
| 3 | `SRKSUDP6_E077` | `motivates` | 09-Problem Scenario | manual fault feature extraction and sub-optimal bearing health state representation(Other) |  | 15-Data Preprocessing Algorithm | Discrete Wavelet Packet Transform |  |
| 4 | `SRKSUDP6_E078` | `motivates` | 09-Problem Scenario | low-speed bearing fault detection(Other) |  | 15-Data Preprocessing Algorithm | Discrete Wavelet Packet Transform |  |
| 5 | `SRKSUDP6_E079` | `motivates` | 09-Problem Scenario | manual fault feature extraction and sub-optimal bearing health state representation(Other) |  | 16-Feature Extraction Algorithm | Adaptive Deep Convolutional Neural Network |  |
| 6 | `SRKSUDP6_E080` | `motivates` | 09-Problem Scenario | low-speed bearing fault detection(Other) |  | 16-Feature Extraction Algorithm | Adaptive Deep Convolutional Neural Network |  |
| 7 | `SRKSUDP6_E081` | `motivates` | 09-Problem Scenario | manual fault feature extraction and sub-optimal bearing health state representation(Other) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `SRKSUDP6_E082` | `motivates` | 09-Problem Scenario | low-speed bearing fault detection(Other) |  | 17-Core Classifier Algorithm | Softmax |  |
| 9 | `SRKSUDP6_E083` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Adaptive Deep Convolutional Neural Network |  |
| 10 | `SRKSUDP6_E084` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `SRKSUDP6_E085` | `motivates` | 06-Fault Severity | crack sizes (3 mm and 12 mm)(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `SRKSUDP6_E077`：manual fault feature extraction and sub-optimal bearing health state representation(Other) motivates Discrete Wavelet Packet Transform
  - `SRKSUDP6_E078`：low-speed bearing fault detection(Other) motivates Discrete Wavelet Packet Transform
  - `SRKSUDP6_E079`：manual fault feature extraction and sub-optimal bearing health state representation(Other) motivates Adaptive Deep Convolutional Neural Network
  - `SRKSUDP6_E080`：low-speed bearing fault detection(Other) motivates Adaptive Deep Convolutional Neural Network
  - `SRKSUDP6_E081`：manual fault feature extraction and sub-optimal bearing health state representation(Other) motivates Softmax
  - `SRKSUDP6_E082`：low-speed bearing fault detection(Other) motivates Softmax
