...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `K22P4DKL_E108` | `motivates` | 12-Training Data Availability | Not explicitly mentioned as limited(Sufficient) |  | 18-Data Generation Algorithm | LS-SVM Rolling Forecast |  |
| 2 | `K22P4DKL_E109` | `motivates` | 13-Noise Level | high-frequency intermittent components and other non-Gaussian noises(High Noise) |  | 15-Data Preprocessing Algorithm | Weighted LS-SVM |  |
| 3 | `K22P4DKL_E110` | `motivates` | 13-Noise Level | high-frequency intermittent components and other non-Gaussian noises(High Noise) |  | 16-Feature Extraction Algorithm | EMD |  |
| 4 | `K22P4DKL_E111` | `motivates` | 09-Problem Scenario | high-frequency intermittent and non-Gaussian noises(Uncertainty) |  | 18-Data Generation Algorithm | LS-SVM Rolling Forecast |  |
| 5 | `K22P4DKL_E112` | `motivates` | 09-Problem Scenario | end effects of EMD(Other) |  | 18-Data Generation Algorithm | LS-SVM Rolling Forecast |  |
| 6 | `K22P4DKL_E113` | `motivates` | 09-Problem Scenario | high-frequency intermittent and non-Gaussian noises(Uncertainty) |  | 15-Data Preprocessing Algorithm | Weighted LS-SVM |  |
| 7 | `K22P4DKL_E114` | `motivates` | 09-Problem Scenario | end effects of EMD(Other) |  | 15-Data Preprocessing Algorithm | Weighted LS-SVM |  |
| 8 | `K22P4DKL_E115` | `motivates` | 09-Problem Scenario | high-frequency intermittent and non-Gaussian noises(Uncertainty) |  | 16-Feature Extraction Algorithm | EMD |  |
| 9 | `K22P4DKL_E116` | `motivates` | 09-Problem Scenario | end effects of EMD(Other) |  | 16-Feature Extraction Algorithm | EMD |  |
| 10 | `K22P4DKL_E117` | `motivates` | 09-Problem Scenario | high-frequency intermittent and non-Gaussian noises(Uncertainty) |  | 17-Core Classifier Algorithm | Hilbert Envelope Demodulation |  |
| 11 | `K22P4DKL_E118` | `motivates` | 09-Problem Scenario | end effects of EMD(Other) |  | 17-Core Classifier Algorithm | Hilbert Envelope Demodulation |  |
| 12 | `K22P4DKL_E119` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | EMD |  |
| 13 | `K22P4DKL_E120` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Hilbert Envelope Demodulation |  |
| 14 | `K22P4DKL_E121` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Hilbert Envelope Demodulation |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `K22P4DKL_E111`：high-frequency intermittent and non-Gaussian noises(Uncertainty) motivates LS-SVM Rolling Forecast
  - `K22P4DKL_E112`：end effects of EMD(Other) motivates LS-SVM Rolling Forecast
  - `K22P4DKL_E113`：high-frequency intermittent and non-Gaussian noises(Uncertainty) motivates Weighted LS-SVM
  - `K22P4DKL_E114`：end effects of EMD(Other) motivates Weighted LS-SVM
  - `K22P4DKL_E115`：high-frequency intermittent and non-Gaussian noises(Uncertainty) motivates EMD
  - `K22P4DKL_E116`：end effects of EMD(Other) motivates EMD
  - `K22P4DKL_E117`：high-frequency intermittent and non-Gaussian noises(Uncertainty) motivates Hilbert Envelope Demodulation
  - `K22P4DKL_E118`：end effects of EMD(Other) motivates Hilbert Envelope Demodulation
