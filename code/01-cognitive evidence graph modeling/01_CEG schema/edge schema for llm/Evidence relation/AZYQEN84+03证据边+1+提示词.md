...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AZYQEN84_E108` | `motivates` | 13-Noise Level | environment noise, heavy background noise(High Noise) |  | 15-Data Preprocessing Algorithm | Angular Resampling |  |
| 2 | `AZYQEN84_E109` | `motivates` | 13-Noise Level | environment noise, heavy background noise(High Noise) |  | 16-Feature Extraction Algorithm | Kanade-Lucas-Tomasi algorithm |  |
| 3 | `AZYQEN84_E110` | `motivates` | 09-Problem Scenario | combining the contactless optical- and acoustic-measurement techniques(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Angular Resampling |  |
| 4 | `AZYQEN84_E111` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | Angular Resampling |  |
| 5 | `AZYQEN84_E112` | `motivates` | 09-Problem Scenario | combining the contactless optical- and acoustic-measurement techniques(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | Kanade-Lucas-Tomasi algorithm |  |
| 6 | `AZYQEN84_E113` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 16-Feature Extraction Algorithm | Kanade-Lucas-Tomasi algorithm |  |
| 7 | `AZYQEN84_E114` | `motivates` | 09-Problem Scenario | combining the contactless optical- and acoustic-measurement techniques(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | Order Analysis |  |
| 8 | `AZYQEN84_E115` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 17-Core Classifier Algorithm | Order Analysis |  |
| 9 | `AZYQEN84_E116` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Kanade-Lucas-Tomasi algorithm |  |
| 10 | `AZYQEN84_E117` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Order Analysis |  |
| 11 | `AZYQEN84_E118` | `motivates` | 06-Fault Severity | 0.6-mm width(Single Severity) |  | 17-Core Classifier Algorithm | Order Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `AZYQEN84_E110`：combining the contactless optical- and acoustic-measurement techniques(Multi-Source Heterogeneous / Multimodal Data) motivates Angular Resampling
  - `AZYQEN84_E111`：noise interference(Uncertainty) motivates Angular Resampling
  - `AZYQEN84_E112`：combining the contactless optical- and acoustic-measurement techniques(Multi-Source Heterogeneous / Multimodal Data) motivates Kanade-Lucas-Tomasi algorithm
  - `AZYQEN84_E113`：noise interference(Uncertainty) motivates Kanade-Lucas-Tomasi algorithm
  - `AZYQEN84_E114`：combining the contactless optical- and acoustic-measurement techniques(Multi-Source Heterogeneous / Multimodal Data) motivates Order Analysis
  - `AZYQEN84_E115`：noise interference(Uncertainty) motivates Order Analysis
