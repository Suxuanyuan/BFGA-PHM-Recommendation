...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CH4BT7VU_E119` | `motivates` | 12-Training Data Availability | None(Sufficient) |  | 18-Data Generation Algorithm | Bond Graph |  |
| 2 | `CH4BT7VU_E120` | `motivates` | 13-Noise Level | low SNR value / noise dominates the signal(High Noise) |  | 15-Data Preprocessing Algorithm | EMD-IIT |  |
| 3 | `CH4BT7VU_E121` | `motivates` | 13-Noise Level | low SNR value / noise dominates the signal(High Noise) |  | 16-Feature Extraction Algorithm | Hilbert Transform |  |
| 4 | `CH4BT7VU_E122` | `motivates` | 09-Problem Scenario | noise dominates the signal in slow speed(Uncertainty) |  | 18-Data Generation Algorithm | Bond Graph |  |
| 5 | `CH4BT7VU_E123` | `motivates` | 09-Problem Scenario | variable speed operation(Other) |  | 18-Data Generation Algorithm | Bond Graph |  |
| 6 | `CH4BT7VU_E124` | `motivates` | 09-Problem Scenario | combination fault(Compound Faults) |  | 18-Data Generation Algorithm | Bond Graph |  |
| 7 | `CH4BT7VU_E125` | `motivates` | 09-Problem Scenario | noise dominates the signal in slow speed(Uncertainty) |  | 15-Data Preprocessing Algorithm | EMD-IIT |  |
| 8 | `CH4BT7VU_E126` | `motivates` | 09-Problem Scenario | variable speed operation(Other) |  | 15-Data Preprocessing Algorithm | EMD-IIT |  |
| 9 | `CH4BT7VU_E127` | `motivates` | 09-Problem Scenario | combination fault(Compound Faults) |  | 15-Data Preprocessing Algorithm | EMD-IIT |  |
| 10 | `CH4BT7VU_E128` | `motivates` | 09-Problem Scenario | noise dominates the signal in slow speed(Uncertainty) |  | 16-Feature Extraction Algorithm | Hilbert Transform |  |
| 11 | `CH4BT7VU_E129` | `motivates` | 09-Problem Scenario | variable speed operation(Other) |  | 16-Feature Extraction Algorithm | Hilbert Transform |  |
| 12 | `CH4BT7VU_E130` | `motivates` | 09-Problem Scenario | combination fault(Compound Faults) |  | 16-Feature Extraction Algorithm | Hilbert Transform |  |
| 13 | `CH4BT7VU_E131` | `motivates` | 09-Problem Scenario | noise dominates the signal in slow speed(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Order Tracking |  |
| 14 | `CH4BT7VU_E132` | `motivates` | 09-Problem Scenario | variable speed operation(Other) |  | 17-Core Classifier Algorithm | Envelope Order Tracking |  |
| 15 | `CH4BT7VU_E133` | `motivates` | 09-Problem Scenario | combination fault(Compound Faults) |  | 17-Core Classifier Algorithm | Envelope Order Tracking |  |
| 16 | `CH4BT7VU_E134` | `motivates` | 07-Compound Fault | combination (inner and outer) fault(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Hilbert Transform |  |
| 17 | `CH4BT7VU_E135` | `motivates` | 07-Compound Fault | combination (inner and outer) fault(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Envelope Order Tracking |  |
| 18 | `CH4BT7VU_E136` | `motivates` | 06-Fault Severity | penetration depth Cd = Cdb = 1 mm, width = 3.0 mm(Single Severity) |  | 17-Core Classifier Algorithm | Envelope Order Tracking |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `CH4BT7VU_E122`：noise dominates the signal in slow speed(Uncertainty) motivates Bond Graph
  - `CH4BT7VU_E123`：variable speed operation(Other) motivates Bond Graph
  - `CH4BT7VU_E124`：combination fault(Compound Faults) motivates Bond Graph
  - `CH4BT7VU_E125`：noise dominates the signal in slow speed(Uncertainty) motivates EMD-IIT
  - `CH4BT7VU_E126`：variable speed operation(Other) motivates EMD-IIT
  - `CH4BT7VU_E127`：combination fault(Compound Faults) motivates EMD-IIT
  - `CH4BT7VU_E128`：noise dominates the signal in slow speed(Uncertainty) motivates Hilbert Transform
  - `CH4BT7VU_E129`：variable speed operation(Other) motivates Hilbert Transform
  - `CH4BT7VU_E130`：combination fault(Compound Faults) motivates Hilbert Transform
  - `CH4BT7VU_E131`：noise dominates the signal in slow speed(Uncertainty) motivates Envelope Order Tracking
  - `CH4BT7VU_E132`：variable speed operation(Other) motivates Envelope Order Tracking
  - `CH4BT7VU_E133`：combination fault(Compound Faults) motivates Envelope Order Tracking
