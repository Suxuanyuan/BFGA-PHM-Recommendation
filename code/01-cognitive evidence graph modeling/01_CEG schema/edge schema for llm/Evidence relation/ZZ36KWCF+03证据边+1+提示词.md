...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZZ36KWCF_E112` | `motivates` | 13-Noise Level | highly noised vibration signals(High Noise) |  | 16-Feature Extraction Algorithm | DRSN-CW |  |
| 2 | `ZZ36KWCF_E113` | `motivates` | 09-Problem Scenario | noise robustness / highly noised vibration signals(Uncertainty) |  | 16-Feature Extraction Algorithm | DRSN-CW |  |
| 3 | `ZZ36KWCF_E114` | `motivates` | 09-Problem Scenario | noise robustness / highly noised vibration signals(Uncertainty) |  | 17-Core Classifier Algorithm | Softmax |  |
| 4 | `ZZ36KWCF_E115` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | DRSN-CW |  |
| 5 | `ZZ36KWCF_E116` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 6 | `ZZ36KWCF_E117` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZZ36KWCF_E113`：noise robustness / highly noised vibration signals(Uncertainty) motivates DRSN-CW
  - `ZZ36KWCF_E114`：noise robustness / highly noised vibration signals(Uncertainty) motivates Softmax
