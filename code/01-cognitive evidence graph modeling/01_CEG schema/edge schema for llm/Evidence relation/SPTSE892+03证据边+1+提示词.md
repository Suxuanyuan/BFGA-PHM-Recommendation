...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SPTSE892_E096` | `motivates` | 13-Noise Level | strong background noise(High Noise) |  | 15-Data Preprocessing Algorithm | TQWT |  |
| 2 | `SPTSE892_E097` | `motivates` | 13-Noise Level | strong background noise(High Noise) |  | 16-Feature Extraction Algorithm | WMSDL |  |
| 3 | `SPTSE892_E098` | `motivates` | 09-Problem Scenario | strong background noise and harmonic interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | TQWT |  |
| 4 | `SPTSE892_E099` | `motivates` | 09-Problem Scenario | early stage of fault(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | TQWT |  |
| 5 | `SPTSE892_E100` | `motivates` | 09-Problem Scenario | strong background noise and harmonic interference(Uncertainty) |  | 16-Feature Extraction Algorithm | WMSDL |  |
| 6 | `SPTSE892_E101` | `motivates` | 09-Problem Scenario | early stage of fault(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | WMSDL |  |
| 7 | `SPTSE892_E102` | `motivates` | 09-Problem Scenario | strong background noise and harmonic interference(Uncertainty) |  | 17-Core Classifier Algorithm | Square Envelope Spectrum |  |
| 8 | `SPTSE892_E103` | `motivates` | 09-Problem Scenario | early stage of fault(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Square Envelope Spectrum |  |
| 9 | `SPTSE892_E104` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | WMSDL |  |
| 10 | `SPTSE892_E105` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Square Envelope Spectrum |  |
| 11 | `SPTSE892_E106` | `motivates` | 06-Fault Severity | early stage, medium stage, failure stage, diameter equal to 1 mm(Multiple Severities) |  | 17-Core Classifier Algorithm | Square Envelope Spectrum |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `SPTSE892_E098`：strong background noise and harmonic interference(Uncertainty) motivates TQWT
  - `SPTSE892_E099`：early stage of fault(Early Degradation Prediction) motivates TQWT
  - `SPTSE892_E100`：strong background noise and harmonic interference(Uncertainty) motivates WMSDL
  - `SPTSE892_E101`：early stage of fault(Early Degradation Prediction) motivates WMSDL
  - `SPTSE892_E102`：strong background noise and harmonic interference(Uncertainty) motivates Square Envelope Spectrum
  - `SPTSE892_E103`：early stage of fault(Early Degradation Prediction) motivates Square Envelope Spectrum
