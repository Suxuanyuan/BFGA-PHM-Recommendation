...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WJI4RP9W_E118` | `motivates` | 09-Problem Scenario | uncertainties or incomplete and conflicting information(Uncertainty) |  | 19-Training Optimization Algorithm | Lexicographic Approach |  |
| 2 | `WJI4RP9W_E119` | `motivates` | 09-Problem Scenario | multiple heterogeneous Fault Detection and Diagnosis (FDD) methods(Multi-Source Heterogeneous / Multimodal Data) |  | 19-Training Optimization Algorithm | Lexicographic Approach |  |
| 3 | `WJI4RP9W_E120` | `motivates` | 12-Training Data Availability | training and test data sets(Sufficient) |  | 19-Training Optimization Algorithm | Lexicographic Approach |  |
| 4 | `WJI4RP9W_E121` | `motivates` | 09-Problem Scenario | uncertainties or incomplete and conflicting information(Uncertainty) |  | 17-Core Classifier Algorithm | Bayesian Network |  |
| 5 | `WJI4RP9W_E122` | `motivates` | 09-Problem Scenario | multiple heterogeneous Fault Detection and Diagnosis (FDD) methods(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | Bayesian Network |  |
| 6 | `WJI4RP9W_E123` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Bayesian Network |  |
| 7 | `WJI4RP9W_E124` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Bayesian Network |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `WJI4RP9W_E118`：uncertainties or incomplete and conflicting information(Uncertainty) motivates Lexicographic Approach
  - `WJI4RP9W_E119`：multiple heterogeneous Fault Detection and Diagnosis (FDD) methods(Multi-Source Heterogeneous / Multimodal Data) motivates Lexicographic Approach
  - `WJI4RP9W_E121`：uncertainties or incomplete and conflicting information(Uncertainty) motivates Bayesian Network
  - `WJI4RP9W_E122`：multiple heterogeneous Fault Detection and Diagnosis (FDD) methods(Multi-Source Heterogeneous / Multimodal Data) motivates Bayesian Network
