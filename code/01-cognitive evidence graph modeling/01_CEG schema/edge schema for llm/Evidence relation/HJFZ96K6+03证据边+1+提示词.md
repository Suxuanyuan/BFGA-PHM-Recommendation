...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HJFZ96K6_E102` | `motivates` | 13-Noise Level | heavy background noise(High Noise) |  | 16-Feature Extraction Algorithm | 1D CNN |  |
| 2 | `HJFZ96K6_E103` | `motivates` | 09-Problem Scenario | varying working conditions / domain shift(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | 1D CNN |  |
| 3 | `HJFZ96K6_E104` | `motivates` | 09-Problem Scenario | bearing and gear compound fault(Compound Faults) |  | 16-Feature Extraction Algorithm | 1D CNN |  |
| 4 | `HJFZ96K6_E105` | `motivates` | 09-Problem Scenario | varying working conditions / domain shift(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | WSCN |  |
| 5 | `HJFZ96K6_E106` | `motivates` | 09-Problem Scenario | bearing and gear compound fault(Compound Faults) |  | 17-Core Classifier Algorithm | WSCN |  |
| 6 | `HJFZ96K6_E107` | `motivates` | 07-Compound Fault | bearing and gear compound fault(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | 1D CNN |  |
| 7 | `HJFZ96K6_E108` | `motivates` | 07-Compound Fault | bearing and gear compound fault(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | WSCN |  |
| 8 | `HJFZ96K6_E109` | `motivates` | 06-Fault Severity | Fault Size (7, 14, 21 * 10^-3 inches)(Multiple Severities) |  | 17-Core Classifier Algorithm | WSCN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `HJFZ96K6_E103`：varying working conditions / domain shift(Distribution Discrepancy) motivates 1D CNN
  - `HJFZ96K6_E104`：bearing and gear compound fault(Compound Faults) motivates 1D CNN
  - `HJFZ96K6_E105`：varying working conditions / domain shift(Distribution Discrepancy) motivates WSCN
  - `HJFZ96K6_E106`：bearing and gear compound fault(Compound Faults) motivates WSCN
