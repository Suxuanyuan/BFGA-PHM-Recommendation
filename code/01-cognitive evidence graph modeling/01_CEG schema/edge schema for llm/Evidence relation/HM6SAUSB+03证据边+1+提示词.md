...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HM6SAUSB_E091` | `motivates` | 13-Noise Level | strong background noises(High Noise) |  | 15-Data Preprocessing Algorithm | EEMD |  |
| 2 | `HM6SAUSB_E092` | `motivates` | 13-Noise Level | strong background noises(High Noise) |  | 16-Feature Extraction Algorithm | TQWT |  |
| 3 | `HM6SAUSB_E093` | `motivates` | 09-Problem Scenario | early weak fault(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | EEMD |  |
| 4 | `HM6SAUSB_E094` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | EEMD |  |
| 5 | `HM6SAUSB_E095` | `motivates` | 09-Problem Scenario | early weak fault(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | TQWT |  |
| 6 | `HM6SAUSB_E096` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | TQWT |  |
| 7 | `HM6SAUSB_E097` | `motivates` | 09-Problem Scenario | early weak fault(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Envelope Demodulation |  |
| 8 | `HM6SAUSB_E098` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Demodulation |  |
| 9 | `HM6SAUSB_E099` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | TQWT |  |
| 10 | `HM6SAUSB_E100` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope Demodulation |  |
| 11 | `HM6SAUSB_E101` | `motivates` | 06-Fault Severity | point corrosions of 0.18 mm diameter and whole life degradation(Multiple Severities) |  | 17-Core Classifier Algorithm | Envelope Demodulation |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `HM6SAUSB_E093`：early weak fault(Early Degradation Prediction) motivates EEMD
  - `HM6SAUSB_E094`：strong background noise(Uncertainty) motivates EEMD
  - `HM6SAUSB_E095`：early weak fault(Early Degradation Prediction) motivates TQWT
  - `HM6SAUSB_E096`：strong background noise(Uncertainty) motivates TQWT
  - `HM6SAUSB_E097`：early weak fault(Early Degradation Prediction) motivates Envelope Demodulation
  - `HM6SAUSB_E098`：strong background noise(Uncertainty) motivates Envelope Demodulation
