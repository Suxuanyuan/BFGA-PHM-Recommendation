...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `884N5BW8_E136` | `motivates` | 12-Training Data Availability | N/A (Model-based approach)(Sufficient) |  | 18-Data Generation Algorithm | GSP |  |
| 2 | `884N5BW8_E137` | `motivates` | 09-Problem Scenario | multiple concurrent faults(Compound Faults) |  | 18-Data Generation Algorithm | GSP |  |
| 3 | `884N5BW8_E138` | `motivates` | 09-Problem Scenario | measurement noise outliers(Uncertainty) |  | 18-Data Generation Algorithm | GSP |  |
| 4 | `884N5BW8_E139` | `motivates` | 09-Problem Scenario | sensor failure and configuration reduction(Other) |  | 18-Data Generation Algorithm | GSP |  |
| 5 | `884N5BW8_E140` | `motivates` | 09-Problem Scenario | multiple concurrent faults(Compound Faults) |  | 17-Core Classifier Algorithm | Kalman Filter |  |
| 6 | `884N5BW8_E141` | `motivates` | 09-Problem Scenario | measurement noise outliers(Uncertainty) |  | 17-Core Classifier Algorithm | Kalman Filter |  |
| 7 | `884N5BW8_E142` | `motivates` | 09-Problem Scenario | sensor failure and configuration reduction(Other) |  | 17-Core Classifier Algorithm | Kalman Filter |  |
| 8 | `884N5BW8_E143` | `motivates` | 07-Compound Fault | concurrent faults(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | Kalman Filter |  |
| 9 | `884N5BW8_E144` | `motivates` | 06-Fault Severity | 2% and 5% degradation levels(Multiple Severities) |  | 17-Core Classifier Algorithm | Kalman Filter |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `884N5BW8_E137`：multiple concurrent faults(Compound Faults) motivates GSP
  - `884N5BW8_E138`：measurement noise outliers(Uncertainty) motivates GSP
  - `884N5BW8_E139`：sensor failure and configuration reduction(Other) motivates GSP
  - `884N5BW8_E140`：multiple concurrent faults(Compound Faults) motivates Kalman Filter
  - `884N5BW8_E141`：measurement noise outliers(Uncertainty) motivates Kalman Filter
  - `884N5BW8_E142`：sensor failure and configuration reduction(Other) motivates Kalman Filter
