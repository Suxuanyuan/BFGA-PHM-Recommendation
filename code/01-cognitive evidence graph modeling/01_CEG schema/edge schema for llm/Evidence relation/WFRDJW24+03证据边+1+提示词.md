...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WFRDJW24_E114` | `motivates` | 12-Training Data Availability | Sufficient |  | 18-Data Generation Algorithm | Runge-Kutta method |  |
| 2 | `WFRDJW24_E115` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Fast Kurtogram |  |
| 3 | `WFRDJW24_E116` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Spectral DCS |  |
| 4 | `WFRDJW24_E117` | `motivates` | 09-Problem Scenario | pseudo-fault caused by coupling effect of components(Complex Systems) |  | 18-Data Generation Algorithm | Runge-Kutta method |  |
| 5 | `WFRDJW24_E118` | `motivates` | 09-Problem Scenario | decouple pseudo-fault feature by single-channel signal(Other) |  | 18-Data Generation Algorithm | Runge-Kutta method |  |
| 6 | `WFRDJW24_E119` | `motivates` | 09-Problem Scenario | pseudo-fault caused by coupling effect of components(Complex Systems) |  | 15-Data Preprocessing Algorithm | Fast Kurtogram |  |
| 7 | `WFRDJW24_E120` | `motivates` | 09-Problem Scenario | decouple pseudo-fault feature by single-channel signal(Other) |  | 15-Data Preprocessing Algorithm | Fast Kurtogram |  |
| 8 | `WFRDJW24_E121` | `motivates` | 09-Problem Scenario | pseudo-fault caused by coupling effect of components(Complex Systems) |  | 16-Feature Extraction Algorithm | Spectral DCS |  |
| 9 | `WFRDJW24_E122` | `motivates` | 09-Problem Scenario | decouple pseudo-fault feature by single-channel signal(Other) |  | 16-Feature Extraction Algorithm | Spectral DCS |  |
| 10 | `WFRDJW24_E123` | `motivates` | 09-Problem Scenario | pseudo-fault caused by coupling effect of components(Complex Systems) |  | 17-Core Classifier Algorithm | Linear fitting |  |
| 11 | `WFRDJW24_E124` | `motivates` | 09-Problem Scenario | decouple pseudo-fault feature by single-channel signal(Other) |  | 17-Core Classifier Algorithm | Linear fitting |  |
| 12 | `WFRDJW24_E125` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Spectral DCS |  |
| 13 | `WFRDJW24_E126` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Linear fitting |  |
| 14 | `WFRDJW24_E127` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Linear fitting |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `WFRDJW24_E117`：pseudo-fault caused by coupling effect of components(Complex Systems) motivates Runge-Kutta method
  - `WFRDJW24_E118`：decouple pseudo-fault feature by single-channel signal(Other) motivates Runge-Kutta method
  - `WFRDJW24_E119`：pseudo-fault caused by coupling effect of components(Complex Systems) motivates Fast Kurtogram
  - `WFRDJW24_E120`：decouple pseudo-fault feature by single-channel signal(Other) motivates Fast Kurtogram
  - `WFRDJW24_E121`：pseudo-fault caused by coupling effect of components(Complex Systems) motivates Spectral DCS
  - `WFRDJW24_E122`：decouple pseudo-fault feature by single-channel signal(Other) motivates Spectral DCS
  - `WFRDJW24_E123`：pseudo-fault caused by coupling effect of components(Complex Systems) motivates Linear fitting
  - `WFRDJW24_E124`：decouple pseudo-fault feature by single-channel signal(Other) motivates Linear fitting
