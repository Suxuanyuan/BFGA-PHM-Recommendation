...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `P6LXQZF8_E130` | `motivates` | 09-Problem Scenario | weak fault features of incipient soft faults(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | Sine Cosine Algorithm |  |
| 2 | `P6LXQZF8_E131` | `motivates` | 09-Problem Scenario | component tolerances cause state overlap(Uncertainty) |  | 19-Training Optimization Algorithm | Sine Cosine Algorithm |  |
| 3 | `P6LXQZF8_E132` | `motivates` | 12-Training Data Availability | 200 signal samples are generated for each fault class(Sufficient) |  | 19-Training Optimization Algorithm | Sine Cosine Algorithm |  |
| 4 | `P6LXQZF8_E133` | `motivates` | 13-Noise Level | normal(Normal) |  | 15-Data Preprocessing Algorithm | Wavelet Packet Transform |  |
| 5 | `P6LXQZF8_E134` | `motivates` | 13-Noise Level | normal(Normal) |  | 16-Feature Extraction Algorithm | Generalized Discriminant Analysis |  |
| 6 | `P6LXQZF8_E135` | `motivates` | 09-Problem Scenario | weak fault features of incipient soft faults(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Wavelet Packet Transform |  |
| 7 | `P6LXQZF8_E136` | `motivates` | 09-Problem Scenario | component tolerances cause state overlap(Uncertainty) |  | 15-Data Preprocessing Algorithm | Wavelet Packet Transform |  |
| 8 | `P6LXQZF8_E137` | `motivates` | 09-Problem Scenario | weak fault features of incipient soft faults(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Generalized Discriminant Analysis |  |
| 9 | `P6LXQZF8_E138` | `motivates` | 09-Problem Scenario | component tolerances cause state overlap(Uncertainty) |  | 16-Feature Extraction Algorithm | Generalized Discriminant Analysis |  |
| 10 | `P6LXQZF8_E139` | `motivates` | 09-Problem Scenario | weak fault features of incipient soft faults(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | GMKL-SVM |  |
| 11 | `P6LXQZF8_E140` | `motivates` | 09-Problem Scenario | component tolerances cause state overlap(Uncertainty) |  | 17-Core Classifier Algorithm | GMKL-SVM |  |
| 12 | `P6LXQZF8_E141` | `motivates` | 07-Compound Fault | single-variation faults(No Compound Fault) |  | 16-Feature Extraction Algorithm | Generalized Discriminant Analysis |  |
| 13 | `P6LXQZF8_E142` | `motivates` | 07-Compound Fault | single-variation faults(No Compound Fault) |  | 17-Core Classifier Algorithm | GMKL-SVM |  |
| 14 | `P6LXQZF8_E143` | `motivates` | 06-Fault Severity | 30% deviation from nominal value(Single Severity) |  | 17-Core Classifier Algorithm | GMKL-SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `P6LXQZF8_E130`：weak fault features of incipient soft faults(Early Degradation Prediction) motivates Sine Cosine Algorithm
  - `P6LXQZF8_E131`：component tolerances cause state overlap(Uncertainty) motivates Sine Cosine Algorithm
  - `P6LXQZF8_E135`：weak fault features of incipient soft faults(Early Degradation Prediction) motivates Wavelet Packet Transform
  - `P6LXQZF8_E136`：component tolerances cause state overlap(Uncertainty) motivates Wavelet Packet Transform
  - `P6LXQZF8_E137`：weak fault features of incipient soft faults(Early Degradation Prediction) motivates Generalized Discriminant Analysis
  - `P6LXQZF8_E138`：component tolerances cause state overlap(Uncertainty) motivates Generalized Discriminant Analysis
  - `P6LXQZF8_E139`：weak fault features of incipient soft faults(Early Degradation Prediction) motivates GMKL-SVM
  - `P6LXQZF8_E140`：component tolerances cause state overlap(Uncertainty) motivates GMKL-SVM
