...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `K9WZZP4T_E048` | `motivates` | 09-Problem Scenario | Model uncertainties and parameter variations(Uncertainty) |  | 17-Core Classifier Algorithm | Luenberger observer |  |
| 2 | `K9WZZP4T_E049` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Luenberger observer |  |
| 3 | `K9WZZP4T_E050` | `motivates` | 06-Fault Severity | 5 degrees, larger phase shift(Multiple Severities) |  | 17-Core Classifier Algorithm | Luenberger observer |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `K9WZZP4T_E048`：Model uncertainties and parameter variations(Uncertainty) motivates Luenberger observer
...
*This prompt is automatically generated by edge_03_prompt.py (Batch 1, total 3 edges)*
