...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4ESDG5PN_E096` | `motivates` | 09-Problem Scenario | strong background noise environment(Uncertainty) |  | 19-Training Optimization Algorithm | Group Searching Method |  |
| 2 | `4ESDG5PN_E097` | `motivates` | 12-Training Data Availability | The training sets consist of 2800 observations(Sufficient) |  | 19-Training Optimization Algorithm | Group Searching Method |  |
| 3 | `4ESDG5PN_E098` | `motivates` | 13-Noise Level | strong background noise environment(High Noise) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 4 | `4ESDG5PN_E099` | `motivates` | 13-Noise Level | strong background noise environment(High Noise) |  | 16-Feature Extraction Algorithm | IDRSN |  |
| 5 | `4ESDG5PN_E100` | `motivates` | 09-Problem Scenario | strong background noise environment(Uncertainty) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 6 | `4ESDG5PN_E101` | `motivates` | 09-Problem Scenario | strong background noise environment(Uncertainty) |  | 16-Feature Extraction Algorithm | IDRSN |  |
| 7 | `4ESDG5PN_E102` | `motivates` | 09-Problem Scenario | strong background noise environment(Uncertainty) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `4ESDG5PN_E103` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | IDRSN |  |
| 9 | `4ESDG5PN_E104` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 10 | `4ESDG5PN_E105` | `motivates` | 06-Fault Severity | 7 mils, 14 mils, 21 mils(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4ESDG5PN_E096`：strong background noise environment(Uncertainty) motivates Group Searching Method
  - `4ESDG5PN_E100`：strong background noise environment(Uncertainty) motivates Min-Max Normalization
  - `4ESDG5PN_E101`：strong background noise environment(Uncertainty) motivates IDRSN
  - `4ESDG5PN_E102`：strong background noise environment(Uncertainty) motivates Softmax
