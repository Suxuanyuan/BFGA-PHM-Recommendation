...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PTV3IF2V_E080` | `motivates` | 13-Noise Level | remove the impact of noise(High Noise) |  | 15-Data Preprocessing Algorithm | PSO-VMD |  |
| 2 | `PTV3IF2V_E081` | `motivates` | 13-Noise Level | remove the impact of noise(High Noise) |  | 16-Feature Extraction Algorithm | RCMFDE |  |
| 3 | `PTV3IF2V_E082` | `motivates` | 09-Problem Scenario | weak fault features and noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | PSO-VMD |  |
| 4 | `PTV3IF2V_E083` | `motivates` | 09-Problem Scenario | weak fault features and noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | RCMFDE |  |
| 5 | `PTV3IF2V_E084` | `motivates` | 09-Problem Scenario | weak fault features and noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | PSO-SVM |  |
| 6 | `PTV3IF2V_E085` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | RCMFDE |  |
| 7 | `PTV3IF2V_E086` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | PSO-SVM |  |
| 8 | `PTV3IF2V_E087` | `motivates` | 06-Fault Severity | single plunger loose slipper, double plungers loose slipper(Multiple Severities) |  | 17-Core Classifier Algorithm | PSO-SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `PTV3IF2V_E082`：weak fault features and noise robustness(Uncertainty) motivates PSO-VMD
  - `PTV3IF2V_E083`：weak fault features and noise robustness(Uncertainty) motivates RCMFDE
  - `PTV3IF2V_E084`：weak fault features and noise robustness(Uncertainty) motivates PSO-SVM
