...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DU4MTNUH_E076` | `motivates` | 13-Noise Level | contaminated by strong background noise(High Noise) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 2 | `DU4MTNUH_E077` | `motivates` | 13-Noise Level | contaminated by strong background noise(High Noise) |  | 16-Feature Extraction Algorithm | SDMP |  |
| 3 | `DU4MTNUH_E078` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 4 | `DU4MTNUH_E079` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | SDMP |  |
| 5 | `DU4MTNUH_E080` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | LS-SVM |  |
| 6 | `DU4MTNUH_E081` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | SDMP |  |
| 7 | `DU4MTNUH_E082` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | LS-SVM |  |
| 8 | `DU4MTNUH_E083` | `motivates` | 06-Fault Severity | diameter of 0.007 in, depth of 0.011 in(Single Severity) |  | 17-Core Classifier Algorithm | LS-SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `DU4MTNUH_E078`：noise robustness(Uncertainty) motivates Normalization
  - `DU4MTNUH_E079`：noise robustness(Uncertainty) motivates SDMP
  - `DU4MTNUH_E080`：noise robustness(Uncertainty) motivates LS-SVM
