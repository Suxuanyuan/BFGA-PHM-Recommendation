...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WLP8JFHE_E089` | `motivates` | 12-Training Data Availability | FBS load flow and algebraic equations(Sufficient) |  | 18-Data Generation Algorithm | Matlab/Simulink Simulation |  |
| 2 | `WLP8JFHE_E090` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Symmetrical Component Method |  |
| 3 | `WLP8JFHE_E091` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Curve Fitting |  |
| 4 | `WLP8JFHE_E092` | `motivates` | 09-Problem Scenario | multi-response of impedance-based fault location due to network configuration(Complex Systems) |  | 18-Data Generation Algorithm | Matlab/Simulink Simulation |  |
| 5 | `WLP8JFHE_E093` | `motivates` | 09-Problem Scenario | multi-response of impedance-based fault location due to network configuration(Complex Systems) |  | 15-Data Preprocessing Algorithm | Symmetrical Component Method |  |
| 6 | `WLP8JFHE_E094` | `motivates` | 09-Problem Scenario | multi-response of impedance-based fault location due to network configuration(Complex Systems) |  | 16-Feature Extraction Algorithm | Curve Fitting |  |
| 7 | `WLP8JFHE_E095` | `motivates` | 09-Problem Scenario | multi-response of impedance-based fault location due to network configuration(Complex Systems) |  | 17-Core Classifier Algorithm | Voltage Sag Matching Algorithm |  |
| 8 | `WLP8JFHE_E096` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Curve Fitting |  |
| 9 | `WLP8JFHE_E097` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Voltage Sag Matching Algorithm |  |
| 10 | `WLP8JFHE_E098` | `motivates` | 06-Fault Severity | fault resistance(Multiple Severities) |  | 17-Core Classifier Algorithm | Voltage Sag Matching Algorithm |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `WLP8JFHE_E092`：multi-response of impedance-based fault location due to network configuration(Complex Systems) motivates Matlab/Simulink Simulation
  - `WLP8JFHE_E093`：multi-response of impedance-based fault location due to network configuration(Complex Systems) motivates Symmetrical Component Method
  - `WLP8JFHE_E094`：multi-response of impedance-based fault location due to network configuration(Complex Systems) motivates Curve Fitting
  - `WLP8JFHE_E095`：multi-response of impedance-based fault location due to network configuration(Complex Systems) motivates Voltage Sag Matching Algorithm
