...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `KNSPWWAX_E088` | `motivates` | 13-Noise Level | signals contaminated with noise(High Noise) |  | 15-Data Preprocessing Algorithm | Improved Local Mean Decomposition |  |
| 2 | `KNSPWWAX_E089` | `motivates` | 13-Noise Level | signals contaminated with noise(High Noise) |  | 16-Feature Extraction Algorithm | Envelope Demodulation |  |
| 3 | `KNSPWWAX_E090` | `motivates` | 09-Problem Scenario | nonlinearity and nonstationarity of vibration signals(Other) |  | 15-Data Preprocessing Algorithm | Improved Local Mean Decomposition |  |
| 4 | `KNSPWWAX_E091` | `motivates` | 09-Problem Scenario | signals contaminated with noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Improved Local Mean Decomposition |  |
| 5 | `KNSPWWAX_E092` | `motivates` | 09-Problem Scenario | nonlinearity and nonstationarity of vibration signals(Other) |  | 16-Feature Extraction Algorithm | Envelope Demodulation |  |
| 6 | `KNSPWWAX_E093` | `motivates` | 09-Problem Scenario | signals contaminated with noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Envelope Demodulation |  |
| 7 | `KNSPWWAX_E094` | `motivates` | 09-Problem Scenario | nonlinearity and nonstationarity of vibration signals(Other) |  | 17-Core Classifier Algorithm | Spectral Peak Identification |  |
| 8 | `KNSPWWAX_E095` | `motivates` | 09-Problem Scenario | signals contaminated with noise(Uncertainty) |  | 17-Core Classifier Algorithm | Spectral Peak Identification |  |
| 9 | `KNSPWWAX_E096` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Envelope Demodulation |  |
| 10 | `KNSPWWAX_E097` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Spectral Peak Identification |  |
| 11 | `KNSPWWAX_E098` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Spectral Peak Identification |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `KNSPWWAX_E090`：nonlinearity and nonstationarity of vibration signals(Other) motivates Improved Local Mean Decomposition
  - `KNSPWWAX_E091`：signals contaminated with noise(Uncertainty) motivates Improved Local Mean Decomposition
  - `KNSPWWAX_E092`：nonlinearity and nonstationarity of vibration signals(Other) motivates Envelope Demodulation
  - `KNSPWWAX_E093`：signals contaminated with noise(Uncertainty) motivates Envelope Demodulation
  - `KNSPWWAX_E094`：nonlinearity and nonstationarity of vibration signals(Other) motivates Spectral Peak Identification
  - `KNSPWWAX_E095`：signals contaminated with noise(Uncertainty) motivates Spectral Peak Identification
