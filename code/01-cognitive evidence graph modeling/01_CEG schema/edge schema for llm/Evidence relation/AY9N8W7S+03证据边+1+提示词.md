...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AY9N8W7S_E079` | `motivates` | 13-Noise Level | whelmed by noise, SNR -13 dB, heavy background noise(High Noise) |  | 15-Data Preprocessing Algorithm | SVD |  |
| 2 | `AY9N8W7S_E080` | `motivates` | 13-Noise Level | whelmed by noise, SNR -13 dB, heavy background noise(High Noise) |  | 16-Feature Extraction Algorithm | TEO |  |
| 3 | `AY9N8W7S_E081` | `motivates` | 09-Problem Scenario | early defect / incipient fault(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | SVD |  |
| 4 | `AY9N8W7S_E082` | `motivates` | 09-Problem Scenario | heavy background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | SVD |  |
| 5 | `AY9N8W7S_E083` | `motivates` | 09-Problem Scenario | early defect / incipient fault(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | TEO |  |
| 6 | `AY9N8W7S_E084` | `motivates` | 09-Problem Scenario | heavy background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | TEO |  |
| 7 | `AY9N8W7S_E085` | `motivates` | 09-Problem Scenario | early defect / incipient fault(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | TEO Spectrum Analysis |  |
| 8 | `AY9N8W7S_E086` | `motivates` | 09-Problem Scenario | heavy background noise(Uncertainty) |  | 17-Core Classifier Algorithm | TEO Spectrum Analysis |  |
| 9 | `AY9N8W7S_E087` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | TEO |  |
| 10 | `AY9N8W7S_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | TEO Spectrum Analysis |  |
| 11 | `AY9N8W7S_E089` | `motivates` | 06-Fault Severity | run-to-failure(Multiple Severities) |  | 17-Core Classifier Algorithm | TEO Spectrum Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `AY9N8W7S_E081`：early defect / incipient fault(Early Degradation Prediction) motivates SVD
  - `AY9N8W7S_E082`：heavy background noise(Uncertainty) motivates SVD
  - `AY9N8W7S_E083`：early defect / incipient fault(Early Degradation Prediction) motivates TEO
  - `AY9N8W7S_E084`：heavy background noise(Uncertainty) motivates TEO
  - `AY9N8W7S_E085`：early defect / incipient fault(Early Degradation Prediction) motivates TEO Spectrum Analysis
  - `AY9N8W7S_E086`：heavy background noise(Uncertainty) motivates TEO Spectrum Analysis
