...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZWXHI3E5_E100` | `motivates` | 13-Noise Level | Gaussian noise / highly noisy vibration signal(High Noise) |  | 16-Feature Extraction Algorithm | TFDG |  |
| 2 | `ZWXHI3E5_E101` | `motivates` | 09-Problem Scenario | low signal-to-noise ratio / noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | TFDG |  |
| 3 | `ZWXHI3E5_E102` | `motivates` | 09-Problem Scenario | nonstationary signals(Other) |  | 16-Feature Extraction Algorithm | TFDG |  |
| 4 | `ZWXHI3E5_E103` | `motivates` | 09-Problem Scenario | low signal-to-noise ratio / noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | MUSIC |  |
| 5 | `ZWXHI3E5_E104` | `motivates` | 09-Problem Scenario | nonstationary signals(Other) |  | 17-Core Classifier Algorithm | MUSIC |  |
| 6 | `ZWXHI3E5_E105` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | TFDG |  |
| 7 | `ZWXHI3E5_E106` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | MUSIC |  |
| 8 | `ZWXHI3E5_E107` | `motivates` | 06-Fault Severity | one broken rotor bar, two broken bars(Multiple Severities) |  | 17-Core Classifier Algorithm | MUSIC |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZWXHI3E5_E101`：low signal-to-noise ratio / noise robustness(Uncertainty) motivates TFDG
  - `ZWXHI3E5_E102`：nonstationary signals(Other) motivates TFDG
  - `ZWXHI3E5_E103`：low signal-to-noise ratio / noise robustness(Uncertainty) motivates MUSIC
  - `ZWXHI3E5_E104`：nonstationary signals(Other) motivates MUSIC
