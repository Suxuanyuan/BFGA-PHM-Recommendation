...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `6H7DPIJL_E075` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | KICA |  |
| 2 | `6H7DPIJL_E076` | `motivates` | 09-Problem Scenario | process control and recycle loops in process flowsheets(Complex Systems) |  | 16-Feature Extraction Algorithm | KICA |  |
| 3 | `6H7DPIJL_E077` | `motivates` | 09-Problem Scenario | nonlinear and non-Gaussian process variables(Other) |  | 16-Feature Extraction Algorithm | KICA |  |
| 4 | `6H7DPIJL_E078` | `motivates` | 09-Problem Scenario | process control and recycle loops in process flowsheets(Complex Systems) |  | 17-Core Classifier Algorithm | KICAFR |  |
| 5 | `6H7DPIJL_E079` | `motivates` | 09-Problem Scenario | nonlinear and non-Gaussian process variables(Other) |  | 17-Core Classifier Algorithm | KICAFR |  |
| 6 | `6H7DPIJL_E080` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | KICA |  |
| 7 | `6H7DPIJL_E081` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | KICAFR |  |
| 8 | `6H7DPIJL_E082` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | KICAFR |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `6H7DPIJL_E076`：process control and recycle loops in process flowsheets(Complex Systems) motivates KICA
  - `6H7DPIJL_E077`：nonlinear and non-Gaussian process variables(Other) motivates KICA
  - `6H7DPIJL_E078`：process control and recycle loops in process flowsheets(Complex Systems) motivates KICAFR
  - `6H7DPIJL_E079`：nonlinear and non-Gaussian process variables(Other) motivates KICAFR
