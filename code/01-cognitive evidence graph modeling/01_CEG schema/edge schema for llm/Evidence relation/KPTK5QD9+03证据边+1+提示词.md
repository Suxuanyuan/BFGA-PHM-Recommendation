...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `KPTK5QD9_E095` | `motivates` | 13-Noise Level | external disturbance(High Noise) |  | 15-Data Preprocessing Algorithm | Persistence Time Constraint |  |
| 2 | `KPTK5QD9_E096` | `motivates` | 13-Noise Level | external disturbance(High Noise) |  | 16-Feature Extraction Algorithm | Fractal Box Dimension |  |
| 3 | `KPTK5QD9_E097` | `motivates` | 09-Problem Scenario | general uncertainty and external disturbance(Uncertainty) |  | 15-Data Preprocessing Algorithm | Persistence Time Constraint |  |
| 4 | `KPTK5QD9_E098` | `motivates` | 09-Problem Scenario | strong non-linearity and high multivariate coupling(Complex Systems) |  | 15-Data Preprocessing Algorithm | Persistence Time Constraint |  |
| 5 | `KPTK5QD9_E099` | `motivates` | 09-Problem Scenario | general uncertainty and external disturbance(Uncertainty) |  | 16-Feature Extraction Algorithm | Fractal Box Dimension |  |
| 6 | `KPTK5QD9_E100` | `motivates` | 09-Problem Scenario | strong non-linearity and high multivariate coupling(Complex Systems) |  | 16-Feature Extraction Algorithm | Fractal Box Dimension |  |
| 7 | `KPTK5QD9_E101` | `motivates` | 09-Problem Scenario | general uncertainty and external disturbance(Uncertainty) |  | 17-Core Classifier Algorithm | Weighted Average Grey Relational Analysis |  |
| 8 | `KPTK5QD9_E102` | `motivates` | 09-Problem Scenario | strong non-linearity and high multivariate coupling(Complex Systems) |  | 17-Core Classifier Algorithm | Weighted Average Grey Relational Analysis |  |
| 9 | `KPTK5QD9_E103` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Fractal Box Dimension |  |
| 10 | `KPTK5QD9_E104` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Weighted Average Grey Relational Analysis |  |
| 11 | `KPTK5QD9_E105` | `motivates` | 06-Fault Severity | magnitude of thruster fault(Multiple Severities) |  | 17-Core Classifier Algorithm | Weighted Average Grey Relational Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `KPTK5QD9_E097`：general uncertainty and external disturbance(Uncertainty) motivates Persistence Time Constraint
  - `KPTK5QD9_E098`：strong non-linearity and high multivariate coupling(Complex Systems) motivates Persistence Time Constraint
  - `KPTK5QD9_E099`：general uncertainty and external disturbance(Uncertainty) motivates Fractal Box Dimension
  - `KPTK5QD9_E100`：strong non-linearity and high multivariate coupling(Complex Systems) motivates Fractal Box Dimension
  - `KPTK5QD9_E101`：general uncertainty and external disturbance(Uncertainty) motivates Weighted Average Grey Relational Analysis
  - `KPTK5QD9_E102`：strong non-linearity and high multivariate coupling(Complex Systems) motivates Weighted Average Grey Relational Analysis
