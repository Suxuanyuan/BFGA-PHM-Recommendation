...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VIBX6K69_E088` | `motivates` | 13-Noise Level | strong noise, background noise, Gaussian white noise(High Noise) |  | 15-Data Preprocessing Algorithm | Sliding window |  |
| 2 | `VIBX6K69_E089` | `motivates` | 13-Noise Level | strong noise, background noise, Gaussian white noise(High Noise) |  | 16-Feature Extraction Algorithm | ISGMD |  |
| 3 | `VIBX6K69_E090` | `motivates` | 09-Problem Scenario | early gear fault / weak fault(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Sliding window |  |
| 4 | `VIBX6K69_E091` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Sliding window |  |
| 5 | `VIBX6K69_E092` | `motivates` | 09-Problem Scenario | early gear fault / weak fault(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | ISGMD |  |
| 6 | `VIBX6K69_E093` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | ISGMD |  |
| 7 | `VIBX6K69_E094` | `motivates` | 09-Problem Scenario | early gear fault / weak fault(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Envelope spectrum analysis |  |
| 8 | `VIBX6K69_E095` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope spectrum analysis |  |
| 9 | `VIBX6K69_E096` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | ISGMD |  |
| 10 | `VIBX6K69_E097` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope spectrum analysis |  |
| 11 | `VIBX6K69_E098` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Envelope spectrum analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `VIBX6K69_E090`：early gear fault / weak fault(Early Degradation Prediction) motivates Sliding window
  - `VIBX6K69_E091`：strong background noise(Uncertainty) motivates Sliding window
  - `VIBX6K69_E092`：early gear fault / weak fault(Early Degradation Prediction) motivates ISGMD
  - `VIBX6K69_E093`：strong background noise(Uncertainty) motivates ISGMD
  - `VIBX6K69_E094`：early gear fault / weak fault(Early Degradation Prediction) motivates Envelope spectrum analysis
  - `VIBX6K69_E095`：strong background noise(Uncertainty) motivates Envelope spectrum analysis
