...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `L7C2K9UK_E101` | `motivates` | 09-Problem Scenario | parameter selection of SVM(Other) |  | 19-Training Optimization Algorithm | Inter-Cluster Distance |  |
| 2 | `L7C2K9UK_E102` | `motivates` | 12-Training Data Availability | 2400 samples in total(Sufficient) |  | 19-Training Optimization Algorithm | Inter-Cluster Distance |  |
| 3 | `L7C2K9UK_E103` | `motivates` | 13-Noise Level | additive Gaussian noise(High Noise) |  | 15-Data Preprocessing Algorithm | Ensemble Empirical Mode Decomposition |  |
| 4 | `L7C2K9UK_E104` | `motivates` | 13-Noise Level | additive Gaussian noise(High Noise) |  | 16-Feature Extraction Algorithm | Permutation Entropy |  |
| 5 | `L7C2K9UK_E105` | `motivates` | 09-Problem Scenario | parameter selection of SVM(Other) |  | 15-Data Preprocessing Algorithm | Ensemble Empirical Mode Decomposition |  |
| 6 | `L7C2K9UK_E106` | `motivates` | 09-Problem Scenario | parameter selection of SVM(Other) |  | 16-Feature Extraction Algorithm | Permutation Entropy |  |
| 7 | `L7C2K9UK_E107` | `motivates` | 09-Problem Scenario | parameter selection of SVM(Other) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 8 | `L7C2K9UK_E108` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Permutation Entropy |  |
| 9 | `L7C2K9UK_E109` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 10 | `L7C2K9UK_E110` | `motivates` | 06-Fault Severity | 0.007-0.028 in(Multiple Severities) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `L7C2K9UK_E101`：parameter selection of SVM(Other) motivates Inter-Cluster Distance
  - `L7C2K9UK_E105`：parameter selection of SVM(Other) motivates Ensemble Empirical Mode Decomposition
  - `L7C2K9UK_E106`：parameter selection of SVM(Other) motivates Permutation Entropy
  - `L7C2K9UK_E107`：parameter selection of SVM(Other) motivates Support Vector Machine
