...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DEWITA68_E106` | `motivates` | 09-Problem Scenario | small-scale samples(Small Fault Samples) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 2 | `DEWITA68_E107` | `motivates` | 09-Problem Scenario | noisy vibration signals(Uncertainty) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 3 | `DEWITA68_E108` | `motivates` | 12-Training Data Availability | small-scale samples(Scarce) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 4 | `DEWITA68_E109` | `motivates` | 13-Noise Level | noisy vibration signals, additive noise(High Noise) |  | 15-Data Preprocessing Algorithm | Fast Nonlocal Means |  |
| 5 | `DEWITA68_E110` | `motivates` | 13-Noise Level | noisy vibration signals, additive noise(High Noise) |  | 16-Feature Extraction Algorithm | Symmetric Alpha-Stable Distribution |  |
| 6 | `DEWITA68_E111` | `motivates` | 09-Problem Scenario | small-scale samples(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Fast Nonlocal Means |  |
| 7 | `DEWITA68_E112` | `motivates` | 09-Problem Scenario | noisy vibration signals(Uncertainty) |  | 15-Data Preprocessing Algorithm | Fast Nonlocal Means |  |
| 8 | `DEWITA68_E113` | `motivates` | 09-Problem Scenario | small-scale samples(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Symmetric Alpha-Stable Distribution |  |
| 9 | `DEWITA68_E114` | `motivates` | 09-Problem Scenario | noisy vibration signals(Uncertainty) |  | 16-Feature Extraction Algorithm | Symmetric Alpha-Stable Distribution |  |
| 10 | `DEWITA68_E115` | `motivates` | 09-Problem Scenario | small-scale samples(Small Fault Samples) |  | 17-Core Classifier Algorithm | LS-WSVM |  |
| 11 | `DEWITA68_E116` | `motivates` | 09-Problem Scenario | noisy vibration signals(Uncertainty) |  | 17-Core Classifier Algorithm | LS-WSVM |  |
| 12 | `DEWITA68_E117` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Symmetric Alpha-Stable Distribution |  |
| 13 | `DEWITA68_E118` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | LS-WSVM |  |
| 14 | `DEWITA68_E119` | `motivates` | 06-Fault Severity | defect size (0.23 mm, 0.43 mm)(Multiple Severities) |  | 17-Core Classifier Algorithm | LS-WSVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `DEWITA68_E106`：small-scale samples(Small Fault Samples) motivates Particle Swarm Optimization
  - `DEWITA68_E107`：noisy vibration signals(Uncertainty) motivates Particle Swarm Optimization
  - `DEWITA68_E111`：small-scale samples(Small Fault Samples) motivates Fast Nonlocal Means
  - `DEWITA68_E112`：noisy vibration signals(Uncertainty) motivates Fast Nonlocal Means
  - `DEWITA68_E113`：small-scale samples(Small Fault Samples) motivates Symmetric Alpha-Stable Distribution
  - `DEWITA68_E114`：noisy vibration signals(Uncertainty) motivates Symmetric Alpha-Stable Distribution
  - `DEWITA68_E115`：small-scale samples(Small Fault Samples) motivates LS-WSVM
  - `DEWITA68_E116`：noisy vibration signals(Uncertainty) motivates LS-WSVM
