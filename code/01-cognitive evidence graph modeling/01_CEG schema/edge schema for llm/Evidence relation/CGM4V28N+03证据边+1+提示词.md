...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CGM4V28N_E069` | `motivates` | 13-Noise Level | background noise(High Noise) |  | 15-Data Preprocessing Algorithm | Synchronous Average |  |
| 2 | `CGM4V28N_E070` | `motivates` | 13-Noise Level | background noise(High Noise) |  | 16-Feature Extraction Algorithm | Spectral Correlation Density |  |
| 3 | `CGM4V28N_E071` | `motivates` | 09-Problem Scenario | mixed source interference in vibration signals(Other) |  | 15-Data Preprocessing Algorithm | Synchronous Average |  |
| 4 | `CGM4V28N_E072` | `motivates` | 09-Problem Scenario | mixed source interference in vibration signals(Other) |  | 16-Feature Extraction Algorithm | Spectral Correlation Density |  |
| 5 | `CGM4V28N_E073` | `motivates` | 09-Problem Scenario | mixed source interference in vibration signals(Other) |  | 17-Core Classifier Algorithm | Cyclic Spectral Coherence |  |
| 6 | `CGM4V28N_E074` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Spectral Correlation Density |  |
| 7 | `CGM4V28N_E075` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Cyclic Spectral Coherence |  |
| 8 | `CGM4V28N_E076` | `motivates` | 06-Fault Severity | incipient fault(Single Severity) |  | 17-Core Classifier Algorithm | Cyclic Spectral Coherence |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `CGM4V28N_E071`：mixed source interference in vibration signals(Other) motivates Synchronous Average
  - `CGM4V28N_E072`：mixed source interference in vibration signals(Other) motivates Spectral Correlation Density
  - `CGM4V28N_E073`：mixed source interference in vibration signals(Other) motivates Cyclic Spectral Coherence
