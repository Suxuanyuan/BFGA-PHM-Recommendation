...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `T8AVGKGI_E099` | `motivates` | 09-Problem Scenario | small number of samples(Small Fault Samples) |  | 19-Training Optimization Algorithm | ACROA |  |
| 2 | `T8AVGKGI_E100` | `motivates` | 09-Problem Scenario | selection of the SVM parameters is very difficult(Other) |  | 19-Training Optimization Algorithm | ACROA |  |
| 3 | `T8AVGKGI_E101` | `motivates` | 12-Training Data Availability | 45 groups were selected at random as the training data(Sufficient) |  | 19-Training Optimization Algorithm | ACROA |  |
| 4 | `T8AVGKGI_E102` | `motivates` | 13-Noise Level | vibration signals(Normal) |  | 15-Data Preprocessing Algorithm | LCD |  |
| 5 | `T8AVGKGI_E103` | `motivates` | 13-Noise Level | vibration signals(Normal) |  | 16-Feature Extraction Algorithm | LCD Energy Entropy |  |
| 6 | `T8AVGKGI_E104` | `motivates` | 09-Problem Scenario | small number of samples(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | LCD |  |
| 7 | `T8AVGKGI_E105` | `motivates` | 09-Problem Scenario | selection of the SVM parameters is very difficult(Other) |  | 15-Data Preprocessing Algorithm | LCD |  |
| 8 | `T8AVGKGI_E106` | `motivates` | 09-Problem Scenario | small number of samples(Small Fault Samples) |  | 16-Feature Extraction Algorithm | LCD Energy Entropy |  |
| 9 | `T8AVGKGI_E107` | `motivates` | 09-Problem Scenario | selection of the SVM parameters is very difficult(Other) |  | 16-Feature Extraction Algorithm | LCD Energy Entropy |  |
| 10 | `T8AVGKGI_E108` | `motivates` | 09-Problem Scenario | small number of samples(Small Fault Samples) |  | 17-Core Classifier Algorithm | SVM |  |
| 11 | `T8AVGKGI_E109` | `motivates` | 09-Problem Scenario | selection of the SVM parameters is very difficult(Other) |  | 17-Core Classifier Algorithm | SVM |  |
| 12 | `T8AVGKGI_E110` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | LCD Energy Entropy |  |
| 13 | `T8AVGKGI_E111` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVM |  |
| 14 | `T8AVGKGI_E112` | `motivates` | 06-Fault Severity | width and a depth of 0.15 mm and 0.13 mm(Single Severity) |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `T8AVGKGI_E099`：small number of samples(Small Fault Samples) motivates ACROA
  - `T8AVGKGI_E100`：selection of the SVM parameters is very difficult(Other) motivates ACROA
  - `T8AVGKGI_E104`：small number of samples(Small Fault Samples) motivates LCD
  - `T8AVGKGI_E105`：selection of the SVM parameters is very difficult(Other) motivates LCD
  - `T8AVGKGI_E106`：small number of samples(Small Fault Samples) motivates LCD Energy Entropy
  - `T8AVGKGI_E107`：selection of the SVM parameters is very difficult(Other) motivates LCD Energy Entropy
  - `T8AVGKGI_E108`：small number of samples(Small Fault Samples) motivates SVM
  - `T8AVGKGI_E109`：selection of the SVM parameters is very difficult(Other) motivates SVM
