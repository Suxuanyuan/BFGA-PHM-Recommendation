...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZNZN9U26_E083` | `motivates` | 09-Problem Scenario | single sensor signal restriction in fault diagnosis(Multi-Source Heterogeneous / Multimodal Data) |  | 19-Training Optimization Algorithm | ABC |  |
| 2 | `ZNZN9U26_E084` | `motivates` | 12-Training Data Availability | each type had 100 samples (of which 60 samples are for training and 40 samples are for testing)(Sufficient) |  | 19-Training Optimization Algorithm | ABC |  |
| 3 | `ZNZN9U26_E085` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | t-SNE |  |
| 4 | `ZNZN9U26_E086` | `motivates` | 09-Problem Scenario | single sensor signal restriction in fault diagnosis(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | t-SNE |  |
| 5 | `ZNZN9U26_E087` | `motivates` | 09-Problem Scenario | single sensor signal restriction in fault diagnosis(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | LSSVM |  |
| 6 | `ZNZN9U26_E088` | `motivates` | 07-Compound Fault | integrated misalignment(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | t-SNE |  |
| 7 | `ZNZN9U26_E089` | `motivates` | 07-Compound Fault | integrated misalignment(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | LSSVM |  |
| 8 | `ZNZN9U26_E090` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | LSSVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZNZN9U26_E083`：single sensor signal restriction in fault diagnosis(Multi-Source Heterogeneous / Multimodal Data) motivates ABC
  - `ZNZN9U26_E086`：single sensor signal restriction in fault diagnosis(Multi-Source Heterogeneous / Multimodal Data) motivates t-SNE
  - `ZNZN9U26_E087`：single sensor signal restriction in fault diagnosis(Multi-Source Heterogeneous / Multimodal Data) motivates LSSVM
