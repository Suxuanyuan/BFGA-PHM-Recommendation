...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4P2E4WEP_E083` | `motivates` | 09-Problem Scenario | heavy background noise(Uncertainty) |  | 19-Training Optimization Algorithm | MM |  |
| 2 | `4P2E4WEP_E084` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | MM |  |
| 3 | `4P2E4WEP_E085` | `motivates` | 13-Noise Level | heavy noise(High Noise) |  | 15-Data Preprocessing Algorithm | MAD |  |
| 4 | `4P2E4WEP_E086` | `motivates` | 13-Noise Level | heavy noise(High Noise) |  | 16-Feature Extraction Algorithm | SR-ASD |  |
| 5 | `4P2E4WEP_E087` | `motivates` | 09-Problem Scenario | heavy background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | MAD |  |
| 6 | `4P2E4WEP_E088` | `motivates` | 09-Problem Scenario | heavy background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | SR-ASD |  |
| 7 | `4P2E4WEP_E089` | `motivates` | 09-Problem Scenario | heavy background noise(Uncertainty) |  | 17-Core Classifier Algorithm | FFT |  |
| 8 | `4P2E4WEP_E090` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | SR-ASD |  |
| 9 | `4P2E4WEP_E091` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | FFT |  |
| 10 | `4P2E4WEP_E092` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | FFT |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4P2E4WEP_E083`：heavy background noise(Uncertainty) motivates MM
  - `4P2E4WEP_E087`：heavy background noise(Uncertainty) motivates MAD
  - `4P2E4WEP_E088`：heavy background noise(Uncertainty) motivates SR-ASD
  - `4P2E4WEP_E089`：heavy background noise(Uncertainty) motivates FFT
