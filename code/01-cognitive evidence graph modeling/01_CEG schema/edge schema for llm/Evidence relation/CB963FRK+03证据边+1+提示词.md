...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CB963FRK_E093` | `motivates` | 13-Noise Level | white Gaussian noise(High Noise) |  | 15-Data Preprocessing Algorithm | Resampling |  |
| 2 | `CB963FRK_E094` | `motivates` | 13-Noise Level | white Gaussian noise(High Noise) |  | 16-Feature Extraction Algorithm | Intrinsic Time-scale Decomposition |  |
| 3 | `CB963FRK_E095` | `motivates` | 09-Problem Scenario | complex interior kinetics of planetary gearboxes(Complex Systems) |  | 15-Data Preprocessing Algorithm | Resampling |  |
| 4 | `CB963FRK_E096` | `motivates` | 09-Problem Scenario | complex amplitude and frequency modulation signals(Other) |  | 15-Data Preprocessing Algorithm | Resampling |  |
| 5 | `CB963FRK_E097` | `motivates` | 09-Problem Scenario | complex interior kinetics of planetary gearboxes(Complex Systems) |  | 16-Feature Extraction Algorithm | Intrinsic Time-scale Decomposition |  |
| 6 | `CB963FRK_E098` | `motivates` | 09-Problem Scenario | complex amplitude and frequency modulation signals(Other) |  | 16-Feature Extraction Algorithm | Intrinsic Time-scale Decomposition |  |
| 7 | `CB963FRK_E099` | `motivates` | 09-Problem Scenario | complex interior kinetics of planetary gearboxes(Complex Systems) |  | 17-Core Classifier Algorithm | Peak matching |  |
| 8 | `CB963FRK_E100` | `motivates` | 09-Problem Scenario | complex amplitude and frequency modulation signals(Other) |  | 17-Core Classifier Algorithm | Peak matching |  |
| 9 | `CB963FRK_E101` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Intrinsic Time-scale Decomposition |  |
| 10 | `CB963FRK_E102` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Peak matching |  |
| 11 | `CB963FRK_E103` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Peak matching |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `CB963FRK_E095`：complex interior kinetics of planetary gearboxes(Complex Systems) motivates Resampling
  - `CB963FRK_E096`：complex amplitude and frequency modulation signals(Other) motivates Resampling
  - `CB963FRK_E097`：complex interior kinetics of planetary gearboxes(Complex Systems) motivates Intrinsic Time-scale Decomposition
  - `CB963FRK_E098`：complex amplitude and frequency modulation signals(Other) motivates Intrinsic Time-scale Decomposition
  - `CB963FRK_E099`：complex interior kinetics of planetary gearboxes(Complex Systems) motivates Peak matching
  - `CB963FRK_E100`：complex amplitude and frequency modulation signals(Other) motivates Peak matching
