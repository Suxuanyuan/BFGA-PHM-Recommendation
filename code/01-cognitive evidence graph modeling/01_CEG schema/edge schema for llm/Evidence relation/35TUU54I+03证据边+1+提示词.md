...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `35TUU54I_E075` | `motivates` | 13-Noise Level | noise component in signal(High Noise) |  | 15-Data Preprocessing Algorithm | SVD |  |
| 2 | `35TUU54I_E076` | `motivates` | 13-Noise Level | noise component in signal(High Noise) |  | 16-Feature Extraction Algorithm | Hilbert transform |  |
| 3 | `35TUU54I_E077` | `motivates` | 09-Problem Scenario | compound faults(Compound Faults) |  | 15-Data Preprocessing Algorithm | SVD |  |
| 4 | `35TUU54I_E078` | `motivates` | 09-Problem Scenario | noise control(Uncertainty) |  | 15-Data Preprocessing Algorithm | SVD |  |
| 5 | `35TUU54I_E079` | `motivates` | 09-Problem Scenario | compound faults(Compound Faults) |  | 16-Feature Extraction Algorithm | Hilbert transform |  |
| 6 | `35TUU54I_E080` | `motivates` | 09-Problem Scenario | noise control(Uncertainty) |  | 16-Feature Extraction Algorithm | Hilbert transform |  |
| 7 | `35TUU54I_E081` | `motivates` | 09-Problem Scenario | compound faults(Compound Faults) |  | 17-Core Classifier Algorithm | Frequency matching |  |
| 8 | `35TUU54I_E082` | `motivates` | 09-Problem Scenario | noise control(Uncertainty) |  | 17-Core Classifier Algorithm | Frequency matching |  |
| 9 | `35TUU54I_E083` | `motivates` | 07-Compound Fault | compound faults of inner and outer rings, outer ring and rolling elements, inner and outer rings and rolling elements(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Hilbert transform |  |
| 10 | `35TUU54I_E084` | `motivates` | 07-Compound Fault | compound faults of inner and outer rings, outer ring and rolling elements, inner and outer rings and rolling elements(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Frequency matching |  |
| 11 | `35TUU54I_E085` | `motivates` | 06-Fault Severity | cutting depth is 0.2 mm(Single Severity) |  | 17-Core Classifier Algorithm | Frequency matching |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `35TUU54I_E077`：compound faults(Compound Faults) motivates SVD
  - `35TUU54I_E078`：noise control(Uncertainty) motivates SVD
  - `35TUU54I_E079`：compound faults(Compound Faults) motivates Hilbert transform
  - `35TUU54I_E080`：noise control(Uncertainty) motivates Hilbert transform
  - `35TUU54I_E081`：compound faults(Compound Faults) motivates Frequency matching
  - `35TUU54I_E082`：noise control(Uncertainty) motivates Frequency matching
