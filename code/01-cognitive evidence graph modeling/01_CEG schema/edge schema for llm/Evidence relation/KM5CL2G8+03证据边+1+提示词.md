...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `KM5CL2G8_E105` | `motivates` | 12-Training Data Availability | approximately 30 sets of readings were taken(Scarce) |  | 18-Data Generation Algorithm | Interpolation |  |
| 2 | `KM5CL2G8_E106` | `motivates` | 13-Noise Level | low signal-to-noise level(High Noise) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 3 | `KM5CL2G8_E107` | `motivates` | 13-Noise Level | low signal-to-noise level(High Noise) |  | 16-Feature Extraction Algorithm | Spectral peak extraction |  |
| 4 | `KM5CL2G8_E108` | `motivates` | 09-Problem Scenario | absence of the training data at the testing angular speed(Distribution Discrepancy) |  | 18-Data Generation Algorithm | Interpolation |  |
| 5 | `KM5CL2G8_E109` | `motivates` | 09-Problem Scenario | absence of the training data at the testing angular speed(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 6 | `KM5CL2G8_E110` | `motivates` | 09-Problem Scenario | absence of the training data at the testing angular speed(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Spectral peak extraction |  |
| 7 | `KM5CL2G8_E111` | `motivates` | 09-Problem Scenario | absence of the training data at the testing angular speed(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | SVM |  |
| 8 | `KM5CL2G8_E112` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Spectral peak extraction |  |
| 9 | `KM5CL2G8_E113` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVM |  |
| 10 | `KM5CL2G8_E114` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `KM5CL2G8_E108`：absence of the training data at the testing angular speed(Distribution Discrepancy) motivates Interpolation
  - `KM5CL2G8_E109`：absence of the training data at the testing angular speed(Distribution Discrepancy) motivates FFT
  - `KM5CL2G8_E110`：absence of the training data at the testing angular speed(Distribution Discrepancy) motivates Spectral peak extraction
  - `KM5CL2G8_E111`：absence of the training data at the testing angular speed(Distribution Discrepancy) motivates SVM
