...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `YYIHB7CM_E096` | `motivates` | 13-Noise Level | random noise, SNR=-5 dB(High Noise) |  | 15-Data Preprocessing Algorithm | OBSD |  |
| 2 | `YYIHB7CM_E097` | `motivates` | 13-Noise Level | random noise, SNR=-5 dB(High Noise) |  | 16-Feature Extraction Algorithm | MTFCE |  |
| 3 | `YYIHB7CM_E098` | `motivates` | 09-Problem Scenario | contaminated by random noise and interferences(Uncertainty) |  | 15-Data Preprocessing Algorithm | OBSD |  |
| 4 | `YYIHB7CM_E099` | `motivates` | 09-Problem Scenario | tachometer-free and resampling-free diagnostics under time-varying speed(Other) |  | 15-Data Preprocessing Algorithm | OBSD |  |
| 5 | `YYIHB7CM_E100` | `motivates` | 09-Problem Scenario | contaminated by random noise and interferences(Uncertainty) |  | 16-Feature Extraction Algorithm | MTFCE |  |
| 6 | `YYIHB7CM_E101` | `motivates` | 09-Problem Scenario | tachometer-free and resampling-free diagnostics under time-varying speed(Other) |  | 16-Feature Extraction Algorithm | MTFCE |  |
| 7 | `YYIHB7CM_E102` | `motivates` | 09-Problem Scenario | contaminated by random noise and interferences(Uncertainty) |  | 17-Core Classifier Algorithm | FCC Matching Algorithm |  |
| 8 | `YYIHB7CM_E103` | `motivates` | 09-Problem Scenario | tachometer-free and resampling-free diagnostics under time-varying speed(Other) |  | 17-Core Classifier Algorithm | FCC Matching Algorithm |  |
| 9 | `YYIHB7CM_E104` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | MTFCE |  |
| 10 | `YYIHB7CM_E105` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | FCC Matching Algorithm |  |
| 11 | `YYIHB7CM_E106` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | FCC Matching Algorithm |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `YYIHB7CM_E098`：contaminated by random noise and interferences(Uncertainty) motivates OBSD
  - `YYIHB7CM_E099`：tachometer-free and resampling-free diagnostics under time-varying speed(Other) motivates OBSD
  - `YYIHB7CM_E100`：contaminated by random noise and interferences(Uncertainty) motivates MTFCE
  - `YYIHB7CM_E101`：tachometer-free and resampling-free diagnostics under time-varying speed(Other) motivates MTFCE
  - `YYIHB7CM_E102`：contaminated by random noise and interferences(Uncertainty) motivates FCC Matching Algorithm
  - `YYIHB7CM_E103`：tachometer-free and resampling-free diagnostics under time-varying speed(Other) motivates FCC Matching Algorithm
