...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ERUWESUA_E070` | `motivates` | 09-Problem Scenario | parametric uncertainties and measurement noise(Uncertainty) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 2 | `ERUWESUA_E071` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 3 | `ERUWESUA_E072` | `motivates` | 09-Problem Scenario | parametric uncertainties and measurement noise(Uncertainty) |  | 17-Core Classifier Algorithm | High-Gain Fractional Order Observer |  |
| 4 | `ERUWESUA_E073` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | High-Gain Fractional Order Observer |  |
| 5 | `ERUWESUA_E074` | `motivates` | 06-Fault Severity | partial fault, total fault(Multiple Severities) |  | 17-Core Classifier Algorithm | High-Gain Fractional Order Observer |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ERUWESUA_E070`：parametric uncertainties and measurement noise(Uncertainty) motivates Particle Swarm Optimization
  - `ERUWESUA_E072`：parametric uncertainties and measurement noise(Uncertainty) motivates High-Gain Fractional Order Observer
