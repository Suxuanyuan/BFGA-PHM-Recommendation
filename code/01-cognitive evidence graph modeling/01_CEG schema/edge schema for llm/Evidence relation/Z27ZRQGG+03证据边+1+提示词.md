...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `Z27ZRQGG_E091` | `motivates` | 09-Problem Scenario | fewer training samples(Small Fault Samples) |  | 19-Training Optimization Algorithm | Unsupervised pre-training and supervised fine-tuning |  |
| 2 | `Z27ZRQGG_E092` | `motivates` | 09-Problem Scenario | Robust against noise(Uncertainty) |  | 19-Training Optimization Algorithm | Unsupervised pre-training and supervised fine-tuning |  |
| 3 | `Z27ZRQGG_E093` | `motivates` | 12-Training Data Availability | fewer training samples(Scarce) |  | 19-Training Optimization Algorithm | Unsupervised pre-training and supervised fine-tuning |  |
| 4 | `Z27ZRQGG_E094` | `motivates` | 13-Noise Level | additional white noise(High Noise) |  | 16-Feature Extraction Algorithm | Restricted Boltzmann Machine |  |
| 5 | `Z27ZRQGG_E095` | `motivates` | 09-Problem Scenario | fewer training samples(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Restricted Boltzmann Machine |  |
| 6 | `Z27ZRQGG_E096` | `motivates` | 09-Problem Scenario | Robust against noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Restricted Boltzmann Machine |  |
| 7 | `Z27ZRQGG_E097` | `motivates` | 09-Problem Scenario | fewer training samples(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `Z27ZRQGG_E098` | `motivates` | 09-Problem Scenario | Robust against noise(Uncertainty) |  | 17-Core Classifier Algorithm | Softmax |  |
| 9 | `Z27ZRQGG_E099` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Restricted Boltzmann Machine |  |
| 10 | `Z27ZRQGG_E100` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `Z27ZRQGG_E101` | `motivates` | 06-Fault Severity | fault diameter / fault degrees(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `Z27ZRQGG_E091`：fewer training samples(Small Fault Samples) motivates Unsupervised pre-training and supervised fine-tuning
  - `Z27ZRQGG_E092`：Robust against noise(Uncertainty) motivates Unsupervised pre-training and supervised fine-tuning
  - `Z27ZRQGG_E095`：fewer training samples(Small Fault Samples) motivates Restricted Boltzmann Machine
  - `Z27ZRQGG_E096`：Robust against noise(Uncertainty) motivates Restricted Boltzmann Machine
  - `Z27ZRQGG_E097`：fewer training samples(Small Fault Samples) motivates Softmax
  - `Z27ZRQGG_E098`：Robust against noise(Uncertainty) motivates Softmax
