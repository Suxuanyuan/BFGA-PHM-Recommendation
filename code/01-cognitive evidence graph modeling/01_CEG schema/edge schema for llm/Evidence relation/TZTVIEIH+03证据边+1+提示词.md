...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TZTVIEIH_E118` | `motivates` | 13-Noise Level | did not require outlier cleaning nor de-noising(Normal) |  | 16-Feature Extraction Algorithm | Multiple Linear Regression |  |
| 2 | `TZTVIEIH_E119` | `motivates` | 09-Problem Scenario | semi-supervised approach using only normal operating data(Zero Fault Samples) |  | 16-Feature Extraction Algorithm | Multiple Linear Regression |  |
| 3 | `TZTVIEIH_E120` | `motivates` | 09-Problem Scenario | structural change in the form of coefficient instability(Other) |  | 16-Feature Extraction Algorithm | Multiple Linear Regression |  |
| 4 | `TZTVIEIH_E121` | `motivates` | 09-Problem Scenario | semi-supervised approach using only normal operating data(Zero Fault Samples) |  | 17-Core Classifier Algorithm | CUSUM |  |
| 5 | `TZTVIEIH_E122` | `motivates` | 09-Problem Scenario | structural change in the form of coefficient instability(Other) |  | 17-Core Classifier Algorithm | CUSUM |  |
| 6 | `TZTVIEIH_E123` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Multiple Linear Regression |  |
| 7 | `TZTVIEIH_E124` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | CUSUM |  |
| 8 | `TZTVIEIH_E125` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | CUSUM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `TZTVIEIH_E119`：semi-supervised approach using only normal operating data(Zero Fault Samples) motivates Multiple Linear Regression
  - `TZTVIEIH_E120`：structural change in the form of coefficient instability(Other) motivates Multiple Linear Regression
  - `TZTVIEIH_E121`：semi-supervised approach using only normal operating data(Zero Fault Samples) motivates CUSUM
  - `TZTVIEIH_E122`：structural change in the form of coefficient instability(Other) motivates CUSUM
