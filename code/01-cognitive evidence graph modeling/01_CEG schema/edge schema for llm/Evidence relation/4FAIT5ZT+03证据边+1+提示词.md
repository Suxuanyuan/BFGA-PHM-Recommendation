...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4FAIT5ZT_E091` | `motivates` | 13-Noise Level | assessing the degree of robustness to noise of a classifier(High Noise) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 2 | `4FAIT5ZT_E092` | `motivates` | 13-Noise Level | assessing the degree of robustness to noise of a classifier(High Noise) |  | 16-Feature Extraction Algorithm | FFS |  |
| 3 | `4FAIT5ZT_E093` | `motivates` | 09-Problem Scenario | robustness to noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 4 | `4FAIT5ZT_E094` | `motivates` | 09-Problem Scenario | generalization to higher fault severity(Other) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 5 | `4FAIT5ZT_E095` | `motivates` | 09-Problem Scenario | robustness to noise(Uncertainty) |  | 16-Feature Extraction Algorithm | FFS |  |
| 6 | `4FAIT5ZT_E096` | `motivates` | 09-Problem Scenario | generalization to higher fault severity(Other) |  | 16-Feature Extraction Algorithm | FFS |  |
| 7 | `4FAIT5ZT_E097` | `motivates` | 09-Problem Scenario | robustness to noise(Uncertainty) |  | 17-Core Classifier Algorithm | QDC |  |
| 8 | `4FAIT5ZT_E098` | `motivates` | 09-Problem Scenario | generalization to higher fault severity(Other) |  | 17-Core Classifier Algorithm | QDC |  |
| 9 | `4FAIT5ZT_E099` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | FFS |  |
| 10 | `4FAIT5ZT_E100` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | QDC |  |
| 11 | `4FAIT5ZT_E101` | `motivates` | 06-Fault Severity | light, medium, high(Multiple Severities) |  | 17-Core Classifier Algorithm | QDC |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4FAIT5ZT_E093`：robustness to noise(Uncertainty) motivates FFT
  - `4FAIT5ZT_E094`：generalization to higher fault severity(Other) motivates FFT
  - `4FAIT5ZT_E095`：robustness to noise(Uncertainty) motivates FFS
  - `4FAIT5ZT_E096`：generalization to higher fault severity(Other) motivates FFS
  - `4FAIT5ZT_E097`：robustness to noise(Uncertainty) motivates QDC
  - `4FAIT5ZT_E098`：generalization to higher fault severity(Other) motivates QDC
