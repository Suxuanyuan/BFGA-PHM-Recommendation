...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TUS5MTVK_E198` | `motivates` | 13-Noise Level | random noise, inevitable noise contamination(High Noise) |  | 15-Data Preprocessing Algorithm | Hanning window |  |
| 2 | `TUS5MTVK_E199` | `motivates` | 13-Noise Level | random noise, inevitable noise contamination(High Noise) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 3 | `TUS5MTVK_E200` | `motivates` | 09-Problem Scenario | random noise contamination(Uncertainty) |  | 15-Data Preprocessing Algorithm | Hanning window |  |
| 4 | `TUS5MTVK_E201` | `motivates` | 09-Problem Scenario | weak sideband feature extraction under strong carrier(Other) |  | 15-Data Preprocessing Algorithm | Hanning window |  |
| 5 | `TUS5MTVK_E202` | `motivates` | 09-Problem Scenario | random noise contamination(Uncertainty) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 6 | `TUS5MTVK_E203` | `motivates` | 09-Problem Scenario | weak sideband feature extraction under strong carrier(Other) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 7 | `TUS5MTVK_E204` | `motivates` | 09-Problem Scenario | random noise contamination(Uncertainty) |  | 17-Core Classifier Algorithm | Modulation Signal Bispectrum |  |
| 8 | `TUS5MTVK_E205` | `motivates` | 09-Problem Scenario | weak sideband feature extraction under strong carrier(Other) |  | 17-Core Classifier Algorithm | Modulation Signal Bispectrum |  |
| 9 | `TUS5MTVK_E206` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 10 | `TUS5MTVK_E207` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Modulation Signal Bispectrum |  |
| 11 | `TUS5MTVK_E208` | `motivates` | 06-Fault Severity | half a BRB, one complete bar broken, two continuous broken bars, wear progressions(Multiple Severities) |  | 17-Core Classifier Algorithm | Modulation Signal Bispectrum |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `TUS5MTVK_E200`：random noise contamination(Uncertainty) motivates Hanning window
  - `TUS5MTVK_E201`：weak sideband feature extraction under strong carrier(Other) motivates Hanning window
  - `TUS5MTVK_E202`：random noise contamination(Uncertainty) motivates Fast Fourier Transform
  - `TUS5MTVK_E203`：weak sideband feature extraction under strong carrier(Other) motivates Fast Fourier Transform
  - `TUS5MTVK_E204`：random noise contamination(Uncertainty) motivates Modulation Signal Bispectrum
  - `TUS5MTVK_E205`：weak sideband feature extraction under strong carrier(Other) motivates Modulation Signal Bispectrum
