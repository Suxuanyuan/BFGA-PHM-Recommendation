...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `2VKGSYJ7_E145` | `motivates` | 09-Problem Scenario | noise(Uncertainty) |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 2 | `2VKGSYJ7_E146` | `motivates` | 09-Problem Scenario | sensitivity of NSPs to the changes of machine condition(Other) |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 3 | `2VKGSYJ7_E147` | `motivates` | 12-Training Data Availability | 20 training data files, 16 training data files(Scarce) |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 4 | `2VKGSYJ7_E148` | `motivates` | 13-Noise Level | submerged in substantial noise(High Noise) |  | 15-Data Preprocessing Algorithm | Neighcoeff GHM |  |
| 5 | `2VKGSYJ7_E149` | `motivates` | 13-Noise Level | submerged in substantial noise(High Noise) |  | 16-Feature Extraction Algorithm | Adaptive Multiwavelets |  |
| 6 | `2VKGSYJ7_E150` | `motivates` | 09-Problem Scenario | noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Neighcoeff GHM |  |
| 7 | `2VKGSYJ7_E151` | `motivates` | 09-Problem Scenario | sensitivity of NSPs to the changes of machine condition(Other) |  | 15-Data Preprocessing Algorithm | Neighcoeff GHM |  |
| 8 | `2VKGSYJ7_E152` | `motivates` | 09-Problem Scenario | noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Adaptive Multiwavelets |  |
| 9 | `2VKGSYJ7_E153` | `motivates` | 09-Problem Scenario | sensitivity of NSPs to the changes of machine condition(Other) |  | 16-Feature Extraction Algorithm | Adaptive Multiwavelets |  |
| 10 | `2VKGSYJ7_E154` | `motivates` | 09-Problem Scenario | noise(Uncertainty) |  | 17-Core Classifier Algorithm | K-means |  |
| 11 | `2VKGSYJ7_E155` | `motivates` | 09-Problem Scenario | sensitivity of NSPs to the changes of machine condition(Other) |  | 17-Core Classifier Algorithm | K-means |  |
| 12 | `2VKGSYJ7_E156` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Adaptive Multiwavelets |  |
| 13 | `2VKGSYJ7_E157` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | K-means |  |
| 14 | `2VKGSYJ7_E158` | `motivates` | 06-Fault Severity | 2 g mass block(Single Severity) |  | 17-Core Classifier Algorithm | K-means |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `2VKGSYJ7_E145`：noise(Uncertainty) motivates Genetic Algorithm
  - `2VKGSYJ7_E146`：sensitivity of NSPs to the changes of machine condition(Other) motivates Genetic Algorithm
  - `2VKGSYJ7_E150`：noise(Uncertainty) motivates Neighcoeff GHM
  - `2VKGSYJ7_E151`：sensitivity of NSPs to the changes of machine condition(Other) motivates Neighcoeff GHM
  - `2VKGSYJ7_E152`：noise(Uncertainty) motivates Adaptive Multiwavelets
  - `2VKGSYJ7_E153`：sensitivity of NSPs to the changes of machine condition(Other) motivates Adaptive Multiwavelets
  - `2VKGSYJ7_E154`：noise(Uncertainty) motivates K-means
  - `2VKGSYJ7_E155`：sensitivity of NSPs to the changes of machine condition(Other) motivates K-means
