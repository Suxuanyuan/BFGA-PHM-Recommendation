...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `UCL9WUMZ_E093` | `motivates` | 13-Noise Level | noise corrupted resample signal in angle domain(High Noise) |  | 15-Data Preprocessing Algorithm | Modified Numerical Integration |  |
| 2 | `UCL9WUMZ_E094` | `motivates` | 13-Noise Level | noise corrupted resample signal in angle domain(High Noise) |  | 16-Feature Extraction Algorithm | Flexible Synchronous Average |  |
| 3 | `UCL9WUMZ_E095` | `motivates` | 09-Problem Scenario | noise corrupted resample signal / noise interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | Modified Numerical Integration |  |
| 4 | `UCL9WUMZ_E096` | `motivates` | 09-Problem Scenario | tacholess order tracking(Other) |  | 15-Data Preprocessing Algorithm | Modified Numerical Integration |  |
| 5 | `UCL9WUMZ_E097` | `motivates` | 09-Problem Scenario | noise corrupted resample signal / noise interference(Uncertainty) |  | 16-Feature Extraction Algorithm | Flexible Synchronous Average |  |
| 6 | `UCL9WUMZ_E098` | `motivates` | 09-Problem Scenario | tacholess order tracking(Other) |  | 16-Feature Extraction Algorithm | Flexible Synchronous Average |  |
| 7 | `UCL9WUMZ_E099` | `motivates` | 09-Problem Scenario | noise corrupted resample signal / noise interference(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Order Analysis |  |
| 8 | `UCL9WUMZ_E100` | `motivates` | 09-Problem Scenario | tacholess order tracking(Other) |  | 17-Core Classifier Algorithm | Envelope Order Analysis |  |
| 9 | `UCL9WUMZ_E101` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Flexible Synchronous Average |  |
| 10 | `UCL9WUMZ_E102` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope Order Analysis |  |
| 11 | `UCL9WUMZ_E103` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Envelope Order Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `UCL9WUMZ_E095`：noise corrupted resample signal / noise interference(Uncertainty) motivates Modified Numerical Integration
  - `UCL9WUMZ_E096`：tacholess order tracking(Other) motivates Modified Numerical Integration
  - `UCL9WUMZ_E097`：noise corrupted resample signal / noise interference(Uncertainty) motivates Flexible Synchronous Average
  - `UCL9WUMZ_E098`：tacholess order tracking(Other) motivates Flexible Synchronous Average
  - `UCL9WUMZ_E099`：noise corrupted resample signal / noise interference(Uncertainty) motivates Envelope Order Analysis
  - `UCL9WUMZ_E100`：tacholess order tracking(Other) motivates Envelope Order Analysis
