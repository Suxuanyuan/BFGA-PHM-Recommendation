...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `JJEU5RDV_E129` | `motivates` | 09-Problem Scenario | feature distribution of a training data set is the same as that of a test data set, which is unrealistic in practical industrial applications(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Transfer learning |  |
| 2 | `JJEU5RDV_E130` | `motivates` | 09-Problem Scenario | very difficult to meet the real-time requirement of online FDD applications / achieving the desired diagnostic accuracy within limited training time(Other) |  | 19-Training Optimization Algorithm | Transfer learning |  |
| 3 | `JJEU5RDV_E131` | `motivates` | 12-Training Data Availability | 2000 time-domain signal samples for training, 5000 selected signal samples in the training data set(Sufficient) |  | 19-Training Optimization Algorithm | Transfer learning |  |
| 4 | `JJEU5RDV_E132` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Signal-to-image conversion |  |
| 5 | `JJEU5RDV_E133` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | CNN |  |
| 6 | `JJEU5RDV_E134` | `motivates` | 09-Problem Scenario | feature distribution of a training data set is the same as that of a test data set, which is unrealistic in practical industrial applications(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Signal-to-image conversion |  |
| 7 | `JJEU5RDV_E135` | `motivates` | 09-Problem Scenario | very difficult to meet the real-time requirement of online FDD applications / achieving the desired diagnostic accuracy within limited training time(Other) |  | 15-Data Preprocessing Algorithm | Signal-to-image conversion |  |
| 8 | `JJEU5RDV_E136` | `motivates` | 09-Problem Scenario | feature distribution of a training data set is the same as that of a test data set, which is unrealistic in practical industrial applications(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | CNN |  |
| 9 | `JJEU5RDV_E137` | `motivates` | 09-Problem Scenario | very difficult to meet the real-time requirement of online FDD applications / achieving the desired diagnostic accuracy within limited training time(Other) |  | 16-Feature Extraction Algorithm | CNN |  |
| 10 | `JJEU5RDV_E138` | `motivates` | 09-Problem Scenario | feature distribution of a training data set is the same as that of a test data set, which is unrealistic in practical industrial applications(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `JJEU5RDV_E139` | `motivates` | 09-Problem Scenario | very difficult to meet the real-time requirement of online FDD applications / achieving the desired diagnostic accuracy within limited training time(Other) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `JJEU5RDV_E140` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 13 | `JJEU5RDV_E141` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `JJEU5RDV_E142` | `motivates` | 06-Fault Severity | damage sizes (0.18, 0.36, and 0.54 mm)(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `JJEU5RDV_E129`：feature distribution of a training data set is the same as that of a test data set, which is unrealistic in practical industrial applications(Distribution Discrepancy) motivates Transfer learning
  - `JJEU5RDV_E130`：very difficult to meet the real-time requirement of online FDD applications / achieving the desired diagnostic accuracy within limited training time(Other) motivates Transfer learning
  - `JJEU5RDV_E134`：feature distribution of a training data set is the same as that of a test data set, which is unrealistic in practical industrial applications(Distribution Discrepancy) motivates Signal-to-image conversion
  - `JJEU5RDV_E135`：very difficult to meet the real-time requirement of online FDD applications / achieving the desired diagnostic accuracy within limited training time(Other) motivates Signal-to-image conversion
  - `JJEU5RDV_E136`：feature distribution of a training data set is the same as that of a test data set, which is unrealistic in practical industrial applications(Distribution Discrepancy) motivates CNN
  - `JJEU5RDV_E137`：very difficult to meet the real-time requirement of online FDD applications / achieving the desired diagnostic accuracy within limited training time(Other) motivates CNN
  - `JJEU5RDV_E138`：feature distribution of a training data set is the same as that of a test data set, which is unrealistic in practical industrial applications(Distribution Discrepancy) motivates Softmax
  - `JJEU5RDV_E139`：very difficult to meet the real-time requirement of online FDD applications / achieving the desired diagnostic accuracy within limited training time(Other) motivates Softmax
