...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XEDZKN9V_E092` | `motivates` | 13-Noise Level | severe surrounding noise, Gaussian white noise(High Noise) |  | 15-Data Preprocessing Algorithm | 1/3-binary tree filter bank |  |
| 2 | `XEDZKN9V_E093` | `motivates` | 13-Noise Level | severe surrounding noise, Gaussian white noise(High Noise) |  | 16-Feature Extraction Algorithm | Gini index |  |
| 3 | `XEDZKN9V_E094` | `motivates` | 09-Problem Scenario | noise robustness and random impulse interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | 1/3-binary tree filter bank |  |
| 4 | `XEDZKN9V_E095` | `motivates` | 09-Problem Scenario | lack of selection guidelines for sparsity measures under different scenarios(Other) |  | 15-Data Preprocessing Algorithm | 1/3-binary tree filter bank |  |
| 5 | `XEDZKN9V_E096` | `motivates` | 09-Problem Scenario | noise robustness and random impulse interference(Uncertainty) |  | 16-Feature Extraction Algorithm | Gini index |  |
| 6 | `XEDZKN9V_E097` | `motivates` | 09-Problem Scenario | lack of selection guidelines for sparsity measures under different scenarios(Other) |  | 16-Feature Extraction Algorithm | Gini index |  |
| 7 | `XEDZKN9V_E098` | `motivates` | 09-Problem Scenario | noise robustness and random impulse interference(Uncertainty) |  | 17-Core Classifier Algorithm | Kurtogram |  |
| 8 | `XEDZKN9V_E099` | `motivates` | 09-Problem Scenario | lack of selection guidelines for sparsity measures under different scenarios(Other) |  | 17-Core Classifier Algorithm | Kurtogram |  |
| 9 | `XEDZKN9V_E100` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Gini index |  |
| 10 | `XEDZKN9V_E101` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Kurtogram |  |
| 11 | `XEDZKN9V_E102` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Kurtogram |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `XEDZKN9V_E094`：noise robustness and random impulse interference(Uncertainty) motivates 1/3-binary tree filter bank
  - `XEDZKN9V_E095`：lack of selection guidelines for sparsity measures under different scenarios(Other) motivates 1/3-binary tree filter bank
  - `XEDZKN9V_E096`：noise robustness and random impulse interference(Uncertainty) motivates Gini index
  - `XEDZKN9V_E097`：lack of selection guidelines for sparsity measures under different scenarios(Other) motivates Gini index
  - `XEDZKN9V_E098`：noise robustness and random impulse interference(Uncertainty) motivates Kurtogram
  - `XEDZKN9V_E099`：lack of selection guidelines for sparsity measures under different scenarios(Other) motivates Kurtogram
