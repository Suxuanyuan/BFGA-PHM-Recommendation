...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XFCTWVTT_E073` | `motivates` | 13-Noise Level | strong noise / noisy mechanical vibration signals / SNR = -13 dB(High Noise) |  | 16-Feature Extraction Algorithm | MEWT |  |
| 2 | `XFCTWVTT_E074` | `motivates` | 09-Problem Scenario | strong noise contamination(Uncertainty) |  | 16-Feature Extraction Algorithm | MEWT |  |
| 3 | `XFCTWVTT_E075` | `motivates` | 09-Problem Scenario | adaptive Fourier spectrum segment and mode redundancy(Other) |  | 16-Feature Extraction Algorithm | MEWT |  |
| 4 | `XFCTWVTT_E076` | `motivates` | 09-Problem Scenario | strong noise contamination(Uncertainty) |  | 17-Core Classifier Algorithm | Hilbert Transform |  |
| 5 | `XFCTWVTT_E077` | `motivates` | 09-Problem Scenario | adaptive Fourier spectrum segment and mode redundancy(Other) |  | 17-Core Classifier Algorithm | Hilbert Transform |  |
| 6 | `XFCTWVTT_E078` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | MEWT |  |
| 7 | `XFCTWVTT_E079` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Hilbert Transform |  |
| 8 | `XFCTWVTT_E080` | `motivates` | 06-Fault Severity | slight cut, slight rub defect(Single Severity) |  | 17-Core Classifier Algorithm | Hilbert Transform |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `XFCTWVTT_E074`：strong noise contamination(Uncertainty) motivates MEWT
  - `XFCTWVTT_E075`：adaptive Fourier spectrum segment and mode redundancy(Other) motivates MEWT
  - `XFCTWVTT_E076`：strong noise contamination(Uncertainty) motivates Hilbert Transform
  - `XFCTWVTT_E077`：adaptive Fourier spectrum segment and mode redundancy(Other) motivates Hilbert Transform
