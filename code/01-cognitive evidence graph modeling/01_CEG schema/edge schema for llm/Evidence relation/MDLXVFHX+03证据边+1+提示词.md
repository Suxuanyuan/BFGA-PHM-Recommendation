...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `MDLXVFHX_E111` | `motivates` | 12-Training Data Availability | 20 for the normal and 10 for each of the spalled and cracked conditions(Scarce) |  | 18-Data Generation Algorithm | Finite Element Analysis |  |
| 2 | `MDLXVFHX_E112` | `motivates` | 13-Noise Level | noise from the measured TE / artificial noise(High Noise) |  | 15-Data Preprocessing Algorithm | Time Synchronous Averaging |  |
| 3 | `MDLXVFHX_E113` | `motivates` | 13-Noise Level | noise from the measured TE / artificial noise(High Noise) |  | 16-Feature Extraction Algorithm | Ensemble Empirical Mode Decomposition |  |
| 4 | `MDLXVFHX_E114` | `motivates` | 09-Problem Scenario | background noise and mechanical resonance, mounting and dismounting uncertainty(Uncertainty) |  | 18-Data Generation Algorithm | Finite Element Analysis |  |
| 5 | `MDLXVFHX_E115` | `motivates` | 09-Problem Scenario | deformation physics of gears in mesh(Trustworthiness / Interpretability) |  | 18-Data Generation Algorithm | Finite Element Analysis |  |
| 6 | `MDLXVFHX_E116` | `motivates` | 09-Problem Scenario | background noise and mechanical resonance, mounting and dismounting uncertainty(Uncertainty) |  | 15-Data Preprocessing Algorithm | Time Synchronous Averaging |  |
| 7 | `MDLXVFHX_E117` | `motivates` | 09-Problem Scenario | deformation physics of gears in mesh(Trustworthiness / Interpretability) |  | 15-Data Preprocessing Algorithm | Time Synchronous Averaging |  |
| 8 | `MDLXVFHX_E118` | `motivates` | 09-Problem Scenario | background noise and mechanical resonance, mounting and dismounting uncertainty(Uncertainty) |  | 16-Feature Extraction Algorithm | Ensemble Empirical Mode Decomposition |  |
| 9 | `MDLXVFHX_E119` | `motivates` | 09-Problem Scenario | deformation physics of gears in mesh(Trustworthiness / Interpretability) |  | 16-Feature Extraction Algorithm | Ensemble Empirical Mode Decomposition |  |
| 10 | `MDLXVFHX_E120` | `motivates` | 09-Problem Scenario | background noise and mechanical resonance, mounting and dismounting uncertainty(Uncertainty) |  | 17-Core Classifier Algorithm | k-Nearest Neighbor |  |
| 11 | `MDLXVFHX_E121` | `motivates` | 09-Problem Scenario | deformation physics of gears in mesh(Trustworthiness / Interpretability) |  | 17-Core Classifier Algorithm | k-Nearest Neighbor |  |
| 12 | `MDLXVFHX_E122` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Ensemble Empirical Mode Decomposition |  |
| 13 | `MDLXVFHX_E123` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | k-Nearest Neighbor |  |
| 14 | `MDLXVFHX_E124` | `motivates` | 06-Fault Severity | spall of W * D 1.3 mm * 0.5 mm, crack of length 4 mm(Single Severity) |  | 17-Core Classifier Algorithm | k-Nearest Neighbor |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `MDLXVFHX_E114`：background noise and mechanical resonance, mounting and dismounting uncertainty(Uncertainty) motivates Finite Element Analysis
  - `MDLXVFHX_E115`：deformation physics of gears in mesh(Trustworthiness / Interpretability) motivates Finite Element Analysis
  - `MDLXVFHX_E116`：background noise and mechanical resonance, mounting and dismounting uncertainty(Uncertainty) motivates Time Synchronous Averaging
  - `MDLXVFHX_E117`：deformation physics of gears in mesh(Trustworthiness / Interpretability) motivates Time Synchronous Averaging
  - `MDLXVFHX_E118`：background noise and mechanical resonance, mounting and dismounting uncertainty(Uncertainty) motivates Ensemble Empirical Mode Decomposition
  - `MDLXVFHX_E119`：deformation physics of gears in mesh(Trustworthiness / Interpretability) motivates Ensemble Empirical Mode Decomposition
  - `MDLXVFHX_E120`：background noise and mechanical resonance, mounting and dismounting uncertainty(Uncertainty) motivates k-Nearest Neighbor
  - `MDLXVFHX_E121`：deformation physics of gears in mesh(Trustworthiness / Interpretability) motivates k-Nearest Neighbor
