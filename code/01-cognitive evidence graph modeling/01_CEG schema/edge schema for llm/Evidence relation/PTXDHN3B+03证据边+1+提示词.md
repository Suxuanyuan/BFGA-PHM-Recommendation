...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PTXDHN3B_E078` | `motivates` | 09-Problem Scenario | weak features submerged in heavy noise(Uncertainty) |  | 19-Training Optimization Algorithm | QPSO |  |
| 2 | `PTXDHN3B_E079` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | QPSO |  |
| 3 | `PTXDHN3B_E080` | `motivates` | 13-Noise Level | heavy noise(High Noise) |  | 15-Data Preprocessing Algorithm | Scale Transformation |  |
| 4 | `PTXDHN3B_E081` | `motivates` | 13-Noise Level | heavy noise(High Noise) |  | 16-Feature Extraction Algorithm | ACPLSR |  |
| 5 | `PTXDHN3B_E082` | `motivates` | 09-Problem Scenario | weak features submerged in heavy noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Scale Transformation |  |
| 6 | `PTXDHN3B_E083` | `motivates` | 09-Problem Scenario | weak features submerged in heavy noise(Uncertainty) |  | 16-Feature Extraction Algorithm | ACPLSR |  |
| 7 | `PTXDHN3B_E084` | `motivates` | 09-Problem Scenario | weak features submerged in heavy noise(Uncertainty) |  | 17-Core Classifier Algorithm | Spectral Analysis |  |
| 8 | `PTXDHN3B_E085` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | ACPLSR |  |
| 9 | `PTXDHN3B_E086` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Spectral Analysis |  |
| 10 | `PTXDHN3B_E087` | `motivates` | 06-Fault Severity | 0.007 inches(Single Severity) |  | 17-Core Classifier Algorithm | Spectral Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `PTXDHN3B_E078`：weak features submerged in heavy noise(Uncertainty) motivates QPSO
  - `PTXDHN3B_E082`：weak features submerged in heavy noise(Uncertainty) motivates Scale Transformation
  - `PTXDHN3B_E083`：weak features submerged in heavy noise(Uncertainty) motivates ACPLSR
  - `PTXDHN3B_E084`：weak features submerged in heavy noise(Uncertainty) motivates Spectral Analysis
