...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `IARXUC2K_E099` | `motivates` | 13-Noise Level | Noise signals are introduced during the simulation(High Noise) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 2 | `IARXUC2K_E100` | `motivates` | 13-Noise Level | Noise signals are introduced during the simulation(High Noise) |  | 16-Feature Extraction Algorithm | CNN |  |
| 3 | `IARXUC2K_E101` | `motivates` | 09-Problem Scenario | complex physical processes, nonlinear parameter variations, and multiple system factors(Complex Systems) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 4 | `IARXUC2K_E102` | `motivates` | 09-Problem Scenario | uncertainty of the process to be predicted(Uncertainty) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 5 | `IARXUC2K_E103` | `motivates` | 09-Problem Scenario | complex physical processes, nonlinear parameter variations, and multiple system factors(Complex Systems) |  | 16-Feature Extraction Algorithm | CNN |  |
| 6 | `IARXUC2K_E104` | `motivates` | 09-Problem Scenario | uncertainty of the process to be predicted(Uncertainty) |  | 16-Feature Extraction Algorithm | CNN |  |
| 7 | `IARXUC2K_E105` | `motivates` | 09-Problem Scenario | complex physical processes, nonlinear parameter variations, and multiple system factors(Complex Systems) |  | 17-Core Classifier Algorithm | ConvLSTM |  |
| 8 | `IARXUC2K_E106` | `motivates` | 09-Problem Scenario | uncertainty of the process to be predicted(Uncertainty) |  | 17-Core Classifier Algorithm | ConvLSTM |  |
| 9 | `IARXUC2K_E107` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 10 | `IARXUC2K_E108` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | ConvLSTM |  |
| 11 | `IARXUC2K_E109` | `motivates` | 06-Fault Severity | break size of 0.2, 0.4, 0.6, 0.8, and 1.0 cm2(Multiple Severities) |  | 17-Core Classifier Algorithm | ConvLSTM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `IARXUC2K_E101`：complex physical processes, nonlinear parameter variations, and multiple system factors(Complex Systems) motivates Min-Max Normalization
  - `IARXUC2K_E102`：uncertainty of the process to be predicted(Uncertainty) motivates Min-Max Normalization
  - `IARXUC2K_E103`：complex physical processes, nonlinear parameter variations, and multiple system factors(Complex Systems) motivates CNN
  - `IARXUC2K_E104`：uncertainty of the process to be predicted(Uncertainty) motivates CNN
  - `IARXUC2K_E105`：complex physical processes, nonlinear parameter variations, and multiple system factors(Complex Systems) motivates ConvLSTM
  - `IARXUC2K_E106`：uncertainty of the process to be predicted(Uncertainty) motivates ConvLSTM
