...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `RDZQSUWJ_E080` | `motivates` | 13-Noise Level | vibration signals(Normal) |  | 15-Data Preprocessing Algorithm | LMD |  |
| 2 | `RDZQSUWJ_E081` | `motivates` | 13-Noise Level | vibration signals(Normal) |  | 16-Feature Extraction Algorithm | PE |  |
| 3 | `RDZQSUWJ_E082` | `motivates` | 09-Problem Scenario | variable working conditions(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | LMD |  |
| 4 | `RDZQSUWJ_E083` | `motivates` | 09-Problem Scenario | limitations of Euclidean distance metric in DTW(Other) |  | 15-Data Preprocessing Algorithm | LMD |  |
| 5 | `RDZQSUWJ_E084` | `motivates` | 09-Problem Scenario | variable working conditions(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | PE |  |
| 6 | `RDZQSUWJ_E085` | `motivates` | 09-Problem Scenario | limitations of Euclidean distance metric in DTW(Other) |  | 16-Feature Extraction Algorithm | PE |  |
| 7 | `RDZQSUWJ_E086` | `motivates` | 09-Problem Scenario | variable working conditions(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | MDTW |  |
| 8 | `RDZQSUWJ_E087` | `motivates` | 09-Problem Scenario | limitations of Euclidean distance metric in DTW(Other) |  | 17-Core Classifier Algorithm | MDTW |  |
| 9 | `RDZQSUWJ_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | PE |  |
| 10 | `RDZQSUWJ_E089` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | MDTW |  |
| 11 | `RDZQSUWJ_E090` | `motivates` | 06-Fault Severity | fault widths (7 mils, 14 mils, 21 mils)(Multiple Severities) |  | 17-Core Classifier Algorithm | MDTW |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `RDZQSUWJ_E082`：variable working conditions(Distribution Discrepancy) motivates LMD
  - `RDZQSUWJ_E083`：limitations of Euclidean distance metric in DTW(Other) motivates LMD
  - `RDZQSUWJ_E084`：variable working conditions(Distribution Discrepancy) motivates PE
  - `RDZQSUWJ_E085`：limitations of Euclidean distance metric in DTW(Other) motivates PE
  - `RDZQSUWJ_E086`：variable working conditions(Distribution Discrepancy) motivates MDTW
  - `RDZQSUWJ_E087`：limitations of Euclidean distance metric in DTW(Other) motivates MDTW
