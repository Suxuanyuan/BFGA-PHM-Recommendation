...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AFZ2QY64_E064` | `motivates` | 09-Problem Scenario | unbalanced datasets(Small Fault Samples) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 2 | `AFZ2QY64_E065` | `motivates` | 12-Training Data Availability | data scarcity, 50, 40, 30, 20, 10 samples(Scarce) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 3 | `AFZ2QY64_E066` | `motivates` | 13-Noise Level | vibration signal(Normal) |  | 16-Feature Extraction Algorithm | Multifractal Detrended Fluctuation Analysis |  |
| 4 | `AFZ2QY64_E067` | `motivates` | 09-Problem Scenario | unbalanced datasets(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Multifractal Detrended Fluctuation Analysis |  |
| 5 | `AFZ2QY64_E068` | `motivates` | 09-Problem Scenario | unbalanced datasets(Small Fault Samples) |  | 17-Core Classifier Algorithm | Support Vector Data Description |  |
| 6 | `AFZ2QY64_E069` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Multifractal Detrended Fluctuation Analysis |  |
| 7 | `AFZ2QY64_E070` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Support Vector Data Description |  |
| 8 | `AFZ2QY64_E071` | `motivates` | 06-Fault Severity | 0.3 g, 0.5 g, 0.8 g and 1.0 g weights(Multiple Severities) |  | 17-Core Classifier Algorithm | Support Vector Data Description |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `AFZ2QY64_E064`：unbalanced datasets(Small Fault Samples) motivates Particle Swarm Optimization
  - `AFZ2QY64_E067`：unbalanced datasets(Small Fault Samples) motivates Multifractal Detrended Fluctuation Analysis
  - `AFZ2QY64_E068`：unbalanced datasets(Small Fault Samples) motivates Support Vector Data Description
