...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `FJV295EW_E091` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Overlap segmentation |  |
| 2 | `FJV295EW_E092` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Stacked LSTM |  |
| 3 | `FJV295EW_E093` | `motivates` | 09-Problem Scenario | shallow learning structures(Other) |  | 15-Data Preprocessing Algorithm | Overlap segmentation |  |
| 4 | `FJV295EW_E094` | `motivates` | 09-Problem Scenario | variation of loads(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Overlap segmentation |  |
| 5 | `FJV295EW_E095` | `motivates` | 09-Problem Scenario | shallow learning structures(Other) |  | 16-Feature Extraction Algorithm | Stacked LSTM |  |
| 6 | `FJV295EW_E096` | `motivates` | 09-Problem Scenario | variation of loads(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Stacked LSTM |  |
| 7 | `FJV295EW_E097` | `motivates` | 09-Problem Scenario | shallow learning structures(Other) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `FJV295EW_E098` | `motivates` | 09-Problem Scenario | variation of loads(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 9 | `FJV295EW_E099` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Stacked LSTM |  |
| 10 | `FJV295EW_E100` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `FJV295EW_E101` | `motivates` | 06-Fault Severity | diameter of faults(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `FJV295EW_E093`：shallow learning structures(Other) motivates Overlap segmentation
  - `FJV295EW_E094`：variation of loads(Distribution Discrepancy) motivates Overlap segmentation
  - `FJV295EW_E095`：shallow learning structures(Other) motivates Stacked LSTM
  - `FJV295EW_E096`：variation of loads(Distribution Discrepancy) motivates Stacked LSTM
  - `FJV295EW_E097`：shallow learning structures(Other) motivates Softmax
  - `FJV295EW_E098`：variation of loads(Distribution Discrepancy) motivates Softmax
