...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DXJQ6S6Q_E068` | `motivates` | 13-Noise Level | intense noise interference(High Noise) |  | 15-Data Preprocessing Algorithm | EEMD |  |
| 2 | `DXJQ6S6Q_E069` | `motivates` | 13-Noise Level | intense noise interference(High Noise) |  | 16-Feature Extraction Algorithm | Multi-scale Binary Spectrum |  |
| 3 | `DXJQ6S6Q_E070` | `motivates` | 09-Problem Scenario | intense noise interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | EEMD |  |
| 4 | `DXJQ6S6Q_E071` | `motivates` | 09-Problem Scenario | intense noise interference(Uncertainty) |  | 16-Feature Extraction Algorithm | Multi-scale Binary Spectrum |  |
| 5 | `DXJQ6S6Q_E072` | `motivates` | 09-Problem Scenario | intense noise interference(Uncertainty) |  | 17-Core Classifier Algorithm | Power Spectrum |  |
| 6 | `DXJQ6S6Q_E073` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Multi-scale Binary Spectrum |  |
| 7 | `DXJQ6S6Q_E074` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Power Spectrum |  |
| 8 | `DXJQ6S6Q_E075` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Power Spectrum |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `DXJQ6S6Q_E070`：intense noise interference(Uncertainty) motivates EEMD
  - `DXJQ6S6Q_E071`：intense noise interference(Uncertainty) motivates Multi-scale Binary Spectrum
  - `DXJQ6S6Q_E072`：intense noise interference(Uncertainty) motivates Power Spectrum
