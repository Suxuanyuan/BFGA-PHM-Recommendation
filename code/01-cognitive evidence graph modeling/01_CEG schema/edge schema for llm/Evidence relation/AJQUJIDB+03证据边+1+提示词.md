...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AJQUJIDB_E093` | `motivates` | 13-Noise Level | Background noise(High Noise) |  | 15-Data Preprocessing Algorithm | Autoregressive Model |  |
| 2 | `AJQUJIDB_E094` | `motivates` | 13-Noise Level | Background noise(High Noise) |  | 16-Feature Extraction Algorithm | Cross-correlation |  |
| 3 | `AJQUJIDB_E095` | `motivates` | 09-Problem Scenario | Low signal-to-noise ratio (SNR) under low-speed conditions(Uncertainty) |  | 15-Data Preprocessing Algorithm | Autoregressive Model |  |
| 4 | `AJQUJIDB_E096` | `motivates` | 09-Problem Scenario | Early fault detection / incipient fault diagnostics(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Autoregressive Model |  |
| 5 | `AJQUJIDB_E097` | `motivates` | 09-Problem Scenario | Low signal-to-noise ratio (SNR) under low-speed conditions(Uncertainty) |  | 16-Feature Extraction Algorithm | Cross-correlation |  |
| 6 | `AJQUJIDB_E098` | `motivates` | 09-Problem Scenario | Early fault detection / incipient fault diagnostics(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Cross-correlation |  |
| 7 | `AJQUJIDB_E099` | `motivates` | 09-Problem Scenario | Low signal-to-noise ratio (SNR) under low-speed conditions(Uncertainty) |  | 17-Core Classifier Algorithm | Fourier Transform |  |
| 8 | `AJQUJIDB_E100` | `motivates` | 09-Problem Scenario | Early fault detection / incipient fault diagnostics(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Fourier Transform |  |
| 9 | `AJQUJIDB_E101` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Cross-correlation |  |
| 10 | `AJQUJIDB_E102` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Fourier Transform |  |
| 11 | `AJQUJIDB_E103` | `motivates` | 06-Fault Severity | million revolutions(Multiple Severities) |  | 17-Core Classifier Algorithm | Fourier Transform |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `AJQUJIDB_E095`：Low signal-to-noise ratio (SNR) under low-speed conditions(Uncertainty) motivates Autoregressive Model
  - `AJQUJIDB_E096`：Early fault detection / incipient fault diagnostics(Early Degradation Prediction) motivates Autoregressive Model
  - `AJQUJIDB_E097`：Low signal-to-noise ratio (SNR) under low-speed conditions(Uncertainty) motivates Cross-correlation
  - `AJQUJIDB_E098`：Early fault detection / incipient fault diagnostics(Early Degradation Prediction) motivates Cross-correlation
  - `AJQUJIDB_E099`：Low signal-to-noise ratio (SNR) under low-speed conditions(Uncertainty) motivates Fourier Transform
  - `AJQUJIDB_E100`：Early fault detection / incipient fault diagnostics(Early Degradation Prediction) motivates Fourier Transform
