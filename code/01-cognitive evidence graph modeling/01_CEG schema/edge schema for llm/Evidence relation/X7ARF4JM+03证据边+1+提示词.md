...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `X7ARF4JM_E061` | `motivates` | 09-Problem Scenario | switched linear systems(Complex Systems) |  | 19-Training Optimization Algorithm | Linear Matrix Inequality |  |
| 2 | `X7ARF4JM_E062` | `motivates` | 09-Problem Scenario | limited network resources and external disturbances(Uncertainty) |  | 19-Training Optimization Algorithm | Linear Matrix Inequality |  |
| 3 | `X7ARF4JM_E063` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Linear Matrix Inequality |  |
| 4 | `X7ARF4JM_E064` | `motivates` | 09-Problem Scenario | switched linear systems(Complex Systems) |  | 17-Core Classifier Algorithm | Fault Detection Filter |  |
| 5 | `X7ARF4JM_E065` | `motivates` | 09-Problem Scenario | limited network resources and external disturbances(Uncertainty) |  | 17-Core Classifier Algorithm | Fault Detection Filter |  |
| 6 | `X7ARF4JM_E066` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Fault Detection Filter |  |
| 7 | `X7ARF4JM_E067` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Fault Detection Filter |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `X7ARF4JM_E061`：switched linear systems(Complex Systems) motivates Linear Matrix Inequality
  - `X7ARF4JM_E062`：limited network resources and external disturbances(Uncertainty) motivates Linear Matrix Inequality
  - `X7ARF4JM_E064`：switched linear systems(Complex Systems) motivates Fault Detection Filter
  - `X7ARF4JM_E065`：limited network resources and external disturbances(Uncertainty) motivates Fault Detection Filter
