...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `UT3J3HEN_E072` | `motivates` | 13-Noise Level | low signal-to-noise ratio and non-Gaussian noise(High Noise) |  | 15-Data Preprocessing Algorithm | Autoregressive model |  |
| 2 | `UT3J3HEN_E073` | `motivates` | 13-Noise Level | low signal-to-noise ratio and non-Gaussian noise(High Noise) |  | 16-Feature Extraction Algorithm | enhanced Kurtogram |  |
| 3 | `UT3J3HEN_E074` | `motivates` | 09-Problem Scenario | low signal-to-noise ratio and non-Gaussian noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Autoregressive model |  |
| 4 | `UT3J3HEN_E075` | `motivates` | 09-Problem Scenario | low signal-to-noise ratio and non-Gaussian noise(Uncertainty) |  | 16-Feature Extraction Algorithm | enhanced Kurtogram |  |
| 5 | `UT3J3HEN_E076` | `motivates` | 09-Problem Scenario | low signal-to-noise ratio and non-Gaussian noise(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope analysis |  |
| 6 | `UT3J3HEN_E077` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | enhanced Kurtogram |  |
| 7 | `UT3J3HEN_E078` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope analysis |  |
| 8 | `UT3J3HEN_E079` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Envelope analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `UT3J3HEN_E074`：low signal-to-noise ratio and non-Gaussian noise(Uncertainty) motivates Autoregressive model
  - `UT3J3HEN_E075`：low signal-to-noise ratio and non-Gaussian noise(Uncertainty) motivates enhanced Kurtogram
  - `UT3J3HEN_E076`：low signal-to-noise ratio and non-Gaussian noise(Uncertainty) motivates Envelope analysis
