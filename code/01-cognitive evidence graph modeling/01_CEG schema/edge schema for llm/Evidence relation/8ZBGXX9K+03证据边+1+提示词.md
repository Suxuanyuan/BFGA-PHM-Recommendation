...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `8ZBGXX9K_E100` | `motivates` | 13-Noise Level | noise, random noise(High Noise) |  | 15-Data Preprocessing Algorithm | Dynamic Time Warping |  |
| 2 | `8ZBGXX9K_E101` | `motivates` | 13-Noise Level | noise, random noise(High Noise) |  | 16-Feature Extraction Algorithm | Empirical Mode Decomposition |  |
| 3 | `8ZBGXX9K_E102` | `motivates` | 09-Problem Scenario | fluctuating speed without tachometer(Other) |  | 15-Data Preprocessing Algorithm | Dynamic Time Warping |  |
| 4 | `8ZBGXX9K_E103` | `motivates` | 09-Problem Scenario | weak fault features masked by noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Dynamic Time Warping |  |
| 5 | `8ZBGXX9K_E104` | `motivates` | 09-Problem Scenario | fluctuating speed without tachometer(Other) |  | 16-Feature Extraction Algorithm | Empirical Mode Decomposition |  |
| 6 | `8ZBGXX9K_E105` | `motivates` | 09-Problem Scenario | weak fault features masked by noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Empirical Mode Decomposition |  |
| 7 | `8ZBGXX9K_E106` | `motivates` | 09-Problem Scenario | fluctuating speed without tachometer(Other) |  | 17-Core Classifier Algorithm | Kurtosis |  |
| 8 | `8ZBGXX9K_E107` | `motivates` | 09-Problem Scenario | weak fault features masked by noise(Uncertainty) |  | 17-Core Classifier Algorithm | Kurtosis |  |
| 9 | `8ZBGXX9K_E108` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Empirical Mode Decomposition |  |
| 10 | `8ZBGXX9K_E109` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Kurtosis |  |
| 11 | `8ZBGXX9K_E110` | `motivates` | 06-Fault Severity | initial crack, advanced crack, chipped tooth, missing tooth(Multiple Severities) |  | 17-Core Classifier Algorithm | Kurtosis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `8ZBGXX9K_E102`：fluctuating speed without tachometer(Other) motivates Dynamic Time Warping
  - `8ZBGXX9K_E103`：weak fault features masked by noise(Uncertainty) motivates Dynamic Time Warping
  - `8ZBGXX9K_E104`：fluctuating speed without tachometer(Other) motivates Empirical Mode Decomposition
  - `8ZBGXX9K_E105`：weak fault features masked by noise(Uncertainty) motivates Empirical Mode Decomposition
  - `8ZBGXX9K_E106`：fluctuating speed without tachometer(Other) motivates Kurtosis
  - `8ZBGXX9K_E107`：weak fault features masked by noise(Uncertainty) motivates Kurtosis
