...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3GBJU7N7_E126` | `motivates` | 13-Noise Level | contaminated by noise(High Noise) |  | 15-Data Preprocessing Algorithm | Gap metric |  |
| 2 | `3GBJU7N7_E127` | `motivates` | 13-Noise Level | contaminated by noise(High Noise) |  | 16-Feature Extraction Algorithm | Gap-DBN |  |
| 3 | `3GBJU7N7_E128` | `motivates` | 09-Problem Scenario | multiple fault modes(Compound Faults) |  | 15-Data Preprocessing Algorithm | Gap metric |  |
| 4 | `3GBJU7N7_E129` | `motivates` | 09-Problem Scenario | process noise and prediction uncertainty(Uncertainty) |  | 15-Data Preprocessing Algorithm | Gap metric |  |
| 5 | `3GBJU7N7_E130` | `motivates` | 09-Problem Scenario | degradation feature extraction and prediction(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Gap metric |  |
| 6 | `3GBJU7N7_E131` | `motivates` | 09-Problem Scenario | multiple fault modes(Compound Faults) |  | 16-Feature Extraction Algorithm | Gap-DBN |  |
| 7 | `3GBJU7N7_E132` | `motivates` | 09-Problem Scenario | process noise and prediction uncertainty(Uncertainty) |  | 16-Feature Extraction Algorithm | Gap-DBN |  |
| 8 | `3GBJU7N7_E133` | `motivates` | 09-Problem Scenario | degradation feature extraction and prediction(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Gap-DBN |  |
| 9 | `3GBJU7N7_E134` | `motivates` | 09-Problem Scenario | multiple fault modes(Compound Faults) |  | 17-Core Classifier Algorithm | Particle Filter |  |
| 10 | `3GBJU7N7_E135` | `motivates` | 09-Problem Scenario | process noise and prediction uncertainty(Uncertainty) |  | 17-Core Classifier Algorithm | Particle Filter |  |
| 11 | `3GBJU7N7_E136` | `motivates` | 09-Problem Scenario | degradation feature extraction and prediction(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Particle Filter |  |
| 12 | `3GBJU7N7_E137` | `motivates` | 07-Compound Fault | multiple fault modes(No Compound Fault) |  | 16-Feature Extraction Algorithm | Gap-DBN |  |
| 13 | `3GBJU7N7_E138` | `motivates` | 07-Compound Fault | multiple fault modes(No Compound Fault) |  | 17-Core Classifier Algorithm | Particle Filter |  |
| 14 | `3GBJU7N7_E139` | `motivates` | 06-Fault Severity | remaining useful life(Multiple Severities) |  | 17-Core Classifier Algorithm | Particle Filter |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `3GBJU7N7_E128`：multiple fault modes(Compound Faults) motivates Gap metric
  - `3GBJU7N7_E129`：process noise and prediction uncertainty(Uncertainty) motivates Gap metric
  - `3GBJU7N7_E130`：degradation feature extraction and prediction(Early Degradation Prediction) motivates Gap metric
  - `3GBJU7N7_E131`：multiple fault modes(Compound Faults) motivates Gap-DBN
  - `3GBJU7N7_E132`：process noise and prediction uncertainty(Uncertainty) motivates Gap-DBN
  - `3GBJU7N7_E133`：degradation feature extraction and prediction(Early Degradation Prediction) motivates Gap-DBN
  - `3GBJU7N7_E134`：multiple fault modes(Compound Faults) motivates Particle Filter
  - `3GBJU7N7_E135`：process noise and prediction uncertainty(Uncertainty) motivates Particle Filter
  - `3GBJU7N7_E136`：degradation feature extraction and prediction(Early Degradation Prediction) motivates Particle Filter
