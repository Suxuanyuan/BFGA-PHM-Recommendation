...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `Q8PEX93T_E110` | `motivates` | 09-Problem Scenario | complex system fault diagnosis(Complex Systems) |  | 19-Training Optimization Algorithm | PSO |  |
| 2 | `Q8PEX93T_E111` | `motivates` | 09-Problem Scenario | manual parameter tuning and design of deep neural networks(Other) |  | 19-Training Optimization Algorithm | PSO |  |
| 3 | `Q8PEX93T_E112` | `motivates` | 12-Training Data Availability | 500/2000 instances per class(Sufficient) |  | 19-Training Optimization Algorithm | PSO |  |
| 4 | `Q8PEX93T_E113` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Hierarchical Symbolic Analysis |  |
| 5 | `Q8PEX93T_E114` | `motivates` | 09-Problem Scenario | complex system fault diagnosis(Complex Systems) |  | 16-Feature Extraction Algorithm | Hierarchical Symbolic Analysis |  |
| 6 | `Q8PEX93T_E115` | `motivates` | 09-Problem Scenario | manual parameter tuning and design of deep neural networks(Other) |  | 16-Feature Extraction Algorithm | Hierarchical Symbolic Analysis |  |
| 7 | `Q8PEX93T_E116` | `motivates` | 09-Problem Scenario | complex system fault diagnosis(Complex Systems) |  | 17-Core Classifier Algorithm | CNN |  |
| 8 | `Q8PEX93T_E117` | `motivates` | 09-Problem Scenario | manual parameter tuning and design of deep neural networks(Other) |  | 17-Core Classifier Algorithm | CNN |  |
| 9 | `Q8PEX93T_E118` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Hierarchical Symbolic Analysis |  |
| 10 | `Q8PEX93T_E119` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | CNN |  |
| 11 | `Q8PEX93T_E120` | `motivates` | 06-Fault Severity | fault size lesser than 0.5 mm, fault size of 2 × 3 mm2(Single Severity) |  | 17-Core Classifier Algorithm | CNN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `Q8PEX93T_E110`：complex system fault diagnosis(Complex Systems) motivates PSO
  - `Q8PEX93T_E111`：manual parameter tuning and design of deep neural networks(Other) motivates PSO
  - `Q8PEX93T_E114`：complex system fault diagnosis(Complex Systems) motivates Hierarchical Symbolic Analysis
  - `Q8PEX93T_E115`：manual parameter tuning and design of deep neural networks(Other) motivates Hierarchical Symbolic Analysis
  - `Q8PEX93T_E116`：complex system fault diagnosis(Complex Systems) motivates CNN
  - `Q8PEX93T_E117`：manual parameter tuning and design of deep neural networks(Other) motivates CNN
