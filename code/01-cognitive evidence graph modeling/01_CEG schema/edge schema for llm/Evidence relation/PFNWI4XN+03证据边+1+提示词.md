...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PFNWI4XN_E117` | `motivates` | 13-Noise Level | non-Gaussian noise and a low signal-to-noise ratio (SNR)(High Noise) |  | 15-Data Preprocessing Algorithm | Wavelet Packet Transform |  |
| 2 | `PFNWI4XN_E118` | `motivates` | 13-Noise Level | non-Gaussian noise and a low signal-to-noise ratio (SNR)(High Noise) |  | 16-Feature Extraction Algorithm | Enhanced Frequency Band Entropy |  |
| 3 | `PFNWI4XN_E119` | `motivates` | 09-Problem Scenario | low signal-to-noise ratio (SNR) and non-Gaussian noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Wavelet Packet Transform |  |
| 4 | `PFNWI4XN_E120` | `motivates` | 09-Problem Scenario | early weak fault characteristics(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Wavelet Packet Transform |  |
| 5 | `PFNWI4XN_E121` | `motivates` | 09-Problem Scenario | low signal-to-noise ratio (SNR) and non-Gaussian noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Enhanced Frequency Band Entropy |  |
| 6 | `PFNWI4XN_E122` | `motivates` | 09-Problem Scenario | early weak fault characteristics(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Enhanced Frequency Band Entropy |  |
| 7 | `PFNWI4XN_E123` | `motivates` | 09-Problem Scenario | low signal-to-noise ratio (SNR) and non-Gaussian noise(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Power Spectrum Analysis |  |
| 8 | `PFNWI4XN_E124` | `motivates` | 09-Problem Scenario | early weak fault characteristics(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Envelope Power Spectrum Analysis |  |
| 9 | `PFNWI4XN_E125` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Enhanced Frequency Band Entropy |  |
| 10 | `PFNWI4XN_E126` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope Power Spectrum Analysis |  |
| 11 | `PFNWI4XN_E127` | `motivates` | 06-Fault Severity | 0.021'', 0.028''(Single Severity) |  | 17-Core Classifier Algorithm | Envelope Power Spectrum Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `PFNWI4XN_E119`：low signal-to-noise ratio (SNR) and non-Gaussian noise(Uncertainty) motivates Wavelet Packet Transform
  - `PFNWI4XN_E120`：early weak fault characteristics(Early Degradation Prediction) motivates Wavelet Packet Transform
  - `PFNWI4XN_E121`：low signal-to-noise ratio (SNR) and non-Gaussian noise(Uncertainty) motivates Enhanced Frequency Band Entropy
  - `PFNWI4XN_E122`：early weak fault characteristics(Early Degradation Prediction) motivates Enhanced Frequency Band Entropy
  - `PFNWI4XN_E123`：low signal-to-noise ratio (SNR) and non-Gaussian noise(Uncertainty) motivates Envelope Power Spectrum Analysis
  - `PFNWI4XN_E124`：early weak fault characteristics(Early Degradation Prediction) motivates Envelope Power Spectrum Analysis
