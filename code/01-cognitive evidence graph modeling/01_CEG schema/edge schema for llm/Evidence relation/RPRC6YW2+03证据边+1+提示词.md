...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `RPRC6YW2_E126` | `motivates` | 09-Problem Scenario | new class faults(Zero Fault Samples) |  | 19-Training Optimization Algorithm | Learn++.NC |  |
| 2 | `RPRC6YW2_E127` | `motivates` | 09-Problem Scenario | missing data scenarios(Other) |  | 19-Training Optimization Algorithm | Learn++.NC |  |
| 3 | `RPRC6YW2_E128` | `motivates` | 12-Training Data Availability | Train-set1 (232 patterns), Train-set2 (500 patterns), Train-set3 (1028 patterns)(Sufficient) |  | 19-Training Optimization Algorithm | Learn++.NC |  |
| 4 | `RPRC6YW2_E129` | `motivates` | 13-Noise Level | noise and unstructured variance in residual data(High Noise) |  | 15-Data Preprocessing Algorithm | Down-sampling |  |
| 5 | `RPRC6YW2_E130` | `motivates` | 13-Noise Level | noise and unstructured variance in residual data(High Noise) |  | 16-Feature Extraction Algorithm | NIPALS |  |
| 6 | `RPRC6YW2_E131` | `motivates` | 09-Problem Scenario | new class faults(Zero Fault Samples) |  | 15-Data Preprocessing Algorithm | Down-sampling |  |
| 7 | `RPRC6YW2_E132` | `motivates` | 09-Problem Scenario | missing data scenarios(Other) |  | 15-Data Preprocessing Algorithm | Down-sampling |  |
| 8 | `RPRC6YW2_E133` | `motivates` | 09-Problem Scenario | new class faults(Zero Fault Samples) |  | 16-Feature Extraction Algorithm | NIPALS |  |
| 9 | `RPRC6YW2_E134` | `motivates` | 09-Problem Scenario | missing data scenarios(Other) |  | 16-Feature Extraction Algorithm | NIPALS |  |
| 10 | `RPRC6YW2_E135` | `motivates` | 09-Problem Scenario | new class faults(Zero Fault Samples) |  | 17-Core Classifier Algorithm | MLP |  |
| 11 | `RPRC6YW2_E136` | `motivates` | 09-Problem Scenario | missing data scenarios(Other) |  | 17-Core Classifier Algorithm | MLP |  |
| 12 | `RPRC6YW2_E137` | `motivates` | 07-Compound Fault | single additive sensor faults(No Compound Fault) |  | 16-Feature Extraction Algorithm | NIPALS |  |
| 13 | `RPRC6YW2_E138` | `motivates` | 07-Compound Fault | single additive sensor faults(No Compound Fault) |  | 17-Core Classifier Algorithm | MLP |  |
| 14 | `RPRC6YW2_E139` | `motivates` | 06-Fault Severity | 5% of the rated stator voltage / current / rotor current (peak value)(Single Severity) |  | 17-Core Classifier Algorithm | MLP |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `RPRC6YW2_E126`：new class faults(Zero Fault Samples) motivates Learn++.NC
  - `RPRC6YW2_E127`：missing data scenarios(Other) motivates Learn++.NC
  - `RPRC6YW2_E131`：new class faults(Zero Fault Samples) motivates Down-sampling
  - `RPRC6YW2_E132`：missing data scenarios(Other) motivates Down-sampling
  - `RPRC6YW2_E133`：new class faults(Zero Fault Samples) motivates NIPALS
  - `RPRC6YW2_E134`：missing data scenarios(Other) motivates NIPALS
  - `RPRC6YW2_E135`：new class faults(Zero Fault Samples) motivates MLP
  - `RPRC6YW2_E136`：missing data scenarios(Other) motivates MLP
