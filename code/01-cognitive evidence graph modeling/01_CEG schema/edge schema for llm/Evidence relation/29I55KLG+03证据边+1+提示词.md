...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `29I55KLG_E108` | `motivates` | 09-Problem Scenario | small sample data(Small Fault Samples) |  | 19-Training Optimization Algorithm | Cut-off Condition |  |
| 2 | `29I55KLG_E109` | `motivates` | 09-Problem Scenario | noise robustness / effect of noises(Uncertainty) |  | 19-Training Optimization Algorithm | Cut-off Condition |  |
| 3 | `29I55KLG_E110` | `motivates` | 12-Training Data Availability | small sample data(Scarce) |  | 19-Training Optimization Algorithm | Cut-off Condition |  |
| 4 | `29I55KLG_E111` | `motivates` | 13-Noise Level | Gaussian white noise(High Noise) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 5 | `29I55KLG_E112` | `motivates` | 13-Noise Level | Gaussian white noise(High Noise) |  | 16-Feature Extraction Algorithm | CNN |  |
| 6 | `29I55KLG_E113` | `motivates` | 09-Problem Scenario | small sample data(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 7 | `29I55KLG_E114` | `motivates` | 09-Problem Scenario | noise robustness / effect of noises(Uncertainty) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 8 | `29I55KLG_E115` | `motivates` | 09-Problem Scenario | small sample data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | CNN |  |
| 9 | `29I55KLG_E116` | `motivates` | 09-Problem Scenario | noise robustness / effect of noises(Uncertainty) |  | 16-Feature Extraction Algorithm | CNN |  |
| 10 | `29I55KLG_E117` | `motivates` | 09-Problem Scenario | small sample data(Small Fault Samples) |  | 17-Core Classifier Algorithm | SVM |  |
| 11 | `29I55KLG_E118` | `motivates` | 09-Problem Scenario | noise robustness / effect of noises(Uncertainty) |  | 17-Core Classifier Algorithm | SVM |  |
| 12 | `29I55KLG_E119` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 13 | `29I55KLG_E120` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVM |  |
| 14 | `29I55KLG_E121` | `motivates` | 06-Fault Severity | 0.007, 0.014, 0.021 in.(Multiple Severities) |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `29I55KLG_E108`：small sample data(Small Fault Samples) motivates Cut-off Condition
  - `29I55KLG_E109`：noise robustness / effect of noises(Uncertainty) motivates Cut-off Condition
  - `29I55KLG_E113`：small sample data(Small Fault Samples) motivates Normalization
  - `29I55KLG_E114`：noise robustness / effect of noises(Uncertainty) motivates Normalization
  - `29I55KLG_E115`：small sample data(Small Fault Samples) motivates CNN
  - `29I55KLG_E116`：noise robustness / effect of noises(Uncertainty) motivates CNN
  - `29I55KLG_E117`：small sample data(Small Fault Samples) motivates SVM
  - `29I55KLG_E118`：noise robustness / effect of noises(Uncertainty) motivates SVM
