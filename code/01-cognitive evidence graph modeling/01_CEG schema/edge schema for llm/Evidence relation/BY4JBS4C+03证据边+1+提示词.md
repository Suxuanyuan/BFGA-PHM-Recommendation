...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `BY4JBS4C_E114` | `motivates` | 13-Noise Level | The signature obtained is robust to disturbances(Normal) |  | 15-Data Preprocessing Algorithm | PCA |  |
| 2 | `BY4JBS4C_E115` | `motivates` | 13-Noise Level | The signature obtained is robust to disturbances(Normal) |  | 16-Feature Extraction Algorithm | Kernel Density Estimation |  |
| 3 | `BY4JBS4C_E116` | `motivates` | 09-Problem Scenario | online monitoring computational cost(Other) |  | 15-Data Preprocessing Algorithm | PCA |  |
| 4 | `BY4JBS4C_E117` | `motivates` | 09-Problem Scenario | uncertainties and disturbances in current signals(Uncertainty) |  | 15-Data Preprocessing Algorithm | PCA |  |
| 5 | `BY4JBS4C_E118` | `motivates` | 09-Problem Scenario | online monitoring computational cost(Other) |  | 16-Feature Extraction Algorithm | Kernel Density Estimation |  |
| 6 | `BY4JBS4C_E119` | `motivates` | 09-Problem Scenario | uncertainties and disturbances in current signals(Uncertainty) |  | 16-Feature Extraction Algorithm | Kernel Density Estimation |  |
| 7 | `BY4JBS4C_E120` | `motivates` | 09-Problem Scenario | online monitoring computational cost(Other) |  | 17-Core Classifier Algorithm | Kullback-Leibler Divergence |  |
| 8 | `BY4JBS4C_E121` | `motivates` | 09-Problem Scenario | uncertainties and disturbances in current signals(Uncertainty) |  | 17-Core Classifier Algorithm | Kullback-Leibler Divergence |  |
| 9 | `BY4JBS4C_E122` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Kernel Density Estimation |  |
| 10 | `BY4JBS4C_E123` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Kullback-Leibler Divergence |  |
| 11 | `BY4JBS4C_E124` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Kullback-Leibler Divergence |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `BY4JBS4C_E116`：online monitoring computational cost(Other) motivates PCA
  - `BY4JBS4C_E117`：uncertainties and disturbances in current signals(Uncertainty) motivates PCA
  - `BY4JBS4C_E118`：online monitoring computational cost(Other) motivates Kernel Density Estimation
  - `BY4JBS4C_E119`：uncertainties and disturbances in current signals(Uncertainty) motivates Kernel Density Estimation
  - `BY4JBS4C_E120`：online monitoring computational cost(Other) motivates Kullback-Leibler Divergence
  - `BY4JBS4C_E121`：uncertainties and disturbances in current signals(Uncertainty) motivates Kullback-Leibler Divergence
