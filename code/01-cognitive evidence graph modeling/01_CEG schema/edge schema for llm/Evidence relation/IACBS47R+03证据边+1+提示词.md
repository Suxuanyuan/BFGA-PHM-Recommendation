...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `IACBS47R_E076` | `motivates` | 09-Problem Scenario | noise modeling / noise robustness(Uncertainty) |  | 19-Training Optimization Algorithm | Expectation-Maximization |  |
| 2 | `IACBS47R_E077` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Expectation-Maximization |  |
| 3 | `IACBS47R_E078` | `motivates` | 13-Noise Level | strong and complex noise(High Noise) |  | 16-Feature Extraction Algorithm | Tunable Q-factor Wavelet Transform |  |
| 4 | `IACBS47R_E079` | `motivates` | 09-Problem Scenario | noise modeling / noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Tunable Q-factor Wavelet Transform |  |
| 5 | `IACBS47R_E080` | `motivates` | 09-Problem Scenario | noise modeling / noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Spectrum |  |
| 6 | `IACBS47R_E081` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Tunable Q-factor Wavelet Transform |  |
| 7 | `IACBS47R_E082` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope Spectrum |  |
| 8 | `IACBS47R_E083` | `motivates` | 06-Fault Severity | run-to-failure(Multiple Severities) |  | 17-Core Classifier Algorithm | Envelope Spectrum |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `IACBS47R_E076`：noise modeling / noise robustness(Uncertainty) motivates Expectation-Maximization
  - `IACBS47R_E079`：noise modeling / noise robustness(Uncertainty) motivates Tunable Q-factor Wavelet Transform
  - `IACBS47R_E080`：noise modeling / noise robustness(Uncertainty) motivates Envelope Spectrum
