...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `G8T7YJIH_E104` | `motivates` | 13-Noise Level | noise cleaning, structure-less noise(High Noise) |  | 15-Data Preprocessing Algorithm | Singular Spectrum Analysis |  |
| 2 | `G8T7YJIH_E105` | `motivates` | 13-Noise Level | noise cleaning, structure-less noise(High Noise) |  | 16-Feature Extraction Algorithm | Linear Time Invariant Autoregressive Model |  |
| 3 | `G8T7YJIH_E106` | `motivates` | 09-Problem Scenario | noise in vibration signals(Uncertainty) |  | 15-Data Preprocessing Algorithm | Singular Spectrum Analysis |  |
| 4 | `G8T7YJIH_E107` | `motivates` | 09-Problem Scenario | non-stationarity of bearing vibration signals(Other) |  | 15-Data Preprocessing Algorithm | Singular Spectrum Analysis |  |
| 5 | `G8T7YJIH_E108` | `motivates` | 09-Problem Scenario | noise in vibration signals(Uncertainty) |  | 16-Feature Extraction Algorithm | Linear Time Invariant Autoregressive Model |  |
| 6 | `G8T7YJIH_E109` | `motivates` | 09-Problem Scenario | non-stationarity of bearing vibration signals(Other) |  | 16-Feature Extraction Algorithm | Linear Time Invariant Autoregressive Model |  |
| 7 | `G8T7YJIH_E110` | `motivates` | 09-Problem Scenario | noise in vibration signals(Uncertainty) |  | 17-Core Classifier Algorithm | Nearest Neighbour |  |
| 8 | `G8T7YJIH_E111` | `motivates` | 09-Problem Scenario | non-stationarity of bearing vibration signals(Other) |  | 17-Core Classifier Algorithm | Nearest Neighbour |  |
| 9 | `G8T7YJIH_E112` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Linear Time Invariant Autoregressive Model |  |
| 10 | `G8T7YJIH_E113` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Nearest Neighbour |  |
| 11 | `G8T7YJIH_E114` | `motivates` | 06-Fault Severity | 0.007 in., 0.014 in., 0.021 in., 0.05 in., 0.006 in., 0.0098 in., 0.0178 in.(Multiple Severities) |  | 17-Core Classifier Algorithm | Nearest Neighbour |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `G8T7YJIH_E106`：noise in vibration signals(Uncertainty) motivates Singular Spectrum Analysis
  - `G8T7YJIH_E107`：non-stationarity of bearing vibration signals(Other) motivates Singular Spectrum Analysis
  - `G8T7YJIH_E108`：noise in vibration signals(Uncertainty) motivates Linear Time Invariant Autoregressive Model
  - `G8T7YJIH_E109`：non-stationarity of bearing vibration signals(Other) motivates Linear Time Invariant Autoregressive Model
  - `G8T7YJIH_E110`：noise in vibration signals(Uncertainty) motivates Nearest Neighbour
  - `G8T7YJIH_E111`：non-stationarity of bearing vibration signals(Other) motivates Nearest Neighbour
