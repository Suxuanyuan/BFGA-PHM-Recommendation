...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4TXMIDZ8_E086` | `motivates` | 13-Noise Level | mixed with serious noise(High Noise) |  | 15-Data Preprocessing Algorithm | Wavelet Threshold Denoising |  |
| 2 | `4TXMIDZ8_E087` | `motivates` | 13-Noise Level | mixed with serious noise(High Noise) |  | 16-Feature Extraction Algorithm | Nonlinear Mode Decomposition |  |
| 3 | `4TXMIDZ8_E088` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Wavelet Threshold Denoising |  |
| 4 | `4TXMIDZ8_E089` | `motivates` | 09-Problem Scenario | parameter sensitivity(Other) |  | 15-Data Preprocessing Algorithm | Wavelet Threshold Denoising |  |
| 5 | `4TXMIDZ8_E090` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Nonlinear Mode Decomposition |  |
| 6 | `4TXMIDZ8_E091` | `motivates` | 09-Problem Scenario | parameter sensitivity(Other) |  | 16-Feature Extraction Algorithm | Nonlinear Mode Decomposition |  |
| 7 | `4TXMIDZ8_E092` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 8 | `4TXMIDZ8_E093` | `motivates` | 09-Problem Scenario | parameter sensitivity(Other) |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 9 | `4TXMIDZ8_E094` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Nonlinear Mode Decomposition |  |
| 10 | `4TXMIDZ8_E095` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 11 | `4TXMIDZ8_E096` | `motivates` | 06-Fault Severity | fault diameter of 0.021 inches, fault depth of 0.011 inches(Single Severity) |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4TXMIDZ8_E088`：noise robustness(Uncertainty) motivates Wavelet Threshold Denoising
  - `4TXMIDZ8_E089`：parameter sensitivity(Other) motivates Wavelet Threshold Denoising
  - `4TXMIDZ8_E090`：noise robustness(Uncertainty) motivates Nonlinear Mode Decomposition
  - `4TXMIDZ8_E091`：parameter sensitivity(Other) motivates Nonlinear Mode Decomposition
  - `4TXMIDZ8_E092`：noise robustness(Uncertainty) motivates Envelope Spectrum Analysis
  - `4TXMIDZ8_E093`：parameter sensitivity(Other) motivates Envelope Spectrum Analysis
