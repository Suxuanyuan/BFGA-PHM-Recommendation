...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZYK243Y3_E090` | `motivates` | 09-Problem Scenario | noise over signal(Uncertainty) |  | 19-Training Optimization Algorithm | Swarm Rapid Centroid Estimation |  |
| 2 | `ZYK243Y3_E091` | `motivates` | 09-Problem Scenario | subtler defects(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | Swarm Rapid Centroid Estimation |  |
| 3 | `ZYK243Y3_E092` | `motivates` | 12-Training Data Availability | 80 observations(Sufficient) |  | 19-Training Optimization Algorithm | Swarm Rapid Centroid Estimation |  |
| 4 | `ZYK243Y3_E093` | `motivates` | 13-Noise Level | additive stochastic noise / noise from other sources of vibration(High Noise) |  | 15-Data Preprocessing Algorithm | Autoregressive Model |  |
| 5 | `ZYK243Y3_E094` | `motivates` | 13-Noise Level | additive stochastic noise / noise from other sources of vibration(High Noise) |  | 16-Feature Extraction Algorithm | Continuous Wavelet Transform |  |
| 6 | `ZYK243Y3_E095` | `motivates` | 09-Problem Scenario | noise over signal(Uncertainty) |  | 15-Data Preprocessing Algorithm | Autoregressive Model |  |
| 7 | `ZYK243Y3_E096` | `motivates` | 09-Problem Scenario | subtler defects(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Autoregressive Model |  |
| 8 | `ZYK243Y3_E097` | `motivates` | 09-Problem Scenario | noise over signal(Uncertainty) |  | 16-Feature Extraction Algorithm | Continuous Wavelet Transform |  |
| 9 | `ZYK243Y3_E098` | `motivates` | 09-Problem Scenario | subtler defects(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Continuous Wavelet Transform |  |
| 10 | `ZYK243Y3_E099` | `motivates` | 09-Problem Scenario | noise over signal(Uncertainty) |  | 17-Core Classifier Algorithm | Hidden Markov Model |  |
| 11 | `ZYK243Y3_E100` | `motivates` | 09-Problem Scenario | subtler defects(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Hidden Markov Model |  |
| 12 | `ZYK243Y3_E101` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Continuous Wavelet Transform |  |
| 13 | `ZYK243Y3_E102` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Hidden Markov Model |  |
| 14 | `ZYK243Y3_E103` | `motivates` | 06-Fault Severity | defect diameters of 7 mils, 14 mils, and 21 mils(Multiple Severities) |  | 17-Core Classifier Algorithm | Hidden Markov Model |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZYK243Y3_E090`：noise over signal(Uncertainty) motivates Swarm Rapid Centroid Estimation
  - `ZYK243Y3_E091`：subtler defects(Early Degradation Prediction) motivates Swarm Rapid Centroid Estimation
  - `ZYK243Y3_E095`：noise over signal(Uncertainty) motivates Autoregressive Model
  - `ZYK243Y3_E096`：subtler defects(Early Degradation Prediction) motivates Autoregressive Model
  - `ZYK243Y3_E097`：noise over signal(Uncertainty) motivates Continuous Wavelet Transform
  - `ZYK243Y3_E098`：subtler defects(Early Degradation Prediction) motivates Continuous Wavelet Transform
  - `ZYK243Y3_E099`：noise over signal(Uncertainty) motivates Hidden Markov Model
  - `ZYK243Y3_E100`：subtler defects(Early Degradation Prediction) motivates Hidden Markov Model
