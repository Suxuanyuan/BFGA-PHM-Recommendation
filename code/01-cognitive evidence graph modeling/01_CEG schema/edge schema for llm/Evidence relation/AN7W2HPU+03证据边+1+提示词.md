...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AN7W2HPU_E105` | `motivates` | 09-Problem Scenario | early weak fault(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | IQGA |  |
| 2 | `AN7W2HPU_E106` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 19-Training Optimization Algorithm | IQGA |  |
| 3 | `AN7W2HPU_E107` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | IQGA |  |
| 4 | `AN7W2HPU_E108` | `motivates` | 13-Noise Level | strong background noise(High Noise) |  | 16-Feature Extraction Algorithm | EOMP |  |
| 5 | `AN7W2HPU_E109` | `motivates` | 09-Problem Scenario | early weak fault(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | EOMP |  |
| 6 | `AN7W2HPU_E110` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | EOMP |  |
| 7 | `AN7W2HPU_E111` | `motivates` | 09-Problem Scenario | early weak fault(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | FFT |  |
| 8 | `AN7W2HPU_E112` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 17-Core Classifier Algorithm | FFT |  |
| 9 | `AN7W2HPU_E113` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | EOMP |  |
| 10 | `AN7W2HPU_E114` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | FFT |  |
| 11 | `AN7W2HPU_E115` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | FFT |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `AN7W2HPU_E105`：early weak fault(Early Degradation Prediction) motivates IQGA
  - `AN7W2HPU_E106`：strong background noise(Uncertainty) motivates IQGA
  - `AN7W2HPU_E109`：early weak fault(Early Degradation Prediction) motivates EOMP
  - `AN7W2HPU_E110`：strong background noise(Uncertainty) motivates EOMP
  - `AN7W2HPU_E111`：early weak fault(Early Degradation Prediction) motivates FFT
  - `AN7W2HPU_E112`：strong background noise(Uncertainty) motivates FFT
