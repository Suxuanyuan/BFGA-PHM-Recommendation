...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `G7F9QUXG_E089` | `motivates` | 13-Noise Level | nonlinear noise(High Noise) |  | 16-Feature Extraction Algorithm | EEMD |  |
| 2 | `G7F9QUXG_E090` | `motivates` | 09-Problem Scenario | positioning of additional sensors / diagnosis without additional sensors(Other) |  | 16-Feature Extraction Algorithm | EEMD |  |
| 3 | `G7F9QUXG_E091` | `motivates` | 09-Problem Scenario | nonlinear noise and non-target harmonics(Uncertainty) |  | 16-Feature Extraction Algorithm | EEMD |  |
| 4 | `G7F9QUXG_E092` | `motivates` | 09-Problem Scenario | positioning of additional sensors / diagnosis without additional sensors(Other) |  | 17-Core Classifier Algorithm | VPT |  |
| 5 | `G7F9QUXG_E093` | `motivates` | 09-Problem Scenario | nonlinear noise and non-target harmonics(Uncertainty) |  | 17-Core Classifier Algorithm | VPT |  |
| 6 | `G7F9QUXG_E094` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | EEMD |  |
| 7 | `G7F9QUXG_E095` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | VPT |  |
| 8 | `G7F9QUXG_E096` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | VPT |  |
| 9 | `G7PD5ANR_E112` | `motivates` | 09-Problem Scenario | insufficient fault database(Small Fault Samples) |  | 19-Training Optimization Algorithm | TrAdaBoost |  |
| 10 | `G7PD5ANR_E113` | `motivates` | 09-Problem Scenario | different feature distribution(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | TrAdaBoost |  |
| 11 | `G7PD5ANR_E114` | `motivates` | 12-Training Data Availability | insuﬃcient fault database(Scarce) |  | 19-Training Optimization Algorithm | TrAdaBoost |  |
| 12 | `G7PD5ANR_E115` | `motivates` | 13-Noise Level | background noise(High Noise) |  | 15-Data Preprocessing Algorithm | CEEMD |  |
| 13 | `G7PD5ANR_E116` | `motivates` | 13-Noise Level | background noise(High Noise) |  | 16-Feature Extraction Algorithm | SVD |  |
| 14 | `G7PD5ANR_E117` | `motivates` | 09-Problem Scenario | insufficient fault database(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | CEEMD |  |
| 15 | `G7PD5ANR_E118` | `motivates` | 09-Problem Scenario | different feature distribution(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | CEEMD |  |
| 16 | `G7PD5ANR_E119` | `motivates` | 09-Problem Scenario | insufficient fault database(Small Fault Samples) |  | 16-Feature Extraction Algorithm | SVD |  |
| 17 | `G7PD5ANR_E120` | `motivates` | 09-Problem Scenario | different feature distribution(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | SVD |  |
| 18 | `G7PD5ANR_E121` | `motivates` | 09-Problem Scenario | insufficient fault database(Small Fault Samples) |  | 17-Core Classifier Algorithm | SVM |  |
| 19 | `G7PD5ANR_E122` | `motivates` | 09-Problem Scenario | different feature distribution(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | SVM |  |
| 20 | `G7PD5ANR_E123` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | SVD |  |
| 21 | `G7PD5ANR_E124` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVM |  |
| 22 | `G7PD5ANR_E125` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `G7F9QUXG_E090`：positioning of additional sensors / diagnosis without additional sensors(Other) motivates EEMD
  - `G7F9QUXG_E091`：nonlinear noise and non-target harmonics(Uncertainty) motivates EEMD
  - `G7F9QUXG_E092`：positioning of additional sensors / diagnosis without additional sensors(Other) motivates VPT
  - `G7F9QUXG_E093`：nonlinear noise and non-target harmonics(Uncertainty) motivates VPT
  - `G7PD5ANR_E112`：insufficient fault database(Small Fault Samples) motivates TrAdaBoost
  - `G7PD5ANR_E113`：different feature distribution(Distribution Discrepancy) motivates TrAdaBoost
  - `G7PD5ANR_E117`：insufficient fault database(Small Fault Samples) motivates CEEMD
  - `G7PD5ANR_E118`：different feature distribution(Distribution Discrepancy) motivates CEEMD
  - `G7PD5ANR_E119`：insufficient fault database(Small Fault Samples) motivates SVD
  - `G7PD5ANR_E120`：different feature distribution(Distribution Discrepancy) motivates SVD
  - `G7PD5ANR_E121`：insufficient fault database(Small Fault Samples) motivates SVM
  - `G7PD5ANR_E122`：different feature distribution(Distribution Discrepancy) motivates SVM
