...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3JUZZK5Z_E090` | `motivates` | 09-Problem Scenario | early weak faults(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | PSO |  |
| 2 | `3JUZZK5Z_E091` | `motivates` | 09-Problem Scenario | strong environmental noise(Uncertainty) |  | 19-Training Optimization Algorithm | PSO |  |
| 3 | `3JUZZK5Z_E092` | `motivates` | 12-Training Data Availability | 1920 samples forms a training set, 1080 groups make up a training set(Sufficient) |  | 19-Training Optimization Algorithm | PSO |  |
| 4 | `3JUZZK5Z_E093` | `motivates` | 13-Noise Level | strong environmental noise(High Noise) |  | 15-Data Preprocessing Algorithm | StOMP |  |
| 5 | `3JUZZK5Z_E094` | `motivates` | 13-Noise Level | strong environmental noise(High Noise) |  | 16-Feature Extraction Algorithm | Time-domain features |  |
| 6 | `3JUZZK5Z_E095` | `motivates` | 09-Problem Scenario | early weak faults(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | StOMP |  |
| 7 | `3JUZZK5Z_E096` | `motivates` | 09-Problem Scenario | strong environmental noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | StOMP |  |
| 8 | `3JUZZK5Z_E097` | `motivates` | 09-Problem Scenario | early weak faults(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Time-domain features |  |
| 9 | `3JUZZK5Z_E098` | `motivates` | 09-Problem Scenario | strong environmental noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Time-domain features |  |
| 10 | `3JUZZK5Z_E099` | `motivates` | 09-Problem Scenario | early weak faults(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | SVM |  |
| 11 | `3JUZZK5Z_E100` | `motivates` | 09-Problem Scenario | strong environmental noise(Uncertainty) |  | 17-Core Classifier Algorithm | SVM |  |
| 12 | `3JUZZK5Z_E101` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Time-domain features |  |
| 13 | `3JUZZK5Z_E102` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVM |  |
| 14 | `3JUZZK5Z_E103` | `motivates` | 06-Fault Severity | Flacking area / Flacking diameter(Multiple Severities) |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `3JUZZK5Z_E090`：early weak faults(Early Degradation Prediction) motivates PSO
  - `3JUZZK5Z_E091`：strong environmental noise(Uncertainty) motivates PSO
  - `3JUZZK5Z_E095`：early weak faults(Early Degradation Prediction) motivates StOMP
  - `3JUZZK5Z_E096`：strong environmental noise(Uncertainty) motivates StOMP
  - `3JUZZK5Z_E097`：early weak faults(Early Degradation Prediction) motivates Time-domain features
  - `3JUZZK5Z_E098`：strong environmental noise(Uncertainty) motivates Time-domain features
  - `3JUZZK5Z_E099`：early weak faults(Early Degradation Prediction) motivates SVM
  - `3JUZZK5Z_E100`：strong environmental noise(Uncertainty) motivates SVM
