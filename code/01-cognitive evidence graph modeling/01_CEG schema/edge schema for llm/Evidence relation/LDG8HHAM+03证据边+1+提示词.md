...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `LDG8HHAM_E091` | `motivates` | 13-Noise Level | self-adaptive de-noising based on EEMD(High Noise) |  | 15-Data Preprocessing Algorithm | Improved EEMD |  |
| 2 | `LDG8HHAM_E092` | `motivates` | 13-Noise Level | self-adaptive de-noising based on EEMD(High Noise) |  | 16-Feature Extraction Algorithm | Improved EEMD |  |
| 3 | `LDG8HHAM_E093` | `motivates` | 09-Problem Scenario | few training samples(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Improved EEMD |  |
| 4 | `LDG8HHAM_E094` | `motivates` | 09-Problem Scenario | short signal decomposition / end effect(Other) |  | 15-Data Preprocessing Algorithm | Improved EEMD |  |
| 5 | `LDG8HHAM_E095` | `motivates` | 09-Problem Scenario | few training samples(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Improved EEMD |  |
| 6 | `LDG8HHAM_E096` | `motivates` | 09-Problem Scenario | short signal decomposition / end effect(Other) |  | 16-Feature Extraction Algorithm | Improved EEMD |  |
| 7 | `LDG8HHAM_E097` | `motivates` | 09-Problem Scenario | few training samples(Small Fault Samples) |  | 17-Core Classifier Algorithm | SVM |  |
| 8 | `LDG8HHAM_E098` | `motivates` | 09-Problem Scenario | short signal decomposition / end effect(Other) |  | 17-Core Classifier Algorithm | SVM |  |
| 9 | `LDG8HHAM_E099` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Improved EEMD |  |
| 10 | `LDG8HHAM_E100` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVM |  |
| 11 | `LDG8HHAM_E101` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `LDG8HHAM_E093`：few training samples(Small Fault Samples) motivates Improved EEMD
  - `LDG8HHAM_E094`：short signal decomposition / end effect(Other) motivates Improved EEMD
  - `LDG8HHAM_E095`：few training samples(Small Fault Samples) motivates Improved EEMD
  - `LDG8HHAM_E096`：short signal decomposition / end effect(Other) motivates Improved EEMD
  - `LDG8HHAM_E097`：few training samples(Small Fault Samples) motivates SVM
  - `LDG8HHAM_E098`：short signal decomposition / end effect(Other) motivates SVM
