...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZS9AMWJE_E099` | `motivates` | 09-Problem Scenario | compound-fault and multi-fault signals(Compound Faults) |  | 19-Training Optimization Algorithm | Harmonic-to-noise ratio optimization |  |
| 2 | `ZS9AMWJE_E100` | `motivates` | 09-Problem Scenario | noisy measured signal, random impulse, prior period knowledge dependence(Uncertainty) |  | 19-Training Optimization Algorithm | Harmonic-to-noise ratio optimization |  |
| 3 | `ZS9AMWJE_E101` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Harmonic-to-noise ratio optimization |  |
| 4 | `ZS9AMWJE_E102` | `motivates` | 13-Noise Level | noisy measured signal, SNR of -14 dB and -12 dB(High Noise) |  | 16-Feature Extraction Algorithm | Normalized proportion of harmonics |  |
| 5 | `ZS9AMWJE_E103` | `motivates` | 09-Problem Scenario | compound-fault and multi-fault signals(Compound Faults) |  | 16-Feature Extraction Algorithm | Normalized proportion of harmonics |  |
| 6 | `ZS9AMWJE_E104` | `motivates` | 09-Problem Scenario | noisy measured signal, random impulse, prior period knowledge dependence(Uncertainty) |  | 16-Feature Extraction Algorithm | Normalized proportion of harmonics |  |
| 7 | `ZS9AMWJE_E105` | `motivates` | 09-Problem Scenario | compound-fault and multi-fault signals(Compound Faults) |  | 17-Core Classifier Algorithm | Harmonics proportion diagram |  |
| 8 | `ZS9AMWJE_E106` | `motivates` | 09-Problem Scenario | noisy measured signal, random impulse, prior period knowledge dependence(Uncertainty) |  | 17-Core Classifier Algorithm | Harmonics proportion diagram |  |
| 9 | `ZS9AMWJE_E107` | `motivates` | 07-Compound Fault | compound faults(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Normalized proportion of harmonics |  |
| 10 | `ZS9AMWJE_E108` | `motivates` | 07-Compound Fault | compound faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Harmonics proportion diagram |  |
| 11 | `ZS9AMWJE_E109` | `motivates` | 06-Fault Severity | B007_1(Single Severity) |  | 17-Core Classifier Algorithm | Harmonics proportion diagram |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZS9AMWJE_E099`：compound-fault and multi-fault signals(Compound Faults) motivates Harmonic-to-noise ratio optimization
  - `ZS9AMWJE_E100`：noisy measured signal, random impulse, prior period knowledge dependence(Uncertainty) motivates Harmonic-to-noise ratio optimization
  - `ZS9AMWJE_E103`：compound-fault and multi-fault signals(Compound Faults) motivates Normalized proportion of harmonics
  - `ZS9AMWJE_E104`：noisy measured signal, random impulse, prior period knowledge dependence(Uncertainty) motivates Normalized proportion of harmonics
  - `ZS9AMWJE_E105`：compound-fault and multi-fault signals(Compound Faults) motivates Harmonics proportion diagram
  - `ZS9AMWJE_E106`：noisy measured signal, random impulse, prior period knowledge dependence(Uncertainty) motivates Harmonics proportion diagram
