...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `Q6UD9X6X_E123` | `motivates` | 09-Problem Scenario | domain discrepancy(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Multi-Adversarial Learning |  |
| 2 | `Q6UD9X6X_E124` | `motivates` | 09-Problem Scenario | labeled samples in practical operated machine are usually scarce(Small Fault Samples) |  | 19-Training Optimization Algorithm | Multi-Adversarial Learning |  |
| 3 | `Q6UD9X6X_E125` | `motivates` | 12-Training Data Availability | insufficient labeled samples, few labeled samples(Scarce) |  | 19-Training Optimization Algorithm | Multi-Adversarial Learning |  |
| 4 | `Q6UD9X6X_E126` | `motivates` | 13-Noise Level | raw vibration data(Normal) |  | 15-Data Preprocessing Algorithm | Signal-to-Image Conversion |  |
| 5 | `Q6UD9X6X_E127` | `motivates` | 13-Noise Level | raw vibration data(Normal) |  | 16-Feature Extraction Algorithm | CNN |  |
| 6 | `Q6UD9X6X_E128` | `motivates` | 09-Problem Scenario | domain discrepancy(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Signal-to-Image Conversion |  |
| 7 | `Q6UD9X6X_E129` | `motivates` | 09-Problem Scenario | labeled samples in practical operated machine are usually scarce(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Signal-to-Image Conversion |  |
| 8 | `Q6UD9X6X_E130` | `motivates` | 09-Problem Scenario | domain discrepancy(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | CNN |  |
| 9 | `Q6UD9X6X_E131` | `motivates` | 09-Problem Scenario | labeled samples in practical operated machine are usually scarce(Small Fault Samples) |  | 16-Feature Extraction Algorithm | CNN |  |
| 10 | `Q6UD9X6X_E132` | `motivates` | 09-Problem Scenario | domain discrepancy(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `Q6UD9X6X_E133` | `motivates` | 09-Problem Scenario | labeled samples in practical operated machine are usually scarce(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `Q6UD9X6X_E134` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 13 | `Q6UD9X6X_E135` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `Q6UD9X6X_E136` | `motivates` | 06-Fault Severity | 0.021 inch, run-to-failure, 0.2 mm, 0.6 mm(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `Q6UD9X6X_E123`：domain discrepancy(Distribution Discrepancy) motivates Multi-Adversarial Learning
  - `Q6UD9X6X_E124`：labeled samples in practical operated machine are usually scarce(Small Fault Samples) motivates Multi-Adversarial Learning
  - `Q6UD9X6X_E128`：domain discrepancy(Distribution Discrepancy) motivates Signal-to-Image Conversion
  - `Q6UD9X6X_E129`：labeled samples in practical operated machine are usually scarce(Small Fault Samples) motivates Signal-to-Image Conversion
  - `Q6UD9X6X_E130`：domain discrepancy(Distribution Discrepancy) motivates CNN
  - `Q6UD9X6X_E131`：labeled samples in practical operated machine are usually scarce(Small Fault Samples) motivates CNN
  - `Q6UD9X6X_E132`：domain discrepancy(Distribution Discrepancy) motivates Softmax
  - `Q6UD9X6X_E133`：labeled samples in practical operated machine are usually scarce(Small Fault Samples) motivates Softmax
