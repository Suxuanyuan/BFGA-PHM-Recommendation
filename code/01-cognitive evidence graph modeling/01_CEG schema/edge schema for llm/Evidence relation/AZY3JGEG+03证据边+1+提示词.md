...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AZY3JGEG_E073` | `motivates` | 13-Noise Level | noisy components(High Noise) |  | 15-Data Preprocessing Algorithm | Stepwise Resampling |  |
| 2 | `AZY3JGEG_E074` | `motivates` | 13-Noise Level | noisy components(High Noise) |  | 16-Feature Extraction Algorithm | CWT |  |
| 3 | `AZY3JGEG_E075` | `motivates` | 09-Problem Scenario | Bearing fault diagnosis under time-varying rotational speed without a tachometer(Other) |  | 15-Data Preprocessing Algorithm | Stepwise Resampling |  |
| 4 | `AZY3JGEG_E076` | `motivates` | 09-Problem Scenario | Bearing fault diagnosis under time-varying rotational speed without a tachometer(Other) |  | 16-Feature Extraction Algorithm | CWT |  |
| 5 | `AZY3JGEG_E077` | `motivates` | 09-Problem Scenario | Bearing fault diagnosis under time-varying rotational speed without a tachometer(Other) |  | 17-Core Classifier Algorithm | FCO Spectrum |  |
| 6 | `AZY3JGEG_E078` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CWT |  |
| 7 | `AZY3JGEG_E079` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | FCO Spectrum |  |
| 8 | `AZY3JGEG_E080` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | FCO Spectrum |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `AZY3JGEG_E075`：Bearing fault diagnosis under time-varying rotational speed without a tachometer(Other) motivates Stepwise Resampling
  - `AZY3JGEG_E076`：Bearing fault diagnosis under time-varying rotational speed without a tachometer(Other) motivates CWT
  - `AZY3JGEG_E077`：Bearing fault diagnosis under time-varying rotational speed without a tachometer(Other) motivates FCO Spectrum
