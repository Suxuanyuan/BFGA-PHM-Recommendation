...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZEVV2C9C_E089` | `motivates` | 13-Noise Level | very noisy(High Noise) |  | 15-Data Preprocessing Algorithm | Linear interpolation |  |
| 2 | `ZEVV2C9C_E090` | `motivates` | 13-Noise Level | very noisy(High Noise) |  | 16-Feature Extraction Algorithm | Adaptive observer |  |
| 3 | `ZEVV2C9C_E091` | `motivates` | 09-Problem Scenario | variable speed and unavailable speed/position measurements(Other) |  | 15-Data Preprocessing Algorithm | Linear interpolation |  |
| 4 | `ZEVV2C9C_E092` | `motivates` | 09-Problem Scenario | small fault amplitude and noisy measurements(Uncertainty) |  | 15-Data Preprocessing Algorithm | Linear interpolation |  |
| 5 | `ZEVV2C9C_E093` | `motivates` | 09-Problem Scenario | variable speed and unavailable speed/position measurements(Other) |  | 16-Feature Extraction Algorithm | Adaptive observer |  |
| 6 | `ZEVV2C9C_E094` | `motivates` | 09-Problem Scenario | small fault amplitude and noisy measurements(Uncertainty) |  | 16-Feature Extraction Algorithm | Adaptive observer |  |
| 7 | `ZEVV2C9C_E095` | `motivates` | 09-Problem Scenario | variable speed and unavailable speed/position measurements(Other) |  | 17-Core Classifier Algorithm | Spectral energy indicator |  |
| 8 | `ZEVV2C9C_E096` | `motivates` | 09-Problem Scenario | small fault amplitude and noisy measurements(Uncertainty) |  | 17-Core Classifier Algorithm | Spectral energy indicator |  |
| 9 | `ZEVV2C9C_E097` | `motivates` | 07-Compound Fault | single fault(No Compound Fault) |  | 16-Feature Extraction Algorithm | Adaptive observer |  |
| 10 | `ZEVV2C9C_E098` | `motivates` | 07-Compound Fault | single fault(No Compound Fault) |  | 17-Core Classifier Algorithm | Spectral energy indicator |  |
| 11 | `ZEVV2C9C_E099` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Spectral energy indicator |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZEVV2C9C_E091`：variable speed and unavailable speed/position measurements(Other) motivates Linear interpolation
  - `ZEVV2C9C_E092`：small fault amplitude and noisy measurements(Uncertainty) motivates Linear interpolation
  - `ZEVV2C9C_E093`：variable speed and unavailable speed/position measurements(Other) motivates Adaptive observer
  - `ZEVV2C9C_E094`：small fault amplitude and noisy measurements(Uncertainty) motivates Adaptive observer
  - `ZEVV2C9C_E095`：variable speed and unavailable speed/position measurements(Other) motivates Spectral energy indicator
  - `ZEVV2C9C_E096`：small fault amplitude and noisy measurements(Uncertainty) motivates Spectral energy indicator
