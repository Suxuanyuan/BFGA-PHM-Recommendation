...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `BQWYTHIR_E150` | `motivates` | 09-Problem Scenario | unsupervised partial transfer diagnosis (UPTD)(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | CIDA |  |
| 2 | `BQWYTHIR_E151` | `motivates` | 09-Problem Scenario | environment noise robustness(Uncertainty) |  | 19-Training Optimization Algorithm | CIDA |  |
| 3 | `BQWYTHIR_E152` | `motivates` | 12-Training Data Availability | 1000 samples for each category(Sufficient) |  | 19-Training Optimization Algorithm | CIDA |  |
| 4 | `BQWYTHIR_E153` | `motivates` | 13-Noise Level | Gaussian noise (SNR of 5dB and 2dB)(High Noise) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 5 | `BQWYTHIR_E154` | `motivates` | 09-Problem Scenario | unsupervised partial transfer diagnosis (UPTD)(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 6 | `BQWYTHIR_E155` | `motivates` | 09-Problem Scenario | environment noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 7 | `BQWYTHIR_E156` | `motivates` | 09-Problem Scenario | unsupervised partial transfer diagnosis (UPTD)(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `BQWYTHIR_E157` | `motivates` | 09-Problem Scenario | environment noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Softmax |  |
| 9 | `BQWYTHIR_E158` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 10 | `BQWYTHIR_E159` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `BQWYTHIR_E160` | `motivates` | 06-Fault Severity | mild tooth broken, sever tooth broken, 7mils, 14mils, 21mils(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `BQWYTHIR_E150`：unsupervised partial transfer diagnosis (UPTD)(Distribution Discrepancy) motivates CIDA
  - `BQWYTHIR_E151`：environment noise robustness(Uncertainty) motivates CIDA
  - `BQWYTHIR_E154`：unsupervised partial transfer diagnosis (UPTD)(Distribution Discrepancy) motivates 1DCNN
  - `BQWYTHIR_E155`：environment noise robustness(Uncertainty) motivates 1DCNN
  - `BQWYTHIR_E156`：unsupervised partial transfer diagnosis (UPTD)(Distribution Discrepancy) motivates Softmax
  - `BQWYTHIR_E157`：environment noise robustness(Uncertainty) motivates Softmax
