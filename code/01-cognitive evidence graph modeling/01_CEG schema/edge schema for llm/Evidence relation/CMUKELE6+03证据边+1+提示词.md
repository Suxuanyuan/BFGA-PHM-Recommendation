...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CMUKELE6_E084` | `motivates` | 13-Noise Level | undesired noise, weak signal detection(High Noise) |  | 15-Data Preprocessing Algorithm | Mirror-Cycle-Add |  |
| 2 | `CMUKELE6_E085` | `motivates` | 13-Noise Level | undesired noise, weak signal detection(High Noise) |  | 16-Feature Extraction Algorithm | Stochastic Resonance |  |
| 3 | `CMUKELE6_E086` | `motivates` | 09-Problem Scenario | weak signal detection under noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Mirror-Cycle-Add |  |
| 4 | `CMUKELE6_E087` | `motivates` | 09-Problem Scenario | stochastic resonance under half-wave signal excitation(Other) |  | 15-Data Preprocessing Algorithm | Mirror-Cycle-Add |  |
| 5 | `CMUKELE6_E088` | `motivates` | 09-Problem Scenario | weak signal detection under noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Stochastic Resonance |  |
| 6 | `CMUKELE6_E089` | `motivates` | 09-Problem Scenario | stochastic resonance under half-wave signal excitation(Other) |  | 16-Feature Extraction Algorithm | Stochastic Resonance |  |
| 7 | `CMUKELE6_E090` | `motivates` | 09-Problem Scenario | weak signal detection under noise(Uncertainty) |  | 17-Core Classifier Algorithm | Spectral Analysis |  |
| 8 | `CMUKELE6_E091` | `motivates` | 09-Problem Scenario | stochastic resonance under half-wave signal excitation(Other) |  | 17-Core Classifier Algorithm | Spectral Analysis |  |
| 9 | `CMUKELE6_E092` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Stochastic Resonance |  |
| 10 | `CMUKELE6_E093` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Spectral Analysis |  |
| 11 | `CMUKELE6_E094` | `motivates` | 06-Fault Severity | early failure status, 0.5 mm artificial fault(Single Severity) |  | 17-Core Classifier Algorithm | Spectral Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `CMUKELE6_E086`：weak signal detection under noise(Uncertainty) motivates Mirror-Cycle-Add
  - `CMUKELE6_E087`：stochastic resonance under half-wave signal excitation(Other) motivates Mirror-Cycle-Add
  - `CMUKELE6_E088`：weak signal detection under noise(Uncertainty) motivates Stochastic Resonance
  - `CMUKELE6_E089`：stochastic resonance under half-wave signal excitation(Other) motivates Stochastic Resonance
  - `CMUKELE6_E090`：weak signal detection under noise(Uncertainty) motivates Spectral Analysis
  - `CMUKELE6_E091`：stochastic resonance under half-wave signal excitation(Other) motivates Spectral Analysis
