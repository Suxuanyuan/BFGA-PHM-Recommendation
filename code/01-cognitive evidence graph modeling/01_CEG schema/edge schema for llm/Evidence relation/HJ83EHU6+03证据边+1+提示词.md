...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HJ83EHU6_E120` | `motivates` | 09-Problem Scenario | shortage of fault samples(Small Fault Samples) |  | 19-Training Optimization Algorithm | PSO-CS |  |
| 2 | `HJ83EHU6_E121` | `motivates` | 09-Problem Scenario | incipient faults(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | PSO-CS |  |
| 3 | `HJ83EHU6_E122` | `motivates` | 09-Problem Scenario | multisensor fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 19-Training Optimization Algorithm | PSO-CS |  |
| 4 | `HJ83EHU6_E123` | `motivates` | 12-Training Data Availability | shortage of fault samples, limited samples(Scarce) |  | 19-Training Optimization Algorithm | PSO-CS |  |
| 5 | `HJ83EHU6_E124` | `motivates` | 13-Noise Level | external voltage disturbances(High Noise) |  | 16-Feature Extraction Algorithm | HHT |  |
| 6 | `HJ83EHU6_E125` | `motivates` | 09-Problem Scenario | shortage of fault samples(Small Fault Samples) |  | 16-Feature Extraction Algorithm | HHT |  |
| 7 | `HJ83EHU6_E126` | `motivates` | 09-Problem Scenario | incipient faults(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | HHT |  |
| 8 | `HJ83EHU6_E127` | `motivates` | 09-Problem Scenario | multisensor fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | HHT |  |
| 9 | `HJ83EHU6_E128` | `motivates` | 09-Problem Scenario | shortage of fault samples(Small Fault Samples) |  | 17-Core Classifier Algorithm | SVM |  |
| 10 | `HJ83EHU6_E129` | `motivates` | 09-Problem Scenario | incipient faults(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | SVM |  |
| 11 | `HJ83EHU6_E130` | `motivates` | 09-Problem Scenario | multisensor fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | SVM |  |
| 12 | `HJ83EHU6_E131` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | HHT |  |
| 13 | `HJ83EHU6_E132` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVM |  |
| 14 | `HJ83EHU6_E133` | `motivates` | 06-Fault Severity | minor burns, moderate burns, and severe burns(Multiple Severities) |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `HJ83EHU6_E120`：shortage of fault samples(Small Fault Samples) motivates PSO-CS
  - `HJ83EHU6_E121`：incipient faults(Early Degradation Prediction) motivates PSO-CS
  - `HJ83EHU6_E122`：multisensor fusion(Multi-Source Heterogeneous / Multimodal Data) motivates PSO-CS
  - `HJ83EHU6_E125`：shortage of fault samples(Small Fault Samples) motivates HHT
  - `HJ83EHU6_E126`：incipient faults(Early Degradation Prediction) motivates HHT
  - `HJ83EHU6_E127`：multisensor fusion(Multi-Source Heterogeneous / Multimodal Data) motivates HHT
  - `HJ83EHU6_E128`：shortage of fault samples(Small Fault Samples) motivates SVM
  - `HJ83EHU6_E129`：incipient faults(Early Degradation Prediction) motivates SVM
  - `HJ83EHU6_E130`：multisensor fusion(Multi-Source Heterogeneous / Multimodal Data) motivates SVM
