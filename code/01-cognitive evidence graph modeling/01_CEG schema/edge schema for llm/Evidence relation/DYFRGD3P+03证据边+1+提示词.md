...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DYFRGD3P_E086` | `motivates` | 13-Noise Level | measure noise induced by the current and speed sensors, high order harmonics induced by the PWM-Switching process(High Noise) |  | 15-Data Preprocessing Algorithm | Phase currents normalization |  |
| 2 | `DYFRGD3P_E087` | `motivates` | 13-Noise Level | measure noise induced by the current and speed sensors, high order harmonics induced by the PWM-Switching process(High Noise) |  | 16-Feature Extraction Algorithm | Concordia transformation |  |
| 3 | `DYFRGD3P_E088` | `motivates` | 09-Problem Scenario | robustness to transient states and noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Phase currents normalization |  |
| 4 | `DYFRGD3P_E089` | `motivates` | 09-Problem Scenario | robustness to transient states and noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Concordia transformation |  |
| 5 | `DYFRGD3P_E090` | `motivates` | 09-Problem Scenario | robustness to transient states and noise(Uncertainty) |  | 17-Core Classifier Algorithm | Centroid-based diagnostic method |  |
| 6 | `DYFRGD3P_E091` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Concordia transformation |  |
| 7 | `DYFRGD3P_E092` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Centroid-based diagnostic method |  |
| 8 | `DYFRGD3P_E093` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Centroid-based diagnostic method |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `DYFRGD3P_E088`：robustness to transient states and noise(Uncertainty) motivates Phase currents normalization
  - `DYFRGD3P_E089`：robustness to transient states and noise(Uncertainty) motivates Concordia transformation
  - `DYFRGD3P_E090`：robustness to transient states and noise(Uncertainty) motivates Centroid-based diagnostic method
