...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `EBPZMG6E_E113` | `motivates` | 09-Problem Scenario | foundation vibration and harmonic interference(Uncertainty) |  | 19-Training Optimization Algorithm | GA |  |
| 2 | `EBPZMG6E_E114` | `motivates` | 09-Problem Scenario | parameter selection of convolutional sparse coding(Other) |  | 19-Training Optimization Algorithm | GA |  |
| 3 | `EBPZMG6E_E115` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | GA |  |
| 4 | `EBPZMG6E_E116` | `motivates` | 13-Noise Level | strong background noise(High Noise) |  | 15-Data Preprocessing Algorithm | EWT |  |
| 5 | `EBPZMG6E_E117` | `motivates` | 13-Noise Level | strong background noise(High Noise) |  | 16-Feature Extraction Algorithm | UC-DLA |  |
| 6 | `EBPZMG6E_E118` | `motivates` | 09-Problem Scenario | foundation vibration and harmonic interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | EWT |  |
| 7 | `EBPZMG6E_E119` | `motivates` | 09-Problem Scenario | parameter selection of convolutional sparse coding(Other) |  | 15-Data Preprocessing Algorithm | EWT |  |
| 8 | `EBPZMG6E_E120` | `motivates` | 09-Problem Scenario | foundation vibration and harmonic interference(Uncertainty) |  | 16-Feature Extraction Algorithm | UC-DLA |  |
| 9 | `EBPZMG6E_E121` | `motivates` | 09-Problem Scenario | parameter selection of convolutional sparse coding(Other) |  | 16-Feature Extraction Algorithm | UC-DLA |  |
| 10 | `EBPZMG6E_E122` | `motivates` | 09-Problem Scenario | foundation vibration and harmonic interference(Uncertainty) |  | 17-Core Classifier Algorithm | HES |  |
| 11 | `EBPZMG6E_E123` | `motivates` | 09-Problem Scenario | parameter selection of convolutional sparse coding(Other) |  | 17-Core Classifier Algorithm | HES |  |
| 12 | `EBPZMG6E_E124` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | UC-DLA |  |
| 13 | `EBPZMG6E_E125` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | HES |  |
| 14 | `EBPZMG6E_E126` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | HES |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `EBPZMG6E_E113`：foundation vibration and harmonic interference(Uncertainty) motivates GA
  - `EBPZMG6E_E114`：parameter selection of convolutional sparse coding(Other) motivates GA
  - `EBPZMG6E_E118`：foundation vibration and harmonic interference(Uncertainty) motivates EWT
  - `EBPZMG6E_E119`：parameter selection of convolutional sparse coding(Other) motivates EWT
  - `EBPZMG6E_E120`：foundation vibration and harmonic interference(Uncertainty) motivates UC-DLA
  - `EBPZMG6E_E121`：parameter selection of convolutional sparse coding(Other) motivates UC-DLA
  - `EBPZMG6E_E122`：foundation vibration and harmonic interference(Uncertainty) motivates HES
  - `EBPZMG6E_E123`：parameter selection of convolutional sparse coding(Other) motivates HES
