...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `LXYP6TTD_E124` | `motivates` | 13-Noise Level | measurement or sensor error(Normal) |  | 15-Data Preprocessing Algorithm | Z-score normalization |  |
| 2 | `LXYP6TTD_E125` | `motivates` | 13-Noise Level | measurement or sensor error(Normal) |  | 16-Feature Extraction Algorithm | PPCA |  |
| 3 | `LXYP6TTD_E126` | `motivates` | 09-Problem Scenario | measurement and sensor noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Z-score normalization |  |
| 4 | `LXYP6TTD_E127` | `motivates` | 09-Problem Scenario | composite mutually orthogonal fault directions(Compound Faults) |  | 15-Data Preprocessing Algorithm | Z-score normalization |  |
| 5 | `LXYP6TTD_E128` | `motivates` | 09-Problem Scenario | lack of directional information in conventional PCA(Other) |  | 15-Data Preprocessing Algorithm | Z-score normalization |  |
| 6 | `LXYP6TTD_E129` | `motivates` | 09-Problem Scenario | measurement and sensor noise(Uncertainty) |  | 16-Feature Extraction Algorithm | PPCA |  |
| 7 | `LXYP6TTD_E130` | `motivates` | 09-Problem Scenario | composite mutually orthogonal fault directions(Compound Faults) |  | 16-Feature Extraction Algorithm | PPCA |  |
| 8 | `LXYP6TTD_E131` | `motivates` | 09-Problem Scenario | lack of directional information in conventional PCA(Other) |  | 16-Feature Extraction Algorithm | PPCA |  |
| 9 | `LXYP6TTD_E132` | `motivates` | 09-Problem Scenario | measurement and sensor noise(Uncertainty) |  | 17-Core Classifier Algorithm | cdiPCA |  |
| 10 | `LXYP6TTD_E133` | `motivates` | 09-Problem Scenario | composite mutually orthogonal fault directions(Compound Faults) |  | 17-Core Classifier Algorithm | cdiPCA |  |
| 11 | `LXYP6TTD_E134` | `motivates` | 09-Problem Scenario | lack of directional information in conventional PCA(Other) |  | 17-Core Classifier Algorithm | cdiPCA |  |
| 12 | `LXYP6TTD_E135` | `motivates` | 07-Compound Fault | multiple-sensor faults(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | PPCA |  |
| 13 | `LXYP6TTD_E136` | `motivates` | 07-Compound Fault | multiple-sensor faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | cdiPCA |  |
| 14 | `LXYP6TTD_E137` | `motivates` | 06-Fault Severity | fault magnitude(Multiple Severities) |  | 17-Core Classifier Algorithm | cdiPCA |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `LXYP6TTD_E126`：measurement and sensor noise(Uncertainty) motivates Z-score normalization
  - `LXYP6TTD_E127`：composite mutually orthogonal fault directions(Compound Faults) motivates Z-score normalization
  - `LXYP6TTD_E128`：lack of directional information in conventional PCA(Other) motivates Z-score normalization
  - `LXYP6TTD_E129`：measurement and sensor noise(Uncertainty) motivates PPCA
  - `LXYP6TTD_E130`：composite mutually orthogonal fault directions(Compound Faults) motivates PPCA
  - `LXYP6TTD_E131`：lack of directional information in conventional PCA(Other) motivates PPCA
  - `LXYP6TTD_E132`：measurement and sensor noise(Uncertainty) motivates cdiPCA
  - `LXYP6TTD_E133`：composite mutually orthogonal fault directions(Compound Faults) motivates cdiPCA
  - `LXYP6TTD_E134`：lack of directional information in conventional PCA(Other) motivates cdiPCA
