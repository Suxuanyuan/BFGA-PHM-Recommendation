...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VR5QEYGR_E134` | `motivates` | 09-Problem Scenario | compound fault(Compound Faults) |  | 19-Training Optimization Algorithm | PSO |  |
| 2 | `VR5QEYGR_E135` | `motivates` | 09-Problem Scenario | weak fault impulses submerged by strong ambient noise(Uncertainty) |  | 19-Training Optimization Algorithm | PSO |  |
| 3 | `VR5QEYGR_E136` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | PSO |  |
| 4 | `VR5QEYGR_E137` | `motivates` | 13-Noise Level | strong ambient noise(High Noise) |  | 15-Data Preprocessing Algorithm | RSSD |  |
| 5 | `VR5QEYGR_E138` | `motivates` | 13-Noise Level | strong ambient noise(High Noise) |  | 16-Feature Extraction Algorithm | MOMEDA |  |
| 6 | `VR5QEYGR_E139` | `motivates` | 09-Problem Scenario | compound fault(Compound Faults) |  | 15-Data Preprocessing Algorithm | RSSD |  |
| 7 | `VR5QEYGR_E140` | `motivates` | 09-Problem Scenario | weak fault impulses submerged by strong ambient noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | RSSD |  |
| 8 | `VR5QEYGR_E141` | `motivates` | 09-Problem Scenario | compound fault(Compound Faults) |  | 16-Feature Extraction Algorithm | MOMEDA |  |
| 9 | `VR5QEYGR_E142` | `motivates` | 09-Problem Scenario | weak fault impulses submerged by strong ambient noise(Uncertainty) |  | 16-Feature Extraction Algorithm | MOMEDA |  |
| 10 | `VR5QEYGR_E143` | `motivates` | 09-Problem Scenario | compound fault(Compound Faults) |  | 17-Core Classifier Algorithm | Envelope Demodulation |  |
| 11 | `VR5QEYGR_E144` | `motivates` | 09-Problem Scenario | weak fault impulses submerged by strong ambient noise(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Demodulation |  |
| 12 | `VR5QEYGR_E145` | `motivates` | 07-Compound Fault | compound fault(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | MOMEDA |  |
| 13 | `VR5QEYGR_E146` | `motivates` | 07-Compound Fault | compound fault(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | Envelope Demodulation |  |
| 14 | `VR5QEYGR_E147` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Envelope Demodulation |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `VR5QEYGR_E134`：compound fault(Compound Faults) motivates PSO
  - `VR5QEYGR_E135`：weak fault impulses submerged by strong ambient noise(Uncertainty) motivates PSO
  - `VR5QEYGR_E139`：compound fault(Compound Faults) motivates RSSD
  - `VR5QEYGR_E140`：weak fault impulses submerged by strong ambient noise(Uncertainty) motivates RSSD
  - `VR5QEYGR_E141`：compound fault(Compound Faults) motivates MOMEDA
  - `VR5QEYGR_E142`：weak fault impulses submerged by strong ambient noise(Uncertainty) motivates MOMEDA
  - `VR5QEYGR_E143`：compound fault(Compound Faults) motivates Envelope Demodulation
  - `VR5QEYGR_E144`：weak fault impulses submerged by strong ambient noise(Uncertainty) motivates Envelope Demodulation
