...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `7245HRHE_E109` | `motivates` | 13-Noise Level | low signal-to-noise ratio (SNR)(High Noise) |  | 15-Data Preprocessing Algorithm | Inverted Editing |  |
| 2 | `7245HRHE_E110` | `motivates` | 13-Noise Level | low signal-to-noise ratio (SNR)(High Noise) |  | 16-Feature Extraction Algorithm | Resonance Detection Diagram |  |
| 3 | `7245HRHE_E111` | `motivates` | 09-Problem Scenario | compound faults(Compound Faults) |  | 15-Data Preprocessing Algorithm | Inverted Editing |  |
| 4 | `7245HRHE_E112` | `motivates` | 09-Problem Scenario | noise sensitivity and low SNR(Uncertainty) |  | 15-Data Preprocessing Algorithm | Inverted Editing |  |
| 5 | `7245HRHE_E113` | `motivates` | 09-Problem Scenario | compound faults(Compound Faults) |  | 16-Feature Extraction Algorithm | Resonance Detection Diagram |  |
| 6 | `7245HRHE_E114` | `motivates` | 09-Problem Scenario | noise sensitivity and low SNR(Uncertainty) |  | 16-Feature Extraction Algorithm | Resonance Detection Diagram |  |
| 7 | `7245HRHE_E115` | `motivates` | 09-Problem Scenario | compound faults(Compound Faults) |  | 17-Core Classifier Algorithm | Envelope Analysis |  |
| 8 | `7245HRHE_E116` | `motivates` | 09-Problem Scenario | noise sensitivity and low SNR(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Analysis |  |
| 9 | `7245HRHE_E117` | `motivates` | 07-Compound Fault | compound faults of bearing and gear(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | Resonance Detection Diagram |  |
| 10 | `7245HRHE_E118` | `motivates` | 07-Compound Fault | compound faults of bearing and gear(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | Envelope Analysis |  |
| 11 | `7245HRHE_E119` | `motivates` | 06-Fault Severity | 0.4-mm, 0.2-mm(Single Severity) |  | 17-Core Classifier Algorithm | Envelope Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `7245HRHE_E111`：compound faults(Compound Faults) motivates Inverted Editing
  - `7245HRHE_E112`：noise sensitivity and low SNR(Uncertainty) motivates Inverted Editing
  - `7245HRHE_E113`：compound faults(Compound Faults) motivates Resonance Detection Diagram
  - `7245HRHE_E114`：noise sensitivity and low SNR(Uncertainty) motivates Resonance Detection Diagram
  - `7245HRHE_E115`：compound faults(Compound Faults) motivates Envelope Analysis
  - `7245HRHE_E116`：noise sensitivity and low SNR(Uncertainty) motivates Envelope Analysis
