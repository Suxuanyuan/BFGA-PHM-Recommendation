...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HS9PCYHX_E122` | `motivates` | 09-Problem Scenario | Vanishing gradient problem in DBNs(Other) |  | 19-Training Optimization Algorithm | Isigmoid |  |
| 2 | `HS9PCYHX_E123` | `motivates` | 09-Problem Scenario | Complex structures and weak early fault features of planetary gearboxes(Complex Systems) |  | 19-Training Optimization Algorithm | Isigmoid |  |
| 3 | `HS9PCYHX_E124` | `motivates` | 12-Training Data Availability | 6000 samples to train the DBNs for MNIST; 800 samples under each load for training, and 3500 samples for mixed training set(Sufficient) |  | 19-Training Optimization Algorithm | Isigmoid |  |
| 4 | `HS9PCYHX_E125` | `motivates` | 13-Noise Level | adaptive soft-thresholding method is used to denoise(High Noise) |  | 15-Data Preprocessing Algorithm | Optimized Morlet Wavelet Transform |  |
| 5 | `HS9PCYHX_E126` | `motivates` | 13-Noise Level | adaptive soft-thresholding method is used to denoise(High Noise) |  | 16-Feature Extraction Algorithm | Statistical Feature Extraction |  |
| 6 | `HS9PCYHX_E127` | `motivates` | 09-Problem Scenario | Vanishing gradient problem in DBNs(Other) |  | 15-Data Preprocessing Algorithm | Optimized Morlet Wavelet Transform |  |
| 7 | `HS9PCYHX_E128` | `motivates` | 09-Problem Scenario | Complex structures and weak early fault features of planetary gearboxes(Complex Systems) |  | 15-Data Preprocessing Algorithm | Optimized Morlet Wavelet Transform |  |
| 8 | `HS9PCYHX_E129` | `motivates` | 09-Problem Scenario | Vanishing gradient problem in DBNs(Other) |  | 16-Feature Extraction Algorithm | Statistical Feature Extraction |  |
| 9 | `HS9PCYHX_E130` | `motivates` | 09-Problem Scenario | Complex structures and weak early fault features of planetary gearboxes(Complex Systems) |  | 16-Feature Extraction Algorithm | Statistical Feature Extraction |  |
| 10 | `HS9PCYHX_E131` | `motivates` | 09-Problem Scenario | Vanishing gradient problem in DBNs(Other) |  | 17-Core Classifier Algorithm | Deep Belief Network |  |
| 11 | `HS9PCYHX_E132` | `motivates` | 09-Problem Scenario | Complex structures and weak early fault features of planetary gearboxes(Complex Systems) |  | 17-Core Classifier Algorithm | Deep Belief Network |  |
| 12 | `HS9PCYHX_E133` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Statistical Feature Extraction |  |
| 13 | `HS9PCYHX_E134` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Deep Belief Network |  |
| 14 | `HS9PCYHX_E135` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Deep Belief Network |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `HS9PCYHX_E122`：Vanishing gradient problem in DBNs(Other) motivates Isigmoid
  - `HS9PCYHX_E123`：Complex structures and weak early fault features of planetary gearboxes(Complex Systems) motivates Isigmoid
  - `HS9PCYHX_E127`：Vanishing gradient problem in DBNs(Other) motivates Optimized Morlet Wavelet Transform
  - `HS9PCYHX_E128`：Complex structures and weak early fault features of planetary gearboxes(Complex Systems) motivates Optimized Morlet Wavelet Transform
  - `HS9PCYHX_E129`：Vanishing gradient problem in DBNs(Other) motivates Statistical Feature Extraction
  - `HS9PCYHX_E130`：Complex structures and weak early fault features of planetary gearboxes(Complex Systems) motivates Statistical Feature Extraction
  - `HS9PCYHX_E131`：Vanishing gradient problem in DBNs(Other) motivates Deep Belief Network
  - `HS9PCYHX_E132`：Complex structures and weak early fault features of planetary gearboxes(Complex Systems) motivates Deep Belief Network
