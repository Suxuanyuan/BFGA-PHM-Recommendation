...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `2T98FXWZ_E084` | `motivates` | 13-Noise Level | measurement noises(High Noise) |  | 15-Data Preprocessing Algorithm | Mathematical Morphology Filter |  |
| 2 | `2T98FXWZ_E085` | `motivates` | 13-Noise Level | measurement noises(High Noise) |  | 16-Feature Extraction Algorithm | Peak-Valley Detection Operator |  |
| 3 | `2T98FXWZ_E086` | `motivates` | 09-Problem Scenario | protection design challenges in islanded microgrids(Complex Systems) |  | 15-Data Preprocessing Algorithm | Mathematical Morphology Filter |  |
| 4 | `2T98FXWZ_E087` | `motivates` | 09-Problem Scenario | measurement noise, communication delay, and synchronization errors(Uncertainty) |  | 15-Data Preprocessing Algorithm | Mathematical Morphology Filter |  |
| 5 | `2T98FXWZ_E088` | `motivates` | 09-Problem Scenario | protection design challenges in islanded microgrids(Complex Systems) |  | 16-Feature Extraction Algorithm | Peak-Valley Detection Operator |  |
| 6 | `2T98FXWZ_E089` | `motivates` | 09-Problem Scenario | measurement noise, communication delay, and synchronization errors(Uncertainty) |  | 16-Feature Extraction Algorithm | Peak-Valley Detection Operator |  |
| 7 | `2T98FXWZ_E090` | `motivates` | 09-Problem Scenario | protection design challenges in islanded microgrids(Complex Systems) |  | 17-Core Classifier Algorithm | Waveform Difference Feature-Based Protection Criterion |  |
| 8 | `2T98FXWZ_E091` | `motivates` | 09-Problem Scenario | measurement noise, communication delay, and synchronization errors(Uncertainty) |  | 17-Core Classifier Algorithm | Waveform Difference Feature-Based Protection Criterion |  |
| 9 | `2T98FXWZ_E092` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Peak-Valley Detection Operator |  |
| 10 | `2T98FXWZ_E093` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Waveform Difference Feature-Based Protection Criterion |  |
| 11 | `2T98FXWZ_E094` | `motivates` | 06-Fault Severity | fault resistance(Multiple Severities) |  | 17-Core Classifier Algorithm | Waveform Difference Feature-Based Protection Criterion |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `2T98FXWZ_E086`：protection design challenges in islanded microgrids(Complex Systems) motivates Mathematical Morphology Filter
  - `2T98FXWZ_E087`：measurement noise, communication delay, and synchronization errors(Uncertainty) motivates Mathematical Morphology Filter
  - `2T98FXWZ_E088`：protection design challenges in islanded microgrids(Complex Systems) motivates Peak-Valley Detection Operator
  - `2T98FXWZ_E089`：measurement noise, communication delay, and synchronization errors(Uncertainty) motivates Peak-Valley Detection Operator
  - `2T98FXWZ_E090`：protection design challenges in islanded microgrids(Complex Systems) motivates Waveform Difference Feature-Based Protection Criterion
  - `2T98FXWZ_E091`：measurement noise, communication delay, and synchronization errors(Uncertainty) motivates Waveform Difference Feature-Based Protection Criterion
