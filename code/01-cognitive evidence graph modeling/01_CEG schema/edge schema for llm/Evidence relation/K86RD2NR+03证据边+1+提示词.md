...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `K86RD2NR_E090` | `motivates` | 09-Problem Scenario | preserving local and global geometries of input data(Other) |  | 19-Training Optimization Algorithm | Joint Optimization |  |
| 2 | `K86RD2NR_E091` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 19-Training Optimization Algorithm | Joint Optimization |  |
| 3 | `K86RD2NR_E092` | `motivates` | 09-Problem Scenario | detects the failures in the early stage(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | Joint Optimization |  |
| 4 | `K86RD2NR_E093` | `motivates` | 12-Training Data Availability | 20% of dataset is used as training data(Sufficient) |  | 19-Training Optimization Algorithm | Joint Optimization |  |
| 5 | `K86RD2NR_E094` | `motivates` | 13-Noise Level | noises were injected into the test data with nine different signal-to-noise-ratio (SNR) values(High Noise) |  | 16-Feature Extraction Algorithm | SFAE |  |
| 6 | `K86RD2NR_E095` | `motivates` | 09-Problem Scenario | preserving local and global geometries of input data(Other) |  | 16-Feature Extraction Algorithm | SFAE |  |
| 7 | `K86RD2NR_E096` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | SFAE |  |
| 8 | `K86RD2NR_E097` | `motivates` | 09-Problem Scenario | detects the failures in the early stage(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | SFAE |  |
| 9 | `K86RD2NR_E098` | `motivates` | 09-Problem Scenario | preserving local and global geometries of input data(Other) |  | 17-Core Classifier Algorithm | Linear Regression |  |
| 10 | `K86RD2NR_E099` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Linear Regression |  |
| 11 | `K86RD2NR_E100` | `motivates` | 09-Problem Scenario | detects the failures in the early stage(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Linear Regression |  |
| 12 | `K86RD2NR_E101` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | SFAE |  |
| 13 | `K86RD2NR_E102` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Linear Regression |  |
| 14 | `K86RD2NR_E103` | `motivates` | 06-Fault Severity | 0.18 mm, 0.36 mm, 0.53 mm(Multiple Severities) |  | 17-Core Classifier Algorithm | Linear Regression |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `K86RD2NR_E090`：preserving local and global geometries of input data(Other) motivates Joint Optimization
  - `K86RD2NR_E091`：noise robustness(Uncertainty) motivates Joint Optimization
  - `K86RD2NR_E092`：detects the failures in the early stage(Early Degradation Prediction) motivates Joint Optimization
  - `K86RD2NR_E095`：preserving local and global geometries of input data(Other) motivates SFAE
  - `K86RD2NR_E096`：noise robustness(Uncertainty) motivates SFAE
  - `K86RD2NR_E097`：detects the failures in the early stage(Early Degradation Prediction) motivates SFAE
  - `K86RD2NR_E098`：preserving local and global geometries of input data(Other) motivates Linear Regression
  - `K86RD2NR_E099`：noise robustness(Uncertainty) motivates Linear Regression
  - `K86RD2NR_E100`：detects the failures in the early stage(Early Degradation Prediction) motivates Linear Regression
