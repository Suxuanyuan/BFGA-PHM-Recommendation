...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `LCDJZZF2_E089` | `motivates` | 13-Noise Level | low-amplitude high-frequency noise(High Noise) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 2 | `LCDJZZF2_E090` | `motivates` | 13-Noise Level | low-amplitude high-frequency noise(High Noise) |  | 16-Feature Extraction Algorithm | Reference Current Errors |  |
| 3 | `LCDJZZF2_E091` | `motivates` | 09-Problem Scenario | multiple open-circuit faults(Compound Faults) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 4 | `LCDJZZF2_E092` | `motivates` | 09-Problem Scenario | robustness against false alarms under load and speed transients(Uncertainty) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 5 | `LCDJZZF2_E093` | `motivates` | 09-Problem Scenario | multiple open-circuit faults(Compound Faults) |  | 16-Feature Extraction Algorithm | Reference Current Errors |  |
| 6 | `LCDJZZF2_E094` | `motivates` | 09-Problem Scenario | robustness against false alarms under load and speed transients(Uncertainty) |  | 16-Feature Extraction Algorithm | Reference Current Errors |  |
| 7 | `LCDJZZF2_E095` | `motivates` | 09-Problem Scenario | multiple open-circuit faults(Compound Faults) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 8 | `LCDJZZF2_E096` | `motivates` | 09-Problem Scenario | robustness against false alarms under load and speed transients(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 9 | `LCDJZZF2_E097` | `motivates` | 07-Compound Fault | multiple open-circuit faults(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Reference Current Errors |  |
| 10 | `LCDJZZF2_E098` | `motivates` | 07-Compound Fault | multiple open-circuit faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 11 | `LCDJZZF2_E099` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Threshold Decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `LCDJZZF2_E091`：multiple open-circuit faults(Compound Faults) motivates Normalization
  - `LCDJZZF2_E092`：robustness against false alarms under load and speed transients(Uncertainty) motivates Normalization
  - `LCDJZZF2_E093`：multiple open-circuit faults(Compound Faults) motivates Reference Current Errors
  - `LCDJZZF2_E094`：robustness against false alarms under load and speed transients(Uncertainty) motivates Reference Current Errors
  - `LCDJZZF2_E095`：multiple open-circuit faults(Compound Faults) motivates Threshold Decision
  - `LCDJZZF2_E096`：robustness against false alarms under load and speed transients(Uncertainty) motivates Threshold Decision
