...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WI5JAEU6_E100` | `motivates` | 13-Noise Level | environmental noises(High Noise) |  | 15-Data Preprocessing Algorithm | Frequency zooming |  |
| 2 | `WI5JAEU6_E101` | `motivates` | 13-Noise Level | environmental noises(High Noise) |  | 16-Feature Extraction Algorithm | Frequency-shifted bispectrum |  |
| 3 | `WI5JAEU6_E102` | `motivates` | 09-Problem Scenario | strong environmental noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Frequency zooming |  |
| 4 | `WI5JAEU6_E103` | `motivates` | 09-Problem Scenario | early fault detection and degradation tracking(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Frequency zooming |  |
| 5 | `WI5JAEU6_E104` | `motivates` | 09-Problem Scenario | strong environmental noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Frequency-shifted bispectrum |  |
| 6 | `WI5JAEU6_E105` | `motivates` | 09-Problem Scenario | early fault detection and degradation tracking(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Frequency-shifted bispectrum |  |
| 7 | `WI5JAEU6_E106` | `motivates` | 09-Problem Scenario | strong environmental noise(Uncertainty) |  | 17-Core Classifier Algorithm | Hypothesis testing |  |
| 8 | `WI5JAEU6_E107` | `motivates` | 09-Problem Scenario | early fault detection and degradation tracking(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Hypothesis testing |  |
| 9 | `WI5JAEU6_E108` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Frequency-shifted bispectrum |  |
| 10 | `WI5JAEU6_E109` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Hypothesis testing |  |
| 11 | `WI5JAEU6_E110` | `motivates` | 06-Fault Severity | run-to-failure(Multiple Severities) |  | 17-Core Classifier Algorithm | Hypothesis testing |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `WI5JAEU6_E102`：strong environmental noise(Uncertainty) motivates Frequency zooming
  - `WI5JAEU6_E103`：early fault detection and degradation tracking(Early Degradation Prediction) motivates Frequency zooming
  - `WI5JAEU6_E104`：strong environmental noise(Uncertainty) motivates Frequency-shifted bispectrum
  - `WI5JAEU6_E105`：early fault detection and degradation tracking(Early Degradation Prediction) motivates Frequency-shifted bispectrum
  - `WI5JAEU6_E106`：strong environmental noise(Uncertainty) motivates Hypothesis testing
  - `WI5JAEU6_E107`：early fault detection and degradation tracking(Early Degradation Prediction) motivates Hypothesis testing
