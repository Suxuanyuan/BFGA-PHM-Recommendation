...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `C9GABGHM_E105` | `motivates` | 13-Noise Level | additive Gaussian white noise with different signal-to-noise ratios (SNRs)(High Noise) |  | 16-Feature Extraction Algorithm | MSMPSF |  |
| 2 | `C9GABGHM_E106` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | MSMPSF |  |
| 3 | `C9GABGHM_E107` | `motivates` | 09-Problem Scenario | unbalanced dataset(Small Fault Samples) |  | 16-Feature Extraction Algorithm | MSMPSF |  |
| 4 | `C9GABGHM_E108` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Softmax Regression |  |
| 5 | `C9GABGHM_E109` | `motivates` | 09-Problem Scenario | unbalanced dataset(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax Regression |  |
| 6 | `C9GABGHM_E110` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | MSMPSF |  |
| 7 | `C9GABGHM_E111` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax Regression |  |
| 8 | `C9GABGHM_E112` | `motivates` | 06-Fault Severity | 0.18 mm, 0.36 mm, 0.53 mm(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax Regression |  |
| 9 | `C9RMWWZ4_E067` | `motivates` | 13-Noise Level | Gaussian noise, strong noise and interference components(High Noise) |  | 16-Feature Extraction Algorithm | Teager-Kaiser Energy Operator |  |
| 10 | `C9RMWWZ4_E068` | `motivates` | 09-Problem Scenario | IM operating at low load with low slip(Other) |  | 16-Feature Extraction Algorithm | Teager-Kaiser Energy Operator |  |
| 11 | `C9RMWWZ4_E069` | `motivates` | 09-Problem Scenario | separate AM and FM from the modulation sidebands(Other) |  | 16-Feature Extraction Algorithm | Teager-Kaiser Energy Operator |  |
| 12 | `C9RMWWZ4_E070` | `motivates` | 09-Problem Scenario | IM operating at low load with low slip(Other) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 13 | `C9RMWWZ4_E071` | `motivates` | 09-Problem Scenario | separate AM and FM from the modulation sidebands(Other) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 14 | `C9RMWWZ4_E072` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Teager-Kaiser Energy Operator |  |
| 15 | `C9RMWWZ4_E073` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 16 | `C9RMWWZ4_E074` | `motivates` | 06-Fault Severity | 1 BRB, 2 BRB(Multiple Severities) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `C9GABGHM_E106`：noise robustness(Uncertainty) motivates MSMPSF
  - `C9GABGHM_E107`：unbalanced dataset(Small Fault Samples) motivates MSMPSF
  - `C9GABGHM_E108`：noise robustness(Uncertainty) motivates Softmax Regression
  - `C9GABGHM_E109`：unbalanced dataset(Small Fault Samples) motivates Softmax Regression
  - `C9RMWWZ4_E068`：IM operating at low load with low slip(Other) motivates Teager-Kaiser Energy Operator
  - `C9RMWWZ4_E069`：separate AM and FM from the modulation sidebands(Other) motivates Teager-Kaiser Energy Operator
  - `C9RMWWZ4_E070`：IM operating at low load with low slip(Other) motivates Threshold Decision
  - `C9RMWWZ4_E071`：separate AM and FM from the modulation sidebands(Other) motivates Threshold Decision
