...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `7SYWTM73_E091` | `motivates` | 13-Noise Level | 1% background noise (40dB white noise)(High Noise) |  | 15-Data Preprocessing Algorithm | Rectangular windowing |  |
| 2 | `7SYWTM73_E092` | `motivates` | 13-Noise Level | 1% background noise (40dB white noise)(High Noise) |  | 16-Feature Extraction Algorithm | Continuous Morlet wavelet transform |  |
| 3 | `7SYWTM73_E093` | `motivates` | 09-Problem Scenario | influence of DG control loops(Other) |  | 15-Data Preprocessing Algorithm | Rectangular windowing |  |
| 4 | `7SYWTM73_E094` | `motivates` | 09-Problem Scenario | distribution systems with multiple branches and laterals(Complex Systems) |  | 15-Data Preprocessing Algorithm | Rectangular windowing |  |
| 5 | `7SYWTM73_E095` | `motivates` | 09-Problem Scenario | fault resistance and background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Rectangular windowing |  |
| 6 | `7SYWTM73_E096` | `motivates` | 09-Problem Scenario | influence of DG control loops(Other) |  | 16-Feature Extraction Algorithm | Continuous Morlet wavelet transform |  |
| 7 | `7SYWTM73_E097` | `motivates` | 09-Problem Scenario | distribution systems with multiple branches and laterals(Complex Systems) |  | 16-Feature Extraction Algorithm | Continuous Morlet wavelet transform |  |
| 8 | `7SYWTM73_E098` | `motivates` | 09-Problem Scenario | fault resistance and background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Continuous Morlet wavelet transform |  |
| 9 | `7SYWTM73_E099` | `motivates` | 09-Problem Scenario | influence of DG control loops(Other) |  | 17-Core Classifier Algorithm | Iterative fault location algorithm |  |
| 10 | `7SYWTM73_E100` | `motivates` | 09-Problem Scenario | distribution systems with multiple branches and laterals(Complex Systems) |  | 17-Core Classifier Algorithm | Iterative fault location algorithm |  |
| 11 | `7SYWTM73_E101` | `motivates` | 09-Problem Scenario | fault resistance and background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Iterative fault location algorithm |  |
| 12 | `7SYWTM73_E102` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Continuous Morlet wavelet transform |  |
| 13 | `7SYWTM73_E103` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Iterative fault location algorithm |  |
| 14 | `7SYWTM73_E104` | `motivates` | 06-Fault Severity | fault resistance(Multiple Severities) |  | 17-Core Classifier Algorithm | Iterative fault location algorithm |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `7SYWTM73_E093`：influence of DG control loops(Other) motivates Rectangular windowing
  - `7SYWTM73_E094`：distribution systems with multiple branches and laterals(Complex Systems) motivates Rectangular windowing
  - `7SYWTM73_E095`：fault resistance and background noise(Uncertainty) motivates Rectangular windowing
  - `7SYWTM73_E096`：influence of DG control loops(Other) motivates Continuous Morlet wavelet transform
  - `7SYWTM73_E097`：distribution systems with multiple branches and laterals(Complex Systems) motivates Continuous Morlet wavelet transform
  - `7SYWTM73_E098`：fault resistance and background noise(Uncertainty) motivates Continuous Morlet wavelet transform
  - `7SYWTM73_E099`：influence of DG control loops(Other) motivates Iterative fault location algorithm
  - `7SYWTM73_E100`：distribution systems with multiple branches and laterals(Complex Systems) motivates Iterative fault location algorithm
  - `7SYWTM73_E101`：fault resistance and background noise(Uncertainty) motivates Iterative fault location algorithm
