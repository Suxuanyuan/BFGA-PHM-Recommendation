...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TE67G33D_E101` | `motivates` | 12-Training Data Availability | analytical method without training database(Sufficient) |  | 18-Data Generation Algorithm | Finite element analysis |  |
| 2 | `TE67G33D_E102` | `motivates` | 13-Noise Level | measurement noise(High Noise) |  | 15-Data Preprocessing Algorithm | Fundamental component extraction |  |
| 3 | `TE67G33D_E103` | `motivates` | 13-Noise Level | measurement noise(High Noise) |  | 16-Feature Extraction Algorithm | Standstill parameter identification |  |
| 4 | `TE67G33D_E104` | `motivates` | 09-Problem Scenario | Dependency on ITSC prototype with multiple taps for fault characterization(Other) |  | 18-Data Generation Algorithm | Finite element analysis |  |
| 5 | `TE67G33D_E105` | `motivates` | 09-Problem Scenario | Non-zero fault resistance / contact resistance uncertainty(Uncertainty) |  | 18-Data Generation Algorithm | Finite element analysis |  |
| 6 | `TE67G33D_E106` | `motivates` | 09-Problem Scenario | Dependency on ITSC prototype with multiple taps for fault characterization(Other) |  | 15-Data Preprocessing Algorithm | Fundamental component extraction |  |
| 7 | `TE67G33D_E107` | `motivates` | 09-Problem Scenario | Non-zero fault resistance / contact resistance uncertainty(Uncertainty) |  | 15-Data Preprocessing Algorithm | Fundamental component extraction |  |
| 8 | `TE67G33D_E108` | `motivates` | 09-Problem Scenario | Dependency on ITSC prototype with multiple taps for fault characterization(Other) |  | 16-Feature Extraction Algorithm | Standstill parameter identification |  |
| 9 | `TE67G33D_E109` | `motivates` | 09-Problem Scenario | Non-zero fault resistance / contact resistance uncertainty(Uncertainty) |  | 16-Feature Extraction Algorithm | Standstill parameter identification |  |
| 10 | `TE67G33D_E110` | `motivates` | 09-Problem Scenario | Dependency on ITSC prototype with multiple taps for fault characterization(Other) |  | 17-Core Classifier Algorithm | Analytical estimation formula |  |
| 11 | `TE67G33D_E111` | `motivates` | 09-Problem Scenario | Non-zero fault resistance / contact resistance uncertainty(Uncertainty) |  | 17-Core Classifier Algorithm | Analytical estimation formula |  |
| 12 | `TE67G33D_E112` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Standstill parameter identification |  |
| 13 | `TE67G33D_E113` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Analytical estimation formula |  |
| 14 | `TE67G33D_E114` | `motivates` | 06-Fault Severity | Number of shorted turns(Multiple Severities) |  | 17-Core Classifier Algorithm | Analytical estimation formula |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `TE67G33D_E104`：Dependency on ITSC prototype with multiple taps for fault characterization(Other) motivates Finite element analysis
  - `TE67G33D_E105`：Non-zero fault resistance / contact resistance uncertainty(Uncertainty) motivates Finite element analysis
  - `TE67G33D_E106`：Dependency on ITSC prototype with multiple taps for fault characterization(Other) motivates Fundamental component extraction
  - `TE67G33D_E107`：Non-zero fault resistance / contact resistance uncertainty(Uncertainty) motivates Fundamental component extraction
  - `TE67G33D_E108`：Dependency on ITSC prototype with multiple taps for fault characterization(Other) motivates Standstill parameter identification
  - `TE67G33D_E109`：Non-zero fault resistance / contact resistance uncertainty(Uncertainty) motivates Standstill parameter identification
  - `TE67G33D_E110`：Dependency on ITSC prototype with multiple taps for fault characterization(Other) motivates Analytical estimation formula
  - `TE67G33D_E111`：Non-zero fault resistance / contact resistance uncertainty(Uncertainty) motivates Analytical estimation formula
