...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `LXLYS6MD_E098` | `motivates` | 13-Noise Level | Telemetry data(Normal) |  | 16-Feature Extraction Algorithm | FS-FBR |  |
| 2 | `LXLYS6MD_E099` | `motivates` | 09-Problem Scenario | complicated spacecraft systems(Complex Systems) |  | 16-Feature Extraction Algorithm | FS-FBR |  |
| 3 | `LXLYS6MD_E100` | `motivates` | 09-Problem Scenario | fuzziness of data set(Uncertainty) |  | 16-Feature Extraction Algorithm | FS-FBR |  |
| 4 | `LXLYS6MD_E101` | `motivates` | 09-Problem Scenario | complicated spacecraft systems(Complex Systems) |  | 17-Core Classifier Algorithm | SVM |  |
| 5 | `LXLYS6MD_E102` | `motivates` | 09-Problem Scenario | fuzziness of data set(Uncertainty) |  | 17-Core Classifier Algorithm | SVM |  |
| 6 | `LXLYS6MD_E103` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | FS-FBR |  |
| 7 | `LXLYS6MD_E104` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVM |  |
| 8 | `LXLYS6MD_E105` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `LXLYS6MD_E099`：complicated spacecraft systems(Complex Systems) motivates FS-FBR
  - `LXLYS6MD_E100`：fuzziness of data set(Uncertainty) motivates FS-FBR
  - `LXLYS6MD_E101`：complicated spacecraft systems(Complex Systems) motivates SVM
  - `LXLYS6MD_E102`：fuzziness of data set(Uncertainty) motivates SVM
