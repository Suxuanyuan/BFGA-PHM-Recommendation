...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `BCZN2QXE_E080` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 2 | `BCZN2QXE_E081` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Teager-Kaiser Energy Operator |  |
| 3 | `BCZN2QXE_E082` | `motivates` | 09-Problem Scenario | difficulty in the correct selection of the central frequency and the bandwidth of the band-pass filter(Other) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 4 | `BCZN2QXE_E083` | `motivates` | 09-Problem Scenario | difficulty in the correct selection of the central frequency and the bandwidth of the band-pass filter(Other) |  | 16-Feature Extraction Algorithm | Teager-Kaiser Energy Operator |  |
| 5 | `BCZN2QXE_E084` | `motivates` | 09-Problem Scenario | difficulty in the correct selection of the central frequency and the bandwidth of the band-pass filter(Other) |  | 17-Core Classifier Algorithm | LS-SVM |  |
| 6 | `BCZN2QXE_E085` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Teager-Kaiser Energy Operator |  |
| 7 | `BCZN2QXE_E086` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | LS-SVM |  |
| 8 | `BCZN2QXE_E087` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | LS-SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `BCZN2QXE_E082`：difficulty in the correct selection of the central frequency and the bandwidth of the band-pass filter(Other) motivates Normalization
  - `BCZN2QXE_E083`：difficulty in the correct selection of the central frequency and the bandwidth of the band-pass filter(Other) motivates Teager-Kaiser Energy Operator
  - `BCZN2QXE_E084`：difficulty in the correct selection of the central frequency and the bandwidth of the band-pass filter(Other) motivates LS-SVM
