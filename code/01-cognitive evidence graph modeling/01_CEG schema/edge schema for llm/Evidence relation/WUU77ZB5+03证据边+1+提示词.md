...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WUU77ZB5_E081` | `motivates` | 13-Noise Level | ripple and noise component(High Noise) |  | 15-Data Preprocessing Algorithm | Park Transformation |  |
| 2 | `WUU77ZB5_E082` | `motivates` | 13-Noise Level | ripple and noise component(High Noise) |  | 16-Feature Extraction Algorithm | Current Derivative Calculation |  |
| 3 | `WUU77ZB5_E083` | `motivates` | 09-Problem Scenario | Current ripple and noise component in boundary value selection(Uncertainty) |  | 15-Data Preprocessing Algorithm | Park Transformation |  |
| 4 | `WUU77ZB5_E084` | `motivates` | 09-Problem Scenario | Current ripple and noise component in boundary value selection(Uncertainty) |  | 16-Feature Extraction Algorithm | Current Derivative Calculation |  |
| 5 | `WUU77ZB5_E085` | `motivates` | 09-Problem Scenario | Current ripple and noise component in boundary value selection(Uncertainty) |  | 17-Core Classifier Algorithm | Fault Detection Table |  |
| 6 | `WUU77ZB5_E086` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Current Derivative Calculation |  |
| 7 | `WUU77ZB5_E087` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Fault Detection Table |  |
| 8 | `WUU77ZB5_E088` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Fault Detection Table |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `WUU77ZB5_E083`：Current ripple and noise component in boundary value selection(Uncertainty) motivates Park Transformation
  - `WUU77ZB5_E084`：Current ripple and noise component in boundary value selection(Uncertainty) motivates Current Derivative Calculation
  - `WUU77ZB5_E085`：Current ripple and noise component in boundary value selection(Uncertainty) motivates Fault Detection Table
