...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QG9H5LNQ_E122` | `motivates` | 12-Training Data Availability | 28 groups of the four sun gear scenarios(Sufficient) |  | 18-Data Generation Algorithm | Phenomenological model |  |
| 2 | `QG9H5LNQ_E123` | `motivates` | 13-Noise Level | background noise r(t)(High Noise) |  | 15-Data Preprocessing Algorithm | Signal slicing |  |
| 3 | `QG9H5LNQ_E124` | `motivates` | 13-Noise Level | background noise r(t)(High Noise) |  | 16-Feature Extraction Algorithm | Kurtosis |  |
| 4 | `QG9H5LNQ_E125` | `motivates` | 09-Problem Scenario | diagnostic complexity via a fixed sensor due to the irregular dynamic nature of gear fault meshing positions(Complex Systems) |  | 18-Data Generation Algorithm | Phenomenological model |  |
| 5 | `QG9H5LNQ_E126` | `motivates` | 09-Problem Scenario | interpret previously uncleared and uninterpreted fault-related sidebands(Trustworthiness / Interpretability) |  | 18-Data Generation Algorithm | Phenomenological model |  |
| 6 | `QG9H5LNQ_E127` | `motivates` | 09-Problem Scenario | minimum required data length for proper fault diagnosis(Other) |  | 18-Data Generation Algorithm | Phenomenological model |  |
| 7 | `QG9H5LNQ_E128` | `motivates` | 09-Problem Scenario | diagnostic complexity via a fixed sensor due to the irregular dynamic nature of gear fault meshing positions(Complex Systems) |  | 15-Data Preprocessing Algorithm | Signal slicing |  |
| 8 | `QG9H5LNQ_E129` | `motivates` | 09-Problem Scenario | interpret previously uncleared and uninterpreted fault-related sidebands(Trustworthiness / Interpretability) |  | 15-Data Preprocessing Algorithm | Signal slicing |  |
| 9 | `QG9H5LNQ_E130` | `motivates` | 09-Problem Scenario | minimum required data length for proper fault diagnosis(Other) |  | 15-Data Preprocessing Algorithm | Signal slicing |  |
| 10 | `QG9H5LNQ_E131` | `motivates` | 09-Problem Scenario | diagnostic complexity via a fixed sensor due to the irregular dynamic nature of gear fault meshing positions(Complex Systems) |  | 16-Feature Extraction Algorithm | Kurtosis |  |
| 11 | `QG9H5LNQ_E132` | `motivates` | 09-Problem Scenario | interpret previously uncleared and uninterpreted fault-related sidebands(Trustworthiness / Interpretability) |  | 16-Feature Extraction Algorithm | Kurtosis |  |
| 12 | `QG9H5LNQ_E133` | `motivates` | 09-Problem Scenario | minimum required data length for proper fault diagnosis(Other) |  | 16-Feature Extraction Algorithm | Kurtosis |  |
| 13 | `QG9H5LNQ_E134` | `motivates` | 09-Problem Scenario | diagnostic complexity via a fixed sensor due to the irregular dynamic nature of gear fault meshing positions(Complex Systems) |  | 17-Core Classifier Algorithm | Statistical analysis |  |
| 14 | `QG9H5LNQ_E135` | `motivates` | 09-Problem Scenario | interpret previously uncleared and uninterpreted fault-related sidebands(Trustworthiness / Interpretability) |  | 17-Core Classifier Algorithm | Statistical analysis |  |
| 15 | `QG9H5LNQ_E136` | `motivates` | 09-Problem Scenario | minimum required data length for proper fault diagnosis(Other) |  | 17-Core Classifier Algorithm | Statistical analysis |  |
| 16 | `QG9H5LNQ_E137` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Kurtosis |  |
| 17 | `QG9H5LNQ_E138` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Statistical analysis |  |
| 18 | `QG9H5LNQ_E139` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Statistical analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `QG9H5LNQ_E125`：diagnostic complexity via a fixed sensor due to the irregular dynamic nature of gear fault meshing positions(Complex Systems) motivates Phenomenological model
  - `QG9H5LNQ_E126`：interpret previously uncleared and uninterpreted fault-related sidebands(Trustworthiness / Interpretability) motivates Phenomenological model
  - `QG9H5LNQ_E127`：minimum required data length for proper fault diagnosis(Other) motivates Phenomenological model
  - `QG9H5LNQ_E128`：diagnostic complexity via a fixed sensor due to the irregular dynamic nature of gear fault meshing positions(Complex Systems) motivates Signal slicing
  - `QG9H5LNQ_E129`：interpret previously uncleared and uninterpreted fault-related sidebands(Trustworthiness / Interpretability) motivates Signal slicing
  - `QG9H5LNQ_E130`：minimum required data length for proper fault diagnosis(Other) motivates Signal slicing
  - `QG9H5LNQ_E131`：diagnostic complexity via a fixed sensor due to the irregular dynamic nature of gear fault meshing positions(Complex Systems) motivates Kurtosis
  - `QG9H5LNQ_E132`：interpret previously uncleared and uninterpreted fault-related sidebands(Trustworthiness / Interpretability) motivates Kurtosis
  - `QG9H5LNQ_E133`：minimum required data length for proper fault diagnosis(Other) motivates Kurtosis
  - `QG9H5LNQ_E134`：diagnostic complexity via a fixed sensor due to the irregular dynamic nature of gear fault meshing positions(Complex Systems) motivates Statistical analysis
  - `QG9H5LNQ_E135`：interpret previously uncleared and uninterpreted fault-related sidebands(Trustworthiness / Interpretability) motivates Statistical analysis
  - `QG9H5LNQ_E136`：minimum required data length for proper fault diagnosis(Other) motivates Statistical analysis
