...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `YMMPNUK2_E123` | `motivates` | 09-Problem Scenario | severe background noise(Uncertainty) |  | 19-Training Optimization Algorithm | Fuzzy C-Means |  |
| 2 | `YMMPNUK2_E124` | `motivates` | 09-Problem Scenario | unlabeled samples(Other) |  | 19-Training Optimization Algorithm | Fuzzy C-Means |  |
| 3 | `YMMPNUK2_E125` | `motivates` | 12-Training Data Availability | training set(Sufficient) |  | 19-Training Optimization Algorithm | Fuzzy C-Means |  |
| 4 | `YMMPNUK2_E126` | `motivates` | 13-Noise Level | noisy vibration signals(High Noise) |  | 15-Data Preprocessing Algorithm | Fourier Transform |  |
| 5 | `YMMPNUK2_E127` | `motivates` | 13-Noise Level | noisy vibration signals(High Noise) |  | 16-Feature Extraction Algorithm | K-SVD |  |
| 6 | `YMMPNUK2_E128` | `motivates` | 09-Problem Scenario | severe background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Fourier Transform |  |
| 7 | `YMMPNUK2_E129` | `motivates` | 09-Problem Scenario | unlabeled samples(Other) |  | 15-Data Preprocessing Algorithm | Fourier Transform |  |
| 8 | `YMMPNUK2_E130` | `motivates` | 09-Problem Scenario | severe background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | K-SVD |  |
| 9 | `YMMPNUK2_E131` | `motivates` | 09-Problem Scenario | unlabeled samples(Other) |  | 16-Feature Extraction Algorithm | K-SVD |  |
| 10 | `YMMPNUK2_E132` | `motivates` | 09-Problem Scenario | severe background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Cosine Similarity |  |
| 11 | `YMMPNUK2_E133` | `motivates` | 09-Problem Scenario | unlabeled samples(Other) |  | 17-Core Classifier Algorithm | Cosine Similarity |  |
| 12 | `YMMPNUK2_E134` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | K-SVD |  |
| 13 | `YMMPNUK2_E135` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Cosine Similarity |  |
| 14 | `YMMPNUK2_E136` | `motivates` | 06-Fault Severity | 0.007, 0.014, 0.021, and 0.028 in.(Multiple Severities) |  | 17-Core Classifier Algorithm | Cosine Similarity |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `YMMPNUK2_E123`：severe background noise(Uncertainty) motivates Fuzzy C-Means
  - `YMMPNUK2_E124`：unlabeled samples(Other) motivates Fuzzy C-Means
  - `YMMPNUK2_E128`：severe background noise(Uncertainty) motivates Fourier Transform
  - `YMMPNUK2_E129`：unlabeled samples(Other) motivates Fourier Transform
  - `YMMPNUK2_E130`：severe background noise(Uncertainty) motivates K-SVD
  - `YMMPNUK2_E131`：unlabeled samples(Other) motivates K-SVD
  - `YMMPNUK2_E132`：severe background noise(Uncertainty) motivates Cosine Similarity
  - `YMMPNUK2_E133`：unlabeled samples(Other) motivates Cosine Similarity
