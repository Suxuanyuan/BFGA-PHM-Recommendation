...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `6P2KFMGC_E108` | `motivates` | 09-Problem Scenario | poor self-adaptive ability in traditional feature extraction methods and weak generalization ability in single classifier under big data(Other) |  | 19-Training Optimization Algorithm | GOA |  |
| 2 | `6P2KFMGC_E109` | `motivates` | 09-Problem Scenario | DBN network parameters are still modified according to experience, making the diagnosis model insufficient stability and high randomness(Other) |  | 19-Training Optimization Algorithm | GOA |  |
| 3 | `6P2KFMGC_E110` | `motivates` | 12-Training Data Availability | 500 sample groups are obtained from each running state... 50% samples are randomly selected for training(Sufficient) |  | 19-Training Optimization Algorithm | GOA |  |
| 4 | `6P2KFMGC_E111` | `motivates` | 13-Noise Level | reduce the influence of noises and abnormal samples(High Noise) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 5 | `6P2KFMGC_E112` | `motivates` | 13-Noise Level | reduce the influence of noises and abnormal samples(High Noise) |  | 16-Feature Extraction Algorithm | RBM |  |
| 6 | `6P2KFMGC_E113` | `motivates` | 09-Problem Scenario | poor self-adaptive ability in traditional feature extraction methods and weak generalization ability in single classifier under big data(Other) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 7 | `6P2KFMGC_E114` | `motivates` | 09-Problem Scenario | DBN network parameters are still modified according to experience, making the diagnosis model insufficient stability and high randomness(Other) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 8 | `6P2KFMGC_E115` | `motivates` | 09-Problem Scenario | poor self-adaptive ability in traditional feature extraction methods and weak generalization ability in single classifier under big data(Other) |  | 16-Feature Extraction Algorithm | RBM |  |
| 9 | `6P2KFMGC_E116` | `motivates` | 09-Problem Scenario | DBN network parameters are still modified according to experience, making the diagnosis model insufficient stability and high randomness(Other) |  | 16-Feature Extraction Algorithm | RBM |  |
| 10 | `6P2KFMGC_E117` | `motivates` | 09-Problem Scenario | poor self-adaptive ability in traditional feature extraction methods and weak generalization ability in single classifier under big data(Other) |  | 17-Core Classifier Algorithm | BP |  |
| 11 | `6P2KFMGC_E118` | `motivates` | 09-Problem Scenario | DBN network parameters are still modified according to experience, making the diagnosis model insufficient stability and high randomness(Other) |  | 17-Core Classifier Algorithm | BP |  |
| 12 | `6P2KFMGC_E119` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | RBM |  |
| 13 | `6P2KFMGC_E120` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | BP |  |
| 14 | `6P2KFMGC_E121` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | BP |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `6P2KFMGC_E108`：poor self-adaptive ability in traditional feature extraction methods and weak generalization ability in single classifier under big data(Other) motivates GOA
  - `6P2KFMGC_E109`：DBN network parameters are still modified according to experience, making the diagnosis model insufficient stability and high randomness(Other) motivates GOA
  - `6P2KFMGC_E113`：poor self-adaptive ability in traditional feature extraction methods and weak generalization ability in single classifier under big data(Other) motivates FFT
  - `6P2KFMGC_E114`：DBN network parameters are still modified according to experience, making the diagnosis model insufficient stability and high randomness(Other) motivates FFT
  - `6P2KFMGC_E115`：poor self-adaptive ability in traditional feature extraction methods and weak generalization ability in single classifier under big data(Other) motivates RBM
  - `6P2KFMGC_E116`：DBN network parameters are still modified according to experience, making the diagnosis model insufficient stability and high randomness(Other) motivates RBM
  - `6P2KFMGC_E117`：poor self-adaptive ability in traditional feature extraction methods and weak generalization ability in single classifier under big data(Other) motivates BP
  - `6P2KFMGC_E118`：DBN network parameters are still modified according to experience, making the diagnosis model insufficient stability and high randomness(Other) motivates BP
