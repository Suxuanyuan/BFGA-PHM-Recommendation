...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `IAZZT5DG_E122` | `motivates` | 13-Noise Level | clean(Normal) |  | 15-Data Preprocessing Algorithm | Referral Algorithm |  |
| 2 | `IAZZT5DG_E123` | `motivates` | 13-Noise Level | clean(Normal) |  | 16-Feature Extraction Algorithm | Harmonic Analysis |  |
| 3 | `IAZZT5DG_E124` | `motivates` | 09-Problem Scenario | present individually or at the same time(Compound Faults) |  | 15-Data Preprocessing Algorithm | Referral Algorithm |  |
| 4 | `IAZZT5DG_E125` | `motivates` | 09-Problem Scenario | noise and tolerance of dynamic variations(Uncertainty) |  | 15-Data Preprocessing Algorithm | Referral Algorithm |  |
| 5 | `IAZZT5DG_E126` | `motivates` | 09-Problem Scenario | present individually or at the same time(Compound Faults) |  | 16-Feature Extraction Algorithm | Harmonic Analysis |  |
| 6 | `IAZZT5DG_E127` | `motivates` | 09-Problem Scenario | noise and tolerance of dynamic variations(Uncertainty) |  | 16-Feature Extraction Algorithm | Harmonic Analysis |  |
| 7 | `IAZZT5DG_E128` | `motivates` | 09-Problem Scenario | present individually or at the same time(Compound Faults) |  | 17-Core Classifier Algorithm | Bipolar Thresholding |  |
| 8 | `IAZZT5DG_E129` | `motivates` | 09-Problem Scenario | noise and tolerance of dynamic variations(Uncertainty) |  | 17-Core Classifier Algorithm | Bipolar Thresholding |  |
| 9 | `IAZZT5DG_E130` | `motivates` | 07-Compound Fault | present individually or at the same time(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | Harmonic Analysis |  |
| 10 | `IAZZT5DG_E131` | `motivates` | 07-Compound Fault | present individually or at the same time(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | Bipolar Thresholding |  |
| 11 | `IAZZT5DG_E132` | `motivates` | 06-Fault Severity | number of shorted turns, static and dynamic eccentricity percentage(Multiple Severities) |  | 17-Core Classifier Algorithm | Bipolar Thresholding |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `IAZZT5DG_E124`：present individually or at the same time(Compound Faults) motivates Referral Algorithm
  - `IAZZT5DG_E125`：noise and tolerance of dynamic variations(Uncertainty) motivates Referral Algorithm
  - `IAZZT5DG_E126`：present individually or at the same time(Compound Faults) motivates Harmonic Analysis
  - `IAZZT5DG_E127`：noise and tolerance of dynamic variations(Uncertainty) motivates Harmonic Analysis
  - `IAZZT5DG_E128`：present individually or at the same time(Compound Faults) motivates Bipolar Thresholding
  - `IAZZT5DG_E129`：noise and tolerance of dynamic variations(Uncertainty) motivates Bipolar Thresholding
