...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `IHCWYP22_E085` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Adaptive Interval Expansion |  |
| 2 | `IHCWYP22_E086` | `motivates` | 09-Problem Scenario | computationally expensive / evaluation times(Other) |  | 15-Data Preprocessing Algorithm | Adaptive Interval Expansion |  |
| 3 | `IHCWYP22_E087` | `motivates` | 09-Problem Scenario | no prior knowledge about the distribution / non-Gaussian distributed, multimodal dataset(Other) |  | 15-Data Preprocessing Algorithm | Adaptive Interval Expansion |  |
| 4 | `IHCWYP22_E088` | `motivates` | 09-Problem Scenario | computationally expensive / evaluation times(Other) |  | 17-Core Classifier Algorithm | Naive Bayes Classifier |  |
| 5 | `IHCWYP22_E089` | `motivates` | 09-Problem Scenario | no prior knowledge about the distribution / non-Gaussian distributed, multimodal dataset(Other) |  | 17-Core Classifier Algorithm | Naive Bayes Classifier |  |
| 6 | `IHCWYP22_E090` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Naive Bayes Classifier |  |
| 7 | `IHCWYP22_E091` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Naive Bayes Classifier |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `IHCWYP22_E086`：computationally expensive / evaluation times(Other) motivates Adaptive Interval Expansion
  - `IHCWYP22_E087`：no prior knowledge about the distribution / non-Gaussian distributed, multimodal dataset(Other) motivates Adaptive Interval Expansion
  - `IHCWYP22_E088`：computationally expensive / evaluation times(Other) motivates Naive Bayes Classifier
  - `IHCWYP22_E089`：no prior knowledge about the distribution / non-Gaussian distributed, multimodal dataset(Other) motivates Naive Bayes Classifier
