...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DVF38FLX_E144` | `motivates` | 09-Problem Scenario | small amount of labeled data(Small Fault Samples) |  | 19-Training Optimization Algorithm | Semisupervised learning |  |
| 2 | `DVF38FLX_E145` | `motivates` | 09-Problem Scenario | incipient gear-pitting failure, defect degradation(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | Semisupervised learning |  |
| 3 | `DVF38FLX_E146` | `motivates` | 12-Training Data Availability | A total of 200 raw vibration data sets, 360 data sets(Sufficient) |  | 19-Training Optimization Algorithm | Semisupervised learning |  |
| 4 | `DVF38FLX_E147` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 5 | `DVF38FLX_E148` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Linear Discriminant Analysis |  |
| 6 | `DVF38FLX_E149` | `motivates` | 09-Problem Scenario | small amount of labeled data(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 7 | `DVF38FLX_E150` | `motivates` | 09-Problem Scenario | incipient gear-pitting failure, defect degradation(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 8 | `DVF38FLX_E151` | `motivates` | 09-Problem Scenario | small amount of labeled data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Linear Discriminant Analysis |  |
| 9 | `DVF38FLX_E152` | `motivates` | 09-Problem Scenario | incipient gear-pitting failure, defect degradation(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Linear Discriminant Analysis |  |
| 10 | `DVF38FLX_E153` | `motivates` | 09-Problem Scenario | small amount of labeled data(Small Fault Samples) |  | 17-Core Classifier Algorithm | SS-DPSOM |  |
| 11 | `DVF38FLX_E154` | `motivates` | 09-Problem Scenario | incipient gear-pitting failure, defect degradation(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | SS-DPSOM |  |
| 12 | `DVF38FLX_E155` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Linear Discriminant Analysis |  |
| 13 | `DVF38FLX_E156` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SS-DPSOM |  |
| 14 | `DVF38FLX_E157` | `motivates` | 06-Fault Severity | 0.007, 0.014, and 0.021 in(Multiple Severities) |  | 17-Core Classifier Algorithm | SS-DPSOM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `DVF38FLX_E144`：small amount of labeled data(Small Fault Samples) motivates Semisupervised learning
  - `DVF38FLX_E145`：incipient gear-pitting failure, defect degradation(Early Degradation Prediction) motivates Semisupervised learning
  - `DVF38FLX_E149`：small amount of labeled data(Small Fault Samples) motivates Hilbert transform
  - `DVF38FLX_E150`：incipient gear-pitting failure, defect degradation(Early Degradation Prediction) motivates Hilbert transform
  - `DVF38FLX_E151`：small amount of labeled data(Small Fault Samples) motivates Linear Discriminant Analysis
  - `DVF38FLX_E152`：incipient gear-pitting failure, defect degradation(Early Degradation Prediction) motivates Linear Discriminant Analysis
  - `DVF38FLX_E153`：small amount of labeled data(Small Fault Samples) motivates SS-DPSOM
  - `DVF38FLX_E154`：incipient gear-pitting failure, defect degradation(Early Degradation Prediction) motivates SS-DPSOM
