...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `K4UQQ7HY_E150` | `motivates` | 13-Noise Level | contains strong noise(High Noise) |  | 15-Data Preprocessing Algorithm | Wavelet Transformation |  |
| 2 | `K4UQQ7HY_E151` | `motivates` | 13-Noise Level | contains strong noise(High Noise) |  | 16-Feature Extraction Algorithm | Locally Linear Embedding |  |
| 3 | `K4UQQ7HY_E152` | `motivates` | 09-Problem Scenario | non-stationary signal and strong noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Wavelet Transformation |  |
| 4 | `K4UQQ7HY_E153` | `motivates` | 09-Problem Scenario | non-stationary signal and strong noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Locally Linear Embedding |  |
| 5 | `K4UQQ7HY_E154` | `motivates` | 09-Problem Scenario | non-stationary signal and strong noise(Uncertainty) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 6 | `K4UQQ7HY_E155` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Locally Linear Embedding |  |
| 7 | `K4UQQ7HY_E156` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 8 | `K4UQQ7HY_E157` | `motivates` | 06-Fault Severity | 7 mils(Single Severity) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `K4UQQ7HY_E152`：non-stationary signal and strong noise(Uncertainty) motivates Wavelet Transformation
  - `K4UQQ7HY_E153`：non-stationary signal and strong noise(Uncertainty) motivates Locally Linear Embedding
  - `K4UQQ7HY_E154`：non-stationary signal and strong noise(Uncertainty) motivates Support Vector Machine
