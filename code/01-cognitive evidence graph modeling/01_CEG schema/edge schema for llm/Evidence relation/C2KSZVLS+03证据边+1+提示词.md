...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `C2KSZVLS_E120` | `motivates` | 13-Noise Level | None(Normal) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 2 | `C2KSZVLS_E121` | `motivates` | 13-Noise Level | None(Normal) |  | 16-Feature Extraction Algorithm | Fuzzy membership functions |  |
| 3 | `C2KSZVLS_E122` | `motivates` | 09-Problem Scenario | uncertainty, overlapping, unresolved cases(Uncertainty) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 4 | `C2KSZVLS_E123` | `motivates` | 09-Problem Scenario | severity of faulting, degree of healthiness(Other) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 5 | `C2KSZVLS_E124` | `motivates` | 09-Problem Scenario | uncertainty, overlapping, unresolved cases(Uncertainty) |  | 16-Feature Extraction Algorithm | Fuzzy membership functions |  |
| 6 | `C2KSZVLS_E125` | `motivates` | 09-Problem Scenario | severity of faulting, degree of healthiness(Other) |  | 16-Feature Extraction Algorithm | Fuzzy membership functions |  |
| 7 | `C2KSZVLS_E126` | `motivates` | 09-Problem Scenario | uncertainty, overlapping, unresolved cases(Uncertainty) |  | 17-Core Classifier Algorithm | Fuzzy-Evidential Reasoning |  |
| 8 | `C2KSZVLS_E127` | `motivates` | 09-Problem Scenario | severity of faulting, degree of healthiness(Other) |  | 17-Core Classifier Algorithm | Fuzzy-Evidential Reasoning |  |
| 9 | `C2KSZVLS_E128` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Fuzzy membership functions |  |
| 10 | `C2KSZVLS_E129` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Fuzzy-Evidential Reasoning |  |
| 11 | `C2KSZVLS_E130` | `motivates` | 06-Fault Severity | degree of faultiness (DOF)(Multiple Severities) |  | 17-Core Classifier Algorithm | Fuzzy-Evidential Reasoning |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `C2KSZVLS_E122`：uncertainty, overlapping, unresolved cases(Uncertainty) motivates Normalization
  - `C2KSZVLS_E123`：severity of faulting, degree of healthiness(Other) motivates Normalization
  - `C2KSZVLS_E124`：uncertainty, overlapping, unresolved cases(Uncertainty) motivates Fuzzy membership functions
  - `C2KSZVLS_E125`：severity of faulting, degree of healthiness(Other) motivates Fuzzy membership functions
  - `C2KSZVLS_E126`：uncertainty, overlapping, unresolved cases(Uncertainty) motivates Fuzzy-Evidential Reasoning
  - `C2KSZVLS_E127`：severity of faulting, degree of healthiness(Other) motivates Fuzzy-Evidential Reasoning
