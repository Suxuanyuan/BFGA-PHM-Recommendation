...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `9FU5QK5S_E071` | `motivates` | 13-Noise Level | mixed with a large amount of noise(High Noise) |  | 15-Data Preprocessing Algorithm | Double-dictionary matching pursuit |  |
| 2 | `9FU5QK5S_E072` | `motivates` | 13-Noise Level | mixed with a large amount of noise(High Noise) |  | 16-Feature Extraction Algorithm | Lempel-Ziv complexity |  |
| 3 | `9FU5QK5S_E073` | `motivates` | 09-Problem Scenario | signal collected from the practical engineering is often mixed with a large amount of noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Double-dictionary matching pursuit |  |
| 4 | `9FU5QK5S_E074` | `motivates` | 09-Problem Scenario | signal collected from the practical engineering is often mixed with a large amount of noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Lempel-Ziv complexity |  |
| 5 | `9FU5QK5S_E075` | `motivates` | 09-Problem Scenario | signal collected from the practical engineering is often mixed with a large amount of noise(Uncertainty) |  | 17-Core Classifier Algorithm | Trend analysis |  |
| 6 | `9FU5QK5S_E076` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Lempel-Ziv complexity |  |
| 7 | `9FU5QK5S_E077` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Trend analysis |  |
| 8 | `9FU5QK5S_E078` | `motivates` | 06-Fault Severity | diameters of 0.2, 0.5, 2, 3.5, and 5 mm(Multiple Severities) |  | 17-Core Classifier Algorithm | Trend analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `9FU5QK5S_E073`：signal collected from the practical engineering is often mixed with a large amount of noise(Uncertainty) motivates Double-dictionary matching pursuit
  - `9FU5QK5S_E074`：signal collected from the practical engineering is often mixed with a large amount of noise(Uncertainty) motivates Lempel-Ziv complexity
  - `9FU5QK5S_E075`：signal collected from the practical engineering is often mixed with a large amount of noise(Uncertainty) motivates Trend analysis
