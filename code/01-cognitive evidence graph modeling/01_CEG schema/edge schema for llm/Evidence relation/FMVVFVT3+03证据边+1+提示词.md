...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `FMVVFVT3_E079` | `motivates` | 13-Noise Level | noise, disturbance, and component tolerances(High Noise) |  | 15-Data Preprocessing Algorithm | Voltage Thresholding |  |
| 2 | `FMVVFVT3_E080` | `motivates` | 13-Noise Level | noise, disturbance, and component tolerances(High Noise) |  | 16-Feature Extraction Algorithm | Voltage Space Pattern |  |
| 3 | `FMVVFVT3_E081` | `motivates` | 09-Problem Scenario | robustness to the modeling errors and noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Voltage Thresholding |  |
| 4 | `FMVVFVT3_E082` | `motivates` | 09-Problem Scenario | slow diagnosis speed of current-based methods and sensor cost(Other) |  | 15-Data Preprocessing Algorithm | Voltage Thresholding |  |
| 5 | `FMVVFVT3_E083` | `motivates` | 09-Problem Scenario | robustness to the modeling errors and noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Voltage Space Pattern |  |
| 6 | `FMVVFVT3_E084` | `motivates` | 09-Problem Scenario | slow diagnosis speed of current-based methods and sensor cost(Other) |  | 16-Feature Extraction Algorithm | Voltage Space Pattern |  |
| 7 | `FMVVFVT3_E085` | `motivates` | 09-Problem Scenario | robustness to the modeling errors and noise(Uncertainty) |  | 17-Core Classifier Algorithm | Fault-Banned Zone Isolation |  |
| 8 | `FMVVFVT3_E086` | `motivates` | 09-Problem Scenario | slow diagnosis speed of current-based methods and sensor cost(Other) |  | 17-Core Classifier Algorithm | Fault-Banned Zone Isolation |  |
| 9 | `FMVVFVT3_E087` | `motivates` | 07-Compound Fault | single faults(No Compound Fault) |  | 16-Feature Extraction Algorithm | Voltage Space Pattern |  |
| 10 | `FMVVFVT3_E088` | `motivates` | 07-Compound Fault | single faults(No Compound Fault) |  | 17-Core Classifier Algorithm | Fault-Banned Zone Isolation |  |
| 11 | `FMVVFVT3_E089` | `motivates` | 06-Fault Severity | internal resistance R_f = 1mΩ(Single Severity) |  | 17-Core Classifier Algorithm | Fault-Banned Zone Isolation |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `FMVVFVT3_E081`：robustness to the modeling errors and noise(Uncertainty) motivates Voltage Thresholding
  - `FMVVFVT3_E082`：slow diagnosis speed of current-based methods and sensor cost(Other) motivates Voltage Thresholding
  - `FMVVFVT3_E083`：robustness to the modeling errors and noise(Uncertainty) motivates Voltage Space Pattern
  - `FMVVFVT3_E084`：slow diagnosis speed of current-based methods and sensor cost(Other) motivates Voltage Space Pattern
  - `FMVVFVT3_E085`：robustness to the modeling errors and noise(Uncertainty) motivates Fault-Banned Zone Isolation
  - `FMVVFVT3_E086`：slow diagnosis speed of current-based methods and sensor cost(Other) motivates Fault-Banned Zone Isolation
