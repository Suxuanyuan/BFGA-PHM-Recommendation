...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `U6FPAVVG_E088` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Standardization |  |
| 2 | `U6FPAVVG_E089` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | DPJE |  |
| 3 | `U6FPAVVG_E090` | `motivates` | 09-Problem Scenario | unbalanced sample(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Standardization |  |
| 4 | `U6FPAVVG_E091` | `motivates` | 09-Problem Scenario | speed transfer(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Standardization |  |
| 5 | `U6FPAVVG_E092` | `motivates` | 09-Problem Scenario | unbalanced sample(Small Fault Samples) |  | 16-Feature Extraction Algorithm | DPJE |  |
| 6 | `U6FPAVVG_E093` | `motivates` | 09-Problem Scenario | speed transfer(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | DPJE |  |
| 7 | `U6FPAVVG_E094` | `motivates` | 09-Problem Scenario | unbalanced sample(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `U6FPAVVG_E095` | `motivates` | 09-Problem Scenario | speed transfer(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 9 | `U6FPAVVG_E096` | `motivates` | 07-Compound Fault | compound fault composed of outer race and roller(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | DPJE |  |
| 10 | `U6FPAVVG_E097` | `motivates` | 07-Compound Fault | compound fault composed of outer race and roller(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `U6FPAVVG_E098` | `motivates` | 06-Fault Severity | 0.007 inch, 0.014 inch, 0.021 inch, 0.5 mm(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `U6FPAVVG_E090`：unbalanced sample(Small Fault Samples) motivates Standardization
  - `U6FPAVVG_E091`：speed transfer(Distribution Discrepancy) motivates Standardization
  - `U6FPAVVG_E092`：unbalanced sample(Small Fault Samples) motivates DPJE
  - `U6FPAVVG_E093`：speed transfer(Distribution Discrepancy) motivates DPJE
  - `U6FPAVVG_E094`：unbalanced sample(Small Fault Samples) motivates Softmax
  - `U6FPAVVG_E095`：speed transfer(Distribution Discrepancy) motivates Softmax
