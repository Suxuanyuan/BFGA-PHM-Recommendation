...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4YCGGAK4_E138` | `motivates` | 13-Noise Level | disturbances / noise and outliers(High Noise) |  | 15-Data Preprocessing Algorithm | Downsampling |  |
| 2 | `4YCGGAK4_E139` | `motivates` | 13-Noise Level | disturbances / noise and outliers(High Noise) |  | 16-Feature Extraction Algorithm | CCVA |  |
| 3 | `4YCGGAK4_E140` | `motivates` | 09-Problem Scenario | multiple faults(Compound Faults) |  | 15-Data Preprocessing Algorithm | Downsampling |  |
| 4 | `4YCGGAK4_E141` | `motivates` | 09-Problem Scenario | plant-wide process / process industries(Complex Systems) |  | 15-Data Preprocessing Algorithm | Downsampling |  |
| 5 | `4YCGGAK4_E142` | `motivates` | 09-Problem Scenario | multiple faults(Compound Faults) |  | 16-Feature Extraction Algorithm | CCVA |  |
| 6 | `4YCGGAK4_E143` | `motivates` | 09-Problem Scenario | plant-wide process / process industries(Complex Systems) |  | 16-Feature Extraction Algorithm | CCVA |  |
| 7 | `4YCGGAK4_E144` | `motivates` | 09-Problem Scenario | multiple faults(Compound Faults) |  | 17-Core Classifier Algorithm | TSADA |  |
| 8 | `4YCGGAK4_E145` | `motivates` | 09-Problem Scenario | plant-wide process / process industries(Complex Systems) |  | 17-Core Classifier Algorithm | TSADA |  |
| 9 | `4YCGGAK4_E146` | `motivates` | 07-Compound Fault | multiple faults(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | CCVA |  |
| 10 | `4YCGGAK4_E147` | `motivates` | 07-Compound Fault | multiple faults(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | TSADA |  |
| 11 | `4YCGGAK4_E148` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | TSADA |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4YCGGAK4_E140`：multiple faults(Compound Faults) motivates Downsampling
  - `4YCGGAK4_E141`：plant-wide process / process industries(Complex Systems) motivates Downsampling
  - `4YCGGAK4_E142`：multiple faults(Compound Faults) motivates CCVA
  - `4YCGGAK4_E143`：plant-wide process / process industries(Complex Systems) motivates CCVA
  - `4YCGGAK4_E144`：multiple faults(Compound Faults) motivates TSADA
  - `4YCGGAK4_E145`：plant-wide process / process industries(Complex Systems) motivates TSADA
