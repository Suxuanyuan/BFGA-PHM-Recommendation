...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VD29JX4T_E083` | `motivates` | 13-Noise Level | quantization noise, noise(High Noise) |  | 15-Data Preprocessing Algorithm | Low-pass filter |  |
| 2 | `VD29JX4T_E084` | `motivates` | 13-Noise Level | quantization noise, noise(High Noise) |  | 16-Feature Extraction Algorithm | Second-order exact differentiation |  |
| 3 | `VD29JX4T_E085` | `motivates` | 09-Problem Scenario | system uncertainties and unknown bounded faults(Uncertainty) |  | 15-Data Preprocessing Algorithm | Low-pass filter |  |
| 4 | `VD29JX4T_E086` | `motivates` | 09-Problem Scenario | singularity and chattering in terminal sliding mode control(Other) |  | 15-Data Preprocessing Algorithm | Low-pass filter |  |
| 5 | `VD29JX4T_E087` | `motivates` | 09-Problem Scenario | system uncertainties and unknown bounded faults(Uncertainty) |  | 16-Feature Extraction Algorithm | Second-order exact differentiation |  |
| 6 | `VD29JX4T_E088` | `motivates` | 09-Problem Scenario | singularity and chattering in terminal sliding mode control(Other) |  | 16-Feature Extraction Algorithm | Second-order exact differentiation |  |
| 7 | `VD29JX4T_E089` | `motivates` | 09-Problem Scenario | system uncertainties and unknown bounded faults(Uncertainty) |  | 17-Core Classifier Algorithm | Nonsingular fast terminal sliding mode control |  |
| 8 | `VD29JX4T_E090` | `motivates` | 09-Problem Scenario | singularity and chattering in terminal sliding mode control(Other) |  | 17-Core Classifier Algorithm | Nonsingular fast terminal sliding mode control |  |
| 9 | `VD29JX4T_E091` | `motivates` | 07-Compound Fault | complex fault(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | Second-order exact differentiation |  |
| 10 | `VD29JX4T_E092` | `motivates` | 07-Compound Fault | complex fault(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | Nonsingular fast terminal sliding mode control |  |
| 11 | `VD29JX4T_E093` | `motivates` | 06-Fault Severity | magnitude 12 Nm, 75% partial loss(Single Severity) |  | 17-Core Classifier Algorithm | Nonsingular fast terminal sliding mode control |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `VD29JX4T_E085`：system uncertainties and unknown bounded faults(Uncertainty) motivates Low-pass filter
  - `VD29JX4T_E086`：singularity and chattering in terminal sliding mode control(Other) motivates Low-pass filter
  - `VD29JX4T_E087`：system uncertainties and unknown bounded faults(Uncertainty) motivates Second-order exact differentiation
  - `VD29JX4T_E088`：singularity and chattering in terminal sliding mode control(Other) motivates Second-order exact differentiation
  - `VD29JX4T_E089`：system uncertainties and unknown bounded faults(Uncertainty) motivates Nonsingular fast terminal sliding mode control
  - `VD29JX4T_E090`：singularity and chattering in terminal sliding mode control(Other) motivates Nonsingular fast terminal sliding mode control
