...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `27JDIFKZ_E123` | `motivates` | 09-Problem Scenario | high dimensional data with low sample size / small sample classification problems(Small Fault Samples) |  | 19-Training Optimization Algorithm | GWO |  |
| 2 | `27JDIFKZ_E124` | `motivates` | 09-Problem Scenario | multiscale amplitude-aware permutation entropy ignores high-frequency features(Other) |  | 19-Training Optimization Algorithm | GWO |  |
| 3 | `27JDIFKZ_E125` | `motivates` | 12-Training Data Availability | low sample size / small sample(Scarce) |  | 19-Training Optimization Algorithm | GWO |  |
| 4 | `27JDIFKZ_E126` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | HAAPE |  |
| 5 | `27JDIFKZ_E127` | `motivates` | 09-Problem Scenario | high dimensional data with low sample size / small sample classification problems(Small Fault Samples) |  | 16-Feature Extraction Algorithm | HAAPE |  |
| 6 | `27JDIFKZ_E128` | `motivates` | 09-Problem Scenario | multiscale amplitude-aware permutation entropy ignores high-frequency features(Other) |  | 16-Feature Extraction Algorithm | HAAPE |  |
| 7 | `27JDIFKZ_E129` | `motivates` | 09-Problem Scenario | high dimensional data with low sample size / small sample classification problems(Small Fault Samples) |  | 17-Core Classifier Algorithm | SVM |  |
| 8 | `27JDIFKZ_E130` | `motivates` | 09-Problem Scenario | multiscale amplitude-aware permutation entropy ignores high-frequency features(Other) |  | 17-Core Classifier Algorithm | SVM |  |
| 9 | `27JDIFKZ_E131` | `motivates` | 07-Compound Fault | pitting + wear(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | HAAPE |  |
| 10 | `27JDIFKZ_E132` | `motivates` | 07-Compound Fault | pitting + wear(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | SVM |  |
| 11 | `27JDIFKZ_E133` | `motivates` | 06-Fault Severity | 0.1778, 0.3556, and 0.5334 mm(Multiple Severities) |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `27JDIFKZ_E123`：high dimensional data with low sample size / small sample classification problems(Small Fault Samples) motivates GWO
  - `27JDIFKZ_E124`：multiscale amplitude-aware permutation entropy ignores high-frequency features(Other) motivates GWO
  - `27JDIFKZ_E127`：high dimensional data with low sample size / small sample classification problems(Small Fault Samples) motivates HAAPE
  - `27JDIFKZ_E128`：multiscale amplitude-aware permutation entropy ignores high-frequency features(Other) motivates HAAPE
  - `27JDIFKZ_E129`：high dimensional data with low sample size / small sample classification problems(Small Fault Samples) motivates SVM
  - `27JDIFKZ_E130`：multiscale amplitude-aware permutation entropy ignores high-frequency features(Other) motivates SVM
