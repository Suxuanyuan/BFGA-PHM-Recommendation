...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ENE5VYTR_E068` | `motivates` | 13-Noise Level | massive corruption of noise, heavy background noise interference(High Noise) |  | 15-Data Preprocessing Algorithm | Teager energy operator |  |
| 2 | `ENE5VYTR_E069` | `motivates` | 13-Noise Level | massive corruption of noise, heavy background noise interference(High Noise) |  | 16-Feature Extraction Algorithm | CEEMD |  |
| 3 | `ENE5VYTR_E070` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Teager energy operator |  |
| 4 | `ENE5VYTR_E071` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | CEEMD |  |
| 5 | `ENE5VYTR_E072` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope analysis |  |
| 6 | `ENE5VYTR_E073` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CEEMD |  |
| 7 | `ENE5VYTR_E074` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope analysis |  |
| 8 | `ENE5VYTR_E075` | `motivates` | 06-Fault Severity | 2x2mm(Single Severity) |  | 17-Core Classifier Algorithm | Envelope analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ENE5VYTR_E070`：noise robustness(Uncertainty) motivates Teager energy operator
  - `ENE5VYTR_E071`：noise robustness(Uncertainty) motivates CEEMD
  - `ENE5VYTR_E072`：noise robustness(Uncertainty) motivates Envelope analysis
