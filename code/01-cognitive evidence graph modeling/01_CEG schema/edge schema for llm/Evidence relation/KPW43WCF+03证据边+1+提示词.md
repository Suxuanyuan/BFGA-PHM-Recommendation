...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `KPW43WCF_E135` | `motivates` | 13-Noise Level | uniform distributed noise(High Noise) |  | 15-Data Preprocessing Algorithm | Standardization |  |
| 2 | `KPW43WCF_E136` | `motivates` | 13-Noise Level | uniform distributed noise(High Noise) |  | 16-Feature Extraction Algorithm | Wavelet Packet Transform |  |
| 3 | `KPW43WCF_E137` | `motivates` | 09-Problem Scenario | environmental noises and variations(Uncertainty) |  | 15-Data Preprocessing Algorithm | Standardization |  |
| 4 | `KPW43WCF_E138` | `motivates` | 09-Problem Scenario | adaptive for new information / easily insert any new information like a new fault without affecting previously built network(Other) |  | 15-Data Preprocessing Algorithm | Standardization |  |
| 5 | `KPW43WCF_E139` | `motivates` | 09-Problem Scenario | environmental noises and variations(Uncertainty) |  | 16-Feature Extraction Algorithm | Wavelet Packet Transform |  |
| 6 | `KPW43WCF_E140` | `motivates` | 09-Problem Scenario | adaptive for new information / easily insert any new information like a new fault without affecting previously built network(Other) |  | 16-Feature Extraction Algorithm | Wavelet Packet Transform |  |
| 7 | `KPW43WCF_E141` | `motivates` | 09-Problem Scenario | environmental noises and variations(Uncertainty) |  | 17-Core Classifier Algorithm | Extension Neural Network |  |
| 8 | `KPW43WCF_E142` | `motivates` | 09-Problem Scenario | adaptive for new information / easily insert any new information like a new fault without affecting previously built network(Other) |  | 17-Core Classifier Algorithm | Extension Neural Network |  |
| 9 | `KPW43WCF_E143` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Wavelet Packet Transform |  |
| 10 | `KPW43WCF_E144` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Extension Neural Network |  |
| 11 | `KPW43WCF_E145` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Extension Neural Network |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `KPW43WCF_E137`：environmental noises and variations(Uncertainty) motivates Standardization
  - `KPW43WCF_E138`：adaptive for new information / easily insert any new information like a new fault without affecting previously built network(Other) motivates Standardization
  - `KPW43WCF_E139`：environmental noises and variations(Uncertainty) motivates Wavelet Packet Transform
  - `KPW43WCF_E140`：adaptive for new information / easily insert any new information like a new fault without affecting previously built network(Other) motivates Wavelet Packet Transform
  - `KPW43WCF_E141`：environmental noises and variations(Uncertainty) motivates Extension Neural Network
  - `KPW43WCF_E142`：adaptive for new information / easily insert any new information like a new fault without affecting previously built network(Other) motivates Extension Neural Network
