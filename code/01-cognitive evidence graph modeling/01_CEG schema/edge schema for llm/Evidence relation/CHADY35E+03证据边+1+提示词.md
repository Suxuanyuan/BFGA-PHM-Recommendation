...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CHADY35E_E090` | `motivates` | 13-Noise Level | original fault signals(Normal) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 2 | `CHADY35E_E091` | `motivates` | 13-Noise Level | original fault signals(Normal) |  | 16-Feature Extraction Algorithm | SNP-ELM-AE |  |
| 3 | `CHADY35E_E092` | `motivates` | 09-Problem Scenario | dimension reduction of high-dimensional data, preserving global and local manifold structures(Other) |  | 15-Data Preprocessing Algorithm | Normalization |  |
| 4 | `CHADY35E_E093` | `motivates` | 09-Problem Scenario | dimension reduction of high-dimensional data, preserving global and local manifold structures(Other) |  | 16-Feature Extraction Algorithm | SNP-ELM-AE |  |
| 5 | `CHADY35E_E094` | `motivates` | 09-Problem Scenario | dimension reduction of high-dimensional data, preserving global and local manifold structures(Other) |  | 17-Core Classifier Algorithm | ELM |  |
| 6 | `CHADY35E_E095` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | SNP-ELM-AE |  |
| 7 | `CHADY35E_E096` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | ELM |  |
| 8 | `CHADY35E_E097` | `motivates` | 06-Fault Severity | 0.007 inches(Single Severity) |  | 17-Core Classifier Algorithm | ELM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `CHADY35E_E092`：dimension reduction of high-dimensional data, preserving global and local manifold structures(Other) motivates Normalization
  - `CHADY35E_E093`：dimension reduction of high-dimensional data, preserving global and local manifold structures(Other) motivates SNP-ELM-AE
  - `CHADY35E_E094`：dimension reduction of high-dimensional data, preserving global and local manifold structures(Other) motivates ELM
