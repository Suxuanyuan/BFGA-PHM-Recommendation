...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4YLEBZSW_E080` | `motivates` | 13-Noise Level | noise and external measurement disturbance(High Noise) |  | 15-Data Preprocessing Algorithm | binary morphology |  |
| 2 | `4YLEBZSW_E081` | `motivates` | 13-Noise Level | noise and external measurement disturbance(High Noise) |  | 16-Feature Extraction Algorithm | composite indicator of extreme point variation |  |
| 3 | `4YLEBZSW_E082` | `motivates` | 09-Problem Scenario | External disturbance and measurement noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | binary morphology |  |
| 4 | `4YLEBZSW_E083` | `motivates` | 09-Problem Scenario | External disturbance and measurement noise(Uncertainty) |  | 16-Feature Extraction Algorithm | composite indicator of extreme point variation |  |
| 5 | `4YLEBZSW_E084` | `motivates` | 09-Problem Scenario | External disturbance and measurement noise(Uncertainty) |  | 17-Core Classifier Algorithm | ternary diagram |  |
| 6 | `4YLEBZSW_E085` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | composite indicator of extreme point variation |  |
| 7 | `4YLEBZSW_E086` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | ternary diagram |  |
| 8 | `4YLEBZSW_E087` | `motivates` | 06-Fault Severity | radial deformation ratio, capacitance percentage(Multiple Severities) |  | 17-Core Classifier Algorithm | ternary diagram |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4YLEBZSW_E082`：External disturbance and measurement noise(Uncertainty) motivates binary morphology
  - `4YLEBZSW_E083`：External disturbance and measurement noise(Uncertainty) motivates composite indicator of extreme point variation
  - `4YLEBZSW_E084`：External disturbance and measurement noise(Uncertainty) motivates ternary diagram
