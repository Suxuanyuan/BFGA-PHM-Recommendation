...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `85P74XGJ_E100` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 19-Training Optimization Algorithm | KFFR |  |
| 2 | `85P74XGJ_E101` | `motivates` | 09-Problem Scenario | early fault identification, weak fault signals(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | KFFR |  |
| 3 | `85P74XGJ_E102` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | KFFR |  |
| 4 | `85P74XGJ_E103` | `motivates` | 13-Noise Level | strong background noise, Gaussian white noise(High Noise) |  | 15-Data Preprocessing Algorithm | MECGMF |  |
| 5 | `85P74XGJ_E104` | `motivates` | 13-Noise Level | strong background noise, Gaussian white noise(High Noise) |  | 16-Feature Extraction Algorithm | Envelope Analysis |  |
| 6 | `85P74XGJ_E105` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | MECGMF |  |
| 7 | `85P74XGJ_E106` | `motivates` | 09-Problem Scenario | early fault identification, weak fault signals(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | MECGMF |  |
| 8 | `85P74XGJ_E107` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Envelope Analysis |  |
| 9 | `85P74XGJ_E108` | `motivates` | 09-Problem Scenario | early fault identification, weak fault signals(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Envelope Analysis |  |
| 10 | `85P74XGJ_E109` | `motivates` | 09-Problem Scenario | strong background noise(Uncertainty) |  | 17-Core Classifier Algorithm | Spectral Peak Identification |  |
| 11 | `85P74XGJ_E110` | `motivates` | 09-Problem Scenario | early fault identification, weak fault signals(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Spectral Peak Identification |  |
| 12 | `85P74XGJ_E111` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Envelope Analysis |  |
| 13 | `85P74XGJ_E112` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Spectral Peak Identification |  |
| 14 | `85P74XGJ_E113` | `motivates` | 06-Fault Severity | 0.007 mm fault in diameter(Single Severity) |  | 17-Core Classifier Algorithm | Spectral Peak Identification |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `85P74XGJ_E100`：strong background noise(Uncertainty) motivates KFFR
  - `85P74XGJ_E101`：early fault identification, weak fault signals(Early Degradation Prediction) motivates KFFR
  - `85P74XGJ_E105`：strong background noise(Uncertainty) motivates MECGMF
  - `85P74XGJ_E106`：early fault identification, weak fault signals(Early Degradation Prediction) motivates MECGMF
  - `85P74XGJ_E107`：strong background noise(Uncertainty) motivates Envelope Analysis
  - `85P74XGJ_E108`：early fault identification, weak fault signals(Early Degradation Prediction) motivates Envelope Analysis
  - `85P74XGJ_E109`：strong background noise(Uncertainty) motivates Spectral Peak Identification
  - `85P74XGJ_E110`：early fault identification, weak fault signals(Early Degradation Prediction) motivates Spectral Peak Identification
