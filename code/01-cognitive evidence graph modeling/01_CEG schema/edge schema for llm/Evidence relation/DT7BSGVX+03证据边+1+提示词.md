...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DT7BSGVX_E080` | `motivates` | 13-Noise Level | vibration signals(Normal) |  | 15-Data Preprocessing Algorithm | IFDI |  |
| 2 | `DT7BSGVX_E081` | `motivates` | 13-Noise Level | vibration signals(Normal) |  | 16-Feature Extraction Algorithm | PCA |  |
| 3 | `DT7BSGVX_E082` | `motivates` | 09-Problem Scenario | computational burden and model complexity of raw data(Other) |  | 15-Data Preprocessing Algorithm | IFDI |  |
| 4 | `DT7BSGVX_E083` | `motivates` | 09-Problem Scenario | sensor failure in data acquisition(Other) |  | 15-Data Preprocessing Algorithm | IFDI |  |
| 5 | `DT7BSGVX_E084` | `motivates` | 09-Problem Scenario | computational burden and model complexity of raw data(Other) |  | 16-Feature Extraction Algorithm | PCA |  |
| 6 | `DT7BSGVX_E085` | `motivates` | 09-Problem Scenario | sensor failure in data acquisition(Other) |  | 16-Feature Extraction Algorithm | PCA |  |
| 7 | `DT7BSGVX_E086` | `motivates` | 09-Problem Scenario | computational burden and model complexity of raw data(Other) |  | 17-Core Classifier Algorithm | DCNN |  |
| 8 | `DT7BSGVX_E087` | `motivates` | 09-Problem Scenario | sensor failure in data acquisition(Other) |  | 17-Core Classifier Algorithm | DCNN |  |
| 9 | `DT7BSGVX_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | PCA |  |
| 10 | `DT7BSGVX_E089` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | DCNN |  |
| 11 | `DT7BSGVX_E090` | `motivates` | 06-Fault Severity | crack length(Multiple Severities) |  | 17-Core Classifier Algorithm | DCNN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `DT7BSGVX_E082`：computational burden and model complexity of raw data(Other) motivates IFDI
  - `DT7BSGVX_E083`：sensor failure in data acquisition(Other) motivates IFDI
  - `DT7BSGVX_E084`：computational burden and model complexity of raw data(Other) motivates PCA
  - `DT7BSGVX_E085`：sensor failure in data acquisition(Other) motivates PCA
  - `DT7BSGVX_E086`：computational burden and model complexity of raw data(Other) motivates DCNN
  - `DT7BSGVX_E087`：sensor failure in data acquisition(Other) motivates DCNN
