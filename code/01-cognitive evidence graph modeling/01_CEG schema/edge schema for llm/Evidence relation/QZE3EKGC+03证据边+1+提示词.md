...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QZE3EKGC_E023` | `motivates` | 09-Problem Scenario | IP mobility issues in virtual machine migration across subnets(Other) |  | 17-Core Classifier Algorithm | Identity/Locator Decoupling |  |
| 2 | `QZE3EKGC_E024` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Identity/Locator Decoupling |  |
| 3 | `QZE3EKGC_E025` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Identity/Locator Decoupling |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `QZE3EKGC_E023`：IP mobility issues in virtual machine migration across subnets(Other) motivates Identity/Locator Decoupling
