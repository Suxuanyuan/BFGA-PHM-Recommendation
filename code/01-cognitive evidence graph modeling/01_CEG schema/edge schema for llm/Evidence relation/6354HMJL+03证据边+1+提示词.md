...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `6354HMJL_E118` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Z-Score |  |
| 2 | `6354HMJL_E119` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | ILTSA |  |
| 3 | `6354HMJL_E120` | `motivates` | 09-Problem Scenario | high-dimensionality, nonlinearity and dynamic characteristics of process data(Other) |  | 15-Data Preprocessing Algorithm | Z-Score |  |
| 4 | `6354HMJL_E121` | `motivates` | 09-Problem Scenario | complex correlations among global variables(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Z-Score |  |
| 5 | `6354HMJL_E122` | `motivates` | 09-Problem Scenario | high-dimensionality, nonlinearity and dynamic characteristics of process data(Other) |  | 16-Feature Extraction Algorithm | ILTSA |  |
| 6 | `6354HMJL_E123` | `motivates` | 09-Problem Scenario | complex correlations among global variables(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | ILTSA |  |
| 7 | `6354HMJL_E124` | `motivates` | 09-Problem Scenario | high-dimensionality, nonlinearity and dynamic characteristics of process data(Other) |  | 17-Core Classifier Algorithm | SVDD |  |
| 8 | `6354HMJL_E125` | `motivates` | 09-Problem Scenario | complex correlations among global variables(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | SVDD |  |
| 9 | `6354HMJL_E126` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | ILTSA |  |
| 10 | `6354HMJL_E127` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVDD |  |
| 11 | `6354HMJL_E128` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | SVDD |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `6354HMJL_E120`：high-dimensionality, nonlinearity and dynamic characteristics of process data(Other) motivates Z-Score
  - `6354HMJL_E121`：complex correlations among global variables(Multi-Source Heterogeneous / Multimodal Data) motivates Z-Score
  - `6354HMJL_E122`：high-dimensionality, nonlinearity and dynamic characteristics of process data(Other) motivates ILTSA
  - `6354HMJL_E123`：complex correlations among global variables(Multi-Source Heterogeneous / Multimodal Data) motivates ILTSA
  - `6354HMJL_E124`：high-dimensionality, nonlinearity and dynamic characteristics of process data(Other) motivates SVDD
  - `6354HMJL_E125`：complex correlations among global variables(Multi-Source Heterogeneous / Multimodal Data) motivates SVDD
