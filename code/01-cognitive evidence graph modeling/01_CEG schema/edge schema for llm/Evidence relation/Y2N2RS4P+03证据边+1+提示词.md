...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `Y2N2RS4P_E119` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Unsupervised multisource domain adaptation |  |
| 2 | `Y2N2RS4P_E120` | `motivates` | 09-Problem Scenario | negative transfer and bad samples(Uncertainty) |  | 19-Training Optimization Algorithm | Unsupervised multisource domain adaptation |  |
| 3 | `Y2N2RS4P_E121` | `motivates` | 12-Training Data Availability | The labeled data in source domains and the unlabeled data in the target domain are sufficient(Sufficient) |  | 19-Training Optimization Algorithm | Unsupervised multisource domain adaptation |  |
| 4 | `Y2N2RS4P_E122` | `motivates` | 13-Noise Level | noises related to the underlying shared distribution, environmental noise(High Noise) |  | 15-Data Preprocessing Algorithm | Sliding window |  |
| 5 | `Y2N2RS4P_E123` | `motivates` | 13-Noise Level | noises related to the underlying shared distribution, environmental noise(High Noise) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 6 | `Y2N2RS4P_E124` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Sliding window |  |
| 7 | `Y2N2RS4P_E125` | `motivates` | 09-Problem Scenario | negative transfer and bad samples(Uncertainty) |  | 15-Data Preprocessing Algorithm | Sliding window |  |
| 8 | `Y2N2RS4P_E126` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 9 | `Y2N2RS4P_E127` | `motivates` | 09-Problem Scenario | negative transfer and bad samples(Uncertainty) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 10 | `Y2N2RS4P_E128` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `Y2N2RS4P_E129` | `motivates` | 09-Problem Scenario | negative transfer and bad samples(Uncertainty) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `Y2N2RS4P_E130` | `motivates` | 07-Compound Fault | IF + OF(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | 1DCNN |  |
| 13 | `Y2N2RS4P_E131` | `motivates` | 07-Compound Fault | IF + OF(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `Y2N2RS4P_E132` | `motivates` | 06-Fault Severity | damage level(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `Y2N2RS4P_E119`：domain shift(Distribution Discrepancy) motivates Unsupervised multisource domain adaptation
  - `Y2N2RS4P_E120`：negative transfer and bad samples(Uncertainty) motivates Unsupervised multisource domain adaptation
  - `Y2N2RS4P_E124`：domain shift(Distribution Discrepancy) motivates Sliding window
  - `Y2N2RS4P_E125`：negative transfer and bad samples(Uncertainty) motivates Sliding window
  - `Y2N2RS4P_E126`：domain shift(Distribution Discrepancy) motivates 1DCNN
  - `Y2N2RS4P_E127`：negative transfer and bad samples(Uncertainty) motivates 1DCNN
  - `Y2N2RS4P_E128`：domain shift(Distribution Discrepancy) motivates Softmax
  - `Y2N2RS4P_E129`：negative transfer and bad samples(Uncertainty) motivates Softmax
