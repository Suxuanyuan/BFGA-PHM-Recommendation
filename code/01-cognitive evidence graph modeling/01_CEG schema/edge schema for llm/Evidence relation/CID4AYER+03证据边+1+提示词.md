...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CID4AYER_E111` | `motivates` | 13-Noise Level | noise contained in the vibration signal, noisy signal(High Noise) |  | 15-Data Preprocessing Algorithm | Envelope Extraction |  |
| 2 | `CID4AYER_E112` | `motivates` | 13-Noise Level | noise contained in the vibration signal, noisy signal(High Noise) |  | 16-Feature Extraction Algorithm | Matching Pursuit |  |
| 3 | `CID4AYER_E113` | `motivates` | 09-Problem Scenario | current-aided order tracking of vibration signals(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Envelope Extraction |  |
| 4 | `CID4AYER_E114` | `motivates` | 09-Problem Scenario | massive data storage and transmission costs(Other) |  | 15-Data Preprocessing Algorithm | Envelope Extraction |  |
| 5 | `CID4AYER_E115` | `motivates` | 09-Problem Scenario | current-aided order tracking of vibration signals(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | Matching Pursuit |  |
| 6 | `CID4AYER_E116` | `motivates` | 09-Problem Scenario | massive data storage and transmission costs(Other) |  | 16-Feature Extraction Algorithm | Matching Pursuit |  |
| 7 | `CID4AYER_E117` | `motivates` | 09-Problem Scenario | current-aided order tracking of vibration signals(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | Characteristic Order Matching |  |
| 8 | `CID4AYER_E118` | `motivates` | 09-Problem Scenario | massive data storage and transmission costs(Other) |  | 17-Core Classifier Algorithm | Characteristic Order Matching |  |
| 9 | `CID4AYER_E119` | `motivates` | 07-Compound Fault | outer-race bearing fault and cage out-of-shape defect(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Matching Pursuit |  |
| 10 | `CID4AYER_E120` | `motivates` | 07-Compound Fault | outer-race bearing fault and cage out-of-shape defect(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Characteristic Order Matching |  |
| 11 | `CID4AYER_E121` | `motivates` | 06-Fault Severity | width: 3 mm and depth: 1 mm; width: 1 mm and depth: 0.5 mm(Single Severity) |  | 17-Core Classifier Algorithm | Characteristic Order Matching |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `CID4AYER_E113`：current-aided order tracking of vibration signals(Multi-Source Heterogeneous / Multimodal Data) motivates Envelope Extraction
  - `CID4AYER_E114`：massive data storage and transmission costs(Other) motivates Envelope Extraction
  - `CID4AYER_E115`：current-aided order tracking of vibration signals(Multi-Source Heterogeneous / Multimodal Data) motivates Matching Pursuit
  - `CID4AYER_E116`：massive data storage and transmission costs(Other) motivates Matching Pursuit
  - `CID4AYER_E117`：current-aided order tracking of vibration signals(Multi-Source Heterogeneous / Multimodal Data) motivates Characteristic Order Matching
  - `CID4AYER_E118`：massive data storage and transmission costs(Other) motivates Characteristic Order Matching
