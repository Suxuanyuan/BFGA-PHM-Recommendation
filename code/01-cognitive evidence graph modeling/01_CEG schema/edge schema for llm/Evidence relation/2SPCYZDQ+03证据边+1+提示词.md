...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `2SPCYZDQ_E076` | `motivates` | 13-Noise Level | Noise(t), background noise(High Noise) |  | 15-Data Preprocessing Algorithm | BEMD |  |
| 2 | `2SPCYZDQ_E077` | `motivates` | 13-Noise Level | Noise(t), background noise(High Noise) |  | 16-Feature Extraction Algorithm | AMMA |  |
| 3 | `2SPCYZDQ_E078` | `motivates` | 09-Problem Scenario | incipient fault / early fault stage(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | BEMD |  |
| 4 | `2SPCYZDQ_E079` | `motivates` | 09-Problem Scenario | incipient fault / early fault stage(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | AMMA |  |
| 5 | `2SPCYZDQ_E080` | `motivates` | 09-Problem Scenario | incipient fault / early fault stage(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | FFT |  |
| 6 | `2SPCYZDQ_E081` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | AMMA |  |
| 7 | `2SPCYZDQ_E082` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | FFT |  |
| 8 | `2SPCYZDQ_E083` | `motivates` | 06-Fault Severity | micro-pits (< 0.5mm), spalling (5mm x 4mm)(Multiple Severities) |  | 17-Core Classifier Algorithm | FFT |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `2SPCYZDQ_E078`：incipient fault / early fault stage(Early Degradation Prediction) motivates BEMD
  - `2SPCYZDQ_E079`：incipient fault / early fault stage(Early Degradation Prediction) motivates AMMA
  - `2SPCYZDQ_E080`：incipient fault / early fault stage(Early Degradation Prediction) motivates FFT
