...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4VKUYLBM_E091` | `motivates` | 09-Problem Scenario | lack of sufficient labeled data(Small Fault Samples) |  | 19-Training Optimization Algorithm | Hierarchical Deep Domain Adaptation |  |
| 2 | `4VKUYLBM_E092` | `motivates` | 09-Problem Scenario | data distribution discrepancy(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Hierarchical Deep Domain Adaptation |  |
| 3 | `4VKUYLBM_E093` | `motivates` | 12-Training Data Availability | lack of sufficient labeled data(Scarce) |  | 19-Training Optimization Algorithm | Hierarchical Deep Domain Adaptation |  |
| 4 | `4VKUYLBM_E094` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Hierarchical structure |  |
| 5 | `4VKUYLBM_E095` | `motivates` | 09-Problem Scenario | lack of sufficient labeled data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Hierarchical structure |  |
| 6 | `4VKUYLBM_E096` | `motivates` | 09-Problem Scenario | data distribution discrepancy(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Hierarchical structure |  |
| 7 | `4VKUYLBM_E097` | `motivates` | 09-Problem Scenario | lack of sufficient labeled data(Small Fault Samples) |  | 17-Core Classifier Algorithm | Classifier |  |
| 8 | `4VKUYLBM_E098` | `motivates` | 09-Problem Scenario | data distribution discrepancy(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Classifier |  |
| 9 | `4VKUYLBM_E099` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Hierarchical structure |  |
| 10 | `4VKUYLBM_E100` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Classifier |  |
| 11 | `4VKUYLBM_E101` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Classifier |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4VKUYLBM_E091`：lack of sufficient labeled data(Small Fault Samples) motivates Hierarchical Deep Domain Adaptation
  - `4VKUYLBM_E092`：data distribution discrepancy(Distribution Discrepancy) motivates Hierarchical Deep Domain Adaptation
  - `4VKUYLBM_E095`：lack of sufficient labeled data(Small Fault Samples) motivates Hierarchical structure
  - `4VKUYLBM_E096`：data distribution discrepancy(Distribution Discrepancy) motivates Hierarchical structure
  - `4VKUYLBM_E097`：lack of sufficient labeled data(Small Fault Samples) motivates Classifier
  - `4VKUYLBM_E098`：data distribution discrepancy(Distribution Discrepancy) motivates Classifier
