...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `FQZR7ZH2_E100` | `motivates` | 09-Problem Scenario | uncertainty affecting predictions(Uncertainty) |  | 19-Training Optimization Algorithm | Ensemble |  |
| 2 | `FQZR7ZH2_E101` | `motivates` | 09-Problem Scenario | distinguishing anomalies from regular shadings and ageing(Other) |  | 19-Training Optimization Algorithm | Ensemble |  |
| 3 | `FQZR7ZH2_E102` | `motivates` | 12-Training Data Availability | 307 days were available for the whole year 2017, 269 healthy days(Sufficient) |  | 19-Training Optimization Algorithm | Ensemble |  |
| 4 | `FQZR7ZH2_E103` | `motivates` | 13-Noise Level | measurement noise or offsets(Normal) |  | 16-Feature Extraction Algorithm | CSRM |  |
| 5 | `FQZR7ZH2_E104` | `motivates` | 09-Problem Scenario | uncertainty affecting predictions(Uncertainty) |  | 16-Feature Extraction Algorithm | CSRM |  |
| 6 | `FQZR7ZH2_E105` | `motivates` | 09-Problem Scenario | distinguishing anomalies from regular shadings and ageing(Other) |  | 16-Feature Extraction Algorithm | CSRM |  |
| 7 | `FQZR7ZH2_E106` | `motivates` | 09-Problem Scenario | uncertainty affecting predictions(Uncertainty) |  | 17-Core Classifier Algorithm | PHANN |  |
| 8 | `FQZR7ZH2_E107` | `motivates` | 09-Problem Scenario | distinguishing anomalies from regular shadings and ageing(Other) |  | 17-Core Classifier Algorithm | PHANN |  |
| 9 | `FQZR7ZH2_E108` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CSRM |  |
| 10 | `FQZR7ZH2_E109` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | PHANN |  |
| 11 | `FQZR7ZH2_E110` | `motivates` | 06-Fault Severity | soft fault, hard fault(Multiple Severities) |  | 17-Core Classifier Algorithm | PHANN |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `FQZR7ZH2_E100`：uncertainty affecting predictions(Uncertainty) motivates Ensemble
  - `FQZR7ZH2_E101`：distinguishing anomalies from regular shadings and ageing(Other) motivates Ensemble
  - `FQZR7ZH2_E104`：uncertainty affecting predictions(Uncertainty) motivates CSRM
  - `FQZR7ZH2_E105`：distinguishing anomalies from regular shadings and ageing(Other) motivates CSRM
  - `FQZR7ZH2_E106`：uncertainty affecting predictions(Uncertainty) motivates PHANN
  - `FQZR7ZH2_E107`：distinguishing anomalies from regular shadings and ageing(Other) motivates PHANN
