...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PZ3L2822_E147` | `motivates` | 13-Noise Level | heavy background noise(High Noise) |  | 15-Data Preprocessing Algorithm | SFFT |  |
| 2 | `PZ3L2822_E148` | `motivates` | 13-Noise Level | heavy background noise(High Noise) |  | 16-Feature Extraction Algorithm | LTSA |  |
| 3 | `PZ3L2822_E149` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | SFFT |  |
| 4 | `PZ3L2822_E150` | `motivates` | 09-Problem Scenario | early degradation stage(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | SFFT |  |
| 5 | `PZ3L2822_E151` | `motivates` | 09-Problem Scenario | high computational cost for online diagnosis(Other) |  | 15-Data Preprocessing Algorithm | SFFT |  |
| 6 | `PZ3L2822_E152` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 16-Feature Extraction Algorithm | LTSA |  |
| 7 | `PZ3L2822_E153` | `motivates` | 09-Problem Scenario | early degradation stage(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | LTSA |  |
| 8 | `PZ3L2822_E154` | `motivates` | 09-Problem Scenario | high computational cost for online diagnosis(Other) |  | 16-Feature Extraction Algorithm | LTSA |  |
| 9 | `PZ3L2822_E155` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 17-Core Classifier Algorithm | PSR synthesis |  |
| 10 | `PZ3L2822_E156` | `motivates` | 09-Problem Scenario | early degradation stage(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | PSR synthesis |  |
| 11 | `PZ3L2822_E157` | `motivates` | 09-Problem Scenario | high computational cost for online diagnosis(Other) |  | 17-Core Classifier Algorithm | PSR synthesis |  |
| 12 | `PZ3L2822_E158` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | LTSA |  |
| 13 | `PZ3L2822_E159` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | PSR synthesis |  |
| 14 | `PZ3L2822_E160` | `motivates` | 06-Fault Severity | 0.2 mm width, run-to-failure degradation(Multiple Severities) |  | 17-Core Classifier Algorithm | PSR synthesis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `PZ3L2822_E149`：noise interference(Uncertainty) motivates SFFT
  - `PZ3L2822_E150`：early degradation stage(Early Degradation Prediction) motivates SFFT
  - `PZ3L2822_E151`：high computational cost for online diagnosis(Other) motivates SFFT
  - `PZ3L2822_E152`：noise interference(Uncertainty) motivates LTSA
  - `PZ3L2822_E153`：early degradation stage(Early Degradation Prediction) motivates LTSA
  - `PZ3L2822_E154`：high computational cost for online diagnosis(Other) motivates LTSA
  - `PZ3L2822_E155`：noise interference(Uncertainty) motivates PSR synthesis
  - `PZ3L2822_E156`：early degradation stage(Early Degradation Prediction) motivates PSR synthesis
  - `PZ3L2822_E157`：high computational cost for online diagnosis(Other) motivates PSR synthesis
