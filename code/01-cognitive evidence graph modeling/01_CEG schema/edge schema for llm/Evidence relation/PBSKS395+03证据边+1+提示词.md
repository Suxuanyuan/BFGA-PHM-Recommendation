...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PBSKS395_E122` | `motivates` | 09-Problem Scenario | low SNR / submerged in strong noise(Uncertainty) |  | 19-Training Optimization Algorithm | Trust-region reflective least square algorithm |  |
| 2 | `PBSKS395_E123` | `motivates` | 09-Problem Scenario | combination of misalignment and broken-tooth fault(Compound Faults) |  | 19-Training Optimization Algorithm | Trust-region reflective least square algorithm |  |
| 3 | `PBSKS395_E124` | `motivates` | 09-Problem Scenario | accurate separation of AM and PM signals(Other) |  | 19-Training Optimization Algorithm | Trust-region reflective least square algorithm |  |
| 4 | `PBSKS395_E125` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Trust-region reflective least square algorithm |  |
| 5 | `PBSKS395_E126` | `motivates` | 13-Noise Level | white Gaussian noises with different SNRs(High Noise) |  | 15-Data Preprocessing Algorithm | Band-pass filter |  |
| 6 | `PBSKS395_E127` | `motivates` | 13-Noise Level | white Gaussian noises with different SNRs(High Noise) |  | 16-Feature Extraction Algorithm | Phase demodulation based on Bessel function |  |
| 7 | `PBSKS395_E128` | `motivates` | 09-Problem Scenario | low SNR / submerged in strong noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Band-pass filter |  |
| 8 | `PBSKS395_E129` | `motivates` | 09-Problem Scenario | combination of misalignment and broken-tooth fault(Compound Faults) |  | 15-Data Preprocessing Algorithm | Band-pass filter |  |
| 9 | `PBSKS395_E130` | `motivates` | 09-Problem Scenario | accurate separation of AM and PM signals(Other) |  | 15-Data Preprocessing Algorithm | Band-pass filter |  |
| 10 | `PBSKS395_E131` | `motivates` | 09-Problem Scenario | low SNR / submerged in strong noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Phase demodulation based on Bessel function |  |
| 11 | `PBSKS395_E132` | `motivates` | 09-Problem Scenario | combination of misalignment and broken-tooth fault(Compound Faults) |  | 16-Feature Extraction Algorithm | Phase demodulation based on Bessel function |  |
| 12 | `PBSKS395_E133` | `motivates` | 09-Problem Scenario | accurate separation of AM and PM signals(Other) |  | 16-Feature Extraction Algorithm | Phase demodulation based on Bessel function |  |
| 13 | `PBSKS395_E134` | `motivates` | 09-Problem Scenario | low SNR / submerged in strong noise(Uncertainty) |  | 17-Core Classifier Algorithm | Modulation intensity analysis |  |
| 14 | `PBSKS395_E135` | `motivates` | 09-Problem Scenario | combination of misalignment and broken-tooth fault(Compound Faults) |  | 17-Core Classifier Algorithm | Modulation intensity analysis |  |
| 15 | `PBSKS395_E136` | `motivates` | 09-Problem Scenario | accurate separation of AM and PM signals(Other) |  | 17-Core Classifier Algorithm | Modulation intensity analysis |  |
| 16 | `PBSKS395_E137` | `motivates` | 07-Compound Fault | combination of misalignment and broken-tooth fault(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Phase demodulation based on Bessel function |  |
| 17 | `PBSKS395_E138` | `motivates` | 07-Compound Fault | combination of misalignment and broken-tooth fault(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Modulation intensity analysis |  |
| 18 | `PBSKS395_E139` | `motivates` | 06-Fault Severity | size of broken-tooth(Multiple Severities) |  | 17-Core Classifier Algorithm | Modulation intensity analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `PBSKS395_E122`：low SNR / submerged in strong noise(Uncertainty) motivates Trust-region reflective least square algorithm
  - `PBSKS395_E123`：combination of misalignment and broken-tooth fault(Compound Faults) motivates Trust-region reflective least square algorithm
  - `PBSKS395_E124`：accurate separation of AM and PM signals(Other) motivates Trust-region reflective least square algorithm
  - `PBSKS395_E128`：low SNR / submerged in strong noise(Uncertainty) motivates Band-pass filter
  - `PBSKS395_E129`：combination of misalignment and broken-tooth fault(Compound Faults) motivates Band-pass filter
  - `PBSKS395_E130`：accurate separation of AM and PM signals(Other) motivates Band-pass filter
  - `PBSKS395_E131`：low SNR / submerged in strong noise(Uncertainty) motivates Phase demodulation based on Bessel function
  - `PBSKS395_E132`：combination of misalignment and broken-tooth fault(Compound Faults) motivates Phase demodulation based on Bessel function
  - `PBSKS395_E133`：accurate separation of AM and PM signals(Other) motivates Phase demodulation based on Bessel function
  - `PBSKS395_E134`：low SNR / submerged in strong noise(Uncertainty) motivates Modulation intensity analysis
  - `PBSKS395_E135`：combination of misalignment and broken-tooth fault(Compound Faults) motivates Modulation intensity analysis
  - `PBSKS395_E136`：accurate separation of AM and PM signals(Other) motivates Modulation intensity analysis
