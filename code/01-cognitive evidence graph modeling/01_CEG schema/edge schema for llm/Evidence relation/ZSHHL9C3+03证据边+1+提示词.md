...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZSHHL9C3_E080` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Whitening |  |
| 2 | `ZSHHL9C3_E081` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | KICA |  |
| 3 | `ZSHHL9C3_E082` | `motivates` | 09-Problem Scenario | complex nonlinear system(Complex Systems) |  | 15-Data Preprocessing Algorithm | Whitening |  |
| 4 | `ZSHHL9C3_E083` | `motivates` | 09-Problem Scenario | multi-channel vibration signals and condition information fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Whitening |  |
| 5 | `ZSHHL9C3_E084` | `motivates` | 09-Problem Scenario | complex nonlinear system(Complex Systems) |  | 16-Feature Extraction Algorithm | KICA |  |
| 6 | `ZSHHL9C3_E085` | `motivates` | 09-Problem Scenario | multi-channel vibration signals and condition information fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | KICA |  |
| 7 | `ZSHHL9C3_E086` | `motivates` | 09-Problem Scenario | complex nonlinear system(Complex Systems) |  | 17-Core Classifier Algorithm | Hotelling's T2 |  |
| 8 | `ZSHHL9C3_E087` | `motivates` | 09-Problem Scenario | multi-channel vibration signals and condition information fusion(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | Hotelling's T2 |  |
| 9 | `ZSHHL9C3_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | KICA |  |
| 10 | `ZSHHL9C3_E089` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Hotelling's T2 |  |
| 11 | `ZSHHL9C3_E090` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Hotelling's T2 |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZSHHL9C3_E082`：complex nonlinear system(Complex Systems) motivates Whitening
  - `ZSHHL9C3_E083`：multi-channel vibration signals and condition information fusion(Multi-Source Heterogeneous / Multimodal Data) motivates Whitening
  - `ZSHHL9C3_E084`：complex nonlinear system(Complex Systems) motivates KICA
  - `ZSHHL9C3_E085`：multi-channel vibration signals and condition information fusion(Multi-Source Heterogeneous / Multimodal Data) motivates KICA
  - `ZSHHL9C3_E086`：complex nonlinear system(Complex Systems) motivates Hotelling's T2
  - `ZSHHL9C3_E087`：multi-channel vibration signals and condition information fusion(Multi-Source Heterogeneous / Multimodal Data) motivates Hotelling's T2
