...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `9IEFUYTM_E075` | `motivates` | 13-Noise Level | raw bearing vibration signal(Normal) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 2 | `9IEFUYTM_E076` | `motivates` | 13-Noise Level | raw bearing vibration signal(Normal) |  | 16-Feature Extraction Algorithm | Inception Network |  |
| 3 | `9IEFUYTM_E077` | `motivates` | 09-Problem Scenario | changing working conditions(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 4 | `9IEFUYTM_E078` | `motivates` | 09-Problem Scenario | smaller data sets(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 5 | `9IEFUYTM_E079` | `motivates` | 09-Problem Scenario | changing working conditions(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Inception Network |  |
| 6 | `9IEFUYTM_E080` | `motivates` | 09-Problem Scenario | smaller data sets(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Inception Network |  |
| 7 | `9IEFUYTM_E081` | `motivates` | 09-Problem Scenario | changing working conditions(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Capsule Network |  |
| 8 | `9IEFUYTM_E082` | `motivates` | 09-Problem Scenario | smaller data sets(Small Fault Samples) |  | 17-Core Classifier Algorithm | Capsule Network |  |
| 9 | `9IEFUYTM_E083` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Inception Network |  |
| 10 | `9IEFUYTM_E084` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Capsule Network |  |
| 11 | `9IEFUYTM_E085` | `motivates` | 06-Fault Severity | three-point, nine-point, and six-point pitting(Multiple Severities) |  | 17-Core Classifier Algorithm | Capsule Network |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `9IEFUYTM_E077`：changing working conditions(Distribution Discrepancy) motivates Min-Max Normalization
  - `9IEFUYTM_E078`：smaller data sets(Small Fault Samples) motivates Min-Max Normalization
  - `9IEFUYTM_E079`：changing working conditions(Distribution Discrepancy) motivates Inception Network
  - `9IEFUYTM_E080`：smaller data sets(Small Fault Samples) motivates Inception Network
  - `9IEFUYTM_E081`：changing working conditions(Distribution Discrepancy) motivates Capsule Network
  - `9IEFUYTM_E082`：smaller data sets(Small Fault Samples) motivates Capsule Network
