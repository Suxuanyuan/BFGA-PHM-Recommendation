...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `UIAHMDGD_E064` | `motivates` | 13-Noise Level | noise reduction, noise that may exist in the spectrum(High Noise) |  | 15-Data Preprocessing Algorithm | Moving average filter |  |
| 2 | `UIAHMDGD_E065` | `motivates` | 13-Noise Level | noise reduction, noise that may exist in the spectrum(High Noise) |  | 16-Feature Extraction Algorithm | Spectral subtraction |  |
| 3 | `UIAHMDGD_E066` | `motivates` | 09-Problem Scenario | detection of nonadjacent rotor faults(Other) |  | 15-Data Preprocessing Algorithm | Moving average filter |  |
| 4 | `UIAHMDGD_E067` | `motivates` | 09-Problem Scenario | detection of nonadjacent rotor faults(Other) |  | 16-Feature Extraction Algorithm | Spectral subtraction |  |
| 5 | `UIAHMDGD_E068` | `motivates` | 09-Problem Scenario | detection of nonadjacent rotor faults(Other) |  | 17-Core Classifier Algorithm | Pearson correlation coefficient |  |
| 6 | `UIAHMDGD_E069` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Spectral subtraction |  |
| 7 | `UIAHMDGD_E070` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Pearson correlation coefficient |  |
| 8 | `UIAHMDGD_E071` | `motivates` | 06-Fault Severity | number of broken bars(Multiple Severities) |  | 17-Core Classifier Algorithm | Pearson correlation coefficient |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `UIAHMDGD_E066`：detection of nonadjacent rotor faults(Other) motivates Moving average filter
  - `UIAHMDGD_E067`：detection of nonadjacent rotor faults(Other) motivates Spectral subtraction
  - `UIAHMDGD_E068`：detection of nonadjacent rotor faults(Other) motivates Pearson correlation coefficient
