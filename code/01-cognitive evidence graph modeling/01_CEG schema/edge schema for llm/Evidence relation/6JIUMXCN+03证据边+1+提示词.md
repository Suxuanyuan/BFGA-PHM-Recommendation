...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `6JIUMXCN_E064` | `motivates` | 09-Problem Scenario | reduce noise effect in bearing fault diagnosis systems / noise robustness(Uncertainty) |  | 19-Training Optimization Algorithm | Iterative Boolean Combination |  |
| 2 | `6JIUMXCN_E065` | `motivates` | 12-Training Data Availability | trn: 3500 positive, 3500 negative(Sufficient) |  | 18-Data Generation Algorithm | BEAring Toolbox |  |
| 3 | `6JIUMXCN_E066` | `motivates` | 12-Training Data Availability | trn: 3500 positive, 3500 negative(Sufficient) |  | 19-Training Optimization Algorithm | Iterative Boolean Combination |  |
| 4 | `6JIUMXCN_E067` | `motivates` | 09-Problem Scenario | reduce noise effect in bearing fault diagnosis systems / noise robustness(Uncertainty) |  | 18-Data Generation Algorithm | BEAring Toolbox |  |
| 5 | `6JIUMXCN_E068` | `motivates` | 09-Problem Scenario | reduce noise effect in bearing fault diagnosis systems / noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 6 | `6JIUMXCN_E069` | `motivates` | 07-Compound Fault | multiple defects occurring simultaneously(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
| 7 | `6JIUMXCN_E070` | `motivates` | 06-Fault Severity | defect diameter(Multiple Severities) |  | 17-Core Classifier Algorithm | Support Vector Machine |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `6JIUMXCN_E064`：reduce noise effect in bearing fault diagnosis systems / noise robustness(Uncertainty) motivates Iterative Boolean Combination
  - `6JIUMXCN_E067`：reduce noise effect in bearing fault diagnosis systems / noise robustness(Uncertainty) motivates BEAring Toolbox
  - `6JIUMXCN_E068`：reduce noise effect in bearing fault diagnosis systems / noise robustness(Uncertainty) motivates Support Vector Machine
...
*This prompt is automatically generated by edge_03_prompt.py (Batch 1, total 7 edges)*
