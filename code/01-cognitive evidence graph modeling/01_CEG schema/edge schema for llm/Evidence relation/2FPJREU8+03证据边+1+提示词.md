...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `2FPJREU8_E105` | `motivates` | 09-Problem Scenario | weak impact features submerged in strong noise(Uncertainty) |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 2 | `2FPJREU8_E106` | `motivates` | 09-Problem Scenario | influence of multiple impact components and parameter optimization(Other) |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 3 | `2FPJREU8_E107` | `motivates` | 12-Training Data Availability | Not explicitly mentioned(Sufficient) |  | 19-Training Optimization Algorithm | Genetic Algorithm |  |
| 4 | `2FPJREU8_E108` | `motivates` | 13-Noise Level | strong noise, heavy noise(High Noise) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 5 | `2FPJREU8_E109` | `motivates` | 13-Noise Level | strong noise, heavy noise(High Noise) |  | 16-Feature Extraction Algorithm | Cascaded Stochastic Resonance |  |
| 6 | `2FPJREU8_E110` | `motivates` | 09-Problem Scenario | weak impact features submerged in strong noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 7 | `2FPJREU8_E111` | `motivates` | 09-Problem Scenario | influence of multiple impact components and parameter optimization(Other) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 8 | `2FPJREU8_E112` | `motivates` | 09-Problem Scenario | weak impact features submerged in strong noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Cascaded Stochastic Resonance |  |
| 9 | `2FPJREU8_E113` | `motivates` | 09-Problem Scenario | influence of multiple impact components and parameter optimization(Other) |  | 16-Feature Extraction Algorithm | Cascaded Stochastic Resonance |  |
| 10 | `2FPJREU8_E114` | `motivates` | 09-Problem Scenario | weak impact features submerged in strong noise(Uncertainty) |  | 17-Core Classifier Algorithm | Rotational Period Matching |  |
| 11 | `2FPJREU8_E115` | `motivates` | 09-Problem Scenario | influence of multiple impact components and parameter optimization(Other) |  | 17-Core Classifier Algorithm | Rotational Period Matching |  |
| 12 | `2FPJREU8_E116` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Cascaded Stochastic Resonance |  |
| 13 | `2FPJREU8_E117` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Rotational Period Matching |  |
| 14 | `2FPJREU8_E118` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Rotational Period Matching |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `2FPJREU8_E105`：weak impact features submerged in strong noise(Uncertainty) motivates Genetic Algorithm
  - `2FPJREU8_E106`：influence of multiple impact components and parameter optimization(Other) motivates Genetic Algorithm
  - `2FPJREU8_E110`：weak impact features submerged in strong noise(Uncertainty) motivates Sliding Window
  - `2FPJREU8_E111`：influence of multiple impact components and parameter optimization(Other) motivates Sliding Window
  - `2FPJREU8_E112`：weak impact features submerged in strong noise(Uncertainty) motivates Cascaded Stochastic Resonance
  - `2FPJREU8_E113`：influence of multiple impact components and parameter optimization(Other) motivates Cascaded Stochastic Resonance
  - `2FPJREU8_E114`：weak impact features submerged in strong noise(Uncertainty) motivates Rotational Period Matching
  - `2FPJREU8_E115`：influence of multiple impact components and parameter optimization(Other) motivates Rotational Period Matching
