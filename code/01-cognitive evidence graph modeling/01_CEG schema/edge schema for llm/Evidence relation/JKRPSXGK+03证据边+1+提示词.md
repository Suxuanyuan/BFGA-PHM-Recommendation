...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `JKRPSXGK_E080` | `motivates` | 13-Noise Level | measurement noise and error(High Noise) |  | 15-Data Preprocessing Algorithm | Angular Integration |  |
| 2 | `JKRPSXGK_E081` | `motivates` | 13-Noise Level | measurement noise and error(High Noise) |  | 16-Feature Extraction Algorithm | Finite Element Model |  |
| 3 | `JKRPSXGK_E082` | `motivates` | 09-Problem Scenario | incipient inter-turn faults / single turn fault(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Angular Integration |  |
| 4 | `JKRPSXGK_E083` | `motivates` | 09-Problem Scenario | transient states and model inaccuracy(Uncertainty) |  | 15-Data Preprocessing Algorithm | Angular Integration |  |
| 5 | `JKRPSXGK_E084` | `motivates` | 09-Problem Scenario | incipient inter-turn faults / single turn fault(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Finite Element Model |  |
| 6 | `JKRPSXGK_E085` | `motivates` | 09-Problem Scenario | transient states and model inaccuracy(Uncertainty) |  | 16-Feature Extraction Algorithm | Finite Element Model |  |
| 7 | `JKRPSXGK_E086` | `motivates` | 09-Problem Scenario | incipient inter-turn faults / single turn fault(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Threshold Decision Logic |  |
| 8 | `JKRPSXGK_E087` | `motivates` | 09-Problem Scenario | transient states and model inaccuracy(Uncertainty) |  | 17-Core Classifier Algorithm | Threshold Decision Logic |  |
| 9 | `JKRPSXGK_E088` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Finite Element Model |  |
| 10 | `JKRPSXGK_E089` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold Decision Logic |  |
| 11 | `JKRPSXGK_E090` | `motivates` | 06-Fault Severity | single turn short-circuit(Single Severity) |  | 17-Core Classifier Algorithm | Threshold Decision Logic |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `JKRPSXGK_E082`：incipient inter-turn faults / single turn fault(Early Degradation Prediction) motivates Angular Integration
  - `JKRPSXGK_E083`：transient states and model inaccuracy(Uncertainty) motivates Angular Integration
  - `JKRPSXGK_E084`：incipient inter-turn faults / single turn fault(Early Degradation Prediction) motivates Finite Element Model
  - `JKRPSXGK_E085`：transient states and model inaccuracy(Uncertainty) motivates Finite Element Model
  - `JKRPSXGK_E086`：incipient inter-turn faults / single turn fault(Early Degradation Prediction) motivates Threshold Decision Logic
  - `JKRPSXGK_E087`：transient states and model inaccuracy(Uncertainty) motivates Threshold Decision Logic
