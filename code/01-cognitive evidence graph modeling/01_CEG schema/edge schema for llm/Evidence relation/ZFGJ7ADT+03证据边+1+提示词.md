...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZFGJ7ADT_E090` | `motivates` | 09-Problem Scenario | limited labeled samples situation(Small Fault Samples) |  | 19-Training Optimization Algorithm | Consistency Regularization |  |
| 2 | `ZFGJ7ADT_E091` | `motivates` | 09-Problem Scenario | vibration data contaminated by heavily noise(Uncertainty) |  | 19-Training Optimization Algorithm | Consistency Regularization |  |
| 3 | `ZFGJ7ADT_E092` | `motivates` | 12-Training Data Availability | limited labeled samples(Scarce) |  | 19-Training Optimization Algorithm | Consistency Regularization |  |
| 4 | `ZFGJ7ADT_E093` | `motivates` | 13-Noise Level | Gaussian white noise with SNR of -4 dB(High Noise) |  | 15-Data Preprocessing Algorithm | DAM |  |
| 5 | `ZFGJ7ADT_E094` | `motivates` | 13-Noise Level | Gaussian white noise with SNR of -4 dB(High Noise) |  | 16-Feature Extraction Algorithm | CRN |  |
| 6 | `ZFGJ7ADT_E095` | `motivates` | 09-Problem Scenario | limited labeled samples situation(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | DAM |  |
| 7 | `ZFGJ7ADT_E096` | `motivates` | 09-Problem Scenario | vibration data contaminated by heavily noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | DAM |  |
| 8 | `ZFGJ7ADT_E097` | `motivates` | 09-Problem Scenario | limited labeled samples situation(Small Fault Samples) |  | 16-Feature Extraction Algorithm | CRN |  |
| 9 | `ZFGJ7ADT_E098` | `motivates` | 09-Problem Scenario | vibration data contaminated by heavily noise(Uncertainty) |  | 16-Feature Extraction Algorithm | CRN |  |
| 10 | `ZFGJ7ADT_E099` | `motivates` | 09-Problem Scenario | limited labeled samples situation(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `ZFGJ7ADT_E100` | `motivates` | 09-Problem Scenario | vibration data contaminated by heavily noise(Uncertainty) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `ZFGJ7ADT_E101` | `motivates` | 07-Compound Fault | compound fault(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | CRN |  |
| 13 | `ZFGJ7ADT_E102` | `motivates` | 07-Compound Fault | compound fault(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `ZFGJ7ADT_E103` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZFGJ7ADT_E090`：limited labeled samples situation(Small Fault Samples) motivates Consistency Regularization
  - `ZFGJ7ADT_E091`：vibration data contaminated by heavily noise(Uncertainty) motivates Consistency Regularization
  - `ZFGJ7ADT_E095`：limited labeled samples situation(Small Fault Samples) motivates DAM
  - `ZFGJ7ADT_E096`：vibration data contaminated by heavily noise(Uncertainty) motivates DAM
  - `ZFGJ7ADT_E097`：limited labeled samples situation(Small Fault Samples) motivates CRN
  - `ZFGJ7ADT_E098`：vibration data contaminated by heavily noise(Uncertainty) motivates CRN
  - `ZFGJ7ADT_E099`：limited labeled samples situation(Small Fault Samples) motivates Softmax
  - `ZFGJ7ADT_E100`：vibration data contaminated by heavily noise(Uncertainty) motivates Softmax
