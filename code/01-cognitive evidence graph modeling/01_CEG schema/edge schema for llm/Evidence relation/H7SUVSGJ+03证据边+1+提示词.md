...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `H7SUVSGJ_E102` | `motivates` | 09-Problem Scenario | Kernel function limitation of SVM in nonlinear classification(Other) |  | 19-Training Optimization Algorithm | KMC |  |
| 2 | `H7SUVSGJ_E103` | `motivates` | 12-Training Data Availability | 48 samples for each state(Sufficient) |  | 19-Training Optimization Algorithm | KMC |  |
| 3 | `H7SUVSGJ_E104` | `motivates` | 13-Noise Level | vibration data(Normal) |  | 15-Data Preprocessing Algorithm | CWT |  |
| 4 | `H7SUVSGJ_E105` | `motivates` | 13-Noise Level | vibration data(Normal) |  | 16-Feature Extraction Algorithm | SVD |  |
| 5 | `H7SUVSGJ_E106` | `motivates` | 09-Problem Scenario | Kernel function limitation of SVM in nonlinear classification(Other) |  | 15-Data Preprocessing Algorithm | CWT |  |
| 6 | `H7SUVSGJ_E107` | `motivates` | 09-Problem Scenario | Kernel function limitation of SVM in nonlinear classification(Other) |  | 16-Feature Extraction Algorithm | SVD |  |
| 7 | `H7SUVSGJ_E108` | `motivates` | 09-Problem Scenario | Kernel function limitation of SVM in nonlinear classification(Other) |  | 17-Core Classifier Algorithm | SVM |  |
| 8 | `H7SUVSGJ_E109` | `motivates` | 07-Compound Fault | introduced separately(No Compound Fault) |  | 16-Feature Extraction Algorithm | SVD |  |
| 9 | `H7SUVSGJ_E110` | `motivates` | 07-Compound Fault | introduced separately(No Compound Fault) |  | 17-Core Classifier Algorithm | SVM |  |
| 10 | `H7SUVSGJ_E111` | `motivates` | 06-Fault Severity | 0.007, 0.014 and 0.021 inches in diameter(Multiple Severities) |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `H7SUVSGJ_E102`：Kernel function limitation of SVM in nonlinear classification(Other) motivates KMC
  - `H7SUVSGJ_E106`：Kernel function limitation of SVM in nonlinear classification(Other) motivates CWT
  - `H7SUVSGJ_E107`：Kernel function limitation of SVM in nonlinear classification(Other) motivates SVD
  - `H7SUVSGJ_E108`：Kernel function limitation of SVM in nonlinear classification(Other) motivates SVM
