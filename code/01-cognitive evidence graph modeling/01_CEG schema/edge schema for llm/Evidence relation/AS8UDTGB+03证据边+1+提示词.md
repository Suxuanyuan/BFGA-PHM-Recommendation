...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AS8UDTGB_E093` | `motivates` | 13-Noise Level | global interference (e.g. EMI)(High Noise) |  | 15-Data Preprocessing Algorithm | Data comparison |  |
| 2 | `AS8UDTGB_E094` | `motivates` | 13-Noise Level | global interference (e.g. EMI)(High Noise) |  | 16-Feature Extraction Algorithm | Context Free Grammar |  |
| 3 | `AS8UDTGB_E095` | `motivates` | 09-Problem Scenario | multiple IC faults(Compound Faults) |  | 15-Data Preprocessing Algorithm | Data comparison |  |
| 4 | `AS8UDTGB_E096` | `motivates` | 09-Problem Scenario | global interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | Data comparison |  |
| 5 | `AS8UDTGB_E097` | `motivates` | 09-Problem Scenario | network topology representation(Complex Systems) |  | 15-Data Preprocessing Algorithm | Data comparison |  |
| 6 | `AS8UDTGB_E098` | `motivates` | 09-Problem Scenario | multiple IC faults(Compound Faults) |  | 16-Feature Extraction Algorithm | Context Free Grammar |  |
| 7 | `AS8UDTGB_E099` | `motivates` | 09-Problem Scenario | global interference(Uncertainty) |  | 16-Feature Extraction Algorithm | Context Free Grammar |  |
| 8 | `AS8UDTGB_E100` | `motivates` | 09-Problem Scenario | network topology representation(Complex Systems) |  | 16-Feature Extraction Algorithm | Context Free Grammar |  |
| 9 | `AS8UDTGB_E101` | `motivates` | 09-Problem Scenario | multiple IC faults(Compound Faults) |  | 17-Core Classifier Algorithm | Concurrent Localization Algorithm |  |
| 10 | `AS8UDTGB_E102` | `motivates` | 09-Problem Scenario | global interference(Uncertainty) |  | 17-Core Classifier Algorithm | Concurrent Localization Algorithm |  |
| 11 | `AS8UDTGB_E103` | `motivates` | 09-Problem Scenario | network topology representation(Complex Systems) |  | 17-Core Classifier Algorithm | Concurrent Localization Algorithm |  |
| 12 | `AS8UDTGB_E104` | `motivates` | 07-Compound Fault | multiple IC faults(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Context Free Grammar |  |
| 13 | `AS8UDTGB_E105` | `motivates` | 07-Compound Fault | multiple IC faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | Concurrent Localization Algorithm |  |
| 14 | `AS8UDTGB_E106` | `motivates` | 06-Fault Severity | fault injection rate(Single Severity) |  | 17-Core Classifier Algorithm | Concurrent Localization Algorithm |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `AS8UDTGB_E095`：multiple IC faults(Compound Faults) motivates Data comparison
  - `AS8UDTGB_E096`：global interference(Uncertainty) motivates Data comparison
  - `AS8UDTGB_E097`：network topology representation(Complex Systems) motivates Data comparison
  - `AS8UDTGB_E098`：multiple IC faults(Compound Faults) motivates Context Free Grammar
  - `AS8UDTGB_E099`：global interference(Uncertainty) motivates Context Free Grammar
  - `AS8UDTGB_E100`：network topology representation(Complex Systems) motivates Context Free Grammar
  - `AS8UDTGB_E101`：multiple IC faults(Compound Faults) motivates Concurrent Localization Algorithm
  - `AS8UDTGB_E102`：global interference(Uncertainty) motivates Concurrent Localization Algorithm
  - `AS8UDTGB_E103`：network topology representation(Complex Systems) motivates Concurrent Localization Algorithm
