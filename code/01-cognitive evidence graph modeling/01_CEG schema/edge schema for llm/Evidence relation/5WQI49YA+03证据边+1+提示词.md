...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `5WQI49YA_E157` | `motivates` | 13-Noise Level | noisy original signal(High Noise) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 2 | `5WQI49YA_E158` | `motivates` | 13-Noise Level | noisy original signal(High Noise) |  | 16-Feature Extraction Algorithm | Wavelet Packet Decomposition |  |
| 3 | `5WQI49YA_E159` | `motivates` | 09-Problem Scenario | incipient fault diagnosis(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 4 | `5WQI49YA_E160` | `motivates` | 09-Problem Scenario | multi-sensory scenario(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Sliding Window |  |
| 5 | `5WQI49YA_E161` | `motivates` | 09-Problem Scenario | incipient fault diagnosis(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Wavelet Packet Decomposition |  |
| 6 | `5WQI49YA_E162` | `motivates` | 09-Problem Scenario | multi-sensory scenario(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | Wavelet Packet Decomposition |  |
| 7 | `5WQI49YA_E163` | `motivates` | 09-Problem Scenario | incipient fault diagnosis(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | LFGRU |  |
| 8 | `5WQI49YA_E164` | `motivates` | 09-Problem Scenario | multi-sensory scenario(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | LFGRU |  |
| 9 | `5WQI49YA_E165` | `motivates` | 07-Compound Fault | combo(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Wavelet Packet Decomposition |  |
| 10 | `5WQI49YA_E166` | `motivates` | 07-Compound Fault | combo(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | LFGRU |  |
| 11 | `5WQI49YA_E167` | `motivates` | 06-Fault Severity | flank wear, 7 mils(Multiple Severities) |  | 17-Core Classifier Algorithm | LFGRU |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `5WQI49YA_E159`：incipient fault diagnosis(Early Degradation Prediction) motivates Sliding Window
  - `5WQI49YA_E160`：multi-sensory scenario(Multi-Source Heterogeneous / Multimodal Data) motivates Sliding Window
  - `5WQI49YA_E161`：incipient fault diagnosis(Early Degradation Prediction) motivates Wavelet Packet Decomposition
  - `5WQI49YA_E162`：multi-sensory scenario(Multi-Source Heterogeneous / Multimodal Data) motivates Wavelet Packet Decomposition
  - `5WQI49YA_E163`：incipient fault diagnosis(Early Degradation Prediction) motivates LFGRU
  - `5WQI49YA_E164`：multi-sensory scenario(Multi-Source Heterogeneous / Multimodal Data) motivates LFGRU
