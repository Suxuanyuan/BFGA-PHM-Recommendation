...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `JN74PU8N_E146` | `motivates` | 09-Problem Scenario | probabilistic uncertainty and lack of prior operational data(Uncertainty) |  | 19-Training Optimization Algorithm | Bayesian Updating |  |
| 2 | `JN74PU8N_E147` | `motivates` | 09-Problem Scenario | no diagnostic method can single-handedly detect faults with high detection accuracy(Multi-Source Heterogeneous / Multimodal Data) |  | 19-Training Optimization Algorithm | Bayesian Updating |  |
| 3 | `JN74PU8N_E148` | `motivates` | 12-Training Data Availability | no prior operational data(Zero-Sample) |  | 19-Training Optimization Algorithm | Bayesian Updating |  |
| 4 | `JN74PU8N_E149` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Data Binning |  |
| 5 | `JN74PU8N_E150` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Envelope Analysis |  |
| 6 | `JN74PU8N_E151` | `motivates` | 09-Problem Scenario | probabilistic uncertainty and lack of prior operational data(Uncertainty) |  | 15-Data Preprocessing Algorithm | Data Binning |  |
| 7 | `JN74PU8N_E152` | `motivates` | 09-Problem Scenario | no diagnostic method can single-handedly detect faults with high detection accuracy(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Data Binning |  |
| 8 | `JN74PU8N_E153` | `motivates` | 09-Problem Scenario | probabilistic uncertainty and lack of prior operational data(Uncertainty) |  | 16-Feature Extraction Algorithm | Envelope Analysis |  |
| 9 | `JN74PU8N_E154` | `motivates` | 09-Problem Scenario | no diagnostic method can single-handedly detect faults with high detection accuracy(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | Envelope Analysis |  |
| 10 | `JN74PU8N_E155` | `motivates` | 09-Problem Scenario | probabilistic uncertainty and lack of prior operational data(Uncertainty) |  | 17-Core Classifier Algorithm | Bayesian Diagnostic Model |  |
| 11 | `JN74PU8N_E156` | `motivates` | 09-Problem Scenario | no diagnostic method can single-handedly detect faults with high detection accuracy(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | Bayesian Diagnostic Model |  |
| 12 | `JN74PU8N_E157` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Envelope Analysis |  |
| 13 | `JN74PU8N_E158` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Bayesian Diagnostic Model |  |
| 14 | `JN74PU8N_E159` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Bayesian Diagnostic Model |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `JN74PU8N_E146`：probabilistic uncertainty and lack of prior operational data(Uncertainty) motivates Bayesian Updating
  - `JN74PU8N_E147`：no diagnostic method can single-handedly detect faults with high detection accuracy(Multi-Source Heterogeneous / Multimodal Data) motivates Bayesian Updating
  - `JN74PU8N_E151`：probabilistic uncertainty and lack of prior operational data(Uncertainty) motivates Data Binning
  - `JN74PU8N_E152`：no diagnostic method can single-handedly detect faults with high detection accuracy(Multi-Source Heterogeneous / Multimodal Data) motivates Data Binning
  - `JN74PU8N_E153`：probabilistic uncertainty and lack of prior operational data(Uncertainty) motivates Envelope Analysis
  - `JN74PU8N_E154`：no diagnostic method can single-handedly detect faults with high detection accuracy(Multi-Source Heterogeneous / Multimodal Data) motivates Envelope Analysis
  - `JN74PU8N_E155`：probabilistic uncertainty and lack of prior operational data(Uncertainty) motivates Bayesian Diagnostic Model
  - `JN74PU8N_E156`：no diagnostic method can single-handedly detect faults with high detection accuracy(Multi-Source Heterogeneous / Multimodal Data) motivates Bayesian Diagnostic Model
