...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CZ6EC5XJ_E095` | `motivates` | 09-Problem Scenario | data sparsity, few labeled data(Small Fault Samples) |  | 19-Training Optimization Algorithm | Distance Metric Learning |  |
| 2 | `CZ6EC5XJ_E096` | `motivates` | 09-Problem Scenario | variations of machine operating conditions, domain shift(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Distance Metric Learning |  |
| 3 | `CZ6EC5XJ_E097` | `motivates` | 12-Training Data Availability | only one labeled sample in each machine health condition is used as supervised information, i.e. Nsp = 1(Scarce) |  | 19-Training Optimization Algorithm | Distance Metric Learning |  |
| 4 | `CZ6EC5XJ_E098` | `motivates` | 13-Noise Level | significant noises are observed in the collected data(High Noise) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 5 | `CZ6EC5XJ_E099` | `motivates` | 13-Noise Level | significant noises are observed in the collected data(High Noise) |  | 16-Feature Extraction Algorithm | Autoencoder |  |
| 6 | `CZ6EC5XJ_E100` | `motivates` | 09-Problem Scenario | data sparsity, few labeled data(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 7 | `CZ6EC5XJ_E101` | `motivates` | 09-Problem Scenario | variations of machine operating conditions, domain shift(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 8 | `CZ6EC5XJ_E102` | `motivates` | 09-Problem Scenario | data sparsity, few labeled data(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Autoencoder |  |
| 9 | `CZ6EC5XJ_E103` | `motivates` | 09-Problem Scenario | variations of machine operating conditions, domain shift(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Autoencoder |  |
| 10 | `CZ6EC5XJ_E104` | `motivates` | 09-Problem Scenario | data sparsity, few labeled data(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 11 | `CZ6EC5XJ_E105` | `motivates` | 09-Problem Scenario | variations of machine operating conditions, domain shift(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 12 | `CZ6EC5XJ_E106` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Autoencoder |  |
| 13 | `CZ6EC5XJ_E107` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `CZ6EC5XJ_E108` | `motivates` | 06-Fault Severity | 7, 14, 21 mils; incipient, medium, severe(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `CZ6EC5XJ_E095`：data sparsity, few labeled data(Small Fault Samples) motivates Distance Metric Learning
  - `CZ6EC5XJ_E096`：variations of machine operating conditions, domain shift(Distribution Discrepancy) motivates Distance Metric Learning
  - `CZ6EC5XJ_E100`：data sparsity, few labeled data(Small Fault Samples) motivates FFT
  - `CZ6EC5XJ_E101`：variations of machine operating conditions, domain shift(Distribution Discrepancy) motivates FFT
  - `CZ6EC5XJ_E102`：data sparsity, few labeled data(Small Fault Samples) motivates Autoencoder
  - `CZ6EC5XJ_E103`：variations of machine operating conditions, domain shift(Distribution Discrepancy) motivates Autoencoder
  - `CZ6EC5XJ_E104`：data sparsity, few labeled data(Small Fault Samples) motivates Softmax
  - `CZ6EC5XJ_E105`：variations of machine operating conditions, domain shift(Distribution Discrepancy) motivates Softmax
