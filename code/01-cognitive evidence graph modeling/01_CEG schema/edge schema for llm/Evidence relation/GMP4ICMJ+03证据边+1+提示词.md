...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `GMP4ICMJ_E060` | `motivates` | 09-Problem Scenario | fault analysis of complex multi-stage topology(Complex Systems) |  | 17-Core Classifier Algorithm | Fault Location Algorithm |  |
| 2 | `GMP4ICMJ_E061` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Fault Location Algorithm |  |
| 3 | `GMP4ICMJ_E062` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Fault Location Algorithm |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `GMP4ICMJ_E060`：fault analysis of complex multi-stage topology(Complex Systems) motivates Fault Location Algorithm
