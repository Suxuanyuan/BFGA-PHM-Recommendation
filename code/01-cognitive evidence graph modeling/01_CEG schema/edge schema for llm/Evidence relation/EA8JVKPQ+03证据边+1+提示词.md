...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `EA8JVKPQ_E078` | `motivates` | 09-Problem Scenario | computational complexity and real-time implementation(Other) |  | 17-Core Classifier Algorithm | IF-THEN rules |  |
| 2 | `EA8JVKPQ_E079` | `motivates` | 07-Compound Fault | simultaneous faults(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | IF-THEN rules |  |
| 3 | `EA8JVKPQ_E080` | `motivates` | 06-Fault Severity | twice its average value(Single Severity) |  | 17-Core Classifier Algorithm | IF-THEN rules |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `EA8JVKPQ_E078`：computational complexity and real-time implementation(Other) motivates IF-THEN rules
