...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `MEIGLL7E_E089` | `motivates` | 13-Noise Level | Gaussian white noise(High Noise) |  | 15-Data Preprocessing Algorithm | Empirical Mode Decomposition |  |
| 2 | `MEIGLL7E_E090` | `motivates` | 13-Noise Level | Gaussian white noise(High Noise) |  | 16-Feature Extraction Algorithm | Hilbert Transform |  |
| 3 | `MEIGLL7E_E091` | `motivates` | 09-Problem Scenario | time variant vibration transfer paths(Complex Systems) |  | 15-Data Preprocessing Algorithm | Empirical Mode Decomposition |  |
| 4 | `MEIGLL7E_E092` | `motivates` | 09-Problem Scenario | time variant vibration transfer paths(Complex Systems) |  | 16-Feature Extraction Algorithm | Hilbert Transform |  |
| 5 | `MEIGLL7E_E093` | `motivates` | 09-Problem Scenario | time variant vibration transfer paths(Complex Systems) |  | 17-Core Classifier Algorithm | Spectral peak matching |  |
| 6 | `MEIGLL7E_E094` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Hilbert Transform |  |
| 7 | `MEIGLL7E_E095` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Spectral peak matching |  |
| 8 | `MEIGLL7E_E096` | `motivates` | 06-Fault Severity | depth: 4.5 mm, width: 38.1 mm, thickness: 0.4 mm(Single Severity) |  | 17-Core Classifier Algorithm | Spectral peak matching |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `MEIGLL7E_E091`：time variant vibration transfer paths(Complex Systems) motivates Empirical Mode Decomposition
  - `MEIGLL7E_E092`：time variant vibration transfer paths(Complex Systems) motivates Hilbert Transform
  - `MEIGLL7E_E093`：time variant vibration transfer paths(Complex Systems) motivates Spectral peak matching
