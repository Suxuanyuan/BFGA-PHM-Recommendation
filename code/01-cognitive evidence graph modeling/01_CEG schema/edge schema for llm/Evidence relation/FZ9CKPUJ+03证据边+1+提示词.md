...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `FZ9CKPUJ_E103` | `motivates` | 09-Problem Scenario | sample class imbalance(Small Fault Samples) |  | 19-Training Optimization Algorithm | Enhanced Transfer Joint Matching |  |
| 2 | `FZ9CKPUJ_E104` | `motivates` | 09-Problem Scenario | unsupervised domain adaptation / cross-domain distributions(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Enhanced Transfer Joint Matching |  |
| 3 | `FZ9CKPUJ_E105` | `motivates` | 12-Training Data Availability | sample class imbalance, the sample number is small(Scarce) |  | 19-Training Optimization Algorithm | Enhanced Transfer Joint Matching |  |
| 4 | `FZ9CKPUJ_E106` | `motivates` | 13-Noise Level | under strong noise needs further research and verification(Normal) |  | 15-Data Preprocessing Algorithm | Row L2-norm |  |
| 5 | `FZ9CKPUJ_E107` | `motivates` | 13-Noise Level | under strong noise needs further research and verification(Normal) |  | 16-Feature Extraction Algorithm | Kernel Principal Component Analysis |  |
| 6 | `FZ9CKPUJ_E108` | `motivates` | 09-Problem Scenario | sample class imbalance(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Row L2-norm |  |
| 7 | `FZ9CKPUJ_E109` | `motivates` | 09-Problem Scenario | unsupervised domain adaptation / cross-domain distributions(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Row L2-norm |  |
| 8 | `FZ9CKPUJ_E110` | `motivates` | 09-Problem Scenario | sample class imbalance(Small Fault Samples) |  | 16-Feature Extraction Algorithm | Kernel Principal Component Analysis |  |
| 9 | `FZ9CKPUJ_E111` | `motivates` | 09-Problem Scenario | unsupervised domain adaptation / cross-domain distributions(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | Kernel Principal Component Analysis |  |
| 10 | `FZ9CKPUJ_E112` | `motivates` | 09-Problem Scenario | sample class imbalance(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax Regression |  |
| 11 | `FZ9CKPUJ_E113` | `motivates` | 09-Problem Scenario | unsupervised domain adaptation / cross-domain distributions(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax Regression |  |
| 12 | `FZ9CKPUJ_E114` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Kernel Principal Component Analysis |  |
| 13 | `FZ9CKPUJ_E115` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax Regression |  |
| 14 | `FZ9CKPUJ_E116` | `motivates` | 06-Fault Severity | 0.18, 0.36, 0.54 mm(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax Regression |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `FZ9CKPUJ_E103`：sample class imbalance(Small Fault Samples) motivates Enhanced Transfer Joint Matching
  - `FZ9CKPUJ_E104`：unsupervised domain adaptation / cross-domain distributions(Distribution Discrepancy) motivates Enhanced Transfer Joint Matching
  - `FZ9CKPUJ_E108`：sample class imbalance(Small Fault Samples) motivates Row L2-norm
  - `FZ9CKPUJ_E109`：unsupervised domain adaptation / cross-domain distributions(Distribution Discrepancy) motivates Row L2-norm
  - `FZ9CKPUJ_E110`：sample class imbalance(Small Fault Samples) motivates Kernel Principal Component Analysis
  - `FZ9CKPUJ_E111`：unsupervised domain adaptation / cross-domain distributions(Distribution Discrepancy) motivates Kernel Principal Component Analysis
  - `FZ9CKPUJ_E112`：sample class imbalance(Small Fault Samples) motivates Softmax Regression
  - `FZ9CKPUJ_E113`：unsupervised domain adaptation / cross-domain distributions(Distribution Discrepancy) motivates Softmax Regression
