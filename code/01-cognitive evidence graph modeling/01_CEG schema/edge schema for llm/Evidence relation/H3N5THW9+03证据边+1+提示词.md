...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `H3N5THW9_E116` | `motivates` | 09-Problem Scenario | data island problem and data privacy(Other) |  | 19-Training Optimization Algorithm | Federated Averaging |  |
| 2 | `H3N5THW9_E117` | `motivates` | 09-Problem Scenario | limited training data and data sparsity(Small Fault Samples) |  | 19-Training Optimization Algorithm | Federated Averaging |  |
| 3 | `H3N5THW9_E118` | `motivates` | 09-Problem Scenario | distribution discrepancy / Non-IID-Domain(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Federated Averaging |  |
| 4 | `H3N5THW9_E119` | `motivates` | 12-Training Data Availability | nsample(Sufficient) |  | 19-Training Optimization Algorithm | Federated Averaging |  |
| 5 | `H3N5THW9_E120` | `motivates` | 13-Noise Level | significant noises(High Noise) |  | 15-Data Preprocessing Algorithm | Data translation |  |
| 6 | `H3N5THW9_E121` | `motivates` | 13-Noise Level | significant noises(High Noise) |  | 16-Feature Extraction Algorithm | CNN |  |
| 7 | `H3N5THW9_E122` | `motivates` | 09-Problem Scenario | data island problem and data privacy(Other) |  | 15-Data Preprocessing Algorithm | Data translation |  |
| 8 | `H3N5THW9_E123` | `motivates` | 09-Problem Scenario | limited training data and data sparsity(Small Fault Samples) |  | 15-Data Preprocessing Algorithm | Data translation |  |
| 9 | `H3N5THW9_E124` | `motivates` | 09-Problem Scenario | distribution discrepancy / Non-IID-Domain(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | Data translation |  |
| 10 | `H3N5THW9_E125` | `motivates` | 09-Problem Scenario | data island problem and data privacy(Other) |  | 16-Feature Extraction Algorithm | CNN |  |
| 11 | `H3N5THW9_E126` | `motivates` | 09-Problem Scenario | limited training data and data sparsity(Small Fault Samples) |  | 16-Feature Extraction Algorithm | CNN |  |
| 12 | `H3N5THW9_E127` | `motivates` | 09-Problem Scenario | distribution discrepancy / Non-IID-Domain(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | CNN |  |
| 13 | `H3N5THW9_E128` | `motivates` | 09-Problem Scenario | data island problem and data privacy(Other) |  | 17-Core Classifier Algorithm | Softmax |  |
| 14 | `H3N5THW9_E129` | `motivates` | 09-Problem Scenario | limited training data and data sparsity(Small Fault Samples) |  | 17-Core Classifier Algorithm | Softmax |  |
| 15 | `H3N5THW9_E130` | `motivates` | 09-Problem Scenario | distribution discrepancy / Non-IID-Domain(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 16 | `H3N5THW9_E131` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 17 | `H3N5THW9_E132` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 18 | `H3N5THW9_E133` | `motivates` | 06-Fault Severity | 7 mils, 14 mils, 21 mils, incipient, medium, severe(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `H3N5THW9_E116`：data island problem and data privacy(Other) motivates Federated Averaging
  - `H3N5THW9_E117`：limited training data and data sparsity(Small Fault Samples) motivates Federated Averaging
  - `H3N5THW9_E118`：distribution discrepancy / Non-IID-Domain(Distribution Discrepancy) motivates Federated Averaging
  - `H3N5THW9_E122`：data island problem and data privacy(Other) motivates Data translation
  - `H3N5THW9_E123`：limited training data and data sparsity(Small Fault Samples) motivates Data translation
  - `H3N5THW9_E124`：distribution discrepancy / Non-IID-Domain(Distribution Discrepancy) motivates Data translation
  - `H3N5THW9_E125`：data island problem and data privacy(Other) motivates CNN
  - `H3N5THW9_E126`：limited training data and data sparsity(Small Fault Samples) motivates CNN
  - `H3N5THW9_E127`：distribution discrepancy / Non-IID-Domain(Distribution Discrepancy) motivates CNN
  - `H3N5THW9_E128`：data island problem and data privacy(Other) motivates Softmax
  - `H3N5THW9_E129`：limited training data and data sparsity(Small Fault Samples) motivates Softmax
  - `H3N5THW9_E130`：distribution discrepancy / Non-IID-Domain(Distribution Discrepancy) motivates Softmax
