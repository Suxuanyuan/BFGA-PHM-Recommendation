...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `9GFHNCIU_E064` | `motivates` | 13-Noise Level | noise of the battery data(High Noise) |  | 15-Data Preprocessing Algorithm | Lebesgue Sampling |  |
| 2 | `9GFHNCIU_E065` | `motivates` | 09-Problem Scenario | Limited computational resources for FDP deployment on embedded systems(Other) |  | 15-Data Preprocessing Algorithm | Lebesgue Sampling |  |
| 3 | `9GFHNCIU_E066` | `motivates` | 09-Problem Scenario | Uncertainty accumulation in long-term prognosis(Uncertainty) |  | 15-Data Preprocessing Algorithm | Lebesgue Sampling |  |
| 4 | `9GFHNCIU_E067` | `motivates` | 09-Problem Scenario | Limited computational resources for FDP deployment on embedded systems(Other) |  | 17-Core Classifier Algorithm | Particle Filter |  |
| 5 | `9GFHNCIU_E068` | `motivates` | 09-Problem Scenario | Uncertainty accumulation in long-term prognosis(Uncertainty) |  | 17-Core Classifier Algorithm | Particle Filter |  |
| 6 | `9GFHNCIU_E069` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Particle Filter |  |
| 7 | `9GFHNCIU_E070` | `motivates` | 06-Fault Severity | capacity degradation from 1.1Ah to 0.25Ah(Multiple Severities) |  | 17-Core Classifier Algorithm | Particle Filter |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `9GFHNCIU_E065`：Limited computational resources for FDP deployment on embedded systems(Other) motivates Lebesgue Sampling
  - `9GFHNCIU_E066`：Uncertainty accumulation in long-term prognosis(Uncertainty) motivates Lebesgue Sampling
  - `9GFHNCIU_E067`：Limited computational resources for FDP deployment on embedded systems(Other) motivates Particle Filter
  - `9GFHNCIU_E068`：Uncertainty accumulation in long-term prognosis(Uncertainty) motivates Particle Filter
