...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XEMFRB8R_E124` | `motivates` | 13-Noise Level | noise component, noise level, white Gaussian noise(High Noise) |  | 15-Data Preprocessing Algorithm | Oblique Projection |  |
| 2 | `XEMFRB8R_E125` | `motivates` | 13-Noise Level | noise component, noise level, white Gaussian noise(High Noise) |  | 16-Feature Extraction Algorithm | Maximum Likelihood Estimator |  |
| 3 | `XEMFRB8R_E126` | `motivates` | 09-Problem Scenario | interference from supply fundamental frequency and noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | Oblique Projection |  |
| 4 | `XEMFRB8R_E127` | `motivates` | 09-Problem Scenario | limitation of manual threshold setting and dependency on large training database(Other) |  | 15-Data Preprocessing Algorithm | Oblique Projection |  |
| 5 | `XEMFRB8R_E128` | `motivates` | 09-Problem Scenario | interference from supply fundamental frequency and noise(Uncertainty) |  | 16-Feature Extraction Algorithm | Maximum Likelihood Estimator |  |
| 6 | `XEMFRB8R_E129` | `motivates` | 09-Problem Scenario | limitation of manual threshold setting and dependency on large training database(Other) |  | 16-Feature Extraction Algorithm | Maximum Likelihood Estimator |  |
| 7 | `XEMFRB8R_E130` | `motivates` | 09-Problem Scenario | interference from supply fundamental frequency and noise(Uncertainty) |  | 17-Core Classifier Algorithm | Matched Subspace Detector |  |
| 8 | `XEMFRB8R_E131` | `motivates` | 09-Problem Scenario | limitation of manual threshold setting and dependency on large training database(Other) |  | 17-Core Classifier Algorithm | Matched Subspace Detector |  |
| 9 | `XEMFRB8R_E132` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Maximum Likelihood Estimator |  |
| 10 | `XEMFRB8R_E133` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Matched Subspace Detector |  |
| 11 | `XEMFRB8R_E134` | `motivates` | 06-Fault Severity | inner raceway hole diameters: 0.178 mm to 1.016 mm; one and two broken rotor bars(Multiple Severities) |  | 17-Core Classifier Algorithm | Matched Subspace Detector |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `XEMFRB8R_E126`：interference from supply fundamental frequency and noise(Uncertainty) motivates Oblique Projection
  - `XEMFRB8R_E127`：limitation of manual threshold setting and dependency on large training database(Other) motivates Oblique Projection
  - `XEMFRB8R_E128`：interference from supply fundamental frequency and noise(Uncertainty) motivates Maximum Likelihood Estimator
  - `XEMFRB8R_E129`：limitation of manual threshold setting and dependency on large training database(Other) motivates Maximum Likelihood Estimator
  - `XEMFRB8R_E130`：interference from supply fundamental frequency and noise(Uncertainty) motivates Matched Subspace Detector
  - `XEMFRB8R_E131`：limitation of manual threshold setting and dependency on large training database(Other) motivates Matched Subspace Detector
