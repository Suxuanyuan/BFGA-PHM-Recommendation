...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TJ99CE8U_E092` | `motivates` | 13-Noise Level | Not mentioned(Normal) |  | 16-Feature Extraction Algorithm | Descriptive Statistics |  |
| 2 | `TJ99CE8U_E093` | `motivates` | 09-Problem Scenario | combined shaft and ball bearing fault(Compound Faults) |  | 16-Feature Extraction Algorithm | Descriptive Statistics |  |
| 3 | `TJ99CE8U_E094` | `motivates` | 09-Problem Scenario | complex signals including real, symbolic, missing value attributes(Other) |  | 16-Feature Extraction Algorithm | Descriptive Statistics |  |
| 4 | `TJ99CE8U_E095` | `motivates` | 09-Problem Scenario | combined shaft and ball bearing fault(Compound Faults) |  | 17-Core Classifier Algorithm | k-star |  |
| 5 | `TJ99CE8U_E096` | `motivates` | 09-Problem Scenario | complex signals including real, symbolic, missing value attributes(Other) |  | 17-Core Classifier Algorithm | k-star |  |
| 6 | `TJ99CE8U_E097` | `motivates` | 07-Compound Fault | combined shaft and ball bearing fault(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Descriptive Statistics |  |
| 7 | `TJ99CE8U_E098` | `motivates` | 07-Compound Fault | combined shaft and ball bearing fault(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | k-star |  |
| 8 | `TJ99CE8U_E099` | `motivates` | 06-Fault Severity | outer ring thickness 4.0mm, inner ring thickness 2.0mm, shaft diameter 9.8mm(Single Severity) |  | 17-Core Classifier Algorithm | k-star |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `TJ99CE8U_E093`：combined shaft and ball bearing fault(Compound Faults) motivates Descriptive Statistics
  - `TJ99CE8U_E094`：complex signals including real, symbolic, missing value attributes(Other) motivates Descriptive Statistics
  - `TJ99CE8U_E095`：combined shaft and ball bearing fault(Compound Faults) motivates k-star
  - `TJ99CE8U_E096`：complex signals including real, symbolic, missing value attributes(Other) motivates k-star
