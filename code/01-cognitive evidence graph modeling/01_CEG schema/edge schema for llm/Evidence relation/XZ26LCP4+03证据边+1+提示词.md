...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XZ26LCP4_E091` | `motivates` | 13-Noise Level | strong background noise / heavy background noise(High Noise) |  | 15-Data Preprocessing Algorithm | Sparse Code Shrinkage |  |
| 2 | `XZ26LCP4_E092` | `motivates` | 13-Noise Level | strong background noise / heavy background noise(High Noise) |  | 16-Feature Extraction Algorithm | Fast Spectral Correlation |  |
| 3 | `XZ26LCP4_E093` | `motivates` | 09-Problem Scenario | strong background noise / noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | Sparse Code Shrinkage |  |
| 4 | `XZ26LCP4_E094` | `motivates` | 09-Problem Scenario | incipient faults of bearing(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Sparse Code Shrinkage |  |
| 5 | `XZ26LCP4_E095` | `motivates` | 09-Problem Scenario | strong background noise / noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Fast Spectral Correlation |  |
| 6 | `XZ26LCP4_E096` | `motivates` | 09-Problem Scenario | incipient faults of bearing(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Fast Spectral Correlation |  |
| 7 | `XZ26LCP4_E097` | `motivates` | 09-Problem Scenario | strong background noise / noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | Squared Enhanced Envelope Spectrum |  |
| 8 | `XZ26LCP4_E098` | `motivates` | 09-Problem Scenario | incipient faults of bearing(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Squared Enhanced Envelope Spectrum |  |
| 9 | `XZ26LCP4_E099` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Fast Spectral Correlation |  |
| 10 | `XZ26LCP4_E100` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Squared Enhanced Envelope Spectrum |  |
| 11 | `XZ26LCP4_E101` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Squared Enhanced Envelope Spectrum |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `XZ26LCP4_E093`：strong background noise / noise robustness(Uncertainty) motivates Sparse Code Shrinkage
  - `XZ26LCP4_E094`：incipient faults of bearing(Early Degradation Prediction) motivates Sparse Code Shrinkage
  - `XZ26LCP4_E095`：strong background noise / noise robustness(Uncertainty) motivates Fast Spectral Correlation
  - `XZ26LCP4_E096`：incipient faults of bearing(Early Degradation Prediction) motivates Fast Spectral Correlation
  - `XZ26LCP4_E097`：strong background noise / noise robustness(Uncertainty) motivates Squared Enhanced Envelope Spectrum
  - `XZ26LCP4_E098`：incipient faults of bearing(Early Degradation Prediction) motivates Squared Enhanced Envelope Spectrum
