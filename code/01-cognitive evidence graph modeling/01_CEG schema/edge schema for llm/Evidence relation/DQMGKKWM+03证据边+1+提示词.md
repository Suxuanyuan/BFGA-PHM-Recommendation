...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DQMGKKWM_E075` | `motivates` | 13-Noise Level | harsh, noisy industrial environment(High Noise) |  | 15-Data Preprocessing Algorithm | Rectification |  |
| 2 | `DQMGKKWM_E076` | `motivates` | 13-Noise Level | harsh, noisy industrial environment(High Noise) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 3 | `DQMGKKWM_E077` | `motivates` | 09-Problem Scenario | detection of fault harmonics that are very close to the fundamental component is challenging(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Rectification |  |
| 4 | `DQMGKKWM_E078` | `motivates` | 09-Problem Scenario | limited computing power and storage of low-cost devices impose severe constraints on the choice of the diagnostic methods(Other) |  | 15-Data Preprocessing Algorithm | Rectification |  |
| 5 | `DQMGKKWM_E079` | `motivates` | 09-Problem Scenario | detection of fault harmonics that are very close to the fundamental component is challenging(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 6 | `DQMGKKWM_E080` | `motivates` | 09-Problem Scenario | limited computing power and storage of low-cost devices impose severe constraints on the choice of the diagnostic methods(Other) |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 7 | `DQMGKKWM_E081` | `motivates` | 09-Problem Scenario | detection of fault harmonics that are very close to the fundamental component is challenging(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Threshold Comparison |  |
| 8 | `DQMGKKWM_E082` | `motivates` | 09-Problem Scenario | limited computing power and storage of low-cost devices impose severe constraints on the choice of the diagnostic methods(Other) |  | 17-Core Classifier Algorithm | Threshold Comparison |  |
| 9 | `DQMGKKWM_E083` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Fast Fourier Transform |  |
| 10 | `DQMGKKWM_E084` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold Comparison |  |
| 11 | `DQMGKKWM_E085` | `motivates` | 06-Fault Severity | one broken bar(Single Severity) |  | 17-Core Classifier Algorithm | Threshold Comparison |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `DQMGKKWM_E077`：detection of fault harmonics that are very close to the fundamental component is challenging(Early Degradation Prediction) motivates Rectification
  - `DQMGKKWM_E078`：limited computing power and storage of low-cost devices impose severe constraints on the choice of the diagnostic methods(Other) motivates Rectification
  - `DQMGKKWM_E079`：detection of fault harmonics that are very close to the fundamental component is challenging(Early Degradation Prediction) motivates Fast Fourier Transform
  - `DQMGKKWM_E080`：limited computing power and storage of low-cost devices impose severe constraints on the choice of the diagnostic methods(Other) motivates Fast Fourier Transform
  - `DQMGKKWM_E081`：detection of fault harmonics that are very close to the fundamental component is challenging(Early Degradation Prediction) motivates Threshold Comparison
  - `DQMGKKWM_E082`：limited computing power and storage of low-cost devices impose severe constraints on the choice of the diagnostic methods(Other) motivates Threshold Comparison
