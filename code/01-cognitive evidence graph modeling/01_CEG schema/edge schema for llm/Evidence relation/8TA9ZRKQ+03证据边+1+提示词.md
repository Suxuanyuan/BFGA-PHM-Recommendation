...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `8TA9ZRKQ_E184` | `motivates` | 09-Problem Scenario | outliers in training datasets(Uncertainty) |  | 19-Training Optimization Algorithm | MPRM |  |
| 2 | `8TA9ZRKQ_E185` | `motivates` | 12-Training Data Availability | one half of IDV(0) samples(Sufficient) |  | 19-Training Optimization Algorithm | MPRM |  |
| 3 | `8TA9ZRKQ_E186` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | tSL-Center |  |
| 4 | `8TA9ZRKQ_E187` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | SVD |  |
| 5 | `8TA9ZRKQ_E188` | `motivates` | 09-Problem Scenario | outliers in training datasets(Uncertainty) |  | 15-Data Preprocessing Algorithm | tSL-Center |  |
| 6 | `8TA9ZRKQ_E189` | `motivates` | 09-Problem Scenario | outliers in training datasets(Uncertainty) |  | 16-Feature Extraction Algorithm | SVD |  |
| 7 | `8TA9ZRKQ_E190` | `motivates` | 09-Problem Scenario | outliers in training datasets(Uncertainty) |  | 17-Core Classifier Algorithm | Hotelling's T2 |  |
| 8 | `8TA9ZRKQ_E191` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | SVD |  |
| 9 | `8TA9ZRKQ_E192` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Hotelling's T2 |  |
| 10 | `8TA9ZRKQ_E193` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Hotelling's T2 |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `8TA9ZRKQ_E184`：outliers in training datasets(Uncertainty) motivates MPRM
  - `8TA9ZRKQ_E188`：outliers in training datasets(Uncertainty) motivates tSL-Center
  - `8TA9ZRKQ_E189`：outliers in training datasets(Uncertainty) motivates SVD
  - `8TA9ZRKQ_E190`：outliers in training datasets(Uncertainty) motivates Hotelling's T2
