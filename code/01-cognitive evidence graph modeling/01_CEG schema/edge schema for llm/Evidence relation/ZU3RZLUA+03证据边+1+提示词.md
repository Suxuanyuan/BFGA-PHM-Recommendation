...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZU3RZLUA_E055` | `motivates` | 13-Noise Level | noise variance(High Noise) |  | 16-Feature Extraction Algorithm | Differential Feature |  |
| 2 | `ZU3RZLUA_E056` | `motivates` | 09-Problem Scenario | dynamic fault with zero cross points (ZCPs)(Other) |  | 16-Feature Extraction Algorithm | Differential Feature |  |
| 3 | `ZU3RZLUA_E057` | `motivates` | 09-Problem Scenario | dynamic fault with zero cross points (ZCPs)(Other) |  | 17-Core Classifier Algorithm | Hierarchical PCA |  |
| 4 | `ZU3RZLUA_E058` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Differential Feature |  |
| 5 | `ZU3RZLUA_E059` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Hierarchical PCA |  |
| 6 | `ZU3RZLUA_E060` | `motivates` | 06-Fault Severity | fault amplitude, variance increasing(Multiple Severities) |  | 17-Core Classifier Algorithm | Hierarchical PCA |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `ZU3RZLUA_E056`：dynamic fault with zero cross points (ZCPs)(Other) motivates Differential Feature
  - `ZU3RZLUA_E057`：dynamic fault with zero cross points (ZCPs)(Other) motivates Hierarchical PCA
