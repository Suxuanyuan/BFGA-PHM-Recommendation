...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `98IJBDA5_E060` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | Linear regression |  |
| 2 | `98IJBDA5_E061` | `motivates` | 09-Problem Scenario | parameter uncertainties(Uncertainty) |  | 15-Data Preprocessing Algorithm | Linear regression |  |
| 3 | `98IJBDA5_E062` | `motivates` | 09-Problem Scenario | data inconsistency and geographic boundaries(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Linear regression |  |
| 4 | `98IJBDA5_E063` | `motivates` | 09-Problem Scenario | parameter uncertainties(Uncertainty) |  | 17-Core Classifier Algorithm | Bottom-up stock accounting |  |
| 5 | `98IJBDA5_E064` | `motivates` | 09-Problem Scenario | data inconsistency and geographic boundaries(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | Bottom-up stock accounting |  |
| 6 | `98IJBDA5_E065` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Bottom-up stock accounting |  |
| 7 | `98IJBDA5_E066` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Bottom-up stock accounting |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `98IJBDA5_E061`：parameter uncertainties(Uncertainty) motivates Linear regression
  - `98IJBDA5_E062`：data inconsistency and geographic boundaries(Multi-Source Heterogeneous / Multimodal Data) motivates Linear regression
  - `98IJBDA5_E063`：parameter uncertainties(Uncertainty) motivates Bottom-up stock accounting
  - `98IJBDA5_E064`：data inconsistency and geographic boundaries(Multi-Source Heterogeneous / Multimodal Data) motivates Bottom-up stock accounting
