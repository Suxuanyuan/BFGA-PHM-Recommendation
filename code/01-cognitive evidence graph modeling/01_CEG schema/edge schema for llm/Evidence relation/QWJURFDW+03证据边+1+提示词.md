...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QWJURFDW_E104` | `motivates` | 13-Noise Level | noise(High Noise) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 2 | `QWJURFDW_E105` | `motivates` | 13-Noise Level | noise(High Noise) |  | 16-Feature Extraction Algorithm | Matching Demodulation Transform |  |
| 3 | `QWJURFDW_E106` | `motivates` | 09-Problem Scenario | highly oscillatory frequency modulation (FM) feature / nonstationary signals(Other) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 4 | `QWJURFDW_E107` | `motivates` | 09-Problem Scenario | noise / model uncertainty(Uncertainty) |  | 15-Data Preprocessing Algorithm | Hilbert transform |  |
| 5 | `QWJURFDW_E108` | `motivates` | 09-Problem Scenario | highly oscillatory frequency modulation (FM) feature / nonstationary signals(Other) |  | 16-Feature Extraction Algorithm | Matching Demodulation Transform |  |
| 6 | `QWJURFDW_E109` | `motivates` | 09-Problem Scenario | noise / model uncertainty(Uncertainty) |  | 16-Feature Extraction Algorithm | Matching Demodulation Transform |  |
| 7 | `QWJURFDW_E110` | `motivates` | 09-Problem Scenario | highly oscillatory frequency modulation (FM) feature / nonstationary signals(Other) |  | 17-Core Classifier Algorithm | Envelope spectrum analysis |  |
| 8 | `QWJURFDW_E111` | `motivates` | 09-Problem Scenario | noise / model uncertainty(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope spectrum analysis |  |
| 9 | `QWJURFDW_E112` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Matching Demodulation Transform |  |
| 10 | `QWJURFDW_E113` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope spectrum analysis |  |
| 11 | `QWJURFDW_E114` | `motivates` | 06-Fault Severity | small rubbing fault(Single Severity) |  | 17-Core Classifier Algorithm | Envelope spectrum analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `QWJURFDW_E106`：highly oscillatory frequency modulation (FM) feature / nonstationary signals(Other) motivates Hilbert transform
  - `QWJURFDW_E107`：noise / model uncertainty(Uncertainty) motivates Hilbert transform
  - `QWJURFDW_E108`：highly oscillatory frequency modulation (FM) feature / nonstationary signals(Other) motivates Matching Demodulation Transform
  - `QWJURFDW_E109`：noise / model uncertainty(Uncertainty) motivates Matching Demodulation Transform
  - `QWJURFDW_E110`：highly oscillatory frequency modulation (FM) feature / nonstationary signals(Other) motivates Envelope spectrum analysis
  - `QWJURFDW_E111`：noise / model uncertainty(Uncertainty) motivates Envelope spectrum analysis
