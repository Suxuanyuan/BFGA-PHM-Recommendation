...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `I3CYXNUE_E084` | `motivates` | 13-Noise Level | heavy noise, noise contamination(High Noise) |  | 15-Data Preprocessing Algorithm | TSA |  |
| 2 | `I3CYXNUE_E085` | `motivates` | 13-Noise Level | heavy noise, noise contamination(High Noise) |  | 16-Feature Extraction Algorithm | VMD |  |
| 3 | `I3CYXNUE_E086` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | TSA |  |
| 4 | `I3CYXNUE_E087` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | VMD |  |
| 5 | `I3CYXNUE_E088` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | SOVMD |  |
| 6 | `I3CYXNUE_E089` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | VMD |  |
| 7 | `I3CYXNUE_E090` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SOVMD |  |
| 8 | `I3CYXNUE_E091` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | SOVMD |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `I3CYXNUE_E086`：noise robustness(Uncertainty) motivates TSA
  - `I3CYXNUE_E087`：noise robustness(Uncertainty) motivates VMD
  - `I3CYXNUE_E088`：noise robustness(Uncertainty) motivates SOVMD
