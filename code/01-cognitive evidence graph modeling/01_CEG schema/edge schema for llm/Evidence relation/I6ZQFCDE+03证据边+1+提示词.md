...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `I6ZQFCDE_E095` | `motivates` | 13-Noise Level | Gaussian white noise, strong noise(High Noise) |  | 15-Data Preprocessing Algorithm | VMD-FRFT |  |
| 2 | `I6ZQFCDE_E096` | `motivates` | 13-Noise Level | Gaussian white noise, strong noise(High Noise) |  | 16-Feature Extraction Algorithm | Wavelet Transform |  |
| 3 | `I6ZQFCDE_E097` | `motivates` | 09-Problem Scenario | early failure period(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | VMD-FRFT |  |
| 4 | `I6ZQFCDE_E098` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 15-Data Preprocessing Algorithm | VMD-FRFT |  |
| 5 | `I6ZQFCDE_E099` | `motivates` | 09-Problem Scenario | over-decomposition of VMD(Other) |  | 15-Data Preprocessing Algorithm | VMD-FRFT |  |
| 6 | `I6ZQFCDE_E100` | `motivates` | 09-Problem Scenario | early failure period(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Wavelet Transform |  |
| 7 | `I6ZQFCDE_E101` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 16-Feature Extraction Algorithm | Wavelet Transform |  |
| 8 | `I6ZQFCDE_E102` | `motivates` | 09-Problem Scenario | over-decomposition of VMD(Other) |  | 16-Feature Extraction Algorithm | Wavelet Transform |  |
| 9 | `I6ZQFCDE_E103` | `motivates` | 09-Problem Scenario | early failure period(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | FCC |  |
| 10 | `I6ZQFCDE_E104` | `motivates` | 09-Problem Scenario | noise robustness(Uncertainty) |  | 17-Core Classifier Algorithm | FCC |  |
| 11 | `I6ZQFCDE_E105` | `motivates` | 09-Problem Scenario | over-decomposition of VMD(Other) |  | 17-Core Classifier Algorithm | FCC |  |
| 12 | `I6ZQFCDE_E106` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Wavelet Transform |  |
| 13 | `I6ZQFCDE_E107` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | FCC |  |
| 14 | `I6ZQFCDE_E108` | `motivates` | 06-Fault Severity | diameter of damage points is set to 0.018 cm and 0.02 cm(Single Severity) |  | 17-Core Classifier Algorithm | FCC |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `I6ZQFCDE_E097`：early failure period(Early Degradation Prediction) motivates VMD-FRFT
  - `I6ZQFCDE_E098`：noise robustness(Uncertainty) motivates VMD-FRFT
  - `I6ZQFCDE_E099`：over-decomposition of VMD(Other) motivates VMD-FRFT
  - `I6ZQFCDE_E100`：early failure period(Early Degradation Prediction) motivates Wavelet Transform
  - `I6ZQFCDE_E101`：noise robustness(Uncertainty) motivates Wavelet Transform
  - `I6ZQFCDE_E102`：over-decomposition of VMD(Other) motivates Wavelet Transform
  - `I6ZQFCDE_E103`：early failure period(Early Degradation Prediction) motivates FCC
  - `I6ZQFCDE_E104`：noise robustness(Uncertainty) motivates FCC
  - `I6ZQFCDE_E105`：over-decomposition of VMD(Other) motivates FCC
