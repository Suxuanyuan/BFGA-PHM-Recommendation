...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3UBRXWHI_E092` | `motivates` | 09-Problem Scenario | strong ambient noise interference(Uncertainty) |  | 19-Training Optimization Algorithm | IPSO |  |
| 2 | `3UBRXWHI_E093` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | IPSO |  |
| 3 | `3UBRXWHI_E094` | `motivates` | 13-Noise Level | background noise / Gaussian noise(High Noise) |  | 15-Data Preprocessing Algorithm | TV-MM |  |
| 4 | `3UBRXWHI_E095` | `motivates` | 13-Noise Level | background noise / Gaussian noise(High Noise) |  | 16-Feature Extraction Algorithm | EWT |  |
| 5 | `3UBRXWHI_E096` | `motivates` | 09-Problem Scenario | strong ambient noise interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | TV-MM |  |
| 6 | `3UBRXWHI_E097` | `motivates` | 09-Problem Scenario | strong ambient noise interference(Uncertainty) |  | 16-Feature Extraction Algorithm | EWT |  |
| 7 | `3UBRXWHI_E098` | `motivates` | 09-Problem Scenario | strong ambient noise interference(Uncertainty) |  | 17-Core Classifier Algorithm | Hilbert envelope demodulation |  |
| 8 | `3UBRXWHI_E099` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | EWT |  |
| 9 | `3UBRXWHI_E100` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Hilbert envelope demodulation |  |
| 10 | `3UBRXWHI_E101` | `motivates` | 06-Fault Severity | 3 mm groove(Single Severity) |  | 17-Core Classifier Algorithm | Hilbert envelope demodulation |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `3UBRXWHI_E092`：strong ambient noise interference(Uncertainty) motivates IPSO
  - `3UBRXWHI_E096`：strong ambient noise interference(Uncertainty) motivates TV-MM
  - `3UBRXWHI_E097`：strong ambient noise interference(Uncertainty) motivates EWT
  - `3UBRXWHI_E098`：strong ambient noise interference(Uncertainty) motivates Hilbert envelope demodulation
