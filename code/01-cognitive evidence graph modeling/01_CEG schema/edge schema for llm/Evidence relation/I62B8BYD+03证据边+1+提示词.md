...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `I62B8BYD_E085` | `motivates` | 12-Training Data Availability | 62,535 instances in the majority class and 2,233 instances in the minority class(Sufficient) |  | 18-Data Generation Algorithm | SMOTE |  |
| 2 | `I62B8BYD_E086` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | PCA |  |
| 3 | `I62B8BYD_E087` | `motivates` | 09-Problem Scenario | imbalanced data set(Small Fault Samples) |  | 18-Data Generation Algorithm | SMOTE |  |
| 4 | `I62B8BYD_E088` | `motivates` | 09-Problem Scenario | generator degradation process and RUL estimation(Early Degradation Prediction) |  | 18-Data Generation Algorithm | SMOTE |  |
| 5 | `I62B8BYD_E089` | `motivates` | 09-Problem Scenario | imbalanced data set(Small Fault Samples) |  | 16-Feature Extraction Algorithm | PCA |  |
| 6 | `I62B8BYD_E090` | `motivates` | 09-Problem Scenario | generator degradation process and RUL estimation(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | PCA |  |
| 7 | `I62B8BYD_E091` | `motivates` | 09-Problem Scenario | imbalanced data set(Small Fault Samples) |  | 17-Core Classifier Algorithm | SVM |  |
| 8 | `I62B8BYD_E092` | `motivates` | 09-Problem Scenario | generator degradation process and RUL estimation(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | SVM |  |
| 9 | `I62B8BYD_E093` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | PCA |  |
| 10 | `I62B8BYD_E094` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVM |  |
| 11 | `I62B8BYD_E095` | `motivates` | 06-Fault Severity | remaining useful life(Multiple Severities) |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `I62B8BYD_E087`：imbalanced data set(Small Fault Samples) motivates SMOTE
  - `I62B8BYD_E088`：generator degradation process and RUL estimation(Early Degradation Prediction) motivates SMOTE
  - `I62B8BYD_E089`：imbalanced data set(Small Fault Samples) motivates PCA
  - `I62B8BYD_E090`：generator degradation process and RUL estimation(Early Degradation Prediction) motivates PCA
  - `I62B8BYD_E091`：imbalanced data set(Small Fault Samples) motivates SVM
  - `I62B8BYD_E092`：generator degradation process and RUL estimation(Early Degradation Prediction) motivates SVM
