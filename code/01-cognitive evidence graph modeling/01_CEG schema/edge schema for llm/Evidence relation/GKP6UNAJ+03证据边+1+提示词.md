...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `GKP6UNAJ_E050` | `motivates` | 13-Noise Level | N/A(Normal) |  | 16-Feature Extraction Algorithm | Empirical Mode Decomposition |  |
| 2 | `GKP6UNAJ_E051` | `motivates` | 09-Problem Scenario | incipient broken rotor bars detection(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Empirical Mode Decomposition |  |
| 3 | `GKP6UNAJ_E052` | `motivates` | 09-Problem Scenario | incipient broken rotor bars detection(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 4 | `GKP6UNAJ_E053` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Empirical Mode Decomposition |  |
| 5 | `GKP6UNAJ_E054` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Threshold Decision |  |
| 6 | `GKP6UNAJ_E055` | `motivates` | 06-Fault Severity | incipient broken rotor bars(Multiple Severities) |  | 17-Core Classifier Algorithm | Threshold Decision |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `GKP6UNAJ_E051`：incipient broken rotor bars detection(Early Degradation Prediction) motivates Empirical Mode Decomposition
  - `GKP6UNAJ_E052`：incipient broken rotor bars detection(Early Degradation Prediction) motivates Threshold Decision
