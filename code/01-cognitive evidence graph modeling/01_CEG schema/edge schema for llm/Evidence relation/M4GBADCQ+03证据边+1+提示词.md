...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `M4GBADCQ_E080` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | FFT |  |
| 2 | `M4GBADCQ_E081` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | CNN |  |
| 3 | `M4GBADCQ_E082` | `motivates` | 09-Problem Scenario | manual parameter selection and nonstationary characteristic(Other) |  | 15-Data Preprocessing Algorithm | FFT |  |
| 4 | `M4GBADCQ_E083` | `motivates` | 09-Problem Scenario | manual parameter selection and nonstationary characteristic(Other) |  | 16-Feature Extraction Algorithm | CNN |  |
| 5 | `M4GBADCQ_E084` | `motivates` | 09-Problem Scenario | manual parameter selection and nonstationary characteristic(Other) |  | 17-Core Classifier Algorithm | SVM |  |
| 6 | `M4GBADCQ_E085` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 7 | `M4GBADCQ_E086` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | SVM |  |
| 8 | `M4GBADCQ_E087` | `motivates` | 06-Fault Severity | fault diameter(Multiple Severities) |  | 17-Core Classifier Algorithm | SVM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `M4GBADCQ_E082`：manual parameter selection and nonstationary characteristic(Other) motivates FFT
  - `M4GBADCQ_E083`：manual parameter selection and nonstationary characteristic(Other) motivates CNN
  - `M4GBADCQ_E084`：manual parameter selection and nonstationary characteristic(Other) motivates SVM
