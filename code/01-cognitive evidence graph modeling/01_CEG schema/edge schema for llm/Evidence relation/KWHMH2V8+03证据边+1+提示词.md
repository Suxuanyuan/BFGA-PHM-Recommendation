...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `KWHMH2V8_E100` | `motivates` | 13-Noise Level | Gaussian white noise(High Noise) |  | 15-Data Preprocessing Algorithm | Space-time fragments |  |
| 2 | `KWHMH2V8_E101` | `motivates` | 13-Noise Level | Gaussian white noise(High Noise) |  | 16-Feature Extraction Algorithm | Histogram of multi-channel shaft orbit |  |
| 3 | `KWHMH2V8_E102` | `motivates` | 09-Problem Scenario | multi-sensor data fusion ignoring the coupling relationship between signals(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Space-time fragments |  |
| 4 | `KWHMH2V8_E103` | `motivates` | 09-Problem Scenario | noise robustness and sensor fault(Uncertainty) |  | 15-Data Preprocessing Algorithm | Space-time fragments |  |
| 5 | `KWHMH2V8_E104` | `motivates` | 09-Problem Scenario | multi-sensor data fusion ignoring the coupling relationship between signals(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | Histogram of multi-channel shaft orbit |  |
| 6 | `KWHMH2V8_E105` | `motivates` | 09-Problem Scenario | noise robustness and sensor fault(Uncertainty) |  | 16-Feature Extraction Algorithm | Histogram of multi-channel shaft orbit |  |
| 7 | `KWHMH2V8_E106` | `motivates` | 09-Problem Scenario | multi-sensor data fusion ignoring the coupling relationship between signals(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | K-nearest neighbor |  |
| 8 | `KWHMH2V8_E107` | `motivates` | 09-Problem Scenario | noise robustness and sensor fault(Uncertainty) |  | 17-Core Classifier Algorithm | K-nearest neighbor |  |
| 9 | `KWHMH2V8_E108` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Histogram of multi-channel shaft orbit |  |
| 10 | `KWHMH2V8_E109` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | K-nearest neighbor |  |
| 11 | `KWHMH2V8_E110` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | K-nearest neighbor |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `KWHMH2V8_E102`：multi-sensor data fusion ignoring the coupling relationship between signals(Multi-Source Heterogeneous / Multimodal Data) motivates Space-time fragments
  - `KWHMH2V8_E103`：noise robustness and sensor fault(Uncertainty) motivates Space-time fragments
  - `KWHMH2V8_E104`：multi-sensor data fusion ignoring the coupling relationship between signals(Multi-Source Heterogeneous / Multimodal Data) motivates Histogram of multi-channel shaft orbit
  - `KWHMH2V8_E105`：noise robustness and sensor fault(Uncertainty) motivates Histogram of multi-channel shaft orbit
  - `KWHMH2V8_E106`：multi-sensor data fusion ignoring the coupling relationship between signals(Multi-Source Heterogeneous / Multimodal Data) motivates K-nearest neighbor
  - `KWHMH2V8_E107`：noise robustness and sensor fault(Uncertainty) motivates K-nearest neighbor
