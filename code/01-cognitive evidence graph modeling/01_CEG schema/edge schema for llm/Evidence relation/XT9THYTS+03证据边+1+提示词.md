...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XT9THYTS_E155` | `motivates` | 09-Problem Scenario | presence of unnecessary, correlated and distorting indicators, over-fitting(Other) |  | 19-Training Optimization Algorithm | Adaptive indicators selection |  |
| 2 | `XT9THYTS_E156` | `motivates` | 09-Problem Scenario | emergence of new operating conditions, appearance of a new class of failure(Other) |  | 19-Training Optimization Algorithm | Adaptive indicators selection |  |
| 3 | `XT9THYTS_E157` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Adaptive indicators selection |  |
| 4 | `XT9THYTS_E158` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Statistical feature extraction |  |
| 5 | `XT9THYTS_E159` | `motivates` | 09-Problem Scenario | presence of unnecessary, correlated and distorting indicators, over-fitting(Other) |  | 16-Feature Extraction Algorithm | Statistical feature extraction |  |
| 6 | `XT9THYTS_E160` | `motivates` | 09-Problem Scenario | emergence of new operating conditions, appearance of a new class of failure(Other) |  | 16-Feature Extraction Algorithm | Statistical feature extraction |  |
| 7 | `XT9THYTS_E161` | `motivates` | 09-Problem Scenario | presence of unnecessary, correlated and distorting indicators, over-fitting(Other) |  | 17-Core Classifier Algorithm | Radial Basis Function Network |  |
| 8 | `XT9THYTS_E162` | `motivates` | 09-Problem Scenario | emergence of new operating conditions, appearance of a new class of failure(Other) |  | 17-Core Classifier Algorithm | Radial Basis Function Network |  |
| 9 | `XT9THYTS_E163` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Statistical feature extraction |  |
| 10 | `XT9THYTS_E164` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Radial Basis Function Network |  |
| 11 | `XT9THYTS_E165` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Radial Basis Function Network |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `XT9THYTS_E155`：presence of unnecessary, correlated and distorting indicators, over-fitting(Other) motivates Adaptive indicators selection
  - `XT9THYTS_E156`：emergence of new operating conditions, appearance of a new class of failure(Other) motivates Adaptive indicators selection
  - `XT9THYTS_E159`：presence of unnecessary, correlated and distorting indicators, over-fitting(Other) motivates Statistical feature extraction
  - `XT9THYTS_E160`：emergence of new operating conditions, appearance of a new class of failure(Other) motivates Statistical feature extraction
  - `XT9THYTS_E161`：presence of unnecessary, correlated and distorting indicators, over-fitting(Other) motivates Radial Basis Function Network
  - `XT9THYTS_E162`：emergence of new operating conditions, appearance of a new class of failure(Other) motivates Radial Basis Function Network
