...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `6SZFJUCV_E083` | `motivates` | 09-Problem Scenario | heavy noises and strong low-frequency periodic signals(Uncertainty) |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 2 | `6SZFJUCV_E084` | `motivates` | 12-Training Data Availability | Sufficient |  | 19-Training Optimization Algorithm | Particle Swarm Optimization |  |
| 3 | `6SZFJUCV_E085` | `motivates` | 13-Noise Level | heavy noises, in-band noises(High Noise) |  | 15-Data Preprocessing Algorithm | Complex Morlet Wavelet |  |
| 4 | `6SZFJUCV_E086` | `motivates` | 13-Noise Level | heavy noises, in-band noises(High Noise) |  | 16-Feature Extraction Algorithm | Morphological Analysis |  |
| 5 | `6SZFJUCV_E087` | `motivates` | 09-Problem Scenario | heavy noises and strong low-frequency periodic signals(Uncertainty) |  | 15-Data Preprocessing Algorithm | Complex Morlet Wavelet |  |
| 6 | `6SZFJUCV_E088` | `motivates` | 09-Problem Scenario | heavy noises and strong low-frequency periodic signals(Uncertainty) |  | 16-Feature Extraction Algorithm | Morphological Analysis |  |
| 7 | `6SZFJUCV_E089` | `motivates` | 09-Problem Scenario | heavy noises and strong low-frequency periodic signals(Uncertainty) |  | 17-Core Classifier Algorithm | Iterative Local Maximum Selection |  |
| 8 | `6SZFJUCV_E090` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Morphological Analysis |  |
| 9 | `6SZFJUCV_E091` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Iterative Local Maximum Selection |  |
| 10 | `6SZFJUCV_E092` | `motivates` | 06-Fault Severity | fault diameter is 0.007 inches and the fault depth is 0.0011 inches(Single Severity) |  | 17-Core Classifier Algorithm | Iterative Local Maximum Selection |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `6SZFJUCV_E083`：heavy noises and strong low-frequency periodic signals(Uncertainty) motivates Particle Swarm Optimization
  - `6SZFJUCV_E087`：heavy noises and strong low-frequency periodic signals(Uncertainty) motivates Complex Morlet Wavelet
  - `6SZFJUCV_E088`：heavy noises and strong low-frequency periodic signals(Uncertainty) motivates Morphological Analysis
  - `6SZFJUCV_E089`：heavy noises and strong low-frequency periodic signals(Uncertainty) motivates Iterative Local Maximum Selection
