...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `MK8TTCJQ_E116` | `motivates` | 09-Problem Scenario | Sensitivity to outliers(Uncertainty) |  | 19-Training Optimization Algorithm | Tree-structured Parzen Estimator |  |
| 2 | `MK8TTCJQ_E117` | `motivates` | 09-Problem Scenario | High computational cost and poor real-time performance in big data(Other) |  | 19-Training Optimization Algorithm | Tree-structured Parzen Estimator |  |
| 3 | `MK8TTCJQ_E118` | `motivates` | 12-Training Data Availability | Dataset 1: 3427 samples, Dataset 2: 3015 samples, Dataset 3: 5376 samples(Sufficient) |  | 19-Training Optimization Algorithm | Tree-structured Parzen Estimator |  |
| 4 | `MK8TTCJQ_E119` | `motivates` | 13-Noise Level | Normal |  | 15-Data Preprocessing Algorithm | 0-1 scaling |  |
| 5 | `MK8TTCJQ_E120` | `motivates` | 13-Noise Level | Normal |  | 16-Feature Extraction Algorithm | Maximum Information Coefficient |  |
| 6 | `MK8TTCJQ_E121` | `motivates` | 09-Problem Scenario | Sensitivity to outliers(Uncertainty) |  | 15-Data Preprocessing Algorithm | 0-1 scaling |  |
| 7 | `MK8TTCJQ_E122` | `motivates` | 09-Problem Scenario | High computational cost and poor real-time performance in big data(Other) |  | 15-Data Preprocessing Algorithm | 0-1 scaling |  |
| 8 | `MK8TTCJQ_E123` | `motivates` | 09-Problem Scenario | Sensitivity to outliers(Uncertainty) |  | 16-Feature Extraction Algorithm | Maximum Information Coefficient |  |
| 9 | `MK8TTCJQ_E124` | `motivates` | 09-Problem Scenario | High computational cost and poor real-time performance in big data(Other) |  | 16-Feature Extraction Algorithm | Maximum Information Coefficient |  |
| 10 | `MK8TTCJQ_E125` | `motivates` | 09-Problem Scenario | Sensitivity to outliers(Uncertainty) |  | 17-Core Classifier Algorithm | LightGBM |  |
| 11 | `MK8TTCJQ_E126` | `motivates` | 09-Problem Scenario | High computational cost and poor real-time performance in big data(Other) |  | 17-Core Classifier Algorithm | LightGBM |  |
| 12 | `MK8TTCJQ_E127` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Maximum Information Coefficient |  |
| 13 | `MK8TTCJQ_E128` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | LightGBM |  |
| 14 | `MK8TTCJQ_E129` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | LightGBM |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `MK8TTCJQ_E116`：Sensitivity to outliers(Uncertainty) motivates Tree-structured Parzen Estimator
  - `MK8TTCJQ_E117`：High computational cost and poor real-time performance in big data(Other) motivates Tree-structured Parzen Estimator
  - `MK8TTCJQ_E121`：Sensitivity to outliers(Uncertainty) motivates 0-1 scaling
  - `MK8TTCJQ_E122`：High computational cost and poor real-time performance in big data(Other) motivates 0-1 scaling
  - `MK8TTCJQ_E123`：Sensitivity to outliers(Uncertainty) motivates Maximum Information Coefficient
  - `MK8TTCJQ_E124`：High computational cost and poor real-time performance in big data(Other) motivates Maximum Information Coefficient
  - `MK8TTCJQ_E125`：Sensitivity to outliers(Uncertainty) motivates LightGBM
  - `MK8TTCJQ_E126`：High computational cost and poor real-time performance in big data(Other) motivates LightGBM
