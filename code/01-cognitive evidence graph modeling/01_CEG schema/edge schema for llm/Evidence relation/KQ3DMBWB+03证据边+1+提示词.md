...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `KQ3DMBWB_E162` | `motivates` | 13-Noise Level | noise subspace(Normal) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 2 | `KQ3DMBWB_E163` | `motivates` | 13-Noise Level | noise subspace(Normal) |  | 16-Feature Extraction Algorithm | PCA |  |
| 3 | `KQ3DMBWB_E164` | `motivates` | 09-Problem Scenario | simultaneous fault detection(Compound Faults) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 4 | `KQ3DMBWB_E165` | `motivates` | 09-Problem Scenario | multiple sensor information from different physical magnitudes(Multi-Source Heterogeneous / Multimodal Data) |  | 15-Data Preprocessing Algorithm | Min-Max Normalization |  |
| 5 | `KQ3DMBWB_E166` | `motivates` | 09-Problem Scenario | simultaneous fault detection(Compound Faults) |  | 16-Feature Extraction Algorithm | PCA |  |
| 6 | `KQ3DMBWB_E167` | `motivates` | 09-Problem Scenario | multiple sensor information from different physical magnitudes(Multi-Source Heterogeneous / Multimodal Data) |  | 16-Feature Extraction Algorithm | PCA |  |
| 7 | `KQ3DMBWB_E168` | `motivates` | 09-Problem Scenario | simultaneous fault detection(Compound Faults) |  | 17-Core Classifier Algorithm | Decision Tree |  |
| 8 | `KQ3DMBWB_E169` | `motivates` | 09-Problem Scenario | multiple sensor information from different physical magnitudes(Multi-Source Heterogeneous / Multimodal Data) |  | 17-Core Classifier Algorithm | Decision Tree |  |
| 9 | `KQ3DMBWB_E170` | `motivates` | 07-Compound Fault | combined, and simultaneous faulty conditions(Compound Fault Across Structures) |  | 16-Feature Extraction Algorithm | PCA |  |
| 10 | `KQ3DMBWB_E171` | `motivates` | 07-Compound Fault | combined, and simultaneous faulty conditions(Compound Fault Across Structures) |  | 17-Core Classifier Algorithm | Decision Tree |  |
| 11 | `KQ3DMBWB_E172` | `motivates` | 06-Fault Severity | rough-hole of 2 mm diameter, 1.191 mm tungsten drill bit(Single Severity) |  | 17-Core Classifier Algorithm | Decision Tree |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `KQ3DMBWB_E164`：simultaneous fault detection(Compound Faults) motivates Min-Max Normalization
  - `KQ3DMBWB_E165`：multiple sensor information from different physical magnitudes(Multi-Source Heterogeneous / Multimodal Data) motivates Min-Max Normalization
  - `KQ3DMBWB_E166`：simultaneous fault detection(Compound Faults) motivates PCA
  - `KQ3DMBWB_E167`：multiple sensor information from different physical magnitudes(Multi-Source Heterogeneous / Multimodal Data) motivates PCA
  - `KQ3DMBWB_E168`：simultaneous fault detection(Compound Faults) motivates Decision Tree
  - `KQ3DMBWB_E169`：multiple sensor information from different physical magnitudes(Multi-Source Heterogeneous / Multimodal Data) motivates Decision Tree
