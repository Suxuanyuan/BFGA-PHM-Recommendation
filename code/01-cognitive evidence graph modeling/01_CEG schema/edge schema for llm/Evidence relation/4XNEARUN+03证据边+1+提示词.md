...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4XNEARUN_E084` | `motivates` | 13-Noise Level | strong noise interferences(High Noise) |  | 15-Data Preprocessing Algorithm | Spectral Kurtosis |  |
| 2 | `4XNEARUN_E085` | `motivates` | 13-Noise Level | strong noise interferences(High Noise) |  | 16-Feature Extraction Algorithm | ConceFT |  |
| 3 | `4XNEARUN_E086` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 15-Data Preprocessing Algorithm | Spectral Kurtosis |  |
| 4 | `4XNEARUN_E087` | `motivates` | 09-Problem Scenario | variable speed conditions(Other) |  | 15-Data Preprocessing Algorithm | Spectral Kurtosis |  |
| 5 | `4XNEARUN_E088` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 16-Feature Extraction Algorithm | ConceFT |  |
| 6 | `4XNEARUN_E089` | `motivates` | 09-Problem Scenario | variable speed conditions(Other) |  | 16-Feature Extraction Algorithm | ConceFT |  |
| 7 | `4XNEARUN_E090` | `motivates` | 09-Problem Scenario | noise interference(Uncertainty) |  | 17-Core Classifier Algorithm | Theoretical frequency comparison |  |
| 8 | `4XNEARUN_E091` | `motivates` | 09-Problem Scenario | variable speed conditions(Other) |  | 17-Core Classifier Algorithm | Theoretical frequency comparison |  |
| 9 | `4XNEARUN_E092` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | ConceFT |  |
| 10 | `4XNEARUN_E093` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Theoretical frequency comparison |  |
| 11 | `4XNEARUN_E094` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Theoretical frequency comparison |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `4XNEARUN_E086`：noise interference(Uncertainty) motivates Spectral Kurtosis
  - `4XNEARUN_E087`：variable speed conditions(Other) motivates Spectral Kurtosis
  - `4XNEARUN_E088`：noise interference(Uncertainty) motivates ConceFT
  - `4XNEARUN_E089`：variable speed conditions(Other) motivates ConceFT
  - `4XNEARUN_E090`：noise interference(Uncertainty) motivates Theoretical frequency comparison
  - `4XNEARUN_E091`：variable speed conditions(Other) motivates Theoretical frequency comparison
