...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `UTGG9GAR_E095` | `motivates` | 13-Noise Level | addictive noise, white noised(High Noise) |  | 15-Data Preprocessing Algorithm | Overlap Segmentation |  |
| 2 | `UTGG9GAR_E096` | `motivates` | 13-Noise Level | addictive noise, white noised(High Noise) |  | 16-Feature Extraction Algorithm | Shift-Invariant Sparse Coding |  |
| 3 | `UTGG9GAR_E097` | `motivates` | 09-Problem Scenario | compound fault(Compound Faults) |  | 15-Data Preprocessing Algorithm | Overlap Segmentation |  |
| 4 | `UTGG9GAR_E098` | `motivates` | 09-Problem Scenario | single channel blind source separation(Other) |  | 15-Data Preprocessing Algorithm | Overlap Segmentation |  |
| 5 | `UTGG9GAR_E099` | `motivates` | 09-Problem Scenario | compound fault(Compound Faults) |  | 16-Feature Extraction Algorithm | Shift-Invariant Sparse Coding |  |
| 6 | `UTGG9GAR_E100` | `motivates` | 09-Problem Scenario | single channel blind source separation(Other) |  | 16-Feature Extraction Algorithm | Shift-Invariant Sparse Coding |  |
| 7 | `UTGG9GAR_E101` | `motivates` | 09-Problem Scenario | compound fault(Compound Faults) |  | 17-Core Classifier Algorithm | K-means |  |
| 8 | `UTGG9GAR_E102` | `motivates` | 09-Problem Scenario | single channel blind source separation(Other) |  | 17-Core Classifier Algorithm | K-means |  |
| 9 | `UTGG9GAR_E103` | `motivates` | 07-Compound Fault | compound fault(Compound Fault Within Same Structure) |  | 16-Feature Extraction Algorithm | Shift-Invariant Sparse Coding |  |
| 10 | `UTGG9GAR_E104` | `motivates` | 07-Compound Fault | compound fault(Compound Fault Within Same Structure) |  | 17-Core Classifier Algorithm | K-means |  |
| 11 | `UTGG9GAR_E105` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | K-means |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `UTGG9GAR_E097`：compound fault(Compound Faults) motivates Overlap Segmentation
  - `UTGG9GAR_E098`：single channel blind source separation(Other) motivates Overlap Segmentation
  - `UTGG9GAR_E099`：compound fault(Compound Faults) motivates Shift-Invariant Sparse Coding
  - `UTGG9GAR_E100`：single channel blind source separation(Other) motivates Shift-Invariant Sparse Coding
  - `UTGG9GAR_E101`：compound fault(Compound Faults) motivates K-means
  - `UTGG9GAR_E102`：single channel blind source separation(Other) motivates K-means
