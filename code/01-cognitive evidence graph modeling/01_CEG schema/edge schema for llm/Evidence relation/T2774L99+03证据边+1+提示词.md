...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `T2774L99_E101` | `motivates` | 09-Problem Scenario | weak fault features under large interferences and noise(Uncertainty) |  | 19-Training Optimization Algorithm | EHNR |  |
| 2 | `T2774L99_E102` | `motivates` | 09-Problem Scenario | early fault identification(Early Degradation Prediction) |  | 19-Training Optimization Algorithm | EHNR |  |
| 3 | `T2774L99_E103` | `motivates` | 12-Training Data Availability | N/A(Sufficient) |  | 19-Training Optimization Algorithm | EHNR |  |
| 4 | `T2774L99_E104` | `motivates` | 13-Noise Level | strong noise and ambient interferences(High Noise) |  | 15-Data Preprocessing Algorithm | PDSC |  |
| 5 | `T2774L99_E105` | `motivates` | 13-Noise Level | strong noise and ambient interferences(High Noise) |  | 16-Feature Extraction Algorithm | HDSC |  |
| 6 | `T2774L99_E106` | `motivates` | 09-Problem Scenario | weak fault features under large interferences and noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | PDSC |  |
| 7 | `T2774L99_E107` | `motivates` | 09-Problem Scenario | early fault identification(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | PDSC |  |
| 8 | `T2774L99_E108` | `motivates` | 09-Problem Scenario | weak fault features under large interferences and noise(Uncertainty) |  | 16-Feature Extraction Algorithm | HDSC |  |
| 9 | `T2774L99_E109` | `motivates` | 09-Problem Scenario | early fault identification(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | HDSC |  |
| 10 | `T2774L99_E110` | `motivates` | 09-Problem Scenario | weak fault features under large interferences and noise(Uncertainty) |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 11 | `T2774L99_E111` | `motivates` | 09-Problem Scenario | early fault identification(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 12 | `T2774L99_E112` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | HDSC |  |
| 13 | `T2774L99_E113` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
| 14 | `T2774L99_E114` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Envelope Spectrum Analysis |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `T2774L99_E101`：weak fault features under large interferences and noise(Uncertainty) motivates EHNR
  - `T2774L99_E102`：early fault identification(Early Degradation Prediction) motivates EHNR
  - `T2774L99_E106`：weak fault features under large interferences and noise(Uncertainty) motivates PDSC
  - `T2774L99_E107`：early fault identification(Early Degradation Prediction) motivates PDSC
  - `T2774L99_E108`：weak fault features under large interferences and noise(Uncertainty) motivates HDSC
  - `T2774L99_E109`：early fault identification(Early Degradation Prediction) motivates HDSC
  - `T2774L99_E110`：weak fault features under large interferences and noise(Uncertainty) motivates Envelope Spectrum Analysis
  - `T2774L99_E111`：early fault identification(Early Degradation Prediction) motivates Envelope Spectrum Analysis
