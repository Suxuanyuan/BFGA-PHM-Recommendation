...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `KC8MEE2V_E109` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 19-Training Optimization Algorithm | Adversarial domain adaptation |  |
| 2 | `KC8MEE2V_E110` | `motivates` | 12-Training Data Availability | 400 training samples and 200 test samples(Sufficient) |  | 19-Training Optimization Algorithm | Adversarial domain adaptation |  |
| 3 | `KC8MEE2V_E111` | `motivates` | 13-Noise Level | variable working conditions(Normal) |  | 15-Data Preprocessing Algorithm | STFT |  |
| 4 | `KC8MEE2V_E112` | `motivates` | 13-Noise Level | variable working conditions(Normal) |  | 16-Feature Extraction Algorithm | CNN |  |
| 5 | `KC8MEE2V_E113` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 15-Data Preprocessing Algorithm | STFT |  |
| 6 | `KC8MEE2V_E114` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 16-Feature Extraction Algorithm | CNN |  |
| 7 | `KC8MEE2V_E115` | `motivates` | 09-Problem Scenario | domain shift(Distribution Discrepancy) |  | 17-Core Classifier Algorithm | Softmax |  |
| 8 | `KC8MEE2V_E116` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | CNN |  |
| 9 | `KC8MEE2V_E117` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Softmax |  |
| 10 | `KC8MEE2V_E118` | `motivates` | 06-Fault Severity | 0.2 mm, 0.4 mm, 0.6 mm, 0.18 mm(Multiple Severities) |  | 17-Core Classifier Algorithm | Softmax |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `KC8MEE2V_E109`：domain shift(Distribution Discrepancy) motivates Adversarial domain adaptation
  - `KC8MEE2V_E113`：domain shift(Distribution Discrepancy) motivates STFT
  - `KC8MEE2V_E114`：domain shift(Distribution Discrepancy) motivates CNN
  - `KC8MEE2V_E115`：domain shift(Distribution Discrepancy) motivates Softmax
