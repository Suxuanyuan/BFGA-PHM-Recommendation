...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `49ADSFAF_E093` | `motivates` | 13-Noise Level | strong noise(High Noise) |  | 15-Data Preprocessing Algorithm | modified nonlocal means |  |
| 2 | `49ADSFAF_E094` | `motivates` | 13-Noise Level | strong noise(High Noise) |  | 16-Feature Extraction Algorithm | MEWT |  |
| 3 | `49ADSFAF_E095` | `motivates` | 09-Problem Scenario | strong noise(Uncertainty) |  | 15-Data Preprocessing Algorithm | modified nonlocal means |  |
| 4 | `49ADSFAF_E096` | `motivates` | 09-Problem Scenario | strong noise(Uncertainty) |  | 16-Feature Extraction Algorithm | MEWT |  |
| 5 | `49ADSFAF_E097` | `motivates` | 09-Problem Scenario | strong noise(Uncertainty) |  | 17-Core Classifier Algorithm | Hilbert transform |  |
| 6 | `49ADSFAF_E098` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | MEWT |  |
| 7 | `49ADSFAF_E099` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Hilbert transform |  |
| 8 | `49ADSFAF_E100` | `motivates` | 06-Fault Severity | Single Severity |  | 17-Core Classifier Algorithm | Hilbert transform |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `49ADSFAF_E095`：strong noise(Uncertainty) motivates modified nonlocal means
  - `49ADSFAF_E096`：strong noise(Uncertainty) motivates MEWT
  - `49ADSFAF_E097`：strong noise(Uncertainty) motivates Hilbert transform
