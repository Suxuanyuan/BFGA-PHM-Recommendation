...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XRVWEK4B_E110` | `motivates` | 13-Noise Level | noise and other minor amplitude components(High Noise) |  | 15-Data Preprocessing Algorithm | Teager-Kaiser algorithm |  |
| 2 | `XRVWEK4B_E111` | `motivates` | 13-Noise Level | noise and other minor amplitude components(High Noise) |  | 16-Feature Extraction Algorithm | Wigner-Ville distribution |  |
| 3 | `XRVWEK4B_E112` | `motivates` | 09-Problem Scenario | incipient fault detection and Remaining Useful Life prediction(Early Degradation Prediction) |  | 15-Data Preprocessing Algorithm | Teager-Kaiser algorithm |  |
| 4 | `XRVWEK4B_E113` | `motivates` | 09-Problem Scenario | model deviations and noise in state estimation(Uncertainty) |  | 15-Data Preprocessing Algorithm | Teager-Kaiser algorithm |  |
| 5 | `XRVWEK4B_E114` | `motivates` | 09-Problem Scenario | incipient fault detection and Remaining Useful Life prediction(Early Degradation Prediction) |  | 16-Feature Extraction Algorithm | Wigner-Ville distribution |  |
| 6 | `XRVWEK4B_E115` | `motivates` | 09-Problem Scenario | model deviations and noise in state estimation(Uncertainty) |  | 16-Feature Extraction Algorithm | Wigner-Ville distribution |  |
| 7 | `XRVWEK4B_E116` | `motivates` | 09-Problem Scenario | incipient fault detection and Remaining Useful Life prediction(Early Degradation Prediction) |  | 17-Core Classifier Algorithm | Particle Filter |  |
| 8 | `XRVWEK4B_E117` | `motivates` | 09-Problem Scenario | model deviations and noise in state estimation(Uncertainty) |  | 17-Core Classifier Algorithm | Particle Filter |  |
| 9 | `XRVWEK4B_E118` | `motivates` | 07-Compound Fault | No Compound Fault |  | 16-Feature Extraction Algorithm | Wigner-Ville distribution |  |
| 10 | `XRVWEK4B_E119` | `motivates` | 07-Compound Fault | No Compound Fault |  | 17-Core Classifier Algorithm | Particle Filter |  |
| 11 | `XRVWEK4B_E120` | `motivates` | 06-Fault Severity | bar section reduced to 14% and 7%(Multiple Severities) |  | 17-Core Classifier Algorithm | Particle Filter |  |
...
The following candidate edges are of the type "09-Problem Scenario → Nodes 15~19 (Algorithm)"; **at least 1 of them must be judged as "existing" and extracted as an evidence edge**:
  - `XRVWEK4B_E112`：incipient fault detection and Remaining Useful Life prediction(Early Degradation Prediction) motivates Teager-Kaiser algorithm
  - `XRVWEK4B_E113`：model deviations and noise in state estimation(Uncertainty) motivates Teager-Kaiser algorithm
  - `XRVWEK4B_E114`：incipient fault detection and Remaining Useful Life prediction(Early Degradation Prediction) motivates Wigner-Ville distribution
  - `XRVWEK4B_E115`：model deviations and noise in state estimation(Uncertainty) motivates Wigner-Ville distribution
  - `XRVWEK4B_E116`：incipient fault detection and Remaining Useful Life prediction(Early Degradation Prediction) motivates Particle Filter
  - `XRVWEK4B_E117`：model deviations and noise in state estimation(Uncertainty) motivates Particle Filter
