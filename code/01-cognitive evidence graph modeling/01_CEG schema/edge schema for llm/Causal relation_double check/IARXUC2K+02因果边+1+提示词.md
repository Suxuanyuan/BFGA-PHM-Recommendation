...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `IARXUC2K_E065` | `is collected on` | 11-Sensor Information | temperature sensors |  | 04-Fault Location | steam generator tube |  |
| 2 | `IARXUC2K_E066` | `is collected on` | 11-Sensor Information | pressure sensors |  | 04-Fault Location | steam generator tube |  |
| 3 | `IARXUC2K_E067` | `is collected on` | 11-Sensor Information | water level sensors |  | 04-Fault Location | steam generator tube |  |
| 4 | `IARXUC2K_E068` | `is collected on` | 11-Sensor Information | flowrate sensors |  | 04-Fault Location | steam generator tube |  |
