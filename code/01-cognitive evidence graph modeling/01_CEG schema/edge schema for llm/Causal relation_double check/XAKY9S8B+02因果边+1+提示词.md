...
- **Reference ID**: XAKY9S8B
- **Paper Title**: Fault Estimation and Accommodation For Virtual Sensor Bias Fault in Image-Based Visual Servoing Using Particle Filter
...
> **Input Material**: Reference ID `XAKY9S8B` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "XAKY9S8B_E021", "edge_description": "industrial robot contains single operating condition"},
    {"edge_id": "XAKY9S8B_E022", "edge_description": "camera contains single operating condition"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XAKY9S8B_E021` | `contains` | 02-Object Type | industrial robot |  | 03-Operating Conditions | single operating condition(Single Condition) |  |
| 2 | `XAKY9S8B_E022` | `contains` | 02-Object Type | camera |  | 03-Operating Conditions | single operating condition(Single Condition) |  |
