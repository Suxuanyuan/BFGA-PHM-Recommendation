...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `BP9CZHH8_E081` | `contains` | 05-Fault Mode | outer race fault |  | 07-Compound Fault | compound fault of WF and BT(Compound Fault Within Same Structure) |  |
| 2 | `BP9CZHH8_E082` | `contains` | 05-Fault Mode | inner race fault |  | 07-Compound Fault | compound fault of WF and BT(Compound Fault Within Same Structure) |  |
| 3 | `BP9CZHH8_E083` | `contains` | 05-Fault Mode | roller fault |  | 07-Compound Fault | compound fault of WF and BT(Compound Fault Within Same Structure) |  |
| 4 | `BP9CZHH8_E084` | `contains` | 05-Fault Mode | worn fault |  | 07-Compound Fault | compound fault of WF and BT(Compound Fault Within Same Structure) |  |
| 5 | `BP9CZHH8_E085` | `contains` | 05-Fault Mode | broken tooth |  | 07-Compound Fault | compound fault of WF and BT(Compound Fault Within Same Structure) |  |
