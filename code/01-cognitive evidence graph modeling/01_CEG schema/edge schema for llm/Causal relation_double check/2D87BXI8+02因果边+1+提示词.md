...
- **Reference ID**: 2D87BXI8
- **Paper Title**: Semisupervised Deep Sparse Auto-Encoder With Local and Nonlocal Information for Intelligent Fault Diagnosis of Rotating Machinery
...
> **Input Material**: Reference ID `2D87BXI8` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "2D87BXI8_E069", "edge_description": "inner ring fault contains inner and outer ring compound fault"},
    {"edge_id": "2D87BXI8_E070", "edge_description": "outer ring fault contains inner and outer ring compound fault"},
    {"edge_id": "2D87BXI8_E071", "edge_description": "rotor fault contains inner and outer ring compound fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `2D87BXI8_E069` | `contains` | 05-Fault Mode | inner ring fault |  | 07-Compound Fault | inner and outer ring compound fault(Compound Fault Within Same Structure) |  |
| 2 | `2D87BXI8_E070` | `contains` | 05-Fault Mode | outer ring fault |  | 07-Compound Fault | inner and outer ring compound fault(Compound Fault Within Same Structure) |  |
| 3 | `2D87BXI8_E071` | `contains` | 05-Fault Mode | rotor fault |  | 07-Compound Fault | inner and outer ring compound fault(Compound Fault Within Same Structure) |  |
