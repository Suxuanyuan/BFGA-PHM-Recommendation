...
- **Reference ID**: Y6E6M8AC
- **Paper Title**: A sparse stacked denoising autoencoder with optimized transfer learning applied to the fault diagnosis of rolling bearings
...
> **Input Material**: Reference ID `Y6E6M8AC` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "Y6E6M8AC_E075", "edge_description": "vibration sensor is collected on inner race"},
    {"edge_id": "Y6E6M8AC_E076", "edge_description": "vibration sensor is collected on outer race"},
    {"edge_id": "Y6E6M8AC_E077", "edge_description": "vibration sensor is collected on ball"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `Y6E6M8AC_E075` | `is collected on` | 11-Sensor Information | vibration sensor |  | 04-Fault Location | inner race |  |
| 2 | `Y6E6M8AC_E076` | `is collected on` | 11-Sensor Information | vibration sensor |  | 04-Fault Location | outer race |  |
| 3 | `Y6E6M8AC_E077` | `is collected on` | 11-Sensor Information | vibration sensor |  | 04-Fault Location | ball |  |
