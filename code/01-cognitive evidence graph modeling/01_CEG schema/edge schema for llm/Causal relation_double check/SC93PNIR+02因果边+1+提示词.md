...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SC93PNIR_E076` | `is collected on` | 11-Sensor Information | Piezoelectric Acceleration Sensor |  | 04-Fault Location | main contact |  |
| 2 | `SC93PNIR_E077` | `is collected on` | 11-Sensor Information | Piezoelectric Acceleration Sensor |  | 04-Fault Location | main spring |  |
| 3 | `SC93PNIR_E078` | `is collected on` | 11-Sensor Information | Piezoelectric Acceleration Sensor |  | 04-Fault Location | mechanism |  |
