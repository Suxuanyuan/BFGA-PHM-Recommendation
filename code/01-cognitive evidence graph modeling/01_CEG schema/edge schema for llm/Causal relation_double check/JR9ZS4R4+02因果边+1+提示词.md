...
- **Reference ID**: JR9ZS4R4
- **Paper Title**: Nonlinear-Drifted Fractional Brownian Motion With Multiple Hidden State Variables for Remaining Useful Life Prediction of Lithium-Ion Batteries
...
> **Input Material**: Reference ID `JR9ZS4R4` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "JR9ZS4R4_E042", "edge_description": "voltage sensor can obviously reflect capacity degradation"},
    {"edge_id": "JR9ZS4R4_E043", "edge_description": "current sensor can obviously reflect capacity degradation"},
    {"edge_id": "JR9ZS4R4_E044", "edge_description": "temperature sensor can obviously reflect capacity degradation"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `JR9ZS4R4_E042` | `can obviously reflect` | 11-Sensor Information | voltage sensor |  | 05-Fault Mode | capacity degradation |  |
| 2 | `JR9ZS4R4_E043` | `can obviously reflect` | 11-Sensor Information | current sensor |  | 05-Fault Mode | capacity degradation |  |
| 3 | `JR9ZS4R4_E044` | `can obviously reflect` | 11-Sensor Information | temperature sensor |  | 05-Fault Mode | capacity degradation |  |
