...
- **Reference ID**: SQN9SL46
- **Paper Title**: Vulnerability assessment of chemical facilities to intentional attacks based on Bayesian Network
...
> **Input Material**: Reference ID `SQN9SL46` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "SQN9SL46_E030", "edge_description": "Video Motion Detection cameras / CCTV is collected on atmospheric tank"},
    {"edge_id": "SQN9SL46_E031", "edge_description": "Video Motion Detection cameras / CCTV is collected on pressurized vessel"},
    {"edge_id": "SQN9SL46_E032", "edge_description": "Video Motion Detection cameras / CCTV can obviously reflect overpressure damage"},
    {"edge_id": "SQN9SL46_E033", "edge_description": "Video Motion Detection cameras / CCTV can obviously reflect deliberate misoperation"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SQN9SL46_E030` | `is collected on` | 11-Sensor Information | Video Motion Detection cameras / CCTV |  | 04-Fault Location | atmospheric tank |  |
| 2 | `SQN9SL46_E031` | `is collected on` | 11-Sensor Information | Video Motion Detection cameras / CCTV |  | 04-Fault Location | pressurized vessel |  |
| 3 | `SQN9SL46_E032` | `can obviously reflect` | 11-Sensor Information | Video Motion Detection cameras / CCTV |  | 05-Fault Mode | overpressure damage |  |
| 4 | `SQN9SL46_E033` | `can obviously reflect` | 11-Sensor Information | Video Motion Detection cameras / CCTV |  | 05-Fault Mode | deliberate misoperation |  |
