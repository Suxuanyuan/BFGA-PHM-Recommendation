...
- **Reference ID**: PBEWJ3AL
- **Paper Title**: Feature Extraction of Gearbox Compound Faults Based on Blind Source Separation
...
> **Input Material**: Reference ID `PBEWJ3AL` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "PBEWJ3AL_E057", "edge_description": "eccentricity contains Single Severity"},
    {"edge_id": "PBEWJ3AL_E058", "edge_description": "teeth broken contains Single Severity"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PBEWJ3AL_E057` | `contains` | 05-Fault Mode | eccentricity |  | 06-Fault Severity | Single Severity |  |
| 2 | `PBEWJ3AL_E058` | `contains` | 05-Fault Mode | teeth broken |  | 06-Fault Severity | Single Severity |  |
