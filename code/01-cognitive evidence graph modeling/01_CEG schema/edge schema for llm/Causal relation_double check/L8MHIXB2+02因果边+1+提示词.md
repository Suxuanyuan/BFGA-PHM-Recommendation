...
- **Reference ID**: L8MHIXB2
- **Paper Title**: Application of Nonlinear Output Frequency Response Functions and Deep Learning to RV Reducer Fault Diagnosis
...
> **Input Material**: Reference ID `L8MHIXB2` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "L8MHIXB2_E078", "edge_description": "pitting contains coupling faults"},
    {"edge_id": "L8MHIXB2_E079", "edge_description": "wear contains coupling faults"},
    {"edge_id": "L8MHIXB2_E080", "edge_description": "acceleration sensors is collected on cycloid wheel"},
    {"edge_id": "L8MHIXB2_E081", "edge_description": "acceleration sensors is collected on eccentric shaft"},
    {"edge_id": "L8MHIXB2_E082", "edge_description": "acceleration sensors is collected on planet carrier"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `L8MHIXB2_E078` | `contains` | 05-Fault Mode | pitting |  | 07-Compound Fault | coupling faults(Compound Fault Within Same Structure) |  |
| 2 | `L8MHIXB2_E079` | `contains` | 05-Fault Mode | wear |  | 07-Compound Fault | coupling faults(Compound Fault Within Same Structure) |  |
| 3 | `L8MHIXB2_E080` | `is collected on` | 11-Sensor Information | acceleration sensors |  | 04-Fault Location | cycloid wheel |  |
| 4 | `L8MHIXB2_E081` | `is collected on` | 11-Sensor Information | acceleration sensors |  | 04-Fault Location | eccentric shaft |  |
| 5 | `L8MHIXB2_E082` | `is collected on` | 11-Sensor Information | acceleration sensors |  | 04-Fault Location | planet carrier |  |
