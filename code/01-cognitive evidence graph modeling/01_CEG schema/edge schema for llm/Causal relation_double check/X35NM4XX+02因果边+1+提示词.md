...
- **Reference ID**: X35NM4XX
- **Paper Title**: Open Fault Detection and Tolerant Control for a Five Phase Inverter Driving System
...
> **Input Material**: Reference ID `X35NM4XX` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "X35NM4XX_E064", "edge_description": "current sensor is collected on five-phase inverter"},
    {"edge_id": "X35NM4XX_E065", "edge_description": "current sensor is collected on switching devices"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `X35NM4XX_E064` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | five-phase inverter |  |
| 2 | `X35NM4XX_E065` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | switching devices |  |
