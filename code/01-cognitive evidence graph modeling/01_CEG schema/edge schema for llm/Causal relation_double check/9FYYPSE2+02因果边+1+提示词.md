...
- **Reference ID**: 9FYYPSE2
- **Paper Title**: A State Estimator-Based Approach for Open-Circuit Fault Diagnosis in Single-Phase Cascaded H-Bridge Rectifiers
...
> **Input Material**: Reference ID `9FYYPSE2` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "9FYYPSE2_E053", "edge_description": "voltage sensor is collected on semiconductor transistor"},
    {"edge_id": "9FYYPSE2_E054", "edge_description": "current sensor is collected on semiconductor transistor"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `9FYYPSE2_E053` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | semiconductor transistor |  |
| 2 | `9FYYPSE2_E054` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | semiconductor transistor |  |
