...
- **Reference ID**: CKQG6E3K
- **Paper Title**: Health condition identification of planetary gearboxes based on variational mode decomposition and generalized composite multi-scale symbolic dynamic entropy
...
> **Input Material**: Reference ID `CKQG6E3K` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "CKQG6E3K_E069", "edge_description": "transducers is collected on sun gear"},
    {"edge_id": "CKQG6E3K_E070", "edge_description": "transducers is collected on planet gear"},
    {"edge_id": "CKQG6E3K_E071", "edge_description": "transducers is collected on ring gear"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CKQG6E3K_E069` | `is collected on` | 11-Sensor Information | transducers |  | 04-Fault Location | sun gear |  |
| 2 | `CKQG6E3K_E070` | `is collected on` | 11-Sensor Information | transducers |  | 04-Fault Location | planet gear |  |
| 3 | `CKQG6E3K_E071` | `is collected on` | 11-Sensor Information | transducers |  | 04-Fault Location | ring gear |  |
