...
- **Reference ID**: QJSH4DY6
- **Paper Title**: Tolerant Control for Power Transistor Faults in Switched Reluctance Motor Drives
...
> **Input Material**: Reference ID `QJSH4DY6` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "QJSH4DY6_E045", "edge_description": "current sensors is collected on power transistor"},
    {"edge_id": "QJSH4DY6_E046", "edge_description": "speed sensor / position sensor is collected on power transistor"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QJSH4DY6_E045` | `is collected on` | 11-Sensor Information | current sensors |  | 04-Fault Location | power transistor |  |
| 2 | `QJSH4DY6_E046` | `is collected on` | 11-Sensor Information | speed sensor / position sensor |  | 04-Fault Location | power transistor |  |
