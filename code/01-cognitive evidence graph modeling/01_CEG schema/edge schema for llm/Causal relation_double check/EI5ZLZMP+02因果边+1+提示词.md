...
- **Reference ID**: EI5ZLZMP
- **Paper Title**: A new subset based deep feature learning method for intelligent fault diagnosis of bearing
...
> **Input Material**: Reference ID `EI5ZLZMP` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "EI5ZLZMP_E095", "edge_description": "bearing contains multiple operating conditions"},
    {"edge_id": "EI5ZLZMP_E096", "edge_description": "centrifugal pump contains multiple operating conditions"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `EI5ZLZMP_E095` | `contains` | 02-Object Type | bearing |  | 03-Operating Conditions | multiple operating conditions(Multiple Conditions) |  |
| 2 | `EI5ZLZMP_E096` | `contains` | 02-Object Type | centrifugal pump |  | 03-Operating Conditions | multiple operating conditions(Multiple Conditions) |  |
