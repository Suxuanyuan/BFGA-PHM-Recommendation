...
- **Reference ID**: 5JHYB5HB
- **Paper Title**: Compound-Fault Diagnosis of Rotating Machinery: A Fused Imbalance Learning Method
...
> **Input Material**: Reference ID `5JHYB5HB` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "5JHYB5HB_E093", "edge_description": "bearing contains steady operating condition"},
    {"edge_id": "5JHYB5HB_E094", "edge_description": "gearbox contains steady operating condition"},
    {"edge_id": "5JHYB5HB_E098", "edge_description": "US CTC accelerometer is collected on bearing"},
    {"edge_id": "5JHYB5HB_E099", "edge_description": "US CTC accelerometer is collected on gearwheels"},
    {"edge_id": "5JHYB5HB_E100", "edge_description": "US CTC accelerometer is collected on pinions"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `5JHYB5HB_E093` | `contains` | 02-Object Type | bearing |  | 03-Operating Conditions | steady operating condition(Single Condition) |  |
| 2 | `5JHYB5HB_E094` | `contains` | 02-Object Type | gearbox |  | 03-Operating Conditions | steady operating condition(Single Condition) |  |
| 3 | `5JHYB5HB_E098` | `is collected on` | 11-Sensor Information | US CTC accelerometer |  | 04-Fault Location | bearing |  |
| 4 | `5JHYB5HB_E099` | `is collected on` | 11-Sensor Information | US CTC accelerometer |  | 04-Fault Location | gearwheels |  |
| 5 | `5JHYB5HB_E100` | `is collected on` | 11-Sensor Information | US CTC accelerometer |  | 04-Fault Location | pinions |  |
