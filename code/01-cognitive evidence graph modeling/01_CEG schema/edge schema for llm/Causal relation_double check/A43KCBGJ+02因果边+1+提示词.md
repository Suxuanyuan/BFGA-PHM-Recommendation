...
- **Reference ID**: A43KCBGJ
- **Paper Title**: Demagnetization Fault Diagnosis of a PMSM Based on Structure Analysis of Motor Inductance
...
> **Input Material**: Reference ID `A43KCBGJ` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "A43KCBGJ_E023", "edge_description": "voltage sensor is collected on permanent magnet"},
    {"edge_id": "A43KCBGJ_E024", "edge_description": "current sensor is collected on permanent magnet"},
    {"edge_id": "A43KCBGJ_E025", "edge_description": "BEI Ideacod encoder is collected on permanent magnet"},
    {"edge_id": "A43KCBGJ_E026", "edge_description": "dynamo machine is collected on permanent magnet"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `A43KCBGJ_E023` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | permanent magnet |  |
| 2 | `A43KCBGJ_E024` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | permanent magnet |  |
| 3 | `A43KCBGJ_E025` | `is collected on` | 11-Sensor Information | BEI Ideacod encoder |  | 04-Fault Location | permanent magnet |  |
| 4 | `A43KCBGJ_E026` | `is collected on` | 11-Sensor Information | dynamo machine |  | 04-Fault Location | permanent magnet |  |
