...
- **Reference ID**: A4NKR4RD
- **Paper Title**: Analog circuit fault diagnosis based UCISVM
...
> **Input Material**: Reference ID `A4NKR4RD` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "A4NKR4RD_E056", "edge_description": "upward bias contains single soft faults"},
    {"edge_id": "A4NKR4RD_E057", "edge_description": "downward bias contains single soft faults"},
    {"edge_id": "A4NKR4RD_E067", "edge_description": "upward bias contains 1.5 times of nominal, 0.85 times of nominal"},
    {"edge_id": "A4NKR4RD_E068", "edge_description": "downward bias contains 1.5 times of nominal, 0.85 times of nominal"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `A4NKR4RD_E056` | `contains` | 05-Fault Mode | upward bias |  | 07-Compound Fault | single soft faults(No Compound Fault) |  |
| 2 | `A4NKR4RD_E057` | `contains` | 05-Fault Mode | downward bias |  | 07-Compound Fault | single soft faults(No Compound Fault) |  |
| 3 | `A4NKR4RD_E067` | `contains` | 05-Fault Mode | upward bias |  | 06-Fault Severity | 1.5 times of nominal, 0.85 times of nominal(Single Severity) |  |
| 4 | `A4NKR4RD_E068` | `contains` | 05-Fault Mode | downward bias |  | 06-Fault Severity | 1.5 times of nominal, 0.85 times of nominal(Single Severity) |  |
