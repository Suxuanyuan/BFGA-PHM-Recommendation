...
- **Reference ID**: R3A2BRQH
- **Paper Title**: Multireceptive Field Graph Convolutional Networks for Machine Fault Diagnosis
...
> **Input Material**: Reference ID `R3A2BRQH` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "R3A2BRQH_E076", "edge_description": "wear contains Compound fault of the three bearing faults"},
    {"edge_id": "R3A2BRQH_E077", "edge_description": "crack contains Compound fault of the three bearing faults"},
    {"edge_id": "R3A2BRQH_E078", "edge_description": "fracture contains Compound fault of the three bearing faults"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `R3A2BRQH_E076` | `contains` | 05-Fault Mode | wear |  | 07-Compound Fault | Compound fault of the three bearing faults(Compound Fault Within Same Structure) |  |
| 2 | `R3A2BRQH_E077` | `contains` | 05-Fault Mode | crack |  | 07-Compound Fault | Compound fault of the three bearing faults(Compound Fault Within Same Structure) |  |
| 3 | `R3A2BRQH_E078` | `contains` | 05-Fault Mode | fracture |  | 07-Compound Fault | Compound fault of the three bearing faults(Compound Fault Within Same Structure) |  |
