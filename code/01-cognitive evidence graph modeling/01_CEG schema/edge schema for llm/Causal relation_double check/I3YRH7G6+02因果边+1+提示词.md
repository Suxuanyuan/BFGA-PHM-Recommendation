...
- **Reference ID**: I3YRH7G6
- **Paper Title**: Automatic Diagnosis of Electromechanical Faults in Induction Motors Based on the Transient Analysis of the Stray Flux via MUSIC Methods
...
> **Input Material**: Reference ID `I3YRH7G6` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "I3YRH7G6_E061", "edge_description": "external coil sensor is collected on rotor"},
    {"edge_id": "I3YRH7G6_E062", "edge_description": "external coil sensor is collected on coupling"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `I3YRH7G6_E061` | `is collected on` | 11-Sensor Information | external coil sensor |  | 04-Fault Location | rotor |  |
| 2 | `I3YRH7G6_E062` | `is collected on` | 11-Sensor Information | external coil sensor |  | 04-Fault Location | coupling |  |
