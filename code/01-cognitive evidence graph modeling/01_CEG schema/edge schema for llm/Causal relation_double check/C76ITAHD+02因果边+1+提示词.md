...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `C76ITAHD_E082` | `contains` | 05-Fault Mode | chipped tooth / missed tooth / broken teeth |  | 07-Compound Fault | composite fault on a bearing(Compound Fault Within Same Structure) |  |
| 2 | `C76ITAHD_E083` | `contains` | 05-Fault Mode | wear |  | 07-Compound Fault | composite fault on a bearing(Compound Fault Within Same Structure) |  |
| 3 | `C76ITAHD_E084` | `contains` | 05-Fault Mode | pitting |  | 07-Compound Fault | composite fault on a bearing(Compound Fault Within Same Structure) |  |
| 4 | `C76ITAHD_E085` | `contains` | 05-Fault Mode | eccentric |  | 07-Compound Fault | composite fault on a bearing(Compound Fault Within Same Structure) |  |
| 5 | `C76ITAHD_E086` | `contains` | 05-Fault Mode | ball fault / inner raceway fault / outer raceway fault |  | 07-Compound Fault | composite fault on a bearing(Compound Fault Within Same Structure) |  |
