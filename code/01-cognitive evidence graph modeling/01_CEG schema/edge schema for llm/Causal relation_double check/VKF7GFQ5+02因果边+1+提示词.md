...
- **Reference ID**: VKF7GFQ5
- **Paper Title**: Ensemble of optimized echo state networks for remaining useful life prediction
...
> **Input Material**: Reference ID `VKF7GFQ5` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "VKF7GFQ5_E068", "edge_description": "speed sensor, tachometer is collected on High Pressure Compressor"},
    {"edge_id": "VKF7GFQ5_E069", "edge_description": "speed sensor, tachometer is collected on cutting knives"},
    {"edge_id": "VKF7GFQ5_E070", "edge_description": "speed sensor, tachometer can obviously reflect degradation"},
    {"edge_id": "VKF7GFQ5_E071", "edge_description": "speed sensor, tachometer can obviously reflect degradation"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VKF7GFQ5_E068` | `is collected on` | 11-Sensor Information | speed sensor, tachometer |  | 04-Fault Location | High Pressure Compressor |  |
| 2 | `VKF7GFQ5_E069` | `is collected on` | 11-Sensor Information | speed sensor, tachometer |  | 04-Fault Location | cutting knives |  |
| 3 | `VKF7GFQ5_E070` | `can obviously reflect` | 11-Sensor Information | speed sensor, tachometer |  | 05-Fault Mode | degradation |  |
| 4 | `VKF7GFQ5_E071` | `can obviously reflect` | 11-Sensor Information | speed sensor, tachometer |  | 05-Fault Mode | degradation |  |
