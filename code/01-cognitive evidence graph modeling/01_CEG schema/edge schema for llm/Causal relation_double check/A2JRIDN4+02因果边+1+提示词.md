...
- **Reference ID**: A2JRIDN4
- **Paper Title**: Normalized Relative RBC-Based Minimum Risk Bayesian Decision Approach for Fault Diagnosis of Industrial Process
...
> **Input Material**: Reference ID `A2JRIDN4` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "A2JRIDN4_E081", "edge_description": "step change contains multiple faults"},
    {"edge_id": "A2JRIDN4_E082", "edge_description": "sticking contains multiple faults"},
    {"edge_id": "A2JRIDN4_E083", "edge_description": "slow drift contains multiple faults"},
    {"edge_id": "A2JRIDN4_E084", "edge_description": "bias fault contains multiple faults"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `A2JRIDN4_E081` | `contains` | 05-Fault Mode | step change |  | 07-Compound Fault | multiple faults(Compound Fault Within Same Structure) |  |
| 2 | `A2JRIDN4_E082` | `contains` | 05-Fault Mode | sticking |  | 07-Compound Fault | multiple faults(Compound Fault Within Same Structure) |  |
| 3 | `A2JRIDN4_E083` | `contains` | 05-Fault Mode | slow drift |  | 07-Compound Fault | multiple faults(Compound Fault Within Same Structure) |  |
| 4 | `A2JRIDN4_E084` | `contains` | 05-Fault Mode | bias fault |  | 07-Compound Fault | multiple faults(Compound Fault Within Same Structure) |  |
