...
- **Reference ID**: BHDYP8ZP
- **Paper Title**: Investigation of a Fault-Tolerant Three-Level T-Type Inverter System
...
> **Input Material**: Reference ID `BHDYP8ZP` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "BHDYP8ZP_E042", "edge_description": "voltage sensor is collected on power switches"},
    {"edge_id": "BHDYP8ZP_E043", "edge_description": "current sensor is collected on power switches"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `BHDYP8ZP_E042` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | power switches |  |
| 2 | `BHDYP8ZP_E043` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | power switches |  |
