...
- **Reference ID**: XUH7NUSG
- **Paper Title**: Orthotopic-filtering-based fault diagnosis algorithms for nonlinear systems with slowly varying faults
...
> **Input Material**: Reference ID `XUH7NUSG` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "XUH7NUSG_E019", "edge_description": "generator contains generator and converter"},
    {"edge_id": "XUH7NUSG_E020", "edge_description": "converter contains generator and converter"},
    {"edge_id": "XUH7NUSG_E021", "edge_description": "generator contains noise boundary"},
    {"edge_id": "XUH7NUSG_E022", "edge_description": "converter contains noise boundary"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XUH7NUSG_E019` | `contains` | 02-Object Type | generator |  | 04-Fault Location | generator and converter |  |
| 2 | `XUH7NUSG_E020` | `contains` | 02-Object Type | converter |  | 04-Fault Location | generator and converter |  |
| 3 | `XUH7NUSG_E021` | `contains` | 02-Object Type | generator |  | 03-Operating Conditions | noise boundary(Multiple Conditions) |  |
| 4 | `XUH7NUSG_E022` | `contains` | 02-Object Type | converter |  | 03-Operating Conditions | noise boundary(Multiple Conditions) |  |
