...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WNVRAXPR_E064` | `contains` | 02-Object Type | carrying roll |  | 04-Fault Location | steel strip |  |
| 2 | `WNVRAXPR_E065` | `contains` | 02-Object Type | motor |  | 04-Fault Location | steel strip |  |
| 3 | `WNVRAXPR_E066` | `contains` | 02-Object Type | dancer roll |  | 04-Fault Location | steel strip |  |
