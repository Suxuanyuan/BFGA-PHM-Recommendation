...
- **Reference ID**: DUEL7RK9
- **Paper Title**: Remaining useful life estimation with multiple local similarities
...
> **Input Material**: Reference ID `DUEL7RK9` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "DUEL7RK9_E055", "edge_description": "aviation contains turbofan engine"},
    {"edge_id": "DUEL7RK9_E056", "edge_description": "aviation contains rolling element bearing"},
    {"edge_id": "DUEL7RK9_E057", "edge_description": "turbofan engine contains turbofan engine"},
    {"edge_id": "DUEL7RK9_E058", "edge_description": "turbofan engine contains rolling element bearing"},
    {"edge_id": "DUEL7RK9_E059", "edge_description": "rolling element bearing contains turbofan engine"},
    {"edge_id": "DUEL7RK9_E060", "edge_description": "rolling element bearing contains rolling element bearing"},
    {"edge_id": "DUEL7RK9_E061", "edge_description": "turbofan engine contains single operating condition"},
    {"edge_id": "DUEL7RK9_E062", "edge_description": "rolling element bearing contains single operating condition"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DUEL7RK9_E055` | `contains` | 01-Object Domain | aviation(Aerospace) |  | 02-Object Type | turbofan engine |  |
| 2 | `DUEL7RK9_E056` | `contains` | 01-Object Domain | aviation(Aerospace) |  | 02-Object Type | rolling element bearing |  |
| 3 | `DUEL7RK9_E057` | `contains` | 02-Object Type | turbofan engine |  | 04-Fault Location | turbofan engine |  |
| 4 | `DUEL7RK9_E058` | `contains` | 02-Object Type | turbofan engine |  | 04-Fault Location | rolling element bearing |  |
| 5 | `DUEL7RK9_E059` | `contains` | 02-Object Type | rolling element bearing |  | 04-Fault Location | turbofan engine |  |
| 6 | `DUEL7RK9_E060` | `contains` | 02-Object Type | rolling element bearing |  | 04-Fault Location | rolling element bearing |  |
| 7 | `DUEL7RK9_E061` | `contains` | 02-Object Type | turbofan engine |  | 03-Operating Conditions | single operating condition(Single Condition) |  |
| 8 | `DUEL7RK9_E062` | `contains` | 02-Object Type | rolling element bearing |  | 03-Operating Conditions | single operating condition(Single Condition) |  |
