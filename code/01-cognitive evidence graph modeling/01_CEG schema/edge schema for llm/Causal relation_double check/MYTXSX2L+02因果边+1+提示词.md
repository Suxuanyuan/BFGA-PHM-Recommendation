...
- **Reference ID**: MYTXSX2L
- **Paper Title**: Open-Circuit Fault Diagnosis and Tolerance Strategy Applied to Four-Wire T-Type Converter Systems
...
> **Input Material**: Reference ID `MYTXSX2L` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "MYTXSX2L_E056", "edge_description": "current sensor is collected on switching devices"},
    {"edge_id": "MYTXSX2L_E057", "edge_description": "voltage sensor is collected on switching devices"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `MYTXSX2L_E056` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | switching devices |  |
| 2 | `MYTXSX2L_E057` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | switching devices |  |
