...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `UTGG9GAR_E070` | `contains` | 05-Fault Mode | inner race fault |  | 06-Fault Severity | Single Severity |  |
| 2 | `UTGG9GAR_E071` | `contains` | 05-Fault Mode | outer race fault |  | 06-Fault Severity | Single Severity |  |
| 3 | `UTGG9GAR_E072` | `contains` | 05-Fault Mode | rolling element fault |  | 06-Fault Severity | Single Severity |  |
