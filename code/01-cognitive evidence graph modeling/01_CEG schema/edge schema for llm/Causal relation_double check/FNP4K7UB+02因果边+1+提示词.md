...
- **Reference ID**: FNP4K7UB
- **Paper Title**: L- and LCL-Filtered Grid-Tied Single-Phase Inverter Transistor Open-Circuit Fault Diagnosis Based on Post-Fault Reconfiguration Algorithms
...
> **Input Material**: Reference ID `FNP4K7UB` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "FNP4K7UB_E059", "edge_description": "voltage sensor is collected on transistor"},
    {"edge_id": "FNP4K7UB_E060", "edge_description": "current sensor is collected on transistor"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `FNP4K7UB_E059` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | transistor |  |
| 2 | `FNP4K7UB_E060` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | transistor |  |
