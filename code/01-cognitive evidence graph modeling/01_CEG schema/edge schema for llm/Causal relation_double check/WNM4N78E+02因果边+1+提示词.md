...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WNM4N78E_E028` | `is collected on` | 11-Sensor Information | LEM Voltage Transducer LV 25-P |  | 04-Fault Location | switch |  |
| 2 | `WNM4N78E_E029` | `is collected on` | 11-Sensor Information | LEM Current Transducer LA 55-P |  | 04-Fault Location | switch |  |
