...
- **Reference ID**: 7KQC7XQY
- **Paper Title**: A novel bearing intelligent fault diagnosis framework under time-varying working conditions using recurrent neural network
...
> **Input Material**: Reference ID `7KQC7XQY` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "7KQC7XQY_E080", "edge_description": "inner race fault contains concurrent faults in the outer race and roller"},
    {"edge_id": "7KQC7XQY_E081", "edge_description": "roller fault contains concurrent faults in the outer race and roller"},
    {"edge_id": "7KQC7XQY_E082", "edge_description": "outer race fault contains concurrent faults in the outer race and roller"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `7KQC7XQY_E080` | `contains` | 05-Fault Mode | inner race fault |  | 07-Compound Fault | concurrent faults in the outer race and roller(Compound Fault Within Same Structure) |  |
| 2 | `7KQC7XQY_E081` | `contains` | 05-Fault Mode | roller fault |  | 07-Compound Fault | concurrent faults in the outer race and roller(Compound Fault Within Same Structure) |  |
| 3 | `7KQC7XQY_E082` | `contains` | 05-Fault Mode | outer race fault |  | 07-Compound Fault | concurrent faults in the outer race and roller(Compound Fault Within Same Structure) |  |
