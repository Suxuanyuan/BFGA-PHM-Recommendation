...
- **Reference ID**: RZMVWKJD
- **Paper Title**: Quaternion Signal Analysis Algorithm for Induction Motor Fault Detection
...
> **Input Material**: Reference ID `RZMVWKJD` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "RZMVWKJD_E049", "edge_description": "MEMS-based accelerometer (LIS3L02AS4) is collected on bearing"},
    {"edge_id": "RZMVWKJD_E050", "edge_description": "MEMS-based accelerometer (LIS3L02AS4) is collected on motor shaft"},
    {"edge_id": "RZMVWKJD_E051", "edge_description": "current clamp (Fluke i200s) is collected on bearing"},
    {"edge_id": "RZMVWKJD_E052", "edge_description": "current clamp (Fluke i200s) is collected on motor shaft"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `RZMVWKJD_E049` | `is collected on` | 11-Sensor Information | MEMS-based accelerometer (LIS3L02AS4) |  | 04-Fault Location | bearing |  |
| 2 | `RZMVWKJD_E050` | `is collected on` | 11-Sensor Information | MEMS-based accelerometer (LIS3L02AS4) |  | 04-Fault Location | motor shaft |  |
| 3 | `RZMVWKJD_E051` | `is collected on` | 11-Sensor Information | current clamp (Fluke i200s) |  | 04-Fault Location | bearing |  |
| 4 | `RZMVWKJD_E052` | `is collected on` | 11-Sensor Information | current clamp (Fluke i200s) |  | 04-Fault Location | motor shaft |  |
