...
- **Reference ID**: 3CT5LE5W
- **Paper Title**: Time-frequency space vector modulus analysis of motor current for planetary gearbox fault diagnosis under variable speed conditions
...
> **Input Material**: Reference ID `3CT5LE5W` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "3CT5LE5W_E069", "edge_description": "Fluke 80i-110s AC/DC current clamps is collected on sun gear"},
    {"edge_id": "3CT5LE5W_E070", "edge_description": "Fluke 80i-110s AC/DC current clamps is collected on planet gear"},
    {"edge_id": "3CT5LE5W_E071", "edge_description": "Fluke 80i-110s AC/DC current clamps is collected on ring gear"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3CT5LE5W_E069` | `is collected on` | 11-Sensor Information | Fluke 80i-110s AC/DC current clamps |  | 04-Fault Location | sun gear |  |
| 2 | `3CT5LE5W_E070` | `is collected on` | 11-Sensor Information | Fluke 80i-110s AC/DC current clamps |  | 04-Fault Location | planet gear |  |
| 3 | `3CT5LE5W_E071` | `is collected on` | 11-Sensor Information | Fluke 80i-110s AC/DC current clamps |  | 04-Fault Location | ring gear |  |
