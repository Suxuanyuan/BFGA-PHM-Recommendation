...
- **Reference ID**: F9AYYCMG
- **Paper Title**: Conditional Adversarial Domain Adaptation With Discrimination Embedding for Locomotive Fault Diagnosis
...
> **Input Material**: Reference ID `F9AYYCMG` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `F9AYYCMG_E100` | `contains` | 05-Fault Mode | single-point faults (pitting) |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `F9AYYCMG_E101` | `contains` | 05-Fault Mode | bolt loosening |  | 07-Compound Fault | No Compound Fault |  |
| 3 | `F9AYYCMG_E102` | `contains` | 05-Fault Mode | balance weight falling off |  | 07-Compound Fault | No Compound Fault |  |
| 4 | `F9AYYCMG_E103` | `contains` | 05-Fault Mode | spline dislocation |  | 07-Compound Fault | No Compound Fault |  |
