...
- **Reference ID**: EE2E9FKF
- **Paper Title**: Evaluation of the Detectability of Electromechanical Faults in Induction Motors Via Transient Analysis of the Stray Flux
...
> **Input Material**: Reference ID `EE2E9FKF` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "EE2E9FKF_E041", "edge_description": "coil sensor is collected on induction motor rotor"},
    {"edge_id": "EE2E9FKF_E042", "edge_description": "coil sensor is collected on coupling / shaft"},
    {"edge_id": "EE2E9FKF_E043", "edge_description": "current sensor is collected on induction motor rotor"},
    {"edge_id": "EE2E9FKF_E044", "edge_description": "current sensor is collected on coupling / shaft"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `EE2E9FKF_E041` | `is collected on` | 11-Sensor Information | coil sensor |  | 04-Fault Location | induction motor rotor |  |
| 2 | `EE2E9FKF_E042` | `is collected on` | 11-Sensor Information | coil sensor |  | 04-Fault Location | coupling / shaft |  |
| 3 | `EE2E9FKF_E043` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | induction motor rotor |  |
| 4 | `EE2E9FKF_E044` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | coupling / shaft |  |
