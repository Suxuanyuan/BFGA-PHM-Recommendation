...
- **Reference ID**: 48BRDTDX
- **Paper Title**: Degradation Alignment in Remaining Useful Life Prediction Using Deep Cycle-Consistent Learning
...
> **Input Material**: Reference ID `48BRDTDX` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "48BRDTDX_E079", "edge_description": "turbofan engine contains turbofan engine"},
    {"edge_id": "48BRDTDX_E080", "edge_description": "turbofan engine contains rolling bearing"},
    {"edge_id": "48BRDTDX_E081", "edge_description": "rolling bearing contains turbofan engine"},
    {"edge_id": "48BRDTDX_E082", "edge_description": "rolling bearing contains rolling bearing"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `48BRDTDX_E079` | `contains` | 02-Object Type | turbofan engine |  | 04-Fault Location | turbofan engine |  |
| 2 | `48BRDTDX_E080` | `contains` | 02-Object Type | turbofan engine |  | 04-Fault Location | rolling bearing |  |
| 3 | `48BRDTDX_E081` | `contains` | 02-Object Type | rolling bearing |  | 04-Fault Location | turbofan engine |  |
| 4 | `48BRDTDX_E082` | `contains` | 02-Object Type | rolling bearing |  | 04-Fault Location | rolling bearing |  |
