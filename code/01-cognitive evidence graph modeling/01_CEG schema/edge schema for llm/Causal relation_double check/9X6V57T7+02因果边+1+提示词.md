...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `9X6V57T7_E062` | `contains` | 05-Fault Mode | discharge |  | 06-Fault Severity | Single Severity |  |
| 2 | `9X6V57T7_E063` | `contains` | 05-Fault Mode | thermal fault |  | 06-Fault Severity | Single Severity |  |
