...
- **Reference ID**: 333IWM53
- **Paper Title**: Fault diagnosis of rolling bearing using symmetrized dot pattern and density-based clustering
...
> **Input Material**: Reference ID `333IWM53` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "333IWM53_E058", "edge_description": "inner race fault contains compound faults"},
    {"edge_id": "333IWM53_E059", "edge_description": "outer race fault contains compound faults"},
    {"edge_id": "333IWM53_E060", "edge_description": "ball element fault contains compound faults"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `333IWM53_E058` | `contains` | 05-Fault Mode | inner race fault |  | 07-Compound Fault | compound faults(Compound Fault Within Same Structure) |  |
| 2 | `333IWM53_E059` | `contains` | 05-Fault Mode | outer race fault |  | 07-Compound Fault | compound faults(Compound Fault Within Same Structure) |  |
| 3 | `333IWM53_E060` | `contains` | 05-Fault Mode | ball element fault |  | 07-Compound Fault | compound faults(Compound Fault Within Same Structure) |  |
