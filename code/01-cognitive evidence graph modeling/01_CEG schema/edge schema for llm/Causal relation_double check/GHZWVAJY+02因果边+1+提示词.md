...
- **Reference ID**: GHZWVAJY
- **Paper Title**: Probability Analysis of Fault Diagnosis Performance for Satellite Attitude Control Systems
...
> **Input Material**: Reference ID `GHZWVAJY` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "GHZWVAJY_E073", "edge_description": "momentum wheel contains single operating condition"},
    {"edge_id": "GHZWVAJY_E074", "edge_description": "star sensor contains single operating condition"},
    {"edge_id": "GHZWVAJY_E075", "edge_description": "gyroscope contains single operating condition"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `GHZWVAJY_E073` | `contains` | 02-Object Type | momentum wheel |  | 03-Operating Conditions | single operating condition(Single Condition) |  |
| 2 | `GHZWVAJY_E074` | `contains` | 02-Object Type | star sensor |  | 03-Operating Conditions | single operating condition(Single Condition) |  |
| 3 | `GHZWVAJY_E075` | `contains` | 02-Object Type | gyroscope |  | 03-Operating Conditions | single operating condition(Single Condition) |  |
