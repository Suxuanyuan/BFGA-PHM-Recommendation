...
- **Reference ID**: DR52LA8J
- **Paper Title**: Voltage Difference Residual-Based Open-Circuit Fault Diagnosis Approach for Three-Level Converters in Electric Traction Systems
...
> **Input Material**: Reference ID `DR52LA8J` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "DR52LA8J_E098", "edge_description": "current sensor is collected on transistor"},
    {"edge_id": "DR52LA8J_E099", "edge_description": "current sensor is collected on clamp diode"},
    {"edge_id": "DR52LA8J_E100", "edge_description": "voltage sensor is collected on transistor"},
    {"edge_id": "DR52LA8J_E101", "edge_description": "voltage sensor is collected on clamp diode"},
    {"edge_id": "DR52LA8J_E102", "edge_description": "speed sensor is collected on transistor"},
    {"edge_id": "DR52LA8J_E103", "edge_description": "speed sensor is collected on clamp diode"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DR52LA8J_E098` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | transistor |  |
| 2 | `DR52LA8J_E099` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | clamp diode |  |
| 3 | `DR52LA8J_E100` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | transistor |  |
| 4 | `DR52LA8J_E101` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | clamp diode |  |
| 5 | `DR52LA8J_E102` | `is collected on` | 11-Sensor Information | speed sensor |  | 04-Fault Location | transistor |  |
| 6 | `DR52LA8J_E103` | `is collected on` | 11-Sensor Information | speed sensor |  | 04-Fault Location | clamp diode |  |
