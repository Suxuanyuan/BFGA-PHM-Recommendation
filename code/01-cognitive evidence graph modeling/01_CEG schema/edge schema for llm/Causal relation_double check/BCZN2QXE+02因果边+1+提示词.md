...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `BCZN2QXE_E063` | `contains` | 05-Fault Mode | inner race fault |  | 06-Fault Severity | Single Severity |  |
| 2 | `BCZN2QXE_E064` | `contains` | 05-Fault Mode | outer race fault |  | 06-Fault Severity | Single Severity |  |
| 3 | `BCZN2QXE_E065` | `contains` | 05-Fault Mode | ball fault |  | 06-Fault Severity | Single Severity |  |
