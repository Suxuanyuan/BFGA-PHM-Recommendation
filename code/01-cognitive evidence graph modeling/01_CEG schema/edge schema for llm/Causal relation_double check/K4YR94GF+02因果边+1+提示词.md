...
- **Reference ID**: K4YR94GF
- **Paper Title**: Quadrotor Actuator Fault Diagnosis and Accommodation Using Nonlinear Adaptive Estimators
...
> **Input Material**: Reference ID `K4YR94GF` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "K4YR94GF_E037", "edge_description": "IMU (Inertial Measurement Unit) is collected on rotor"},
    {"edge_id": "K4YR94GF_E038", "edge_description": "Vicon motion capture camera system is collected on rotor"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `K4YR94GF_E037` | `is collected on` | 11-Sensor Information | IMU (Inertial Measurement Unit) |  | 04-Fault Location | rotor |  |
| 2 | `K4YR94GF_E038` | `is collected on` | 11-Sensor Information | Vicon motion capture camera system |  | 04-Fault Location | rotor |  |
