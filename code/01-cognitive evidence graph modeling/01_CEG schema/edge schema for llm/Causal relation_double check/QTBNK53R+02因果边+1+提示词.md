...
- **Reference ID**: QTBNK53R
- **Paper Title**: Roller Element Bearing of Mine Ventilating Fan with Fault Diagnosis Based on Mechanics Properties and RBF Neural Network
...
> **Input Material**: Reference ID `QTBNK53R` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "QTBNK53R_E050", "edge_description": "roller element bearing contains roller element bearing"},
    {"edge_id": "QTBNK53R_E051", "edge_description": "roller element bearing contains rotor"},
    {"edge_id": "QTBNK53R_E053", "edge_description": "inner race fault contains composed fault"},
    {"edge_id": "QTBNK53R_E054", "edge_description": "unbalance fault contains composed fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QTBNK53R_E050` | `contains` | 02-Object Type | roller element bearing |  | 04-Fault Location | roller element bearing |  |
| 2 | `QTBNK53R_E051` | `contains` | 02-Object Type | roller element bearing |  | 04-Fault Location | rotor |  |
| 3 | `QTBNK53R_E053` | `contains` | 05-Fault Mode | inner race fault |  | 07-Compound Fault | composed fault(Compound Fault Across Structures) |  |
| 4 | `QTBNK53R_E054` | `contains` | 05-Fault Mode | unbalance fault |  | 07-Compound Fault | composed fault(Compound Fault Across Structures) |  |
