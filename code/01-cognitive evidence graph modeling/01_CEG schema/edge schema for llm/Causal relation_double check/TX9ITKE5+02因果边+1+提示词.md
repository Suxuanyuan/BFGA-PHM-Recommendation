...
```json
[
    {"edge_id": "TX9ITKE5_E098", "edge_description": "Current sensor is collected on Rotor bar"},
    {"edge_id": "TX9ITKE5_E099", "edge_description": "Current sensor is collected on Air gap"},
    {"edge_id": "TX9ITKE5_E100", "edge_description": "Current sensor is collected on Bearing"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TX9ITKE5_E098` | `is collected on` | 11-Sensor Information | Current sensor |  | 04-Fault Location | Rotor bar |  |
| 2 | `TX9ITKE5_E099` | `is collected on` | 11-Sensor Information | Current sensor |  | 04-Fault Location | Air gap |  |
| 3 | `TX9ITKE5_E100` | `is collected on` | 11-Sensor Information | Current sensor |  | 04-Fault Location | Bearing |  |
