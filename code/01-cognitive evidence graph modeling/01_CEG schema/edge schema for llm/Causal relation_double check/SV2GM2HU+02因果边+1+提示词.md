...
- **Reference ID**: SV2GM2HU
- **Paper Title**: An Integrated Feature-Based Failure Prognosis Method for Wind Turbine Bearings
...
> **Input Material**: Reference ID `SV2GM2HU` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "SV2GM2HU_E052", "edge_description": "spalling contains No Compound Fault"},
    {"edge_id": "SV2GM2HU_E053", "edge_description": "wear contains No Compound Fault"},
    {"edge_id": "SV2GM2HU_E055", "edge_description": "uniaxial piezoelectronic accelerometer can obviously reflect spalling"},
    {"edge_id": "SV2GM2HU_E056", "edge_description": "uniaxial piezoelectronic accelerometer can obviously reflect wear"},
    {"edge_id": "SV2GM2HU_E058", "edge_description": "bearing has_fault_mode spalling"},
    {"edge_id": "SV2GM2HU_E059", "edge_description": "bearing has_fault_mode wear"},
    {"edge_id": "SV2GM2HU_E060", "edge_description": "spalling contains degradation"},
    {"edge_id": "SV2GM2HU_E061", "edge_description": "wear contains degradation"},
    {"edge_id": "SV2GM2HU_E064", "edge_description": "spalling contains_phm_task Continuous monitoring and evaluation of depressive mood"},
    {"edge_id": "SV2GM2HU_E065", "edge_description": "wear contains_phm_task Continuous monitoring and evaluation of depressive mood"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SV2GM2HU_E052` | `contains` | 05-Fault Mode | spalling |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `SV2GM2HU_E053` | `contains` | 05-Fault Mode | wear |  | 07-Compound Fault | No Compound Fault |  |
| 3 | `SV2GM2HU_E055` | `can obviously reflect` | 11-Sensor Information | uniaxial piezoelectronic accelerometer |  | 05-Fault Mode | spalling |  |
| 4 | `SV2GM2HU_E056` | `can obviously reflect` | 11-Sensor Information | uniaxial piezoelectronic accelerometer |  | 05-Fault Mode | wear |  |
| 5 | `SV2GM2HU_E058` | `has_fault_mode` | 04-Fault Location | bearing |  | 05-Fault Mode | spalling |  |
| 6 | `SV2GM2HU_E059` | `has_fault_mode` | 04-Fault Location | bearing |  | 05-Fault Mode | wear |  |
| 7 | `SV2GM2HU_E060` | `contains` | 05-Fault Mode | spalling |  | 06-Fault Severity | degradation(Multiple Severities) |  |
| 8 | `SV2GM2HU_E061` | `contains` | 05-Fault Mode | wear |  | 06-Fault Severity | degradation(Multiple Severities) |  |
| 9 | `SV2GM2HU_E064` | `contains_phm_task` | 05-Fault Mode | spalling |  | 08-PHM Task | Continuous monitoring and evaluation of depressive mood(Assessment Task) |  |
| 10 | `SV2GM2HU_E065` | `contains_phm_task` | 05-Fault Mode | wear |  | 08-PHM Task | Continuous monitoring and evaluation of depressive mood(Assessment Task) |  |
