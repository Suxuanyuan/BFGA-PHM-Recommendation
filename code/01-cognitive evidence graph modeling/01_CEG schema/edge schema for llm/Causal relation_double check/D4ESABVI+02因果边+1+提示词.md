...
- **Reference ID**: D4ESABVI
- **Paper Title**: Fault diagnosis method for rolling bearings based on segment tensor rank-(Lr, Lr, 1) decomposition
...
> **Input Material**: Reference ID `D4ESABVI` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "D4ESABVI_E065", "edge_description": "acceleration sensor, PCB 353B33 high sensitive quartz accelerometer can obviously reflect pitting"},
    {"edge_id": "D4ESABVI_E066", "edge_description": "acceleration sensor, PCB 353B33 high sensitive quartz accelerometer can obviously reflect peeling"},
    {"edge_id": "D4ESABVI_E067", "edge_description": "acceleration sensor, PCB 353B33 high sensitive quartz accelerometer can obviously reflect scratched"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `D4ESABVI_E065` | `can obviously reflect` | 11-Sensor Information | acceleration sensor, PCB 353B33 high sensitive quartz accelerometer |  | 05-Fault Mode | pitting |  |
| 2 | `D4ESABVI_E066` | `can obviously reflect` | 11-Sensor Information | acceleration sensor, PCB 353B33 high sensitive quartz accelerometer |  | 05-Fault Mode | peeling |  |
| 3 | `D4ESABVI_E067` | `can obviously reflect` | 11-Sensor Information | acceleration sensor, PCB 353B33 high sensitive quartz accelerometer |  | 05-Fault Mode | scratched |  |
