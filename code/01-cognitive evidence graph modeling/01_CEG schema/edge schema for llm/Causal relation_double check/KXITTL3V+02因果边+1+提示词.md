...
- **Reference ID**: KXITTL3V
- **Paper Title**: Nonlinear Autoregressive Neural Network Models for Prediction of Transformer Oil-Dissolved Gas Concentrations
...
> **Input Material**: Reference ID `KXITTL3V` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "KXITTL3V_E055", "edge_description": "thermal faults contains No Compound Fault"},
    {"edge_id": "KXITTL3V_E056", "edge_description": "electrical faults contains No Compound Fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `KXITTL3V_E055` | `contains` | 05-Fault Mode | thermal faults |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `KXITTL3V_E056` | `contains` | 05-Fault Mode | electrical faults |  | 07-Compound Fault | No Compound Fault |  |
