...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AKUF543M_E070` | `contains` | 02-Object Type | diesel engine fuel injection system |  | 03-Operating Conditions | constant operating conditions(Single Condition) |  |
| 2 | `AKUF543M_E071` | `contains` | 02-Object Type | high pressure fuel pump |  | 03-Operating Conditions | constant operating conditions(Single Condition) |  |
| 3 | `AKUF543M_E072` | `contains` | 02-Object Type | high pressure pipe |  | 03-Operating Conditions | constant operating conditions(Single Condition) |  |
| 4 | `AKUF543M_E073` | `contains` | 05-Fault Mode | leak |  | 07-Compound Fault | No Compound Fault |  |
| 5 | `AKUF543M_E074` | `contains` | 05-Fault Mode | broken |  | 07-Compound Fault | No Compound Fault |  |
| 6 | `AKUF543M_E075` | `contains` | 05-Fault Mode | cavitation erosion |  | 07-Compound Fault | No Compound Fault |  |
| 7 | `AKUF543M_E076` | `contains` | 05-Fault Mode | carbon deposition |  | 07-Compound Fault | No Compound Fault |  |
| 8 | `AKUF543M_E077` | `contains` | 05-Fault Mode | stuck |  | 07-Compound Fault | No Compound Fault |  |
| 9 | `AKUF543M_E078` | `contains` | 05-Fault Mode | invalidation |  | 07-Compound Fault | No Compound Fault |  |
| 10 | `AKUF543M_E079` | `contains` | 05-Fault Mode | improper injection timing |  | 07-Compound Fault | No Compound Fault |  |
