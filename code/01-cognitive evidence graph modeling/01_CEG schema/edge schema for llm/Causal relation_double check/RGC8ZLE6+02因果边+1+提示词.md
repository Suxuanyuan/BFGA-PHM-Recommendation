...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `RGC8ZLE6_E039` | `contains` | 05-Fault Mode | degrading insulation |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `RGC8ZLE6_E040` | `contains` | 05-Fault Mode | overload |  | 07-Compound Fault | No Compound Fault |  |
| 3 | `RGC8ZLE6_E041` | `contains` | 05-Fault Mode | electrical faults |  | 07-Compound Fault | No Compound Fault |  |
