...
- **Reference ID**: ZDEJV878
- **Paper Title**: Diagnosis of Structural and Temporal Faults for k-Bounded Non-Markovian Stochastic Petri Nets
...
> **Input Material**: Reference ID `ZDEJV878` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "ZDEJV878_E020", "edge_description": "structural fault contains No Compound Fault"},
    {"edge_id": "ZDEJV878_E021", "edge_description": "temporal fault contains No Compound Fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZDEJV878_E020` | `contains` | 05-Fault Mode | structural fault |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `ZDEJV878_E021` | `contains` | 05-Fault Mode | temporal fault |  | 07-Compound Fault | No Compound Fault |  |
