...
- **Reference ID**: FZ8HPQWJ
- **Paper Title**: Joint Online RUL Prediction for Multivariate Deteriorating Systems
...
> **Input Material**: Reference ID `FZ8HPQWJ` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "FZ8HPQWJ_E039", "edge_description": "current sensor is collected on Lithium-ion battery"},
    {"edge_id": "FZ8HPQWJ_E040", "edge_description": "voltage sensor is collected on Lithium-ion battery"},
    {"edge_id": "FZ8HPQWJ_E041", "edge_description": "current sensor can obviously reflect capacity degradation"},
    {"edge_id": "FZ8HPQWJ_E042", "edge_description": "voltage sensor can obviously reflect capacity degradation"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `FZ8HPQWJ_E039` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | Lithium-ion battery |  |
| 2 | `FZ8HPQWJ_E040` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | Lithium-ion battery |  |
| 3 | `FZ8HPQWJ_E041` | `can obviously reflect` | 11-Sensor Information | current sensor |  | 05-Fault Mode | capacity degradation |  |
| 4 | `FZ8HPQWJ_E042` | `can obviously reflect` | 11-Sensor Information | voltage sensor |  | 05-Fault Mode | capacity degradation |  |
