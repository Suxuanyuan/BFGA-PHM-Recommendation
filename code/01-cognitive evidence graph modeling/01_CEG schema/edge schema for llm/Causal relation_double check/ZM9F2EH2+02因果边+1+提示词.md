...
- **Reference ID**: ZM9F2EH2
- **Paper Title**: A Robust Prescriptive Framework and Performance Metric for Diagnosing and Predicting Wind Turbine Faults Based on SCADA and Alarms Data with Case Study
...
> **Input Material**: Reference ID `ZM9F2EH2` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "ZM9F2EH2_E065", "edge_description": "temperature sensor is collected on pitch system"},
    {"edge_id": "ZM9F2EH2_E066", "edge_description": "current sensor is collected on pitch system"},
    {"edge_id": "ZM9F2EH2_E067", "edge_description": "voltage sensor is collected on pitch system"},
    {"edge_id": "ZM9F2EH2_E068", "edge_description": "anemometer is collected on pitch system"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZM9F2EH2_E065` | `is collected on` | 11-Sensor Information | temperature sensor |  | 04-Fault Location | pitch system |  |
| 2 | `ZM9F2EH2_E066` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | pitch system |  |
| 3 | `ZM9F2EH2_E067` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | pitch system |  |
| 4 | `ZM9F2EH2_E068` | `is collected on` | 11-Sensor Information | anemometer |  | 04-Fault Location | pitch system |  |
