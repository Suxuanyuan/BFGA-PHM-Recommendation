...
- **Reference ID**: AIFH7W9L
- **Paper Title**: A New Method for Power Converter Fault Diagnosis in SRM Drives
...
> **Input Material**: Reference ID `AIFH7W9L` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "AIFH7W9L_E045", "edge_description": "current sensor is collected on power switch"},
    {"edge_id": "AIFH7W9L_E046", "edge_description": "optical sensor is collected on power switch"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AIFH7W9L_E045` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | power switch |  |
| 2 | `AIFH7W9L_E046` | `is collected on` | 11-Sensor Information | optical sensor |  | 04-Fault Location | power switch |  |
