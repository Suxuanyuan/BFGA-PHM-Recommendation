...
- **Reference ID**: C7RS3X53
- **Paper Title**: Condition Parameter Modeling for Anomaly Detection in Wind Turbines
...
> **Input Material**: Reference ID `C7RS3X53` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "C7RS3X53_E069", "edge_description": "overheating fault contains Multiple Severities"},
    {"edge_id": "C7RS3X53_E070", "edge_description": "failure contains Multiple Severities"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `C7RS3X53_E069` | `contains` | 05-Fault Mode | overheating fault |  | 06-Fault Severity | Multiple Severities |  |
| 2 | `C7RS3X53_E070` | `contains` | 05-Fault Mode | failure |  | 06-Fault Severity | Multiple Severities |  |
