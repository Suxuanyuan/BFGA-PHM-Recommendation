...
- **Reference ID**: UINMMASF
- **Paper Title**: A case study of conditional deep convolutional generative adversarial networks in machine fault diagnosis
...
> **Input Material**: Reference ID `UINMMASF` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "UINMMASF_E091", "edge_description": "crack contains Fault size"},
    {"edge_id": "UINMMASF_E092", "edge_description": "wear contains Fault size"},
    {"edge_id": "UINMMASF_E093", "edge_description": "broken contains Fault size"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `UINMMASF_E091` | `contains` | 05-Fault Mode | crack |  | 06-Fault Severity | Fault size(Multiple Severities) |  |
| 2 | `UINMMASF_E092` | `contains` | 05-Fault Mode | wear |  | 06-Fault Severity | Fault size(Multiple Severities) |  |
| 3 | `UINMMASF_E093` | `contains` | 05-Fault Mode | broken |  | 06-Fault Severity | Fault size(Multiple Severities) |  |
