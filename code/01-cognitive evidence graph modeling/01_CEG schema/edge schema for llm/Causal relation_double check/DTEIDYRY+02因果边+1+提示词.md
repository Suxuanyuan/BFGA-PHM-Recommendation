...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DTEIDYRY_E066` | `is collected on` | 11-Sensor Information | water level measurement sensors |  | 04-Fault Location | valve 1 and valve 2 |  |
| 2 | `DTEIDYRY_E067` | `is collected on` | 11-Sensor Information | water level measurement sensors |  | 04-Fault Location | pump 2 |  |
| 3 | `DTEIDYRY_E068` | `is collected on` | 11-Sensor Information | water level measurement sensors |  | 04-Fault Location | water level measurement sensors |  |
