...
- **Reference ID**: H73ND9WK
- **Paper Title**: Logic-Based Methods for Intelligent Fault Diagnosis and Recovery in Power Electronics
...
> **Input Material**: Reference ID `H73ND9WK` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "H73ND9WK_E052", "edge_description": "open-circuit contains Single Severity"},
    {"edge_id": "H73ND9WK_E053", "edge_description": "short-circuit contains Single Severity"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `H73ND9WK_E052` | `contains` | 05-Fault Mode | open-circuit |  | 06-Fault Severity | Single Severity |  |
| 2 | `H73ND9WK_E053` | `contains` | 05-Fault Mode | short-circuit |  | 06-Fault Severity | Single Severity |  |
