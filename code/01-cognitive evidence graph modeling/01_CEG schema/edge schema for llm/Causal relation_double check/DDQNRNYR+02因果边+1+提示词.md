...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DDQNRNYR_E083` | `contains` | 02-Object Type | generator bearing |  | 03-Operating Conditions | constant operating conditions(Single Condition) |  |
| 2 | `DDQNRNYR_E084` | `contains` | 02-Object Type | gearbox |  | 03-Operating Conditions | constant operating conditions(Single Condition) |  |
