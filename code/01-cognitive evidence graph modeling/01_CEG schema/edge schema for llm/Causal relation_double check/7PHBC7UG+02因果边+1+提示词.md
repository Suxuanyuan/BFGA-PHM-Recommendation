...
- **Reference ID**: 7PHBC7UG
- **Paper Title**: Fault Diagnosis and Fault-Tolerant Control of Wind Turbines via a Discrete Time Controller with a Disturbance Compensator
...
> **Input Material**: Reference ID `7PHBC7UG` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "7PHBC7UG_E067", "edge_description": "generator speed sensor is collected on pitch actuator"},
    {"edge_id": "7PHBC7UG_E068", "edge_description": "accelerometer is collected on pitch actuator"},
    {"edge_id": "7PHBC7UG_E069", "edge_description": "generator speed sensor can obviously reflect high air content in oil"},
    {"edge_id": "7PHBC7UG_E070", "edge_description": "generator speed sensor can obviously reflect pump wear"},
    {"edge_id": "7PHBC7UG_E071", "edge_description": "generator speed sensor can obviously reflect hydraulic leakage"},
    {"edge_id": "7PHBC7UG_E072", "edge_description": "accelerometer can obviously reflect high air content in oil"},
    {"edge_id": "7PHBC7UG_E073", "edge_description": "accelerometer can obviously reflect pump wear"},
    {"edge_id": "7PHBC7UG_E074", "edge_description": "accelerometer can obviously reflect hydraulic leakage"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `7PHBC7UG_E067` | `is collected on` | 11-Sensor Information | generator speed sensor |  | 04-Fault Location | pitch actuator |  |
| 2 | `7PHBC7UG_E068` | `is collected on` | 11-Sensor Information | accelerometer |  | 04-Fault Location | pitch actuator |  |
| 3 | `7PHBC7UG_E069` | `can obviously reflect` | 11-Sensor Information | generator speed sensor |  | 05-Fault Mode | high air content in oil |  |
| 4 | `7PHBC7UG_E070` | `can obviously reflect` | 11-Sensor Information | generator speed sensor |  | 05-Fault Mode | pump wear |  |
| 5 | `7PHBC7UG_E071` | `can obviously reflect` | 11-Sensor Information | generator speed sensor |  | 05-Fault Mode | hydraulic leakage |  |
| 6 | `7PHBC7UG_E072` | `can obviously reflect` | 11-Sensor Information | accelerometer |  | 05-Fault Mode | high air content in oil |  |
| 7 | `7PHBC7UG_E073` | `can obviously reflect` | 11-Sensor Information | accelerometer |  | 05-Fault Mode | pump wear |  |
| 8 | `7PHBC7UG_E074` | `can obviously reflect` | 11-Sensor Information | accelerometer |  | 05-Fault Mode | hydraulic leakage |  |
