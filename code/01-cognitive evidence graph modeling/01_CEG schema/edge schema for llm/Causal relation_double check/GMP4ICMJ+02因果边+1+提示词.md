...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `GMP4ICMJ_E029` | `is collected on` | 11-Sensor Information | voltage sensors |  | 04-Fault Location | IGBT |  |
| 2 | `GMP4ICMJ_E030` | `is collected on` | 11-Sensor Information | voltage sensors |  | 04-Fault Location | diode |  |
| 3 | `GMP4ICMJ_E031` | `is collected on` | 11-Sensor Information | current sensors |  | 04-Fault Location | IGBT |  |
| 4 | `GMP4ICMJ_E032` | `is collected on` | 11-Sensor Information | current sensors |  | 04-Fault Location | diode |  |
