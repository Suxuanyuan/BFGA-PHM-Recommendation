...
- **Reference ID**: D5ANNL6H
- **Paper Title**: Rolling Bearing Fault Diagnosis With Adaptive Harmonic Kurtosis and Improved Bat Algorithm
...
> **Input Material**: Reference ID `D5ANNL6H` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "D5ANNL6H_E088", "edge_description": "inner race fault contains Single Severity"},
    {"edge_id": "D5ANNL6H_E089", "edge_description": "outer race fault contains Single Severity"},
    {"edge_id": "D5ANNL6H_E090", "edge_description": "rolling element fault contains Single Severity"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `D5ANNL6H_E088` | `contains` | 05-Fault Mode | inner race fault |  | 06-Fault Severity | Single Severity |  |
| 2 | `D5ANNL6H_E089` | `contains` | 05-Fault Mode | outer race fault |  | 06-Fault Severity | Single Severity |  |
| 3 | `D5ANNL6H_E090` | `contains` | 05-Fault Mode | rolling element fault |  | 06-Fault Severity | Single Severity |  |
