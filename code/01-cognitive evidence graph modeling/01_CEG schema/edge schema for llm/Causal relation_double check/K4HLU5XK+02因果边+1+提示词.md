...
- **Reference ID**: K4HLU5XK
- **Paper Title**: Experimental diagnosis of broken rotor bars fault in induction machine based on Hilbert and discrete wavelet transforms
...
> **Input Material**: Reference ID `K4HLU5XK` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "K4HLU5XK_E056", "edge_description": "Hall type current sensors is collected on rotor bar"},
    {"edge_id": "K4HLU5XK_E057", "edge_description": "voltage sensors is collected on rotor bar"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `K4HLU5XK_E056` | `is collected on` | 11-Sensor Information | Hall type current sensors |  | 04-Fault Location | rotor bar |  |
| 2 | `K4HLU5XK_E057` | `is collected on` | 11-Sensor Information | voltage sensors |  | 04-Fault Location | rotor bar |  |
