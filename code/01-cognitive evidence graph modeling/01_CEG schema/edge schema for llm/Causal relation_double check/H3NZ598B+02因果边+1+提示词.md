...
- **Reference ID**: H3NZ598B
- **Paper Title**: A Novel Framework for Fault Diagnosis Using Kernel Partial Least Squares Based on an Optimal Preference Matrix
...
> **Input Material**: Reference ID `H3NZ598B` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "H3NZ598B_E099", "edge_description": "Tennessee Eastman process contains steady operating conditions"},
    {"edge_id": "H3NZ598B_E100", "edge_description": "aluminum reduction cell contains steady operating conditions"},
    {"edge_id": "H3NZ598B_E105", "edge_description": "current sensor is collected on cathode"},
    {"edge_id": "H3NZ598B_E106", "edge_description": "current sensor is collected on anode"},
    {"edge_id": "H3NZ598B_E107", "edge_description": "voltage sensor is collected on cathode"},
    {"edge_id": "H3NZ598B_E108", "edge_description": "voltage sensor is collected on anode"},
    {"edge_id": "H3NZ598B_E109", "edge_description": "temperature sensor is collected on cathode"},
    {"edge_id": "H3NZ598B_E110", "edge_description": "temperature sensor is collected on anode"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `H3NZ598B_E099` | `contains` | 02-Object Type | Tennessee Eastman process |  | 03-Operating Conditions | steady operating conditions(Single Condition) |  |
| 2 | `H3NZ598B_E100` | `contains` | 02-Object Type | aluminum reduction cell |  | 03-Operating Conditions | steady operating conditions(Single Condition) |  |
| 3 | `H3NZ598B_E105` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | cathode |  |
| 4 | `H3NZ598B_E106` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | anode |  |
| 5 | `H3NZ598B_E107` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | cathode |  |
| 6 | `H3NZ598B_E108` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | anode |  |
| 7 | `H3NZ598B_E109` | `is collected on` | 11-Sensor Information | temperature sensor |  | 04-Fault Location | cathode |  |
| 8 | `H3NZ598B_E110` | `is collected on` | 11-Sensor Information | temperature sensor |  | 04-Fault Location | anode |  |
