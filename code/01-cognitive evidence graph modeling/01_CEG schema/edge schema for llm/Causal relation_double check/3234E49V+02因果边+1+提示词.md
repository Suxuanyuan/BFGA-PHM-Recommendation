...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3234E49V_E061` | `contains` | 02-Object Type | fluidized catalytic cracking unit (FCCU) |  | 03-Operating Conditions | steady-state operating condition(Single Condition) |  |
| 2 | `3234E49V_E062` | `contains` | 02-Object Type | riser reactor |  | 03-Operating Conditions | steady-state operating condition(Single Condition) |  |
| 3 | `3234E49V_E063` | `contains` | 02-Object Type | regenerator |  | 03-Operating Conditions | steady-state operating condition(Single Condition) |  |
