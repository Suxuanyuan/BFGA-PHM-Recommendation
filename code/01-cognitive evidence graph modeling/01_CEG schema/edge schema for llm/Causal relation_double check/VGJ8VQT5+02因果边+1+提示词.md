...
- **Reference ID**: VGJ8VQT5
- **Paper Title**: A novel approach for analog circuit fault diagnosis based on Deep Belief Network
...
> **Input Material**: Reference ID `VGJ8VQT5` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "VGJ8VQT5_E064", "edge_description": "output of the amplifier is collected on resistors"},
    {"edge_id": "VGJ8VQT5_E065", "edge_description": "output of the amplifier is collected on capacitors"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VGJ8VQT5_E064` | `is collected on` | 11-Sensor Information | output of the amplifier |  | 04-Fault Location | resistors |  |
| 2 | `VGJ8VQT5_E065` | `is collected on` | 11-Sensor Information | output of the amplifier |  | 04-Fault Location | capacitors |  |
