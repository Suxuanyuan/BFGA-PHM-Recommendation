...
- **Reference ID**: QANSK4QU
- **Paper Title**: Amplification of Single Mechanical Fault Signatures Using Full Adaptive PMSM Observer
...
> **Input Material**: Reference ID `QANSK4QU` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "QANSK4QU_E064", "edge_description": "Permanent Magnet Synchronous Machine (PMSM) contains sprocket"},
    {"edge_id": "QANSK4QU_E065", "edge_description": "Permanent Magnet Synchronous Machine (PMSM) contains coupling"},
    {"edge_id": "QANSK4QU_E066", "edge_description": "bearing contains sprocket"},
    {"edge_id": "QANSK4QU_E067", "edge_description": "bearing contains coupling"},
    {"edge_id": "QANSK4QU_E068", "edge_description": "gearbox contains sprocket"},
    {"edge_id": "QANSK4QU_E069", "edge_description": "gearbox contains coupling"},
    {"edge_id": "QANSK4QU_E074", "edge_description": "current sensor is collected on sprocket"},
    {"edge_id": "QANSK4QU_E075", "edge_description": "current sensor is collected on coupling"},
    {"edge_id": "QANSK4QU_E076", "edge_description": "voltage sensor is collected on sprocket"},
    {"edge_id": "QANSK4QU_E077", "edge_description": "voltage sensor is collected on coupling"},
    {"edge_id": "QANSK4QU_E078", "edge_description": "incremental encoder is collected on sprocket"},
    {"edge_id": "QANSK4QU_E079", "edge_description": "incremental encoder is collected on coupling"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QANSK4QU_E064` | `contains` | 02-Object Type | Permanent Magnet Synchronous Machine (PMSM) |  | 04-Fault Location | sprocket |  |
| 2 | `QANSK4QU_E065` | `contains` | 02-Object Type | Permanent Magnet Synchronous Machine (PMSM) |  | 04-Fault Location | coupling |  |
| 3 | `QANSK4QU_E066` | `contains` | 02-Object Type | bearing |  | 04-Fault Location | sprocket |  |
| 4 | `QANSK4QU_E067` | `contains` | 02-Object Type | bearing |  | 04-Fault Location | coupling |  |
| 5 | `QANSK4QU_E068` | `contains` | 02-Object Type | gearbox |  | 04-Fault Location | sprocket |  |
| 6 | `QANSK4QU_E069` | `contains` | 02-Object Type | gearbox |  | 04-Fault Location | coupling |  |
| 7 | `QANSK4QU_E074` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | sprocket |  |
| 8 | `QANSK4QU_E075` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | coupling |  |
| 9 | `QANSK4QU_E076` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | sprocket |  |
| 10 | `QANSK4QU_E077` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | coupling |  |
| 11 | `QANSK4QU_E078` | `is collected on` | 11-Sensor Information | incremental encoder |  | 04-Fault Location | sprocket |  |
| 12 | `QANSK4QU_E079` | `is collected on` | 11-Sensor Information | incremental encoder |  | 04-Fault Location | coupling |  |
