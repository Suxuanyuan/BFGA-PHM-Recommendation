...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QU33MX82_E106` | `contains` | 05-Fault Mode | rub |  | 06-Fault Severity | health degradation(Multiple Severities) |  |
| 2 | `QU33MX82_E107` | `contains` | 05-Fault Mode | pit |  | 06-Fault Severity | health degradation(Multiple Severities) |  |
