...
- **Reference ID**: W68HMZEC
- **Paper Title**: Current-Based Mechanical Fault Detection for Direct-Drive Wind Turbines via Synchronous Sampling and Impulse Detection
...
> **Input Material**: Reference ID `W68HMZEC` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "W68HMZEC_E065", "edge_description": "Fluke 80i-110s AC/DC current clamp is collected on rotor"},
    {"edge_id": "W68HMZEC_E066", "edge_description": "Fluke 80i-110s AC/DC current clamp is collected on bearing"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `W68HMZEC_E065` | `is collected on` | 11-Sensor Information | Fluke 80i-110s AC/DC current clamp |  | 04-Fault Location | rotor |  |
| 2 | `W68HMZEC_E066` | `is collected on` | 11-Sensor Information | Fluke 80i-110s AC/DC current clamp |  | 04-Fault Location | bearing |  |
