...
- **Reference ID**: EPI9LJ3F
- **Paper Title**: A New Deep Convolutional Domain Adaptation Network for Bearing Fault Diagnosis under Different Working Conditions
...
> **Input Material**: Reference ID `EPI9LJ3F` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "EPI9LJ3F_E076", "edge_description": "inner-race fault contains compound fault (OF and BF)"},
    {"edge_id": "EPI9LJ3F_E077", "edge_description": "outer-race fault contains compound fault (OF and BF)"},
    {"edge_id": "EPI9LJ3F_E078", "edge_description": "ball fault contains compound fault (OF and BF)"},
    {"edge_id": "EPI9LJ3F_E079", "edge_description": "roller fault contains compound fault (OF and BF)"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `EPI9LJ3F_E076` | `contains` | 05-Fault Mode | inner-race fault |  | 07-Compound Fault | compound fault (OF and BF)(Compound Fault Within Same Structure) |  |
| 2 | `EPI9LJ3F_E077` | `contains` | 05-Fault Mode | outer-race fault |  | 07-Compound Fault | compound fault (OF and BF)(Compound Fault Within Same Structure) |  |
| 3 | `EPI9LJ3F_E078` | `contains` | 05-Fault Mode | ball fault |  | 07-Compound Fault | compound fault (OF and BF)(Compound Fault Within Same Structure) |  |
| 4 | `EPI9LJ3F_E079` | `contains` | 05-Fault Mode | roller fault |  | 07-Compound Fault | compound fault (OF and BF)(Compound Fault Within Same Structure) |  |
