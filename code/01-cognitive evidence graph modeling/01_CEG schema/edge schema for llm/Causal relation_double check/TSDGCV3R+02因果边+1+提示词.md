...
- **Reference ID**: TSDGCV3R
- **Paper Title**: Sensor selection in neuro-fuzzy modelling and fault diagnosis in HVAC system
...
> **Input Material**: Reference ID `TSDGCV3R` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "TSDGCV3R_E101", "edge_description": "incipient sensor fault contains incipient sensor fault, abrupt sensor fault"},
    {"edge_id": "TSDGCV3R_E102", "edge_description": "abrupt sensor fault contains incipient sensor fault, abrupt sensor fault"},
    {"edge_id": "TSDGCV3R_E103", "edge_description": "air fouling fault contains incipient sensor fault, abrupt sensor fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TSDGCV3R_E101` | `contains` | 05-Fault Mode | incipient sensor fault |  | 06-Fault Severity | incipient sensor fault, abrupt sensor fault(Multiple Severities) |  |
| 2 | `TSDGCV3R_E102` | `contains` | 05-Fault Mode | abrupt sensor fault |  | 06-Fault Severity | incipient sensor fault, abrupt sensor fault(Multiple Severities) |  |
| 3 | `TSDGCV3R_E103` | `contains` | 05-Fault Mode | air fouling fault |  | 06-Fault Severity | incipient sensor fault, abrupt sensor fault(Multiple Severities) |  |
