...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ETGC7BHB_E060` | `contains` | 02-Object Type | Ni-MH battery |  | 04-Fault Location | solar array |  |
| 2 | `ETGC7BHB_E061` | `contains` | 02-Object Type | solar array |  | 04-Fault Location | solar array |  |
| 3 | `ETGC7BHB_E065` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | solar array |  |
| 4 | `ETGC7BHB_E066` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | solar array |  |
| 5 | `ETGC7BHB_E067` | `is collected on` | 11-Sensor Information | pressure sensor |  | 04-Fault Location | solar array |  |
