...
- **Reference ID**: 8TERVMKA
- **Paper Title**: A Real-Time Multiple Open-Circuit Fault Diagnosis Method in Voltage-Source-Inverter Fed Vector Controlled Drives
...
> **Input Material**: Reference ID `8TERVMKA` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "8TERVMKA_E044", "edge_description": "current sensor is collected on transistor"},
    {"edge_id": "8TERVMKA_E045", "edge_description": "speed sensor is collected on transistor"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `8TERVMKA_E044` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | transistor |  |
| 2 | `8TERVMKA_E045` | `is collected on` | 11-Sensor Information | speed sensor |  | 04-Fault Location | transistor |  |
