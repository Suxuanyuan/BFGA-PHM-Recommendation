...
- **Reference ID**: K49QH4M7
- **Paper Title**: DC-NNMN: Across Components Fault Diagnosis Based on Deep Few-Shot Learning
...
> **Input Material**: Reference ID `K49QH4M7` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "K49QH4M7_E075", "edge_description": "pitting contains B and OF"},
    {"edge_id": "K49QH4M7_E076", "edge_description": "crack contains B and OF"},
    {"edge_id": "K49QH4M7_E077", "edge_description": "spall contains B and OF"},
    {"edge_id": "K49QH4M7_E078", "edge_description": "missing contains B and OF"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `K49QH4M7_E075` | `contains` | 05-Fault Mode | pitting |  | 07-Compound Fault | B and OF(Compound Fault Within Same Structure) |  |
| 2 | `K49QH4M7_E076` | `contains` | 05-Fault Mode | crack |  | 07-Compound Fault | B and OF(Compound Fault Within Same Structure) |  |
| 3 | `K49QH4M7_E077` | `contains` | 05-Fault Mode | spall |  | 07-Compound Fault | B and OF(Compound Fault Within Same Structure) |  |
| 4 | `K49QH4M7_E078` | `contains` | 05-Fault Mode | missing |  | 07-Compound Fault | B and OF(Compound Fault Within Same Structure) |  |
