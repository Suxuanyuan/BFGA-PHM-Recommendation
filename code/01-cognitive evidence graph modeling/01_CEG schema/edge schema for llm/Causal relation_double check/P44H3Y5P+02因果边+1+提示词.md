...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `P44H3Y5P_E025` | `contains` | 05-Fault Mode | bias faults |  | 06-Fault Severity | bf = 2 cos(x1x2), gf = 1 + 0.2 sin(u)(Single Severity) |  |
| 2 | `P44H3Y5P_E026` | `contains` | 05-Fault Mode | gain faults |  | 06-Fault Severity | bf = 2 cos(x1x2), gf = 1 + 0.2 sin(u)(Single Severity) |  |
