...
- **Reference ID**: J5N27NKZ
- **Paper Title**: Fault diagnosis for underdetermined multistage assembly processes via an enhanced Bayesian hierarchical model
...
> **Input Material**: Reference ID `J5N27NKZ` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "J5N27NKZ_E059", "edge_description": "moving distance modification error contains combination of abnormal r12 and r15"},
    {"edge_id": "J5N27NKZ_E060", "edge_description": "radial error of the pin gear contains combination of abnormal r12 and r15"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `J5N27NKZ_E059` | `contains` | 05-Fault Mode | moving distance modification error |  | 07-Compound Fault | combination of abnormal r12 and r15(Compound Fault Within Same Structure) |  |
| 2 | `J5N27NKZ_E060` | `contains` | 05-Fault Mode | radial error of the pin gear |  | 07-Compound Fault | combination of abnormal r12 and r15(Compound Fault Within Same Structure) |  |
