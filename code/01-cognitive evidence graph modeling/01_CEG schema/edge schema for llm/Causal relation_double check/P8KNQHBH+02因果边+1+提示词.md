...
- **Reference ID**: P8KNQHBH
- **Paper Title**: A Shape-Constrained Neural Data Fusion Network for Health Index Construction and Residual Life Prediction
...
> **Input Material**: Reference ID `P8KNQHBH` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "P8KNQHBH_E069", "edge_description": "T24, T30 (Total temperature at LPC outlet, Total temperature at HPC outlet) is collected on High Pressure Compressor (HPC)"},
    {"edge_id": "P8KNQHBH_E070", "edge_description": "Nc (Physical core speed) is collected on High Pressure Compressor (HPC)"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `P8KNQHBH_E069` | `is collected on` | 11-Sensor Information | T24, T30 (Total temperature at LPC outlet, Total temperature at HPC outlet) |  | 04-Fault Location | High Pressure Compressor (HPC) |  |
| 2 | `P8KNQHBH_E070` | `is collected on` | 11-Sensor Information | Nc (Physical core speed) |  | 04-Fault Location | High Pressure Compressor (HPC) |  |
