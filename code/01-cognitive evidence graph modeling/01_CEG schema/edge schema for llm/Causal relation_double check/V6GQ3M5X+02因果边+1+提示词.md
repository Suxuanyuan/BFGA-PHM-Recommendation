...
- **Reference ID**: V6GQ3M5X
- **Paper Title**: Lithium-ion battery state of health monitoring and remaining useful life prediction based on support vector regression-particle filter
...
> **Input Material**: Reference ID `V6GQ3M5X` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "V6GQ3M5X_E076", "edge_description": "voltage can obviously reflect capacity degradation"},
    {"edge_id": "V6GQ3M5X_E077", "edge_description": "voltage can obviously reflect impedance increase"},
    {"edge_id": "V6GQ3M5X_E078", "edge_description": "current can obviously reflect capacity degradation"},
    {"edge_id": "V6GQ3M5X_E079", "edge_description": "current can obviously reflect impedance increase"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `V6GQ3M5X_E076` | `can obviously reflect` | 11-Sensor Information | voltage |  | 05-Fault Mode | capacity degradation |  |
| 2 | `V6GQ3M5X_E077` | `can obviously reflect` | 11-Sensor Information | voltage |  | 05-Fault Mode | impedance increase |  |
| 3 | `V6GQ3M5X_E078` | `can obviously reflect` | 11-Sensor Information | current |  | 05-Fault Mode | capacity degradation |  |
| 4 | `V6GQ3M5X_E079` | `can obviously reflect` | 11-Sensor Information | current |  | 05-Fault Mode | impedance increase |  |
