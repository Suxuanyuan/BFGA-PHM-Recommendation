...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `G2A8AS96_E076` | `contains` | 02-Object Type | motor bearing |  | 03-Operating Conditions | motor speed of 1797RPM, sampling rate of 500HZ(Single Condition) |  |
| 2 | `G2A8AS96_E077` | `contains` | 02-Object Type | submersible plunger pump |  | 03-Operating Conditions | motor speed of 1797RPM, sampling rate of 500HZ(Single Condition) |  |
