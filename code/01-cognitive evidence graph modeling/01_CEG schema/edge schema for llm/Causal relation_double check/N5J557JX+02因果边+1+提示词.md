...
- **Reference ID**: N5J557JX
- **Paper Title**: A Noise-Boosted Remaining Useful Life Prediction Method for Rotating Machines Under Different Conditions
...
> **Input Material**: Reference ID `N5J557JX` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "N5J557JX_E059", "edge_description": "failure of a high-pressure compressor contains failure of a high-pressure compressor and fan"},
    {"edge_id": "N5J557JX_E060", "edge_description": "failure of a fan contains failure of a high-pressure compressor and fan"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `N5J557JX_E059` | `contains` | 05-Fault Mode | failure of a high-pressure compressor |  | 07-Compound Fault | failure of a high-pressure compressor and fan(Compound Fault Across Structures) |  |
| 2 | `N5J557JX_E060` | `contains` | 05-Fault Mode | failure of a fan |  | 07-Compound Fault | failure of a high-pressure compressor and fan(Compound Fault Across Structures) |  |
