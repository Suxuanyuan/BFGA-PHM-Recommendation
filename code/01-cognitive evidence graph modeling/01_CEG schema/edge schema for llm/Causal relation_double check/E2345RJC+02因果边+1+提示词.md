...
- **Reference ID**: E2345RJC
- **Paper Title**: Improved CICA Algorithm Used for Single Channel Compound Fault Diagnosis of Rolling Bearings
...
> **Input Material**: Reference ID `E2345RJC` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "E2345RJC_E060", "edge_description": "outer-race defect contains Single Severity"},
    {"edge_id": "E2345RJC_E061", "edge_description": "roller defect contains Single Severity"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `E2345RJC_E060` | `contains` | 05-Fault Mode | outer-race defect |  | 06-Fault Severity | Single Severity |  |
| 2 | `E2345RJC_E061` | `contains` | 05-Fault Mode | roller defect |  | 06-Fault Severity | Single Severity |  |
