...
- **Reference ID**: HR5BVAIZ
- **Paper Title**: Fault diagnosis model based on Granular Computing and Echo State Network
...
> **Input Material**: Reference ID `HR5BVAIZ` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "HR5BVAIZ_E069", "edge_description": "voltage sensor is collected on SYS board"},
    {"edge_id": "HR5BVAIZ_E070", "edge_description": "voltage sensor is collected on FI board"},
    {"edge_id": "HR5BVAIZ_E071", "edge_description": "voltage sensor is collected on AGC board"},
    {"edge_id": "HR5BVAIZ_E072", "edge_description": "current sensor is collected on SYS board"},
    {"edge_id": "HR5BVAIZ_E073", "edge_description": "current sensor is collected on FI board"},
    {"edge_id": "HR5BVAIZ_E074", "edge_description": "current sensor is collected on AGC board"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HR5BVAIZ_E069` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | SYS board |  |
| 2 | `HR5BVAIZ_E070` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | FI board |  |
| 3 | `HR5BVAIZ_E071` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | AGC board |  |
| 4 | `HR5BVAIZ_E072` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | SYS board |  |
| 5 | `HR5BVAIZ_E073` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | FI board |  |
| 6 | `HR5BVAIZ_E074` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | AGC board |  |
