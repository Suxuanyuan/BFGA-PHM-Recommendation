...
- **Reference ID**: 6ERHXUDP
- **Paper Title**: Toward Self-Supervised Feature Learning for Online Diagnosis of Multiple Faults in Electric Powertrains
...
> **Input Material**: Reference ID `6ERHXUDP` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "6ERHXUDP_E133", "edge_description": "tooth damage, broken tooth contains GF1, GF2, GF3, BF1, BF2, BF3, SF1, SF2"},
    {"edge_id": "6ERHXUDP_E134", "edge_description": "outer-race defects contains GF1, GF2, GF3, BF1, BF2, BF3, SF1, SF2"},
    {"edge_id": "6ERHXUDP_E135", "edge_description": "inter-turn short circuit contains GF1, GF2, GF3, BF1, BF2, BF3, SF1, SF2"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `6ERHXUDP_E133` | `contains` | 05-Fault Mode | tooth damage, broken tooth |  | 06-Fault Severity | GF1, GF2, GF3, BF1, BF2, BF3, SF1, SF2(Multiple Severities) |  |
| 2 | `6ERHXUDP_E134` | `contains` | 05-Fault Mode | outer-race defects |  | 06-Fault Severity | GF1, GF2, GF3, BF1, BF2, BF3, SF1, SF2(Multiple Severities) |  |
| 3 | `6ERHXUDP_E135` | `contains` | 05-Fault Mode | inter-turn short circuit |  | 06-Fault Severity | GF1, GF2, GF3, BF1, BF2, BF3, SF1, SF2(Multiple Severities) |  |
