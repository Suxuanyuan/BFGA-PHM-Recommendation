...
- **Reference ID**: EF6K495H
- **Paper Title**: Deep normalized convolutional neural network for imbalanced fault classification of machinery and its understanding via visualization
...
> **Input Material**: Reference ID `EF6K495H` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "EF6K495H_E055", "edge_description": "roller fault contains compound faults"},
    {"edge_id": "EF6K495H_E056", "edge_description": "inner race fault contains compound faults"},
    {"edge_id": "EF6K495H_E057", "edge_description": "outer race fault contains compound faults"},
    {"edge_id": "EF6K495H_E066", "edge_description": "roller fault contains Single Severity"},
    {"edge_id": "EF6K495H_E067", "edge_description": "inner race fault contains Single Severity"},
    {"edge_id": "EF6K495H_E068", "edge_description": "outer race fault contains Single Severity"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `EF6K495H_E055` | `contains` | 05-Fault Mode | roller fault |  | 07-Compound Fault | compound faults(Compound Fault Within Same Structure) |  |
| 2 | `EF6K495H_E056` | `contains` | 05-Fault Mode | inner race fault |  | 07-Compound Fault | compound faults(Compound Fault Within Same Structure) |  |
| 3 | `EF6K495H_E057` | `contains` | 05-Fault Mode | outer race fault |  | 07-Compound Fault | compound faults(Compound Fault Within Same Structure) |  |
| 4 | `EF6K495H_E066` | `contains` | 05-Fault Mode | roller fault |  | 06-Fault Severity | Single Severity |  |
| 5 | `EF6K495H_E067` | `contains` | 05-Fault Mode | inner race fault |  | 06-Fault Severity | Single Severity |  |
| 6 | `EF6K495H_E068` | `contains` | 05-Fault Mode | outer race fault |  | 06-Fault Severity | Single Severity |  |
