...
- **Reference ID**: 9JWJKQJU
- **Paper Title**: An MRAS-Based Diagnosis of Open-Circuit Fault in PWM Voltage-Source Inverters for PM Synchronous Motor Drive Systems
...
> **Input Material**: Reference ID `9JWJKQJU` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "9JWJKQJU_E037", "edge_description": "permanent magnet synchronous motor contains PWM voltage-source inverter"},
    {"edge_id": "9JWJKQJU_E038", "edge_description": "permanent magnet synchronous motor contains permanent magnet synchronous motor"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `9JWJKQJU_E037` | `contains` | 01-Object Domain | permanent magnet synchronous motor(Electronics) |  | 02-Object Type | PWM voltage-source inverter |  |
| 2 | `9JWJKQJU_E038` | `contains` | 01-Object Domain | permanent magnet synchronous motor(Electronics) |  | 02-Object Type | permanent magnet synchronous motor |  |
