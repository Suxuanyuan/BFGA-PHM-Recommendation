...
- **Reference ID**: MSF9BP78
- **Paper Title**: Intelligent fault monitoring and diagnosis in electrical machines
...
> **Input Material**: Reference ID `MSF9BP78` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "MSF9BP78_E025", "edge_description": "speed sensor is collected on bearing"},
    {"edge_id": "MSF9BP78_E026", "edge_description": "current sensor is collected on bearing"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `MSF9BP78_E025` | `is collected on` | 11-Sensor Information | speed sensor |  | 04-Fault Location | bearing |  |
| 2 | `MSF9BP78_E026` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | bearing |  |
