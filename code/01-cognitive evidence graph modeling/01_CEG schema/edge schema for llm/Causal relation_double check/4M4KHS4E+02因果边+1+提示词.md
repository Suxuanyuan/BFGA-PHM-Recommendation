...
- **Reference ID**: 4M4KHS4E
- **Paper Title**: Generative Adversarial Networks With Comprehensive Wavelet Feature for Fault Diagnosis of Analog Circuits
...
> **Input Material**: Reference ID `4M4KHS4E` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "4M4KHS4E_E082", "edge_description": "digital oscilloscope / Output voltage measurement is collected on resistor"},
    {"edge_id": "4M4KHS4E_E083", "edge_description": "digital oscilloscope / Output voltage measurement is collected on capacitor"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4M4KHS4E_E082` | `is collected on` | 11-Sensor Information | digital oscilloscope / Output voltage measurement |  | 04-Fault Location | resistor |  |
| 2 | `4M4KHS4E_E083` | `is collected on` | 11-Sensor Information | digital oscilloscope / Output voltage measurement |  | 04-Fault Location | capacitor |  |
