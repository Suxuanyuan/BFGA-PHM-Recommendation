...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CRVEYEI3_E065` | `can obviously reflect` | 11-Sensor Information | temperature sensor |  | 05-Fault Mode | step fault |  |
| 2 | `CRVEYEI3_E066` | `can obviously reflect` | 11-Sensor Information | temperature sensor |  | 05-Fault Mode | ramp fault |  |
