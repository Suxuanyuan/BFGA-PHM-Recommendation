...
- **Reference ID**: FPTKZWTF
- **Paper Title**: Noise resistant time frequency analysis and application in fault diagnosis of rolling element bearings
...
> **Input Material**: Reference ID `FPTKZWTF` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "FPTKZWTF_E084", "edge_description": "slot contains performance degradation"},
    {"edge_id": "FPTKZWTF_E085", "edge_description": "rough surface contains performance degradation"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `FPTKZWTF_E084` | `contains` | 05-Fault Mode | slot |  | 06-Fault Severity | performance degradation(Multiple Severities) |  |
| 2 | `FPTKZWTF_E085` | `contains` | 05-Fault Mode | rough surface |  | 06-Fault Severity | performance degradation(Multiple Severities) |  |
