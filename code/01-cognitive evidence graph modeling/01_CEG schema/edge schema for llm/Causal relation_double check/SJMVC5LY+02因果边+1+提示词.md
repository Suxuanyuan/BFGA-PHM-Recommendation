...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SJMVC5LY_E072` | `contains` | 05-Fault Mode | tooth breakage |  | 07-Compound Fault | bearing with combined fault(Compound Fault Within Same Structure) |  |
| 2 | `SJMVC5LY_E073` | `contains` | 05-Fault Mode | chipped gear |  | 07-Compound Fault | bearing with combined fault(Compound Fault Within Same Structure) |  |
| 3 | `SJMVC5LY_E074` | `contains` | 05-Fault Mode | eccentric gear |  | 07-Compound Fault | bearing with combined fault(Compound Fault Within Same Structure) |  |
| 4 | `SJMVC5LY_E075` | `contains` | 05-Fault Mode | inner race fault |  | 07-Compound Fault | bearing with combined fault(Compound Fault Within Same Structure) |  |
| 5 | `SJMVC5LY_E076` | `contains` | 05-Fault Mode | outer race fault |  | 07-Compound Fault | bearing with combined fault(Compound Fault Within Same Structure) |  |
| 6 | `SJMVC5LY_E077` | `contains` | 05-Fault Mode | ball fault |  | 07-Compound Fault | bearing with combined fault(Compound Fault Within Same Structure) |  |
