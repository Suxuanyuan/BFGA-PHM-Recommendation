...
- **Reference ID**: QL5NDXDA
- **Paper Title**: Battery Remaining Useful Life Prediction with Inheritance Particle Filtering
...
> **Input Material**: Reference ID `QL5NDXDA` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "QL5NDXDA_E037", "edge_description": "current sensor can obviously reflect capacity degradation"},
    {"edge_id": "QL5NDXDA_E038", "edge_description": "voltage sensor can obviously reflect capacity degradation"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QL5NDXDA_E037` | `can obviously reflect` | 11-Sensor Information | current sensor |  | 05-Fault Mode | capacity degradation |  |
| 2 | `QL5NDXDA_E038` | `can obviously reflect` | 11-Sensor Information | voltage sensor |  | 05-Fault Mode | capacity degradation |  |
