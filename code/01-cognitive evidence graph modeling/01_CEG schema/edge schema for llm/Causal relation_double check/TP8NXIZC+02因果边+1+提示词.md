...
- **Reference ID**: TP8NXIZC
- **Paper Title**: Analog fault diagnosis using S-transform preprocessor and a QNN classifier
...
> **Input Material**: Reference ID `TP8NXIZC` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "TP8NXIZC_E061", "edge_description": "voltage sensor is collected on resistors"},
    {"edge_id": "TP8NXIZC_E062", "edge_description": "voltage sensor is collected on capacitors"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TP8NXIZC_E061` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | resistors |  |
| 2 | `TP8NXIZC_E062` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | capacitors |  |
