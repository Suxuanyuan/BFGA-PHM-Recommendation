...
- **Reference ID**: JWIZQSA9
- **Paper Title**: A new deep auto-encoder method with fusing discriminant information for bearing fault diagnosis
...
> **Input Material**: Reference ID `JWIZQSA9` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "JWIZQSA9_E082", "edge_description": "inner race fault contains No Compound Fault"},
    {"edge_id": "JWIZQSA9_E083", "edge_description": "outer race fault contains No Compound Fault"},
    {"edge_id": "JWIZQSA9_E084", "edge_description": "ball fault contains No Compound Fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `JWIZQSA9_E082` | `contains` | 05-Fault Mode | inner race fault |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `JWIZQSA9_E083` | `contains` | 05-Fault Mode | outer race fault |  | 07-Compound Fault | No Compound Fault |  |
| 3 | `JWIZQSA9_E084` | `contains` | 05-Fault Mode | ball fault |  | 07-Compound Fault | No Compound Fault |  |
