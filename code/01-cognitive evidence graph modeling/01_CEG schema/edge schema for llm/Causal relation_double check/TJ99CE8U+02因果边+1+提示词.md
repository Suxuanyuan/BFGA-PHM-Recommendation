...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TJ99CE8U_E062` | `contains` | 05-Fault Mode | bearing fault |  | 06-Fault Severity | outer ring thickness 4.0mm, inner ring thickness 2.0mm, shaft diameter 9.8mm(Single Severity) |  |
| 2 | `TJ99CE8U_E063` | `contains` | 05-Fault Mode | central shaft fault |  | 06-Fault Severity | outer ring thickness 4.0mm, inner ring thickness 2.0mm, shaft diameter 9.8mm(Single Severity) |  |
