...
- **Reference ID**: KEP65J96
- **Paper Title**: Comparison of Support Vector Machine-Based Techniques for Detection of Bearing Faults
...
> **Input Material**: Reference ID `KEP65J96` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "KEP65J96_E040", "edge_description": "extensometer can obviously reflect fatigue crack"},
    {"edge_id": "KEP65J96_E041", "edge_description": "extensometer can obviously reflect fracture"},
    {"edge_id": "KEP65J96_E042", "edge_description": "radiation thermometer can obviously reflect fatigue crack"},
    {"edge_id": "KEP65J96_E043", "edge_description": "radiation thermometer can obviously reflect fracture"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `KEP65J96_E040` | `can obviously reflect` | 11-Sensor Information | extensometer |  | 05-Fault Mode | fatigue crack |  |
| 2 | `KEP65J96_E041` | `can obviously reflect` | 11-Sensor Information | extensometer |  | 05-Fault Mode | fracture |  |
| 3 | `KEP65J96_E042` | `can obviously reflect` | 11-Sensor Information | radiation thermometer |  | 05-Fault Mode | fatigue crack |  |
| 4 | `KEP65J96_E043` | `can obviously reflect` | 11-Sensor Information | radiation thermometer |  | 05-Fault Mode | fracture |  |
