...
- **Reference ID**: JP9FD5NK
- **Paper Title**: Fault Diagnosis and Tolerant Control of Single IGBT Open-Circuit Failure in Modular Multilevel Converters
...
> **Input Material**: Reference ID `JP9FD5NK` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "JP9FD5NK_E025", "edge_description": "current sensors is collected on insulated gate bipolar transistor (IGBT)"},
    {"edge_id": "JP9FD5NK_E026", "edge_description": "voltage sensors is collected on insulated gate bipolar transistor (IGBT)"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `JP9FD5NK_E025` | `is collected on` | 11-Sensor Information | current sensors |  | 04-Fault Location | insulated gate bipolar transistor (IGBT) |  |
| 2 | `JP9FD5NK_E026` | `is collected on` | 11-Sensor Information | voltage sensors |  | 04-Fault Location | insulated gate bipolar transistor (IGBT) |  |
