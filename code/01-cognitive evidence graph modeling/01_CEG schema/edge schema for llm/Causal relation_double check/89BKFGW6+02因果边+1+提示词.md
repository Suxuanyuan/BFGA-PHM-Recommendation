...
- **Reference ID**: 89BKFGW6
- **Paper Title**: Adaptive Ensemble Fault Diagnosis Based on Online Learning of Personalized Decision Parameters
...
> **Input Material**: Reference ID `89BKFGW6` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "89BKFGW6_E037", "edge_description": "Tennessee Eastman process contains oil-immersed transformer"},
    {"edge_id": "89BKFGW6_E038", "edge_description": "oil-immersed transformer contains oil-immersed transformer"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `89BKFGW6_E037` | `contains` | 02-Object Type | Tennessee Eastman process |  | 04-Fault Location | oil-immersed transformer |  |
| 2 | `89BKFGW6_E038` | `contains` | 02-Object Type | oil-immersed transformer |  | 04-Fault Location | oil-immersed transformer |  |
