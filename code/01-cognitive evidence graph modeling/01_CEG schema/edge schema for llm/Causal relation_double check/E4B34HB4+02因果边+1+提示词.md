...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `E4B34HB4_E028` | `is collected on` | 11-Sensor Information | Hall current sensors |  | 04-Fault Location | switching devices |  |
| 2 | `E4B34HB4_E029` | `is collected on` | 11-Sensor Information | position sensor |  | 04-Fault Location | switching devices |  |
| 3 | `E4B34HB4_E030` | `is collected on` | 11-Sensor Information | torque sensor |  | 04-Fault Location | switching devices |  |
