...
- **Reference ID**: TWY3IWVT
- **Paper Title**: Research on a knowledge modelling methodology for fault diagnosis of machine tools based on formal semantics
...
> **Input Material**: Reference ID `TWY3IWVT` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "TWY3IWVT_E036", "edge_description": "scratch contains No Compound Fault"},
    {"edge_id": "TWY3IWVT_E037", "edge_description": "dither contains No Compound Fault"},
    {"edge_id": "TWY3IWVT_E038", "edge_description": "slip contains No Compound Fault"},
    {"edge_id": "TWY3IWVT_E039", "edge_description": "shift contains No Compound Fault"},
    {"edge_id": "TWY3IWVT_E040", "edge_description": "damage contains No Compound Fault"},
    {"edge_id": "TWY3IWVT_E041", "edge_description": "loose contains No Compound Fault"},
    {"edge_id": "TWY3IWVT_E042", "edge_description": "None is collected on z axis linear guide"},
    {"edge_id": "TWY3IWVT_E043", "edge_description": "None is collected on slide plate"},
    {"edge_id": "TWY3IWVT_E044", "edge_description": "None is collected on x axis linear guide"},
    {"edge_id": "TWY3IWVT_E045", "edge_description": "None is collected on big column"},
    {"edge_id": "TWY3IWVT_E046", "edge_description": "None is collected on gear belt"},
    {"edge_id": "TWY3IWVT_E047", "edge_description": "None is collected on expansion sleeve"},
    {"edge_id": "TWY3IWVT_E048", "edge_description": "None is collected on tuner screw"},
    {"edge_id": "TWY3IWVT_E049", "edge_description": "None can obviously reflect scratch"},
    {"edge_id": "TWY3IWVT_E050", "edge_description": "None can obviously reflect dither"},
    {"edge_id": "TWY3IWVT_E051", "edge_description": "None can obviously reflect slip"},
    {"edge_id": "TWY3IWVT_E052", "edge_description": "None can obviously reflect shift"},
    {"edge_id": "TWY3IWVT_E053", "edge_description": "None can obviously reflect damage"},
    {"edge_id": "TWY3IWVT_E054", "edge_description": "None can obviously reflect loose"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TWY3IWVT_E036` | `contains` | 05-Fault Mode | scratch |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `TWY3IWVT_E037` | `contains` | 05-Fault Mode | dither |  | 07-Compound Fault | No Compound Fault |  |
| 3 | `TWY3IWVT_E038` | `contains` | 05-Fault Mode | slip |  | 07-Compound Fault | No Compound Fault |  |
| 4 | `TWY3IWVT_E039` | `contains` | 05-Fault Mode | shift |  | 07-Compound Fault | No Compound Fault |  |
| 5 | `TWY3IWVT_E040` | `contains` | 05-Fault Mode | damage |  | 07-Compound Fault | No Compound Fault |  |
| 6 | `TWY3IWVT_E041` | `contains` | 05-Fault Mode | loose |  | 07-Compound Fault | No Compound Fault |  |
| 7 | `TWY3IWVT_E042` | `is collected on` | 11-Sensor Information | None |  | 04-Fault Location | z axis linear guide |  |
| 8 | `TWY3IWVT_E043` | `is collected on` | 11-Sensor Information | None |  | 04-Fault Location | slide plate |  |
| 9 | `TWY3IWVT_E044` | `is collected on` | 11-Sensor Information | None |  | 04-Fault Location | x axis linear guide |  |
| 10 | `TWY3IWVT_E045` | `is collected on` | 11-Sensor Information | None |  | 04-Fault Location | big column |  |
| 11 | `TWY3IWVT_E046` | `is collected on` | 11-Sensor Information | None |  | 04-Fault Location | gear belt |  |
| 12 | `TWY3IWVT_E047` | `is collected on` | 11-Sensor Information | None |  | 04-Fault Location | expansion sleeve |  |
| 13 | `TWY3IWVT_E048` | `is collected on` | 11-Sensor Information | None |  | 04-Fault Location | tuner screw |  |
| 14 | `TWY3IWVT_E049` | `can obviously reflect` | 11-Sensor Information | None |  | 05-Fault Mode | scratch |  |
| 15 | `TWY3IWVT_E050` | `can obviously reflect` | 11-Sensor Information | None |  | 05-Fault Mode | dither |  |
| 16 | `TWY3IWVT_E051` | `can obviously reflect` | 11-Sensor Information | None |  | 05-Fault Mode | slip |  |
| 17 | `TWY3IWVT_E052` | `can obviously reflect` | 11-Sensor Information | None |  | 05-Fault Mode | shift |  |
| 18 | `TWY3IWVT_E053` | `can obviously reflect` | 11-Sensor Information | None |  | 05-Fault Mode | damage |  |
| 19 | `TWY3IWVT_E054` | `can obviously reflect` | 11-Sensor Information | None |  | 05-Fault Mode | loose |  |
...
*This prompt is automatically generated by edge_02_prompt_v2.py (Batch 1, total 19 edges)*
