...
- **Reference ID**: I7HMHXE2
- **Paper Title**: Iterative Condition Monitoring and Fault Diagnosis Scheme of Electric Motor for Harsh Industrial Application
...
> **Input Material**: Reference ID `I7HMHXE2` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "I7HMHXE2_E055", "edge_description": "Current sensor is collected on rotor bar"},
    {"edge_id": "I7HMHXE2_E056", "edge_description": "Current sensor is collected on housing"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `I7HMHXE2_E055` | `is collected on` | 11-Sensor Information | Current sensor |  | 04-Fault Location | rotor bar |  |
| 2 | `I7HMHXE2_E056` | `is collected on` | 11-Sensor Information | Current sensor |  | 04-Fault Location | housing |  |
