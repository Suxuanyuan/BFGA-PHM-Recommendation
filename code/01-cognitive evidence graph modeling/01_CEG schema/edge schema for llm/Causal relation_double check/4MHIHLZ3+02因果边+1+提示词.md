...
- **Reference ID**: 4MHIHLZ3
- **Paper Title**: iDCR: Improved Dempster Combination Rule for multisensor fault diagnosis
...
> **Input Material**: Reference ID `4MHIHLZ3` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "4MHIHLZ3_E047", "edge_description": "rotating machinery contains single operating condition"},
    {"edge_id": "4MHIHLZ3_E048", "edge_description": "bearing contains single operating condition"},
    {"edge_id": "4MHIHLZ3_E053", "edge_description": "Sensors is collected on bearing"},
    {"edge_id": "4MHIHLZ3_E054", "edge_description": "Sensors is collected on shaft"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4MHIHLZ3_E047` | `contains` | 02-Object Type | rotating machinery |  | 03-Operating Conditions | single operating condition(Single Condition) |  |
| 2 | `4MHIHLZ3_E048` | `contains` | 02-Object Type | bearing |  | 03-Operating Conditions | single operating condition(Single Condition) |  |
| 3 | `4MHIHLZ3_E053` | `is collected on` | 11-Sensor Information | Sensors |  | 04-Fault Location | bearing |  |
| 4 | `4MHIHLZ3_E054` | `is collected on` | 11-Sensor Information | Sensors |  | 04-Fault Location | shaft |  |
