...
- **Reference ID**: CIVJRAHU
- **Paper Title**: A New Approach for Current Sensor Fault Diagnosis in PMSG Drives for Wind Energy Conversion Systems
...
> **Input Material**: Reference ID `CIVJRAHU` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "CIVJRAHU_E072", "edge_description": "LEM LA 55-P current sensors is collected on current sensor"},
    {"edge_id": "CIVJRAHU_E073", "edge_description": "LEM LA 55-P current sensors is collected on insulated-gate bipolar transistor"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CIVJRAHU_E072` | `is collected on` | 11-Sensor Information | LEM LA 55-P current sensors |  | 04-Fault Location | current sensor |  |
| 2 | `CIVJRAHU_E073` | `is collected on` | 11-Sensor Information | LEM LA 55-P current sensors |  | 04-Fault Location | insulated-gate bipolar transistor |  |
