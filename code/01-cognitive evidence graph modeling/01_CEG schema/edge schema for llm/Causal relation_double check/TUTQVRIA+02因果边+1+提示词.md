...
- **Reference ID**: TUTQVRIA
- **Paper Title**: Methodology for fault detection in induction motors via sound and vibration signals
...
> **Input Material**: Reference ID `TUTQVRIA` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "TUTQVRIA_E099", "edge_description": "broken rotor bars contains two broken rotor bars, 1.191 mm diameter holes"},
    {"edge_id": "TUTQVRIA_E100", "edge_description": "bearing defects contains two broken rotor bars, 1.191 mm diameter holes"},
    {"edge_id": "TUTQVRIA_E101", "edge_description": "mechanical unbalance contains two broken rotor bars, 1.191 mm diameter holes"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `TUTQVRIA_E099` | `contains` | 05-Fault Mode | broken rotor bars |  | 06-Fault Severity | two broken rotor bars, 1.191 mm diameter holes(Single Severity) |  |
| 2 | `TUTQVRIA_E100` | `contains` | 05-Fault Mode | bearing defects |  | 06-Fault Severity | two broken rotor bars, 1.191 mm diameter holes(Single Severity) |  |
| 3 | `TUTQVRIA_E101` | `contains` | 05-Fault Mode | mechanical unbalance |  | 06-Fault Severity | two broken rotor bars, 1.191 mm diameter holes(Single Severity) |  |
