...
- **Reference ID**: 3QEIYIRE
- **Paper Title**: Online Fault Diagnosis in Industrial Processes Using Multimodel Exponential Discriminant Analysis Algorithm
...
> **Input Material**: Reference ID `3QEIYIRE` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "3QEIYIRE_E090", "edge_description": "step changes contains multifault"},
    {"edge_id": "3QEIYIRE_E091", "edge_description": "feed loss contains multifault"},
    {"edge_id": "3QEIYIRE_E092", "edge_description": "pressure loss contains multifault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3QEIYIRE_E090` | `contains` | 05-Fault Mode | step changes |  | 07-Compound Fault | multifault(No Compound Fault) |  |
| 2 | `3QEIYIRE_E091` | `contains` | 05-Fault Mode | feed loss |  | 07-Compound Fault | multifault(No Compound Fault) |  |
| 3 | `3QEIYIRE_E092` | `contains` | 05-Fault Mode | pressure loss |  | 07-Compound Fault | multifault(No Compound Fault) |  |
