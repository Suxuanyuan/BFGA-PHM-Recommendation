...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `Z797YKX7_E036` | `contains` | 05-Fault Mode | short circuit |  | 06-Fault Severity | Single Severity |  |
| 2 | `Z797YKX7_E037` | `contains` | 05-Fault Mode | tripped |  | 06-Fault Severity | Single Severity |  |
