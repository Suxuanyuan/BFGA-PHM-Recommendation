...
- **Reference ID**: 3ZMMZCKN
- **Paper Title**: Assessment of Data Suitability for Machine Prognosis Using Maximum Mean Discrepancy
...
> **Input Material**: Reference ID `3ZMMZCKN` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "3ZMMZCKN_E048", "edge_description": "semiconductor etching machine contains boring tool"},
    {"edge_id": "3ZMMZCKN_E049", "edge_description": "semiconductor etching machine contains motor"},
    {"edge_id": "3ZMMZCKN_E050", "edge_description": "motor contains boring tool"},
    {"edge_id": "3ZMMZCKN_E051", "edge_description": "motor contains motor"},
    {"edge_id": "3ZMMZCKN_E052", "edge_description": "boring tool contains boring tool"},
    {"edge_id": "3ZMMZCKN_E053", "edge_description": "boring tool contains motor"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3ZMMZCKN_E048` | `contains` | 02-Object Type | semiconductor etching machine |  | 04-Fault Location | boring tool |  |
| 2 | `3ZMMZCKN_E049` | `contains` | 02-Object Type | semiconductor etching machine |  | 04-Fault Location | motor |  |
| 3 | `3ZMMZCKN_E050` | `contains` | 02-Object Type | motor |  | 04-Fault Location | boring tool |  |
| 4 | `3ZMMZCKN_E051` | `contains` | 02-Object Type | motor |  | 04-Fault Location | motor |  |
| 5 | `3ZMMZCKN_E052` | `contains` | 02-Object Type | boring tool |  | 04-Fault Location | boring tool |  |
| 6 | `3ZMMZCKN_E053` | `contains` | 02-Object Type | boring tool |  | 04-Fault Location | motor |  |
