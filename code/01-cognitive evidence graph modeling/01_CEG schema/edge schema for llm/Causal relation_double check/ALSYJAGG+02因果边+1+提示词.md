...
- **Reference ID**: ALSYJAGG
- **Paper Title**: Gearbox Fault Identification and Classification with Convolutional Neural Networks
...
> **Input Material**: Reference ID `ALSYJAGG` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "ALSYJAGG_E058", "edge_description": "industrial reciprocating machinery contains gear"},
    {"edge_id": "ALSYJAGG_E059", "edge_description": "industrial reciprocating machinery contains bearing"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ALSYJAGG_E058` | `contains` | 01-Object Domain | industrial reciprocating machinery(Industrial) |  | 02-Object Type | gear |  |
| 2 | `ALSYJAGG_E059` | `contains` | 01-Object Domain | industrial reciprocating machinery(Industrial) |  | 02-Object Type | bearing |  |
