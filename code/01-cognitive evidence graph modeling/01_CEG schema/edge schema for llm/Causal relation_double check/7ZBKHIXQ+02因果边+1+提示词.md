...
- **Reference ID**: 7ZBKHIXQ
- **Paper Title**: Real-Time Fault Diagnosis and Fault-Tolerant Control
...
> **Input Material**: Reference ID `7ZBKHIXQ` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "7ZBKHIXQ_E036", "edge_description": "wind turbine contains working condition variations"},
    {"edge_id": "7ZBKHIXQ_E037", "edge_description": "permanent magnet machines contains working condition variations"},
    {"edge_id": "7ZBKHIXQ_E038", "edge_description": "three-phase voltage inverters contains working condition variations"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `7ZBKHIXQ_E036` | `contains` | 02-Object Type | wind turbine |  | 03-Operating Conditions | working condition variations(Multiple Conditions) |  |
| 2 | `7ZBKHIXQ_E037` | `contains` | 02-Object Type | permanent magnet machines |  | 03-Operating Conditions | working condition variations(Multiple Conditions) |  |
| 3 | `7ZBKHIXQ_E038` | `contains` | 02-Object Type | three-phase voltage inverters |  | 03-Operating Conditions | working condition variations(Multiple Conditions) |  |
