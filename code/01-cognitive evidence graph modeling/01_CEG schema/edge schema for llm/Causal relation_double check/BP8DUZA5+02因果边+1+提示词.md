...
- **Reference ID**: BP8DUZA5
- **Paper Title**: Switch Short-Circuit Fault Diagnosis and Remedial Strategy for Full-Bridge DC-DC Converters
...
> **Input Material**: Reference ID `BP8DUZA5` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "BP8DUZA5_E024", "edge_description": "hall sensor is collected on power switch"},
    {"edge_id": "BP8DUZA5_E025", "edge_description": "auxiliary winding is collected on power switch"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `BP8DUZA5_E024` | `is collected on` | 11-Sensor Information | hall sensor |  | 04-Fault Location | power switch |  |
| 2 | `BP8DUZA5_E025` | `is collected on` | 11-Sensor Information | auxiliary winding |  | 04-Fault Location | power switch |  |
