...
- **Reference ID**: FMIYMNFW
- **Paper Title**: Time and frequency domain scanning fault diagnosis method based on spectral negentropy and its application
...
> **Input Material**: Reference ID `FMIYMNFW` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "FMIYMNFW_E060", "edge_description": "rolling bearing contains rolling bearing"},
    {"edge_id": "FMIYMNFW_E061", "edge_description": "deep groove ball bearing contains rolling bearing"},
    {"edge_id": "FMIYMNFW_E062", "edge_description": "rolling bearing contains multiple operating conditions"},
    {"edge_id": "FMIYMNFW_E063", "edge_description": "deep groove ball bearing contains multiple operating conditions"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `FMIYMNFW_E060` | `contains` | 02-Object Type | rolling bearing |  | 04-Fault Location | rolling bearing |  |
| 2 | `FMIYMNFW_E061` | `contains` | 02-Object Type | deep groove ball bearing |  | 04-Fault Location | rolling bearing |  |
| 3 | `FMIYMNFW_E062` | `contains` | 02-Object Type | rolling bearing |  | 03-Operating Conditions | multiple operating conditions(Multiple Conditions) |  |
| 4 | `FMIYMNFW_E063` | `contains` | 02-Object Type | deep groove ball bearing |  | 03-Operating Conditions | multiple operating conditions(Multiple Conditions) |  |
