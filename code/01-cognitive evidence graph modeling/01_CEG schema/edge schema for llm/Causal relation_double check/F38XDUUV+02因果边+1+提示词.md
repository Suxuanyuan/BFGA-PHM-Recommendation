...
- **Reference ID**: F38XDUUV
- **Paper Title**: A Small-Sample Wind Turbine Fault Detection Method With Synthetic Fault Data Using Generative Adversarial Nets
...
> **Input Material**: Reference ID `F38XDUUV` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "F38XDUUV_E077", "edge_description": "vibration sensor is collected on pitch system"},
    {"edge_id": "F38XDUUV_E078", "edge_description": "temperature sensor is collected on pitch system"},
    {"edge_id": "F38XDUUV_E079", "edge_description": "speed sensor is collected on pitch system"},
    {"edge_id": "F38XDUUV_E080", "edge_description": "torque sensor is collected on pitch system"},
    {"edge_id": "F38XDUUV_E081", "edge_description": "anemometer and wind vane is collected on pitch system"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `F38XDUUV_E077` | `is collected on` | 11-Sensor Information | vibration sensor |  | 04-Fault Location | pitch system |  |
| 2 | `F38XDUUV_E078` | `is collected on` | 11-Sensor Information | temperature sensor |  | 04-Fault Location | pitch system |  |
| 3 | `F38XDUUV_E079` | `is collected on` | 11-Sensor Information | speed sensor |  | 04-Fault Location | pitch system |  |
| 4 | `F38XDUUV_E080` | `is collected on` | 11-Sensor Information | torque sensor |  | 04-Fault Location | pitch system |  |
| 5 | `F38XDUUV_E081` | `is collected on` | 11-Sensor Information | anemometer and wind vane |  | 04-Fault Location | pitch system |  |
