...
- **Reference ID**: WLC3I52A
- **Paper Title**: A maintenance support framework based on dynamic reliability and remaining useful life
...
> **Input Material**: Reference ID `WLC3I52A` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "WLC3I52A_E045", "edge_description": "temperature sensor can obviously reflect wear"},
    {"edge_id": "WLC3I52A_E046", "edge_description": "speed sensor can obviously reflect wear"},
    {"edge_id": "WLC3I52A_E047", "edge_description": "pressure sensor can obviously reflect wear"},
    {"edge_id": "WLC3I52A_E048", "edge_description": "flow sensor can obviously reflect wear"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WLC3I52A_E045` | `can obviously reflect` | 11-Sensor Information | temperature sensor |  | 05-Fault Mode | wear |  |
| 2 | `WLC3I52A_E046` | `can obviously reflect` | 11-Sensor Information | speed sensor |  | 05-Fault Mode | wear |  |
| 3 | `WLC3I52A_E047` | `can obviously reflect` | 11-Sensor Information | pressure sensor |  | 05-Fault Mode | wear |  |
| 4 | `WLC3I52A_E048` | `can obviously reflect` | 11-Sensor Information | flow sensor |  | 05-Fault Mode | wear |  |
