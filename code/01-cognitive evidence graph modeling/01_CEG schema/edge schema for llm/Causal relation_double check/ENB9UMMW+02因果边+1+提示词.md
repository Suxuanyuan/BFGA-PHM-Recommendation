...
- **Reference ID**: ENB9UMMW
- **Paper Title**: Simultaneous-fault detection based on qualitative symptom descriptions for automotive engine diagnosis
...
> **Input Material**: Reference ID `ENB9UMMW` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "ENB9UMMW_E129", "edge_description": "malfunction / defect contains Single Severity"},
    {"edge_id": "ENB9UMMW_E130", "edge_description": "leakage contains Single Severity"},
    {"edge_id": "ENB9UMMW_E131", "edge_description": "incorrect ignition timing contains Single Severity"},
    {"edge_id": "ENB9UMMW_E132", "edge_description": "engine oil quality/level problem contains Single Severity"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ENB9UMMW_E129` | `contains` | 05-Fault Mode | malfunction / defect |  | 06-Fault Severity | Single Severity |  |
| 2 | `ENB9UMMW_E130` | `contains` | 05-Fault Mode | leakage |  | 06-Fault Severity | Single Severity |  |
| 3 | `ENB9UMMW_E131` | `contains` | 05-Fault Mode | incorrect ignition timing |  | 06-Fault Severity | Single Severity |  |
| 4 | `ENB9UMMW_E132` | `contains` | 05-Fault Mode | engine oil quality/level problem |  | 06-Fault Severity | Single Severity |  |
