...
- **Reference ID**: ZQBXWDKP
- **Paper Title**: A Hybrid Prognostic Approach for Remaining Useful Life Prediction of Lithium-Ion Batteries
...
> **Input Material**: Reference ID `ZQBXWDKP` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "ZQBXWDKP_E056", "edge_description": "current sensor is collected on Lithium-ion battery"},
    {"edge_id": "ZQBXWDKP_E057", "edge_description": "voltage sensor is collected on Lithium-ion battery"},
    {"edge_id": "ZQBXWDKP_E058", "edge_description": "current sensor can obviously reflect Capacity degradation"},
    {"edge_id": "ZQBXWDKP_E059", "edge_description": "voltage sensor can obviously reflect Capacity degradation"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZQBXWDKP_E056` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | Lithium-ion battery |  |
| 2 | `ZQBXWDKP_E057` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | Lithium-ion battery |  |
| 3 | `ZQBXWDKP_E058` | `can obviously reflect` | 11-Sensor Information | current sensor |  | 05-Fault Mode | Capacity degradation |  |
| 4 | `ZQBXWDKP_E059` | `can obviously reflect` | 11-Sensor Information | voltage sensor |  | 05-Fault Mode | Capacity degradation |  |
