...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `LIUPSGI6_E059` | `is collected on` | 11-Sensor Information | Voltage sensor |  | 04-Fault Location | switch |  |
| 2 | `LIUPSGI6_E060` | `is collected on` | 11-Sensor Information | Current sensor |  | 04-Fault Location | switch |  |
