...
- **Reference ID**: IDNA7WSL
- **Paper Title**: Development of an SVR Model for the Fault Diagnosis of Large-Scale Doubly-Fed Wind Turbines Using SCADA Data
...
> **Input Material**: Reference ID `IDNA7WSL` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "IDNA7WSL_E095", "edge_description": "unbalanced load contains Single Severity"},
    {"edge_id": "IDNA7WSL_E096", "edge_description": "friction contains Single Severity"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `IDNA7WSL_E095` | `contains` | 05-Fault Mode | unbalanced load |  | 06-Fault Severity | Single Severity |  |
| 2 | `IDNA7WSL_E096` | `contains` | 05-Fault Mode | friction |  | 06-Fault Severity | Single Severity |  |
