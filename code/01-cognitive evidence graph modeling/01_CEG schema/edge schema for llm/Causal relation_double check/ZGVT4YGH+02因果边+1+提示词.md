...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZGVT4YGH_E082` | `contains` | 05-Fault Mode | pitting failure |  | 06-Fault Severity | 0.007 in., 0.014 in., 0.021 in.(Multiple Severities) |  |
| 2 | `ZGVT4YGH_E083` | `contains` | 05-Fault Mode | broken teeth fault |  | 06-Fault Severity | 0.007 in., 0.014 in., 0.021 in.(Multiple Severities) |  |
| 3 | `ZGVT4YGH_E084` | `contains` | 05-Fault Mode | wear failure |  | 06-Fault Severity | 0.007 in., 0.014 in., 0.021 in.(Multiple Severities) |  |
