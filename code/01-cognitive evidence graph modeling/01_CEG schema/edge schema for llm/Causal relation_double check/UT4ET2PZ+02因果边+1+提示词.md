...
- **Reference ID**: UT4ET2PZ
- **Paper Title**: A Fast Diagnosis Method for Both IGBT Faults and Current Sensor Faults in Grid-Tied Three-Phase Inverters With Two Current Sensors
...
> **Input Material**: Reference ID `UT4ET2PZ` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "UT4ET2PZ_E057", "edge_description": "Current sensor is collected on IGBT"},
    {"edge_id": "UT4ET2PZ_E058", "edge_description": "Current sensor is collected on current sensor"},
    {"edge_id": "UT4ET2PZ_E059", "edge_description": "Voltage sensor is collected on IGBT"},
    {"edge_id": "UT4ET2PZ_E060", "edge_description": "Voltage sensor is collected on current sensor"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `UT4ET2PZ_E057` | `is collected on` | 11-Sensor Information | Current sensor |  | 04-Fault Location | IGBT |  |
| 2 | `UT4ET2PZ_E058` | `is collected on` | 11-Sensor Information | Current sensor |  | 04-Fault Location | current sensor |  |
| 3 | `UT4ET2PZ_E059` | `is collected on` | 11-Sensor Information | Voltage sensor |  | 04-Fault Location | IGBT |  |
| 4 | `UT4ET2PZ_E060` | `is collected on` | 11-Sensor Information | Voltage sensor |  | 04-Fault Location | current sensor |  |
