...
- **Reference ID**: V9KHBZM8
- **Paper Title**: Telemetry Data-Based Spacecraft Anomaly Detection With Spatial-Temporal Generative Adversarial Networks
...
> **Input Material**: Reference ID `V9KHBZM8` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "V9KHBZM8_E070", "edge_description": "power system of a rocket contains working conditions"},
    {"edge_id": "V9KHBZM8_E071", "edge_description": "satellite contains working conditions"},
    {"edge_id": "V9KHBZM8_E072", "edge_description": "rover contains working conditions"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `V9KHBZM8_E070` | `contains` | 02-Object Type | power system of a rocket |  | 03-Operating Conditions | working conditions(Multiple Conditions) |  |
| 2 | `V9KHBZM8_E071` | `contains` | 02-Object Type | satellite |  | 03-Operating Conditions | working conditions(Multiple Conditions) |  |
| 3 | `V9KHBZM8_E072` | `contains` | 02-Object Type | rover |  | 03-Operating Conditions | working conditions(Multiple Conditions) |  |
