...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `V4UQ9AUE_E080` | `is collected on` | 11-Sensor Information | accelerometer (PCB 352A60) |  | 04-Fault Location | rotor bar |  |
| 2 | `V4UQ9AUE_E081` | `is collected on` | 11-Sensor Information | accelerometer (PCB 352A60) |  | 04-Fault Location | rotor |  |
| 3 | `V4UQ9AUE_E082` | `is collected on` | 11-Sensor Information | accelerometer (PCB 352A60) |  | 04-Fault Location | bearing |  |
| 4 | `V4UQ9AUE_E083` | `is collected on` | 11-Sensor Information | current probe (Fluke i200s) |  | 04-Fault Location | rotor bar |  |
| 5 | `V4UQ9AUE_E084` | `is collected on` | 11-Sensor Information | current probe (Fluke i200s) |  | 04-Fault Location | rotor |  |
| 6 | `V4UQ9AUE_E085` | `is collected on` | 11-Sensor Information | current probe (Fluke i200s) |  | 04-Fault Location | bearing |  |
