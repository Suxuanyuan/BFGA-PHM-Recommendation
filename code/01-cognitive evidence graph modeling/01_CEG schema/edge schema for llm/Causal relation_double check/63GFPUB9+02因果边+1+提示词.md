...
- **Reference ID**: 63GFPUB9
- **Paper Title**: Theoretical Investigations on Kurtosis and Entropy and Their Improvements for System Health Monitoring
...
> **Input Material**: Reference ID `63GFPUB9` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "63GFPUB9_E064", "edge_description": "bearing contains constant operating conditions"},
    {"edge_id": "63GFPUB9_E065", "edge_description": "gear contains constant operating conditions"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `63GFPUB9_E064` | `contains` | 02-Object Type | bearing |  | 03-Operating Conditions | constant operating conditions(Single Condition) |  |
| 2 | `63GFPUB9_E065` | `contains` | 02-Object Type | gear |  | 03-Operating Conditions | constant operating conditions(Single Condition) |  |
