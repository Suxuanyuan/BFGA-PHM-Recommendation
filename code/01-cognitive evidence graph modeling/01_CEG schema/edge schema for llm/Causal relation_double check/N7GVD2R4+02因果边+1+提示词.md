...
- **Reference ID**: N7GVD2R4
- **Paper Title**: The Harmonic Order Tracking Analysis Method for the Fault Diagnosis in Induction Motors Under Time-Varying Conditions
...
> **Input Material**: Reference ID `N7GVD2R4` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
