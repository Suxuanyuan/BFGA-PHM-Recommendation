...
- **Reference ID**: 7F7GKT8N
- **Paper Title**: Adaptive Power Transformer Lifetime Predictions Through Machine Learning and Uncertainty Modeling in Nuclear Power Plants
...
> **Input Material**: Reference ID `7F7GKT8N` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "7F7GKT8N_E050", "edge_description": "temperature sensor is collected on transformer insulation paper"},
    {"edge_id": "7F7GKT8N_E051", "edge_description": "load sensors is collected on transformer insulation paper"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `7F7GKT8N_E050` | `is collected on` | 11-Sensor Information | temperature sensor |  | 04-Fault Location | transformer insulation paper |  |
| 2 | `7F7GKT8N_E051` | `is collected on` | 11-Sensor Information | load sensors |  | 04-Fault Location | transformer insulation paper |  |
