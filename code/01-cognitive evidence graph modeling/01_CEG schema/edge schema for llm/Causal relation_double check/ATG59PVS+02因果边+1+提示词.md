...
- **Reference ID**: ATG59PVS
- **Paper Title**: A naive Bayes model for robust remaining useful life prediction of lithium-ion battery
...
> **Input Material**: Reference ID `ATG59PVS` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "ATG59PVS_E042", "edge_description": "voltage sensor can obviously reflect capacity fade"},
    {"edge_id": "ATG59PVS_E043", "edge_description": "current sensor can obviously reflect capacity fade"},
    {"edge_id": "ATG59PVS_E044", "edge_description": "temperature sensor can obviously reflect capacity fade"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ATG59PVS_E042` | `can obviously reflect` | 11-Sensor Information | voltage sensor |  | 05-Fault Mode | capacity fade |  |
| 2 | `ATG59PVS_E043` | `can obviously reflect` | 11-Sensor Information | current sensor |  | 05-Fault Mode | capacity fade |  |
| 3 | `ATG59PVS_E044` | `can obviously reflect` | 11-Sensor Information | temperature sensor |  | 05-Fault Mode | capacity fade |  |
