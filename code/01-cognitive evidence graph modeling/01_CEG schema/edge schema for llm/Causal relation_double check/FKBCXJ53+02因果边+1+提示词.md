...
- **Reference ID**: FKBCXJ53
- **Paper Title**: A Transformer Fault Diagnosis Model Based on Chemical Reaction Optimization and Twin Support Vector Machine
...
> **Input Material**: Reference ID `FKBCXJ53` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "FKBCXJ53_E070", "edge_description": "thermal fault contains low overheat (below 300°C), medium overheat (300–700°C), high overheat (over 700°C), partial discharge, low-energy discharge, high-energy discharge"},
    {"edge_id": "FKBCXJ53_E071", "edge_description": "discharge fault contains low overheat (below 300°C), medium overheat (300–700°C), high overheat (over 700°C), partial discharge, low-energy discharge, high-energy discharge"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `FKBCXJ53_E070` | `contains` | 05-Fault Mode | thermal fault |  | 06-Fault Severity | low overheat (below 300°C), medium overheat (300–700°C), high overheat (over 700°C), partial discharge, low-energy discharge, high-energy discharge(Multiple Severities) |  |
| 2 | `FKBCXJ53_E071` | `contains` | 05-Fault Mode | discharge fault |  | 06-Fault Severity | low overheat (below 300°C), medium overheat (300–700°C), high overheat (over 700°C), partial discharge, low-energy discharge, high-energy discharge(Multiple Severities) |  |
...
*This prompt is automatically generated by edge_02_prompt_v2.py (Batch 1, total 2 edges)*
