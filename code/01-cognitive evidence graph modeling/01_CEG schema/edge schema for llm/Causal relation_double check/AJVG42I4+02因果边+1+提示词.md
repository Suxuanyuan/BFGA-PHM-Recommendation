...
- **Reference ID**: AJVG42I4
- **Paper Title**: Rolling bearing fault diagnosis using variational autoencoding generative adversarial networks with deep regret analysis
...
> **Input Material**: Reference ID `AJVG42I4` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "AJVG42I4_E076", "edge_description": "inner race fault contains Compound fault (outer and inner races)"},
    {"edge_id": "AJVG42I4_E077", "edge_description": "outer race fault contains Compound fault (outer and inner races)"},
    {"edge_id": "AJVG42I4_E078", "edge_description": "roller fault contains Compound fault (outer and inner races)"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AJVG42I4_E076` | `contains` | 05-Fault Mode | inner race fault |  | 07-Compound Fault | Compound fault (outer and inner races)(Compound Fault Within Same Structure) |  |
| 2 | `AJVG42I4_E077` | `contains` | 05-Fault Mode | outer race fault |  | 07-Compound Fault | Compound fault (outer and inner races)(Compound Fault Within Same Structure) |  |
| 3 | `AJVG42I4_E078` | `contains` | 05-Fault Mode | roller fault |  | 07-Compound Fault | Compound fault (outer and inner races)(Compound Fault Within Same Structure) |  |
