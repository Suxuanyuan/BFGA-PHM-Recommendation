...
- **Reference ID**: GRE7H9HH
- **Paper Title**: Tri-axial vibration based collective feature analysis for decent fault classification of VFD fed induction motor
...
> **Input Material**: Reference ID `GRE7H9HH` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "GRE7H9HH_E054", "edge_description": "Industrial Ceramic Shear ICP® Accelerometer is collected on bearing outer race"},
    {"edge_id": "GRE7H9HH_E055", "edge_description": "Industrial Ceramic Shear ICP® Accelerometer is collected on stator winding"},
    {"edge_id": "GRE7H9HH_E056", "edge_description": "Industrial Ceramic Shear ICP® Accelerometer is collected on rotor bar"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `GRE7H9HH_E054` | `is collected on` | 11-Sensor Information | Industrial Ceramic Shear ICP® Accelerometer |  | 04-Fault Location | bearing outer race |  |
| 2 | `GRE7H9HH_E055` | `is collected on` | 11-Sensor Information | Industrial Ceramic Shear ICP® Accelerometer |  | 04-Fault Location | stator winding |  |
| 3 | `GRE7H9HH_E056` | `is collected on` | 11-Sensor Information | Industrial Ceramic Shear ICP® Accelerometer |  | 04-Fault Location | rotor bar |  |
