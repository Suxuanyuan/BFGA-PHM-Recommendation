...
- **Reference ID**: WGTK3U2S
- **Paper Title**: Dynamic Uncertain Causality Graph Applied to Dynamic Fault Diagnoses and Predictions With Negative Feedbacks
...
> **Input Material**: Reference ID `WGTK3U2S` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "WGTK3U2S_E043", "edge_description": "flow rate sensor is collected on steam generator tube"},
    {"edge_id": "WGTK3U2S_E044", "edge_description": "pressure sensor is collected on steam generator tube"},
    {"edge_id": "WGTK3U2S_E045", "edge_description": "temperature sensor is collected on steam generator tube"},
    {"edge_id": "WGTK3U2S_E046", "edge_description": "water level sensor is collected on steam generator tube"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WGTK3U2S_E043` | `is collected on` | 11-Sensor Information | flow rate sensor |  | 04-Fault Location | steam generator tube |  |
| 2 | `WGTK3U2S_E044` | `is collected on` | 11-Sensor Information | pressure sensor |  | 04-Fault Location | steam generator tube |  |
| 3 | `WGTK3U2S_E045` | `is collected on` | 11-Sensor Information | temperature sensor |  | 04-Fault Location | steam generator tube |  |
| 4 | `WGTK3U2S_E046` | `is collected on` | 11-Sensor Information | water level sensor |  | 04-Fault Location | steam generator tube |  |
