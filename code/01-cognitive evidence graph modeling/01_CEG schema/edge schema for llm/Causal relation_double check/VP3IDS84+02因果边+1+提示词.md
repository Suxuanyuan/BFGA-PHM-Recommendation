...
- **Reference ID**: VP3IDS84
- **Paper Title**: Data-Based Detection and Diagnosis of Faults in Linear Actuators
...
> **Input Material**: Reference ID `VP3IDS84` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "VP3IDS84_E077", "edge_description": "linear potentiometer is collected on screw"},
    {"edge_id": "VP3IDS84_E078", "edge_description": "linear potentiometer is collected on nut"},
    {"edge_id": "VP3IDS84_E079", "edge_description": "linear potentiometer is collected on balls"},
    {"edge_id": "VP3IDS84_E080", "edge_description": "Hall effect sensor is collected on screw"},
    {"edge_id": "VP3IDS84_E081", "edge_description": "Hall effect sensor is collected on nut"},
    {"edge_id": "VP3IDS84_E082", "edge_description": "Hall effect sensor is collected on balls"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VP3IDS84_E077` | `is collected on` | 11-Sensor Information | linear potentiometer |  | 04-Fault Location | screw |  |
| 2 | `VP3IDS84_E078` | `is collected on` | 11-Sensor Information | linear potentiometer |  | 04-Fault Location | nut |  |
| 3 | `VP3IDS84_E079` | `is collected on` | 11-Sensor Information | linear potentiometer |  | 04-Fault Location | balls |  |
| 4 | `VP3IDS84_E080` | `is collected on` | 11-Sensor Information | Hall effect sensor |  | 04-Fault Location | screw |  |
| 5 | `VP3IDS84_E081` | `is collected on` | 11-Sensor Information | Hall effect sensor |  | 04-Fault Location | nut |  |
| 6 | `VP3IDS84_E082` | `is collected on` | 11-Sensor Information | Hall effect sensor |  | 04-Fault Location | balls |  |
