...
- **Reference ID**: KRAKJNAV
- **Paper Title**: Two stage deep learning for prognostics using multi-loss encoder and convolutional composite features
...
> **Input Material**: Reference ID `KRAKJNAV` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "KRAKJNAV_E075", "edge_description": "turbofan engine contains turbofan engine"},
    {"edge_id": "KRAKJNAV_E076", "edge_description": "turbofan engine contains cutting blade"},
    {"edge_id": "KRAKJNAV_E077", "edge_description": "cutting blade contains turbofan engine"},
    {"edge_id": "KRAKJNAV_E078", "edge_description": "cutting blade contains cutting blade"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `KRAKJNAV_E075` | `contains` | 02-Object Type | turbofan engine |  | 04-Fault Location | turbofan engine |  |
| 2 | `KRAKJNAV_E076` | `contains` | 02-Object Type | turbofan engine |  | 04-Fault Location | cutting blade |  |
| 3 | `KRAKJNAV_E077` | `contains` | 02-Object Type | cutting blade |  | 04-Fault Location | turbofan engine |  |
| 4 | `KRAKJNAV_E078` | `contains` | 02-Object Type | cutting blade |  | 04-Fault Location | cutting blade |  |
