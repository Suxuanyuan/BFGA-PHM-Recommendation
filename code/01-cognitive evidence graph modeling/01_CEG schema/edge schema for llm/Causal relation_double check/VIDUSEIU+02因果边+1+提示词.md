...
- **Reference ID**: VIDUSEIU
- **Paper Title**: Fault diagnosis and prognostic of solid oxide fuel cells
...
> **Input Material**: Reference ID `VIDUSEIU` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "VIDUSEIU_E025", "edge_description": "voltage sensor is collected on anode"},
    {"edge_id": "VIDUSEIU_E026", "edge_description": "voltage sensor is collected on cathode"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VIDUSEIU_E025` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | anode |  |
| 2 | `VIDUSEIU_E026` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | cathode |  |
