...
- **Reference ID**: ZZZRPFBV
- **Paper Title**: Fault diagnosis of rolling bearing using marine predators algorithm-based support vector machine and topology learning and out-of-sample embedding
...
> **Input Material**: Reference ID `ZZZRPFBV` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "ZZZRPFBV_E056", "edge_description": "1210 self-aligning ball bearing contains motor speed of 1800 r/min, motor speed of 1772 r/min with a load of 1 HP"},
    {"edge_id": "ZZZRPFBV_E057", "edge_description": "SKF6205 deep groove ball bearing contains motor speed of 1800 r/min, motor speed of 1772 r/min with a load of 1 HP"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZZZRPFBV_E056` | `contains` | 02-Object Type | 1210 self-aligning ball bearing |  | 03-Operating Conditions | motor speed of 1800 r/min, motor speed of 1772 r/min with a load of 1 HP(Single Condition) |  |
| 2 | `ZZZRPFBV_E057` | `contains` | 02-Object Type | SKF6205 deep groove ball bearing |  | 03-Operating Conditions | motor speed of 1800 r/min, motor speed of 1772 r/min with a load of 1 HP(Single Condition) |  |
