...
- **Reference ID**: MHQR29N3
- **Paper Title**: A simulation model based fault diagnosis method for bearings
...
> **Input Material**: Reference ID `MHQR29N3` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "MHQR29N3_E055", "edge_description": "inner race fault contains combination of rolling body and outer race faults"},
    {"edge_id": "MHQR29N3_E056", "edge_description": "rolling body fault contains combination of rolling body and outer race faults"},
    {"edge_id": "MHQR29N3_E057", "edge_description": "outer race fault contains combination of rolling body and outer race faults"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `MHQR29N3_E055` | `contains` | 05-Fault Mode | inner race fault |  | 07-Compound Fault | combination of rolling body and outer race faults(Compound Fault Within Same Structure) |  |
| 2 | `MHQR29N3_E056` | `contains` | 05-Fault Mode | rolling body fault |  | 07-Compound Fault | combination of rolling body and outer race faults(Compound Fault Within Same Structure) |  |
| 3 | `MHQR29N3_E057` | `contains` | 05-Fault Mode | outer race fault |  | 07-Compound Fault | combination of rolling body and outer race faults(Compound Fault Within Same Structure) |  |
