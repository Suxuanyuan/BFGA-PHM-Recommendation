...
- **Reference ID**: 2P6TVC36
- **Paper Title**: Open-circuit fault diagnosis of power rectifier using sparse autoencoder based deep neural network
...
> **Input Material**: Reference ID `2P6TVC36` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "2P6TVC36_E074", "edge_description": "Voltage Measurement module is collected on thyristor"},
    {"edge_id": "2P6TVC36_E075", "edge_description": "Voltage Measurement module is collected on power electronic switch"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `2P6TVC36_E074` | `is collected on` | 11-Sensor Information | Voltage Measurement module |  | 04-Fault Location | thyristor |  |
| 2 | `2P6TVC36_E075` | `is collected on` | 11-Sensor Information | Voltage Measurement module |  | 04-Fault Location | power electronic switch |  |
