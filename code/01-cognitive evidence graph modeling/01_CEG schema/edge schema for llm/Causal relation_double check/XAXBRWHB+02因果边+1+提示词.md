...
- **Reference ID**: XAXBRWHB
- **Paper Title**: Robust Deep Learning-Based Diagnosis of Mixed Faults in Rotating Machinery
...
> **Input Material**: Reference ID `XAXBRWHB` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "XAXBRWHB_E066", "edge_description": "rotor contains bearing"},
    {"edge_id": "XAXBRWHB_E067", "edge_description": "rotor contains rotor"},
    {"edge_id": "XAXBRWHB_E068", "edge_description": "bearing contains bearing"},
    {"edge_id": "XAXBRWHB_E069", "edge_description": "bearing contains rotor"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XAXBRWHB_E066` | `contains` | 02-Object Type | rotor |  | 04-Fault Location | bearing |  |
| 2 | `XAXBRWHB_E067` | `contains` | 02-Object Type | rotor |  | 04-Fault Location | rotor |  |
| 3 | `XAXBRWHB_E068` | `contains` | 02-Object Type | bearing |  | 04-Fault Location | bearing |  |
| 4 | `XAXBRWHB_E069` | `contains` | 02-Object Type | bearing |  | 04-Fault Location | rotor |  |
