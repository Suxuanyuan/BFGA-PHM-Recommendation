...
- **Reference ID**: WCF99R59
- **Paper Title**: Calculating a Health Index for Power Transformers Using a Subsystem-Based GRNN Approach
...
> **Input Material**: Reference ID `WCF99R59` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "WCF99R59_E087", "edge_description": "short circuit turns contains Compound Fault Across Structures"},
    {"edge_id": "WCF99R59_E088", "edge_description": "cracks contains Compound Fault Across Structures"},
    {"edge_id": "WCF99R59_E089", "edge_description": "poor electrical connection contains Compound Fault Across Structures"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WCF99R59_E087` | `contains` | 05-Fault Mode | short circuit turns |  | 07-Compound Fault | Compound Fault Across Structures |  |
| 2 | `WCF99R59_E088` | `contains` | 05-Fault Mode | cracks |  | 07-Compound Fault | Compound Fault Across Structures |  |
| 3 | `WCF99R59_E089` | `contains` | 05-Fault Mode | poor electrical connection |  | 07-Compound Fault | Compound Fault Across Structures |  |
