...
- **Reference ID**: PT42B735
- **Paper Title**: Open-Circuit Fault Diagnosis and Maintenance in Multi-Pulse Parallel and Series TRU Topologies
...
> **Input Material**: Reference ID `PT42B735` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "PT42B735_E062", "edge_description": "voltage sensor is collected on diodes of three-phase uncontrolled bridge rectifier"},
    {"edge_id": "PT42B735_E063", "edge_description": "current sensor is collected on diodes of three-phase uncontrolled bridge rectifier"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PT42B735_E062` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | diodes of three-phase uncontrolled bridge rectifier |  |
| 2 | `PT42B735_E063` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | diodes of three-phase uncontrolled bridge rectifier |  |
