...
- **Reference ID**: 7ADLVJSS
- **Paper Title**: Multivariate time series anomaly detection: A framework of Hidden Markov Models
...
> **Input Material**: Reference ID `7ADLVJSS` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "7ADLVJSS_E065", "edge_description": "Emotiv EEG Neuroheadset contains Single operating condition"},
    {"edge_id": "7ADLVJSS_E066", "edge_description": "Air Quality Chemical Multi-sensor Device contains Single operating condition"},
    {"edge_id": "7ADLVJSS_E068", "edge_description": "Emotiv EEG Neuroheadset is collected on sensor"},
    {"edge_id": "7ADLVJSS_E069", "edge_description": "Air Quality Chemical Multi-sensor Device is collected on sensor"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `7ADLVJSS_E065` | `contains` | 02-Object Type | Emotiv EEG Neuroheadset |  | 03-Operating Conditions | Single operating condition(Single Condition) |  |
| 2 | `7ADLVJSS_E066` | `contains` | 02-Object Type | Air Quality Chemical Multi-sensor Device |  | 03-Operating Conditions | Single operating condition(Single Condition) |  |
| 3 | `7ADLVJSS_E068` | `is collected on` | 11-Sensor Information | Emotiv EEG Neuroheadset |  | 04-Fault Location | sensor |  |
| 4 | `7ADLVJSS_E069` | `is collected on` | 11-Sensor Information | Air Quality Chemical Multi-sensor Device |  | 04-Fault Location | sensor |  |
