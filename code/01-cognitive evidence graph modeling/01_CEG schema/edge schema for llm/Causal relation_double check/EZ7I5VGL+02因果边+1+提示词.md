...
- **Reference ID**: EZ7I5VGL
- **Paper Title**: A Novel Method for Imbalanced Fault Diagnosis of Rotating Machinery Based on Generative Adversarial Networks
...
> **Input Material**: Reference ID `EZ7I5VGL` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "EZ7I5VGL_E101", "edge_description": "bearing contains load of 2hp, shaft speed of 30Hz under a high load"},
    {"edge_id": "EZ7I5VGL_E102", "edge_description": "gearbox contains load of 2hp, shaft speed of 30Hz under a high load"},
    {"edge_id": "EZ7I5VGL_E103", "edge_description": "single point faults contains health patterns of the gearbox dataset"},
    {"edge_id": "EZ7I5VGL_E104", "edge_description": "chipped contains health patterns of the gearbox dataset"},
    {"edge_id": "EZ7I5VGL_E105", "edge_description": "broken contains health patterns of the gearbox dataset"},
    {"edge_id": "EZ7I5VGL_E106", "edge_description": "eccentric contains health patterns of the gearbox dataset"},
    {"edge_id": "EZ7I5VGL_E107", "edge_description": "imbalance contains health patterns of the gearbox dataset"},
    {"edge_id": "EZ7I5VGL_E108", "edge_description": "keyway sheared contains health patterns of the gearbox dataset"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `EZ7I5VGL_E101` | `contains` | 02-Object Type | bearing |  | 03-Operating Conditions | load of 2hp, shaft speed of 30Hz under a high load(Single Condition) |  |
| 2 | `EZ7I5VGL_E102` | `contains` | 02-Object Type | gearbox |  | 03-Operating Conditions | load of 2hp, shaft speed of 30Hz under a high load(Single Condition) |  |
| 3 | `EZ7I5VGL_E103` | `contains` | 05-Fault Mode | single point faults |  | 07-Compound Fault | health patterns of the gearbox dataset(Compound Fault Across Structures) |  |
| 4 | `EZ7I5VGL_E104` | `contains` | 05-Fault Mode | chipped |  | 07-Compound Fault | health patterns of the gearbox dataset(Compound Fault Across Structures) |  |
| 5 | `EZ7I5VGL_E105` | `contains` | 05-Fault Mode | broken |  | 07-Compound Fault | health patterns of the gearbox dataset(Compound Fault Across Structures) |  |
| 6 | `EZ7I5VGL_E106` | `contains` | 05-Fault Mode | eccentric |  | 07-Compound Fault | health patterns of the gearbox dataset(Compound Fault Across Structures) |  |
| 7 | `EZ7I5VGL_E107` | `contains` | 05-Fault Mode | imbalance |  | 07-Compound Fault | health patterns of the gearbox dataset(Compound Fault Across Structures) |  |
| 8 | `EZ7I5VGL_E108` | `contains` | 05-Fault Mode | keyway sheared |  | 07-Compound Fault | health patterns of the gearbox dataset(Compound Fault Across Structures) |  |
