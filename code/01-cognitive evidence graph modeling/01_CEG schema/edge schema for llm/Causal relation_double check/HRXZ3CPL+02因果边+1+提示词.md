...
- **Reference ID**: HRXZ3CPL
- **Paper Title**: Transient fault diagnosis for traction control system based on optimal fractional-order method
...
> **Input Material**: Reference ID `HRXZ3CPL` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "HRXZ3CPL_E082", "edge_description": "traction converter contains constant speed operating condition"},
    {"edge_id": "HRXZ3CPL_E083", "edge_description": "current sensor contains constant speed operating condition"},
    {"edge_id": "HRXZ3CPL_E084", "edge_description": "traction control unit contains constant speed operating condition"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HRXZ3CPL_E082` | `contains` | 02-Object Type | traction converter |  | 03-Operating Conditions | constant speed operating condition(Single Condition) |  |
| 2 | `HRXZ3CPL_E083` | `contains` | 02-Object Type | current sensor |  | 03-Operating Conditions | constant speed operating condition(Single Condition) |  |
| 3 | `HRXZ3CPL_E084` | `contains` | 02-Object Type | traction control unit |  | 03-Operating Conditions | constant speed operating condition(Single Condition) |  |
