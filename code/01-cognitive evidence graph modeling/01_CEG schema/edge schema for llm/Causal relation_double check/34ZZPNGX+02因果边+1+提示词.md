...
- **Reference ID**: 34ZZPNGX
- **Paper Title**: Fault Diagnosis of Hydraulic Systems Based on Deep Learning Model With Multirate Data Samples
...
> **Input Material**: Reference ID `34ZZPNGX` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "34ZZPNGX_E085", "edge_description": "manufacturing, metallurgy, energy, and other industries contains cooler"},
    {"edge_id": "34ZZPNGX_E086", "edge_description": "manufacturing, metallurgy, energy, and other industries contains valve"},
    {"edge_id": "34ZZPNGX_E087", "edge_description": "manufacturing, metallurgy, energy, and other industries contains main pump"},
    {"edge_id": "34ZZPNGX_E088", "edge_description": "manufacturing, metallurgy, energy, and other industries contains accumulator"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `34ZZPNGX_E085` | `contains` | 01-Object Domain | manufacturing, metallurgy, energy, and other industries(Industrial) |  | 02-Object Type | cooler |  |
| 2 | `34ZZPNGX_E086` | `contains` | 01-Object Domain | manufacturing, metallurgy, energy, and other industries(Industrial) |  | 02-Object Type | valve |  |
| 3 | `34ZZPNGX_E087` | `contains` | 01-Object Domain | manufacturing, metallurgy, energy, and other industries(Industrial) |  | 02-Object Type | main pump |  |
| 4 | `34ZZPNGX_E088` | `contains` | 01-Object Domain | manufacturing, metallurgy, energy, and other industries(Industrial) |  | 02-Object Type | accumulator |  |
