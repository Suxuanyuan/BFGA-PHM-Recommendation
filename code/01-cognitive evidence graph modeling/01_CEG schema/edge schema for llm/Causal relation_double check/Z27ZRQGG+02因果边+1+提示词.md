...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `Z27ZRQGG_E068` | `contains` | 05-Fault Mode | pitting |  | 06-Fault Severity | fault diameter / fault degrees(Multiple Severities) |  |
| 2 | `Z27ZRQGG_E069` | `contains` | 05-Fault Mode | crack / fracture |  | 06-Fault Severity | fault diameter / fault degrees(Multiple Severities) |  |
