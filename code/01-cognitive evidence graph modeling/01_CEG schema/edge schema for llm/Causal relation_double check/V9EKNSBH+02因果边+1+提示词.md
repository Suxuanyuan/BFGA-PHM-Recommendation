...
- **Reference ID**: V9EKNSBH
- **Paper Title**: A label description space embedded model for zero-shot intelligent diagnosis of mechanical compound faults
...
> **Input Material**: Reference ID `V9EKNSBH` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "V9EKNSBH_E045", "edge_description": "rolling element bearing contains constant operating conditions"},
    {"edge_id": "V9EKNSBH_E046", "edge_description": "planetary gearbox contains constant operating conditions"},
    {"edge_id": "V9EKNSBH_E047", "edge_description": "bearing fault contains mechanical compound faults"},
    {"edge_id": "V9EKNSBH_E048", "edge_description": "gear fault contains mechanical compound faults"},
    {"edge_id": "V9EKNSBH_E059", "edge_description": "bearing fault contains Single Severity"},
    {"edge_id": "V9EKNSBH_E060", "edge_description": "gear fault contains Single Severity"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `V9EKNSBH_E045` | `contains` | 02-Object Type | rolling element bearing |  | 03-Operating Conditions | constant operating conditions(Single Condition) |  |
| 2 | `V9EKNSBH_E046` | `contains` | 02-Object Type | planetary gearbox |  | 03-Operating Conditions | constant operating conditions(Single Condition) |  |
| 3 | `V9EKNSBH_E047` | `contains` | 05-Fault Mode | bearing fault |  | 07-Compound Fault | mechanical compound faults(Compound Fault Across Structures) |  |
| 4 | `V9EKNSBH_E048` | `contains` | 05-Fault Mode | gear fault |  | 07-Compound Fault | mechanical compound faults(Compound Fault Across Structures) |  |
| 5 | `V9EKNSBH_E059` | `contains` | 05-Fault Mode | bearing fault |  | 06-Fault Severity | Single Severity |  |
| 6 | `V9EKNSBH_E060` | `contains` | 05-Fault Mode | gear fault |  | 06-Fault Severity | Single Severity |  |
