...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `8EEFKLFF_E094` | `can obviously reflect` | 11-Sensor Information | tri-axial accelerator |  | 05-Fault Mode | pitting |  |
| 2 | `8EEFKLFF_E095` | `can obviously reflect` | 11-Sensor Information | tri-axial accelerator |  | 05-Fault Mode | worn |  |
| 3 | `8EEFKLFF_E096` | `can obviously reflect` | 11-Sensor Information | tri-axial accelerator |  | 05-Fault Mode | broken-tooth |  |
| 4 | `8EEFKLFF_E105` | `contains` | 05-Fault Mode | pitting |  | 06-Fault Severity | severity levels (0.18, 0.36 and 0.54 mm)(Multiple Severities) |  |
| 5 | `8EEFKLFF_E106` | `contains` | 05-Fault Mode | worn |  | 06-Fault Severity | severity levels (0.18, 0.36 and 0.54 mm)(Multiple Severities) |  |
| 6 | `8EEFKLFF_E107` | `contains` | 05-Fault Mode | broken-tooth |  | 06-Fault Severity | severity levels (0.18, 0.36 and 0.54 mm)(Multiple Severities) |  |
