...
- **Reference ID**: 2T5NKKZ8
- **Paper Title**: Diagnosis of Time Petri Nets Using Fault Diagnosis Graph
...
> **Input Material**: Reference ID `2T5NKKZ8` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "2T5NKKZ8_E027", "edge_description": "malfunctioning contains No Compound Fault"},
    {"edge_id": "2T5NKKZ8_E028", "edge_description": "malfunctioning contains No Compound Fault"},
    {"edge_id": "2T5NKKZ8_E029", "edge_description": "Event observer is collected on robot R1"},
    {"edge_id": "2T5NKKZ8_E030", "edge_description": "Event observer is collected on robot R2"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `2T5NKKZ8_E027` | `contains` | 05-Fault Mode | malfunctioning |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `2T5NKKZ8_E028` | `contains` | 05-Fault Mode | malfunctioning |  | 07-Compound Fault | No Compound Fault |  |
| 3 | `2T5NKKZ8_E029` | `is collected on` | 11-Sensor Information | Event observer |  | 04-Fault Location | robot R1 |  |
| 4 | `2T5NKKZ8_E030` | `is collected on` | 11-Sensor Information | Event observer |  | 04-Fault Location | robot R2 |  |
