...
- **Reference ID**: R28M6NJR
- **Paper Title**: Anomaly Detection and Fault Prognosis for Bearings
...
> **Input Material**: Reference ID `R28M6NJR` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "R28M6NJR_E068", "edge_description": "outer race fault contains No Compound Fault"},
    {"edge_id": "R28M6NJR_E069", "edge_description": "inner race fault contains No Compound Fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `R28M6NJR_E068` | `contains` | 05-Fault Mode | outer race fault |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `R28M6NJR_E069` | `contains` | 05-Fault Mode | inner race fault |  | 07-Compound Fault | No Compound Fault |  |
