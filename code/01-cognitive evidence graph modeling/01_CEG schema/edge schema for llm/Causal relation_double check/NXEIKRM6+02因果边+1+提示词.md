...
- **Reference ID**: NXEIKRM6
- **Paper Title**: A Current-Based Approach for Short-Circuit Fault Diagnosis in Closed-Loop Current Source Inverter
...
> **Input Material**: Reference ID `NXEIKRM6` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "NXEIKRM6_E039", "edge_description": "current source inverter contains fixed operating condition"},
    {"edge_id": "NXEIKRM6_E040", "edge_description": "power switch contains fixed operating condition"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `NXEIKRM6_E039` | `contains` | 02-Object Type | current source inverter |  | 03-Operating Conditions | fixed operating condition(Single Condition) |  |
| 2 | `NXEIKRM6_E040` | `contains` | 02-Object Type | power switch |  | 03-Operating Conditions | fixed operating condition(Single Condition) |  |
