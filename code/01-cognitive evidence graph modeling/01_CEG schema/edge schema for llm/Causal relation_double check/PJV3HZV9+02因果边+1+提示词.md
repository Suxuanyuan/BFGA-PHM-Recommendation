...
- **Reference ID**: PJV3HZV9
- **Paper Title**: Rotor-Current-Based Fault Diagnosis for DFIG Wind Turbine Drivetrain Gearboxes Using Frequency Analysis and a Deep Classifier
...
> **Input Material**: Reference ID `PJV3HZV9` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "PJV3HZV9_E079", "edge_description": "current sensor is collected on gear"},
    {"edge_id": "PJV3HZV9_E080", "edge_description": "position encoder is collected on gear"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `PJV3HZV9_E079` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | gear |  |
| 2 | `PJV3HZV9_E080` | `is collected on` | 11-Sensor Information | position encoder |  | 04-Fault Location | gear |  |
