...
- **Reference ID**: GVTZNYTK
- **Paper Title**: A fault diagnosis model based on weighted extension neural network for turbo-generator sets on small samples with noise
...
> **Input Material**: Reference ID `GVTZNYTK` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "GVTZNYTK_E076", "edge_description": "accelerometers is collected on rotor"},
    {"edge_id": "GVTZNYTK_E077", "edge_description": "accelerometers is collected on bearing"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `GVTZNYTK_E076` | `is collected on` | 11-Sensor Information | accelerometers |  | 04-Fault Location | rotor |  |
| 2 | `GVTZNYTK_E077` | `is collected on` | 11-Sensor Information | accelerometers |  | 04-Fault Location | bearing |  |
