...
- **Reference ID**: F9IZVV5Y
- **Paper Title**: A Hybrid Prognostics Approach for Estimating Remaining Useful Life of Rolling Element Bearings
...
> **Input Material**: Reference ID `F9IZVV5Y` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "F9IZVV5Y_E067", "edge_description": "wear contains Multiple Severities"},
    {"edge_id": "F9IZVV5Y_E068", "edge_description": "fracture contains Multiple Severities"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `F9IZVV5Y_E067` | `contains` | 05-Fault Mode | wear |  | 06-Fault Severity | Multiple Severities |  |
| 2 | `F9IZVV5Y_E068` | `contains` | 05-Fault Mode | fracture |  | 06-Fault Severity | Multiple Severities |  |
