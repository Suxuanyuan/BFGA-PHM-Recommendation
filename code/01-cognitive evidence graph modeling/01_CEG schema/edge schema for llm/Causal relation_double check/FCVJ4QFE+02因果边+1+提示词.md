...
- **Reference ID**: FCVJ4QFE
- **Paper Title**: An Empirical Investigation on a Multiple Filters-Based Approach for Remaining Useful Life Prediction
...
> **Input Material**: Reference ID `FCVJ4QFE` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "FCVJ4QFE_E054", "edge_description": "ball bearing contains ball bearings"},
    {"edge_id": "FCVJ4QFE_E055", "edge_description": "ball bearing contains aircraft engine"},
    {"edge_id": "FCVJ4QFE_E056", "edge_description": "turbofan engine contains ball bearings"},
    {"edge_id": "FCVJ4QFE_E057", "edge_description": "turbofan engine contains aircraft engine"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `FCVJ4QFE_E054` | `contains` | 02-Object Type | ball bearing |  | 04-Fault Location | ball bearings |  |
| 2 | `FCVJ4QFE_E055` | `contains` | 02-Object Type | ball bearing |  | 04-Fault Location | aircraft engine |  |
| 3 | `FCVJ4QFE_E056` | `contains` | 02-Object Type | turbofan engine |  | 04-Fault Location | ball bearings |  |
| 4 | `FCVJ4QFE_E057` | `contains` | 02-Object Type | turbofan engine |  | 04-Fault Location | aircraft engine |  |
