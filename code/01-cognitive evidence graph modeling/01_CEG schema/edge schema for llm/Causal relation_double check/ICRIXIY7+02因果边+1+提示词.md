...
- **Reference ID**: ICRIXIY7
- **Paper Title**: Fault diagnosis for rotating machinery based on Local Mean Decomposition morphology filtering and Least Square Support Vector Machine
...
> **Input Material**: Reference ID `ICRIXIY7` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "ICRIXIY7_E072", "edge_description": "outer-race fault contains No Compound Fault"},
    {"edge_id": "ICRIXIY7_E073", "edge_description": "inner-race fault contains No Compound Fault"},
    {"edge_id": "ICRIXIY7_E074", "edge_description": "rolling element fault contains No Compound Fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ICRIXIY7_E072` | `contains` | 05-Fault Mode | outer-race fault |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `ICRIXIY7_E073` | `contains` | 05-Fault Mode | inner-race fault |  | 07-Compound Fault | No Compound Fault |  |
| 3 | `ICRIXIY7_E074` | `contains` | 05-Fault Mode | rolling element fault |  | 07-Compound Fault | No Compound Fault |  |
