...
- **Reference ID**: JPPD7GZ4
- **Paper Title**: Fault diagnosis model of adaptive miniature circuit breaker based on fractal theory and probabilistic neural network
...
> **Input Material**: Reference ID `JPPD7GZ4` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "JPPD7GZ4_E066", "edge_description": "vibration sensor is collected on motor"},
    {"edge_id": "JPPD7GZ4_E067", "edge_description": "vibration sensor is collected on rivet"},
    {"edge_id": "JPPD7GZ4_E068", "edge_description": "vibration sensor is collected on gear"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `JPPD7GZ4_E066` | `is collected on` | 11-Sensor Information | vibration sensor |  | 04-Fault Location | motor |  |
| 2 | `JPPD7GZ4_E067` | `is collected on` | 11-Sensor Information | vibration sensor |  | 04-Fault Location | rivet |  |
| 3 | `JPPD7GZ4_E068` | `is collected on` | 11-Sensor Information | vibration sensor |  | 04-Fault Location | gear |  |
