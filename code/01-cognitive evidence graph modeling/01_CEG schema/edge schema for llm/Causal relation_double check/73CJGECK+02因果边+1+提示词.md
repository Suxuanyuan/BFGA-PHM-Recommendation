...
- **Reference ID**: 73CJGECK
- **Paper Title**: General normalized sparse filtering: A novel unsupervised learning method for rotating machinery fault diagnosis
...
> **Input Material**: Reference ID `73CJGECK` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "73CJGECK_E069", "edge_description": "outer race fault, inner race fault, roller fault contains complex fault of WF and BT (CF)"},
    {"edge_id": "73CJGECK_E070", "edge_description": "worn fault contains complex fault of WF and BT (CF)"},
    {"edge_id": "73CJGECK_E071", "edge_description": "broken tooth contains complex fault of WF and BT (CF)"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `73CJGECK_E069` | `contains` | 05-Fault Mode | outer race fault, inner race fault, roller fault |  | 07-Compound Fault | complex fault of WF and BT (CF)(Compound Fault Within Same Structure) |  |
| 2 | `73CJGECK_E070` | `contains` | 05-Fault Mode | worn fault |  | 07-Compound Fault | complex fault of WF and BT (CF)(Compound Fault Within Same Structure) |  |
| 3 | `73CJGECK_E071` | `contains` | 05-Fault Mode | broken tooth |  | 07-Compound Fault | complex fault of WF and BT (CF)(Compound Fault Within Same Structure) |  |
