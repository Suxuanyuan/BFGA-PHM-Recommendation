...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `J66EKKTD_E066` | `is collected on` | 11-Sensor Information | Accelerometers |  | 04-Fault Location | outer race |  |
| 2 | `J66EKKTD_E067` | `is collected on` | 11-Sensor Information | Accelerometers |  | 04-Fault Location | rolling element |  |
| 3 | `J66EKKTD_E068` | `is collected on` | 11-Sensor Information | Accelerometers |  | 04-Fault Location | inner race |  |
