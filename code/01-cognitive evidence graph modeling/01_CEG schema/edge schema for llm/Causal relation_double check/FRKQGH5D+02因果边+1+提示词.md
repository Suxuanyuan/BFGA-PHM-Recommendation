...
- **Reference ID**: FRKQGH5D
- **Paper Title**: Probabilistic Framework for Assessing the Accuracy of Data Mining Tool for Online Prediction of Transient Stability
...
> **Input Material**: Reference ID `FRKQGH5D` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "FRKQGH5D_E050", "edge_description": "generator contains transmission lines"},
    {"edge_id": "FRKQGH5D_E051", "edge_description": "generator contains generator buses"},
    {"edge_id": "FRKQGH5D_E054", "edge_description": "phasor measurement units (PMUs) is collected on transmission lines"},
    {"edge_id": "FRKQGH5D_E055", "edge_description": "phasor measurement units (PMUs) is collected on generator buses"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `FRKQGH5D_E050` | `contains` | 02-Object Type | generator |  | 04-Fault Location | transmission lines |  |
| 2 | `FRKQGH5D_E051` | `contains` | 02-Object Type | generator |  | 04-Fault Location | generator buses |  |
| 3 | `FRKQGH5D_E054` | `is collected on` | 11-Sensor Information | phasor measurement units (PMUs) |  | 04-Fault Location | transmission lines |  |
| 4 | `FRKQGH5D_E055` | `is collected on` | 11-Sensor Information | phasor measurement units (PMUs) |  | 04-Fault Location | generator buses |  |
