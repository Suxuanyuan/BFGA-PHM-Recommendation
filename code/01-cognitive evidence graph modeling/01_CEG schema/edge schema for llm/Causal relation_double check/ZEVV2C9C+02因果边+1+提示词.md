...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZEVV2C9C_E059` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | coupling |  |
| 2 | `ZEVV2C9C_E060` | `is collected on` | 11-Sensor Information | incremental encoder |  | 04-Fault Location | coupling |  |
