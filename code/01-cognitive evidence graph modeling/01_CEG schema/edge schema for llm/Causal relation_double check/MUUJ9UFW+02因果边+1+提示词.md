...
- **Reference ID**: MUUJ9UFW
- **Paper Title**: Model-Based General Arcing Fault Detection in Medium-Voltage Distribution Lines
...
> **Input Material**: Reference ID `MUUJ9UFW` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "MUUJ9UFW_E031", "edge_description": "current transformer (CT) is collected on underground cable"},
    {"edge_id": "MUUJ9UFW_E032", "edge_description": "current transformer (CT) is collected on overhead line"},
    {"edge_id": "MUUJ9UFW_E033", "edge_description": "potential transformer (PT) is collected on underground cable"},
    {"edge_id": "MUUJ9UFW_E034", "edge_description": "potential transformer (PT) is collected on overhead line"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `MUUJ9UFW_E031` | `is collected on` | 11-Sensor Information | current transformer (CT) |  | 04-Fault Location | underground cable |  |
| 2 | `MUUJ9UFW_E032` | `is collected on` | 11-Sensor Information | current transformer (CT) |  | 04-Fault Location | overhead line |  |
| 3 | `MUUJ9UFW_E033` | `is collected on` | 11-Sensor Information | potential transformer (PT) |  | 04-Fault Location | underground cable |  |
| 4 | `MUUJ9UFW_E034` | `is collected on` | 11-Sensor Information | potential transformer (PT) |  | 04-Fault Location | overhead line |  |
