...
- **Reference ID**: 6CEFHBR7
- **Paper Title**: Research on Feature Selection for Imbalanced Problem from Fault Diagnosis on Gear
...
> **Input Material**: Reference ID `6CEFHBR7` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "6CEFHBR7_E089", "edge_description": "tooth wear contains Single Severity"},
    {"edge_id": "6CEFHBR7_E090", "edge_description": "tooth bonding contains Single Severity"},
    {"edge_id": "6CEFHBR7_E091", "edge_description": "tooth surface fatigue contains Single Severity"},
    {"edge_id": "6CEFHBR7_E092", "edge_description": "broken teeth contains Single Severity"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `6CEFHBR7_E089` | `contains` | 05-Fault Mode | tooth wear |  | 06-Fault Severity | Single Severity |  |
| 2 | `6CEFHBR7_E090` | `contains` | 05-Fault Mode | tooth bonding |  | 06-Fault Severity | Single Severity |  |
| 3 | `6CEFHBR7_E091` | `contains` | 05-Fault Mode | tooth surface fatigue |  | 06-Fault Severity | Single Severity |  |
| 4 | `6CEFHBR7_E092` | `contains` | 05-Fault Mode | broken teeth |  | 06-Fault Severity | Single Severity |  |
