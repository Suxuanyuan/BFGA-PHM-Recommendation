...
- **Reference ID**: ZDN6U4TU
- **Paper Title**: Probabilistic forecasting informed failure prognostics framework for improved RUL prediction under uncertainty: A transformer case study
...
> **Input Material**: Reference ID `ZDN6U4TU` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "ZDN6U4TU_E053", "edge_description": "temperature sensor is collected on solid insulation paper"},
    {"edge_id": "ZDN6U4TU_E054", "edge_description": "current sensor is collected on solid insulation paper"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZDN6U4TU_E053` | `is collected on` | 11-Sensor Information | temperature sensor |  | 04-Fault Location | solid insulation paper |  |
| 2 | `ZDN6U4TU_E054` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | solid insulation paper |  |
