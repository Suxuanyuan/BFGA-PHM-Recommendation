...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `LIF3IC45_E035` | `is collected on` | 11-Sensor Information | voltage measurement |  | 04-Fault Location | resistors R1–R4 |  |
| 2 | `LIF3IC45_E036` | `is collected on` | 11-Sensor Information | voltage measurement |  | 04-Fault Location | transistors M1–M10 |  |
