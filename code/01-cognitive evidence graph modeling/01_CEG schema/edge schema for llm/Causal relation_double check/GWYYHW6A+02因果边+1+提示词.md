...
- **Reference ID**: GWYYHW6A
- **Paper Title**: Diagnosis of Induction Motor Faults via Gabor Analysis of the Current in Transient Regime
...
> **Input Material**: Reference ID `GWYYHW6A` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "GWYYHW6A_E097", "edge_description": "current transformer is collected on rotor bar"},
    {"edge_id": "GWYYHW6A_E098", "edge_description": "current transformer is collected on bearing housings"},
    {"edge_id": "GWYYHW6A_E099", "edge_description": "incremental encoder is collected on rotor bar"},
    {"edge_id": "GWYYHW6A_E100", "edge_description": "incremental encoder is collected on bearing housings"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `GWYYHW6A_E097` | `is collected on` | 11-Sensor Information | current transformer |  | 04-Fault Location | rotor bar |  |
| 2 | `GWYYHW6A_E098` | `is collected on` | 11-Sensor Information | current transformer |  | 04-Fault Location | bearing housings |  |
| 3 | `GWYYHW6A_E099` | `is collected on` | 11-Sensor Information | incremental encoder |  | 04-Fault Location | rotor bar |  |
| 4 | `GWYYHW6A_E100` | `is collected on` | 11-Sensor Information | incremental encoder |  | 04-Fault Location | bearing housings |  |
