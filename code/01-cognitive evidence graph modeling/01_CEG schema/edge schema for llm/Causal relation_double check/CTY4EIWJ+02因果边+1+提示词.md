...
- **Reference ID**: CTY4EIWJ
- **Paper Title**: Fault Propagation Inference Based on a Graph Neural Network for Steam Turbine Systems
...
> **Input Material**: Reference ID `CTY4EIWJ` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "CTY4EIWJ_E086", "edge_description": "pressure sensor is collected on interstage gland"},
    {"edge_id": "CTY4EIWJ_E087", "edge_description": "pressure sensor is collected on shaft gland"},
    {"edge_id": "CTY4EIWJ_E088", "edge_description": "flow sensor is collected on interstage gland"},
    {"edge_id": "CTY4EIWJ_E089", "edge_description": "flow sensor is collected on shaft gland"},
    {"edge_id": "CTY4EIWJ_E090", "edge_description": "speed sensor is collected on interstage gland"},
    {"edge_id": "CTY4EIWJ_E091", "edge_description": "speed sensor is collected on shaft gland"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CTY4EIWJ_E086` | `is collected on` | 11-Sensor Information | pressure sensor |  | 04-Fault Location | interstage gland |  |
| 2 | `CTY4EIWJ_E087` | `is collected on` | 11-Sensor Information | pressure sensor |  | 04-Fault Location | shaft gland |  |
| 3 | `CTY4EIWJ_E088` | `is collected on` | 11-Sensor Information | flow sensor |  | 04-Fault Location | interstage gland |  |
| 4 | `CTY4EIWJ_E089` | `is collected on` | 11-Sensor Information | flow sensor |  | 04-Fault Location | shaft gland |  |
| 5 | `CTY4EIWJ_E090` | `is collected on` | 11-Sensor Information | speed sensor |  | 04-Fault Location | interstage gland |  |
| 6 | `CTY4EIWJ_E091` | `is collected on` | 11-Sensor Information | speed sensor |  | 04-Fault Location | shaft gland |  |
