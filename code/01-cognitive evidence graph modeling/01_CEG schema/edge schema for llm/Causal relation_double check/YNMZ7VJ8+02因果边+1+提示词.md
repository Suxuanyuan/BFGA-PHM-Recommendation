...
- **Reference ID**: YNMZ7VJ8
- **Paper Title**: A novel KFCM based fault diagnosis method for unknown faults in satellite reaction wheels
...
> **Input Material**: Reference ID `YNMZ7VJ8` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "YNMZ7VJ8_E042", "edge_description": "idling fault contains mixed-unknown-fault"},
    {"edge_id": "YNMZ7VJ8_E043", "edge_description": "friction torque increase fault contains mixed-unknown-fault"},
    {"edge_id": "YNMZ7VJ8_E044", "edge_description": "back EMF increase fault contains mixed-unknown-fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `YNMZ7VJ8_E042` | `contains` | 05-Fault Mode | idling fault |  | 07-Compound Fault | mixed-unknown-fault(Compound Fault Within Same Structure) |  |
| 2 | `YNMZ7VJ8_E043` | `contains` | 05-Fault Mode | friction torque increase fault |  | 07-Compound Fault | mixed-unknown-fault(Compound Fault Within Same Structure) |  |
| 3 | `YNMZ7VJ8_E044` | `contains` | 05-Fault Mode | back EMF increase fault |  | 07-Compound Fault | mixed-unknown-fault(Compound Fault Within Same Structure) |  |
