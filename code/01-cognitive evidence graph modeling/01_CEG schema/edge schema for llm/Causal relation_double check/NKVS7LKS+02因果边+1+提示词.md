...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `NKVS7LKS_E051` | `contains` | 02-Object Type | Pioneer 3-AT vehicle |  | 04-Fault Location | Pioneer 3-AT vehicle |  |
| 2 | `NKVS7LKS_E052` | `contains` | 02-Object Type | Pioneer P3-DX vehicle |  | 04-Fault Location | Pioneer 3-AT vehicle |  |
