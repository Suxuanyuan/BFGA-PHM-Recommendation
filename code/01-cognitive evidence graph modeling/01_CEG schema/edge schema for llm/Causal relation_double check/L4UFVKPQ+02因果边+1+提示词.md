...
- **Reference ID**: L4UFVKPQ
- **Paper Title**: Actual bearing compound fault diagnosis based on active learning and decoupling attentional residual network
...
> **Input Material**: Reference ID `L4UFVKPQ` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "L4UFVKPQ_E080", "edge_description": "inner race fault contains bearing compound fault"},
    {"edge_id": "L4UFVKPQ_E081", "edge_description": "outer race fault contains bearing compound fault"},
    {"edge_id": "L4UFVKPQ_E082", "edge_description": "roller fault contains bearing compound fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `L4UFVKPQ_E080` | `contains` | 05-Fault Mode | inner race fault |  | 07-Compound Fault | bearing compound fault(Compound Fault Within Same Structure) |  |
| 2 | `L4UFVKPQ_E081` | `contains` | 05-Fault Mode | outer race fault |  | 07-Compound Fault | bearing compound fault(Compound Fault Within Same Structure) |  |
| 3 | `L4UFVKPQ_E082` | `contains` | 05-Fault Mode | roller fault |  | 07-Compound Fault | bearing compound fault(Compound Fault Within Same Structure) |  |
