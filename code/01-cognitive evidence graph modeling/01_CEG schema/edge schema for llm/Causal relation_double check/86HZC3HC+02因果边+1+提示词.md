...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `86HZC3HC_E078` | `contains` | 02-Object Type | rolling bearing |  | 03-Operating Conditions | multiple constant operating conditions(Multiple Conditions) |  |
| 2 | `86HZC3HC_E079` | `contains` | 02-Object Type | gearbox |  | 03-Operating Conditions | multiple constant operating conditions(Multiple Conditions) |  |
| 3 | `86HZC3HC_E083` | `is collected on` | 11-Sensor Information | acceleration sensor / accelerometer |  | 04-Fault Location | bearing outer race |  |
| 4 | `86HZC3HC_E084` | `is collected on` | 11-Sensor Information | acceleration sensor / accelerometer |  | 04-Fault Location | pinion on output shaft |  |
| 5 | `86HZC3HC_E085` | `is collected on` | 11-Sensor Information | acceleration sensor / accelerometer |  | 04-Fault Location | bearing inner race |  |
