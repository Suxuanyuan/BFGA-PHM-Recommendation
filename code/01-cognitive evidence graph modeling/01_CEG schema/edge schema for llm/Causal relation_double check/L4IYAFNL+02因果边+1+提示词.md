...
- **Reference ID**: L4IYAFNL
- **Paper Title**: A Composite Failure Precursor for Condition Monitoring and Remaining Useful Life Prediction of Discrete Power Devices
...
> **Input Material**: Reference ID `L4IYAFNL` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "L4IYAFNL_E071", "edge_description": "Thermocouples can obviously reflect gate interface degradation"},
    {"edge_id": "L4IYAFNL_E072", "edge_description": "Thermocouples can obviously reflect package related degradation"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `L4IYAFNL_E071` | `can obviously reflect` | 11-Sensor Information | Thermocouples |  | 05-Fault Mode | gate interface degradation |  |
| 2 | `L4IYAFNL_E072` | `can obviously reflect` | 11-Sensor Information | Thermocouples |  | 05-Fault Mode | package related degradation |  |
