...
- **Reference ID**: DA56S4EE
- **Paper Title**: Data inheritance-based updating method and its application in transient frequency prediction for a power system
...
> **Input Material**: Reference ID `DA56S4EE` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "DA56S4EE_E087", "edge_description": "phasor measurement unit (PMU) is collected on generator"},
    {"edge_id": "DA56S4EE_E088", "edge_description": "phasor measurement unit (PMU) is collected on transmission line"},
    {"edge_id": "DA56S4EE_E097", "edge_description": "generator exiting operation contains Single Severity"},
    {"edge_id": "DA56S4EE_E098", "edge_description": "transmission line disconnection contains Single Severity"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `DA56S4EE_E087` | `is collected on` | 11-Sensor Information | phasor measurement unit (PMU) |  | 04-Fault Location | generator |  |
| 2 | `DA56S4EE_E088` | `is collected on` | 11-Sensor Information | phasor measurement unit (PMU) |  | 04-Fault Location | transmission line |  |
| 3 | `DA56S4EE_E097` | `contains` | 05-Fault Mode | generator exiting operation |  | 06-Fault Severity | Single Severity |  |
| 4 | `DA56S4EE_E098` | `contains` | 05-Fault Mode | transmission line disconnection |  | 06-Fault Severity | Single Severity |  |
