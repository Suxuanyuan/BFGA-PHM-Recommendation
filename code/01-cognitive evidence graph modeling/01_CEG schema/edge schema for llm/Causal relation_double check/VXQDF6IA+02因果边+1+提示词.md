...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VXQDF6IA_E091` | `contains` | 02-Object Type | gearbox / gear |  | 03-Operating Conditions | constant operating conditions(Single Condition) |  |
| 2 | `VXQDF6IA_E092` | `contains` | 02-Object Type | bearing |  | 03-Operating Conditions | constant operating conditions(Single Condition) |  |
