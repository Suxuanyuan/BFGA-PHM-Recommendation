...
- **Reference ID**: SVLKEZ7A
- **Paper Title**: Diagnosis-Free Self-Healing Scheme for Open-Circuit Faults in Dual Three-Phase PMSM Drives
...
> **Input Material**: Reference ID `SVLKEZ7A` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "SVLKEZ7A_E028", "edge_description": "unified field contains stator winding"},
    {"edge_id": "SVLKEZ7A_E029", "edge_description": "unified field contains inverter"},
    {"edge_id": "SVLKEZ7A_E032", "edge_description": "stator winding has_fault_mode open-circuit fault"},
    {"edge_id": "SVLKEZ7A_E033", "edge_description": "inverter has_fault_mode open-circuit fault"},
    {"edge_id": "SVLKEZ7A_E036", "edge_description": "stator winding contains_phm_task unified field representation"},
    {"edge_id": "SVLKEZ7A_E037", "edge_description": "inverter contains_phm_task unified field representation"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SVLKEZ7A_E028` | `contains` | 02-Object Type | unified field |  | 04-Fault Location | stator winding |  |
| 2 | `SVLKEZ7A_E029` | `contains` | 02-Object Type | unified field |  | 04-Fault Location | inverter |  |
| 3 | `SVLKEZ7A_E032` | `has_fault_mode` | 04-Fault Location | stator winding |  | 05-Fault Mode | open-circuit fault |  |
| 4 | `SVLKEZ7A_E033` | `has_fault_mode` | 04-Fault Location | inverter |  | 05-Fault Mode | open-circuit fault |  |
| 5 | `SVLKEZ7A_E036` | `contains_phm_task` | 04-Fault Location | stator winding |  | 08-PHM Task | unified field representation(Other Task) |  |
| 6 | `SVLKEZ7A_E037` | `contains_phm_task` | 04-Fault Location | inverter |  | 08-PHM Task | unified field representation(Other Task) |  |
