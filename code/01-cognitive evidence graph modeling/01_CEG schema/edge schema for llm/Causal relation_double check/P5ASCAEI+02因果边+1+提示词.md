...
- **Reference ID**: P5ASCAEI
- **Paper Title**: Rolling bearing fault diagnosis using transient-extracting transform and linear discriminant analysis
...
> **Input Material**: Reference ID `P5ASCAEI` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "P5ASCAEI_E070", "edge_description": "pitting contains No Compound Fault"},
    {"edge_id": "P5ASCAEI_E071", "edge_description": "wear contains No Compound Fault"},
    {"edge_id": "P5ASCAEI_E076", "edge_description": "accelerometers can obviously reflect pitting"},
    {"edge_id": "P5ASCAEI_E077", "edge_description": "accelerometers can obviously reflect wear"},
    {"edge_id": "P5ASCAEI_E081", "edge_description": "rolling bearing has_fault_mode pitting"},
    {"edge_id": "P5ASCAEI_E082", "edge_description": "rolling bearing has_fault_mode wear"},
    {"edge_id": "P5ASCAEI_E083", "edge_description": "inner race has_fault_mode pitting"},
    {"edge_id": "P5ASCAEI_E084", "edge_description": "inner race has_fault_mode wear"},
    {"edge_id": "P5ASCAEI_E085", "edge_description": "outer race has_fault_mode pitting"},
    {"edge_id": "P5ASCAEI_E086", "edge_description": "outer race has_fault_mode wear"},
    {"edge_id": "P5ASCAEI_E087", "edge_description": "ball has_fault_mode pitting"},
    {"edge_id": "P5ASCAEI_E088", "edge_description": "ball has_fault_mode wear"},
    {"edge_id": "P5ASCAEI_E089", "edge_description": "pitting contains Extent of Damage"},
    {"edge_id": "P5ASCAEI_E090", "edge_description": "wear contains Extent of Damage"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `P5ASCAEI_E070` | `contains` | 05-Fault Mode | pitting |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `P5ASCAEI_E071` | `contains` | 05-Fault Mode | wear |  | 07-Compound Fault | No Compound Fault |  |
| 3 | `P5ASCAEI_E076` | `can obviously reflect` | 11-Sensor Information | accelerometers |  | 05-Fault Mode | pitting |  |
| 4 | `P5ASCAEI_E077` | `can obviously reflect` | 11-Sensor Information | accelerometers |  | 05-Fault Mode | wear |  |
| 5 | `P5ASCAEI_E081` | `has_fault_mode` | 04-Fault Location | rolling bearing |  | 05-Fault Mode | pitting |  |
| 6 | `P5ASCAEI_E082` | `has_fault_mode` | 04-Fault Location | rolling bearing |  | 05-Fault Mode | wear |  |
| 7 | `P5ASCAEI_E083` | `has_fault_mode` | 04-Fault Location | inner race |  | 05-Fault Mode | pitting |  |
| 8 | `P5ASCAEI_E084` | `has_fault_mode` | 04-Fault Location | inner race |  | 05-Fault Mode | wear |  |
| 9 | `P5ASCAEI_E085` | `has_fault_mode` | 04-Fault Location | outer race |  | 05-Fault Mode | pitting |  |
| 10 | `P5ASCAEI_E086` | `has_fault_mode` | 04-Fault Location | outer race |  | 05-Fault Mode | wear |  |
| 11 | `P5ASCAEI_E087` | `has_fault_mode` | 04-Fault Location | ball |  | 05-Fault Mode | pitting |  |
| 12 | `P5ASCAEI_E088` | `has_fault_mode` | 04-Fault Location | ball |  | 05-Fault Mode | wear |  |
| 13 | `P5ASCAEI_E089` | `contains` | 05-Fault Mode | pitting |  | 06-Fault Severity | Extent of Damage(Multiple Severities) |  |
| 14 | `P5ASCAEI_E090` | `contains` | 05-Fault Mode | wear |  | 06-Fault Severity | Extent of Damage(Multiple Severities) |  |
...
*This prompt is automatically generated by edge_02_prompt_v2.py (Batch 1, total 14 edges)*
