...
- **Reference ID**: Y3AMZRDJ
- **Paper Title**: Performance degradation assessment for aircraft environmental control system: A method based on visual cognition
...
> **Input Material**: Reference ID `Y3AMZRDJ` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "Y3AMZRDJ_E065", "edge_description": "temperature sensor is collected on valve"},
    {"edge_id": "Y3AMZRDJ_E066", "edge_description": "temperature sensor is collected on temperature sensor"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `Y3AMZRDJ_E065` | `is collected on` | 11-Sensor Information | temperature sensor |  | 04-Fault Location | valve |  |
| 2 | `Y3AMZRDJ_E066` | `is collected on` | 11-Sensor Information | temperature sensor |  | 04-Fault Location | temperature sensor |  |
