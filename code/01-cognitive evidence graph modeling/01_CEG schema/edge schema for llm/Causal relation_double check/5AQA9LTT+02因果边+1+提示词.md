...
- **Reference ID**: 5AQA9LTT
- **Paper Title**: An Approach to Locate Parametric Faults in Nonlinear Analog Circuits
...
> **Input Material**: Reference ID `5AQA9LTT` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "5AQA9LTT_E073", "edge_description": "voltage sensor is collected on resistor"},
    {"edge_id": "5AQA9LTT_E074", "edge_description": "voltage sensor is collected on capacitor"},
    {"edge_id": "5AQA9LTT_E075", "edge_description": "voltage sensor is collected on operational amplifier"},
    {"edge_id": "5AQA9LTT_E076", "edge_description": "voltage sensor is collected on transistor"},
    {"edge_id": "5AQA9LTT_E077", "edge_description": "voltage sensor can obviously reflect short circuit"},
    {"edge_id": "5AQA9LTT_E078", "edge_description": "voltage sensor can obviously reflect open circuit"},
    {"edge_id": "5AQA9LTT_E079", "edge_description": "voltage sensor can obviously reflect parametric fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `5AQA9LTT_E073` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | resistor |  |
| 2 | `5AQA9LTT_E074` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | capacitor |  |
| 3 | `5AQA9LTT_E075` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | operational amplifier |  |
| 4 | `5AQA9LTT_E076` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | transistor |  |
| 5 | `5AQA9LTT_E077` | `can obviously reflect` | 11-Sensor Information | voltage sensor |  | 05-Fault Mode | short circuit |  |
| 6 | `5AQA9LTT_E078` | `can obviously reflect` | 11-Sensor Information | voltage sensor |  | 05-Fault Mode | open circuit |  |
| 7 | `5AQA9LTT_E079` | `can obviously reflect` | 11-Sensor Information | voltage sensor |  | 05-Fault Mode | parametric fault |  |
