...
- **Reference ID**: FDMBPZUP
- **Paper Title**: Rider-Deep-LSTM Network for Hybrid Distance Score-Based Fault Prediction in Analog Circuits
...
> **Input Material**: Reference ID `FDMBPZUP` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "FDMBPZUP_E092", "edge_description": "voltage sensor is collected on resistor"},
    {"edge_id": "FDMBPZUP_E093", "edge_description": "voltage sensor is collected on capacitor"},
    {"edge_id": "FDMBPZUP_E094", "edge_description": "voltage sensor is collected on inductor"},
    {"edge_id": "FDMBPZUP_E095", "edge_description": "current sensor is collected on resistor"},
    {"edge_id": "FDMBPZUP_E096", "edge_description": "current sensor is collected on capacitor"},
    {"edge_id": "FDMBPZUP_E097", "edge_description": "current sensor is collected on inductor"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `FDMBPZUP_E092` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | resistor |  |
| 2 | `FDMBPZUP_E093` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | capacitor |  |
| 3 | `FDMBPZUP_E094` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | inductor |  |
| 4 | `FDMBPZUP_E095` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | resistor |  |
| 5 | `FDMBPZUP_E096` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | capacitor |  |
| 6 | `FDMBPZUP_E097` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | inductor |  |
