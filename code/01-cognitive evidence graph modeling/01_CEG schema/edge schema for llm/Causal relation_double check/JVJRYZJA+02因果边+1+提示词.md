...
- **Reference ID**: JVJRYZJA
- **Paper Title**: Signed Bond Graph for multiple faults diagnosis
...
> **Input Material**: Reference ID `JVJRYZJA` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "JVJRYZJA_E041", "edge_description": "inertia parameter fault contains Single Severity"},
    {"edge_id": "JVJRYZJA_E042", "edge_description": "inductance parameter fault contains Single Severity"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `JVJRYZJA_E041` | `contains` | 05-Fault Mode | inertia parameter fault |  | 06-Fault Severity | Single Severity |  |
| 2 | `JVJRYZJA_E042` | `contains` | 05-Fault Mode | inductance parameter fault |  | 06-Fault Severity | Single Severity |  |
