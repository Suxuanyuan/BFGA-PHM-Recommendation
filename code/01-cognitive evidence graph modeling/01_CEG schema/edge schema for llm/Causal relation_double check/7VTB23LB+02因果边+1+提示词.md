...
- **Reference ID**: 7VTB23LB
- **Paper Title**: Deep learning fault diagnosis method based on global optimization GAN for unbalanced data
...
> **Input Material**: Reference ID `7VTB23LB` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "7VTB23LB_E097", "edge_description": "rolling bearing contains steady-state operating conditions"},
    {"edge_id": "7VTB23LB_E098", "edge_description": "Tennessee Eastman (TE) process system contains steady-state operating conditions"},
    {"edge_id": "7VTB23LB_E099", "edge_description": "Air Production System (APS) contains steady-state operating conditions"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `7VTB23LB_E097` | `contains` | 02-Object Type | rolling bearing |  | 03-Operating Conditions | steady-state operating conditions(Single Condition) |  |
| 2 | `7VTB23LB_E098` | `contains` | 02-Object Type | Tennessee Eastman (TE) process system |  | 03-Operating Conditions | steady-state operating conditions(Single Condition) |  |
| 3 | `7VTB23LB_E099` | `contains` | 02-Object Type | Air Production System (APS) |  | 03-Operating Conditions | steady-state operating conditions(Single Condition) |  |
