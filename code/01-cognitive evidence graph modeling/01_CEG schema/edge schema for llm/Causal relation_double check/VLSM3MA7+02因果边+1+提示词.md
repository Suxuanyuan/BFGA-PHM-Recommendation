...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VLSM3MA7_E086` | `contains` | 02-Object Type | gearbox |  | 03-Operating Conditions | constant operating conditions(Single Condition) |  |
| 2 | `VLSM3MA7_E087` | `contains` | 02-Object Type | bearing |  | 03-Operating Conditions | constant operating conditions(Single Condition) |  |
