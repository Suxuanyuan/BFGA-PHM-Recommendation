...
- **Reference ID**: QVULRS8I
- **Paper Title**: Probabilistic Information-Theoretic Discriminant Analysis for Industrial Label-Noise Fault Diagnosis
...
> **Input Material**: Reference ID `QVULRS8I` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "QVULRS8I_E048", "edge_description": "Tennessee Eastman benchmark process contains reciprocating air compressor"},
    {"edge_id": "QVULRS8I_E049", "edge_description": "reciprocating air compressor contains reciprocating air compressor"},
    {"edge_id": "QVULRS8I_E050", "edge_description": "Tennessee Eastman benchmark process contains steady operating conditions"},
    {"edge_id": "QVULRS8I_E051", "edge_description": "reciprocating air compressor contains steady operating conditions"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `QVULRS8I_E048` | `contains` | 02-Object Type | Tennessee Eastman benchmark process |  | 04-Fault Location | reciprocating air compressor |  |
| 2 | `QVULRS8I_E049` | `contains` | 02-Object Type | reciprocating air compressor |  | 04-Fault Location | reciprocating air compressor |  |
| 3 | `QVULRS8I_E050` | `contains` | 02-Object Type | Tennessee Eastman benchmark process |  | 03-Operating Conditions | steady operating conditions(Single Condition) |  |
| 4 | `QVULRS8I_E051` | `contains` | 02-Object Type | reciprocating air compressor |  | 03-Operating Conditions | steady operating conditions(Single Condition) |  |
