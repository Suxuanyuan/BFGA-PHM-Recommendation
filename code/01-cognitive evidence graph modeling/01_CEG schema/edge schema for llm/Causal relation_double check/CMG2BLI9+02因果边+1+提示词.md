...
- **Reference ID**: CMG2BLI9
- **Paper Title**: A novel deep autoencoder feature learning method for rotating machinery fault diagnosis
...
> **Input Material**: Reference ID `CMG2BLI9` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "CMG2BLI9_E081", "edge_description": "eccentric fault contains Compound faults"},
    {"edge_id": "CMG2BLI9_E082", "edge_description": "abrasion fault contains Compound faults"},
    {"edge_id": "CMG2BLI9_E083", "edge_description": "misalignment fault contains Compound faults"},
    {"edge_id": "CMG2BLI9_E084", "edge_description": "spalling fault contains Compound faults"},
    {"edge_id": "CMG2BLI9_E085", "edge_description": "inner race defect contains Compound faults"},
    {"edge_id": "CMG2BLI9_E086", "edge_description": "outer race defect contains Compound faults"},
    {"edge_id": "CMG2BLI9_E087", "edge_description": "roller defect contains Compound faults"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CMG2BLI9_E081` | `contains` | 05-Fault Mode | eccentric fault |  | 07-Compound Fault | Compound faults(Compound Fault Within Same Structure) |  |
| 2 | `CMG2BLI9_E082` | `contains` | 05-Fault Mode | abrasion fault |  | 07-Compound Fault | Compound faults(Compound Fault Within Same Structure) |  |
| 3 | `CMG2BLI9_E083` | `contains` | 05-Fault Mode | misalignment fault |  | 07-Compound Fault | Compound faults(Compound Fault Within Same Structure) |  |
| 4 | `CMG2BLI9_E084` | `contains` | 05-Fault Mode | spalling fault |  | 07-Compound Fault | Compound faults(Compound Fault Within Same Structure) |  |
| 5 | `CMG2BLI9_E085` | `contains` | 05-Fault Mode | inner race defect |  | 07-Compound Fault | Compound faults(Compound Fault Within Same Structure) |  |
| 6 | `CMG2BLI9_E086` | `contains` | 05-Fault Mode | outer race defect |  | 07-Compound Fault | Compound faults(Compound Fault Within Same Structure) |  |
| 7 | `CMG2BLI9_E087` | `contains` | 05-Fault Mode | roller defect |  | 07-Compound Fault | Compound faults(Compound Fault Within Same Structure) |  |
...
*This prompt is automatically generated by edge_02_prompt_v2.py (Batch 1, total 7 edges)*
