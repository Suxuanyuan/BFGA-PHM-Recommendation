...
- **Reference ID**: EV6RGH4P
- **Paper Title**: Fault diagnosis of sun gear based on continuous vibration separation and minimum entropy deconvolution
...
> **Input Material**: Reference ID `EV6RGH4P` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "EV6RGH4P_E062", "edge_description": "accelerometers is collected on sun gear"},
    {"edge_id": "EV6RGH4P_E063", "edge_description": "tachometer is collected on sun gear"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `EV6RGH4P_E062` | `is collected on` | 11-Sensor Information | accelerometers |  | 04-Fault Location | sun gear |  |
| 2 | `EV6RGH4P_E063` | `is collected on` | 11-Sensor Information | tachometer |  | 04-Fault Location | sun gear |  |
