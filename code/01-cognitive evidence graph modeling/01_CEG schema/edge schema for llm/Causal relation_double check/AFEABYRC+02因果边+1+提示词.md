...
- **Reference ID**: AFEABYRC
- **Paper Title**: Fault detection and diagnosis of diesel engine valve trains
...
> **Input Material**: Reference ID `AFEABYRC` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "AFEABYRC_E074", "edge_description": "deformed valve spring contains 0.5 mm spring deformation, 0.05 mm small clearance fault, 0.25 mm large clearance fault"},
    {"edge_id": "AFEABYRC_E075", "edge_description": "abnormal valve clearance contains 0.5 mm spring deformation, 0.05 mm small clearance fault, 0.25 mm large clearance fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AFEABYRC_E074` | `contains` | 05-Fault Mode | deformed valve spring |  | 06-Fault Severity | 0.5 mm spring deformation, 0.05 mm small clearance fault, 0.25 mm large clearance fault(Single Severity) |  |
| 2 | `AFEABYRC_E075` | `contains` | 05-Fault Mode | abnormal valve clearance |  | 06-Fault Severity | 0.5 mm spring deformation, 0.05 mm small clearance fault, 0.25 mm large clearance fault(Single Severity) |  |
