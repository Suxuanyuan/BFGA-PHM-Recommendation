...
- **Reference ID**: BFPK4B5Y
- **Paper Title**: Fault-Tolerant Strategy for a Photovoltaic DC-DC Converter
...
> **Input Material**: Reference ID `BFPK4B5Y` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "BFPK4B5Y_E037", "edge_description": "voltage sensor is collected on power switch"},
    {"edge_id": "BFPK4B5Y_E038", "edge_description": "current sensor is collected on power switch"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `BFPK4B5Y_E037` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | power switch |  |
| 2 | `BFPK4B5Y_E038` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | power switch |  |
