...
- **Reference ID**: VV9QRE4B
- **Paper Title**: Intelligent Fault Diagnosis for Rotary Machinery Using Transferable Convolutional Neural Network
...
> **Input Material**: Reference ID `VV9QRE4B` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "VV9QRE4B_E089", "edge_description": "inner race defect, outer race defect, ball defect contains combinations of bearing faults and gear faults"},
    {"edge_id": "VV9QRE4B_E090", "edge_description": "chipped tooth, missing tooth contains combinations of bearing faults and gear faults"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VV9QRE4B_E089` | `contains` | 05-Fault Mode | inner race defect, outer race defect, ball defect |  | 07-Compound Fault | combinations of bearing faults and gear faults(Compound Fault Across Structures) |  |
| 2 | `VV9QRE4B_E090` | `contains` | 05-Fault Mode | chipped tooth, missing tooth |  | 07-Compound Fault | combinations of bearing faults and gear faults(Compound Fault Across Structures) |  |
