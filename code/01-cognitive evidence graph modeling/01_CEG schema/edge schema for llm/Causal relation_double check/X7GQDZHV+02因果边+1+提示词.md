...
- **Reference ID**: X7GQDZHV
- **Paper Title**: A Deep Learning Based Data-Driven Thruster Fault Diagnosis Approach for Satellite Attitude Control System
...
> **Input Material**: Reference ID `X7GQDZHV` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "X7GQDZHV_E061", "edge_description": "stuck-open contains No Compound Fault"},
    {"edge_id": "X7GQDZHV_E062", "edge_description": "stuck-close contains No Compound Fault"},
    {"edge_id": "X7GQDZHV_E063", "edge_description": "3-axis magnetometer is collected on thruster"},
    {"edge_id": "X7GQDZHV_E064", "edge_description": "3-axis accelerator is collected on thruster"},
    {"edge_id": "X7GQDZHV_E065", "edge_description": "3-axis rate gyro is collected on thruster"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `X7GQDZHV_E061` | `contains` | 05-Fault Mode | stuck-open |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `X7GQDZHV_E062` | `contains` | 05-Fault Mode | stuck-close |  | 07-Compound Fault | No Compound Fault |  |
| 3 | `X7GQDZHV_E063` | `is collected on` | 11-Sensor Information | 3-axis magnetometer |  | 04-Fault Location | thruster |  |
| 4 | `X7GQDZHV_E064` | `is collected on` | 11-Sensor Information | 3-axis accelerator |  | 04-Fault Location | thruster |  |
| 5 | `X7GQDZHV_E065` | `is collected on` | 11-Sensor Information | 3-axis rate gyro |  | 04-Fault Location | thruster |  |
