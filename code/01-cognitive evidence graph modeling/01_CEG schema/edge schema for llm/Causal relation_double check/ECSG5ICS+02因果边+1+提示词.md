...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ECSG5ICS_E138` | `contains` | 05-Fault Mode | Overheating |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `ECSG5ICS_E139` | `contains` | 05-Fault Mode | Assembly damage |  | 07-Compound Fault | No Compound Fault |  |
| 3 | `ECSG5ICS_E140` | `contains` | 05-Fault Mode | Scuffing |  | 07-Compound Fault | No Compound Fault |  |
| 4 | `ECSG5ICS_E141` | `contains` | 05-Fault Mode | Dents |  | 07-Compound Fault | No Compound Fault |  |
| 5 | `ECSG5ICS_E142` | `contains` | 05-Fault Mode | Fretting corrosion |  | 07-Compound Fault | No Compound Fault |  |
