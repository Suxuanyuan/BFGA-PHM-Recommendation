...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `KPW43WCF_E080` | `is collected on` | 11-Sensor Information | Sony IC recorder (ICD-UX513F) |  | 04-Fault Location | cylinder |  |
| 2 | `KPW43WCF_E081` | `is collected on` | 11-Sensor Information | Sony IC recorder (ICD-UX513F) |  | 04-Fault Location | intake manifold |  |
| 3 | `KPW43WCF_E082` | `is collected on` | 11-Sensor Information | Sony IC recorder (ICD-UX513F) |  | 04-Fault Location | camshaft position sensor |  |
| 4 | `KPW43WCF_E083` | `is collected on` | 11-Sensor Information | Sony IC recorder (ICD-UX513F) |  | 04-Fault Location | engine coolant temperature sensor |  |
| 5 | `KPW43WCF_E084` | `is collected on` | 11-Sensor Information | Sony IC recorder (ICD-UX513F) |  | 04-Fault Location | mass air flow sensor |  |
