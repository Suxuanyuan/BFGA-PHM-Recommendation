...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `9U7TKXTP_E078` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | submodule |  |
| 2 | `9U7TKXTP_E079` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | insulated gate bipolar transistor (IGBT) |  |
