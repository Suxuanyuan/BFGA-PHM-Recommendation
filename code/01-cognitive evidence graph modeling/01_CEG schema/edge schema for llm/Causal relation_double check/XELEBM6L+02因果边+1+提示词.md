...
- **Reference ID**: XELEBM6L
- **Paper Title**: Rough set based rule learning and fuzzy classification of wavelet features for fault diagnosis of monoblock centrifugal pump
...
> **Input Material**: Reference ID `XELEBM6L` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "XELEBM6L_E073", "edge_description": "outer race defect contains both faulty bearing and impeller"},
    {"edge_id": "XELEBM6L_E074", "edge_description": "impeller defect contains both faulty bearing and impeller"},
    {"edge_id": "XELEBM6L_E075", "edge_description": "cavitation contains both faulty bearing and impeller"},
    {"edge_id": "XELEBM6L_E076", "edge_description": "piezo-electric accelerometer is collected on bearing"},
    {"edge_id": "XELEBM6L_E077", "edge_description": "piezo-electric accelerometer is collected on impeller"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XELEBM6L_E073` | `contains` | 05-Fault Mode | outer race defect |  | 07-Compound Fault | both faulty bearing and impeller(Compound Fault Across Structures) |  |
| 2 | `XELEBM6L_E074` | `contains` | 05-Fault Mode | impeller defect |  | 07-Compound Fault | both faulty bearing and impeller(Compound Fault Across Structures) |  |
| 3 | `XELEBM6L_E075` | `contains` | 05-Fault Mode | cavitation |  | 07-Compound Fault | both faulty bearing and impeller(Compound Fault Across Structures) |  |
| 4 | `XELEBM6L_E076` | `is collected on` | 11-Sensor Information | piezo-electric accelerometer |  | 04-Fault Location | bearing |  |
| 5 | `XELEBM6L_E077` | `is collected on` | 11-Sensor Information | piezo-electric accelerometer |  | 04-Fault Location | impeller |  |
