...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `AXB3YMZY_E118` | `contains` | 05-Fault Mode | pitting |  | 06-Fault Severity | 0.007 inch, 0.014 inch, 0.021 inch(Multiple Severities) |  |
| 2 | `AXB3YMZY_E119` | `contains` | 05-Fault Mode | broken teeth |  | 06-Fault Severity | 0.007 inch, 0.014 inch, 0.021 inch(Multiple Severities) |  |
| 3 | `AXB3YMZY_E120` | `contains` | 05-Fault Mode | wear |  | 06-Fault Severity | 0.007 inch, 0.014 inch, 0.021 inch(Multiple Severities) |  |
| 4 | `AXB3YMZY_E121` | `contains` | 05-Fault Mode | crack |  | 06-Fault Severity | 0.007 inch, 0.014 inch, 0.021 inch(Multiple Severities) |  |
