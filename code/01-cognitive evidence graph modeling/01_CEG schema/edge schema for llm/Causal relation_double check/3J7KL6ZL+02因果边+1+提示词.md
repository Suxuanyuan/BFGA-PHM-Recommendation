...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `3J7KL6ZL_E058` | `contains` | 02-Object Type | hydraulic pump |  | 03-Operating Conditions | rotation speed is set at 5280 r/min, sampling frequency is 20 kHz(Single Condition) |  |
| 2 | `3J7KL6ZL_E059` | `contains` | 02-Object Type | bearing |  | 03-Operating Conditions | rotation speed is set at 5280 r/min, sampling frequency is 20 kHz(Single Condition) |  |
