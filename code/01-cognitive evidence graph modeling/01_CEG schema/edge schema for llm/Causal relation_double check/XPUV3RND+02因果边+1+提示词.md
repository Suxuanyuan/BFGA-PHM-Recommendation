...
- **Reference ID**: XPUV3RND
- **Paper Title**: Diagnosis Using Labeled Petri Nets With Silent or Undistinguishable Fault Events
...
> **Input Material**: Reference ID `XPUV3RND` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "XPUV3RND_E040", "edge_description": "production line contains key slot"},
    {"edge_id": "XPUV3RND_E041", "edge_description": "production line contains microcircuit"},
    {"edge_id": "XPUV3RND_E042", "edge_description": "production line contains production line"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XPUV3RND_E040` | `contains` | 02-Object Type | production line |  | 04-Fault Location | key slot |  |
| 2 | `XPUV3RND_E041` | `contains` | 02-Object Type | production line |  | 04-Fault Location | microcircuit |  |
| 3 | `XPUV3RND_E042` | `contains` | 02-Object Type | production line |  | 04-Fault Location | production line |  |
