...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `BGIL53D9_E090` | `contains` | 05-Fault Mode | without anti-yaw shock absorber |  | 07-Compound Fault | Compound fault(Compound Fault Across Structures) |  |
| 2 | `BGIL53D9_E091` | `contains` | 05-Fault Mode | air spring failure |  | 07-Compound Fault | Compound fault(Compound Fault Across Structures) |  |
| 3 | `BGIL53D9_E092` | `contains` | 05-Fault Mode | without transverse shock absorber |  | 07-Compound Fault | Compound fault(Compound Fault Across Structures) |  |
| 4 | `BGIL53D9_E093` | `is collected on` | 11-Sensor Information | sensors |  | 04-Fault Location | anti-yaw shock absorber |  |
| 5 | `BGIL53D9_E094` | `is collected on` | 11-Sensor Information | sensors |  | 04-Fault Location | air spring |  |
| 6 | `BGIL53D9_E095` | `is collected on` | 11-Sensor Information | sensors |  | 04-Fault Location | transverse shock absorber |  |
