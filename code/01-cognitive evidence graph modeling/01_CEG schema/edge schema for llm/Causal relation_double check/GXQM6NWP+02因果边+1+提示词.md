...
- **Reference ID**: GXQM6NWP
- **Paper Title**: Health Assessment and Prediction of Overhead Line Based on Health Index
...
> **Input Material**: Reference ID `GXQM6NWP` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "GXQM6NWP_E043", "edge_description": "overheating contains No Compound Fault"},
    {"edge_id": "GXQM6NWP_E044", "edge_description": "strand broken contains No Compound Fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `GXQM6NWP_E043` | `contains` | 05-Fault Mode | overheating |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `GXQM6NWP_E044` | `contains` | 05-Fault Mode | strand broken |  | 07-Compound Fault | No Compound Fault |  |
