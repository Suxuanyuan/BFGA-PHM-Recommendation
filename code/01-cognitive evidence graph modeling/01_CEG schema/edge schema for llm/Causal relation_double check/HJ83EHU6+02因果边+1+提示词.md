...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HJ83EHU6_E072` | `is collected on` | 11-Sensor Information | Hall effect sensor |  | 04-Fault Location | bearing |  |
| 2 | `HJ83EHU6_E073` | `is collected on` | 11-Sensor Information | digital attitude sensor |  | 04-Fault Location | bearing |  |
