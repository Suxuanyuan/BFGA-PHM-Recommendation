...
- **Reference ID**: R3RCL97B
- **Paper Title**: Fault prediction of bearings based on LSTM and statistical process analysis
...
> **Input Material**: Reference ID `R3RCL97B` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "R3RCL97B_E067", "edge_description": "failure contains No Compound Fault"},
    {"edge_id": "R3RCL97B_E068", "edge_description": "performance degradation contains No Compound Fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `R3RCL97B_E067` | `contains` | 05-Fault Mode | failure |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `R3RCL97B_E068` | `contains` | 05-Fault Mode | performance degradation |  | 07-Compound Fault | No Compound Fault |  |
