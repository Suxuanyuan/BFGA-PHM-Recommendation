...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZELVFWZ7_E064` | `is collected on` | 11-Sensor Information | accelerometers |  | 04-Fault Location | outer race |  |
| 2 | `ZELVFWZ7_E065` | `is collected on` | 11-Sensor Information | accelerometers |  | 04-Fault Location | inner race |  |
