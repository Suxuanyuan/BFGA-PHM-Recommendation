...
- **Reference ID**: RQYFEKX6
- **Paper Title**: Pattern diagnosis for stochastic discrete event systems
...
> **Input Material**: Reference ID `RQYFEKX6` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "RQYFEKX6_E053", "edge_description": "Three-Tank Water Level Control System contains 18 groups of SFSAs with different number of events and states"},
    {"edge_id": "RQYFEKX6_E054", "edge_description": "Heating, Ventilation, and Air-conditioning (HVAC) System contains 18 groups of SFSAs with different number of events and states"},
    {"edge_id": "RQYFEKX6_E061", "edge_description": "sensors can obviously reflect pump off"},
    {"edge_id": "RQYFEKX6_E062", "edge_description": "sensors can obviously reflect valve off"},
    {"edge_id": "RQYFEKX6_E063", "edge_description": "sensors can obviously reflect fan off"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `RQYFEKX6_E053` | `contains` | 02-Object Type | Three-Tank Water Level Control System |  | 03-Operating Conditions | 18 groups of SFSAs with different number of events and states(Multiple Conditions) |  |
| 2 | `RQYFEKX6_E054` | `contains` | 02-Object Type | Heating, Ventilation, and Air-conditioning (HVAC) System |  | 03-Operating Conditions | 18 groups of SFSAs with different number of events and states(Multiple Conditions) |  |
| 3 | `RQYFEKX6_E061` | `can obviously reflect` | 11-Sensor Information | sensors |  | 05-Fault Mode | pump off |  |
| 4 | `RQYFEKX6_E062` | `can obviously reflect` | 11-Sensor Information | sensors |  | 05-Fault Mode | valve off |  |
| 5 | `RQYFEKX6_E063` | `can obviously reflect` | 11-Sensor Information | sensors |  | 05-Fault Mode | fan off |  |
