...
- **Reference ID**: L3BIK6BJ
- **Paper Title**: Light neural network with fewer parameters based on CNN for fault diagnosis of rotating machinery
...
> **Input Material**: Reference ID `L3BIK6BJ` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "L3BIK6BJ_E093", "edge_description": "single point faults contains Combination"},
    {"edge_id": "L3BIK6BJ_E094", "edge_description": "Chipped, Miss contains Combination"},
    {"edge_id": "L3BIK6BJ_E095", "edge_description": "Root contains Combination"},
    {"edge_id": "L3BIK6BJ_E096", "edge_description": "Surface contains Combination"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `L3BIK6BJ_E093` | `contains` | 05-Fault Mode | single point faults |  | 07-Compound Fault | Combination(Compound Fault Within Same Structure) |  |
| 2 | `L3BIK6BJ_E094` | `contains` | 05-Fault Mode | Chipped, Miss |  | 07-Compound Fault | Combination(Compound Fault Within Same Structure) |  |
| 3 | `L3BIK6BJ_E095` | `contains` | 05-Fault Mode | Root |  | 07-Compound Fault | Combination(Compound Fault Within Same Structure) |  |
| 4 | `L3BIK6BJ_E096` | `contains` | 05-Fault Mode | Surface |  | 07-Compound Fault | Combination(Compound Fault Within Same Structure) |  |
