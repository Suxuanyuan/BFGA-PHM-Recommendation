...
- **Reference ID**: HW9LFHSW
- **Paper Title**: Improved generative adversarial network for vibration-based fault diagnosis with imbalanced data
...
> **Input Material**: Reference ID `HW9LFHSW` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "HW9LFHSW_E084", "edge_description": "pitting contains OR + IR"},
    {"edge_id": "HW9LFHSW_E085", "edge_description": "spalling contains OR + IR"},
    {"edge_id": "HW9LFHSW_E087", "edge_description": "accelerometers can obviously reflect pitting"},
    {"edge_id": "HW9LFHSW_E088", "edge_description": "accelerometers can obviously reflect spalling"},
    {"edge_id": "HW9LFHSW_E091", "edge_description": "rolling element bearing has_fault_mode pitting"},
    {"edge_id": "HW9LFHSW_E092", "edge_description": "rolling element bearing has_fault_mode spalling"},
    {"edge_id": "HW9LFHSW_E093", "edge_description": "pitting contains 0.1778 to 0.7112 mm"},
    {"edge_id": "HW9LFHSW_E094", "edge_description": "spalling contains 0.1778 to 0.7112 mm"},
    {"edge_id": "HW9LFHSW_E097", "edge_description": "pitting contains_phm_task fault diagnosis"},
    {"edge_id": "HW9LFHSW_E098", "edge_description": "spalling contains_phm_task fault diagnosis"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `HW9LFHSW_E084` | `contains` | 05-Fault Mode | pitting |  | 07-Compound Fault | OR + IR(Compound Fault Within Same Structure) |  |
| 2 | `HW9LFHSW_E085` | `contains` | 05-Fault Mode | spalling |  | 07-Compound Fault | OR + IR(Compound Fault Within Same Structure) |  |
| 3 | `HW9LFHSW_E087` | `can obviously reflect` | 11-Sensor Information | accelerometers |  | 05-Fault Mode | pitting |  |
| 4 | `HW9LFHSW_E088` | `can obviously reflect` | 11-Sensor Information | accelerometers |  | 05-Fault Mode | spalling |  |
| 5 | `HW9LFHSW_E091` | `has_fault_mode` | 04-Fault Location | rolling element bearing |  | 05-Fault Mode | pitting |  |
| 6 | `HW9LFHSW_E092` | `has_fault_mode` | 04-Fault Location | rolling element bearing |  | 05-Fault Mode | spalling |  |
| 7 | `HW9LFHSW_E093` | `contains` | 05-Fault Mode | pitting |  | 06-Fault Severity | 0.1778 to 0.7112 mm(Multiple Severities) |  |
| 8 | `HW9LFHSW_E094` | `contains` | 05-Fault Mode | spalling |  | 06-Fault Severity | 0.1778 to 0.7112 mm(Multiple Severities) |  |
| 9 | `HW9LFHSW_E097` | `contains_phm_task` | 05-Fault Mode | pitting |  | 08-PHM Task | fault diagnosis(Diagnosis Task) |  |
| 10 | `HW9LFHSW_E098` | `contains_phm_task` | 05-Fault Mode | spalling |  | 08-PHM Task | fault diagnosis(Diagnosis Task) |  |
