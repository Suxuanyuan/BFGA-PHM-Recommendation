...
- **Reference ID**: IFN2FKH4
- **Paper Title**: Study of Method on Genetic BP Networks for Vibration Fault Diagnosis of Turbogenerator
...
> **Input Material**: Reference ID `IFN2FKH4` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "IFN2FKH4_E050", "edge_description": "vibration sensor is collected on rotor"},
    {"edge_id": "IFN2FKH4_E051", "edge_description": "vibration sensor is collected on coupling"},
    {"edge_id": "IFN2FKH4_E052", "edge_description": "vibration sensor is collected on bearing"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `IFN2FKH4_E050` | `is collected on` | 11-Sensor Information | vibration sensor |  | 04-Fault Location | rotor |  |
| 2 | `IFN2FKH4_E051` | `is collected on` | 11-Sensor Information | vibration sensor |  | 04-Fault Location | coupling |  |
| 3 | `IFN2FKH4_E052` | `is collected on` | 11-Sensor Information | vibration sensor |  | 04-Fault Location | bearing |  |
