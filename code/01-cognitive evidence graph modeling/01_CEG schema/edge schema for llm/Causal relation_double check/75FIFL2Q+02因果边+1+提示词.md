...
- **Reference ID**: 75FIFL2Q
- **Paper Title**: Methodologies for system-level remaining useful life prediction
...
> **Input Material**: Reference ID `75FIFL2Q` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "75FIFL2Q_E055", "edge_description": "electrolyte evaporation contains No Compound Fault"},
    {"edge_id": "75FIFL2Q_E056", "edge_description": "oxide layer break down contains No Compound Fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `75FIFL2Q_E055` | `contains` | 05-Fault Mode | electrolyte evaporation |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `75FIFL2Q_E056` | `contains` | 05-Fault Mode | oxide layer break down |  | 07-Compound Fault | No Compound Fault |  |
