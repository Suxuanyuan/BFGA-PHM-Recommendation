...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `UTG85TYC_E065` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | inverter switch |  |
| 2 | `UTG85TYC_E066` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | inverter switch |  |
| 3 | `UTG85TYC_E067` | `is collected on` | 11-Sensor Information | rotary encoder |  | 04-Fault Location | inverter switch |  |
| 4 | `UTG85TYC_E068` | `is collected on` | 11-Sensor Information | HBM T12 torque sensor |  | 04-Fault Location | inverter switch |  |
