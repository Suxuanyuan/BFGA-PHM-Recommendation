...
- **Reference ID**: VGY2P3U4
- **Paper Title**: Compact convolutional transformers- generative adversarial network for compound fault diagnosis of industrial robot
...
> **Input Material**: Reference ID `VGY2P3U4` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "VGY2P3U4_E110", "edge_description": "reducer contains single operating condition"},
    {"edge_id": "VGY2P3U4_E111", "edge_description": "motor contains single operating condition"},
    {"edge_id": "VGY2P3U4_E112", "edge_description": "industrial robot contains single operating condition"},
    {"edge_id": "VGY2P3U4_E113", "edge_description": "minor abnormal sounds contains compound fault"},
    {"edge_id": "VGY2P3U4_E114", "edge_description": "oil leakage contains compound fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VGY2P3U4_E110` | `contains` | 02-Object Type | reducer |  | 03-Operating Conditions | single operating condition(Single Condition) |  |
| 2 | `VGY2P3U4_E111` | `contains` | 02-Object Type | motor |  | 03-Operating Conditions | single operating condition(Single Condition) |  |
| 3 | `VGY2P3U4_E112` | `contains` | 02-Object Type | industrial robot |  | 03-Operating Conditions | single operating condition(Single Condition) |  |
| 4 | `VGY2P3U4_E113` | `contains` | 05-Fault Mode | minor abnormal sounds |  | 07-Compound Fault | compound fault(Compound Fault Across Structures) |  |
| 5 | `VGY2P3U4_E114` | `contains` | 05-Fault Mode | oil leakage |  | 07-Compound Fault | compound fault(Compound Fault Across Structures) |  |
