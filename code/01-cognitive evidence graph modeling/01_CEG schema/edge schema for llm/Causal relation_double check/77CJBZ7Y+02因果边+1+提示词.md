...
- **Reference ID**: 77CJBZ7Y
- **Paper Title**: Power Transformer Operating State Prediction Method Based on an LSTM Network
...
> **Input Material**: Reference ID `77CJBZ7Y` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "77CJBZ7Y_E068", "edge_description": "deformation contains No Compound Fault"},
    {"edge_id": "77CJBZ7Y_E069", "edge_description": "contact discharge contains No Compound Fault"},
    {"edge_id": "77CJBZ7Y_E070", "edge_description": "overheating contains No Compound Fault"},
    {"edge_id": "77CJBZ7Y_E071", "edge_description": "oil chromatography online monitoring devices is collected on transformer core iron yoke"},
    {"edge_id": "77CJBZ7Y_E072", "edge_description": "oil chromatography online monitoring devices is collected on clamp and tank potential connection"},
    {"edge_id": "77CJBZ7Y_E073", "edge_description": "temperature sensor is collected on transformer core iron yoke"},
    {"edge_id": "77CJBZ7Y_E074", "edge_description": "temperature sensor is collected on clamp and tank potential connection"},
    {"edge_id": "77CJBZ7Y_E075", "edge_description": "current sensor is collected on transformer core iron yoke"},
    {"edge_id": "77CJBZ7Y_E076", "edge_description": "current sensor is collected on clamp and tank potential connection"},
    {"edge_id": "77CJBZ7Y_E077", "edge_description": "humidity sensor is collected on transformer core iron yoke"},
    {"edge_id": "77CJBZ7Y_E078", "edge_description": "humidity sensor is collected on clamp and tank potential connection"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `77CJBZ7Y_E068` | `contains` | 05-Fault Mode | deformation |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `77CJBZ7Y_E069` | `contains` | 05-Fault Mode | contact discharge |  | 07-Compound Fault | No Compound Fault |  |
| 3 | `77CJBZ7Y_E070` | `contains` | 05-Fault Mode | overheating |  | 07-Compound Fault | No Compound Fault |  |
| 4 | `77CJBZ7Y_E071` | `is collected on` | 11-Sensor Information | oil chromatography online monitoring devices |  | 04-Fault Location | transformer core iron yoke |  |
| 5 | `77CJBZ7Y_E072` | `is collected on` | 11-Sensor Information | oil chromatography online monitoring devices |  | 04-Fault Location | clamp and tank potential connection |  |
| 6 | `77CJBZ7Y_E073` | `is collected on` | 11-Sensor Information | temperature sensor |  | 04-Fault Location | transformer core iron yoke |  |
| 7 | `77CJBZ7Y_E074` | `is collected on` | 11-Sensor Information | temperature sensor |  | 04-Fault Location | clamp and tank potential connection |  |
| 8 | `77CJBZ7Y_E075` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | transformer core iron yoke |  |
| 9 | `77CJBZ7Y_E076` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | clamp and tank potential connection |  |
| 10 | `77CJBZ7Y_E077` | `is collected on` | 11-Sensor Information | humidity sensor |  | 04-Fault Location | transformer core iron yoke |  |
| 11 | `77CJBZ7Y_E078` | `is collected on` | 11-Sensor Information | humidity sensor |  | 04-Fault Location | clamp and tank potential connection |  |
...
*This prompt is automatically generated by edge_02_prompt_v2.py (Batch 1, total 11 edges)*
