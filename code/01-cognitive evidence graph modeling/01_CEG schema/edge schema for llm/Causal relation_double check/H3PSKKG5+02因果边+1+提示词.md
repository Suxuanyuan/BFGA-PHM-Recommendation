...
- **Reference ID**: H3PSKKG5
- **Paper Title**: Approach to Diagnose Gear Tooth-Broken Fault Based on Web
...
> **Input Material**: Reference ID `H3PSKKG5` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "H3PSKKG5_E033", "edge_description": "gear box contains gear box"},
    {"edge_id": "H3PSKKG5_E034", "edge_description": "gear contains gear box"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `H3PSKKG5_E033` | `contains` | 02-Object Type | gear box |  | 04-Fault Location | gear box |  |
| 2 | `H3PSKKG5_E034` | `contains` | 02-Object Type | gear |  | 04-Fault Location | gear box |  |
