...
- **Reference ID**: 9TT5UQHE
- **Paper Title**: Hybrid sequential fault estimation for multi-mode diagnosis of gas turbine engines
...
> **Input Material**: Reference ID `9TT5UQHE` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "9TT5UQHE_E038", "edge_description": "fouling contains multiple fault modes"},
    {"edge_id": "9TT5UQHE_E039", "edge_description": "tip clearance increase contains multiple fault modes"},
    {"edge_id": "9TT5UQHE_E040", "edge_description": "surface roughening contains multiple fault modes"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `9TT5UQHE_E038` | `contains` | 05-Fault Mode | fouling |  | 07-Compound Fault | multiple fault modes(Compound Fault Across Structures) |  |
| 2 | `9TT5UQHE_E039` | `contains` | 05-Fault Mode | tip clearance increase |  | 07-Compound Fault | multiple fault modes(Compound Fault Across Structures) |  |
| 3 | `9TT5UQHE_E040` | `contains` | 05-Fault Mode | surface roughening |  | 07-Compound Fault | multiple fault modes(Compound Fault Across Structures) |  |
