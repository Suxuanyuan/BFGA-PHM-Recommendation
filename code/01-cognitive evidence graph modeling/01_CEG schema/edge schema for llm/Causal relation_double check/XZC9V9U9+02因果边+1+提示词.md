...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `XZC9V9U9_E075` | `contains` | 05-Fault Mode | actuator fault |  | 06-Fault Severity | Single Severity |  |
| 2 | `XZC9V9U9_E076` | `contains` | 05-Fault Mode | sensor fault |  | 06-Fault Severity | Single Severity |  |
