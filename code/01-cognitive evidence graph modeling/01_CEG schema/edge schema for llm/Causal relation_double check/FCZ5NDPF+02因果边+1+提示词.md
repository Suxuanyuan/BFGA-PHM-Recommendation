...
- **Reference ID**: FCZ5NDPF
- **Paper Title**: A fault diagnosis scheme for rotating machinery using hierarchical symbolic analysis and convolutional neural network
...
> **Input Material**: Reference ID `FCZ5NDPF` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "FCZ5NDPF_E085", "edge_description": "crack contains fault diameters of 0.1778mm, 0.3556mm, 0.5334mm and 0.7112mm"},
    {"edge_id": "FCZ5NDPF_E086", "edge_description": "corrosive pitting contains fault diameters of 0.1778mm, 0.3556mm, 0.5334mm and 0.7112mm"},
    {"edge_id": "FCZ5NDPF_E087", "edge_description": "damage contains fault diameters of 0.1778mm, 0.3556mm, 0.5334mm and 0.7112mm"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `FCZ5NDPF_E085` | `contains` | 05-Fault Mode | crack |  | 06-Fault Severity | fault diameters of 0.1778mm, 0.3556mm, 0.5334mm and 0.7112mm(Multiple Severities) |  |
| 2 | `FCZ5NDPF_E086` | `contains` | 05-Fault Mode | corrosive pitting |  | 06-Fault Severity | fault diameters of 0.1778mm, 0.3556mm, 0.5334mm and 0.7112mm(Multiple Severities) |  |
| 3 | `FCZ5NDPF_E087` | `contains` | 05-Fault Mode | damage |  | 06-Fault Severity | fault diameters of 0.1778mm, 0.3556mm, 0.5334mm and 0.7112mm(Multiple Severities) |  |
