...
- **Reference ID**: VN7KUK62
- **Paper Title**: Open-Circuit Fault Diagnosis and Fault-Tolerant Control for a Coupled-Inductor-Based Aalborg Inverter
...
> **Input Material**: Reference ID `VN7KUK62` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "VN7KUK62_E037", "edge_description": "DC current sensor is collected on power switch"},
    {"edge_id": "VN7KUK62_E038", "edge_description": "voltages sampled by series resistance grounding method is collected on power switch"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VN7KUK62_E037` | `is collected on` | 11-Sensor Information | DC current sensor |  | 04-Fault Location | power switch |  |
| 2 | `VN7KUK62_E038` | `is collected on` | 11-Sensor Information | voltages sampled by series resistance grounding method |  | 04-Fault Location | power switch |  |
