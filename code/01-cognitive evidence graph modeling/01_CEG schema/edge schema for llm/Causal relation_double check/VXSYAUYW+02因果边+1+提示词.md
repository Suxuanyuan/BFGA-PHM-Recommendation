...
- **Reference ID**: VXSYAUYW
- **Paper Title**: Building cognizance rule knowledge for fault diagnosis based on fuzzy rough sets
...
> **Input Material**: Reference ID `VXSYAUYW` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "VXSYAUYW_E074", "edge_description": "sensor is collected on pin valve"},
    {"edge_id": "VXSYAUYW_E075", "edge_description": "sensor is collected on valve"},
    {"edge_id": "VXSYAUYW_E076", "edge_description": "sensor is collected on excess oil valve"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `VXSYAUYW_E074` | `is collected on` | 11-Sensor Information | sensor |  | 04-Fault Location | pin valve |  |
| 2 | `VXSYAUYW_E075` | `is collected on` | 11-Sensor Information | sensor |  | 04-Fault Location | valve |  |
| 3 | `VXSYAUYW_E076` | `is collected on` | 11-Sensor Information | sensor |  | 04-Fault Location | excess oil valve |  |
