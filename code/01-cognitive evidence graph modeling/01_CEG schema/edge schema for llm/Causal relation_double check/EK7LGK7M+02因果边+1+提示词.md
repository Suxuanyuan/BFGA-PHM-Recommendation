...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `EK7LGK7M_E062` | `is collected on` | 11-Sensor Information | temperature parameters (environmental temperature, nacelle temperature, temperature of pitch motor, temperature of battery cabinet) |  | 04-Fault Location | blades |  |
| 2 | `EK7LGK7M_E063` | `is collected on` | 11-Sensor Information | drive current of pitch motor |  | 04-Fault Location | blades |  |
| 3 | `EK7LGK7M_E064` | `is collected on` | 11-Sensor Information | rotating speed of generator |  | 04-Fault Location | blades |  |
| 4 | `EK7LGK7M_E065` | `is collected on` | 11-Sensor Information | anemometer and wind vane |  | 04-Fault Location | blades |  |
