...
- **Reference ID**: 4Z9N59A3
- **Paper Title**: A Hybrid Neural Model Approach for Health Assessment of Railway Transition Zones With Multiple Data Sources
...
> **Input Material**: Reference ID `4Z9N59A3` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "4Z9N59A3_E093", "edge_description": "track irregularity contains No Compound Fault"},
    {"edge_id": "4Z9N59A3_E094", "edge_description": "track settlement contains No Compound Fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4Z9N59A3_E093` | `contains` | 05-Fault Mode | track irregularity |  | 07-Compound Fault | No Compound Fault |  |
| 2 | `4Z9N59A3_E094` | `contains` | 05-Fault Mode | track settlement |  | 07-Compound Fault | No Compound Fault |  |
