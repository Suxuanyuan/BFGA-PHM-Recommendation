...
- **Reference ID**: C4MQWWUP
- **Paper Title**: Remaining Useful Life Prognosis Based on Ensemble Long Short-Term Memory Neural Network
...
> **Input Material**: Reference ID `C4MQWWUP` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "C4MQWWUP_E059", "edge_description": "high-pressure compressor fault contains high-pressure compressor fault and fan fault"},
    {"edge_id": "C4MQWWUP_E060", "edge_description": "fan fault contains high-pressure compressor fault and fan fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `C4MQWWUP_E059` | `contains` | 05-Fault Mode | high-pressure compressor fault |  | 07-Compound Fault | high-pressure compressor fault and fan fault(Compound Fault Across Structures) |  |
| 2 | `C4MQWWUP_E060` | `contains` | 05-Fault Mode | fan fault |  | 07-Compound Fault | high-pressure compressor fault and fan fault(Compound Fault Across Structures) |  |
