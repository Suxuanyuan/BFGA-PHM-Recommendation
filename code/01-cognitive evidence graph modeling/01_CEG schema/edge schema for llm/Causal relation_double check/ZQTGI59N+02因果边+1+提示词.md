...
- **Reference ID**: ZQTGI59N
- **Paper Title**: Dynamic fault prognosis for multivariate degradation process
...
> **Input Material**: Reference ID `ZQTGI59N` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "ZQTGI59N_E037", "edge_description": "current sensor is collected on rotor bar"},
    {"edge_id": "ZQTGI59N_E038", "edge_description": "torque sensor is collected on rotor bar"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `ZQTGI59N_E037` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | rotor bar |  |
| 2 | `ZQTGI59N_E038` | `is collected on` | 11-Sensor Information | torque sensor |  | 04-Fault Location | rotor bar |  |
