...
- **Reference ID**: V7TNVSYN
- **Paper Title**: Mechanism model-based and data-driven approach for the diagnosis of solid oxide fuel cell stack leakage
...
> **Input Material**: Reference ID `V7TNVSYN` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "V7TNVSYN_E022", "edge_description": "air side leakage contains air and fuel side simultaneous leakage"},
    {"edge_id": "V7TNVSYN_E023", "edge_description": "fuel side leakage contains air and fuel side simultaneous leakage"},
    {"edge_id": "V7TNVSYN_E037", "edge_description": "air side leakage contains air leakage: 4.36e-4 mol/s, fuel leakage: 1.12e-4 mol/s"},
    {"edge_id": "V7TNVSYN_E038", "edge_description": "fuel side leakage contains air leakage: 4.36e-4 mol/s, fuel leakage: 1.12e-4 mol/s"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `V7TNVSYN_E022` | `contains` | 05-Fault Mode | air side leakage |  | 07-Compound Fault | air and fuel side simultaneous leakage(Compound Fault Within Same Structure) |  |
| 2 | `V7TNVSYN_E023` | `contains` | 05-Fault Mode | fuel side leakage |  | 07-Compound Fault | air and fuel side simultaneous leakage(Compound Fault Within Same Structure) |  |
| 3 | `V7TNVSYN_E037` | `contains` | 05-Fault Mode | air side leakage |  | 06-Fault Severity | air leakage: 4.36e-4 mol/s, fuel leakage: 1.12e-4 mol/s(Single Severity) |  |
| 4 | `V7TNVSYN_E038` | `contains` | 05-Fault Mode | fuel side leakage |  | 06-Fault Severity | air leakage: 4.36e-4 mol/s, fuel leakage: 1.12e-4 mol/s(Single Severity) |  |
