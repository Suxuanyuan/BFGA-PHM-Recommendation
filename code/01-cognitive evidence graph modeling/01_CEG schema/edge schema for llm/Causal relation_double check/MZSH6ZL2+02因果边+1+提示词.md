...
- **Reference ID**: MZSH6ZL2
- **Paper Title**: Short-Frequency Fourier Transform for Fault Diagnosis of Induction Machines Working in Transient Regime
...
> **Input Material**: Reference ID `MZSH6ZL2` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "MZSH6ZL2_E037", "edge_description": "Current sensor is collected on rotor bar"},
    {"edge_id": "MZSH6ZL2_E038", "edge_description": "Resolver sensor is collected on rotor bar"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `MZSH6ZL2_E037` | `is collected on` | 11-Sensor Information | Current sensor |  | 04-Fault Location | rotor bar |  |
| 2 | `MZSH6ZL2_E038` | `is collected on` | 11-Sensor Information | Resolver sensor |  | 04-Fault Location | rotor bar |  |
