...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `CL9B8945_E064` | `contains` | 05-Fault Mode | wear |  | 06-Fault Severity | 0.18 mm, 0.36 mm, 0.53 mm(Multiple Severities) |  |
| 2 | `CL9B8945_E065` | `contains` | 05-Fault Mode | fracture |  | 06-Fault Severity | 0.18 mm, 0.36 mm, 0.53 mm(Multiple Severities) |  |
