...
- **Reference ID**: WYVUB3YJ
- **Paper Title**: A Short-Circuit Fault Diagnosis Method for Three-Phase Quasi-Z-Source Inverters
...
> **Input Material**: Reference ID `WYVUB3YJ` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "WYVUB3YJ_E025", "edge_description": "voltage sensor is collected on power switch"},
    {"edge_id": "WYVUB3YJ_E026", "edge_description": "current sensor is collected on power switch"},
    {"edge_id": "WYVUB3YJ_E027", "edge_description": "voltage sensor can obviously reflect short circuit"},
    {"edge_id": "WYVUB3YJ_E028", "edge_description": "current sensor can obviously reflect short circuit"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WYVUB3YJ_E025` | `is collected on` | 11-Sensor Information | voltage sensor |  | 04-Fault Location | power switch |  |
| 2 | `WYVUB3YJ_E026` | `is collected on` | 11-Sensor Information | current sensor |  | 04-Fault Location | power switch |  |
| 3 | `WYVUB3YJ_E027` | `can obviously reflect` | 11-Sensor Information | voltage sensor |  | 05-Fault Mode | short circuit |  |
| 4 | `WYVUB3YJ_E028` | `can obviously reflect` | 11-Sensor Information | current sensor |  | 05-Fault Mode | short circuit |  |
