...
- **Reference ID**: WNBALXPK
- **Paper Title**: Fault Diagnosis of Complex Processes Using Sparse Kernel Local Fisher Discriminant Analysis
...
> **Input Material**: Reference ID `WNBALXPK` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "WNBALXPK_E048", "edge_description": "Tennessee Eastman (TE) benchmark process contains diesel engine"},
    {"edge_id": "WNBALXPK_E049", "edge_description": "diesel engine contains diesel engine"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WNBALXPK_E048` | `contains` | 02-Object Type | Tennessee Eastman (TE) benchmark process |  | 04-Fault Location | diesel engine |  |
| 2 | `WNBALXPK_E049` | `contains` | 02-Object Type | diesel engine |  | 04-Fault Location | diesel engine |  |
