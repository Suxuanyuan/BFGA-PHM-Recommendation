...
- **Reference ID**: YT4AWGJI
- **Paper Title**: Multi-fault diagnosis of gearbox based on resonance-based signal sparse decomposition and comb filter
...
> **Input Material**: Reference ID `YT4AWGJI` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "YT4AWGJI_E118", "edge_description": "inner race fault contains width of 0.15mm and depth of 1.5 mm, width of 0.15mm and depth of 3mm, width of 0.15mm and depth of 1 mm"},
    {"edge_id": "YT4AWGJI_E119", "edge_description": "outer race fault contains width of 0.15mm and depth of 1.5 mm, width of 0.15mm and depth of 3mm, width of 0.15mm and depth of 1 mm"},
    {"edge_id": "YT4AWGJI_E120", "edge_description": "gear tooth crack contains width of 0.15mm and depth of 1.5 mm, width of 0.15mm and depth of 3mm, width of 0.15mm and depth of 1 mm"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `YT4AWGJI_E118` | `contains` | 05-Fault Mode | inner race fault |  | 06-Fault Severity | width of 0.15mm and depth of 1.5 mm, width of 0.15mm and depth of 3mm, width of 0.15mm and depth of 1 mm(Single Severity) |  |
| 2 | `YT4AWGJI_E119` | `contains` | 05-Fault Mode | outer race fault |  | 06-Fault Severity | width of 0.15mm and depth of 1.5 mm, width of 0.15mm and depth of 3mm, width of 0.15mm and depth of 1 mm(Single Severity) |  |
| 3 | `YT4AWGJI_E120` | `contains` | 05-Fault Mode | gear tooth crack |  | 06-Fault Severity | width of 0.15mm and depth of 1.5 mm, width of 0.15mm and depth of 3mm, width of 0.15mm and depth of 1 mm(Single Severity) |  |
...
*This prompt is automatically generated by edge_02_prompt_v2.py (Batch 1, total 3 edges)*
