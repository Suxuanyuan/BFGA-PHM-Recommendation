...
- **Reference ID**: P4KR87QQ
- **Paper Title**: Neural network-based robust actuator fault diagnosis for a non-linear multi-tank system
...
> **Input Material**: Reference ID `P4KR87QQ` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "P4KR87QQ_E072", "edge_description": "stack in place fault contains stack in place, 20% abrupt loss of effectiveness, incipient fault"},
    {"edge_id": "P4KR87QQ_E073", "edge_description": "loss of effectiveness fault contains stack in place, 20% abrupt loss of effectiveness, incipient fault"},
    {"edge_id": "P4KR87QQ_E074", "edge_description": "incipient fault contains stack in place, 20% abrupt loss of effectiveness, incipient fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `P4KR87QQ_E072` | `contains` | 05-Fault Mode | stack in place fault |  | 06-Fault Severity | stack in place, 20% abrupt loss of effectiveness, incipient fault(Multiple Severities) |  |
| 2 | `P4KR87QQ_E073` | `contains` | 05-Fault Mode | loss of effectiveness fault |  | 06-Fault Severity | stack in place, 20% abrupt loss of effectiveness, incipient fault(Multiple Severities) |  |
| 3 | `P4KR87QQ_E074` | `contains` | 05-Fault Mode | incipient fault |  | 06-Fault Severity | stack in place, 20% abrupt loss of effectiveness, incipient fault(Multiple Severities) |  |
