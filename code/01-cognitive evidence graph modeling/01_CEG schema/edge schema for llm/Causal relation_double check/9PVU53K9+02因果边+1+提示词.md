...
- **Reference ID**: 9PVU53K9
- **Paper Title**: Robust fault diagnosis algorithm for a class of Lipschitz system with unknown exogenous disturbances
...
> **Input Material**: Reference ID `9PVU53K9` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "9PVU53K9_E035", "edge_description": "temperature sensor is collected on actuator"},
    {"edge_id": "9PVU53K9_E036", "edge_description": "concentration measurement is collected on actuator"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `9PVU53K9_E035` | `is collected on` | 11-Sensor Information | temperature sensor |  | 04-Fault Location | actuator |  |
| 2 | `9PVU53K9_E036` | `is collected on` | 11-Sensor Information | concentration measurement |  | 04-Fault Location | actuator |  |
