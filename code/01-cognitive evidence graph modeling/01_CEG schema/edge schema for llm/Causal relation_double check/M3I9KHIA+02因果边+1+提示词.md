...
- **Reference ID**: M3I9KHIA
- **Paper Title**: The research of the jam fault features and diagnostic methods of the slide valve oil motive based on DEH data
...
> **Input Material**: Reference ID `M3I9KHIA` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "M3I9KHIA_E054", "edge_description": "displacement sensor is collected on slide valve"},
    {"edge_id": "M3I9KHIA_E055", "edge_description": "displacement sensor is collected on oil motive"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `M3I9KHIA_E054` | `is collected on` | 11-Sensor Information | displacement sensor |  | 04-Fault Location | slide valve |  |
| 2 | `M3I9KHIA_E055` | `is collected on` | 11-Sensor Information | displacement sensor |  | 04-Fault Location | oil motive |  |
