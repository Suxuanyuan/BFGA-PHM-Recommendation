...
- **Reference ID**: C00172
- **Paper Title**: Collaborative Multitask Learning Framework Based on Constrained Bi-Level Gradient Optimization for Mechanical Fault Diagnosis
...
> **Input Material**: Reference ID `C00172` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "C00172_E120", "edge_description": "intern short circuit contains composite fault"},
    {"edge_id": "C00172_E121", "edge_description": "broken bar contains composite fault"},
    {"edge_id": "C00172_E122", "edge_description": "fatigue pitting contains composite fault"},
    {"edge_id": "C00172_E123", "edge_description": "wear contains composite fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `C00172_E120` | `contains` | 05-Fault Mode | intern short circuit |  | 07-Compound Fault | composite fault(Compound Fault Within Same Structure) |  |
| 2 | `C00172_E121` | `contains` | 05-Fault Mode | broken bar |  | 07-Compound Fault | composite fault(Compound Fault Within Same Structure) |  |
| 3 | `C00172_E122` | `contains` | 05-Fault Mode | fatigue pitting |  | 07-Compound Fault | composite fault(Compound Fault Within Same Structure) |  |
| 4 | `C00172_E123` | `contains` | 05-Fault Mode | wear |  | 07-Compound Fault | composite fault(Compound Fault Within Same Structure) |  |
