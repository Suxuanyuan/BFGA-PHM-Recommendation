...
- **Reference ID**: 4J2F9C6K
- **Paper Title**: Gaussian Mixture Model Using Semisupervised Learning for Probabilistic Fault Diagnosis Under New Data Categories
...
> **Input Material**: Reference ID `4J2F9C6K` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "4J2F9C6K_E119", "edge_description": "rotary machine contains constant operating conditions"},
    {"edge_id": "4J2F9C6K_E120", "edge_description": "high-voltage electronic equipment contains constant operating conditions"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `4J2F9C6K_E119` | `contains` | 02-Object Type | rotary machine |  | 03-Operating Conditions | constant operating conditions(Single Condition) |  |
| 2 | `4J2F9C6K_E120` | `contains` | 02-Object Type | high-voltage electronic equipment |  | 03-Operating Conditions | constant operating conditions(Single Condition) |  |
