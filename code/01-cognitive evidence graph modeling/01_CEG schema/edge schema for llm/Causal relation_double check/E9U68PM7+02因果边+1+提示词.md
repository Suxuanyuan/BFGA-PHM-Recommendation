...
- **Reference ID**: E9U68PM7
- **Paper Title**: Dual-Enhanced Sparse Decomposition for Wind Turbine Gearbox Fault Diagnosis
...
> **Input Material**: Reference ID `E9U68PM7` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "E9U68PM7_E093", "edge_description": "fretting corrosion contains two faults in the gearbox"},
    {"edge_id": "E9U68PM7_E094", "edge_description": "inner race defect contains two faults in the gearbox"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `E9U68PM7_E093` | `contains` | 05-Fault Mode | fretting corrosion |  | 07-Compound Fault | two faults in the gearbox(Compound Fault Across Structures) |  |
| 2 | `E9U68PM7_E094` | `contains` | 05-Fault Mode | inner race defect |  | 07-Compound Fault | two faults in the gearbox(Compound Fault Across Structures) |  |
