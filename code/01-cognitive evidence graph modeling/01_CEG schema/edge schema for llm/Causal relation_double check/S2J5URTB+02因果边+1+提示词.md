...
- **Reference ID**: S2J5URTB
- **Paper Title**: Anomaly Detection in Gas Turbine Fuel Systems Using a Sequential Symbolic Method
...
> **Input Material**: Reference ID `S2J5URTB` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "S2J5URTB_E053", "edge_description": "temperature sensor is collected on fuel nozzle valve"},
    {"edge_id": "S2J5URTB_E054", "edge_description": "pressure sensor is collected on fuel nozzle valve"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `S2J5URTB_E053` | `is collected on` | 11-Sensor Information | temperature sensor |  | 04-Fault Location | fuel nozzle valve |  |
| 2 | `S2J5URTB_E054` | `is collected on` | 11-Sensor Information | pressure sensor |  | 04-Fault Location | fuel nozzle valve |  |
