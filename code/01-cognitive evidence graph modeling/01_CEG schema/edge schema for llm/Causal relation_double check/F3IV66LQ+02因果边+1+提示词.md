...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `F3IV66LQ_E072` | `is collected on` | 11-Sensor Information | Data acquisition card |  | 04-Fault Location | resistor |  |
| 2 | `F3IV66LQ_E073` | `is collected on` | 11-Sensor Information | Data acquisition card |  | 04-Fault Location | capacitor |  |
