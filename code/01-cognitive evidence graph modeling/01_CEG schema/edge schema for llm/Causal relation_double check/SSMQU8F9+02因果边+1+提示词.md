...
- **Reference ID**: SSMQU8F9
- **Paper Title**: A bearing data analysis based on kurtogram and deep learning sequence models
...
> **Input Material**: Reference ID `SSMQU8F9` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "SSMQU8F9_E038", "edge_description": "circular defect contains combined fault"},
    {"edge_id": "SSMQU8F9_E039", "edge_description": "frictional damage contains combined fault"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `SSMQU8F9_E038` | `contains` | 05-Fault Mode | circular defect |  | 07-Compound Fault | combined fault(Compound Fault Within Same Structure) |  |
| 2 | `SSMQU8F9_E039` | `contains` | 05-Fault Mode | frictional damage |  | 07-Compound Fault | combined fault(Compound Fault Within Same Structure) |  |
