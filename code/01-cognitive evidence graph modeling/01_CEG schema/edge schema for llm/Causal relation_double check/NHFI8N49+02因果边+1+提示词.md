...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `NHFI8N49_E065` | `contains` | 05-Fault Mode | tooth root crack |  | 07-Compound Fault | composite seeded fault(Compound Fault Within Same Structure) |  |
| 2 | `NHFI8N49_E066` | `contains` | 05-Fault Mode | tooth root chipped |  | 07-Compound Fault | composite seeded fault(Compound Fault Within Same Structure) |  |
| 3 | `NHFI8N49_E067` | `contains` | 05-Fault Mode | tooth missing |  | 07-Compound Fault | composite seeded fault(Compound Fault Within Same Structure) |  |
| 4 | `NHFI8N49_E068` | `contains` | 05-Fault Mode | wear |  | 07-Compound Fault | composite seeded fault(Compound Fault Within Same Structure) |  |
| 5 | `NHFI8N49_E069` | `is collected on` | 11-Sensor Information | acceleration sensor (PCB 352C03) |  | 04-Fault Location | planet gear |  |
| 6 | `NHFI8N49_E070` | `is collected on` | 11-Sensor Information | acceleration sensor (PCB 352C03) |  | 04-Fault Location | sun gear |  |
| 7 | `NHFI8N49_E071` | `is collected on` | 11-Sensor Information | tachometer sensor |  | 04-Fault Location | planet gear |  |
| 8 | `NHFI8N49_E072` | `is collected on` | 11-Sensor Information | tachometer sensor |  | 04-Fault Location | sun gear |  |
