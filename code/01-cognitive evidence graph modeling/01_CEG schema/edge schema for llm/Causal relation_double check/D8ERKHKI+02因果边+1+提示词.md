...
- **Reference ID**: D8ERKHKI
- **Paper Title**: A Fast DC Fault Detection Method for Multi-Terminal AC/DC Hybrid Distribution Network Based on Voltage Change Rate of DC Current-Limiting Inductor
...
> **Input Material**: Reference ID `D8ERKHKI` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "D8ERKHKI_E037", "edge_description": "Current-limiting inductor contains DC line"},
    {"edge_id": "D8ERKHKI_E038", "edge_description": "Voltage source converter contains DC line"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `D8ERKHKI_E037` | `contains` | 02-Object Type | Current-limiting inductor |  | 04-Fault Location | DC line |  |
| 2 | `D8ERKHKI_E038` | `contains` | 02-Object Type | Voltage source converter |  | 04-Fault Location | DC line |  |
