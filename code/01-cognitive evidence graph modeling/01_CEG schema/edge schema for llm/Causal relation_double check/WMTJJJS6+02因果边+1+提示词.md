...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `WMTJJJS6_E091` | `is collected on` | 11-Sensor Information | tri-axial accelerators |  | 04-Fault Location | seals |  |
| 2 | `WMTJJJS6_E092` | `is collected on` | 11-Sensor Information | tri-axial accelerators |  | 04-Fault Location | copper guide sleeve |  |
