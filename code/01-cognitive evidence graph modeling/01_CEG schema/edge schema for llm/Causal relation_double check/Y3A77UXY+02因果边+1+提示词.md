...
- **Reference ID**: Y3A77UXY
- **Paper Title**: Advancing Building Fault Diagnosis Using the Concept of Contextual and Heterogeneous Test
...
> **Input Material**: Reference ID `Y3A77UXY` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "Y3A77UXY_E075", "edge_description": "ventilation system contains window"},
    {"edge_id": "Y3A77UXY_E076", "edge_description": "ventilation system contains appliances"},
    {"edge_id": "Y3A77UXY_E077", "edge_description": "radiator contains window"},
    {"edge_id": "Y3A77UXY_E078", "edge_description": "radiator contains appliances"},
    {"edge_id": "Y3A77UXY_E079", "edge_description": "ventilation system contains time-varying environment and occupancy conditions"},
    {"edge_id": "Y3A77UXY_E080", "edge_description": "radiator contains time-varying environment and occupancy conditions"},
    {"edge_id": "Y3A77UXY_E081", "edge_description": "open window contains unplanned appliances, unplanned occupancy"},
    {"edge_id": "Y3A77UXY_E082", "edge_description": "unplanned appliances contains unplanned appliances, unplanned occupancy"},
    {"edge_id": "Y3A77UXY_E112", "edge_description": "open window contains 2 kW/h heater, 10 occupants"},
    {"edge_id": "Y3A77UXY_E113", "edge_description": "unplanned appliances contains 2 kW/h heater, 10 occupants"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `Y3A77UXY_E075` | `contains` | 02-Object Type | ventilation system |  | 04-Fault Location | window |  |
| 2 | `Y3A77UXY_E076` | `contains` | 02-Object Type | ventilation system |  | 04-Fault Location | appliances |  |
| 3 | `Y3A77UXY_E077` | `contains` | 02-Object Type | radiator |  | 04-Fault Location | window |  |
| 4 | `Y3A77UXY_E078` | `contains` | 02-Object Type | radiator |  | 04-Fault Location | appliances |  |
| 5 | `Y3A77UXY_E079` | `contains` | 02-Object Type | ventilation system |  | 03-Operating Conditions | time-varying environment and occupancy conditions(Variable Conditions) |  |
| 6 | `Y3A77UXY_E080` | `contains` | 02-Object Type | radiator |  | 03-Operating Conditions | time-varying environment and occupancy conditions(Variable Conditions) |  |
| 7 | `Y3A77UXY_E081` | `contains` | 05-Fault Mode | open window |  | 07-Compound Fault | unplanned appliances, unplanned occupancy(Compound Fault Across Structures) |  |
| 8 | `Y3A77UXY_E082` | `contains` | 05-Fault Mode | unplanned appliances |  | 07-Compound Fault | unplanned appliances, unplanned occupancy(Compound Fault Across Structures) |  |
| 9 | `Y3A77UXY_E112` | `contains` | 05-Fault Mode | open window |  | 06-Fault Severity | 2 kW/h heater, 10 occupants(Single Severity) |  |
| 10 | `Y3A77UXY_E113` | `contains` | 05-Fault Mode | unplanned appliances |  | 06-Fault Severity | 2 kW/h heater, 10 occupants(Single Severity) |  |
