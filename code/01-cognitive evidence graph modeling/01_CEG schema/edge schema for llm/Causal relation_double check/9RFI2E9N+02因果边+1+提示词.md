...
- **Reference ID**: 9RFI2E9N
- **Paper Title**: Fault-Tolerant Individual Pitch Control for Load Mitigation in Wind Turbines With Actuator Faults
...
> **Input Material**: Reference ID `9RFI2E9N` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "9RFI2E9N_E076", "edge_description": "generator speed sensor, azimuth angle sensor, pitch sensor is collected on pitch actuator"},
    {"edge_id": "9RFI2E9N_E077", "edge_description": "blade root moment sensor is collected on pitch actuator"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `9RFI2E9N_E076` | `is collected on` | 11-Sensor Information | generator speed sensor, azimuth angle sensor, pitch sensor |  | 04-Fault Location | pitch actuator |  |
| 2 | `9RFI2E9N_E077` | `is collected on` | 11-Sensor Information | blade root moment sensor |  | 04-Fault Location | pitch actuator |  |
