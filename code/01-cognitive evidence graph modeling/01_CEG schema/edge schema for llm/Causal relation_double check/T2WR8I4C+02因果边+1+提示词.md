...
- **Reference ID**: T2WR8I4C
- **Paper Title**: Physics-based prognostics of lithium-ion battery using non-linear least squares with dynamic bounds
...
> **Input Material**: Reference ID `T2WR8I4C` PDF full text (see the [PDF Full Text Content] section at the end of this prompt).
>
...
```json
[
    {"edge_id": "T2WR8I4C_E074", "edge_description": "loss of active materials contains multiple concurrent degradation mechanisms"},
    {"edge_id": "T2WR8I4C_E075", "edge_description": "loss of lithium inventory contains multiple concurrent degradation mechanisms"}
]
```
...
|------|---------|-----------|------------|------------|------------------|------------|------------|-------------------|
| 1 | `T2WR8I4C_E074` | `contains` | 05-Fault Mode | loss of active materials |  | 07-Compound Fault | multiple concurrent degradation mechanisms(Compound Fault Within Same Structure) |  |
| 2 | `T2WR8I4C_E075` | `contains` | 05-Fault Mode | loss of lithium inventory |  | 07-Compound Fault | multiple concurrent degradation mechanisms(Compound Fault Within Same Structure) |  |
